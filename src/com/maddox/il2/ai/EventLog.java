...
//        Exception test = new Exception("EventLog.onActorDied(" + (victim==null?"null":victim.getClass().getName()) + ", " + (aggressor==null?"null":aggressor.getClass().getName()));
...
//        Exception test = new Exception("EventLog.onDamaged(" + (victim==null?"null":victim.getClass().getName()) + ", " + (aggressor==null?"null":aggressor.getClass().getName()));
//        test.printStackTrace();
        if (!Actor.isValid(victim)) return;
        if (!Mission.isPlaying()) return;
        if (victim.isNetMirror()) return;
