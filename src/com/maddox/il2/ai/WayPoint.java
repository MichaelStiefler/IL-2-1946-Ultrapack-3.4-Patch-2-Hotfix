...
public class WayPoint {
    ...
    public void setTargetWaypointIndex(String s) {
        if (s == null) this.targetWaypointIndex = 0;
        try {
            this.targetWaypointIndex = Integer.parseInt(s);
        } catch (Exception e) {
            this.targetWaypointIndex = 0;
        }
    }
    ...
    public void set(WayPoint waypoint) {
        ...
        this.targetWaypointIndex = waypoint.targetWaypointIndex;
    }
