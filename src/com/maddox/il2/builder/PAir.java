...
public class PAir extends PPoint
{
    ...
    public static final String formations[] = {
        "Default", "EchelonRight", "EchelonLeft", "LineAbreast", "LineAstern", "Vic", "FingerFour", "Diamond", "Javelin", "Line", "LineAsternLong", "LineUpStacked", "FingertipRight", "Wall", "FluidFour", "Route", "Box"
    };
    private int type;
