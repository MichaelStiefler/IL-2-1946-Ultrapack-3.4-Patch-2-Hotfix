...
//            bMouseI = ini.get("Mods", "ExternalMouseInertia", 1) == 1;
        ...
        compassTest = this.ini.get("Mods", "CompassTest", 0) == 1;
        ...
        // TODO: +++ Time Overflow log message detail setting +++
        logTimeOverflow = this.ini.get("Mods", "logtimeoverflow", LOG_TIME_OVERFLOW_NORM);
        // TODO: --- Time Overflow log message detail setting ---
    }
...
//            ini.setValue("Mods", "ExternalMouseInertia", bMouseI ? "1" : "0");
    ...
    private void loadConsole() {
        ...
        if (this.ini.get("Console", "OverrideLogSettings", 0, 0, 1) == 1) {
            ...
            RTSConf.cur.console.setLogKeep(isUSE_RENDER()?false:true);
            RTSConf.cur.console.setLogFileName(isUSE_RENDER()?"log.lst":"logs.lst");
...
//        this.bMouseI = true;
    ...
    public static boolean isCompassTestActive() {
        return compassTest;
    }
    
    // TODO: +++ Time Overflow log message detail setting +++
    public static int getLogTimeOverflow() {
        return logTimeOverflow;
    }
    // TODO: --- Time Overflow log message detail setting ---
...
//    private static final String _VERSION                      = "4.10.1_(UP_EDITION)";
    private static final String   CORE_VERSION_NUMBER   = "4.70".intern();
    ...
    private static final String   HOTFIX_VERSION        = "24".intern();
...
//    public static String        LOCALE                        = "EN";
    ...
    public static final int     EXPIRED_YEAR                  = 2024;
...
//    public boolean bMouseI;
    ...
    private static boolean compassTest = false;
    
    // TODO: +++ Time Overflow log message detail setting +++
    private static int logTimeOverflow = 1;
    public static final int     LOG_TIME_OVERFLOW_NONE        = 0;
    public static final int     LOG_TIME_OVERFLOW_NORM        = 1;
    public static final int     LOG_TIME_OVERFLOW_FULL        = 2;
    // TODO: --- Time Overflow log message detail setting ---
