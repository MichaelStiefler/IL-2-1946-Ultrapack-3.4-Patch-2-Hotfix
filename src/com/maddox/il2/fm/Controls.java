...
//        Exception test = new Exception("Controls set(...) " + this.FM.actor.name() + " GearControl=" + controls_0_.GearControl);
...
//        Exception test = new Exception("Controls setLanded() " + this.FM.actor.name() + " GearControl=" + this.GearControl + ", Gear=" + this.Gear + ", bHasGearControl=" + this.bHasGearControl);
//        test.printStackTrace();
...
//        Exception test = new Exception("Controls setFixedGear(" + bool + ") " + this.FM.actor.name() + " GearControl=" + this.GearControl + ", Gear=" + this.Gear);
//        test.printStackTrace();
    }

    public void setGearAirborne() {
        if (this.bHasGearControl) this.GearControl = this.Gear = 0.0F;
//        Exception test = new Exception("Controls setGearAirborne() " + this.FM.actor.name() + " GearControl=" + this.GearControl + ", Gear=" + this.Gear + ", bHasGearControl=" + this.bHasGearControl);
//        test.printStackTrace();
    }

    public void setGear(float f) {
//        Exception test = new Exception("Controls setGear(" + f + ")");
//        test.printStackTrace();
        this.Gear = f;
    }
...
//        Exception test = new Exception("Controls forceGear(" + f + ") " + this.FM.actor.name() + " GearControl=" + this.GearControl + ", Gear=" + this.Gear + ", bHasGearControl=" + this.bHasGearControl);
//        test.printStackTrace();
    }
...
//        if (!this.hasBulletsLeftOnTrigger(trigger)) return false;
    ...
    public int getSelectedBombReleaseDelayIndex() {
        if (this.bombReleaseDelayOptions == null) {
            System.out.println(this.getClass() + ".getSelectedBombReleaseDelayIndex() called while bombReleaseDelayOptions are null. This may be responsible for weird occurances involving ordnance releases!");
            return 0;
        }
    ...
    public void setBombReleaseDelayByIndex(int index) {
        if (this.bombReleaseDelayOptions == null) {
            System.out.println(this.getClass() + ".setBombReleaseDelayByIndex(" + index + ") called while bombReleaseDelayOptions are null. This may be responsible for weird occurances involving ordnance releases!");
            return;
        }
    ...
    public int getSelectedRocketReleaseDelayIndex() {
        if (this.rocketReleaseDelayOptions == null) {
            System.out.println(this.getClass() + ".getSelectedRocketReleaseDelayIndex() called while rocketReleaseDelayOptions are null. This may be responsible for weird occurances involving ordnance releases!");
            return 0;
        }
    ...
    public void setRocketReleaseDelayByIndex(int index) {
        if (this.rocketReleaseDelayOptions == null) {
            System.out.println(this.getClass() + ".setRocketReleaseDelayByIndex(" + index + ") called while rocketReleaseDelayOptions are null. This may be responsible for weird occurances involving ordnance releases!");
            return;
        }
    ...
    public int getSelectedBombSalvoSizeIndex() {
        if (this.bombSalvoSizeOptions == null) {
            System.out.println(this.getClass() + ".getSelectedBombSalvoSizeIndex() called while bombSalvoSizeOptions are null. This may be responsible for weird occurances involving ordnance releases!");
            return 0;
        }
    ...
    public void setBombSalvoSizeByIndex(int index) {
        if (this.bombSalvoSizeOptions == null) {
            System.out.println(this.getClass() + ".setBombSalvoSizeByIndex(" + index + ") called while bombSalvoSizeOptions are null. This may be responsible for weird occurances involving ordnance releases!");
            return;
        }
    ...
    public int getSelectedRocketSalvoSizeIndex() {
        if (this.rocketSalvoSizeOptions == null) {
            System.out.println(this.getClass() + ".getSelectedRocketSalvoSizeIndex() called while rocketSalvoSizeOptions are null. This may be responsible for weird occurances involving ordnance releases!");
            return 0;
        }
    ...
    public void setRocketSalvoSizeByIndex(int index) {
        if (this.rocketSalvoSizeOptions == null) {
            System.out.println(this.getClass() + ".setRocketSalvoSizeByIndex(" + index + ") called while rocketSalvoSizeOptions are null. This may be responsible for weird occurances involving ordnance releases!");
            return;
        }
    ...
    public void setBombSelected(int index) {
        this.listBombs(); // TODO: Added by SAS~Storebror, make sure the list of available Bombs actually exists!
        if (index < 0 || index >= this.availableBombs.size()) {
            System.out.println(this.getClass() + ".setBombSelected() received an off value (" + index + ") and will ignore it. This may be responsible for weird occurances involving ordnance releases!");
            return;
        }
...
//        System.out.println("SKYLLA: Apply selected Rocket");
    ...
    public void setRocketSelected(int index) {
        this.listRockets(); // TODO: Added by SAS~Storebror, make sure the list of available Rockets actually exists!
...
//        System.out.println("SKYLLA: Apply selected Rocket");
    ...
    private void listBombs() {
        ...
        this.availableBombs.clear();
        this.availableBombs.addFirst(BombGun.class);
