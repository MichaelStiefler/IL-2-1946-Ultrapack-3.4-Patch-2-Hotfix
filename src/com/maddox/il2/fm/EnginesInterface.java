...
public class EnginesInterface extends FMMath {
        ...
        if (this.num != 0 && !(this.engines[0].getPropPos().distanceSquared(new Point3f(0.0F, 0.0F, 0.0F)) > 0.0F)) {
            ...
            switch (this.reference.Scheme) {
                ...
                case 8:
                    ...
                    point3d.y = 0.3333F * (2.0F * fs[0][1] + fs[1][1]);
                    engines[1].setPropPos(point3d);
                    point3d.y = 0.3333F * (fs[0][1] + 2.0F * fs[1][1]);
                    engines[2].setPropPos(point3d);
                    point3d.y = fs[1][1];
                    engines[3].setPropPos(point3d);
                    point3d.y = fs[2][1];
                    engines[4].setPropPos(point3d);
                    point3d.y = 0.3333F * (2.0F * fs[2][1] + fs[3][1]);
                    engines[5].setPropPos(point3d);
                    point3d.y = 0.3333F * (fs[2][1] + 2.0F * fs[3][1]);
                    engines[6].setPropPos(point3d);
                    point3d.y = fs[3][1];
                    engines[7].setPropPos(point3d);
                    point3d.x = 0.125F * (fs_2_[0][0] + fs_2_[1][0] + fs_2_[2][0] + fs_2_[3][0] + fs_2_[4][0] + fs_2_[5][0] + fs_2_[6][0] + fs_2_[7][0]);
                    point3d.y = fs_2_[0][1];
                    point3d.z = 0.125F * (fs_2_[0][2] + fs_2_[1][2] + fs_2_[2][2] + fs_2_[3][2] + fs_2_[4][2] + fs_2_[5][2] + fs_2_[6][2] + fs_2_[7][2]);
                ...
                case 10:
                    ...
                    point3d.z = 0.25F * (fs[0][2] + fs[1][2] + fs[2][2] + fs[3][2]);
                    engines[0].setPropPos(point3d);
                    point3d.y = 0.25F * (3F * fs[0][1] + fs[1][1]);
                    engines[1].setPropPos(point3d);
                    point3d.y = 0.5F * (fs[0][1] + fs[1][1]);
                    engines[2].setPropPos(point3d);
                    point3d.y = 0.25F * (fs[0][1] + 3F * fs[1][1]);
                    engines[3].setPropPos(point3d);
                    point3d.y = fs[1][1];
                    engines[4].setPropPos(point3d);
                    point3d.y = fs[2][1];
                    engines[5].setPropPos(point3d);
                    point3d.y = 0.25F * (3F * fs[2][1] + fs[3][1]);
                    engines[6].setPropPos(point3d);
                    point3d.y = 0.5F * (fs[2][1] + fs[3][1]);
                    engines[7].setPropPos(point3d);
                    point3d.y = 0.25F * (fs[2][1] + 3F * fs[3][1]);
                    engines[8].setPropPos(point3d);
                    point3d.y = fs[3][1];
                    engines[9].setPropPos(point3d);
                    point3d.x = 0.1F * (fs_2_[0][0] + fs_2_[1][0] + fs_2_[2][0] + fs_2_[3][0] + fs_2_[4][0] + fs_2_[5][0] + fs_2_[6][0] + fs_2_[7][0] + fs_2_[8][0] + fs_2_[9][0]);
                    point3d.y = fs_2_[0][1];
                    point3d.z = 0.1F * (fs_2_[0][2] + fs_2_[1][2] + fs_2_[2][2] + fs_2_[3][2] + fs_2_[4][2] + fs_2_[5][2] + fs_2_[6][2] + fs_2_[7][2] + fs_2_[8][2] + fs_2_[9][2]);
                    engines[0].setPos(point3d);
                    point3d.y = fs_2_[1][1];
                    engines[1].setPos(point3d);
                    point3d.y = fs_2_[2][1];
    ...
    public void update(float f) {
        ...
        // TODO: +++ Added by SAS~Storebror: Add Engine Forces of docked Mistel Queen to Drone +++
        if (this.reference.actor instanceof Mistel && this.reference.actor instanceof TypeDockable) {
            Mistel mistel = (Mistel)this.reference.actor;
            TypeDockable dockable = (TypeDockable)this.reference.actor;
            if (mistel.isDrone() && dockable.typeDockableIsDocked()) {
//                if (mistel.getQueen() instanceof BF_109) System.out.println("EI " + this.reference.actor.name() + " old producedF.x=" + this.producedF.x);
                EnginesInterface queenEI = mistel.getQueen().FM.EI;
                for (int queenEngineIndex = 0; queenEngineIndex < queenEI.num; queenEngineIndex++) {
//                    queenEI.engines[queenEngineIndex].update(f);

                    // TODO: Modified by CTO Mod
                    // ---------------------------------------------------
                    this.producedF.x += queenEI.engines[queenEngineIndex].getEngineForce().x + this.dCatapultForce;
                    // ---------------------------------------------------

                    this.producedF.y += queenEI.engines[queenEngineIndex].getEngineForce().y;
                    this.producedF.z += queenEI.engines[queenEngineIndex].getEngineForce().z;
                    this.producedM.x += queenEI.engines[queenEngineIndex].getEngineTorque().x;
                    this.producedM.y += queenEI.engines[queenEngineIndex].getEngineTorque().y;
                    this.producedM.z += queenEI.engines[queenEngineIndex].getEngineTorque().z;
                }
//                if (mistel.getQueen() instanceof BF_109) System.out.println("EI " + this.reference.actor.name() + " new producedF.x=" + this.producedF.x);
            }
        }
        // TODO: --- Added by SAS~Storebror: Add Engine Forces of docked Mistel Queen to Drone ---
    }
