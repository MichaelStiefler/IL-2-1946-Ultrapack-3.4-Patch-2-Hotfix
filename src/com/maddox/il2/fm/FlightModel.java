...
//        Exception test = new Exception("updateRotation(" + theTurret.bIsAIControlled + ", " + tickLen + ")");
//        test.printStackTrace();
        ...
        this.prev0 = tu[0];
        this.prev1 = tu[1];
//        float prevT0 = theTurret.tu[0];
//        float prevT1 = theTurret.tu[1];
        this.prev1 = tu[1];
...
//        System.out.println("updateRotation(" + theTurret.bIsAIControlled + ", " + tickLen + ") tu[0] prev=" + this.prev0 + ", new=" + tu[0] + ", tT.tu[0] prev=" + prevT0 + ", new=" + theTurret.tu[0]+ ", tT.tuLim[0]=" + theTurret.tuLim[0] + ", tu[1] prev=" + this.prev1 + ", new=" + tu[1] + ", tT.tu[1] prev=" + prevT1 + ", new=" + theTurret.tu[1]+ ", tT.tuLim[1]=" + theTurret.tuLim[1]);
        ...
        switch (theTurret.tMode) {
            ...
            case Turret.TU_MO_SLEEP:
                ...
                if (Time.current() > theTurret.timeNext) {
                    ...
                    if (VisCheck.visCheckTurret(theTurret, (Aircraft) this.actor, (Aircraft) theTurret.target, true, theTurret.isCheckPlaneBlocking())) {
...
//            theTurret.tuLim[1] = tu[1] * World.Rnd().nextFloat(0.76F + 0.06F * gunnerSkill, 1.24F - 0.06F * gunnerSkill) + World.Rnd().nextFloat((-10F + 2.5F * gunnerSkill) - this.rotSpeed * 5F, (10F - 2.5F * gunnerSkill) + this.rotSpeed * 5F);
                ...
                // ---
                else if (theTurret.useStockUpdate() ) {
                    theTurret.tuLim[0] = (tu[0] * World.Rnd().nextFloat(0.76F + 0.06F * gunnerSkill, 1.24F - 0.06F * gunnerSkill) + World.Rnd().nextFloat(-10.0F + 2.5F * gunnerSkill - this.rotSpeed * 5.0F, 10.0F - 2.5F * gunnerSkill + this.rotSpeed * 5.0F));
                    theTurret.tuLim[1] = (tu[1] * World.Rnd().nextFloat(0.76F + 0.06F * gunnerSkill, 1.24F - 0.06F * gunnerSkill) + World.Rnd().nextFloat(-10.0F + 2.5F * gunnerSkill - this.rotSpeed * 5.0F, 10.0F - 2.5F * gunnerSkill + this.rotSpeed * 5.0F));
                } else {
