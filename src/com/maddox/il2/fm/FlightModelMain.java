...
public class FlightModelMain extends FMMath {
    ...
    public float getAltitudeAboveGround() {
        return (float) this.Loc.z - Landscape.HQ((float)this.Loc.x, (float)this.Loc.y);
    }
    ...
    public void load(String s) {
        ...
        if (!formationDefaultIsNumeric) {
            ...
            else if (formationDefaultName.equalsIgnoreCase("FingertipRight")) this.formationDefault = Formation.F_FINGERTIP_RIGHT;
            else if (formationDefaultName.equalsIgnoreCase("Wall")) this.formationDefault = Formation.F_WALL;
            else if (formationDefaultName.equalsIgnoreCase("FluidFour")) this.formationDefault = Formation.F_FLUID_FOUR;
            else if (formationDefaultName.equalsIgnoreCase("Route")) this.formationDefault = Formation.F_ROUTE;
            else if (formationDefaultName.equalsIgnoreCase("Box")) this.formationDefault = Formation.F_BOX;
