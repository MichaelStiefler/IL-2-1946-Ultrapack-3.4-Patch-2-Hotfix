...
//            int i = Mission.cur().sectFile().get("Mods", "ExternalViewLevel", -1);
    ...
    /*
     * viewAllowedByModSetting is:
     *  bExtViewSelf     for OutsideView          key press
     *  bExtViewFriendly for NextView             key press
     *  bExtViewEnemy    for NextViewEnemy        key press
     *  bExtViewSelf     for OutsideViewFly       key press
     *  bExtViewFriendly for NextViewFollow       key press
     *  bExtViewEnemy    for NextViewEnemyFollow  key press
     */
    
    public boolean viewAllowed(boolean viewAllowedByModSetting) {
        if (!World.cur().diffCur.No_Outside_Views) return true; // Outside views are not limited by current difficulty setting, grant view access.
...
//        if (bool && this.iExtViewGround == -1 && this.iExtViewDead == -1) return true;
        ...
        if (this.bExtViewDead && (World.isPlayerParatrooper() || World.isPlayerDead() || this.FM == null || this.FM.isReadyToDie() || !Actor.isValid(World.getPlayerAircraft()))) return true;
        return viewAllowedByModSetting;
    }
...
//                System.out.println("AircraftHotKeys Requesting OutsideView");
                if (!AircraftHotKeys.this.viewAllowed(AircraftHotKeys.this.bExtViewSelf)) return;
//                System.out.println("AircraftHotKeys Request Granted!");
                Actor actor = World.getPlayerAircraft();
        ...
        HotKeyCmdEnv.addCmd(new HotKeyCmd(true, "NextView", "30") {
            ...
            public void begin() {
                if (!AircraftHotKeys.this.bMissionModsSet) AircraftHotKeys.this.setMissionMods();
//                System.out.println("AircraftHotKeys Requesting NextView");
                if (!AircraftHotKeys.this.viewAllowed(AircraftHotKeys.this.bExtViewFriendly)) return;
//                System.out.println("AircraftHotKeys Request Granted!");
        ...
        HotKeyCmdEnv.addCmd(new HotKeyCmd(true, "NextViewEnemy", "31") {
            ...
            public void begin() {
                if (!AircraftHotKeys.this.bMissionModsSet) AircraftHotKeys.this.setMissionMods();
//                System.out.println("AircraftHotKeys Requesting NextViewEnemy");
                if (!AircraftHotKeys.this.viewAllowed(AircraftHotKeys.this.bExtViewEnemy)) return;
//                System.out.println("AircraftHotKeys Request Granted!");
        ...
        HotKeyCmdEnv.addCmd(new HotKeyCmd(true, "OutsideViewFly", "32") {
            ...
            public void begin() {
                if (!AircraftHotKeys.this.bMissionModsSet) AircraftHotKeys.this.setMissionMods();
//                System.out.println("AircraftHotKeys Requesting OutsideViewFly");
                if (!AircraftHotKeys.this.viewAllowed(AircraftHotKeys.this.bExtViewSelf)) return;
//                System.out.println("AircraftHotKeys Request Granted!");
                Actor actor = AircraftHotKeys.this.getViewActor();
                if (!Actor.isValid(actor) || actor instanceof ActorViewPoint || actor instanceof BigshipGeneric) return;
                boolean bool = !Main3D.cur3D().isViewOutside();
        ...
        HotKeyCmdEnv.addCmd(new HotKeyCmd(true, "NextViewFollow", "47") {
            ...
            public void begin() {
                if (!AircraftHotKeys.this.bMissionModsSet) AircraftHotKeys.this.setMissionMods();
//                System.out.println("AircraftHotKeys Requesting NextViewFollow");
                if (!AircraftHotKeys.this.viewAllowed(AircraftHotKeys.this.bExtViewFriendly)) return;
//                System.out.println("AircraftHotKeys Request Granted!");
                Actor actor = AircraftHotKeys.this.nextViewActor(false);
                if (!Actor.isValid(actor)) return;
        ...
        HotKeyCmdEnv.addCmd(new HotKeyCmd(true, "NextViewEnemyFollow", "48") {
            ...
            public void begin() {
                if (!AircraftHotKeys.this.bMissionModsSet) AircraftHotKeys.this.setMissionMods();
//                System.out.println("AircraftHotKeys Requesting NextViewEnemyFollow");
                if (!AircraftHotKeys.this.viewAllowed(AircraftHotKeys.this.bExtViewEnemy)) return;
//                System.out.println("AircraftHotKeys Request Granted!");
                Actor actor = AircraftHotKeys.this.nextViewActor(true);
                if (!Actor.isValid(actor)) return;
