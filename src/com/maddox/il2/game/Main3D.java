...
public class Main3D extends Main {
    ...
    public class RenderCockpitMirror extends Render {
        ...
        public boolean isShow() {
            if (Main3D.this.viewMirror > 0 && Main3D.this.renderCockpit != null && Main3D.this.cockpitCur != null && Main3D.this.renderCockpit.isShow()) return Main3D.this.cockpitCur.isExistMirror();
            else return false;
        }
