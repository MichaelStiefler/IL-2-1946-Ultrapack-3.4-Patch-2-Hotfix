...
class OrderChange_Formation_To_10 extends Order {
    public OrderChange_Formation_To_10() {
        super("C_F_LINEASTERNLONG");
    }
    ...
    public void run() {
        ...
        for (int commandSetIndex = 0; commandSetIndex < this.CommandSet().length; commandSetIndex++) {
            ...
            if (pilot.Group != null) {
                ...
                pilot.Group.setFormationAndScale(Formation.F_LINEASTERNLONG, pilot.formationScale, true);
            }
        }
        Voice.setSyncMode(0);
    }
