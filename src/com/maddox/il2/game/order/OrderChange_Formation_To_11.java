...
class OrderChange_Formation_To_11 extends Order {
    public OrderChange_Formation_To_11() {
        super("C_F_LINEUPSTACKED");
    }
    ...
    public void run() {
        ...
        for (int commandSetIndex = 0; commandSetIndex < this.CommandSet().length; commandSetIndex++) {
            ...
            if (pilot.Group != null) {
                ...
                pilot.Group.setFormationAndScale(Formation.F_LINEUPSTACKED, pilot.formationScale, true);
            }
        }
        Voice.setSyncMode(0);
    }
