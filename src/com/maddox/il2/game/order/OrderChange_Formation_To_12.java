...
class OrderChange_Formation_To_12 extends Order {
    public OrderChange_Formation_To_12() {
        super("C_F_FINGERTIPRIGHT");
    }
    ...
    public void run() {
        ...
        for (int commandSetIndex = 0; commandSetIndex < this.CommandSet().length; commandSetIndex++) {
            ...
            if (pilot.Group != null) {
                ...
                pilot.Group.setFormationAndScale(Formation.F_FINGERTIP_RIGHT, pilot.formationScale, true);
            }
        }
        Voice.setSyncMode(0);
    }
