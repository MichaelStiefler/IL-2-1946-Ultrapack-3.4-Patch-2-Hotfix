...
class OrderChange_Formation_To_14 extends Order {
    public OrderChange_Formation_To_14() {
        super("C_F_FLUIDFOUR");
    }
    ...
    public void run() {
        ...
        for (int commandSetIndex = 0; commandSetIndex < this.CommandSet().length; commandSetIndex++) {
            ...
            if (pilot.Group != null) {
                ...
                pilot.Group.setFormationAndScale(Formation.F_FLUID_FOUR, pilot.formationScale, true);
            }
        }
        Voice.setSyncMode(0);
    }
