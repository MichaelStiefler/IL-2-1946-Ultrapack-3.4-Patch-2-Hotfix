...
class OrderChange_Formation_To_15 extends Order {
    public OrderChange_Formation_To_15() {
        super("C_F_ROUTE");
    }
    ...
    public void run() {
        ...
        for (int commandSetIndex = 0; commandSetIndex < this.CommandSet().length; commandSetIndex++) {
            ...
            if (pilot.Group != null) {
                ...
                pilot.Group.setFormationAndScale(Formation.F_ROUTE, pilot.formationScale, true);
            }
        }
        Voice.setSyncMode(0);
    }
