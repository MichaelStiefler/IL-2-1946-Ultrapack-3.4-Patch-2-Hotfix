...
class OrderChange_Formation_To_16 extends Order {
    public OrderChange_Formation_To_16() {
        super("C_F_BOX");
    }
    ...
    public void run() {
        ...
        for (int commandSetIndex = 0; commandSetIndex < this.CommandSet().length; commandSetIndex++) {
            ...
            if (pilot.Group != null) {
                ...
                pilot.Group.setFormationAndScale(Formation.F_BOX, pilot.formationScale, true);
            }
        }
        Voice.setSyncMode(0);
    }
