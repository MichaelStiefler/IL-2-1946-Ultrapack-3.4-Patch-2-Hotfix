...
class OrderChange_Formation_To_8 extends Order {
    public OrderChange_Formation_To_8() {
        super("C_F_JAVELIN");
    }
    ...
    public void run() {
        ...
        for (int commandSetIndex = 0; commandSetIndex < this.CommandSet().length; commandSetIndex++) {
            ...
            if (pilot.Group != null) {
                ...
                pilot.Group.setFormationAndScale(Formation.F_JAVELIN, pilot.formationScale, true);
            }
        }
        Voice.setSyncMode(0);
    }
