...
class OrderChange_Formation_To_9 extends Order {
    public OrderChange_Formation_To_9() {
        super("C_F_LINE");
    }
    ...
    public void run() {
        ...
        for (int commandSetIndex = 0; commandSetIndex < this.CommandSet().length; commandSetIndex++) {
            ...
            if (pilot.Group != null) {
                ...
                pilot.Group.setFormationAndScale(Formation.F_LINE, pilot.formationScale, true);
            }
        }
        Voice.setSyncMode(0);
    }
