...
public class OrdersTree {
    ...
    static Orders              ToWingman             = new Orders(new Order[] { new Order("Task"), new OrderCover_Me(), new OrderTarget_All(), new OrderAttack_Fighters(), new OrderAttack_Bombers(), new OrderAttack_My_Target(), new Order("Ground_Targets", OrdersTree.GroundTargets), new OrderDrop_Tanks(), new OrderBreak(), new OrderRejoin(), null, new OrderBack() });

    static Orders              Change_Formation_3    = new Orders(new Order[] { new Order("C_F"), new OrderChange_Formation_To_13(), new OrderChange_Formation_To_14(), new OrderChange_Formation_To_15(), new OrderChange_Formation_To_16(), null, null, null, null, new OrderBack() });

    static Orders              Change_Formation_2    = new Orders(new Order[] { new Order("C_F"), new OrderChange_Formation_To_7(), new OrderChange_Formation_To_8(), new OrderChange_Formation_To_9(), new OrderChange_Formation_To_10(), new OrderChange_Formation_To_11(), new OrderChange_Formation_To_12(), new Order("Change_Formation_More", OrdersTree.Change_Formation_3), null, new OrderBack() });

    static Orders              Change_Formation      = new Orders(new Order[] { new Order("C_F"), new OrderChange_Formation_To_1(), new OrderChange_Formation_To_2(), new OrderChange_Formation_To_3(), new OrderChange_Formation_To_4(), new OrderChange_Formation_To_5(), new OrderChange_Formation_To_6(), new Order("Change_Formation_More", OrdersTree.Change_Formation_2), null, new OrderBack() });

    static Orders              Tactical              = new Orders(new Order[] { new Order("Tactical"), new OrderBreak(), new OrderRejoin(), new OrderTighten_Formation(), new OrderLoosen_Formation(), new Order("Change_Formation_Submenu", OrdersTree.Change_Formation), null, new OrderBack() });
    ...
    static Orders              ToParaZveno           = new Orders(new Order[] { new Order("Task"), new OrderCover_Me(), new OrderTarget_All(), new OrderAttack_Fighters(), new OrderAttack_Bombers(), new OrderAttack_My_Target(), new Order("Ground_Targets", OrdersTree.GroundTargets), new OrderDrop_Tanks(), new Order("Tactical_Submenu", OrdersTree.Tactical), new Order("Navigation_Submenu", OrdersTree.Navigation), null, new OrderBack() });

    static Orders              ToGroupSquad          = OrdersTree.ToParaZveno;
    ...
    static Orders              ToLoadoutsTeam        = new Orders(new Order[] {
            ...
            new Order("mds.loadout"), new ZutiOrder_Loadout("0"), new ZutiOrder_Loadout("1"), new ZutiOrder_Loadout("2"), new ZutiOrder_Loadout("3"), new ZutiOrder_Loadout("4"), new ZutiOrder_Loadout("5"), new ZutiOrder_Loadout("6"), new ZutiOrder_Loadout("7"), new ZutiOrder_Loadout("8"), new OrderBack() });

    static Orders              ToEnginesRepairTeam   = new Orders(new Order[] {
            // "only" 9 load options available... this is how many numbers we have at our disposal :)
            new Order("mds.engines"), new ZutiOrder_EngineRepair("0"), new ZutiOrder_EngineRepair("1"), new ZutiOrder_EngineRepair("2"), new ZutiOrder_EngineRepair("3"), new ZutiOrder_EngineRepair("4"), new ZutiOrder_EngineRepair("5"), new ZutiOrder_EngineRepair("6"), new ZutiOrder_EngineRepair("7"), new ZutiOrder_EngineRepair("8"), new OrderBack() });
    ...
    static Orders              ToGunnersTeam         = new Orders(new Order[] {
            ...
            new Order("mds.kickGunner"), new ZutiOrder_EjectGunner("0"), new ZutiOrder_EjectGunner("1"), new ZutiOrder_EjectGunner("2"), new ZutiOrder_EjectGunner("3"), new ZutiOrder_EjectGunner("4"), new ZutiOrder_EjectGunner("5"), new ZutiOrder_EjectGunner("6"), new ZutiOrder_EjectGunner("7"), new ZutiOrder_EjectGunner("8"), new OrderBack() });

    // TODO: Added by |ZUTI|: for transferring controls
    static Orders              ToTransferTeam        = new Orders(new Order[] {
            // "only" 9 options available... this is how many numbers we have at our disposal :)
            new Order("mds.transferControl"), new ZutiOrder_TransferControls("0"), new ZutiOrder_TransferControls("1"), new ZutiOrder_TransferControls("2"), new ZutiOrder_TransferControls("3"), new ZutiOrder_TransferControls("4"), new ZutiOrder_TransferControls("5"), new ZutiOrder_TransferControls("6"), new ZutiOrder_TransferControls("7"), new ZutiOrder_TransferControls("mds.retakeControl"), new OrderBack() });
...
//    static Orders              ToNavigationTeam      = new Orders(new Order[] { new Order("mds.vectoring"), new OrderVector_To_Home_Base(), new OrderVector_To_Target(), new ZutiOrder_VectorToNearestHB(), null, null, null, null, null, new OrderBack() });
    ...
    static Orders              ToReloadingTeam       = new Orders(new Order[] { new Order("mds.RRR2"), new ZutiOrder_StartAll(), new Order("mds.rearm", OrdersTree.ToRearmingTeam), new ZutiOrder_RefuelAircraft(), new ZutiOrder_RepairAircraft(), new ZutiOrder_UnjamChocks(), null, new Order("mds.repairEngines", OrdersTree.ToEnginesRepairTeam), new Order("mds.loadoutOptions", OrdersTree.ToLoadoutsTeam), null, new OrderBack() });
    ...
    static Orders              ToCrew                = new Orders(new Order[] { new Order("Crew"), new Order("mds.transferControl", OrdersTree.ToTransferTeam), new Order("mds.kickGunner", OrdersTree.ToGunnersTeam), null, null, null, null, null, null, new OrderBack() });
    // ---

    // TODO: +++ Added by SAS~Storebror: Put Commands for Tower in separate menu
    static Orders              ToTower               = new Orders(new Order[] { new Order("Tower"), new OrderRequest_Assistance(), new OrderRequest_For_Landing(), new OrderRequest_For_Takeoff(), new OrderRequest_For_RunwayLights(), new Order("mds.vectoring"), new OrderVector_To_Home_Base(), new OrderVector_To_Target(), new ZutiOrder_VectorToNearestHB(), null, new OrderBack() });
    // ---

    // TODO: +++ Added by SAS~Storebror: Apply new Sub-Menus
    static Orders              ToGroundControl       = new Orders(new Order[] { new Order("GroundControl"), new Order("Crew", OrdersTree.ToCrew), new Order("Tower", OrdersTree.ToTower), null,
            // TODO: Added by |ZUTI|
            null, null, null, new Order("mds.unload", OrdersTree.ToUnloadingTeam), new Order("mds.RRR2", OrdersTree.ToReloadingTeam), new Order("mds.turrets", OrdersTree.ToTurrets), new OrderBack() });
...
//            new Order("mds.vectoring", ToNavigationTeam), new Order("mds.transferControl", ToTransferTeam), new Order("mds.kickGunner", ToGunnersTeam), new Order("mds.unload", ToUnloadingTeam), new Order("mds.RRR2", ToReloadingTeam), new Order("mds.turrets", ToTurrets), new OrderBack() });
    ...
    static Orders              SquadLeader           = new Orders(new Order[] { new Order("MainMenu"), new Order("Wingman", "deWingman", OrdersTree.ToWingman) {
                                                 public void run() {
                                                     this.cset(this.Wingman());
                                                     super.run();
                                                 }
                                             }, new Order("Para_1", "dePara_1", OrdersTree.ToParaZveno) {
                                                 public void run() {
                                                     this.cset(this.PlayerSquad().wing[0]);
                                                     super.run();
                                                 }
                                             }, new Order("Para_2", "dePara_2", OrdersTree.ToParaZveno) {
                                                 public void run() {
                                                     this.cset(this.PlayerSquad().wing[1]);
                                                     super.run();
                                                 }
                                             }, new Order("Para_3", "dePara_3", OrdersTree.ToParaZveno) {
                                                 public void run() {
                                                     this.cset(this.PlayerSquad().wing[2]);
                                                     super.run();
                                                 }
                                             }, new Order("Para_4", "dePara_4", OrdersTree.ToParaZveno) {
                                                 public void run() {
                                                     this.cset(this.PlayerSquad().wing[3]);
                                                     super.run();
                                                 }
                                             }, new Order("Group", "deGroup", OrdersTree.ToGroupSquad) {
                                                 public void run() {
                                                     this.cset(this.PlayerSquad());
                                                     super.run();
                                                 }
                                             }, new OrderAnyone_Help_Me(), new Order("Ground_Control", OrdersTree.ToGroundControl), new Order("Frequency", OrdersTree.Frequency), null, new OrderBack() });
    ...
    static Orders              GroupLeader           = new Orders(new Order[] { new Order("MainMenu"), new Order("Wingman", "deWingman", OrdersTree.ToWingman) {
                                                 public void run() {
                                                     this.cset(this.Wingman());
                                                     super.run();
                                                 }
                                             }, new Order("Zveno_1", "deZveno_1", OrdersTree.ToParaZveno) {
                                                 public void run() {
                                                     this.cset(this.PlayerSquad().wing[0]);
                                                     super.run();
                                                 }
                                             }, new Order("Zveno_2", "deZveno_2", OrdersTree.ToParaZveno) {
                                                 public void run() {
                                                     this.cset(this.PlayerSquad().wing[1]);
                                                     super.run();
                                                 }
                                             }, new Order("Zveno_3", "deZveno_3", OrdersTree.ToParaZveno) {
                                                 public void run() {
                                                     this.cset(this.PlayerSquad().wing[2]);
                                                     super.run();
                                                 }
                                             }, new Order("Zveno_4", "deZveno_4", OrdersTree.ToParaZveno) {
                                                 public void run() {
                                                     this.cset(this.PlayerSquad().wing[3]);
                                                     super.run();
                                                 }
                                             ...
                                             }, new OrderAnyone_Help_Me(), new Order("Ground_Control", OrdersTree.ToGroundControl), new Order("Frequency", OrdersTree.Frequency), new OrderBack() });
    ...
    public void setFrequency(Boolean bool) {
        if (bool != null) {
            this.frequency = bool.booleanValue();
        } else {
                ...
                if (actor instanceof Aircraft) {
                    ...
                    for (int i = 0; i < 16; i++) {
                        if ((squadron.wing[i >> 2] != null) && Actor.isAlive(squadron.wing[i >> 2].airc[i & 0x3])) {
                            this.CommandSet[i] = squadron.wing[i >> 2].airc[i & 0x3];
                        }
                    }
                }
            }
    ...
    private void missionLoaded(Aircraft aircraft) {
        ...
        if (this.Player != null) {
            ...
            if ((this.PlayerWing != wing_23_) || (i_22_ < 2)) {
                if ((i == 0) && (i_20_ > 1)) {
                    this.setAsWingLeader(i_21_);
                } else {
                    this.setAsWingman(i);
                    if (!this.isRemote() && (this.Player instanceof TypeTransport)) {
                        this.home.order[1].attrib |= 0x1;
                    }
                }
            } else if (i != 0) {
                this.setAsWingman(i);
                ...
                for (int i_25_ = 0; i_25_ < 4; i_25_++) {
                    if (this.PlayerSquad.wing[i_25_] == null) {
                        this.home.order[2 + i_25_].attrib |= 0x1;
                    }
                }
            }
            OrdersTree.curOrdersTree = null;
    ...
    private void setAsGroupLeader() {
        this.home = OrdersTree.GroupLeader;
        if (!this.isRemote()) {
            for (int i = 0; i < this.home.order.length; i++) {
                if (this.home.order[i] != null) {
                    this.home.order[i].attrib &= ~0x1;
    ...
    private void setAsWingLeader(int i) {
        if (!this.isRemote()) {
            for (int i_26_ = 0; i_26_ < this.home.order.length; i_26_++) {
                if (this.home.order[i_26_] != null) {
                    this.home.order[i_26_].attrib &= ~0x1;
                }
            }
            ...
            if ((i >= 0) && (i < 4)) {
                this.home.order[2 + i].attrib &= ~0x1;
            }
        }
    }
    ...
    private void disableAircraftCmds() {
        for (int i = 0; i < OrdersTree.hotKeyEnvNames.length; i++) {
            HashMapInt hashmapint = HotKeyEnv.env(OrdersTree.hotKeyEnvNames[i]).all();
        ...
        if (i == 0) {
            for (int i_29_ = orders.length - 1; i_29_ >= 0; i_29_--) {
                if (orders[i_29_] != null) {
                    ...
                    if (!ZutiSupportMethods_GameOrder.isRRROrder(orders[i_29_]) && this.isLocalClient()) {
            ...
            for (int i_30_ = 0; i_30_ < orders.length; i_30_++) {
                if ((orders[i_30_] != null) && (i == 0)) {
                    if (this.isLocal() && ((orders[i_30_].attrib & 0x1) != 0)) {
                        this.unactivate();
                    } else {
                        // TODO: Added by |ZUTI|
                        zutiIsRRROrder = ZutiSupportMethods_GameOrder.isRRROrder(orders[i_30_]);

                        if (this.isLocalClient() && !zutiIsRRROrder) {
                        ...
                        try {
                            orders[i_30_].preRun();
                            if (this.isLocalServer() || this.isRemoteServer() || zutiIsRRROrder) {
                                orders[i_30_].run();
                            }
    ...
    protected void doCmd(int i, boolean bool) {
        if (!bool && ((i == 0) || (Actor.isAlive(this.Player) && !World.isPlayerDead() && !World.isPlayerParatrooper()))) {
            this.execCmd(i);
        }
    }
