    ...
    implements TypeBomber, TypeTransport
{
    ...
    public static void prepareWeapons(Class aircraftClass, HierMesh hierMesh, String thisWeaponsName) {
        ...
        boolean isWinter = World.cur().camouflage == World.CAMOUFLAGE_WINTER;
        hierMesh.chunkVisible("GearL1_D0", !isWinter);
        hierMesh.chunkVisible("GearL3_D0", !isWinter);
        hierMesh.chunkVisible("GearL4_D0", !isWinter);
        hierMesh.chunkVisible("GearL5_D0", !isWinter);
        hierMesh.chunkVisible("GearLS1_D0", isWinter);
        hierMesh.chunkVisible("GearLS5_D0", isWinter);
        hierMesh.chunkVisible("GearLS7_D0", isWinter);
        hierMesh.chunkVisible("GearLS8_D0", isWinter);
        hierMesh.chunkVisible("GearLS9_D0", isWinter);
        hierMesh.chunkVisible("GearLS10_D0", isWinter);
        hierMesh.chunkVisible("GearR1_D0", !isWinter);
        hierMesh.chunkVisible("GearR3_D0", !isWinter);
        hierMesh.chunkVisible("GearR4_D0", !isWinter);
        hierMesh.chunkVisible("GearR5_D0", !isWinter);
        hierMesh.chunkVisible("GearRS1_D0", isWinter);
        hierMesh.chunkVisible("GearRS5_D0", isWinter);
        hierMesh.chunkVisible("GearRS7_D0", isWinter);
        hierMesh.chunkVisible("GearRS8_D0", isWinter);
        hierMesh.chunkVisible("GearRS9_D0", isWinter);
        hierMesh.chunkVisible("GearRS10_D0", isWinter);
        hierMesh.chunkVisible("GearC1_D0", !isWinter);
        hierMesh.chunkVisible("GearCS1_D0", isWinter);
    }
    
    public void onAircraftLoaded()
    {
        super.onAircraftLoaded();
        this.FM.CT.bHasBrakeControl = !Config.isUSE_RENDER() || World.cur().camouflage != World.CAMOUFLAGE_WINTER;
        BLENHEIM.prepareWeapons(this.getClass(), this.hierMesh(), this.thisWeaponsName);
    }
