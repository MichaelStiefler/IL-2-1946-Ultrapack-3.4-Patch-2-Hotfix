...
//        Property.set(class1, "cockpitClass", new Class[] { CockpitB17E.class, CockpitB17E_Bombardier.class, CockpitB17E_TGunner.class, CockpitB17E_LGunner.class, CockpitB17E_RGunner.class, CockpitB17E_AGunner.class });
        Property.set(class1, "cockpitClass", new Class[] { CockpitYB40.class, CockpitB17E_Bombardier.class, CockpitB17E_TGunner.class, CockpitB17E_LGunner.class, CockpitB17E_RGunner.class, CockpitB17E_AGunner.class });
        weaponTriggersRegister(class1, new int[] { 11, 12, 13, 13, 14, 14, 15, 16, 17, 17, 3, 3 });
        weaponHooksRegister(class1, new String[] { "_MGUN03", "_MGUN04", "_MGUN05", "_MGUN06", "_MGUN07", "_MGUN08", "_MGUN09", "_MGUN10", "_MGUN11", "_MGUN12", "_BombSpawn01", "_BombSpawn02" });
    }
}
