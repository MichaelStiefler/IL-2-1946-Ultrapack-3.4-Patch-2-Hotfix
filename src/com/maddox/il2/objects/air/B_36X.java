...
//                    System.out.println("#### AI started Jet Engine " + (i-5));
    ...
    public boolean turretAngles(int i, float af[]) {
        ...
        float minPitch = 0F;
        float maxPitch = 0F;
//        if (i==0) System.out.print("turretAngles(" + i + ", {" + yaw + ", " + pitch + "}) = ");
        switch (i) {
            case 0:
                if (yaw < -45F) {
                    yaw = -45F;
        ...
        af[0] = -yaw;
        af[1] = pitch;
//        if (i==0) System.out.println("" + flag + ", yaw=" + yaw + ", pitch=" + pitch);
        return flag;
    }
...
//                        System.out.println("propsReversed.size()=" + propsReversed.size() + ", propsNormal.size()=" + propsNormal.size());
    ...
    public static boolean useStockTurretUpdate(int turretIndex) {
        return true;
    }
    ...
    private static int[] maneuverValidForJetStartAndShutdown = { 
            Maneuver.NONE,
            Maneuver.HOLD,
            Maneuver.LEVEL_PLANE,
            Maneuver.SPIRAL_DOWN,
            Maneuver.DIVING_0_RPM,
            Maneuver.DIVING_30_DEG,
            Maneuver.DIVING_45_DEG,
            Maneuver.TURN,
            Maneuver.WAYPOINT,
            Maneuver.FOLLOW,
            Maneuver.LANDING,
            ...
            Maneuver.FAR_FOLLOW,
            Maneuver.SPIRAL_DOWN_SLOW,
            Maneuver.SMOOTH_LEVEL,
            Maneuver.STRAIGHT_AND_LEVEL};
    private static int[] maneuverDontTouchJets = {
            Maneuver.TAKEOFF,
            Maneuver.PARKED_STARTUP,
            Maneuver.TAXI,
            Maneuver.TAXI_TO_TO};
