...
public class CockpitA5M4 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitA5M4.this.fm != null) {
                ...
                CockpitA5M4.this.setNew.manifold = (0.8F * CockpitA5M4.this.setOld.manifold) + (0.2F * CockpitA5M4.this.fm.EI.engines[0].getManifoldPressure());
                CockpitA5M4.this.setNew.throttle = (0.8F * CockpitA5M4.this.setOld.throttle) + (0.2F * CockpitA5M4.this.fm.CT.PowerControl);
                CockpitA5M4.this.setNew.prop = (0.8F * CockpitA5M4.this.setOld.prop) + (0.2F * CockpitA5M4.this.fm.EI.engines[0].getControlProp());
                CockpitA5M4.this.setNew.mix = (0.8F * CockpitA5M4.this.setOld.mix) + (0.2F * CockpitA5M4.this.fm.EI.engines[0].getControlMix());
                CockpitA5M4.this.setNew.man = (0.92F * CockpitA5M4.this.setOld.man) + (0.08F * CockpitA5M4.this.fm.EI.engines[0].getManifoldPressure());
                CockpitA5M4.this.setNew.altimeter = CockpitA5M4.this.fm.getAltitude();
                float f = CockpitA5M4.this.waypointAzimuth();
                if (Math.abs(CockpitA5M4.this.fm.Or.getKren()) < 30F) {
                    CockpitA5M4.this.setNew.azimuth.setDeg(CockpitA5M4.this.setOld.azimuth.getDeg(1.0F), CockpitA5M4.this.fm.Or.azimut());
                }
                CockpitA5M4.this.setNew.waypointDeviation.setDeg(CockpitA5M4.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitA5M4.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-5F, 5F));
                CockpitA5M4.this.setNew.waypointAzimuth.setDeg(CockpitA5M4.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitA5M4.this.setNew.vspeed = (0.5F * CockpitA5M4.this.setOld.vspeed) + (0.5F * CockpitA5M4.this.fm.getVertSpeed());
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitA5M4.speedometerScale), 0.0F, 0.0F);
