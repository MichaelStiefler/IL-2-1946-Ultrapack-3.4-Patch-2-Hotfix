...
public class CockpitA6M2 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitA6M2.this.fm != null) {
                CockpitA6M2.this.setTmp = CockpitA6M2.this.setOld;
                CockpitA6M2.this.setOld = CockpitA6M2.this.setNew;
                CockpitA6M2.this.setNew = CockpitA6M2.this.setTmp;
                if (CockpitA6M2.this.cockpitDimControl) {
                    if (CockpitA6M2.this.setNew.dimPosition > 0.0F) {
                        CockpitA6M2.this.setNew.dimPosition = CockpitA6M2.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitA6M2.this.setNew.dimPosition < 1.0F) {
                    CockpitA6M2.this.setNew.dimPosition = CockpitA6M2.this.setOld.dimPosition + 0.05F;
                }
                if ((CockpitA6M2.this.fm.AS.astateCockpitState & 2) != 0) {
                    if (CockpitA6M2.this.setNew.stbyPosition > 0.0F) {
                        CockpitA6M2.this.setNew.stbyPosition = CockpitA6M2.this.setOld.stbyPosition - 0.025F;
                    }
                } else if (CockpitA6M2.this.setNew.stbyPosition < 1.0F) {
                    CockpitA6M2.this.setNew.stbyPosition = CockpitA6M2.this.setOld.stbyPosition + 0.025F;
                }
                CockpitA6M2.this.setNew.throttle = (0.9F * CockpitA6M2.this.setOld.throttle) + (0.1F * CockpitA6M2.this.fm.CT.PowerControl);
                CockpitA6M2.this.setNew.prop = (0.9F * CockpitA6M2.this.setOld.prop) + (0.1F * CockpitA6M2.this.fm.EI.engines[0].getControlProp());
                CockpitA6M2.this.setNew.mix = (0.8F * CockpitA6M2.this.setOld.mix) + (0.2F * CockpitA6M2.this.fm.EI.engines[0].getControlMix());
                CockpitA6M2.this.setNew.man = (0.92F * CockpitA6M2.this.setOld.man) + (0.08F * CockpitA6M2.this.fm.EI.engines[0].getManifoldPressure());
                CockpitA6M2.this.setNew.altimeter = CockpitA6M2.this.fm.getAltitude();
                if (Math.abs(CockpitA6M2.this.fm.Or.getKren()) < 30F) {
                    CockpitA6M2.this.setNew.azimuth.setDeg(CockpitA6M2.this.setOld.azimuth.getDeg(1.0F), CockpitA6M2.this.fm.Or.azimut());
                }
                CockpitA6M2.this.setNew.vspeed = ((199F * CockpitA6M2.this.setOld.vspeed) + CockpitA6M2.this.fm.getVertSpeed()) / 200F;
                float f = CockpitA6M2.this.waypointAzimuth();
                if (CockpitA6M2.this.useRealisticNavigationInstruments()) {
                    CockpitA6M2.this.setNew.waypointAzimuth.setDeg(CockpitA6M2.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitA6M2.this.getBeaconDirection());
                    CockpitA6M2.this.setNew.waypointDirection.setDeg(CockpitA6M2.this.setOld.waypointDirection.getDeg(1.0F), f);
                } else {
                    CockpitA6M2.this.setNew.waypointAzimuth.setDeg(CockpitA6M2.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitA6M2.this.setOld.azimuth.getDeg(1.0F));
                    CockpitA6M2.this.setNew.waypointDirection.setDeg(CockpitA6M2.this.setOld.waypointDirection.getDeg(0.1F), CockpitA6M2.this.fm.Or.azimut() + 90F);
                }
            }
            return true;
        }
    ...
    public CockpitA6M2() {
        super("3DO/Cockpit/A6M2/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Turn3", 0.0F, 68F * this.interp(this.setNew.mix, this.setOld.mix, f), 0.0F);
        this.mesh.chunkSetAngles("Turn3_rod", 0.0F, -68F * this.interp(this.setNew.mix, this.setOld.mix, f), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_AirSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 629.6798F, 0.0F, 17F), CockpitA6M2.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TempOil", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, 7F), CockpitA6M2.oilScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Revolution", 0.0F, this.cvt(f1, 500F, 4500F, 0.0F, 720F), 0.0F);
        if ((this.fm.AS.astateCockpitState & 4) == 0) {
