...
public class CockpitA6M2N extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitA6M2N.this.fm != null) {
                CockpitA6M2N.this.setTmp = CockpitA6M2N.this.setOld;
                CockpitA6M2N.this.setOld = CockpitA6M2N.this.setNew;
                CockpitA6M2N.this.setNew = CockpitA6M2N.this.setTmp;
                if (CockpitA6M2N.this.cockpitDimControl) {
                    if (CockpitA6M2N.this.setNew.dimPosition > 0.0F) {
                        CockpitA6M2N.this.setNew.dimPosition = CockpitA6M2N.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitA6M2N.this.setNew.dimPosition < 1.0F) {
                    CockpitA6M2N.this.setNew.dimPosition = CockpitA6M2N.this.setOld.dimPosition + 0.05F;
                }
                if ((CockpitA6M2N.this.fm.AS.astateCockpitState & 2) != 0) {
                    if (CockpitA6M2N.this.setNew.stbyPosition > 0.0F) {
                        CockpitA6M2N.this.setNew.stbyPosition = CockpitA6M2N.this.setOld.stbyPosition - 0.025F;
                    }
                } else if (CockpitA6M2N.this.setNew.stbyPosition < 1.0F) {
                    CockpitA6M2N.this.setNew.stbyPosition = CockpitA6M2N.this.setOld.stbyPosition + 0.025F;
                }
                ...
                if (Math.abs(CockpitA6M2N.this.fm.Or.getKren()) < 30F) {
                    CockpitA6M2N.this.setNew.azimuth.setDeg(CockpitA6M2N.this.setOld.azimuth.getDeg(1.0F), CockpitA6M2N.this.fm.Or.azimut());
                }
                CockpitA6M2N.this.setNew.vspeed = ((199F * CockpitA6M2N.this.setOld.vspeed) + CockpitA6M2N.this.fm.getVertSpeed()) / 200F;
                ...
                if (CockpitA6M2N.this.useRealisticNavigationInstruments()) {
                    ...
                    CockpitA6M2N.this.setNew.waypointDirection.setDeg(CockpitA6M2N.this.setOld.waypointDirection.getDeg(0.1F), CockpitA6M2N.this.fm.Or.azimut() + 90F);
                }
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_AirSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 814.8798F, 0.0F, 11F), CockpitA6M2N.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TempOil", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, 7F), CockpitA6M2N.oilScale), 0.0F);
    ...
    private static final float speedometerScale[] = { 0.0F, 7.5F, 32.5F, 80.5F, 147.5F, 212F, 288F, 370.5F, 450.5F, 533.5F, 594F, 673.5F };
