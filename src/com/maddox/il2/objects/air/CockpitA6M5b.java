...
public class CockpitA6M5b extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitA6M5b.this.fm != null) {
                CockpitA6M5b.this.setTmp = CockpitA6M5b.this.setOld;
                CockpitA6M5b.this.setOld = CockpitA6M5b.this.setNew;
                CockpitA6M5b.this.setNew = CockpitA6M5b.this.setTmp;
                if (CockpitA6M5b.this.cockpitDimControl) {
                    if (CockpitA6M5b.this.setNew.dimPosition > 0.0F) {
                        CockpitA6M5b.this.setNew.dimPosition = CockpitA6M5b.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitA6M5b.this.setNew.dimPosition < 1.0F) {
                    CockpitA6M5b.this.setNew.dimPosition = CockpitA6M5b.this.setOld.dimPosition + 0.05F;
                }
                if ((CockpitA6M5b.this.fm.AS.astateCockpitState & 2) != 0) {
                    if (CockpitA6M5b.this.setNew.stbyPosition > 0.0F) {
                        CockpitA6M5b.this.setNew.stbyPosition = CockpitA6M5b.this.setOld.stbyPosition - 0.025F;
                    }
                } else if (CockpitA6M5b.this.setNew.stbyPosition < 1.0F) {
                    CockpitA6M5b.this.setNew.stbyPosition = CockpitA6M5b.this.setOld.stbyPosition + 0.025F;
                }
                CockpitA6M5b.this.setNew.throttle = (0.9F * CockpitA6M5b.this.setOld.throttle) + (0.1F * CockpitA6M5b.this.fm.CT.PowerControl);
                CockpitA6M5b.this.setNew.prop = (0.9F * CockpitA6M5b.this.setOld.prop) + (0.1F * CockpitA6M5b.this.fm.EI.engines[0].getControlProp());
                CockpitA6M5b.this.setNew.mix = (0.8F * CockpitA6M5b.this.setOld.mix) + (0.2F * CockpitA6M5b.this.fm.EI.engines[0].getControlMix());
                CockpitA6M5b.this.setNew.man = (0.92F * CockpitA6M5b.this.setOld.man) + (0.08F * CockpitA6M5b.this.fm.EI.engines[0].getManifoldPressure());
                CockpitA6M5b.this.setNew.altimeter = CockpitA6M5b.this.fm.getAltitude();
                if (Math.abs(CockpitA6M5b.this.fm.Or.getKren()) < 30F) {
                    CockpitA6M5b.this.setNew.azimuth.setDeg(CockpitA6M5b.this.setOld.azimuth.getDeg(1.0F), CockpitA6M5b.this.fm.Or.azimut());
                }
                CockpitA6M5b.this.setNew.vspeed = ((199F * CockpitA6M5b.this.setOld.vspeed) + CockpitA6M5b.this.fm.getVertSpeed()) / 200F;
                float f = CockpitA6M5b.this.waypointAzimuth();
                if (CockpitA6M5b.this.useRealisticNavigationInstruments()) {
                    CockpitA6M5b.this.setNew.waypointAzimuth.setDeg(CockpitA6M5b.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitA6M5b.this.getBeaconDirection());
                    CockpitA6M5b.this.setNew.waypointDirection.setDeg(CockpitA6M5b.this.setOld.waypointDirection.getDeg(1.0F), f);
                } else {
                    CockpitA6M5b.this.setNew.waypointAzimuth.setDeg(CockpitA6M5b.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitA6M5b.this.setOld.azimuth.getDeg(1.0F));
                    CockpitA6M5b.this.setNew.waypointDirection.setDeg(CockpitA6M5b.this.setOld.waypointDirection.getDeg(0.1F), CockpitA6M5b.this.fm.Or.azimut() + 90F);
                }
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_AirSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 629.6798F, 0.0F, 17F), CockpitA6M5b.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TempOil", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, 7F), CockpitA6M5b.oilScale), 0.0F);
