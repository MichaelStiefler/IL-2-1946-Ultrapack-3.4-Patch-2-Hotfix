...
public class CockpitA6M5nf extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitA6M5nf.this.fm != null) {
                CockpitA6M5nf.this.setTmp = CockpitA6M5nf.this.setOld;
                CockpitA6M5nf.this.setOld = CockpitA6M5nf.this.setNew;
                CockpitA6M5nf.this.setNew = CockpitA6M5nf.this.setTmp;
                if (CockpitA6M5nf.this.cockpitDimControl) {
                    if (CockpitA6M5nf.this.setNew.dimPosition > 0.0F) {
                        CockpitA6M5nf.this.setNew.dimPosition = CockpitA6M5nf.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitA6M5nf.this.setNew.dimPosition < 1.0F) {
                    CockpitA6M5nf.this.setNew.dimPosition = CockpitA6M5nf.this.setOld.dimPosition + 0.05F;
                }
                if ((CockpitA6M5nf.this.fm.AS.astateCockpitState & 2) != 0) {
                    if (CockpitA6M5nf.this.setNew.stbyPosition > 0.0F) {
                        CockpitA6M5nf.this.setNew.stbyPosition = CockpitA6M5nf.this.setOld.stbyPosition - 0.025F;
                    }
                } else if (CockpitA6M5nf.this.setNew.stbyPosition < 1.0F) {
                    CockpitA6M5nf.this.setNew.stbyPosition = CockpitA6M5nf.this.setOld.stbyPosition + 0.025F;
                }
                CockpitA6M5nf.this.setNew.throttle = (0.9F * CockpitA6M5nf.this.setOld.throttle) + (0.1F * CockpitA6M5nf.this.fm.CT.PowerControl);
                CockpitA6M5nf.this.setNew.prop = (0.9F * CockpitA6M5nf.this.setOld.prop) + (0.1F * CockpitA6M5nf.this.fm.EI.engines[0].getControlProp());
                CockpitA6M5nf.this.setNew.mix = (0.8F * CockpitA6M5nf.this.setOld.mix) + (0.2F * CockpitA6M5nf.this.fm.EI.engines[0].getControlMix());
                CockpitA6M5nf.this.setNew.man = (0.92F * CockpitA6M5nf.this.setOld.man) + (0.08F * CockpitA6M5nf.this.fm.EI.engines[0].getManifoldPressure());
                CockpitA6M5nf.this.setNew.altimeter = CockpitA6M5nf.this.fm.getAltitude();
                if (Math.abs(CockpitA6M5nf.this.fm.Or.getKren()) < 30F) {
                    CockpitA6M5nf.this.setNew.azimuth.setDeg(CockpitA6M5nf.this.setOld.azimuth.getDeg(1.0F), CockpitA6M5nf.this.fm.Or.azimut());
                }
                CockpitA6M5nf.this.setNew.vspeed = ((199F * CockpitA6M5nf.this.setOld.vspeed) + CockpitA6M5nf.this.fm.getVertSpeed()) / 200F;
                float f = CockpitA6M5nf.this.waypointAzimuth();
                CockpitA6M5nf.this.setNew.waypointAzimuth.setDeg(CockpitA6M5nf.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitA6M5nf.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-5F, 5F));
                CockpitA6M5nf.this.setNew.waypointDirection.setDeg(CockpitA6M5nf.this.setOld.waypointDirection.getDeg(0.5F), f);
            }
            return true;
        }
    ...
    public CockpitA6M5nf() {
        super("3DO/Cockpit/A6M5nf/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Azimuth1a", 0.0F, -this.setNew.waypointDirection.getDeg(f) - 90F, 0.0F);
        this.mesh.chunkSetAngles("Z_Navigation", 0.0F, this.cvt(this.setNew.waypointAzimuth.getDeg(f), -25F, 25F, 45F, -45F), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_AirSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 629.6798F, 0.0F, 17F), CockpitA6M5nf.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TempOil", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, 7F), CockpitA6M5nf.oilScale), 0.0F);
