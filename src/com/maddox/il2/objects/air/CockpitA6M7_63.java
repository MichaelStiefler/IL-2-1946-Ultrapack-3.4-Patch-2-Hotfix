...
public class CockpitA6M7_63 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitA6M7_63.this.fm != null) {
                CockpitA6M7_63.this.setTmp = CockpitA6M7_63.this.setOld;
                CockpitA6M7_63.this.setOld = CockpitA6M7_63.this.setNew;
                CockpitA6M7_63.this.setNew = CockpitA6M7_63.this.setTmp;
                if (CockpitA6M7_63.this.cockpitDimControl) {
                    if (CockpitA6M7_63.this.setNew.dimPosition > 0.0F) {
                        CockpitA6M7_63.this.setNew.dimPosition = CockpitA6M7_63.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitA6M7_63.this.setNew.dimPosition < 1.0F) {
                    CockpitA6M7_63.this.setNew.dimPosition = CockpitA6M7_63.this.setOld.dimPosition + 0.05F;
                }
                if ((CockpitA6M7_63.this.fm.AS.astateCockpitState & 2) != 0) {
                    if (CockpitA6M7_63.this.setNew.stbyPosition > 0.0F) {
                        CockpitA6M7_63.this.setNew.stbyPosition = CockpitA6M7_63.this.setOld.stbyPosition - 0.025F;
                    }
                } else if (CockpitA6M7_63.this.setNew.stbyPosition < 1.0F) {
                    CockpitA6M7_63.this.setNew.stbyPosition = CockpitA6M7_63.this.setOld.stbyPosition + 0.025F;
                }
                CockpitA6M7_63.this.setNew.throttle = (0.9F * CockpitA6M7_63.this.setOld.throttle) + (0.1F * CockpitA6M7_63.this.fm.CT.PowerControl);
                CockpitA6M7_63.this.setNew.prop = (0.9F * CockpitA6M7_63.this.setOld.prop) + (0.1F * CockpitA6M7_63.this.fm.EI.engines[0].getControlProp());
                CockpitA6M7_63.this.setNew.mix = (0.8F * CockpitA6M7_63.this.setOld.mix) + (0.2F * CockpitA6M7_63.this.fm.EI.engines[0].getControlMix());
                CockpitA6M7_63.this.setNew.man = (0.92F * CockpitA6M7_63.this.setOld.man) + (0.08F * CockpitA6M7_63.this.fm.EI.engines[0].getManifoldPressure());
                CockpitA6M7_63.this.setNew.altimeter = CockpitA6M7_63.this.fm.getAltitude();
                if (Math.abs(CockpitA6M7_63.this.fm.Or.getKren()) < 30F) {
                    CockpitA6M7_63.this.setNew.azimuth.setDeg(CockpitA6M7_63.this.setOld.azimuth.getDeg(1.0F), CockpitA6M7_63.this.fm.Or.azimut());
                }
                CockpitA6M7_63.this.setNew.vspeed = ((199F * CockpitA6M7_63.this.setOld.vspeed) + CockpitA6M7_63.this.fm.getVertSpeed()) / 200F;
                float f = CockpitA6M7_63.this.waypointAzimuth();
                if (CockpitA6M7_63.this.useRealisticNavigationInstruments()) {
                    CockpitA6M7_63.this.setNew.waypointAzimuth.setDeg(CockpitA6M7_63.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitA6M7_63.this.getBeaconDirection());
                    CockpitA6M7_63.this.setNew.waypointDirection.setDeg(CockpitA6M7_63.this.setOld.waypointDirection.getDeg(0.1F), f);
                } else {
                    CockpitA6M7_63.this.setNew.waypointAzimuth.setDeg(CockpitA6M7_63.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitA6M7_63.this.setOld.azimuth.getDeg(1.0F));
                    CockpitA6M7_63.this.setNew.waypointDirection.setDeg(CockpitA6M7_63.this.setOld.waypointDirection.getDeg(0.1F), CockpitA6M7_63.this.fm.Or.azimut() + 90F);
                }
            }
            return true;
        }
    ...
    public CockpitA6M7_63() {
        super("3DO/Cockpit/A6M7_63/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_AirSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 740.7998F, 0.0F, 20F), CockpitA6M7_63.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TempOil", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, 7F), CockpitA6M7_63.oilScale), 0.0F);
