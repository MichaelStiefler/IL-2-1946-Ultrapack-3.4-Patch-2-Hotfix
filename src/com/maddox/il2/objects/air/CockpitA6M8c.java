...
public class CockpitA6M8c extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitA6M8c.this.fm != null) {
                CockpitA6M8c.this.setTmp = CockpitA6M8c.this.setOld;
                CockpitA6M8c.this.setOld = CockpitA6M8c.this.setNew;
                CockpitA6M8c.this.setNew = CockpitA6M8c.this.setTmp;
                if (CockpitA6M8c.this.cockpitDimControl) {
                    if (CockpitA6M8c.this.setNew.dimPosition > 0.0F) {
                        CockpitA6M8c.this.setNew.dimPosition = CockpitA6M8c.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitA6M8c.this.setNew.dimPosition < 1.0F) {
                    CockpitA6M8c.this.setNew.dimPosition = CockpitA6M8c.this.setOld.dimPosition + 0.05F;
                }
                if ((CockpitA6M8c.this.fm.AS.astateCockpitState & 2) != 0) {
                    if (CockpitA6M8c.this.setNew.stbyPosition > 0.0F) {
                        CockpitA6M8c.this.setNew.stbyPosition = CockpitA6M8c.this.setOld.stbyPosition - 0.025F;
                    }
                } else if (CockpitA6M8c.this.setNew.stbyPosition < 1.0F) {
                    CockpitA6M8c.this.setNew.stbyPosition = CockpitA6M8c.this.setOld.stbyPosition + 0.025F;
                }
                CockpitA6M8c.this.setNew.throttle = (0.9F * CockpitA6M8c.this.setOld.throttle) + (0.1F * CockpitA6M8c.this.fm.CT.PowerControl);
                CockpitA6M8c.this.setNew.prop = (0.9F * CockpitA6M8c.this.setOld.prop) + (0.1F * CockpitA6M8c.this.fm.EI.engines[0].getControlProp());
                CockpitA6M8c.this.setNew.mix = (0.8F * CockpitA6M8c.this.setOld.mix) + (0.2F * CockpitA6M8c.this.fm.EI.engines[0].getControlMix());
                CockpitA6M8c.this.setNew.man = (0.92F * CockpitA6M8c.this.setOld.man) + (0.08F * CockpitA6M8c.this.fm.EI.engines[0].getManifoldPressure());
                CockpitA6M8c.this.setNew.altimeter = CockpitA6M8c.this.fm.getAltitude();
                if (Math.abs(CockpitA6M8c.this.fm.Or.getKren()) < 30F) {
                    CockpitA6M8c.this.setNew.azimuth.setDeg(CockpitA6M8c.this.setOld.azimuth.getDeg(1.0F), CockpitA6M8c.this.fm.Or.azimut());
                }
                CockpitA6M8c.this.setNew.vspeed = ((199F * CockpitA6M8c.this.setOld.vspeed) + CockpitA6M8c.this.fm.getVertSpeed()) / 200F;
                float f = CockpitA6M8c.this.waypointAzimuth();
                CockpitA6M8c.this.setNew.waypointAzimuth.setDeg(CockpitA6M8c.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitA6M8c.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-5F, 5F));
                CockpitA6M8c.this.setNew.waypointDirection.setDeg(CockpitA6M8c.this.setOld.waypointDirection.getDeg(0.5F), f);
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_AirSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 629.6798F, 0.0F, 17F), CockpitA6M8c.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TempOil", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, 7F), CockpitA6M8c.oilScale), 0.0F);
