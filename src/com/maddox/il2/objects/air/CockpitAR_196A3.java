...
public class CockpitAR_196A3 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitAR_196A3.this.fm != null) {
                ...
                CockpitAR_196A3.this.setNew.flaps = (0.9F * CockpitAR_196A3.this.setOld.flaps) + (0.1F * CockpitAR_196A3.this.fm.CT.FlapsControl);
                CockpitAR_196A3.this.setNew.gear = (0.7F * CockpitAR_196A3.this.setOld.gear) + (0.3F * CockpitAR_196A3.this.fm.CT.GearControl);
                CockpitAR_196A3.this.setNew.throttle = (0.8F * CockpitAR_196A3.this.setOld.throttle) + (0.2F * CockpitAR_196A3.this.fm.CT.PowerControl);
                CockpitAR_196A3.this.setNew.prop = (0.8F * CockpitAR_196A3.this.setOld.prop) + (0.2F * CockpitAR_196A3.this.fm.EI.engines[0].getControlProp());
                CockpitAR_196A3.this.setNew.mix = (0.8F * CockpitAR_196A3.this.setOld.mix) + (0.2F * CockpitAR_196A3.this.fm.EI.engines[0].getControlMix());
                CockpitAR_196A3.this.setNew.divebrake = (0.8F * CockpitAR_196A3.this.setOld.divebrake) + (0.2F * CockpitAR_196A3.this.fm.CT.AirBrakeControl);
                CockpitAR_196A3.this.setNew.man = (0.92F * CockpitAR_196A3.this.setOld.man) + (0.08F * CockpitAR_196A3.this.fm.EI.engines[0].getManifoldPressure());
                CockpitAR_196A3.this.setNew.altimeter = CockpitAR_196A3.this.fm.getAltitude();
                if (Math.abs(CockpitAR_196A3.this.fm.Or.getKren()) < 30F) {
                    CockpitAR_196A3.this.setNew.azimuth.setDeg(CockpitAR_196A3.this.setOld.azimuth.getDeg(1.0F), CockpitAR_196A3.this.fm.Or.azimut());
                }
                CockpitAR_196A3.this.setNew.vspeed = ((399F * CockpitAR_196A3.this.setOld.vspeed) + CockpitAR_196A3.this.fm.getVertSpeed()) / 400F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 925.9998F, 0.0F, 10F), CockpitAR_196A3.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.setNew.vspeed < 0.0F ? this.floatindex(this.cvt(-this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitAR_196A3.variometerScale) : -this.floatindex(this.cvt(this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitAR_196A3.variometerScale), 0.0F);
