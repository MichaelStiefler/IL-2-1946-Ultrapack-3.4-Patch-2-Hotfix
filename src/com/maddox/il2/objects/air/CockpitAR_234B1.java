...
public class CockpitAR_234B1 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitAR_234B1.this.fm != null) {
                ...
                CockpitAR_234B1.this.setNew.throttleLockLever = (0.92F * CockpitAR_234B1.this.setOld.throttleLockLever) + (0.08F * (((AR_234B1) CockpitAR_234B1.this.aircraft()).throttleLocked ? 1.0F : 0.0F));
                if (BaseGameVersion.is410orLater()) {
                    ...
                    if (Math.abs(CockpitAR_234B1.this.fm.Or.getKren()) < 30F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("ruchkaSopla", this.cvt(this.interp(this.setNew.throttleLockLever, this.setOld.throttleLockLever, f), 0.0F, 1.0F, 0.0F, 50F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("ruchkaFuel1", this.cvt(this.interp(this.setNew.tankSelector1, this.setOld.tankSelector1, f), 0.0F, 2.0F, 0.0F, -36F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("ruchkaFuel2", this.cvt(this.interp(this.setNew.tankSelector2, this.setOld.tankSelector2, f), 0.0F, 2.0F, 0.0F, -36F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zSpeed1a", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitAR_234B1.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM1", 22.5F + this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitAR_234B1.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM2", 22.5F + this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitAR_234B1.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zGasPrs1a", this.cvt(this.fm.M.fuel > 1.0F ? this.fm.EI.engines[0].getPowerOutput() : 0.0F, 0.0F, 1.0F, 0.0F, 270F) * this.cvt(this.fm.EI.engines[0].tOilOut, 110F, 130F, 1.0F, 1.1F) * this.cvt(this.fm.EI.engines[0].tWaterOut, 630F, 650F, 1.0F, 1.1F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zGasPrs1b", this.cvt(this.fm.M.fuel > 1.0F ? this.fm.EI.engines[0].getPowerOutput() : 0.0F, 0.0F, 1.0F, 0.0F, 130F) * this.cvt(this.fm.EI.engines[0].tOilOut, 110F, 130F, 1.0F, 1.15F) * this.cvt(this.fm.EI.engines[0].tWaterOut, 630F, 650F, 1.0F, 1.15F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zGasPrs2a", this.cvt(this.fm.M.fuel > 1.0F ? this.fm.EI.engines[1].getPowerOutput() : 0.0F, 0.0F, 1.0F, 0.0F, 270F) * this.cvt(this.fm.EI.engines[1].tOilOut, 110F, 130F, 1.0F, 1.1F) * this.cvt(this.fm.EI.engines[1].tWaterOut, 630F, 650F, 1.0F, 1.1F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zGasPrs2b", this.cvt(this.fm.M.fuel > 1.0F ? this.fm.EI.engines[1].getPowerOutput() : 0.0F, 0.0F, 1.0F, 0.0F, -130F) * this.cvt(this.fm.EI.engines[1].tOilOut, 110F, 130F, 1.0F, 1.15F) * this.cvt(this.fm.EI.engines[1].tWaterOut, 630F, 650F, 1.0F, 1.15F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zOilPrs1a", this.fm.EI.engines[0].tOilOut >= 110F ? this.cvt(this.fm.EI.engines[0].tOilOut, 110F, 138F, 135F, 270F) : this.cvt(this.fm.EI.engines[0].tOilOut, 20F, 110F, 0.0F, 135F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zOilPrs2a", this.fm.EI.engines[1].tOilOut >= 110F ? this.cvt(this.fm.EI.engines[1].tOilOut, 110F, 138F, 135F, 270F) : this.cvt(this.fm.EI.engines[1].tOilOut, 20F, 110F, 0.0F, 135F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zFuelPrs1a", this.fm.M.fuel > 1.0F ? this.cvt(this.interp(this.setNew.throttle1, this.setOld.throttle1, f), 0.0F, 1.0F, 0.0F, 135F) * this.cvt(this.fm.EI.engines[0].tOilOut, 110F, 138F, 1.0F, 2.0F) : 0.0F, 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zFuelPrs2a", this.fm.M.fuel > 1.0F ? this.cvt(this.interp(this.setNew.throttle2, this.setOld.throttle2, f), 0.0F, 1.0F, 0.0F, 135F) * this.cvt(this.fm.EI.engines[1].tOilOut, 110F, 138F, 1.0F, 2.0F) : 0.0F, 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zGasTemp1a", this.cvt(this.fm.EI.engines[0].getThrustOutput() * this.cvt(this.fm.EI.engines[0].tWaterOut, 630F, 650F, 1.0F, 2.0F), 0.0F, 2.0F, 0.0F, 61F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zGasTemp2a", this.cvt(this.fm.EI.engines[1].getThrustOutput() * this.cvt(this.fm.EI.engines[1].tWaterOut, 630F, 650F, 1.0F, 2.0F), 0.0F, 2.0F, 0.0F, 61F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zVariometer1a", this.setNew.vspeed >= 0.0F ? this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitAR_234B1.vsiNeedleScale) : -this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitAR_234B1.vsiNeedleScale), 0.0F, 0.0F);
    ...
    public float               limits6DoF[]       = { 0.7F, 0.055F, -0.07F, 0.08F, 0.1F, -0.09F, 0.03F, -0.03F };
