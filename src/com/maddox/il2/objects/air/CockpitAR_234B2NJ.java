...
public class CockpitAR_234B2NJ extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitAR_234B2NJ.this.fm != null) {
                ...
                if (Math.abs(CockpitAR_234B2NJ.this.fm.Or.getKren()) < 30F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed1a", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitAR_234B2NJ.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM1", 22.5F + this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitAR_234B2NJ.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM2", 22.5F + this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitAR_234B2NJ.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zVariometer1a", this.setNew.vspeed >= 0.0F ? this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitAR_234B2NJ.vsiNeedleScale) : -this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitAR_234B2NJ.vsiNeedleScale), 0.0F, 0.0F);
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            ...
            if (this.aircraft().thisWeaponsName.startsWith("SN2d")) {
                this.mesh.chunkVisible("Fug200_D0", false);
                this.mesh.chunkVisible("Fug200d_D0", true);
            } else {
                this.mesh.chunkVisible("Fug200_D0", true);
                this.mesh.chunkVisible("Fug200d_D0", false);
            }
            return true;
        } else {
            return false;
