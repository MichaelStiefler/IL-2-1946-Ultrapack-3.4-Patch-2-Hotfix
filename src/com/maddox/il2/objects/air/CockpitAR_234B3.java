...
public class CockpitAR_234B3 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitAR_234B3.this.fm != null) {
                CockpitAR_234B3.this.setTmp = CockpitAR_234B3.this.setOld;
                CockpitAR_234B3.this.setOld = CockpitAR_234B3.this.setNew;
                CockpitAR_234B3.this.setNew = CockpitAR_234B3.this.setTmp;
                CockpitAR_234B3.this.setNew.altimeter = CockpitAR_234B3.this.fm.getAltitude();
                CockpitAR_234B3.this.setNew.throttle1 = (0.92F * CockpitAR_234B3.this.setOld.throttle1) + (0.08F * ((FlightModelMain) (CockpitAR_234B3.this.fm)).EI.engines[0].getControlThrottle());
                CockpitAR_234B3.this.setNew.throttle2 = (0.92F * CockpitAR_234B3.this.setOld.throttle2) + (0.08F * ((FlightModelMain) (CockpitAR_234B3.this.fm)).EI.engines[1].getControlThrottle());
                CockpitAR_234B3.this.setNew.vspeed = ((499F * CockpitAR_234B3.this.setOld.vspeed) + CockpitAR_234B3.this.fm.getVertSpeed()) / 500F;
                CockpitAR_234B3.this.setNew.waypointAzimuth.setDeg(CockpitAR_234B3.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitAR_234B3.this.waypointAzimuth() - CockpitAR_234B3.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitAR_234B3.this.fm.Or.getKren()) < 30F) {
                    CockpitAR_234B3.this.setNew.azimuth.setDeg(CockpitAR_234B3.this.setOld.azimuth.getDeg(1.0F), CockpitAR_234B3.this.fm.Or.azimut());
                }
            }
            return true;
        }
    ...
    public CockpitAR_234B3() {
        super("3DO/Cockpit/Ar-234B3/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed1a", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitAR_234B3.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM1", 22.5F + this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitAR_234B3.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM2", 22.5F + this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitAR_234B3.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zRoll1a", -f1, 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zVariometer1a", this.setNew.vspeed >= 0.0F ? this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitAR_234B3.vsiNeedleScale) : -this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitAR_234B3.vsiNeedleScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zAzimuth1a", this.setNew.azimuth.getDeg(f), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zAzimuth1b", -this.setNew.waypointAzimuth.getDeg(f), 0.0F, 0.0F);
