...
public class CockpitAR_234C2 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitAR_234C2.this.fm != null) {
                CockpitAR_234C2.this.setTmp = CockpitAR_234C2.this.setOld;
                CockpitAR_234C2.this.setOld = CockpitAR_234C2.this.setNew;
                CockpitAR_234C2.this.setNew = CockpitAR_234C2.this.setTmp;
                CockpitAR_234C2.this.setNew.altimeter = CockpitAR_234C2.this.fm.getAltitude();
                CockpitAR_234C2.this.setNew.throttle1 = (0.92F * CockpitAR_234C2.this.setOld.throttle1) + (0.08F * CockpitAR_234C2.this.fm.EI.engines[0].getControlThrottle());
                CockpitAR_234C2.this.setNew.throttle2 = (0.92F * CockpitAR_234C2.this.setOld.throttle2) + (0.08F * CockpitAR_234C2.this.fm.EI.engines[1].getControlThrottle());
                CockpitAR_234C2.this.setNew.vspeed = ((499F * CockpitAR_234C2.this.setOld.vspeed) + CockpitAR_234C2.this.fm.getVertSpeed()) / 500F;
                float f = CockpitAR_234C2.this.waypointAzimuth();
                if (CockpitAR_234C2.this.useRealisticNavigationInstruments()) {
                    CockpitAR_234C2.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitAR_234C2.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitAR_234C2.this.setNew.waypointAzimuth.setDeg(CockpitAR_234C2.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitAR_234C2.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitAR_234C2.this.fm.Or.getKren()) < 30F) {
                    CockpitAR_234C2.this.setNew.azimuth.setDeg(CockpitAR_234C2.this.setOld.azimuth.getDeg(1.0F), CockpitAR_234C2.this.fm.Or.azimut());
                }
                CockpitAR_234C2.this.w.set(CockpitAR_234C2.this.fm.getW());
                CockpitAR_234C2.this.fm.Or.transform(CockpitAR_234C2.this.w);
                CockpitAR_234C2.this.setNew.turn = ((12F * CockpitAR_234C2.this.setOld.turn) + CockpitAR_234C2.this.w.z) / 13F;
                CockpitAR_234C2.this.setNew.beaconDirection = ((10F * CockpitAR_234C2.this.setOld.beaconDirection) + CockpitAR_234C2.this.getBeaconDirection()) / 11F;
                CockpitAR_234C2.this.setNew.beaconRange = ((10F * CockpitAR_234C2.this.setOld.beaconRange) + CockpitAR_234C2.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zAltWheel", 0.0F, this.cvt(((AR_234C2) this.aircraft()).fSightCurAltitude, 0.0F, 6000F, 0.0F, 225F), 0.0F);
        this.mesh.chunkSetAngles("zAnglePointer", 0.0F, this.cvt(((AR_234C2) this.aircraft()).fSightCurForwardAngle, 0.0F, 60F, 105F, 0.0F), 0.0F);
        this.mesh.chunkSetAngles("zAngleWheel", 0.0F, -10F * ((AR_234C2) this.aircraft()).fSightCurForwardAngle, 0.0F);
        this.mesh.chunkSetAngles("zSpeedPointer", 0.0F, this.cvt(((AR_234C2) this.aircraft()).fSightCurSpeed, 150F, 600F, 0.0F, 60F), 0.0F);
        this.mesh.chunkSetAngles("zSpeedWheel", 0.0F, 0.333F * ((AR_234C2) this.aircraft()).fSightCurSpeed, 0.0F);
        ...
        this.mesh.chunkSetAngles("zSpeed1a", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitAR_234C2.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM1", 22.5F + this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitAR_234C2.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM2", 22.5F + this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitAR_234C2.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zVariometer1a", this.setNew.vspeed >= 0.0F ? this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitAR_234C2.vsiNeedleScale) : -this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitAR_234C2.vsiNeedleScale), 0.0F, 0.0F);
