...
public class CockpitAT6 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitAT6.this.fm != null) {
                CockpitAT6.this.setTmp = CockpitAT6.this.setOld;
                CockpitAT6.this.setOld = CockpitAT6.this.setNew;
                CockpitAT6.this.setNew = CockpitAT6.this.setTmp;
                CockpitAT6.this.setNew.flaps = (0.9F * CockpitAT6.this.setOld.flaps) + (0.1F * CockpitAT6.this.fm.CT.FlapsControl);
                CockpitAT6.this.setNew.gear = (0.7F * CockpitAT6.this.setOld.gear) + (0.3F * CockpitAT6.this.fm.CT.GearControl);
                CockpitAT6.this.setNew.throttle = (0.8F * CockpitAT6.this.setOld.throttle) + (0.2F * CockpitAT6.this.fm.CT.PowerControl);
                CockpitAT6.this.setNew.prop = (0.8F * CockpitAT6.this.setOld.prop) + (0.2F * CockpitAT6.this.fm.EI.engines[0].getControlProp());
                CockpitAT6.this.setNew.mix = (0.8F * CockpitAT6.this.setOld.mix) + (0.2F * CockpitAT6.this.fm.EI.engines[0].getControlMix());
                CockpitAT6.this.setNew.divebrake = (0.8F * CockpitAT6.this.setOld.divebrake) + (0.2F * CockpitAT6.this.fm.CT.AirBrakeControl);
                CockpitAT6.this.setNew.man = (0.92F * CockpitAT6.this.setOld.man) + (0.08F * CockpitAT6.this.fm.EI.engines[0].getManifoldPressure());
                CockpitAT6.this.setNew.altimeter = CockpitAT6.this.fm.getAltitude();
                if (Math.abs(CockpitAT6.this.fm.Or.getKren()) < 30F) {
                    CockpitAT6.this.setNew.azimuth.setDeg(CockpitAT6.this.setOld.azimuth.getDeg(1.0F), CockpitAT6.this.fm.Or.azimut());
                }
                CockpitAT6.this.setNew.vspeed = ((399F * CockpitAT6.this.setOld.vspeed) + CockpitAT6.this.fm.getVertSpeed()) / 400F;
            }
            return true;
        }
    ...
    public CockpitAT6() {
        super("3DO/Cockpit/AT6/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 925.9998F, 0.0F, 10F), CockpitAT6.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.setNew.vspeed >= 0.0F ? -this.floatindex(this.cvt(this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitAT6.variometerScale) : this.floatindex(this.cvt(-this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitAT6.variometerScale), 0.0F);
