...
public class CockpitA_20C extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitA_20C.this.fm != null) {
                CockpitA_20C.this.setTmp = CockpitA_20C.this.setOld;
                CockpitA_20C.this.setOld = CockpitA_20C.this.setNew;
                CockpitA_20C.this.setNew = CockpitA_20C.this.setTmp;
                ...
                if (CockpitA_20C.this.useRealisticNavigationInstruments()) {
                    CockpitA_20C.this.setNew.waypointAzimuth.setDeg(CockpitA_20C.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitA_20C.this.getBeaconDirection());
                } else {
                    CockpitA_20C.this.setNew.waypointAzimuth.setDeg(CockpitA_20C.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitA_20C.this.waypointAzimuth() - CockpitA_20C.this.fm.Or.azimut());
                }
                if (Math.abs(CockpitA_20C.this.fm.Or.getKren()) < 30F) {
                    CockpitA_20C.this.setNew.azimuth.setDeg(CockpitA_20C.this.setOld.azimuth.getDeg(1.0F), CockpitA_20C.this.fm.Or.azimut());
                }
                CockpitA_20C.this.setNew.vspeed = ((199F * CockpitA_20C.this.setOld.vspeed) + CockpitA_20C.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitA_20C() {
        ...
        this.pictAiler = 0.0F;
        this.pictElev = 0.0F;
        this.cockpitNightMats = (new String[] { "256-10_Gauges6", "256-16_Gauges7", "256-5_Gauges1", "256-6_Gauges2", "256-7_Gauges3_DMG", "256-7_Gauges3", "256-8_Gauges4", "256-9_Gauges5_DMG", "256-9_Gauges5", "256-18", "256-21", "256-22", "128_Gauge_DF", "128_Gauge_DF_DMG" });
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 804.6721F, 0.0F, 10F), CockpitA_20C.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zFreeAir", 0.0F, this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 223.09F, 323.09F, 0.0F, 4F), CockpitA_20C.temperatureScale), 0.0F);
