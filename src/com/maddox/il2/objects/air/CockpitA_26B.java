...
public class CockpitA_26B extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitA_26B.this.fm != null) {
                CockpitA_26B.this.setTmp = CockpitA_26B.this.setOld;
                CockpitA_26B.this.setOld = CockpitA_26B.this.setNew;
                CockpitA_26B.this.setNew = CockpitA_26B.this.setTmp;
                CockpitA_26B.this.setNew.throttle1 = (0.85F * CockpitA_26B.this.setOld.throttle1) + (CockpitA_26B.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitA_26B.this.setNew.throttle2 = (0.85F * CockpitA_26B.this.setOld.throttle2) + (CockpitA_26B.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitA_26B.this.setNew.prop1 = (0.85F * CockpitA_26B.this.setOld.prop1) + (CockpitA_26B.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitA_26B.this.setNew.prop2 = (0.85F * CockpitA_26B.this.setOld.prop2) + (CockpitA_26B.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitA_26B.this.setNew.altimeter = CockpitA_26B.this.fm.getAltitude();
                float f = CockpitA_26B.this.waypointAzimuth();
                if (Math.abs(CockpitA_26B.this.fm.Or.getKren()) < 30F) {
                    CockpitA_26B.this.setNew.azimuth.setDeg(CockpitA_26B.this.setOld.azimuth.getDeg(1.0F), CockpitA_26B.this.fm.Or.azimut());
                }
                CockpitA_26B.this.setNew.waypointAzimuth.setDeg(CockpitA_26B.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                CockpitA_26B.this.setNew.radioCompassAzimuth.setDeg(CockpitA_26B.this.setOld.radioCompassAzimuth.getDeg(0.1F), f - CockpitA_26B.this.setOld.azimuth.getDeg(0.1F) - 90F);
                CockpitA_26B.this.setNew.vspeed = ((199F * CockpitA_26B.this.setOld.vspeed) + CockpitA_26B.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitA_26B() {
        super("3DO/Cockpit/A-26B/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitA_26B.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitA_26B.speedometerScale), 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            ...
            this.mesh.chunkSetAngles("Z_Pres1", 0.0F, this.pictManf1 = (0.9F * this.pictManf1) + (0.1F * this.cvt(this.fm.EI.engines[0].getManifoldPressure(), 0.338638F, 2.539784F, 0.0F, 346.5F)), 0.0F);
            this.mesh.chunkSetAngles("Z_Pres2", 0.0F, this.pictManf2 = (0.9F * this.pictManf2) + (0.1F * this.cvt(this.fm.EI.engines[1].getManifoldPressure(), 0.338638F, 2.539784F, 0.0F, 346.5F)), 0.0F);
        }
