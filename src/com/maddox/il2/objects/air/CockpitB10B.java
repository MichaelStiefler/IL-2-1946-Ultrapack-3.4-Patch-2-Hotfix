...
public class CockpitB10B extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitB10B.this.fm != null) {
                CockpitB10B.this.setTmp = CockpitB10B.this.setOld;
                CockpitB10B.this.setOld = CockpitB10B.this.setNew;
                CockpitB10B.this.setNew = CockpitB10B.this.setTmp;
                CockpitB10B.this.setNew.throttle1 = (0.9F * CockpitB10B.this.setOld.throttle1) + (0.1F * CockpitB10B.this.fm.EI.engines[0].getControlThrottle());
                CockpitB10B.this.setNew.prop1 = (0.9F * CockpitB10B.this.setOld.prop1) + (0.1F * CockpitB10B.this.fm.EI.engines[0].getControlProp());
                CockpitB10B.this.setNew.mix1 = (0.8F * CockpitB10B.this.setOld.mix1) + (0.2F * CockpitB10B.this.fm.EI.engines[0].getControlMix());
                CockpitB10B.this.setNew.throttle2 = (0.9F * CockpitB10B.this.setOld.throttle2) + (0.1F * CockpitB10B.this.fm.EI.engines[1].getControlThrottle());
                CockpitB10B.this.setNew.prop2 = (0.9F * CockpitB10B.this.setOld.prop2) + (0.1F * CockpitB10B.this.fm.EI.engines[1].getControlProp());
                CockpitB10B.this.setNew.mix2 = (0.8F * CockpitB10B.this.setOld.mix2) + (0.2F * CockpitB10B.this.fm.EI.engines[1].getControlMix());
                CockpitB10B.this.setNew.man1 = (0.92F * CockpitB10B.this.setOld.man1) + (0.08F * CockpitB10B.this.fm.EI.engines[0].getManifoldPressure());
                CockpitB10B.this.setNew.man2 = (0.92F * CockpitB10B.this.setOld.man2) + (0.08F * CockpitB10B.this.fm.EI.engines[1].getManifoldPressure());
                CockpitB10B.this.setNew.altimeter = CockpitB10B.this.fm.getAltitude();
                if (Math.abs(CockpitB10B.this.fm.Or.getKren()) < 30F) {
                    CockpitB10B.this.setNew.azimuth.setDeg(CockpitB10B.this.setOld.azimuth.getDeg(1.0F), CockpitB10B.this.fm.Or.azimut());
                }
                CockpitB10B.this.setNew.vspeed = ((199F * CockpitB10B.this.setOld.vspeed) + CockpitB10B.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitB10B() {
        super("3DO/Cockpit/B-10B-FRONT/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 804.6721F, 0.0F, 10F), CockpitB10B.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zFreeAir", 0.0F, this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 223.09F, 323.09F, 0.0F, 4F), CockpitB10B.temperatureScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Second1", 0.0F, this.cvt(((World.getTimeofDay() % 1.0F) * 60F) % 1.0F, 0.0F, 1.0F, 0.0F, 360F), 0.0F);
    ...
    private static final float temperatureScale[] = { -46F, 0.0F, 19.5F, 43F, 67F };
}
