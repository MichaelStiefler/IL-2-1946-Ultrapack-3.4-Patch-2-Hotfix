...
public class CockpitB17D extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitB17D.this.fm != null) {
                CockpitB17D.this.setTmp = CockpitB17D.this.setOld;
                CockpitB17D.this.setOld = CockpitB17D.this.setNew;
                CockpitB17D.this.setNew = CockpitB17D.this.setTmp;
                CockpitB17D.this.setNew.throttle1 = (0.85F * CockpitB17D.this.setOld.throttle1) + (CockpitB17D.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitB17D.this.setNew.throttle2 = (0.85F * CockpitB17D.this.setOld.throttle2) + (CockpitB17D.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitB17D.this.setNew.prop1 = (0.85F * CockpitB17D.this.setOld.prop1) + (CockpitB17D.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitB17D.this.setNew.prop2 = (0.85F * CockpitB17D.this.setOld.prop2) + (CockpitB17D.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitB17D.this.setNew.altimeter = CockpitB17D.this.fm.getAltitude();
                float f = CockpitB17D.this.waypointAzimuth();
                if (Math.abs(CockpitB17D.this.fm.Or.getKren()) < 30F) {
                    CockpitB17D.this.setNew.azimuth.setDeg(CockpitB17D.this.setOld.azimuth.getDeg(1.0F), CockpitB17D.this.fm.Or.azimut());
                }
                if (CockpitB17D.this.useRealisticNavigationInstruments()) {
                    CockpitB17D.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitB17D.this.setOld.waypointAzimuth.setDeg(f - 90F);
                    CockpitB17D.this.setNew.radioCompassAzimuth.setDeg(CockpitB17D.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitB17D.this.radioCompassAzimuthInvertMinus() - CockpitB17D.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    CockpitB17D.this.setNew.waypointAzimuth.setDeg(CockpitB17D.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                    CockpitB17D.this.setNew.radioCompassAzimuth.setDeg(CockpitB17D.this.setOld.radioCompassAzimuth.getDeg(0.1F), f - CockpitB17D.this.setOld.azimuth.getDeg(0.1F) - 90F);
                }
                if (CockpitB17D.this.b17D != null) {
                    CockpitB17D.this.setNew.PDI = CockpitB17D.this.b17D.fSightCurSideslip;
                }
                CockpitB17D.this.setNew.vspeed = ((199F * CockpitB17D.this.setOld.vspeed) + CockpitB17D.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitB17D() {
        ...
        if (this.aircraft() instanceof B_17D) {
            this.b17D = (B_17D) this.aircraft();
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitB17D.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitB17D.speedometerScale), 0.0F);
