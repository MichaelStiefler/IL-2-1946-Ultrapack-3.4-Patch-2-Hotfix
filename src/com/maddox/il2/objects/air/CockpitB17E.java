...
public class CockpitB17E extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitB17E.this.fm != null) {
                CockpitB17E.this.setTmp = CockpitB17E.this.setOld;
                CockpitB17E.this.setOld = CockpitB17E.this.setNew;
                CockpitB17E.this.setNew = CockpitB17E.this.setTmp;
                CockpitB17E.this.setNew.throttle1 = (0.85F * CockpitB17E.this.setOld.throttle1) + (CockpitB17E.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitB17E.this.setNew.throttle2 = (0.85F * CockpitB17E.this.setOld.throttle2) + (CockpitB17E.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitB17E.this.setNew.prop1 = (0.85F * CockpitB17E.this.setOld.prop1) + (CockpitB17E.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitB17E.this.setNew.prop2 = (0.85F * CockpitB17E.this.setOld.prop2) + (CockpitB17E.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitB17E.this.setNew.altimeter = CockpitB17E.this.fm.getAltitude();
                float f = CockpitB17E.this.waypointAzimuth();
                if (Math.abs(CockpitB17E.this.fm.Or.getKren()) < 30F) {
                    CockpitB17E.this.setNew.azimuth.setDeg(CockpitB17E.this.setOld.azimuth.getDeg(1.0F), CockpitB17E.this.fm.Or.azimut());
                }
                if (CockpitB17E.this.useRealisticNavigationInstruments()) {
                    CockpitB17E.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitB17E.this.setOld.waypointAzimuth.setDeg(f - 90F);
                    CockpitB17E.this.setNew.radioCompassAzimuth.setDeg(CockpitB17E.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitB17E.this.radioCompassAzimuthInvertMinus() - CockpitB17E.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    CockpitB17E.this.setNew.waypointAzimuth.setDeg(CockpitB17E.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                    CockpitB17E.this.setNew.radioCompassAzimuth.setDeg(CockpitB17E.this.setOld.radioCompassAzimuth.getDeg(0.1F), f - CockpitB17E.this.setOld.azimuth.getDeg(0.1F) - 90F);
                }
                if (CockpitB17E.this.b17E != null) {
                    CockpitB17E.this.setNew.PDI = CockpitB17E.this.b17E.fSightCurSideslip;
                }
                CockpitB17E.this.setNew.vspeed = ((199F * CockpitB17E.this.setOld.vspeed) + CockpitB17E.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitB17E() {
        super("3DO/Cockpit/B-25J/CockpitB17E.him", "bf109");
        ...
        if (this.aircraft() instanceof B_17E) {
            this.b17E = (B_17E) this.aircraft();
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitB17E.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitB17E.speedometerScale), 0.0F);
