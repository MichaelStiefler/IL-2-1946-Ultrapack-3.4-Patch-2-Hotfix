...
public class CockpitB17F extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitB17F.this.fm != null) {
                CockpitB17F.this.setTmp = CockpitB17F.this.setOld;
                CockpitB17F.this.setOld = CockpitB17F.this.setNew;
                CockpitB17F.this.setNew = CockpitB17F.this.setTmp;
                CockpitB17F.this.setNew.throttle1 = (0.85F * CockpitB17F.this.setOld.throttle1) + (CockpitB17F.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitB17F.this.setNew.throttle2 = (0.85F * CockpitB17F.this.setOld.throttle2) + (CockpitB17F.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitB17F.this.setNew.prop1 = (0.85F * CockpitB17F.this.setOld.prop1) + (CockpitB17F.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitB17F.this.setNew.prop2 = (0.85F * CockpitB17F.this.setOld.prop2) + (CockpitB17F.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitB17F.this.setNew.altimeter = CockpitB17F.this.fm.getAltitude();
                float f = CockpitB17F.this.waypointAzimuth();
                if (Math.abs(CockpitB17F.this.fm.Or.getKren()) < 30F) {
                    CockpitB17F.this.setNew.azimuth.setDeg(CockpitB17F.this.setOld.azimuth.getDeg(1.0F), CockpitB17F.this.fm.Or.azimut());
                }
                if (CockpitB17F.this.useRealisticNavigationInstruments()) {
                    CockpitB17F.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitB17F.this.setOld.waypointAzimuth.setDeg(f - 90F);
                    CockpitB17F.this.setNew.radioCompassAzimuth.setDeg(CockpitB17F.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitB17F.this.radioCompassAzimuthInvertMinus() - CockpitB17F.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    CockpitB17F.this.setNew.waypointAzimuth.setDeg(CockpitB17F.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                    CockpitB17F.this.setNew.radioCompassAzimuth.setDeg(CockpitB17F.this.setOld.radioCompassAzimuth.getDeg(0.1F), f - CockpitB17F.this.setOld.azimuth.getDeg(0.1F) - 90F);
                }
                if (CockpitB17F.this.b17F != null) {
                    CockpitB17F.this.setNew.PDI = CockpitB17F.this.b17F.fSightCurSideslip;
                }
                CockpitB17F.this.setNew.vspeed = ((199F * CockpitB17F.this.setOld.vspeed) + CockpitB17F.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitB17F() {
        ...
        if (this.aircraft() instanceof B_17F) {
            this.b17F = (B_17F) this.aircraft();
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitB17F.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitB17F.speedometerScale), 0.0F);
