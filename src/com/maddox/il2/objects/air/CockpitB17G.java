...
public class CockpitB17G extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitB17G.this.fm != null) {
                CockpitB17G.this.setTmp = CockpitB17G.this.setOld;
                CockpitB17G.this.setOld = CockpitB17G.this.setNew;
                CockpitB17G.this.setNew = CockpitB17G.this.setTmp;
                ...
                if (Math.abs(CockpitB17G.this.fm.Or.getKren()) < 30F) {
                    CockpitB17G.this.setNew.azimuth.setDeg(CockpitB17G.this.setOld.azimuth.getDeg(1.0F), CockpitB17G.this.fm.Or.azimut());
                }
                if (CockpitB17G.this.useRealisticNavigationInstruments()) {
                    CockpitB17G.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitB17G.this.setOld.waypointAzimuth.setDeg(f - 90F);
                    CockpitB17G.this.setNew.radioCompassAzimuth.setDeg(CockpitB17G.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitB17G.this.radioCompassAzimuthInvertMinus() - CockpitB17G.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    CockpitB17G.this.setNew.waypointAzimuth.setDeg(CockpitB17G.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                    CockpitB17G.this.setNew.radioCompassAzimuth.setDeg(CockpitB17G.this.setOld.radioCompassAzimuth.getDeg(0.1F), f - CockpitB17G.this.setOld.azimuth.getDeg(0.1F) - 90F);
                }
                if (CockpitB17G.this.b17G != null) {
                    CockpitB17G.this.setNew.PDI = CockpitB17G.this.b17G.fSightCurSideslip;
                }
                CockpitB17G.this.setNew.vspeed = ((199F * CockpitB17G.this.setOld.vspeed) + CockpitB17G.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitB17G() {
        ...
        if (this.aircraft() instanceof B_17G) {
            this.b17G = (B_17G) this.aircraft();
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitB17G.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitB17G.speedometerScale), 0.0F);
