...
public class CockpitB24D extends CockpitPilot {
        ...
        public boolean tick() {
            ...
            if (CockpitB24D.this.fm != null) {
                ...
                if ((CockpitB24D.this.flapsLever != 0.0F) && (CockpitB24D.this.flaps == CockpitB24D.this.fm.CT.getFlap())) {
                    ...
                    if (Math.abs(CockpitB24D.this.flapsLever) < 0.1F) {
                        CockpitB24D.this.flapsLever = 0.0F;
                    }
                    ...
                    if (CockpitB24D.this.flapsLever > f) {
                        CockpitB24D.this.flapsLever = f;
                    }
                } else if (CockpitB24D.this.flaps > CockpitB24D.this.fm.CT.getFlap()) {
                    CockpitB24D.this.flaps = CockpitB24D.this.fm.CT.getFlap();
                    CockpitB24D.this.flapsLever -= 2.0F;
                ...
                if ((CockpitB24D.this.gearsLever != 0.0F) && (CockpitB24D.this.gears == CockpitB24D.this.fm.CT.getGear())) {
                    ...
                    if (Math.abs(CockpitB24D.this.gearsLever) < 0.1F) {
                        CockpitB24D.this.gearsLever = 0.0F;
                    }
                    ...
                    if (CockpitB24D.this.gearsLever > f) {
                        CockpitB24D.this.gearsLever = f;
                    }
                } else if (CockpitB24D.this.gears > CockpitB24D.this.fm.CT.getGear()) {
                    CockpitB24D.this.gears = CockpitB24D.this.fm.CT.getGear();
                    CockpitB24D.this.gearsLever -= 2.0F;
                ...
                if (Math.abs(CockpitB24D.this.fm.Or.getKren()) < 30F) {
                ...
                for (int i = 0; i < 4; i++) {
                    ...
                    if (f2 < CockpitB24D.this.enginePrevRadiators[i]) {
                        CockpitB24D.this.engineRadiators[i] -= 0.2D;
                    } else if (f2 > CockpitB24D.this.enginePrevRadiators[i]) {
                        CockpitB24D.this.engineRadiators[i] += 0.2D;
                    } else {
                        CockpitB24D.this.engineRadiators[i] *= 0.5F;
                    }
                    if (CockpitB24D.this.engineRadiators[i] > 1.0F) {
                        CockpitB24D.this.engineRadiators[i] = 1.0F;
                    }
                    if (CockpitB24D.this.engineRadiators[i] < -1F) {
                        CockpitB24D.this.engineRadiators[i] = -1F;
                    }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zMixture1", this.floatindex(this.cvt(this.setNew.mix1, 0.0F, 1.2F, 0.0F, 3F), CockpitB24D.mixScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zMixture2", this.floatindex(this.cvt(this.setNew.mix2, 0.0F, 1.2F, 0.0F, 3F), CockpitB24D.mixScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zMixture3", this.floatindex(this.cvt(this.setNew.mix3, 0.0F, 1.2F, 0.0F, 3F), CockpitB24D.mixScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zMixture4", this.floatindex(this.cvt(this.setNew.mix4, 0.0F, 1.2F, 0.0F, 3F), CockpitB24D.mixScale), 0.0F, 0.0F);
        float f1 = 0.0F;
        ...
        for (int i = 0; i < 4; i++) {
            ...
            } else if ((this.fm.EI.engines[i].getStage() >= 4) && (this.fm.EI.engines[i].getStage() < 6)) {
                this.mesh.chunkSetAngles("zStarter" + (i + 1), 0.0F, 0.0F, 25F);
            } else {
                this.mesh.chunkSetAngles("zStarter" + (i + 1), 0.0F, 0.0F, 0.0F);
            }
            float f5 = this.fm.EI.engines[i].getRPM();
            if (((i < 2) && !this.dialsR1Dmg) || ((i > 1) && !this.dialsR2Dmg)) {
                this.mesh.chunkSetAngles("z_RPM" + (i + 1), 0.0F, -this.cvt(f5, 0.0F, 4500F, 0.0F, 323F), 0.0F);
            }
            if ((this.fm.Or.getKren() < -110F) || (this.fm.Or.getKren() > 110F)) {
                this.rpmGeneratedPressure[i] = this.rpmGeneratedPressure[i] - 2.0F;
            } else if (f5 < this.rpmGeneratedPressure[i]) {
                this.rpmGeneratedPressure[i] = this.rpmGeneratedPressure[i] - ((this.rpmGeneratedPressure[i] - f5) * 0.01F);
            } else {
                this.rpmGeneratedPressure[i] = this.rpmGeneratedPressure[i] + ((f5 - this.rpmGeneratedPressure[i]) * 0.001F);
            }
            if (this.rpmGeneratedPressure[i] < 800F) {
                this.oilPressure[i] = this.cvt(this.rpmGeneratedPressure[i], 0.0F, 800F, 0.0F, 4F);
            } else if (this.rpmGeneratedPressure[i] < 2000F) {
                this.oilPressure[i] = this.cvt(this.rpmGeneratedPressure[i], 800F, 2000F, 4F, 5F);
            } else {
                this.oilPressure[i] = this.cvt(this.rpmGeneratedPressure[i], 2000F, 3000F, 5F, 5.8F);
            }
            float f7 = 0.0F;
            if (this.fm.EI.engines[i].tOilIn > 90F) {
                f7 = this.cvt(this.fm.EI.engines[i].tOilIn, 90F, 110F, 1.1F, 1.5F);
            } else if (this.fm.EI.engines[i].tOilIn < 50F) {
                f7 = this.cvt(this.fm.EI.engines[i].tOilIn, 0.0F, 50F, 2.0F, 0.9F);
            } else {
                f7 = this.cvt(this.fm.EI.engines[i].tOilIn, 50F, 90F, 0.9F, 1.1F);
            }
            ...
            if (((i < 2) && !this.dialsR1Dmg) || ((i > 1) && !this.dialsR2Dmg)) {
                this.mesh.chunkSetAngles("z_FuelP" + (i + 1), 0.0F, -this.cvt(this.rpmGeneratedPressure[i], 0.0F, 2000F * f2, 0.0F, 200F), 0.0F);
            }
            if (((i > 1) && !this.dialsR1Dmg) || ((i < 2) && !this.dialsR2Dmg)) {
                this.mesh.chunkSetAngles("z_ECylT" + (i + 1), 0.0F, -this.cvt(this.fm.EI.engines[i].tWaterOut, 0.0F, 300F, 0.0F, 41F), 0.0F);
            }
            if (!this.dialsR1Dmg) {
                this.mesh.chunkSetAngles("z_OilT" + (i + 1), 0.0F, -this.cvt(this.fm.EI.engines[i].tOilIn, 30F, 150F, 0.0F, 41F), 0.0F);
            }
        ...
        if (!this.dialsL1Dmg) {
            ...
            this.mesh.chunkSetAngles("Z_MPH", 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 482.8F, 0.0F, 15F), CockpitB24D.speedometerScale), 0.0F);
            ...
            float f8 = this.floatindex(this.cvt(f6, 0.0F, 0.6666667F, 0.0F, 4F), CockpitB24D.pdiScale);
            float f10 = 1.0F;
            if (f4 > 0.0F) {
                f10 = -1F;
            }
        ...
        if (!this.dialsL2Dmg) {
            ...
            this.mesh.chunkSetAngles("Z_Climb", 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitB24D.variometerScale), 0.0F);
