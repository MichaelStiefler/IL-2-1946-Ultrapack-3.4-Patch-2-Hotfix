...
public class CockpitB25A_Late extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitB25A_Late.this.fm != null) {
                CockpitB25A_Late.this.setTmp = CockpitB25A_Late.this.setOld;
                CockpitB25A_Late.this.setOld = CockpitB25A_Late.this.setNew;
                CockpitB25A_Late.this.setNew = CockpitB25A_Late.this.setTmp;
                CockpitB25A_Late.this.setNew.throttle1 = (0.85F * CockpitB25A_Late.this.setOld.throttle1) + (CockpitB25A_Late.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitB25A_Late.this.setNew.throttle2 = (0.85F * CockpitB25A_Late.this.setOld.throttle2) + (CockpitB25A_Late.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitB25A_Late.this.setNew.prop1 = (0.85F * CockpitB25A_Late.this.setOld.prop1) + (CockpitB25A_Late.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitB25A_Late.this.setNew.prop2 = (0.85F * CockpitB25A_Late.this.setOld.prop2) + (CockpitB25A_Late.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitB25A_Late.this.setNew.altimeter = CockpitB25A_Late.this.fm.getAltitude();
                float f = CockpitB25A_Late.this.waypointAzimuth();
                if (Math.abs(CockpitB25A_Late.this.fm.Or.getKren()) < 30F) {
                    CockpitB25A_Late.this.setNew.azimuth.setDeg(CockpitB25A_Late.this.setOld.azimuth.getDeg(1.0F), CockpitB25A_Late.this.fm.Or.azimut());
                }
                CockpitB25A_Late.this.setNew.waypointAzimuth.setDeg(CockpitB25A_Late.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitB25A_Late.this.setNew.waypointDeviation.setDeg(CockpitB25A_Late.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitB25A_Late.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitB25A_Late.this.setNew.vspeed = ((199F * CockpitB25A_Late.this.setOld.vspeed) + CockpitB25A_Late.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitB25A_Late.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitB25A_Late.speedometerScale), 0.0F);
