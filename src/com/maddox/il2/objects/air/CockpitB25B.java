...
public class CockpitB25B extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitB25B.this.fm != null) {
                CockpitB25B.this.setTmp = CockpitB25B.this.setOld;
                CockpitB25B.this.setOld = CockpitB25B.this.setNew;
                CockpitB25B.this.setNew = CockpitB25B.this.setTmp;
                CockpitB25B.this.setNew.throttle1 = (0.85F * CockpitB25B.this.setOld.throttle1) + (CockpitB25B.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitB25B.this.setNew.throttle2 = (0.85F * CockpitB25B.this.setOld.throttle2) + (CockpitB25B.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitB25B.this.setNew.prop1 = (0.85F * CockpitB25B.this.setOld.prop1) + (CockpitB25B.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitB25B.this.setNew.prop2 = (0.85F * CockpitB25B.this.setOld.prop2) + (CockpitB25B.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitB25B.this.setNew.altimeter = CockpitB25B.this.fm.getAltitude();
                float f = CockpitB25B.this.waypointAzimuth();
                if (Math.abs(CockpitB25B.this.fm.Or.getKren()) < 30F) {
                    CockpitB25B.this.setNew.azimuth.setDeg(CockpitB25B.this.setOld.azimuth.getDeg(1.0F), CockpitB25B.this.fm.Or.azimut());
                }
                CockpitB25B.this.setNew.waypointAzimuth.setDeg(CockpitB25B.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitB25B.this.setNew.waypointDeviation.setDeg(CockpitB25B.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitB25B.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitB25B.this.setNew.vspeed = ((199F * CockpitB25B.this.setOld.vspeed) + CockpitB25B.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitB25B.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitB25B.speedometerScale), 0.0F);
