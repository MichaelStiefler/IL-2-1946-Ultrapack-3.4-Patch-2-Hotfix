...
public class CockpitB25BRaider extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitB25BRaider.this.fm != null) {
                CockpitB25BRaider.this.setTmp = CockpitB25BRaider.this.setOld;
                CockpitB25BRaider.this.setOld = CockpitB25BRaider.this.setNew;
                CockpitB25BRaider.this.setNew = CockpitB25BRaider.this.setTmp;
                CockpitB25BRaider.this.setNew.throttle1 = (0.85F * CockpitB25BRaider.this.setOld.throttle1) + (CockpitB25BRaider.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitB25BRaider.this.setNew.throttle2 = (0.85F * CockpitB25BRaider.this.setOld.throttle2) + (CockpitB25BRaider.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitB25BRaider.this.setNew.prop1 = (0.85F * CockpitB25BRaider.this.setOld.prop1) + (CockpitB25BRaider.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitB25BRaider.this.setNew.prop2 = (0.85F * CockpitB25BRaider.this.setOld.prop2) + (CockpitB25BRaider.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitB25BRaider.this.setNew.altimeter = CockpitB25BRaider.this.fm.getAltitude();
                float f = CockpitB25BRaider.this.waypointAzimuth();
                if (Math.abs(CockpitB25BRaider.this.fm.Or.getKren()) < 30F) {
                    CockpitB25BRaider.this.setNew.azimuth.setDeg(CockpitB25BRaider.this.setOld.azimuth.getDeg(1.0F), CockpitB25BRaider.this.fm.Or.azimut());
                }
                CockpitB25BRaider.this.setNew.waypointAzimuth.setDeg(CockpitB25BRaider.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitB25BRaider.this.setNew.waypointDeviation.setDeg(CockpitB25BRaider.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitB25BRaider.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitB25BRaider.this.setNew.vspeed = ((199F * CockpitB25BRaider.this.setOld.vspeed) + CockpitB25BRaider.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitB25BRaider.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitB25BRaider.speedometerScale), 0.0F);
