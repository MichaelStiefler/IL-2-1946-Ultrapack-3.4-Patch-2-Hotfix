...
public class CockpitB25D5 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitB25D5.this.fm != null) {
                CockpitB25D5.this.setTmp = CockpitB25D5.this.setOld;
                CockpitB25D5.this.setOld = CockpitB25D5.this.setNew;
                CockpitB25D5.this.setNew = CockpitB25D5.this.setTmp;
                CockpitB25D5.this.setNew.throttle1 = (0.85F * CockpitB25D5.this.setOld.throttle1) + (CockpitB25D5.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitB25D5.this.setNew.throttle2 = (0.85F * CockpitB25D5.this.setOld.throttle2) + (CockpitB25D5.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitB25D5.this.setNew.prop1 = (0.85F * CockpitB25D5.this.setOld.prop1) + (CockpitB25D5.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitB25D5.this.setNew.prop2 = (0.85F * CockpitB25D5.this.setOld.prop2) + (CockpitB25D5.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitB25D5.this.setNew.altimeter = CockpitB25D5.this.fm.getAltitude();
                float f = CockpitB25D5.this.waypointAzimuth();
                if (Math.abs(CockpitB25D5.this.fm.Or.getKren()) < 30F) {
                    CockpitB25D5.this.setNew.azimuth.setDeg(CockpitB25D5.this.setOld.azimuth.getDeg(1.0F), CockpitB25D5.this.fm.Or.azimut());
                }
                if (CockpitB25D5.this.useRealisticNavigationInstruments()) {
                    CockpitB25D5.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitB25D5.this.setOld.waypointAzimuth.setDeg(f - 90F);
                    CockpitB25D5.this.setNew.radioCompassAzimuth.setDeg(CockpitB25D5.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitB25D5.this.radioCompassAzimuthInvertMinus() - CockpitB25D5.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    CockpitB25D5.this.setNew.waypointAzimuth.setDeg(CockpitB25D5.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                    CockpitB25D5.this.setNew.radioCompassAzimuth.setDeg(CockpitB25D5.this.setOld.radioCompassAzimuth.getDeg(0.1F), f - CockpitB25D5.this.setOld.azimuth.getDeg(0.1F) - 90F);
                }
                if (CockpitB25D5.this.b25D5 != null) {
                    CockpitB25D5.this.setNew.PDI = CockpitB25D5.this.b25D5.fSightCurSideslip;
                }
                CockpitB25D5.this.setNew.vspeed = ((199F * CockpitB25D5.this.setOld.vspeed) + CockpitB25D5.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitB25D5() {
        ...
        if (this.aircraft() instanceof B_25D5) {
            this.b25D5 = (B_25D5) this.aircraft();
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitB25D5.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitB25D5.speedometerScale), 0.0F);
