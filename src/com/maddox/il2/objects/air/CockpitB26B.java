...
public class CockpitB26B extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitB26B.this.fm != null) {
                ...
                if (Math.abs(CockpitB26B.this.fm.Or.getKren()) < 30F) {
                ...
                if (CockpitB26B.this.B26B != null) {
                    CockpitB26B.this.setNew.PDI = CockpitB26B.this.B26B.fSightCurSideslip;
                }
    ...
    public CockpitB26B() {
        ...
        if (this.aircraft() instanceof B_26B) {
            this.B26B = (B_26B) this.aircraft();
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitB26B.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitB26B.speedometerScale), 0.0F);
