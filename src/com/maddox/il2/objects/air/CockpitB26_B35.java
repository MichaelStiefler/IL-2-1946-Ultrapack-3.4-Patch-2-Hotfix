...
public class CockpitB26_B35 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitB26_B35.this.fm != null) {
                CockpitB26_B35.this.setTmp = CockpitB26_B35.this.setOld;
                CockpitB26_B35.this.setOld = CockpitB26_B35.this.setNew;
                CockpitB26_B35.this.setNew = CockpitB26_B35.this.setTmp;
                CockpitB26_B35.this.setNew.throttle1 = (0.85F * CockpitB26_B35.this.setOld.throttle1) + (CockpitB26_B35.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitB26_B35.this.setNew.throttle2 = (0.85F * CockpitB26_B35.this.setOld.throttle2) + (CockpitB26_B35.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitB26_B35.this.setNew.prop1 = (0.85F * CockpitB26_B35.this.setOld.prop1) + (CockpitB26_B35.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitB26_B35.this.setNew.prop2 = (0.85F * CockpitB26_B35.this.setOld.prop2) + (CockpitB26_B35.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitB26_B35.this.setNew.altimeter = CockpitB26_B35.this.fm.getAltitude();
                float f = CockpitB26_B35.this.waypointAzimuth();
                if (Math.abs(CockpitB26_B35.this.fm.Or.getKren()) < 30F) {
                    CockpitB26_B35.this.setNew.azimuth.setDeg(CockpitB26_B35.this.setOld.azimuth.getDeg(1.0F), CockpitB26_B35.this.fm.Or.azimut());
                }
                CockpitB26_B35.this.setNew.waypointAzimuth.setDeg(CockpitB26_B35.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                CockpitB26_B35.this.setNew.radioCompassAzimuth.setDeg(CockpitB26_B35.this.setOld.radioCompassAzimuth.getDeg(0.1F), f - CockpitB26_B35.this.setOld.azimuth.getDeg(0.1F) - 90F);
                if (CockpitB26_B35.this.B26B35 != null) {
                    CockpitB26_B35.this.setNew.PDI = CockpitB26_B35.this.B26B35.fSightCurSideslip;
                }
                CockpitB26_B35.this.setNew.vspeed = ((199F * CockpitB26_B35.this.setOld.vspeed) + CockpitB26_B35.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitB26_B35() {
        super("3DO/Cockpit/B-26B35-P/hier.him", "bf109");
        ...
        if (this.aircraft() instanceof B_26B35) {
            this.B26B35 = (B_26B35) this.aircraft();
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitB26_B35.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitB26_B35.speedometerScale), 0.0F);
