...
public class CockpitB29 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitB29.this.fm != null) {
                CockpitB29.this.setTmp = CockpitB29.this.setOld;
                CockpitB29.this.setOld = CockpitB29.this.setNew;
                CockpitB29.this.setNew = CockpitB29.this.setTmp;
                CockpitB29.this.setNew.throttle1 = (0.85F * CockpitB29.this.setOld.throttle1) + (CockpitB29.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitB29.this.setNew.throttle2 = (0.85F * CockpitB29.this.setOld.throttle2) + (CockpitB29.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitB29.this.setNew.prop1 = (0.85F * CockpitB29.this.setOld.prop1) + (CockpitB29.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitB29.this.setNew.prop2 = (0.85F * CockpitB29.this.setOld.prop2) + (CockpitB29.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitB29.this.setNew.altimeter = CockpitB29.this.fm.getAltitude();
                float f = CockpitB29.this.waypointAzimuth();
                if (Math.abs(CockpitB29.this.fm.Or.getKren()) < 30F) {
                    CockpitB29.this.setNew.azimuth.setDeg(CockpitB29.this.setOld.azimuth.getDeg(1.0F), CockpitB29.this.fm.Or.azimut());
                }
                if (CockpitB29.this.useRealisticNavigationInstruments()) {
                    CockpitB29.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitB29.this.setOld.waypointAzimuth.setDeg(f - 90F);
                    CockpitB29.this.setNew.radioCompassAzimuth.setDeg(CockpitB29.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitB29.this.radioCompassAzimuthInvertMinus() - CockpitB29.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    CockpitB29.this.setNew.waypointAzimuth.setDeg(CockpitB29.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                    CockpitB29.this.setNew.radioCompassAzimuth.setDeg(CockpitB29.this.setOld.radioCompassAzimuth.getDeg(0.1F), f - CockpitB29.this.setOld.azimuth.getDeg(0.1F) - 90F);
                }
                if (CockpitB29.this.b29 != null) {
                    CockpitB29.this.setNew.PDI = CockpitB29.this.b29.fSightCurSideslip;
                }
                CockpitB29.this.setNew.vspeed = ((199F * CockpitB29.this.setOld.vspeed) + CockpitB29.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
...
//        pictGear = 0.0F;
        ...
        if (this.aircraft() instanceof B_29) {
            this.b29 = (B_29) this.aircraft();
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitB29.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitB29.speedometerScale), 0.0F);
