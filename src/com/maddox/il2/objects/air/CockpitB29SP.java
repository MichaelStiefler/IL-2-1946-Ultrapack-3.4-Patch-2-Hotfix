...
public class CockpitB29SP extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitB29SP.this.fm != null) {
                CockpitB29SP.this.setTmp = CockpitB29SP.this.setOld;
                CockpitB29SP.this.setOld = CockpitB29SP.this.setNew;
                CockpitB29SP.this.setNew = CockpitB29SP.this.setTmp;
                CockpitB29SP.this.setNew.throttle1 = (0.85F * CockpitB29SP.this.setOld.throttle1) + (CockpitB29SP.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitB29SP.this.setNew.throttle2 = (0.85F * CockpitB29SP.this.setOld.throttle2) + (CockpitB29SP.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitB29SP.this.setNew.prop1 = (0.85F * CockpitB29SP.this.setOld.prop1) + (CockpitB29SP.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitB29SP.this.setNew.prop2 = (0.85F * CockpitB29SP.this.setOld.prop2) + (CockpitB29SP.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitB29SP.this.setNew.altimeter = CockpitB29SP.this.fm.getAltitude();
                float f = CockpitB29SP.this.waypointAzimuth();
                if (Math.abs(CockpitB29SP.this.fm.Or.getKren()) < 30F) {
                    CockpitB29SP.this.setNew.azimuth.setDeg(CockpitB29SP.this.setOld.azimuth.getDeg(1.0F), CockpitB29SP.this.fm.Or.azimut());
                }
                if (CockpitB29SP.this.useRealisticNavigationInstruments()) {
                    CockpitB29SP.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitB29SP.this.setOld.waypointAzimuth.setDeg(f - 90F);
                    CockpitB29SP.this.setNew.radioCompassAzimuth.setDeg(CockpitB29SP.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitB29SP.this.radioCompassAzimuthInvertMinus() - CockpitB29SP.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    CockpitB29SP.this.setNew.waypointAzimuth.setDeg(CockpitB29SP.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                    CockpitB29SP.this.setNew.radioCompassAzimuth.setDeg(CockpitB29SP.this.setOld.radioCompassAzimuth.getDeg(0.1F), f - CockpitB29SP.this.setOld.azimuth.getDeg(0.1F) - 90F);
                }
                if (CockpitB29SP.this.b29SP != null) {
                    CockpitB29SP.this.setNew.PDI = CockpitB29SP.this.b29SP.fSightCurSideslip;
                }
                CockpitB29SP.this.setNew.vspeed = ((199F * CockpitB29SP.this.setOld.vspeed) + CockpitB29SP.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitB29SP() {
        super("3DO/Cockpit/B-29/CockpitB29.him", "bf109");
...
//        pictGear = 0.0F;
        ...
        if (this.aircraft() instanceof B_29SP) {
            this.b29SP = (B_29SP) this.aircraft();
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitB29SP.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitB29SP.speedometerScale), 0.0F);
