...
public class CockpitB339 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitB339.this.fm != null) {
                CockpitB339.this.setTmp = CockpitB339.this.setOld;
                CockpitB339.this.setOld = CockpitB339.this.setNew;
                CockpitB339.this.setNew = CockpitB339.this.setTmp;
                CockpitB339.this.setNew.throttle = ((10F * CockpitB339.this.setOld.throttle) + CockpitB339.this.fm.CT.PowerControl) / 11F;
                CockpitB339.this.setNew.altimeter = CockpitB339.this.fm.getAltitude();
                CockpitB339.this.setNew.waypointAzimuth.setDeg(CockpitB339.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitB339.this.waypointAzimuth() - CockpitB339.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitB339.this.fm.Or.getKren()) < 30F) {
                    CockpitB339.this.setNew.azimuth.setDeg(CockpitB339.this.setOld.azimuth.getDeg(1.0F), CockpitB339.this.fm.Or.azimut());
                }
                CockpitB339.this.setNew.vspeed = ((199F * CockpitB339.this.setOld.vspeed) + CockpitB339.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 981.5598F, 0.0F, 53F), CockpitB339.speedometerScale), 0.0F, 0.0F);
