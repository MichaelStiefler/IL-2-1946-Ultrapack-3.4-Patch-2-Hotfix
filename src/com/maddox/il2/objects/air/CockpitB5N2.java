...
public class CockpitB5N2 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitB5N2.this.fm != null) {
                ...
                if (Math.abs(CockpitB5N2.this.fm.Or.getKren()) < 30F) {
                ...
                if (CockpitB5N2.this.gearLightsDamaged && (Math.random() > 0.5D)) {
                    CockpitB5N2.this.flickerLight = !CockpitB5N2.this.flickerLight;
                }
                ...
                if (CockpitB5N2.this.amountOfBombs == 1) {
                    if (!CockpitB5N2.this.bombs[0].haveBullets()) {
                        CockpitB5N2.this.bombLever2 = 1.0F;
                    }
                } else if (CockpitB5N2.this.amountOfBombs == 3) {
                    if (!CockpitB5N2.this.bombs[1].haveBullets()) {
                        CockpitB5N2.this.bombLever1 = 1.0F;
                    }
                    if (!CockpitB5N2.this.bombs[2].haveBullets()) {
                        CockpitB5N2.this.bombLever2 = 1.0F;
                    }
                    if (!CockpitB5N2.this.bombs[3].haveBullets()) {
                        CockpitB5N2.this.bombLever3 = 1.0F;
                    }
                } else if (CockpitB5N2.this.amountOfBombs == 6) {
                    if (!CockpitB5N2.this.bombs[4].haveBullets()) {
                        CockpitB5N2.this.bombLever1 = 0.5F;
                    }
                    if (!CockpitB5N2.this.bombs[5].haveBullets()) {
                        CockpitB5N2.this.bombLever1 = 1.0F;
                    }
                    if (!CockpitB5N2.this.bombs[6].haveBullets()) {
                        CockpitB5N2.this.bombLever2 = 0.5F;
                    }
                    if (!CockpitB5N2.this.bombs[7].haveBullets()) {
                        CockpitB5N2.this.bombLever2 = 1.0F;
                    }
                    if (!CockpitB5N2.this.bombs[8].haveBullets()) {
                        CockpitB5N2.this.bombLever3 = 0.5F;
                    }
                    if (!CockpitB5N2.this.bombs[9].haveBullets()) {
                        CockpitB5N2.this.bombLever3 = 1.0F;
                    }
                }
                if (CockpitB5N2.this.amountOfBombs != 0) {
                    if (CockpitB5N2.this.bombLever1cur < CockpitB5N2.this.bombLever1) {
                        CockpitB5N2.this.bombLever1cur += 0.1F;
                    }
                    if (CockpitB5N2.this.bombLever2cur < CockpitB5N2.this.bombLever2) {
                        CockpitB5N2.this.bombLever2cur += 0.1F;
                    }
                    if (CockpitB5N2.this.bombLever3cur < CockpitB5N2.this.bombLever3) {
                        CockpitB5N2.this.bombLever3cur += 0.1F;
                    }
                    if ((CockpitB5N2.this.bombLever1cur == 1.0F) && (CockpitB5N2.this.bombLever2cur == 1.0F) && (CockpitB5N2.this.bombLever3cur == 1.0F)) {
                        CockpitB5N2.this.amountOfBombs = 0;
                    }
                }
            }
            return true;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Need_airspeed", 0.0F, this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 30F), CockpitB5N2.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Need_oiltemp", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilIn, 30F, 110F, 0.0F, 8F), CockpitB5N2.oilTempScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Need_Cylheadtemp", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 350F, 0.0F, 3F), CockpitB5N2.waterTempScale), 0.0F);
