...
public class CockpitB6N2 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitB6N2.this.fm != null) {
                CockpitB6N2.this.setTmp = CockpitB6N2.this.setOld;
                CockpitB6N2.this.setOld = CockpitB6N2.this.setNew;
                CockpitB6N2.this.setNew = CockpitB6N2.this.setTmp;
                CockpitB6N2.this.setNew.flap = (0.88F * CockpitB6N2.this.setOld.flap) + (0.12F * CockpitB6N2.this.fm.CT.FlapsControl);
                CockpitB6N2.this.setNew.tlock = (0.7F * CockpitB6N2.this.setOld.tlock) + (0.3F * (CockpitB6N2.this.fm.Gears.bTailwheelLocked ? 1.0F : 0.0F));
                if (CockpitB6N2.this.cockpitDimControl) {
                    if (CockpitB6N2.this.setNew.dimPosition > 0.0F) {
                        CockpitB6N2.this.setNew.dimPosition = CockpitB6N2.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitB6N2.this.setNew.dimPosition < 1.0F) {
                    CockpitB6N2.this.setNew.dimPosition = CockpitB6N2.this.setOld.dimPosition + 0.05F;
                }
                if ((CockpitB6N2.this.fm.CT.GearControl < 0.5F) && (CockpitB6N2.this.setNew.gear < 1.0F)) {
                    CockpitB6N2.this.setNew.gear = CockpitB6N2.this.setOld.gear + 0.02F;
                }
                if ((CockpitB6N2.this.fm.CT.GearControl > 0.5F) && (CockpitB6N2.this.setNew.gear > 0.0F)) {
                    CockpitB6N2.this.setNew.gear = CockpitB6N2.this.setOld.gear - 0.02F;
                }
                CockpitB6N2.this.setNew.throttle = (0.9F * CockpitB6N2.this.setOld.throttle) + (0.1F * CockpitB6N2.this.fm.CT.PowerControl);
                CockpitB6N2.this.setNew.manifold = (0.8F * CockpitB6N2.this.setOld.manifold) + (0.2F * CockpitB6N2.this.fm.EI.engines[0].getManifoldPressure());
                CockpitB6N2.this.setNew.pitch = (0.9F * CockpitB6N2.this.setOld.pitch) + (0.1F * CockpitB6N2.this.fm.EI.engines[0].getControlProp());
                CockpitB6N2.this.setNew.mix = (0.9F * CockpitB6N2.this.setOld.mix) + (0.1F * CockpitB6N2.this.fm.EI.engines[0].getControlMix());
                CockpitB6N2.this.setNew.altimeter = CockpitB6N2.this.fm.getAltitude();
                if (Math.abs(CockpitB6N2.this.fm.Or.getKren()) < 30F) {
                    CockpitB6N2.this.setNew.azimuth.setDeg(CockpitB6N2.this.setOld.azimuth.getDeg(1.0F), CockpitB6N2.this.fm.Or.azimut());
                }
                float f = CockpitB6N2.this.waypointAzimuth();
                CockpitB6N2.this.setNew.waypointAzimuth.setDeg(CockpitB6N2.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitB6N2.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-3F, 3F));
                CockpitB6N2.this.setNew.vspeed = ((199F * CockpitB6N2.this.setOld.vspeed) + CockpitB6N2.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedOilTemp", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 110F, 0.0F, 8F), CockpitB6N2.oilTScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedRPM", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitB6N2.revolutionsScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 740.7998F, 0.0F, 20F), CockpitB6N2.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedExternalT", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 233.09F, 333.09F, 0.0F, 5F), CockpitB6N2.frAirTempScale), 0.0F, 0.0F);
