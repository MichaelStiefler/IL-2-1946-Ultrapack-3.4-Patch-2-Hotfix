...
public class CockpitBEAU21 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitBEAU21.this.fm != null) {
                CockpitBEAU21.this.setTmp = CockpitBEAU21.this.setOld;
                CockpitBEAU21.this.setOld = CockpitBEAU21.this.setNew;
                CockpitBEAU21.this.setNew = CockpitBEAU21.this.setTmp;
                ...
                if (Math.abs(CockpitBEAU21.this.fm.Or.getKren()) < 30F) {
                ...
                if (CockpitBEAU21.this.useRealisticNavigationInstruments()) {
                    ...
                    CockpitBEAU21.this.setNew.waypointAzimuth.setDeg(CockpitBEAU21.this.setOld.waypointAzimuth.getDeg(0.02F), CockpitBEAU21.this.radioCompassAzimuthInvertMinus() - CockpitBEAU21.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    ...
                    CockpitBEAU21.this.setNew.waypointAzimuth.setDeg(CockpitBEAU21.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitBEAU21.this.setOld.azimuth.getDeg(1.0F) - 90F);
                }
                if ((CockpitBEAU21.this.fm.AS.astateCockpitState & 0x40) == 0) {
                    CockpitBEAU21.this.setNew.vspeed = ((199F * CockpitBEAU21.this.setOld.vspeed) + CockpitBEAU21.this.fm.getVertSpeed()) / 200F;
                } else {
                    CockpitBEAU21.this.setNew.vspeed = ((1990F * CockpitBEAU21.this.setOld.vspeed) + CockpitBEAU21.this.fm.getVertSpeed()) / 2000F;
                }
                CockpitBEAU21.this.setNew.radioalt = (0.9F * CockpitBEAU21.this.setOld.radioalt) + (0.1F * ((CockpitBEAU21.this.fm.getAltitude() - Landscape.HQ_Air((float) CockpitBEAU21.this.fm.Loc.x, (float) CockpitBEAU21.this.fm.Loc.y)) + World.Rnd().nextFloat(-10F, 10F)));
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 143.0528F, 0.0F, 32F), CockpitBEAU21.speedometerScaleFAF), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitBEAU21.variometerScale), 0.0F);
        this.mesh.chunkSetAngles("Z_Compass1", 0.0F, -this.setNew.azimuth.getDeg(f), 0.0F);
        this.mesh.chunkSetAngles("Z_Compass2", 0.0F, this.setNew.waypointAzimuth.getDeg(f * 0.02F), 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 0.0F, 8F), CockpitBEAU21.rpmScale), 0.0F);
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 1000F, 5000F, 0.0F, 8F), CockpitBEAU21.rpmScale), 0.0F);
        } else {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 500F, 9800F, 0.0F, 8F), CockpitBEAU21.rpmScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Temp1", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilIn, 0.0F, 140F, 0.0F, 14F), CockpitBEAU21.radScale), 0.0F);
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Temp2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].tOilIn, 0.0F, 140F, 0.0F, 14F), CockpitBEAU21.radScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Approach", 0.0F, this.cvt(this.setNew.waypointDeviation.getDeg(f * 0.5F), -90F, 90F, -46.5F, 46.5F), 0.0F);
