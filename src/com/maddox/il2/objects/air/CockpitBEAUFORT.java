...
public class CockpitBEAUFORT extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitBEAUFORT.this.fm != null) {
                ...
                if (Math.abs(CockpitBEAUFORT.this.fm.Or.getKren()) < 30F) {
                ...
                if ((CockpitBEAUFORT.this.fm.AS.astateCockpitState & 0x40) == 0) {
                    CockpitBEAUFORT.this.setNew.vspeed = ((199F * CockpitBEAUFORT.this.setOld.vspeed) + CockpitBEAUFORT.this.fm.getVertSpeed()) / 200F;
                } else {
                    CockpitBEAUFORT.this.setNew.vspeed = ((1990F * CockpitBEAUFORT.this.setOld.vspeed) + CockpitBEAUFORT.this.fm.getVertSpeed()) / 2000F;
                }
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 180.0555F, 0.0F, 35F), CockpitBEAUFORT.speedometerScaleFAF), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitBEAUFORT.variometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1200F, 3500F, 0.0F, 8F), CockpitBEAUFORT.rpmScale), 0.0F);
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 1200F, 3500F, 0.0F, 8F), CockpitBEAUFORT.rpmScale), 0.0F);
        } else {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 600F, 7000F, 0.0F, 8F), CockpitBEAUFORT.rpmScale), 0.0F);
        }
