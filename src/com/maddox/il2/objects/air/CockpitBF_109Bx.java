...
public class CockpitBF_109Bx extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitBF_109Bx.this.cockpitDimControl) {
                if (CockpitBF_109Bx.this.setNew.dimPosition > 0.0F) {
                    CockpitBF_109Bx.this.setNew.dimPosition = CockpitBF_109Bx.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitBF_109Bx.this.setNew.dimPosition < 1.0F) {
                CockpitBF_109Bx.this.setNew.dimPosition = CockpitBF_109Bx.this.setOld.dimPosition + 0.05F;
            }
            ...
            CockpitBF_109Bx.this.setNew.waypointAzimuth.setDeg(CockpitBF_109Bx.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitBF_109Bx.this.waypointAzimuth() - CockpitBF_109Bx.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitBF_109Bx.this.fm.Or.getKren()) < 30F) {
                CockpitBF_109Bx.this.setNew.azimuth.setDeg(CockpitBF_109Bx.this.setOld.azimuth.getDeg(1.0F), CockpitBF_109Bx.this.fm.Or.azimut());
            }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) ((Tuple3d) ((FlightModelMain) this.fm).Loc).z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitBF_109Bx.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(((FlightModelMain) this.fm).EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitBF_109Bx.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(((FlightModelMain) this.fm).M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), CockpitBF_109Bx.fuelScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Column", (this.pictAiler = (0.85F * this.pictAiler) + (0.15F * ((FlightModelMain) this.fm).CT.AileronControl)) * 15F, 0.0F, (this.pictElev = (0.85F * this.pictElev) + (0.15F * ((FlightModelMain) this.fm).CT.ElevatorControl)) * 10F);
    ...
    public void reflectCockpitState() {
        ...
        if ((((FlightModelMain) this.fm).AS.astateCockpitState & 1) != 0) {
        ...
        if ((((FlightModelMain) this.fm).AS.astateCockpitState & 4) != 0) {
        ...
        if ((((FlightModelMain) this.fm).AS.astateCockpitState & 0x80) != 0) {
            if ((this.type == 0) || (this.type == 1)) {
        ...
        if ((((FlightModelMain) this.fm).AS.astateCockpitState & 0x10) != 0) {
    ...
    protected void reflectPlaneMats() {
        if (Actor.isValid(((Interpolate) this.fm).actor)) {
            if (((Interpolate) this.fm).actor instanceof BF_109B1) {
                this.type = 0;
            } else if (((Interpolate) this.fm).actor instanceof BF_109B2) {
                this.type = 1;
            } else if (((Interpolate) this.fm).actor instanceof BF_109C1) {
                this.type = 2;
            } else if (((Interpolate) this.fm).actor instanceof BF_109D1) {
                this.type = 3;
            } else if (((Interpolate) this.fm).actor instanceof BF_109D1L) {
                this.type = 4;
            }
            switch (this.type) {
                case 0:
