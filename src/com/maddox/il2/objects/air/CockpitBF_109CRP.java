...
public class CockpitBF_109CRP extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            CockpitBF_109CRP.this.setTmp = CockpitBF_109CRP.this.setOld;
            CockpitBF_109CRP.this.setOld = CockpitBF_109CRP.this.setNew;
            CockpitBF_109CRP.this.setNew = CockpitBF_109CRP.this.setTmp;
            CockpitBF_109CRP.this.checkAircraftFrameDamageState();
            CockpitBF_109CRP.this.setNew.altimeter = CockpitBF_109CRP.this.fm.getAltitude();
            if (CockpitBF_109CRP.this.cockpitDimControl) {
                if (CockpitBF_109CRP.this.setOld.dimPosition > 0.0F) {
                    CockpitBF_109CRP.this.setOld.dimPosition = CockpitBF_109CRP.this.setTmp.dimPosition - 0.05F;
                }
            } else if (CockpitBF_109CRP.this.setOld.dimPosition < 1.0F) {
                CockpitBF_109CRP.this.setOld.dimPosition = CockpitBF_109CRP.this.setTmp.dimPosition + 0.05F;
            }
            CockpitBF_109CRP.this.setOld.throttle = ((10F * CockpitBF_109CRP.this.setTmp.throttle) + CockpitBF_109CRP.this.fm.CT.PowerControl) / 11F;
            CockpitBF_109CRP.this.setOld.mix = ((8F * CockpitBF_109CRP.this.setTmp.mix) + CockpitBF_109CRP.this.fm.EI.engines[0].getControlMix()) / 9F;
            CockpitBF_109CRP.this.setNew.waypointAzimuth.setDeg(CockpitBF_109CRP.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitBF_109CRP.this.waypointAzimuth() - CockpitBF_109CRP.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitBF_109CRP.this.fm.Or.getKren()) < 30F) {
                CockpitBF_109CRP.this.setNew.azimuth.setDeg(CockpitBF_109CRP.this.setOld.azimuth.getDeg(1.0F), CockpitBF_109CRP.this.fm.Or.azimut());
            }
            CockpitBF_109CRP.this.buzzerFX((CockpitBF_109CRP.this.fm.CT.getGear() < 0.999999F) && (CockpitBF_109CRP.this.fm.CT.getFlap() > 0.0F));
            return true;
        }
    ...
    public CockpitBF_109CRP() {
        super("3do/cockpit/Bf-109CRP/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitBF_109CRP.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitBF_109CRP.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), CockpitBF_109CRP.fuelScale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitBF_109CRP.class, "normZN", 0.4F);
        Property.set(CockpitBF_109CRP.class, "gsZN", 0.4F);
    }
