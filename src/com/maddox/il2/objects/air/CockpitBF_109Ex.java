...
public class CockpitBF_109Ex extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitBF_109Ex.this.cockpitDimControl) {
                if (CockpitBF_109Ex.this.setNew.dimPosition > 0.0F) {
                    CockpitBF_109Ex.this.setNew.dimPosition = CockpitBF_109Ex.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitBF_109Ex.this.setNew.dimPosition < 1.0F) {
                CockpitBF_109Ex.this.setNew.dimPosition = CockpitBF_109Ex.this.setOld.dimPosition + 0.05F;
            }
            ...
            if (Math.abs(CockpitBF_109Ex.this.fm.Or.getKren()) < 30F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) ((Tuple3d) this.fm.Loc).z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitBF_109Ex.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitBF_109Ex.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), CockpitBF_109Ex.fuelScale), 0.0F, 0.0F);
        ...
        // TODO: +++ Compass Fix by SAS~Storebror +++
    ...
    protected void reflectPlaneMats() {
        if (Actor.isValid(this.fm.actor)) {
            if (this.fm.actor instanceof BF_109E4) {
                this.type = 0;
            } else if (this.fm.actor instanceof BF_109E4N) {
                this.type = 1;
            } else if ((this.fm.actor instanceof BF_109E7N) || (this.fm.actor instanceof BF_109E7)) {
                this.type = 2;
            } else if (this.fm.actor instanceof BF_109E1) {
                this.type = 3;
            } else if (this.fm.actor instanceof BF_109E3) {
                this.type = 4;
