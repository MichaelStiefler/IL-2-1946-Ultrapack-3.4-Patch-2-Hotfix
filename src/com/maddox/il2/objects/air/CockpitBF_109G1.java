...
public class CockpitBF_109G1 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitBF_109G1.this.cockpitDimControl) {
                if (CockpitBF_109G1.this.setNew.dimPosition > 0.0F) {
                    CockpitBF_109G1.this.setNew.dimPosition = CockpitBF_109G1.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitBF_109G1.this.setNew.dimPosition < 1.0F) {
                CockpitBF_109G1.this.setNew.dimPosition = CockpitBF_109G1.this.setOld.dimPosition + 0.05F;
            }
            ...
            if (CockpitBF_109G1.this.useRealisticNavigationInstruments()) {
                ...
                CockpitBF_109G1.this.setNew.waypointAzimuth.setDeg(CockpitBF_109G1.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitBF_109G1.this.setOld.azimuth.getDeg(1.0F));
            }
            if (Math.abs(CockpitBF_109G1.this.fm.Or.getKren()) < 30F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) ((Tuple3d) this.fm.Loc).z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitBF_109G1.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitBF_109G1.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), CockpitBF_109G1.fuelScale), 0.0F, 0.0F);
