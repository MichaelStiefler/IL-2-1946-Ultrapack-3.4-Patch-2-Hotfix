...
public class CockpitBF_109G10 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            CockpitBF_109G10.this.setTmp = CockpitBF_109G10.this.setOld;
            CockpitBF_109G10.this.setOld = CockpitBF_109G10.this.setNew;
            CockpitBF_109G10.this.setNew = CockpitBF_109G10.this.setTmp;
            ...
            CockpitBF_109G10.this.setNew.throttle = ((10F * CockpitBF_109G10.this.setOld.throttle) + CockpitBF_109G10.this.fm.CT.PowerControl) / 11F;
            CockpitBF_109G10.this.setNew.mix = ((8F * CockpitBF_109G10.this.setOld.mix) + CockpitBF_109G10.this.fm.EI.engines[0].getControlMix()) / 9F;
            float f = CockpitBF_109G10.this.waypointAzimuth();
            if (CockpitBF_109G10.this.useRealisticNavigationInstruments()) {
                CockpitBF_109G10.this.setNew.waypointAzimuth.setDeg(f - 90F);
                CockpitBF_109G10.this.setOld.waypointAzimuth.setDeg(f - 90F);
            } else {
            ...
            if (Math.abs(CockpitBF_109G10.this.fm.Or.getKren()) < 30F) {
            ...
            CockpitBF_109G10.this.setNew.turn = ((12F * CockpitBF_109G10.this.setOld.turn) + ((Tuple3f) CockpitBF_109G10.this.w).z) / 13F;
            CockpitBF_109G10.this.setNew.beaconDirection = ((10F * CockpitBF_109G10.this.setOld.beaconDirection) + CockpitBF_109G10.this.getBeaconDirection()) / 11F;
            CockpitBF_109G10.this.setNew.beaconRange = ((10F * CockpitBF_109G10.this.setOld.beaconRange) + CockpitBF_109G10.this.getBeaconRange()) / 11F;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) ((Tuple3d) this.fm.Loc).z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitBF_109G10.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitBF_109G10.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), CockpitBF_109G10.fuelScale), 0.0F, 0.0F);
