...
public class CockpitBF_109G14 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            CockpitBF_109G14.this.setTmp = CockpitBF_109G14.this.setOld;
            CockpitBF_109G14.this.setOld = CockpitBF_109G14.this.setNew;
            CockpitBF_109G14.this.setNew = CockpitBF_109G14.this.setTmp;
            CockpitBF_109G14.this.setNew.altimeter = CockpitBF_109G14.this.fm.getAltitude();
            if (CockpitBF_109G14.this.cockpitDimControl) {
                if (CockpitBF_109G14.this.setNew.dimPosition > 0.0F) {
                    CockpitBF_109G14.this.setNew.dimPosition = CockpitBF_109G14.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitBF_109G14.this.setNew.dimPosition < 1.0F) {
                CockpitBF_109G14.this.setNew.dimPosition = CockpitBF_109G14.this.setOld.dimPosition + 0.05F;
            }
            CockpitBF_109G14.this.setNew.throttle = ((10F * CockpitBF_109G14.this.setOld.throttle) + CockpitBF_109G14.this.fm.CT.PowerControl) / 11F;
            CockpitBF_109G14.this.setNew.mix = ((8F * CockpitBF_109G14.this.setOld.mix) + CockpitBF_109G14.this.fm.EI.engines[0].getControlMix()) / 9F;
            float f = CockpitBF_109G14.this.waypointAzimuth();
            if (CockpitBF_109G14.this.useRealisticNavigationInstruments()) {
                CockpitBF_109G14.this.setNew.waypointAzimuth.setDeg(f - 90F);
                CockpitBF_109G14.this.setOld.waypointAzimuth.setDeg(f - 90F);
            } else {
                CockpitBF_109G14.this.setNew.waypointAzimuth.setDeg(CockpitBF_109G14.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitBF_109G14.this.setOld.azimuth.getDeg(1.0F));
            }
            if (Math.abs(CockpitBF_109G14.this.fm.Or.getKren()) < 30F) {
                CockpitBF_109G14.this.setNew.azimuth.setDeg(CockpitBF_109G14.this.setOld.azimuth.getDeg(1.0F), CockpitBF_109G14.this.fm.Or.azimut());
            }
            CockpitBF_109G14.this.w.set(CockpitBF_109G14.this.fm.getW());
            CockpitBF_109G14.this.fm.Or.transform(CockpitBF_109G14.this.w);
            CockpitBF_109G14.this.setNew.turn = ((12F * CockpitBF_109G14.this.setOld.turn) + ((Tuple3f) CockpitBF_109G14.this.w).z) / 13F;
            CockpitBF_109G14.this.buzzerFX((CockpitBF_109G14.this.fm.CT.getGear() < 0.999999F) && (CockpitBF_109G14.this.fm.CT.getFlap() > 0.0F));
            CockpitBF_109G14.this.setNew.beaconDirection = ((10F * CockpitBF_109G14.this.setOld.beaconDirection) + CockpitBF_109G14.this.getBeaconDirection()) / 11F;
            CockpitBF_109G14.this.setNew.beaconRange = ((10F * CockpitBF_109G14.this.setOld.beaconRange) + CockpitBF_109G14.this.getBeaconRange()) / 11F;
            return true;
        }
    ...
    public CockpitBF_109G14() {
        super("3DO/Cockpit/Bf-109G-14/hier.him", "bf109");
        this.gun = new Gun[3];
        this.hasCanopy = true;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) ((Tuple3d) this.fm.Loc).z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitBF_109G14.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitBF_109G14.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), CockpitBF_109G14.fuelScale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitBF_109G14.class, "normZN", 0.5F);
        Property.set(CockpitBF_109G14.class, "gsZN", 0.5F);
    }
