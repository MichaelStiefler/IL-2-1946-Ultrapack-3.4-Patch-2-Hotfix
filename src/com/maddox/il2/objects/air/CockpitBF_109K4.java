...
public class CockpitBF_109K4 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            CockpitBF_109K4.this.setTmp = CockpitBF_109K4.this.setOld;
            CockpitBF_109K4.this.setOld = CockpitBF_109K4.this.setNew;
            CockpitBF_109K4.this.setNew = CockpitBF_109K4.this.setTmp;
            CockpitBF_109K4.this.setNew.altimeter = CockpitBF_109K4.this.fm.getAltitude();
            if (CockpitBF_109K4.this.cockpitDimControl) {
                if (CockpitBF_109K4.this.setNew.dimPosition > 0.0F) {
                    CockpitBF_109K4.this.setNew.dimPosition = CockpitBF_109K4.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitBF_109K4.this.setNew.dimPosition < 1.0F) {
                CockpitBF_109K4.this.setNew.dimPosition = CockpitBF_109K4.this.setOld.dimPosition + 0.05F;
            }
            CockpitBF_109K4.this.setNew.throttle = ((10F * CockpitBF_109K4.this.setOld.throttle) + CockpitBF_109K4.this.fm.CT.PowerControl) / 11F;
            CockpitBF_109K4.this.setNew.mix = ((8F * CockpitBF_109K4.this.setOld.mix) + CockpitBF_109K4.this.fm.EI.engines[0].getControlMix()) / 9F;
            float f = CockpitBF_109K4.this.waypointAzimuth();
            if (CockpitBF_109K4.this.useRealisticNavigationInstruments()) {
                CockpitBF_109K4.this.setNew.waypointAzimuth.setDeg(f - 90F);
                CockpitBF_109K4.this.setOld.waypointAzimuth.setDeg(f - 90F);
            } else {
                CockpitBF_109K4.this.setNew.waypointAzimuth.setDeg(CockpitBF_109K4.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitBF_109K4.this.setOld.azimuth.getDeg(1.0F));
            }
            if (Math.abs(CockpitBF_109K4.this.fm.Or.getKren()) < 30F) {
                CockpitBF_109K4.this.setNew.azimuth.setDeg(CockpitBF_109K4.this.setOld.azimuth.getDeg(1.0F), CockpitBF_109K4.this.fm.Or.azimut());
            }
            CockpitBF_109K4.this.w.set(CockpitBF_109K4.this.fm.getW());
            CockpitBF_109K4.this.fm.Or.transform(CockpitBF_109K4.this.w);
            CockpitBF_109K4.this.setNew.turn = ((12F * CockpitBF_109K4.this.setOld.turn) + ((Tuple3f) CockpitBF_109K4.this.w).z) / 13F;
            CockpitBF_109K4.this.setNew.vspeed = ((199F * CockpitBF_109K4.this.setOld.vspeed) + CockpitBF_109K4.this.fm.getVertSpeed()) / 200F;
            CockpitBF_109K4.this.buzzerFX((CockpitBF_109K4.this.fm.CT.getGear() < 0.999999F) && (CockpitBF_109K4.this.fm.CT.getFlap() > 0.0F));
            CockpitBF_109K4.this.setNew.beaconDirection = ((10F * CockpitBF_109K4.this.setOld.beaconDirection) + CockpitBF_109K4.this.getBeaconDirection()) / 11F;
            CockpitBF_109K4.this.setNew.beaconRange = ((10F * CockpitBF_109K4.this.setOld.beaconRange) + CockpitBF_109K4.this.getBeaconRange()) / 11F;
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) ((Tuple3d) this.fm.Loc).z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitBF_109K4.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitBF_109K4.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), CockpitBF_109K4.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_EngTemp1", 0.0F, this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 130F, 0.0F, 75F), 0.0F);
        this.mesh.chunkSetAngles("Z_EngTemp2", 0.0F, this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 130F, 0.0F, 75F), 0.0F);
        this.mesh.chunkSetAngles("Z_FuelPress1", this.cvt(this.fm.M.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 3F, 0.0F, 120F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_OilPress1", this.cvt(1.0F + (0.05F * this.fm.EI.engines[0].tOilOut), 0.0F, 15F, 0.0F, 120F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Variometr", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 12F), CockpitBF_109K4.variometerScale));
        ...
        this.mesh.chunkVisible("Z_GearHRed1", this.fm.CT.getGear() == 0.0F);
        ...
        this.mesh.chunkVisible("Z_GearHGreen1", this.fm.CT.getGear() == 1.0F);
        if (this.gun[0] != null) {
            this.mesh.chunkSetAngles("Z_AmmoCounter1", this.cvt(this.gun[0].countBullets(), 0.0F, 500F, 15F, 0.0F), 0.0F, 0.0F);
        }
        if (this.gun[2] != null) {
            this.mesh.chunkSetAngles("Z_AmmoCounter2", this.cvt(this.gun[2].countBullets(), 0.0F, 500F, 15F, 0.0F), 0.0F, 0.0F);
        }
    ...
    static {
        Property.set(CockpitBF_109K4.class, "normZN", 0.5F);
        Property.set(CockpitBF_109K4.class, "gsZN", 0.5F);
    }
