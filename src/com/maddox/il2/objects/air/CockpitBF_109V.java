...
public class CockpitBF_109V extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            CockpitBF_109V.this.setTmp = CockpitBF_109V.this.setOld;
            CockpitBF_109V.this.setOld = CockpitBF_109V.this.setNew;
            CockpitBF_109V.this.setNew = CockpitBF_109V.this.setTmp;
            CockpitBF_109V.this.checkAircraftFrameDamageState();
            CockpitBF_109V.this.setNew.altimeter = CockpitBF_109V.this.fm.getAltitude();
            if (CockpitBF_109V.this.cockpitDimControl) {
                if (CockpitBF_109V.this.setOld.dimPosition > 0.0F) {
                    CockpitBF_109V.this.setOld.dimPosition = CockpitBF_109V.this.setTmp.dimPosition - 0.05F;
                }
            } else if (CockpitBF_109V.this.setOld.dimPosition < 1.0F) {
                CockpitBF_109V.this.setOld.dimPosition = CockpitBF_109V.this.setTmp.dimPosition + 0.05F;
            }
            CockpitBF_109V.this.setOld.throttle = ((10F * CockpitBF_109V.this.setTmp.throttle) + CockpitBF_109V.this.fm.CT.PowerControl) / 11F;
            CockpitBF_109V.this.setOld.mix = ((8F * CockpitBF_109V.this.setTmp.mix) + CockpitBF_109V.this.fm.EI.engines[0].getControlMix()) / 9F;
            CockpitBF_109V.this.setNew.waypointAzimuth.setDeg(CockpitBF_109V.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitBF_109V.this.waypointAzimuth() - CockpitBF_109V.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitBF_109V.this.fm.Or.getKren()) < 30F) {
                CockpitBF_109V.this.setNew.azimuth.setDeg(CockpitBF_109V.this.setOld.azimuth.getDeg(1.0F), CockpitBF_109V.this.fm.Or.azimut());
            }
            CockpitBF_109V.this.buzzerFX((CockpitBF_109V.this.fm.CT.getGear() < 0.999999F) && (CockpitBF_109V.this.fm.CT.getFlap() > 0.0F));
            return true;
        }
    ...
    public CockpitBF_109V() {
        super("3do/cockpit/Bf-109V/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitBF_109V.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitBF_109V.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), CockpitBF_109V.fuelScale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitBF_109V.class, "normZN", 0.4F);
        Property.set(CockpitBF_109V.class, "gsZN", 0.4F);
    }
