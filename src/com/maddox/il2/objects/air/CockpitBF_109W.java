...
public class CockpitBF_109W extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            CockpitBF_109W.this.setNew.waypointAzimuth.setDeg(CockpitBF_109W.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitBF_109W.this.waypointAzimuth() - CockpitBF_109W.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitBF_109W.this.fm.Or.getKren()) < 30F) {
                CockpitBF_109W.this.setNew.azimuth.setDeg(CockpitBF_109W.this.setOld.azimuth.getDeg(1.0F), CockpitBF_109W.this.fm.Or.azimut());
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitBF_109W.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitBF_109W.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), CockpitBF_109W.fuelScale), 0.0F, 0.0F);
