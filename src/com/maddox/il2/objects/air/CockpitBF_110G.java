...
public class CockpitBF_110G extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            CockpitBF_110G.this.setTmp = CockpitBF_110G.this.setOld;
            CockpitBF_110G.this.setOld = CockpitBF_110G.this.setNew;
            CockpitBF_110G.this.setNew = CockpitBF_110G.this.setTmp;
            CockpitBF_110G.this.setNew.altimeter = CockpitBF_110G.this.fm.getAltitude();
            if (CockpitBF_110G.this.cockpitDimControl) {
                if (CockpitBF_110G.this.setNew.dimPosition > 0.0F) {
                    CockpitBF_110G.this.setNew.dimPosition = CockpitBF_110G.this.setNew.dimPosition - 0.05F;
                }
            } else if (CockpitBF_110G.this.setNew.dimPosition < 1.0F) {
                CockpitBF_110G.this.setNew.dimPosition = CockpitBF_110G.this.setNew.dimPosition + 0.05F;
            }
            ...
            if (CockpitBF_110G.this.useRealisticNavigationInstruments()) {
                CockpitBF_110G.this.setNew.waypointAzimuth.setDeg(f - 90F);
                CockpitBF_110G.this.setOld.waypointAzimuth.setDeg(f - 90F);
            } else {
            ...
            if (Math.abs(CockpitBF_110G.this.fm.Or.getKren()) < 30F) {
            ...
            CockpitBF_110G.this.setNew.turn = ((12F * CockpitBF_110G.this.setOld.turn) + CockpitBF_110G.this.w.z) / 13F;
            CockpitBF_110G.this.setNew.radioalt = (0.9F * CockpitBF_110G.this.setOld.radioalt) + (0.1F * (CockpitBF_110G.this.fm.getAltitude() - Landscape.HQ_Air((float) CockpitBF_110G.this.fm.Loc.x, (float) CockpitBF_110G.this.fm.Loc.y)));
            CockpitBF_110G.this.setNew.vspeed = ((199F * CockpitBF_110G.this.setOld.vspeed) + CockpitBF_110G.this.fm.getVertSpeed()) / 200F;
            CockpitBF_110G.this.setNew.beaconDirection = ((10F * CockpitBF_110G.this.setOld.beaconDirection) + CockpitBF_110G.this.getBeaconDirection()) / 11F;
            CockpitBF_110G.this.setNew.beaconRange = ((10F * CockpitBF_110G.this.setOld.beaconRange) + CockpitBF_110G.this.getBeaconRange()) / 11F;
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.useRealisticNavigationInstruments()) {
            ...
            this.mesh.chunkSetAngles("Z_Autopilot2", this.setNew.waypointAzimuth.getDeg(f * 0.1F), 0.0F, 0.0F);
        } else {
        ...
        this.mesh.chunkSetAngles("Z_TurnBank1", this.cvt(this.setNew.turn, -0.23562F, 0.23562F, 21F, -21F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 12F), CockpitBF_110G.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speed1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitBF_110G.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitBF_110G.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitBF_110G.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Oiltemp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 120F, 0.0F, 8F), CockpitBF_110G.oilTScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Oiltemp2", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 40F, 120F, 0.0F, 8F), CockpitBF_110G.oilTScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_AFN22", 0.0F, this.cvt(this.setNew.beaconDirection, -45F, 45F, -20F, 20F), 0.0F);
        this.mesh.chunkSetAngles("Z_AFN21", 0.0F, this.cvt(this.setNew.beaconRange, 0.0F, 1.0F, 20F, -20F), 0.0F);
