...
public class CockpitBF_110G4NJ extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if ((BF_110G4NJ) CockpitBF_110G4NJ.this.aircraft() == null) {

            }
            if (BF_110G4NJ.bChangedPit) {
                CockpitBF_110G4NJ.this.reflectPlaneToModel();
                if ((BF_110G4NJ) CockpitBF_110G4NJ.this.aircraft() == null) {

                }
                BF_110G4NJ.bChangedPit = false;
            }
            CockpitBF_110G4NJ.this.setTmp = CockpitBF_110G4NJ.this.setOld;
            CockpitBF_110G4NJ.this.setOld = CockpitBF_110G4NJ.this.setNew;
            CockpitBF_110G4NJ.this.setNew = CockpitBF_110G4NJ.this.setTmp;
            CockpitBF_110G4NJ.this.setNew.altimeter = CockpitBF_110G4NJ.this.fm.getAltitude();
            if (CockpitBF_110G4NJ.this.cockpitDimControl) {
                if (CockpitBF_110G4NJ.this.setNew.dimPosition > 0.0F) {
                    CockpitBF_110G4NJ.this.setNew.dimPosition = CockpitBF_110G4NJ.this.setNew.dimPosition - 0.05F;
                }
            } else if (CockpitBF_110G4NJ.this.setNew.dimPosition < 1.0F) {
                CockpitBF_110G4NJ.this.setNew.dimPosition = CockpitBF_110G4NJ.this.setNew.dimPosition + 0.05F;
            }
            CockpitBF_110G4NJ.this.setNew.throttle1 = (0.91F * CockpitBF_110G4NJ.this.setOld.throttle1) + (0.09F * CockpitBF_110G4NJ.this.fm.EI.engines[0].getControlThrottle());
            CockpitBF_110G4NJ.this.setNew.throttle2 = (0.91F * CockpitBF_110G4NJ.this.setOld.throttle2) + (0.09F * CockpitBF_110G4NJ.this.fm.EI.engines[1].getControlThrottle());
            CockpitBF_110G4NJ.this.setNew.mix1 = (0.88F * CockpitBF_110G4NJ.this.setOld.mix1) + (0.12F * CockpitBF_110G4NJ.this.fm.EI.engines[0].getControlMix());
            CockpitBF_110G4NJ.this.setNew.mix2 = (0.88F * CockpitBF_110G4NJ.this.setOld.mix2) + (0.12F * CockpitBF_110G4NJ.this.fm.EI.engines[1].getControlMix());
            CockpitBF_110G4NJ.this.setNew.waypointAzimuth.setDeg(CockpitBF_110G4NJ.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitBF_110G4NJ.this.waypointAzimuth() - CockpitBF_110G4NJ.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitBF_110G4NJ.this.fm.Or.getKren()) < 30F) {
                CockpitBF_110G4NJ.this.setNew.azimuth.setDeg(CockpitBF_110G4NJ.this.setOld.azimuth.getDeg(1.0F), CockpitBF_110G4NJ.this.fm.Or.azimut());
            }
            Variables variables = CockpitBF_110G4NJ.this.setNew;
            float f = 0.9F * CockpitBF_110G4NJ.this.setOld.radioalt;
            float f1 = 0.1F;
            float f2 = CockpitBF_110G4NJ.this.fm.getAltitude();
            World.cur();
            World.land();
            variables.radioalt = f + (f1 * (f2 - Landscape.HQ_Air((float) CockpitBF_110G4NJ.this.fm.Loc.x, (float) CockpitBF_110G4NJ.this.fm.Loc.y)));
            CockpitBF_110G4NJ.this.setNew.vspeed = ((199F * CockpitBF_110G4NJ.this.setOld.vspeed) + CockpitBF_110G4NJ.this.fm.getVertSpeed()) / 200F;
            return true;
        }
    ...
    public CockpitBF_110G4NJ() {
        super("3DO/Cockpit/Bf-110G4/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 12F), CockpitBF_110G4NJ.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speed1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitBF_110G4NJ.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitBF_110G4NJ.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitBF_110G4NJ.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Oiltemp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 120F, 0.0F, 8F), CockpitBF_110G4NJ.oilTScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Oiltemp2", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 40F, 120F, 0.0F, 8F), CockpitBF_110G4NJ.oilTScale), 0.0F, 0.0F);
    }
