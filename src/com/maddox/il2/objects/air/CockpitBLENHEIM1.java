...
public class CockpitBLENHEIM1 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitBLENHEIM1.this.fm != null) {
                CockpitBLENHEIM1.this.setTmp = CockpitBLENHEIM1.this.setOld;
                CockpitBLENHEIM1.this.setOld = CockpitBLENHEIM1.this.setNew;
                CockpitBLENHEIM1.this.setNew = CockpitBLENHEIM1.this.setTmp;
                CockpitBLENHEIM1.this.setNew.throttle1 = (0.85F * CockpitBLENHEIM1.this.setOld.throttle1) + (CockpitBLENHEIM1.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitBLENHEIM1.this.setNew.throttle2 = (0.85F * CockpitBLENHEIM1.this.setOld.throttle2) + (CockpitBLENHEIM1.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitBLENHEIM1.this.setNew.prop1 = (0.85F * CockpitBLENHEIM1.this.setOld.prop1) + (CockpitBLENHEIM1.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitBLENHEIM1.this.setNew.prop2 = (0.85F * CockpitBLENHEIM1.this.setOld.prop2) + (CockpitBLENHEIM1.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitBLENHEIM1.this.setNew.altimeter = CockpitBLENHEIM1.this.fm.getAltitude();
                if (Math.abs(CockpitBLENHEIM1.this.fm.Or.getKren()) < 30F) {
                    CockpitBLENHEIM1.this.setNew.azimuth.setDeg(CockpitBLENHEIM1.this.setOld.azimuth.getDeg(1.0F), CockpitBLENHEIM1.this.fm.Or.azimut());
                }
                if (CockpitBLENHEIM1.this.useRealisticNavigationInstruments()) {
                    CockpitBLENHEIM1.this.setNew.waypointDeviation.setDeg(CockpitBLENHEIM1.this.setOld.waypointDeviation.getDeg(0.1F), CockpitBLENHEIM1.this.getBeaconDirection());
                    CockpitBLENHEIM1.this.setNew.waypointAzimuth.setDeg(CockpitBLENHEIM1.this.setOld.waypointAzimuth.getDeg(0.02F), CockpitBLENHEIM1.this.radioCompassAzimuthInvertMinus() - CockpitBLENHEIM1.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    float f = CockpitBLENHEIM1.this.waypointAzimuth();
                    CockpitBLENHEIM1.this.setNew.waypointDeviation.setDeg(CockpitBLENHEIM1.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitBLENHEIM1.this.setOld.azimuth.getDeg(1.0F));
                    CockpitBLENHEIM1.this.setNew.waypointAzimuth.setDeg(CockpitBLENHEIM1.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitBLENHEIM1.this.setOld.azimuth.getDeg(1.0F) - 90F);
                }
                if ((CockpitBLENHEIM1.this.fm.AS.astateCockpitState & 0x40) == 0) {
                    CockpitBLENHEIM1.this.setNew.vspeed = ((199F * CockpitBLENHEIM1.this.setOld.vspeed) + CockpitBLENHEIM1.this.fm.getVertSpeed()) / 200F;
                } else {
                    CockpitBLENHEIM1.this.setNew.vspeed = ((1990F * CockpitBLENHEIM1.this.setOld.vspeed) + CockpitBLENHEIM1.this.fm.getVertSpeed()) / 2000F;
                }
            }
            return true;
        }
    ...
    public CockpitBLENHEIM1() {
        super("3DO/Cockpit/Blenheim/MKI.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 180.0555F, 0.0F, 35F), CockpitBLENHEIM1.speedometerScaleFAF), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitBLENHEIM1.variometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1200F, 3500F, 0.0F, 8F), CockpitBLENHEIM1.rpmScale), 0.0F);
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 1200F, 3500F, 0.0F, 8F), CockpitBLENHEIM1.rpmScale), 0.0F);
        } else {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 600F, 7000F, 0.0F, 8F), CockpitBLENHEIM1.rpmScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Fuel1", 0.0F, 0.0F, this.cvt(this.fm.M.fuel, 0.0F, 900F, 0.0F, 77F));
        this.mesh.chunkSetAngles("Z_Fuel2", 0.0F, 0.0F, this.cvt(this.fm.M.fuel, 0.0F, 900F, 0.0F, 77F));
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Oil1", 0.0F, this.cvt(this.fm.EI.engines[0].tOilIn, 49F, 101F, 0.0F, 274F), 0.0F);
        }
    ...
    private static final float speedometerScaleFAF[] = { 0.0F, 0.0F, 1.0F, 3F, 7.5F, 34.5F, 46F, 63F, 76F, 94F, 112.5F, 131F, 150F, 168.5F, 187F, 203F, 222F, 242.5F, 258.5F, 277F, 297F, 315.5F, 340F, 360F, 376.5F, 392F, 407F, 423.5F, 442F, 459F, 476F, 492.5F, 513F, 534.5F, 552F, 569.5F };
    ...
    static {
        Property.set(CockpitBLENHEIM1.class, "normZNs", new float[] { 0.75F, 0.75F, 0.75F, 0.75F });
    }
