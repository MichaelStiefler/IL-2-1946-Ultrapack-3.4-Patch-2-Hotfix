...
public class CockpitBLENHEIM1F extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitBLENHEIM1F.this.fm != null) {
                CockpitBLENHEIM1F.this.setTmp = CockpitBLENHEIM1F.this.setOld;
                CockpitBLENHEIM1F.this.setOld = CockpitBLENHEIM1F.this.setNew;
                CockpitBLENHEIM1F.this.setNew = CockpitBLENHEIM1F.this.setTmp;
                CockpitBLENHEIM1F.this.setNew.throttle1 = (0.85F * CockpitBLENHEIM1F.this.setOld.throttle1) + (CockpitBLENHEIM1F.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitBLENHEIM1F.this.setNew.throttle2 = (0.85F * CockpitBLENHEIM1F.this.setOld.throttle2) + (CockpitBLENHEIM1F.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitBLENHEIM1F.this.setNew.prop1 = (0.85F * CockpitBLENHEIM1F.this.setOld.prop1) + (CockpitBLENHEIM1F.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitBLENHEIM1F.this.setNew.prop2 = (0.85F * CockpitBLENHEIM1F.this.setOld.prop2) + (CockpitBLENHEIM1F.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitBLENHEIM1F.this.setNew.altimeter = CockpitBLENHEIM1F.this.fm.getAltitude();
                float f = CockpitBLENHEIM1F.this.waypointAzimuth();
                if (Math.abs(CockpitBLENHEIM1F.this.fm.Or.getKren()) < 30F) {
                    CockpitBLENHEIM1F.this.setNew.azimuth.setDeg(CockpitBLENHEIM1F.this.setOld.azimuth.getDeg(1.0F), CockpitBLENHEIM1F.this.fm.Or.azimut());
                }
                CockpitBLENHEIM1F.this.setNew.waypointAzimuth.setDeg(CockpitBLENHEIM1F.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitBLENHEIM1F.this.setNew.waypointDeviation.setDeg(CockpitBLENHEIM1F.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitBLENHEIM1F.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if ((CockpitBLENHEIM1F.this.fm.AS.astateCockpitState & 0x40) == 0) {
                    CockpitBLENHEIM1F.this.setNew.vspeed = ((199F * CockpitBLENHEIM1F.this.setOld.vspeed) + CockpitBLENHEIM1F.this.fm.getVertSpeed()) / 200F;
                } else {
                    CockpitBLENHEIM1F.this.setNew.vspeed = ((1990F * CockpitBLENHEIM1F.this.setOld.vspeed) + CockpitBLENHEIM1F.this.fm.getVertSpeed()) / 2000F;
                }
                World.land();
                CockpitBLENHEIM1F.this.setNew.radioalt = (0.9F * CockpitBLENHEIM1F.this.setOld.radioalt) + (0.1F * ((CockpitBLENHEIM1F.this.fm.getAltitude() - Landscape.HQ((float) CockpitBLENHEIM1F.this.fm.Loc.x, (float) CockpitBLENHEIM1F.this.fm.Loc.y)) + World.Rnd().nextFloat(-10F, 10F)));
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 143.0528F, 0.0F, 32F), CockpitBLENHEIM1F.speedometerScaleFAF), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitBLENHEIM1F.variometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 0.0F, 8F), CockpitBLENHEIM1F.rpmScale), 0.0F);
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 1000F, 5000F, 0.0F, 8F), CockpitBLENHEIM1F.rpmScale), 0.0F);
        } else {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 500F, 9800F, 0.0F, 8F), CockpitBLENHEIM1F.rpmScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Temp1", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilIn, 0.0F, 140F, 0.0F, 14F), CockpitBLENHEIM1F.radScale), 0.0F);
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Temp2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].tOilIn, 0.0F, 140F, 0.0F, 14F), CockpitBLENHEIM1F.radScale), 0.0F);
        }
