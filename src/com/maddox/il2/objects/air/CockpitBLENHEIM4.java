...
public class CockpitBLENHEIM4 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitBLENHEIM4.this.fm != null) {
                ...
                CockpitBLENHEIM4.this.setNew.throttle1 = (0.85F * CockpitBLENHEIM4.this.setOld.throttle1) + (CockpitBLENHEIM4.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitBLENHEIM4.this.setNew.throttle2 = (0.85F * CockpitBLENHEIM4.this.setOld.throttle2) + (CockpitBLENHEIM4.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitBLENHEIM4.this.setNew.prop1 = (0.85F * CockpitBLENHEIM4.this.setOld.prop1) + (CockpitBLENHEIM4.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitBLENHEIM4.this.setNew.prop2 = (0.85F * CockpitBLENHEIM4.this.setOld.prop2) + (CockpitBLENHEIM4.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitBLENHEIM4.this.setNew.altimeter = CockpitBLENHEIM4.this.fm.getAltitude();
                if (Math.abs(CockpitBLENHEIM4.this.fm.Or.getKren()) < 30F) {
                    CockpitBLENHEIM4.this.setNew.azimuth.setDeg(CockpitBLENHEIM4.this.setOld.azimuth.getDeg(1.0F), CockpitBLENHEIM4.this.fm.Or.azimut());
                }
                if (CockpitBLENHEIM4.this.useRealisticNavigationInstruments()) {
                    CockpitBLENHEIM4.this.setNew.waypointDeviation.setDeg(CockpitBLENHEIM4.this.setOld.waypointDeviation.getDeg(0.1F), CockpitBLENHEIM4.this.getBeaconDirection());
                    CockpitBLENHEIM4.this.setNew.waypointAzimuth.setDeg(CockpitBLENHEIM4.this.setOld.waypointAzimuth.getDeg(0.02F), CockpitBLENHEIM4.this.radioCompassAzimuthInvertMinus() - CockpitBLENHEIM4.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    float f = CockpitBLENHEIM4.this.waypointAzimuth();
                    CockpitBLENHEIM4.this.setNew.waypointDeviation.setDeg(CockpitBLENHEIM4.this.setOld.waypointDeviation.getDeg(0.1F), f - CockpitBLENHEIM4.this.setOld.azimuth.getDeg(1.0F));
                    CockpitBLENHEIM4.this.setNew.waypointAzimuth.setDeg(CockpitBLENHEIM4.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitBLENHEIM4.this.setOld.azimuth.getDeg(1.0F) - 90F);
                }
                if ((CockpitBLENHEIM4.this.fm.AS.astateCockpitState & 0x40) == 0) {
                    CockpitBLENHEIM4.this.setNew.vspeed = ((199F * CockpitBLENHEIM4.this.setOld.vspeed) + CockpitBLENHEIM4.this.fm.getVertSpeed()) / 200F;
                } else {
                    CockpitBLENHEIM4.this.setNew.vspeed = ((1990F * CockpitBLENHEIM4.this.setOld.vspeed) + CockpitBLENHEIM4.this.fm.getVertSpeed()) / 2000F;
                }
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 180.0555F, 0.0F, 35F), CockpitBLENHEIM4.speedometerScaleFAF), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitBLENHEIM4.variometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1200F, 3500F, 0.0F, 8F), CockpitBLENHEIM4.rpmScale), 0.0F);
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 1200F, 3500F, 0.0F, 8F), CockpitBLENHEIM4.rpmScale), 0.0F);
        } else {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 600F, 7000F, 0.0F, 8F), CockpitBLENHEIM4.rpmScale), 0.0F);
        }
    ...
    static {
        Property.set(CockpitBLENHEIM4.class, "normZNs", new float[] { 0.55F, 0.55F, 0.75F, 0.75F });
    }
