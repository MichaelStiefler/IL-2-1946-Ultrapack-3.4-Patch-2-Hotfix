...
public class CockpitBV_138B extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitBV_138B.this.fm != null) {
                CockpitBV_138B.this.setTmp = CockpitBV_138B.this.setOld;
                CockpitBV_138B.this.setOld = CockpitBV_138B.this.setNew;
                CockpitBV_138B.this.setNew = CockpitBV_138B.this.setTmp;
                CockpitBV_138B.this.setNew.throttle1 = (0.9F * CockpitBV_138B.this.setOld.throttle1) + (0.1F * CockpitBV_138B.this.fm.EI.engines[0].getControlThrottle());
                CockpitBV_138B.this.setNew.prop1 = (0.9F * CockpitBV_138B.this.setOld.prop1) + (0.1F * CockpitBV_138B.this.fm.EI.engines[0].getControlProp());
                CockpitBV_138B.this.setNew.mix1 = (0.8F * CockpitBV_138B.this.setOld.mix1) + (0.2F * CockpitBV_138B.this.fm.EI.engines[0].getControlMix());
                CockpitBV_138B.this.setNew.throttle2 = (0.9F * CockpitBV_138B.this.setOld.throttle2) + (0.1F * CockpitBV_138B.this.fm.EI.engines[1].getControlThrottle());
                CockpitBV_138B.this.setNew.prop2 = (0.9F * CockpitBV_138B.this.setOld.prop2) + (0.1F * CockpitBV_138B.this.fm.EI.engines[1].getControlProp());
                CockpitBV_138B.this.setNew.mix2 = (0.8F * CockpitBV_138B.this.setOld.mix2) + (0.2F * CockpitBV_138B.this.fm.EI.engines[1].getControlMix());
                CockpitBV_138B.this.setNew.man1 = (0.92F * CockpitBV_138B.this.setOld.man1) + (0.08F * CockpitBV_138B.this.fm.EI.engines[0].getManifoldPressure());
                CockpitBV_138B.this.setNew.man2 = (0.92F * CockpitBV_138B.this.setOld.man2) + (0.08F * CockpitBV_138B.this.fm.EI.engines[1].getManifoldPressure());
                CockpitBV_138B.this.setNew.altimeter = CockpitBV_138B.this.fm.getAltitude();
                if (Math.abs(CockpitBV_138B.this.fm.Or.getKren()) < 30F) {
                    CockpitBV_138B.this.setNew.azimuth.setDeg(CockpitBV_138B.this.setOld.azimuth.getDeg(1.0F), CockpitBV_138B.this.fm.Or.azimut());
                }
                CockpitBV_138B.this.setNew.vspeed = ((199F * CockpitBV_138B.this.setOld.vspeed) + CockpitBV_138B.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            this.aircraft().hierMesh().chunkVisible("Canopy", false);
    ...
    protected void doFocusLeave() {
        this.aircraft().hierMesh().chunkVisible("Canopy", true);
        this.aircraft().hierMesh().chunkVisible("Cockpit", true);
        this.aircraft().hierMesh().chunkVisible("CN_D0", true);
        super.doFocusLeave();
    }

    public CockpitBV_138B() {
        super("3DO/Cockpit/BV138B-P/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitBV_138B.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitBV_138B.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitBV_138B.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitBV_138B.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitBV_138B.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitBV_138B.rpmScale), 0.0F, 0.0F);
