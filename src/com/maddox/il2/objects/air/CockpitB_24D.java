...
public class CockpitB_24D extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitB_24D.this.fm != null) {
                CockpitB_24D.this.setTmp = CockpitB_24D.this.setOld;
                CockpitB_24D.this.setOld = CockpitB_24D.this.setNew;
                CockpitB_24D.this.setNew = CockpitB_24D.this.setTmp;
                CockpitB_24D.this.setNew.throttle1 = (0.85F * CockpitB_24D.this.setOld.throttle1) + (CockpitB_24D.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitB_24D.this.setNew.throttle2 = (0.85F * CockpitB_24D.this.setOld.throttle2) + (CockpitB_24D.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitB_24D.this.setNew.prop1 = (0.85F * CockpitB_24D.this.setOld.prop1) + (CockpitB_24D.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitB_24D.this.setNew.prop2 = (0.85F * CockpitB_24D.this.setOld.prop2) + (CockpitB_24D.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitB_24D.this.setNew.altimeter = CockpitB_24D.this.fm.getAltitude();
                float f = CockpitB_24D.this.waypointAzimuth();
                if (Math.abs(CockpitB_24D.this.fm.Or.getKren()) < 30F) {
                    CockpitB_24D.this.setNew.azimuth.setDeg(CockpitB_24D.this.setOld.azimuth.getDeg(1.0F), CockpitB_24D.this.fm.Or.azimut());
                }
                CockpitB_24D.this.setNew.waypointAzimuth.setDeg(CockpitB_24D.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitB_24D.this.setNew.waypointDeviation.setDeg(CockpitB_24D.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitB_24D.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitB_24D.this.setNew.vspeed = ((199F * CockpitB_24D.this.setOld.vspeed) + CockpitB_24D.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitB_24D() {
        super("3DO/Cockpit/B-24J/CockpitB24D.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitB_24D.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitB_24D.speedometerScale), 0.0F);
