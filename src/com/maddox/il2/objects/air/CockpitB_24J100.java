...
public class CockpitB_24J100 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitB_24J100.this.fm != null) {
                CockpitB_24J100.this.setTmp = CockpitB_24J100.this.setOld;
                CockpitB_24J100.this.setOld = CockpitB_24J100.this.setNew;
                CockpitB_24J100.this.setNew = CockpitB_24J100.this.setTmp;
                CockpitB_24J100.this.setNew.throttle1 = (0.85F * CockpitB_24J100.this.setOld.throttle1) + (CockpitB_24J100.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitB_24J100.this.setNew.throttle2 = (0.85F * CockpitB_24J100.this.setOld.throttle2) + (CockpitB_24J100.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitB_24J100.this.setNew.throttle3 = (0.85F * CockpitB_24J100.this.setOld.throttle3) + (CockpitB_24J100.this.fm.EI.engines[2].getControlThrottle() * 0.15F);
                CockpitB_24J100.this.setNew.throttle4 = (0.85F * CockpitB_24J100.this.setOld.throttle4) + (CockpitB_24J100.this.fm.EI.engines[3].getControlThrottle() * 0.15F);
                CockpitB_24J100.this.setNew.prop1 = (0.85F * CockpitB_24J100.this.setOld.prop1) + (CockpitB_24J100.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitB_24J100.this.setNew.prop2 = (0.85F * CockpitB_24J100.this.setOld.prop2) + (CockpitB_24J100.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitB_24J100.this.setNew.prop3 = (0.85F * CockpitB_24J100.this.setOld.prop3) + (CockpitB_24J100.this.fm.EI.engines[2].getControlProp() * 0.15F);
                CockpitB_24J100.this.setNew.prop4 = (0.85F * CockpitB_24J100.this.setOld.prop4) + (CockpitB_24J100.this.fm.EI.engines[3].getControlProp() * 0.15F);
                CockpitB_24J100.this.setNew.altimeter = CockpitB_24J100.this.fm.getAltitude();
                float f = CockpitB_24J100.this.waypointAzimuth();
                if (Math.abs(CockpitB_24J100.this.fm.Or.getKren()) < 30F) {
                    CockpitB_24J100.this.setNew.azimuth.setDeg(CockpitB_24J100.this.setOld.azimuth.getDeg(1.0F), CockpitB_24J100.this.fm.Or.azimut());
                }
                CockpitB_24J100.this.setNew.waypointAzimuth.setDeg(CockpitB_24J100.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitB_24J100.this.setNew.waypointDeviation.setDeg(CockpitB_24J100.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitB_24J100.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitB_24J100.this.setNew.vspeed = ((199F * CockpitB_24J100.this.setOld.vspeed) + CockpitB_24J100.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitB_24J100() {
        super("3DO/Cockpit/B-24J/CockpitB24J.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zPitch3", 0.0F, -54F * this.interp(this.setNew.prop3, this.setOld.prop3, f), 0.0F);
        this.mesh.chunkSetAngles("zPitch4", 0.0F, -54F * this.interp(this.setNew.prop4, this.setOld.prop4, f), 0.0F);
        ...
        this.mesh.chunkSetAngles("zThrottle3", 0.0F, -49F * this.interp(this.setNew.throttle3, this.setOld.throttle3, f), 0.0F);
        this.mesh.chunkSetAngles("zThrottle4", 0.0F, -49F * this.interp(this.setNew.throttle4, this.setOld.throttle4, f), 0.0F);
        ...
        this.mesh.chunkSetAngles("zCompressor3", 0.0F, this.cvt(this.fm.EI.engines[2].getControlCompressor(), 0.0F, 1.0F, 0.0F, -50F), 0.0F);
        this.mesh.chunkSetAngles("zCompressor4", 0.0F, this.cvt(this.fm.EI.engines[3].getControlCompressor(), 0.0F, 1.0F, 0.0F, -50F), 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitB_24J100.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitB_24J100.speedometerScale), 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            ...
            this.mesh.chunkSetAngles("Z_Pres3", 0.0F, this.pictManf3 = (0.9F * this.pictManf3) + (0.1F * this.cvt(this.fm.EI.engines[2].getManifoldPressure(), 0.3386378F, 2.539784F, 0.0F, 346.5F)), 0.0F);
            this.mesh.chunkSetAngles("Z_Pres4", 0.0F, this.pictManf4 = (0.9F * this.pictManf4) + (0.1F * this.cvt(this.fm.EI.engines[3].getManifoldPressure(), 0.3386378F, 2.539784F, 0.0F, 346.5F)), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_FuelPres3", 0.0F, this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.78F, 0.0F, 3.25F, 0.0F, 270F), 0.0F);
        this.mesh.chunkSetAngles("Z_FuelPres4", 0.0F, this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.78F, 0.0F, 3.25F, 0.0F, 270F), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Oilpres1", 0.0F, this.cvt(1.0F + (0.05F * this.fm.EI.engines[0].tOilOut * this.fm.EI.engines[0].getReadyness()), 0.0F, 13.49F, 0.0F, 270F), 0.0F);
        this.mesh.chunkSetAngles("Z_Oilpres2", 0.0F, this.cvt(1.0F + (0.05F * this.fm.EI.engines[1].tOilOut * this.fm.EI.engines[1].getReadyness()), 0.0F, 13.49F, 0.0F, 270F), 0.0F);
        this.mesh.chunkSetAngles("Z_Oilpres3", 0.0F, this.cvt(1.0F + (0.05F * this.fm.EI.engines[2].tOilOut * this.fm.EI.engines[2].getReadyness()), 0.0F, 13.49F, 0.0F, 270F), 0.0F);
        this.mesh.chunkSetAngles("Z_Oilpres4", 0.0F, this.cvt(1.0F + (0.05F * this.fm.EI.engines[3].tOilOut * this.fm.EI.engines[3].getReadyness()), 0.0F, 13.49F, 0.0F, 270F), 0.0F);
    ...
    public void reflectCockpitState() {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) != 0) {
            ...
            this.mesh.chunkVisible("Z_FuelPres3", false);
            this.mesh.chunkVisible("Z_FuelPres4", false);
            this.mesh.chunkVisible("Z_Oilpres1", false);
            this.mesh.chunkVisible("Z_Oilpres2", false);
            this.mesh.chunkVisible("Z_Oilpres3", false);
            this.mesh.chunkVisible("Z_Oilpres4", false);
