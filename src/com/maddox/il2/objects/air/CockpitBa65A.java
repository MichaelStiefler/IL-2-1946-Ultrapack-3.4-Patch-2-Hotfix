...
public class CockpitBa65A extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitBa65A.this.fm != null) {
                CockpitBa65A.this.setTmp = CockpitBa65A.this.setOld;
                CockpitBa65A.this.setOld = CockpitBa65A.this.setNew;
                CockpitBa65A.this.setNew = CockpitBa65A.this.setTmp;
                CockpitBa65A.this.setNew.throttle = (0.85F * CockpitBa65A.this.setOld.throttle) + (CockpitBa65A.this.fm.CT.PowerControl * 0.15F);
                CockpitBa65A.this.setNew.prop = (0.85F * CockpitBa65A.this.setOld.prop) + (CockpitBa65A.this.fm.CT.getStepControl() * 0.15F);
                CockpitBa65A.this.setNew.altimeter = CockpitBa65A.this.fm.getAltitude();
                float f = CockpitBa65A.this.waypointAzimuth();
                CockpitBa65A.this.setNew.waypointAzimuth.setDeg(CockpitBa65A.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitBa65A.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitBa65A.this.fm.Or.getKren()) < 30F) {
                    CockpitBa65A.this.setNew.azimuth.setDeg(CockpitBa65A.this.setOld.azimuth.getDeg(1.0F), CockpitBa65A.this.fm.Or.azimut());
                }
                CockpitBa65A.this.setNew.vspeed = ((199F * CockpitBa65A.this.setOld.vspeed) + CockpitBa65A.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitBa65A() {
        super("3DO/Cockpit/Ba65A/hier.him", "bf109");
        this.gun = new BulletEmitter[4];
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Throttle", 29.54F * this.interp(this.setNew.throttle, this.setOld.throttle, f), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_PropPitch1", 33.5F * this.interp(this.setNew.prop, this.setOld.prop, f), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 700F, 0.0F, 12F), CockpitBa65A.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_ManfoldPress", 0.0F, this.pictManf = (0.9F * this.pictManf) + (0.1F * this.cvt(this.fm.EI.engines[0].getManifoldPressure(), 0.5F, 2.0F, 0.0F, 300F)), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_EngTemp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 30F, 130F, 0.0F, 10F), CockpitBa65A.waterTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_OilTemp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 150F, 0.0F, 4F), CockpitBa65A.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_FuelPress1", this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.32F, 0.0F, 1.0F, 0.0F, -300F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", this.cvt(this.fm.M.fuel / this.fm.M.maxFuel, 0.0F, 1.0F, 0.0F, 244F), 0.0F, 0.0F);
        this.resetYPRmodifier();
