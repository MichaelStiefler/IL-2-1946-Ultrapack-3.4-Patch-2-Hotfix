...
public class CockpitBarracuda extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitBarracuda.this.bNeedSetUp) {
                CockpitBarracuda.this.reflectPlaneMats();
                CockpitBarracuda.this.bNeedSetUp = false;
            }
            if (CockpitBarracuda.this.fm != null) {
                CockpitBarracuda.this.setTmp = CockpitBarracuda.this.setOld;
                CockpitBarracuda.this.setOld = CockpitBarracuda.this.setNew;
                CockpitBarracuda.this.setNew = CockpitBarracuda.this.setTmp;
                CockpitBarracuda.this.setNew.throttle = ((10F * CockpitBarracuda.this.setOld.throttle) + CockpitBarracuda.this.fm.CT.PowerControl) / 11F;
                CockpitBarracuda.this.setNew.altimeter = CockpitBarracuda.this.fm.getAltitude();
                CockpitBarracuda.this.setNew.waypointAzimuth.setDeg(CockpitBarracuda.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitBarracuda.this.waypointAzimuth() - CockpitBarracuda.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitBarracuda.this.fm.Or.getKren()) < 30F) {
                    CockpitBarracuda.this.setNew.azimuth.setDeg(CockpitBarracuda.this.setOld.azimuth.getDeg(1.0F), CockpitBarracuda.this.fm.Or.azimut());
                }
                CockpitBarracuda.this.setNew.vspeed = ((199F * CockpitBarracuda.this.setOld.vspeed) + CockpitBarracuda.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitBarracuda() {
        super("3DO/Cockpit/Barracuda/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        Cockpit.xyz[1] = CommonTools.smoothCvt(this.fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.55F, 2);
...
// mesh.chunkSetLocate("FONAR_GLASS2", Cockpit.xyz, Cockpit.ypr);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitBarracuda.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 100F, 0.0F, 270F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitBarracuda.radScale));
        this.resetYPRmodifier();
        ...
        if (this.bFAF) {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 143.0528F, 0.0F, 32F), CockpitBarracuda.speedometerScaleFAF));
        } else {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 180.0555F, 0.0F, 35F), CockpitBarracuda.speedometerScale));
        }
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitBarracuda.variometerScale));
...
//        if ((this.fm.AS.astateCockpitState & 0x80) != 0);
    ...
    static {
        Property.set(CockpitBarracuda.class, "normZN", 0.40F); // 0.77F
    }
