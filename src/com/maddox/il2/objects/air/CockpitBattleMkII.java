...
public class CockpitBattleMkII extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitBattleMkII.this.fm != null) {
                CockpitBattleMkII.this.setTmp = CockpitBattleMkII.this.setOld;
                CockpitBattleMkII.this.setOld = CockpitBattleMkII.this.setNew;
                CockpitBattleMkII.this.setNew = CockpitBattleMkII.this.setTmp;
                CockpitBattleMkII.this.setNew.throttle = (0.92F * CockpitBattleMkII.this.setOld.throttle) + (0.08F * CockpitBattleMkII.this.fm.CT.PowerControl);
                CockpitBattleMkII.this.setNew.prop = (0.92F * CockpitBattleMkII.this.setOld.prop) + (0.08F * CockpitBattleMkII.this.fm.EI.engines[0].getControlProp());
                CockpitBattleMkII.this.setNew.mix = (0.92F * CockpitBattleMkII.this.setOld.mix) + (0.08F * CockpitBattleMkII.this.fm.EI.engines[0].getControlMix());
                CockpitBattleMkII.this.setNew.altimeter = CockpitBattleMkII.this.fm.getAltitude();
                CockpitBattleMkII.this.setNew.waypointAzimuth.setDeg(CockpitBattleMkII.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitBattleMkII.this.waypointAzimuth() - CockpitBattleMkII.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitBattleMkII.this.fm.Or.getKren()) < 30F) {
                    CockpitBattleMkII.this.setNew.azimuth.setDeg(CockpitBattleMkII.this.setOld.azimuth.getDeg(1.0F), CockpitBattleMkII.this.fm.Or.azimut());
                }
                CockpitBattleMkII.this.setNew.vspeed = (0.99F * CockpitBattleMkII.this.setOld.vspeed) + (0.01F * CockpitBattleMkII.this.fm.getVertSpeed());
                if (CockpitBattleMkII.this.fm.CT.GearControl < 0.5F) {
                    if (CockpitBattleMkII.this.setNew.gearPhi > 0.0F) {
                        CockpitBattleMkII.this.setNew.gearPhi = CockpitBattleMkII.this.setOld.gearPhi - 0.021F;
                    }
                } else if (CockpitBattleMkII.this.setNew.gearPhi < 1.0F) {
                    CockpitBattleMkII.this.setNew.gearPhi = CockpitBattleMkII.this.setOld.gearPhi + 0.021F;
                }
            }
            return true;
    ...
    public CockpitBattleMkII() {
        super("3DO/Cockpit/FaireyBattle/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        Cockpit.xyz[1] = CommonTools.smoothCvt(this.fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, 0.48F, 2);
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", -this.floatindex(this.cvt(Pitot.Indicator((float) ((Tuple3d) this.fm.Loc).z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 10F), CockpitBattleMkII.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_VY", -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitBattleMkII.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 5000F, 0.0F, 10F), CockpitBattleMkII.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, -306F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitBattleMkII.radScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STREL_TURN_DOWN", -this.cvt(((Tuple3f) this.w).z, -0.23562F, 0.23562F, -48F, 48F), 0.0F, 0.0F);
