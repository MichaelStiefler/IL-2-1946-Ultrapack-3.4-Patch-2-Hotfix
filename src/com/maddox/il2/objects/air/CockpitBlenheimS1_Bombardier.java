...
public class CockpitBlenheimS1_Bombardier extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitBlenheimS1_Bombardier.this.bEntered) {
                float f = ((BlenheimS1) CockpitBlenheimS1_Bombardier.this.aircraft()).fSightCurForwardAngle;
                float f1 = -((BlenheimS1) CockpitBlenheimS1_Bombardier.this.aircraft()).fSightCurSideslip;
                CockpitBlenheimS1_Bombardier.this.mesh.chunkSetAngles("BlackBox", f1, 0.0F, -f);
                HookPilot hookpilot = HookPilot.current;
                hookpilot.setInstantOrient(-f1, CockpitBlenheimS1_Bombardier.this.tAim + f, 0.0F);
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zMark1", ((BlenheimS1) this.aircraft()).fSightCurForwardAngle * 3.675F, 0.0F, 0.0F);
        float f1 = this.cvt(((BlenheimS1) this.aircraft()).fSightSetForwardAngle, -15F, 75F, -15F, 75F);
