...
public class CockpitBloch210 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitBloch210.this.fm != null) {
                CockpitBloch210.this.setTmp = CockpitBloch210.this.setOld;
                CockpitBloch210.this.setOld = CockpitBloch210.this.setNew;
                CockpitBloch210.this.setNew = CockpitBloch210.this.setTmp;
                CockpitBloch210.this.setNew.throttle1 = (0.9F * CockpitBloch210.this.setOld.throttle1) + (0.1F * CockpitBloch210.this.fm.EI.engines[0].getControlThrottle());
                CockpitBloch210.this.setNew.prop1 = (0.9F * CockpitBloch210.this.setOld.prop1) + (0.1F * CockpitBloch210.this.fm.EI.engines[0].getControlProp());
                CockpitBloch210.this.setNew.mix1 = (0.8F * CockpitBloch210.this.setOld.mix1) + (0.2F * CockpitBloch210.this.fm.EI.engines[0].getControlMix());
                CockpitBloch210.this.setNew.throttle2 = (0.9F * CockpitBloch210.this.setOld.throttle2) + (0.1F * CockpitBloch210.this.fm.EI.engines[1].getControlThrottle());
                CockpitBloch210.this.setNew.prop2 = (0.9F * CockpitBloch210.this.setOld.prop2) + (0.1F * CockpitBloch210.this.fm.EI.engines[1].getControlProp());
                CockpitBloch210.this.setNew.mix2 = (0.8F * CockpitBloch210.this.setOld.mix2) + (0.2F * CockpitBloch210.this.fm.EI.engines[1].getControlMix());
                CockpitBloch210.this.setNew.man1 = (0.92F * CockpitBloch210.this.setOld.man1) + (0.08F * CockpitBloch210.this.fm.EI.engines[0].getManifoldPressure());
                CockpitBloch210.this.setNew.man2 = (0.92F * CockpitBloch210.this.setOld.man2) + (0.08F * CockpitBloch210.this.fm.EI.engines[1].getManifoldPressure());
                CockpitBloch210.this.setNew.altimeter = CockpitBloch210.this.fm.getAltitude();
                if (Math.abs(CockpitBloch210.this.fm.Or.getKren()) < 30F) {
                    CockpitBloch210.this.setNew.azimuth.setDeg(CockpitBloch210.this.setOld.azimuth.getDeg(1.0F), CockpitBloch210.this.fm.Or.azimut());
                }
                CockpitBloch210.this.setNew.vspeed = ((199F * CockpitBloch210.this.setOld.vspeed) + CockpitBloch210.this.fm.getVertSpeed()) / 200F;
                if (CockpitBloch210.this.useRealisticNavigationInstruments()) {
                    CockpitBloch210.this.setNew.waypointAzimuth.setDeg(CockpitBloch210.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitBloch210.this.waypointAzimuth());
                } else {
                    CockpitBloch210.this.setNew.waypointAzimuth.setDeg(CockpitBloch210.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitBloch210.this.fm.Or.azimut() + 90F);
                }
                CockpitBloch210.this.setNew.beaconDirection = ((10F * CockpitBloch210.this.setOld.beaconDirection) + CockpitBloch210.this.getBeaconDirection()) / 11F;
                CockpitBloch210.this.setNew.beaconRange = ((10F * CockpitBloch210.this.setOld.beaconRange) + CockpitBloch210.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public CockpitBloch210() {
        super("3DO/Cockpit/Bloch210/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        float f2 = this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitBloch210.speedometerScale);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitBloch210.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitBloch210.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitBloch210.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitBloch210.rpmScale), 0.0F, 0.0F);
