...
public class CockpitBreguet_691 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitBreguet_691.this.fm != null) {
                if (CockpitBreguet_691.this.bNeedSetUp) {
                    CockpitBreguet_691.this.bNeedSetUp = false;
                }
                CockpitBreguet_691.this.setTmp = CockpitBreguet_691.this.setOld;
                CockpitBreguet_691.this.setOld = CockpitBreguet_691.this.setNew;
                CockpitBreguet_691.this.setNew = CockpitBreguet_691.this.setTmp;
                CockpitBreguet_691.this.setNew.throttle1 = (0.85F * CockpitBreguet_691.this.setOld.throttle1) + (CockpitBreguet_691.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitBreguet_691.this.setNew.throttle2 = (0.85F * CockpitBreguet_691.this.setOld.throttle2) + (CockpitBreguet_691.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitBreguet_691.this.setNew.prop1 = (0.85F * CockpitBreguet_691.this.setOld.prop1) + (CockpitBreguet_691.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitBreguet_691.this.setNew.prop2 = (0.85F * CockpitBreguet_691.this.setOld.prop2) + (CockpitBreguet_691.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitBreguet_691.this.setNew.altimeter = CockpitBreguet_691.this.fm.getAltitude();
                float f = CockpitBreguet_691.this.waypointAzimuth();
                if (Math.abs(CockpitBreguet_691.this.fm.Or.getKren()) < 30F) {
                    CockpitBreguet_691.this.setNew.azimuth.setDeg(CockpitBreguet_691.this.setOld.azimuth.getDeg(1.0F), CockpitBreguet_691.this.fm.Or.azimut());
                }
                CockpitBreguet_691.this.setNew.waypointAzimuth.setDeg(CockpitBreguet_691.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitBreguet_691.this.setNew.vspeed = ((199F * CockpitBreguet_691.this.setOld.vspeed) + CockpitBreguet_691.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitBreguet_691() {
        ...
        this.cockpitNightMats = (new String[] { "prib_one", "prib_two", "prib_three", "prib_four", "prib_five", "PEICES1", "PEICES2" });
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 143.0528F, 0.0F, 32F), CockpitBreguet_691.speedometerScaleFAF), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitBreguet_691.variometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 800F, 3000F, 0.0F, 8F), CockpitBreguet_691.rpmScale), 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 800F, 3000F, 0.0F, 8F), CockpitBreguet_691.rpmScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_FuelPres1", 0.0F, this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 10F * this.fm.EI.engines[0].getPowerOutput(), 0.0F, 10F, 0.0F, 277F), 0.0F);
        this.mesh.chunkSetAngles("Z_FuelPres2", 0.0F, this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 10F * this.fm.EI.engines[1].getPowerOutput(), 0.0F, 10F, 0.0F, 277F), 0.0F);
        this.mesh.chunkSetAngles("Z_Temp1", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilIn, 0.0F, 140F, 0.0F, 14F), CockpitBreguet_691.radScale), 0.0F);
        this.mesh.chunkSetAngles("Z_Temp2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].tOilIn, 0.0F, 140F, 0.0F, 14F), CockpitBreguet_691.radScale), 0.0F);
