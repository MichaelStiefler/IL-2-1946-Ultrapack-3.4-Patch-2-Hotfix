...
public class CockpitC46 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitC46.this.fm != null) {
                CockpitC46.this.setTmp = CockpitC46.this.setOld;
                CockpitC46.this.setOld = CockpitC46.this.setNew;
                CockpitC46.this.setNew = CockpitC46.this.setTmp;
                CockpitC46.this.setNew.throttle1 = (0.85F * CockpitC46.this.setOld.throttle1) + (CockpitC46.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitC46.this.setNew.throttle2 = (0.85F * CockpitC46.this.setOld.throttle2) + (CockpitC46.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitC46.this.setNew.prop1 = (0.85F * CockpitC46.this.setOld.prop1) + (CockpitC46.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitC46.this.setNew.prop2 = (0.85F * CockpitC46.this.setOld.prop2) + (CockpitC46.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitC46.this.setNew.altimeter = CockpitC46.this.fm.getAltitude();
                float f = CockpitC46.this.waypointAzimuth();
                if (Math.abs(CockpitC46.this.fm.Or.getKren()) < 30F) {
                    CockpitC46.this.setNew.azimuth.setDeg(CockpitC46.this.setOld.azimuth.getDeg(1.0F), CockpitC46.this.fm.Or.azimut());
                }
                if (CockpitC46.this.useRealisticNavigationInstruments()) {
                    CockpitC46.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitC46.this.setOld.waypointAzimuth.setDeg(f - 90F);
                    CockpitC46.this.setNew.radioCompassAzimuth.setDeg(CockpitC46.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitC46.this.radioCompassAzimuthInvertMinus() - CockpitC46.this.setOld.azimuth.getDeg(1.0F) - 90F);
                    if (CockpitC46.this.fm.AS.listenLorenzBlindLanding && CockpitC46.this.fm.AS.isAAFIAS) {
                        CockpitC46.this.setNew.ilsLoc = ((10F * CockpitC46.this.setOld.ilsLoc) + CockpitC46.this.getBeaconDirection()) / 11F;
                        CockpitC46.this.setNew.ilsGS = ((10F * CockpitC46.this.setOld.ilsGS) + CockpitC46.this.getGlidePath()) / 11F;
                    } else {
                        CockpitC46.this.setNew.ilsLoc = 0.0F;
                        CockpitC46.this.setNew.ilsGS = 0.0F;
                    }
                } else {
                    CockpitC46.this.setNew.waypointAzimuth.setDeg(CockpitC46.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                    CockpitC46.this.setNew.radioCompassAzimuth.setDeg(CockpitC46.this.setOld.radioCompassAzimuth.getDeg(0.1F), f - CockpitC46.this.setOld.azimuth.getDeg(0.1F) - 90F);
                }
                CockpitC46.this.setNew.vspeed = ((199F * CockpitC46.this.setOld.vspeed) + CockpitC46.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitC46() {
        super("3DO/Cockpit/C47/CockpitC46.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitC46.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitC46.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Temp1", 0.0F, -this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 350F, 0.0F, 102.5F), 0.0F);
        this.mesh.chunkSetAngles("Z_Temp2", 0.0F, this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 350F, 0.0F, 102.5F), 0.0F);
        ...
        this.mesh.chunkSetAngles("BL_Vert", this.cvt(this.setNew.ilsLoc, -9.1F, 9.1F, -26F, 26F), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitC46.class, "normZN", 1.27F);
//        Property.set(CockpitC46.class, "normZNs", new float[] { 0.75F, 0.75F, 1.27F, 1.27F });
    }
