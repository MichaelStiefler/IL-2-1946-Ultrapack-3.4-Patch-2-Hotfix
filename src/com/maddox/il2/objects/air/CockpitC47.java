...
public class CockpitC47 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitC47.this.fm != null) {
                CockpitC47.this.setTmp = CockpitC47.this.setOld;
                CockpitC47.this.setOld = CockpitC47.this.setNew;
                CockpitC47.this.setNew = CockpitC47.this.setTmp;
                CockpitC47.this.setNew.throttle1 = (0.85F * CockpitC47.this.setOld.throttle1) + (CockpitC47.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitC47.this.setNew.throttle2 = (0.85F * CockpitC47.this.setOld.throttle2) + (CockpitC47.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitC47.this.setNew.prop1 = (0.85F * CockpitC47.this.setOld.prop1) + (CockpitC47.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitC47.this.setNew.prop2 = (0.85F * CockpitC47.this.setOld.prop2) + (CockpitC47.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitC47.this.setNew.altimeter = CockpitC47.this.fm.getAltitude();
                float f = CockpitC47.this.waypointAzimuth();
                if (Math.abs(CockpitC47.this.fm.Or.getKren()) < 30F) {
                    CockpitC47.this.setNew.azimuth.setDeg(CockpitC47.this.setOld.azimuth.getDeg(1.0F), CockpitC47.this.fm.Or.azimut());
                }
                CockpitC47.this.setNew.waypointAzimuth.setDeg(CockpitC47.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitC47.this.setNew.waypointDeviation.setDeg(CockpitC47.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitC47.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitC47.this.setNew.vspeed = ((199F * CockpitC47.this.setOld.vspeed) + CockpitC47.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitC47() {
        super("3DO/Cockpit/C47RNW/CockpitC47.him", "bf109");
...
//        pictGear = 0.0F;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitC47.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitC47.speedometerScale), 0.0F);
