...
public class CockpitCA12 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitCA12.this.fm != null) {
                ...
                CockpitCA12.this.setNew.waypointAzimuth.setDeg(CockpitCA12.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitCA12.this.waypointAzimuth() - CockpitCA12.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitCA12.this.fm.Or.getKren()) < 30F) {
                    CockpitCA12.this.setNew.azimuth.setDeg(CockpitCA12.this.setOld.azimuth.getDeg(1.0F), CockpitCA12.this.fm.Or.azimut());
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 981.5598F, 0.0F, 53F), CockpitCA12.speedometerScale), 0.0F, 0.0F);
    ...
    public void reflectCockpitState() {
        if ((this.fm.AS.astateCockpitState & 2) != 0) {
            this.mesh.chunkVisible("Bullethole_1", true);
        }
        if ((this.fm.AS.astateCockpitState & 4) != 0) {
            this.mesh.chunkVisible("Bullethole_2", true);
        }
    }
