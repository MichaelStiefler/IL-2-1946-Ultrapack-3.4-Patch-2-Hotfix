...
public class CockpitCa_310 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitCa_310.this.fm != null) {
                ...
                if (Math.abs(CockpitCa_310.this.fm.Or.getKren()) < 30F) {
                ...
                if ((CockpitCa_310.this.fm.AS.astateCockpitState & 0x40) == 0) {
                    CockpitCa_310.this.setNew.vspeed = ((199F * CockpitCa_310.this.setOld.vspeed) + CockpitCa_310.this.fm.getVertSpeed()) / 200F;
                } else {
                    CockpitCa_310.this.setNew.vspeed = ((1990F * CockpitCa_310.this.setOld.vspeed) + CockpitCa_310.this.fm.getVertSpeed()) / 2000F;
                }
                CockpitCa_310.this.setNew.radioalt = (0.9F * CockpitCa_310.this.setOld.radioalt) + (0.1F * ((CockpitCa_310.this.fm.getAltitude() - Landscape.HQ((float) CockpitCa_310.this.fm.Loc.x, (float) CockpitCa_310.this.fm.Loc.y)) + World.Rnd().nextFloat(-10F, 10F)));
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 143.0528F, 0.0F, 32F), CockpitCa_310.speedometerScaleFAF), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitCa_310.variometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 0.0F, 8F), CockpitCa_310.rpmScale), 0.0F);
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 1000F, 5000F, 0.0F, 8F), CockpitCa_310.rpmScale), 0.0F);
        } else {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 500F, 9800F, 0.0F, 8F), CockpitCa_310.rpmScale), 0.0F);
        }
