...
public class CockpitCa_311 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitCa_311.this.fm != null) {
                CockpitCa_311.this.setTmp = CockpitCa_311.this.setOld;
                CockpitCa_311.this.setOld = CockpitCa_311.this.setNew;
                CockpitCa_311.this.setNew = CockpitCa_311.this.setTmp;
                CockpitCa_311.this.reflectPlaneToModel();
                CockpitCa_311.this.setNew.throttle1 = (0.85F * CockpitCa_311.this.setOld.throttle1) + (CockpitCa_311.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitCa_311.this.setNew.throttle2 = (0.85F * CockpitCa_311.this.setOld.throttle2) + (CockpitCa_311.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitCa_311.this.setNew.prop1 = (0.85F * CockpitCa_311.this.setOld.prop1) + (CockpitCa_311.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitCa_311.this.setNew.prop2 = (0.85F * CockpitCa_311.this.setOld.prop2) + (CockpitCa_311.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitCa_311.this.setNew.altimeter = CockpitCa_311.this.fm.getAltitude();
                float f = CockpitCa_311.this.waypointAzimuth();
                if (Math.abs(CockpitCa_311.this.fm.Or.getKren()) < 30F) {
                    CockpitCa_311.this.setNew.azimuth.setDeg(CockpitCa_311.this.setOld.azimuth.getDeg(1.0F), CockpitCa_311.this.fm.Or.azimut());
                }
                CockpitCa_311.this.setNew.waypointAzimuth.setDeg(CockpitCa_311.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitCa_311.this.setNew.waypointDeviation.setDeg(CockpitCa_311.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitCa_311.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if ((CockpitCa_311.this.fm.AS.astateCockpitState & 0x40) == 0) {
                    CockpitCa_311.this.setNew.vspeed = ((199F * CockpitCa_311.this.setOld.vspeed) + CockpitCa_311.this.fm.getVertSpeed()) / 200F;
                } else {
                    CockpitCa_311.this.setNew.vspeed = ((1990F * CockpitCa_311.this.setOld.vspeed) + CockpitCa_311.this.fm.getVertSpeed()) / 2000F;
                }
                CockpitCa_311.this.setNew.radioalt = (0.9F * CockpitCa_311.this.setOld.radioalt) + (0.1F * ((CockpitCa_311.this.fm.getAltitude() - Landscape.HQ((float) CockpitCa_311.this.fm.Loc.x, (float) CockpitCa_311.this.fm.Loc.y)) + World.Rnd().nextFloat(-10F, 10F)));
            }
            return true;
        }
    ...
    public CockpitCa_311() {
        super("3DO/Cockpit/Ca-311/hier.him", "bf109");
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            ...
            this.aircraft().hierMesh().chunkVisible("311cfd", false);
            this.aircraft().hierMesh().chunkVisible("311glassA", false);
            return true;
        } else {
            return false;
        }
    ...
    protected void doFocusLeave() {
        ...
        this.aircraft().hierMesh().chunkVisible("311cfd", true);
        this.aircraft().hierMesh().chunkVisible("311glassA", true);
        super.doFocusLeave();
    }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 143.0528F, 0.0F, 32F), CockpitCa_311.speedometerScaleFAF), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitCa_311.variometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 0.0F, 8F), CockpitCa_311.rpmScale), 0.0F);
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 1000F, 5000F, 0.0F, 8F), CockpitCa_311.rpmScale), 0.0F);
        } else {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 500F, 9800F, 0.0F, 8F), CockpitCa_311.rpmScale), 0.0F);
        }
