...
public class CockpitCantZ501 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitCantZ501.this.fm != null) {
                CockpitCantZ501.this.setTmp = CockpitCantZ501.this.setOld;
                CockpitCantZ501.this.setOld = CockpitCantZ501.this.setNew;
                CockpitCantZ501.this.setNew = CockpitCantZ501.this.setTmp;
                CockpitCantZ501.this.setNew.throttle1 = (0.85F * CockpitCantZ501.this.setOld.throttle1) + (CockpitCantZ501.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitCantZ501.this.setNew.prop1 = (0.85F * CockpitCantZ501.this.setOld.prop1) + (CockpitCantZ501.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitCantZ501.this.setNew.altimeter = CockpitCantZ501.this.fm.getAltitude();
                float f = CockpitCantZ501.this.waypointAzimuth();
                if (Math.abs(CockpitCantZ501.this.fm.Or.getKren()) < 30F) {
                    CockpitCantZ501.this.setNew.azimuth.setDeg(CockpitCantZ501.this.setOld.azimuth.getDeg(1.0F), CockpitCantZ501.this.fm.Or.azimut());
                }
                CockpitCantZ501.this.setNew.waypointAzimuth.setDeg(CockpitCantZ501.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitCantZ501.this.setNew.waypointDeviation.setDeg(CockpitCantZ501.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitCantZ501.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitCantZ501.this.setNew.vspeed = ((199F * CockpitCantZ501.this.setOld.vspeed) + CockpitCantZ501.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitCantZ501() {
        super("3DO/Cockpit/B-25J/CockpitCantZ501.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitCantZ501.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitCantZ501.speedometerScale), 0.0F);
