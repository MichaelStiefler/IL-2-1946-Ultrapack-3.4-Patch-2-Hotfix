...
public class CockpitD372 extends CockpitPilot {
    private class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitD372.this.fm != null) {
                CockpitD372.this.setTmp = CockpitD372.this.setOld;
                CockpitD372.this.setOld = CockpitD372.this.setNew;
                CockpitD372.this.setNew = CockpitD372.this.setTmp;
                CockpitD372.this.setNew.throttle = (0.92F * CockpitD372.this.setOld.throttle) + (0.08F * CockpitD372.this.fm.CT.PowerControl);
                CockpitD372.this.setNew.prop = (0.92F * CockpitD372.this.setOld.prop) + (0.08F * CockpitD372.this.fm.EI.engines[0].getControlProp());
                CockpitD372.this.setNew.mix = (0.92F * CockpitD372.this.setOld.mix) + (0.08F * CockpitD372.this.fm.EI.engines[0].getControlMix());
                CockpitD372.this.setNew.altimeter = CockpitD372.this.fm.getAltitude();
                CockpitD372.this.setNew.waypointAzimuth.setDeg(CockpitD372.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitD372.this.waypointAzimuth() - CockpitD372.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitD372.this.fm.Or.getKren()) < 30F) {
                    CockpitD372.this.setNew.azimuth.setDeg(CockpitD372.this.setOld.azimuth.getDeg(1.0F), CockpitD372.this.fm.Or.azimut());
                }
                CockpitD372.this.setNew.vspeed = (0.99F * CockpitD372.this.setOld.vspeed) + (0.01F * CockpitD372.this.fm.getVertSpeed());
                if (CockpitD372.this.fm.CT.GearControl < 0.5F) {
                    if (CockpitD372.this.setNew.gearPhi > 0.0F) {
                        CockpitD372.this.setNew.gearPhi = CockpitD372.this.setOld.gearPhi - 0.021F;
                    }
                } else if (CockpitD372.this.setNew.gearPhi < 1.0F) {
                    CockpitD372.this.setNew.gearPhi = CockpitD372.this.setOld.gearPhi + 0.021F;
                }
            }
            return true;
    ...
    public CockpitD372() {
        super("3DO/Cockpit/D372/D372.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 10F), CockpitD372.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_VY", -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitD372.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 5000F, 0.0F, 10F), CockpitD372.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, -306F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitD372.radScale), 0.0F, 0.0F);
