...
public class CockpitD3A1 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitD3A1.this.fm != null) {
                CockpitD3A1.this.setTmp = CockpitD3A1.this.setOld;
                CockpitD3A1.this.setOld = CockpitD3A1.this.setNew;
                CockpitD3A1.this.setNew = CockpitD3A1.this.setTmp;
                if (CockpitD3A1.this.cockpitDimControl) {
                    if (CockpitD3A1.this.setNew.dimPos < 1.0F) {
                        CockpitD3A1.this.setNew.dimPos = CockpitD3A1.this.setOld.dimPos + 0.03F;
                    }
                } else if (CockpitD3A1.this.setNew.dimPos > 0.0F) {
                    CockpitD3A1.this.setNew.dimPos = CockpitD3A1.this.setOld.dimPos - 0.03F;
                }
                ...
                if (Math.abs(CockpitD3A1.this.fm.Or.getKren()) < 30F) {
                ...
                if (CockpitD3A1.this.useRealisticNavigationInstruments()) {
                    ...
                    CockpitD3A1.this.setNew.waypointAzimuth.setDeg(CockpitD3A1.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitD3A1.this.fm.Or.azimut() + 90F);
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 340F, 0.0F, 17F), CockpitD3A1.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Compass4", -90F, 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Compass5", this.setNew.waypointAzimuth.getDeg(f * 0.1F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Compass6", this.cvt(this.setNew.waypointDeviation.getDeg(f * 0.2F), -25F, 25F, -45F, 45F), 0.0F, 0.0F);
        this.resetYPRmodifier();
        ...
        this.mesh.chunkSetAngles("Z_Temp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 7F), CockpitD3A1.oilScale), 0.0F, 0.0F);
