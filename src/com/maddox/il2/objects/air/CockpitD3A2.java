...
public class CockpitD3A2 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitD3A2.this.fm != null) {
                CockpitD3A2.this.setTmp = CockpitD3A2.this.setOld;
                CockpitD3A2.this.setOld = CockpitD3A2.this.setNew;
                CockpitD3A2.this.setNew = CockpitD3A2.this.setTmp;
                if (CockpitD3A2.this.cockpitDimControl) {
                    if (CockpitD3A2.this.setNew.dimPos < 1.0F) {
                        CockpitD3A2.this.setNew.dimPos = CockpitD3A2.this.setOld.dimPos + 0.03F;
                    }
                } else if (CockpitD3A2.this.setNew.dimPos > 0.0F) {
                    CockpitD3A2.this.setNew.dimPos = CockpitD3A2.this.setOld.dimPos - 0.03F;
                }
                CockpitD3A2.this.setNew.throttle = (0.8F * CockpitD3A2.this.setOld.throttle) + (0.2F * CockpitD3A2.this.fm.CT.PowerControl);
                CockpitD3A2.this.setNew.prop = (0.8F * CockpitD3A2.this.setOld.prop) + (0.2F * CockpitD3A2.this.fm.EI.engines[0].getControlProp());
                CockpitD3A2.this.setNew.mix = (0.8F * CockpitD3A2.this.setOld.mix) + (0.2F * CockpitD3A2.this.fm.EI.engines[0].getControlMix());
                CockpitD3A2.this.setNew.man = (0.92F * CockpitD3A2.this.setOld.man) + (0.08F * CockpitD3A2.this.fm.EI.engines[0].getManifoldPressure());
                CockpitD3A2.this.setNew.altimeter = CockpitD3A2.this.fm.getAltitude();
                float f = CockpitD3A2.this.waypointAzimuth();
                if (Math.abs(CockpitD3A2.this.fm.Or.getKren()) < 30F) {
                    CockpitD3A2.this.setNew.azimuth.setDeg(CockpitD3A2.this.setOld.azimuth.getDeg(1.0F), CockpitD3A2.this.fm.Or.azimut());
                }
                CockpitD3A2.this.setNew.waypointDeviation.setDeg(CockpitD3A2.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitD3A2.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-5F, 5F));
                CockpitD3A2.this.setNew.waypointAzimuth.setDeg(CockpitD3A2.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitD3A2.this.setNew.vspeed = (0.5F * CockpitD3A2.this.setOld.vspeed) + (0.5F * CockpitD3A2.this.fm.getVertSpeed());
                CockpitD3A2.this.mesh.chunkSetAngles("Turret1A_D0", 0.0F, -CockpitD3A2.this.aircraft().FM.turret[0].tu[0], 0.0F);
                CockpitD3A2.this.mesh.chunkSetAngles("Turret1B_D0", 0.0F, CockpitD3A2.this.aircraft().FM.turret[0].tu[1], 0.0F);
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 340F, 0.0F, 17F), CockpitD3A2.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Temp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 7F), CockpitD3A2.oilScale), 0.0F, 0.0F);
