...
public class CockpitD4Y2S extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitD4Y2S.this.fm != null) {
                CockpitD4Y2S.this.setTmp = CockpitD4Y2S.this.setOld;
                CockpitD4Y2S.this.setOld = CockpitD4Y2S.this.setNew;
                CockpitD4Y2S.this.setNew = CockpitD4Y2S.this.setTmp;
                CockpitD4Y2S.this.setNew.gear = (0.7F * CockpitD4Y2S.this.setOld.gear) + (0.3F * CockpitD4Y2S.this.fm.CT.GearControl);
                if (CockpitD4Y2S.this.cockpitDimControl) {
                    if (CockpitD4Y2S.this.setNew.dimPosition > 0.0F) {
                        CockpitD4Y2S.this.setNew.dimPosition = CockpitD4Y2S.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitD4Y2S.this.setNew.dimPosition < 1.0F) {
                    CockpitD4Y2S.this.setNew.dimPosition = CockpitD4Y2S.this.setOld.dimPosition + 0.05F;
                }
                if ((CockpitD4Y2S.this.fm.AS.astateCockpitState & 2) != 0) {
                    if (CockpitD4Y2S.this.setNew.stbyPosition > 0.0F) {
                        CockpitD4Y2S.this.setNew.stbyPosition = CockpitD4Y2S.this.setOld.stbyPosition - 0.025F;
                    }
                } else if (CockpitD4Y2S.this.setNew.stbyPosition < 1.0F) {
                    CockpitD4Y2S.this.setNew.stbyPosition = CockpitD4Y2S.this.setOld.stbyPosition + 0.025F;
                }
                CockpitD4Y2S.this.setNew.throttle = (0.8F * CockpitD4Y2S.this.setOld.throttle) + (0.2F * CockpitD4Y2S.this.fm.CT.PowerControl);
                CockpitD4Y2S.this.setNew.prop = (0.8F * CockpitD4Y2S.this.setOld.prop) + (0.2F * CockpitD4Y2S.this.fm.EI.engines[0].getControlProp());
                CockpitD4Y2S.this.setNew.mix = (0.8F * CockpitD4Y2S.this.setOld.mix) + (0.2F * CockpitD4Y2S.this.fm.EI.engines[0].getControlMix());
                CockpitD4Y2S.this.setNew.man = (0.92F * CockpitD4Y2S.this.setOld.man) + (0.08F * CockpitD4Y2S.this.fm.EI.engines[0].getManifoldPressure());
                CockpitD4Y2S.this.setNew.altimeter = CockpitD4Y2S.this.fm.getAltitude();
                float f = CockpitD4Y2S.this.waypointAzimuth();
                if (Math.abs(CockpitD4Y2S.this.fm.Or.getKren()) < 30F) {
                    CockpitD4Y2S.this.setNew.azimuth.setDeg(CockpitD4Y2S.this.setOld.azimuth.getDeg(1.0F), CockpitD4Y2S.this.fm.Or.azimut());
                }
                CockpitD4Y2S.this.setNew.waypointDeviation.setDeg(CockpitD4Y2S.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitD4Y2S.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-5F, 5F));
                CockpitD4Y2S.this.setNew.waypointAzimuth.setDeg(CockpitD4Y2S.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitD4Y2S.this.setNew.vspeed = (0.5F * CockpitD4Y2S.this.setOld.vspeed) + (0.5F * CockpitD4Y2S.this.fm.getVertSpeed());
                CockpitD4Y2S.this.mesh.chunkSetAngles("Turret1A_D0", 0.0F, -CockpitD4Y2S.this.aircraft().FM.turret[0].tu[0], 0.0F);
                CockpitD4Y2S.this.mesh.chunkSetAngles("Turret1B_D0", 0.0F, CockpitD4Y2S.this.aircraft().FM.turret[0].tu[1], 0.0F);
            }
            return true;
        }
    ...
    public CockpitD4Y2S() {
        super("3DO/Cockpit/D4Y2S/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 340F, 0.0F, 17F), CockpitD4Y2S.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Temp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 7F), CockpitD4Y2S.oilScale), 0.0F, 0.0F);
