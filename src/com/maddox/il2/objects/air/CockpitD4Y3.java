...
public class CockpitD4Y3 extends CockpitPilot {
        ...
        public boolean tick() {
            if (CockpitD4Y3.this.fm != null) {
                ...
                if (CockpitD4Y3.this.cockpitDimControl) {
                    if (CockpitD4Y3.this.setNew.dimPos < 1.0F) {
                        CockpitD4Y3.this.setNew.dimPos = CockpitD4Y3.this.setOld.dimPos + 0.03F;
                    }
                } else if (CockpitD4Y3.this.setNew.dimPos > 0.0F) {
                    CockpitD4Y3.this.setNew.dimPos = CockpitD4Y3.this.setOld.dimPos - 0.03F;
                }
                ...
                if (Math.abs(CockpitD4Y3.this.fm.Or.getKren()) < 30F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 340F, 0.0F, 17F), CockpitD4Y3.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Temp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 7F), CockpitD4Y3.oilScale), 0.0F, 0.0F);
