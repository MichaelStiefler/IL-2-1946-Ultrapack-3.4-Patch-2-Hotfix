...
public class CockpitD510 extends CockpitPilot {
    private class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitD510.this.fm != null) {
                CockpitD510.this.setTmp = CockpitD510.this.setOld;
                CockpitD510.this.setOld = CockpitD510.this.setNew;
                CockpitD510.this.setNew = CockpitD510.this.setTmp;
                CockpitD510.this.setNew.throttle = (0.92F * CockpitD510.this.setOld.throttle) + (0.08F * CockpitD510.this.fm.CT.PowerControl);
                CockpitD510.this.setNew.prop = (0.92F * CockpitD510.this.setOld.prop) + (0.08F * CockpitD510.this.fm.EI.engines[0].getControlProp());
                CockpitD510.this.setNew.mix = (0.92F * CockpitD510.this.setOld.mix) + (0.08F * CockpitD510.this.fm.EI.engines[0].getControlMix());
                CockpitD510.this.setNew.altimeter = CockpitD510.this.fm.getAltitude();
                CockpitD510.this.setNew.waypointAzimuth.setDeg(CockpitD510.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitD510.this.waypointAzimuth() - CockpitD510.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitD510.this.fm.Or.getKren()) < 30F) {
                    CockpitD510.this.setNew.azimuth.setDeg(CockpitD510.this.setOld.azimuth.getDeg(1.0F), CockpitD510.this.fm.Or.azimut());
                }
                CockpitD510.this.setNew.vspeed = (0.99F * CockpitD510.this.setOld.vspeed) + (0.01F * CockpitD510.this.fm.getVertSpeed());
                if (CockpitD510.this.fm.CT.GearControl < 0.5F) {
                    if (CockpitD510.this.setNew.gearPhi > 0.0F) {
                        CockpitD510.this.setNew.gearPhi = CockpitD510.this.setOld.gearPhi - 0.021F;
                    }
                } else if (CockpitD510.this.setNew.gearPhi < 1.0F) {
                    CockpitD510.this.setNew.gearPhi = CockpitD510.this.setOld.gearPhi + 0.021F;
                }
            }
            return true;
    ...
    public CockpitD510() {
        super("3DO/Cockpit/D510/D510.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 10F), CockpitD510.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_VY", -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitD510.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 5000F, 0.0F, 10F), CockpitD510.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, -306F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitD510.radScale), 0.0F, 0.0F);
