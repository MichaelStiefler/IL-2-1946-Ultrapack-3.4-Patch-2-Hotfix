...
public class CockpitD520 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitD520.this.fm.CT.GearControl == 1.0F) {
                if (CockpitD520.this.setNew.stbyPosition1 > 0.0F) {
                    CockpitD520.this.setNew.stbyPosition1 = CockpitD520.this.setOld.stbyPosition1 - 0.5F;
                }
            } else if (CockpitD520.this.setNew.stbyPosition1 < 1.0F) {
                CockpitD520.this.setNew.stbyPosition1 = CockpitD520.this.setOld.stbyPosition1 + 0.5F;
            }
            if (!CockpitD520.this.cockpitLightControl) {
                if (CockpitD520.this.setNew.stbyPosition2 > 0.0F) {
                    CockpitD520.this.setNew.stbyPosition2 = CockpitD520.this.setOld.stbyPosition2 - 0.05F;
                }
            } else if (CockpitD520.this.setNew.stbyPosition2 < 1.0F) {
                CockpitD520.this.setNew.stbyPosition2 = CockpitD520.this.setOld.stbyPosition2 + 0.05F;
            }
            if (!CockpitD520.this.fm.AS.bNavLightsOn) {
                if (CockpitD520.this.setNew.stbyPosition3 > 0.0F) {
                    CockpitD520.this.setNew.stbyPosition3 = CockpitD520.this.setOld.stbyPosition3 - 0.5F;
                }
            } else if (CockpitD520.this.setNew.stbyPosition3 < 1.0F) {
                CockpitD520.this.setNew.stbyPosition3 = CockpitD520.this.setOld.stbyPosition3 + 0.5F;
            }
            if (!CockpitD520.this.fm.AS.bLandingLightOn) {
                if (CockpitD520.this.setNew.stbyPosition4 > 0.0F) {
                    CockpitD520.this.setNew.stbyPosition4 = CockpitD520.this.setOld.stbyPosition4 - 0.5F;
                }
            } else if (CockpitD520.this.setNew.stbyPosition4 < 1.0F) {
                CockpitD520.this.setNew.stbyPosition4 = CockpitD520.this.setOld.stbyPosition4 + 0.5F;
            }
            if (!CockpitD520.this.fm.CT.getStepControlAuto()) {
                if (CockpitD520.this.setNew.stbyPosition5 > 0.0F) {
                    CockpitD520.this.setNew.stbyPosition5 = CockpitD520.this.setOld.stbyPosition5 - 0.2F;
                }
            } else if (CockpitD520.this.setNew.stbyPosition5 < 1.0F) {
                CockpitD520.this.setNew.stbyPosition5 = CockpitD520.this.setOld.stbyPosition5 + 0.2F;
            }
            if (CockpitD520.this.fm.CT.BayDoorControl == 0.0F) {
                if (CockpitD520.this.setNew.stbyPosition8 > 0.0F) {
                    CockpitD520.this.setNew.stbyPosition8 = CockpitD520.this.setOld.stbyPosition8 - 0.5F;
                }
            } else if (CockpitD520.this.setNew.stbyPosition8 < 1.0F) {
                CockpitD520.this.setNew.stbyPosition8 = CockpitD520.this.setOld.stbyPosition8 + 0.5F;
            }
            if (!CockpitD520.this.fm.CT.WeaponControl[0] && !CockpitD520.this.fm.CT.WeaponControl[1]) {
                if (CockpitD520.this.setNew.stbyPosition12 > 0.0F) {
                    CockpitD520.this.setNew.stbyPosition12 = CockpitD520.this.setOld.stbyPosition12 - 0.5F;
                }
            } else if (CockpitD520.this.setNew.stbyPosition12 < 1.0F) {
                CockpitD520.this.setNew.stbyPosition12 = CockpitD520.this.setOld.stbyPosition12 + 0.5F;
            }
            if (CockpitD520.this.fm.CT.GearControl == 0.0F) {
                if (CockpitD520.this.setNew.stbyPosition13 > 0.0F) {
                    CockpitD520.this.setNew.stbyPosition13 = CockpitD520.this.setOld.stbyPosition13 - 0.05F;
                }
            } else if (CockpitD520.this.setNew.stbyPosition13 < 1.0F) {
                CockpitD520.this.setNew.stbyPosition13 = CockpitD520.this.setOld.stbyPosition13 + 0.05F;
            }
            if ((CockpitD520.this.fm.CT.FlapsControl <= 0.1F) || (CockpitD520.this.fm.CT.FlapsControl == 1.0F)) {
                if (CockpitD520.this.setNew.stbyPosition14 > 0.0F) {
                    CockpitD520.this.setNew.stbyPosition14 = CockpitD520.this.setOld.stbyPosition14 - 0.05F;
                }
            } else if (CockpitD520.this.setNew.stbyPosition14 < 1.0F) {
                CockpitD520.this.setNew.stbyPosition14 = CockpitD520.this.setOld.stbyPosition14 + 0.05F;
            }
            if ((CockpitD520.this.fm.CT.getGear() > 0.1F) && (CockpitD520.this.fm.CT.getGear() < 0.9F)) {
                if (CockpitD520.this.setNew.stbyPosition15 > 0.0F) {
                    CockpitD520.this.setNew.stbyPosition15 = CockpitD520.this.setOld.stbyPosition15 - 0.05F;
                }
            } else if (CockpitD520.this.setNew.stbyPosition15 < 1.0F) {
                CockpitD520.this.setNew.stbyPosition15 = CockpitD520.this.setOld.stbyPosition15 + 0.05F;
            }
            if (!CockpitD520.this.CompresseOk) {
                if (CockpitD520.this.setNew.stbyPosition35 > 0.0F) {
                    CockpitD520.this.setNew.stbyPosition35 = CockpitD520.this.setOld.stbyPosition35 - 0.005F;
                }
            } else if (CockpitD520.this.setNew.stbyPosition35 < 1.0F) {
                CockpitD520.this.setNew.stbyPosition35 = CockpitD520.this.setOld.stbyPosition35 + 0.005F;
            }
            if (!CockpitD520.this.CompresseOk) {
                if (CockpitD520.this.setNew.stbyPosition36 > 0.0F) {
                    CockpitD520.this.setNew.stbyPosition36 = CockpitD520.this.setOld.stbyPosition36 - 0.005F;
                }
            } else if (CockpitD520.this.setNew.stbyPosition36 < 1.0F) {
                CockpitD520.this.setNew.stbyPosition36 = CockpitD520.this.setOld.stbyPosition36 + 0.005F;
            }
            if (!CockpitD520.this.StarterState2) {
                if (CockpitD520.this.setNew.stbyPosition50 > 0.0F) {
                    CockpitD520.this.setNew.stbyPosition50 = CockpitD520.this.setOld.stbyPosition50 - 0.1F;
                }
            } else if (CockpitD520.this.setNew.stbyPosition50 < 1.0F) {
                CockpitD520.this.setNew.stbyPosition50 = CockpitD520.this.setOld.stbyPosition50 + 0.1F;
            }
            if (!CockpitD520.this.StarterState1) {
                if (CockpitD520.this.setNew.stbyPosition51 > 0.0F) {
                    CockpitD520.this.setNew.stbyPosition51 = CockpitD520.this.setOld.stbyPosition51 - 0.1F;
                }
            } else if (CockpitD520.this.setNew.stbyPosition51 < 1.0F) {
                CockpitD520.this.setNew.stbyPosition51 = CockpitD520.this.setOld.stbyPosition51 + 0.1F;
            }
            if (CockpitD520.this.fm.EI.isSelectionHasControlExtinguisher()) {
                if (CockpitD520.this.setNew.stbyPosition59 > 0.0F) {
                    CockpitD520.this.setNew.stbyPosition59 = CockpitD520.this.setOld.stbyPosition59 - 0.1F;
                }
            } else if (CockpitD520.this.setNew.stbyPosition59 < 1.0F) {
                CockpitD520.this.setNew.stbyPosition59 = CockpitD520.this.setOld.stbyPosition59 + 0.1F;
            }
            if (!CockpitD520.this.cockpitDimControl) {
                if (CockpitD520.this.setNew.dimPosition > 0.0F) {
                    CockpitD520.this.setNew.dimPosition = CockpitD520.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitD520.this.setNew.dimPosition < 1.0F) {
                CockpitD520.this.setNew.dimPosition = CockpitD520.this.setOld.dimPosition + 0.05F;
            }
            ...
            CockpitD520.this.setNew.waypointAzimuth.setDeg(CockpitD520.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitD520.this.waypointAzimuth() - CockpitD520.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitD520.this.fm.Or.getKren()) < 30F) {
                CockpitD520.this.setNew.azimuth.setDeg(CockpitD520.this.setOld.azimuth.getDeg(1.0F), CockpitD520.this.fm.Or.azimut());
            }
    ...
    protected void doFocusLeave() {
        ...
        if (!((D520) this.aircraft()).CockpitDamaged2 && !((D520) this.aircraft()).CanopyEjectState) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Admission", 0.0F, 0.0F, this.floatindex(this.cvt(0.75F * this.fm.EI.engines[0].getManifoldPressure(), 0.0F, 1.5F, 0.0F, 15F), CockpitD520.admissionScale));
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 700F, 0.0F, 14F), CockpitD520.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 200F, 0.0F, 20F), CockpitD520.speedometer2Scale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Variometer", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -12F, 20F, 0.0F, 16F), CockpitD520.variometerScale));
        this.mesh.chunkSetAngles("Z_RPM", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3000F, 0.0F, 6F), CockpitD520.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity", this.floatindex(this.cvt(this.fm.M.fuel, 0.0F, 450F, 0.0F, 9F), CockpitD520.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_OilTemp", 0.0F, 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 140F, 0.0F, 14F), CockpitD520.oiltempScale));
        this.mesh.chunkSetAngles("Z_WaterTemp", 0.0F, 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitD520.watertempScale));
        ...
        if ((this.fm.CT.getCockpitDoor() == 0.0F) && !((D520) this.aircraft()).CanopyEjectState) {
...
//        }
    ...
    public void reflectCockpitState() {
        if (((D520) this.aircraft()).CockpitDamaged2 || ((this.fm.AS.astateCockpitState & 0x20) != 0)) {
        ...
        if (((D520) this.aircraft()).CockpitDamaged1 || ((this.fm.AS.astateCockpitState & 1) != 0)) {
            this.mesh.chunkVisible("Z_Holes1", true);
        }
        if (((D520) this.aircraft()).CockpitDamaged3) {
