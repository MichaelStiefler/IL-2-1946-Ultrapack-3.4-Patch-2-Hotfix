...
public class CockpitDB3B extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitDB3B.this.fm != null) {
                CockpitDB3B.this.setTmp = CockpitDB3B.this.setOld;
                CockpitDB3B.this.setOld = CockpitDB3B.this.setNew;
                CockpitDB3B.this.setNew = CockpitDB3B.this.setTmp;
                if (CockpitDB3B.this.fm.CT.Weapons[3] != null) {
                    if (CockpitDB3B.this.fm.CT.Weapons[3].length > 0) {
                        CockpitDB3B.this.bBombs[1] = !CockpitDB3B.this.fm.CT.Weapons[3][0].haveBullets();
                    }
                    if (CockpitDB3B.this.fm.CT.Weapons[3].length > 1) {
                        CockpitDB3B.this.bBombs[0] = !CockpitDB3B.this.fm.CT.Weapons[3][1].haveBullets();
                    }
                    if (CockpitDB3B.this.fm.CT.Weapons[3].length > 2) {
                        CockpitDB3B.this.bBombs[3] = !CockpitDB3B.this.fm.CT.Weapons[3][2].haveBullets();
                    }
                    if (CockpitDB3B.this.fm.CT.Weapons[3].length > 3) {
                        CockpitDB3B.this.bBombs[2] = !CockpitDB3B.this.fm.CT.Weapons[3][3].haveBullets();
                    }
                    if (CockpitDB3B.this.fm.CT.Weapons[3].length > 4) {
                        CockpitDB3B.this.bBombs[5] = !CockpitDB3B.this.fm.CT.Weapons[3][4].haveBullets();
                    }
                    if (CockpitDB3B.this.fm.CT.Weapons[3].length > 5) {
                        CockpitDB3B.this.bBombs[4] = !CockpitDB3B.this.fm.CT.Weapons[3][5].haveBullets();
                    }
                    if (CockpitDB3B.this.fm.CT.Weapons[3].length > 6) {
                        CockpitDB3B.this.bBombs[5] = CockpitDB3B.this.bBombs[5] || !CockpitDB3B.this.fm.CT.Weapons[3][6].haveBullets();
                    }
                    if (CockpitDB3B.this.fm.CT.Weapons[3].length > 7) {
                        CockpitDB3B.this.bBombs[4] = CockpitDB3B.this.bBombs[4] || !CockpitDB3B.this.fm.CT.Weapons[3][7].haveBullets();
                    }
                    if (CockpitDB3B.this.fm.CT.Weapons[3].length > 8) {
                        CockpitDB3B.this.bBombs[7] = !CockpitDB3B.this.fm.CT.Weapons[3][8].haveBullets();
                    }
                    if (CockpitDB3B.this.fm.CT.Weapons[3].length > 9) {
                        CockpitDB3B.this.bBombs[6] = !CockpitDB3B.this.fm.CT.Weapons[3][9].haveBullets();
                    }
                }
                CockpitDB3B.this.setNew.throttle1 = (0.9F * CockpitDB3B.this.setOld.throttle1) + (0.1F * CockpitDB3B.this.fm.EI.engines[0].getControlThrottle());
                CockpitDB3B.this.setNew.prop1 = (0.9F * CockpitDB3B.this.setOld.prop1) + (0.1F * CockpitDB3B.this.fm.EI.engines[0].getControlProp());
                CockpitDB3B.this.setNew.mix1 = (0.8F * CockpitDB3B.this.setOld.mix1) + (0.2F * CockpitDB3B.this.fm.EI.engines[0].getControlMix());
                CockpitDB3B.this.setNew.man1 = (0.92F * CockpitDB3B.this.setOld.man1) + (0.08F * CockpitDB3B.this.fm.EI.engines[0].getManifoldPressure());
                CockpitDB3B.this.setNew.throttle2 = (0.9F * CockpitDB3B.this.setOld.throttle2) + (0.1F * CockpitDB3B.this.fm.EI.engines[1].getControlThrottle());
                CockpitDB3B.this.setNew.prop2 = (0.9F * CockpitDB3B.this.setOld.prop2) + (0.1F * CockpitDB3B.this.fm.EI.engines[1].getControlProp());
                CockpitDB3B.this.setNew.mix2 = (0.8F * CockpitDB3B.this.setOld.mix2) + (0.2F * CockpitDB3B.this.fm.EI.engines[1].getControlMix());
                CockpitDB3B.this.setNew.man2 = (0.92F * CockpitDB3B.this.setOld.man2) + (0.08F * CockpitDB3B.this.fm.EI.engines[1].getManifoldPressure());
                CockpitDB3B.this.setNew.altimeter = CockpitDB3B.this.fm.getAltitude();
                if (Math.abs(CockpitDB3B.this.fm.Or.getKren()) < 30F) {
                    CockpitDB3B.this.setNew.azimuth.setDeg(CockpitDB3B.this.setOld.azimuth.getDeg(1.0F), CockpitDB3B.this.fm.Or.azimut());
                }
                CockpitDB3B.this.setNew.vspeed = ((100F * CockpitDB3B.this.setOld.vspeed) + CockpitDB3B.this.fm.getVertSpeed()) / 101F;
                if (CockpitDB3B.this.useRealisticNavigationInstruments()) {
                    CockpitDB3B.this.setNew.waypointAzimuth.setDeg(CockpitDB3B.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitDB3B.this.getBeaconDirection());
                } else {
                    CockpitDB3B.this.setNew.waypointAzimuth.setDeg(CockpitDB3B.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitDB3B.this.waypointAzimuth() - CockpitDB3B.this.setOld.azimuth.getDeg(1.0F));
                }
                CockpitDB3B.this.mesh.chunkSetAngles("Z_RTurret", CockpitDB3B.this.aircraft().FM.turret[0].tu[0], 0.0F, 0.0F);
                CockpitDB3B.this.mesh.chunkSetAngles("Z_RGun", -CockpitDB3B.this.aircraft().FM.turret[0].tu[1], 0.0F, 0.0F);
                CockpitDB3B.this.setNew.inert = (0.999F * CockpitDB3B.this.setOld.inert) + (0.001F * (CockpitDB3B.this.fm.EI.engines[0].getStage() == 6 ? 0.867F : 0.0F));
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitDB3B.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitDB3B.speedometerScale), 0.0F, 0.0F);
        this.resetYPRmodifier();
