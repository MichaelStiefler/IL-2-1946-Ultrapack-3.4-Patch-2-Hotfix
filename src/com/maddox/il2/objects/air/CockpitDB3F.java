...
public class CockpitDB3F extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitDB3F.this.fm != null) {
                CockpitDB3F.this.setTmp = CockpitDB3F.this.setOld;
                CockpitDB3F.this.setOld = CockpitDB3F.this.setNew;
                CockpitDB3F.this.setNew = CockpitDB3F.this.setTmp;
                if (CockpitDB3F.this.fm.CT.Weapons[3] != null) {
                    if (CockpitDB3F.this.fm.CT.Weapons[3].length > 0) {
                        CockpitDB3F.this.bBombs[1] = !CockpitDB3F.this.fm.CT.Weapons[3][0].haveBullets();
                    }
                    if (CockpitDB3F.this.fm.CT.Weapons[3].length > 1) {
                        CockpitDB3F.this.bBombs[0] = !CockpitDB3F.this.fm.CT.Weapons[3][1].haveBullets();
                    }
                    if (CockpitDB3F.this.fm.CT.Weapons[3].length > 2) {
                        CockpitDB3F.this.bBombs[3] = !CockpitDB3F.this.fm.CT.Weapons[3][2].haveBullets();
                    }
                    if (CockpitDB3F.this.fm.CT.Weapons[3].length > 3) {
                        CockpitDB3F.this.bBombs[2] = !CockpitDB3F.this.fm.CT.Weapons[3][3].haveBullets();
                    }
                    if (CockpitDB3F.this.fm.CT.Weapons[3].length > 4) {
                        CockpitDB3F.this.bBombs[5] = !CockpitDB3F.this.fm.CT.Weapons[3][4].haveBullets();
                    }
                    if (CockpitDB3F.this.fm.CT.Weapons[3].length > 5) {
                        CockpitDB3F.this.bBombs[4] = !CockpitDB3F.this.fm.CT.Weapons[3][5].haveBullets();
                    }
                    if (CockpitDB3F.this.fm.CT.Weapons[3].length > 6) {
                        CockpitDB3F.this.bBombs[5] = CockpitDB3F.this.bBombs[5] || !CockpitDB3F.this.fm.CT.Weapons[3][6].haveBullets();
                    }
                    if (CockpitDB3F.this.fm.CT.Weapons[3].length > 7) {
                        CockpitDB3F.this.bBombs[4] = CockpitDB3F.this.bBombs[4] || !CockpitDB3F.this.fm.CT.Weapons[3][7].haveBullets();
                    }
                    if (CockpitDB3F.this.fm.CT.Weapons[3].length > 8) {
                        CockpitDB3F.this.bBombs[7] = !CockpitDB3F.this.fm.CT.Weapons[3][8].haveBullets();
                    }
                    if (CockpitDB3F.this.fm.CT.Weapons[3].length > 9) {
                        CockpitDB3F.this.bBombs[6] = !CockpitDB3F.this.fm.CT.Weapons[3][9].haveBullets();
                    }
                }
                CockpitDB3F.this.setNew.throttle1 = (0.9F * CockpitDB3F.this.setOld.throttle1) + (0.1F * CockpitDB3F.this.fm.EI.engines[0].getControlThrottle());
                CockpitDB3F.this.setNew.prop1 = (0.9F * CockpitDB3F.this.setOld.prop1) + (0.1F * CockpitDB3F.this.fm.EI.engines[0].getControlProp());
                CockpitDB3F.this.setNew.mix1 = (0.8F * CockpitDB3F.this.setOld.mix1) + (0.2F * CockpitDB3F.this.fm.EI.engines[0].getControlMix());
                CockpitDB3F.this.setNew.man1 = (0.92F * CockpitDB3F.this.setOld.man1) + (0.08F * CockpitDB3F.this.fm.EI.engines[0].getManifoldPressure());
                CockpitDB3F.this.setNew.throttle2 = (0.9F * CockpitDB3F.this.setOld.throttle2) + (0.1F * CockpitDB3F.this.fm.EI.engines[1].getControlThrottle());
                CockpitDB3F.this.setNew.prop2 = (0.9F * CockpitDB3F.this.setOld.prop2) + (0.1F * CockpitDB3F.this.fm.EI.engines[1].getControlProp());
                CockpitDB3F.this.setNew.mix2 = (0.8F * CockpitDB3F.this.setOld.mix2) + (0.2F * CockpitDB3F.this.fm.EI.engines[1].getControlMix());
                CockpitDB3F.this.setNew.man2 = (0.92F * CockpitDB3F.this.setOld.man2) + (0.08F * CockpitDB3F.this.fm.EI.engines[1].getManifoldPressure());
                CockpitDB3F.this.setNew.altimeter = CockpitDB3F.this.fm.getAltitude();
                if (Math.abs(CockpitDB3F.this.fm.Or.getKren()) < 30F) {
                    CockpitDB3F.this.setNew.azimuth.setDeg(CockpitDB3F.this.setOld.azimuth.getDeg(1.0F), CockpitDB3F.this.fm.Or.azimut());
                }
                CockpitDB3F.this.setNew.vspeed = ((100F * CockpitDB3F.this.setOld.vspeed) + CockpitDB3F.this.fm.getVertSpeed()) / 101F;
                if (CockpitDB3F.this.useRealisticNavigationInstruments()) {
                    CockpitDB3F.this.setNew.waypointAzimuth.setDeg(CockpitDB3F.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitDB3F.this.getBeaconDirection());
                } else {
                    CockpitDB3F.this.setNew.waypointAzimuth.setDeg(CockpitDB3F.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitDB3F.this.waypointAzimuth() - CockpitDB3F.this.setOld.azimuth.getDeg(1.0F));
                }
                CockpitDB3F.this.mesh.chunkSetAngles("Z_RTurret", CockpitDB3F.this.aircraft().FM.turret[0].tu[0], 0.0F, 0.0F);
                CockpitDB3F.this.mesh.chunkSetAngles("Z_RGun", -CockpitDB3F.this.aircraft().FM.turret[0].tu[1], 0.0F, 0.0F);
                CockpitDB3F.this.setNew.inert = (0.999F * CockpitDB3F.this.setOld.inert) + (0.001F * (CockpitDB3F.this.fm.EI.engines[0].getStage() == 6 ? 0.867F : 0.0F));
            }
            return true;
        }
    ...
    public CockpitDB3F() {
        super("3DO/Cockpit/Pe-3bis/CockpitDB3F.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitDB3F.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitDB3F.speedometerScale), 0.0F, 0.0F);
        this.resetYPRmodifier();
