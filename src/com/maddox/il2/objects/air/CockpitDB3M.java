...
public class CockpitDB3M extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitDB3M.this.fm != null) {
                CockpitDB3M.this.setTmp = CockpitDB3M.this.setOld;
                CockpitDB3M.this.setOld = CockpitDB3M.this.setNew;
                CockpitDB3M.this.setNew = CockpitDB3M.this.setTmp;
                if (CockpitDB3M.this.fm.CT.Weapons[3] != null) {
                    if (CockpitDB3M.this.fm.CT.Weapons[3].length > 0) {
                        CockpitDB3M.this.bBombs[1] = !CockpitDB3M.this.fm.CT.Weapons[3][0].haveBullets();
                    }
                    if (CockpitDB3M.this.fm.CT.Weapons[3].length > 1) {
                        CockpitDB3M.this.bBombs[0] = !CockpitDB3M.this.fm.CT.Weapons[3][1].haveBullets();
                    }
                    if (CockpitDB3M.this.fm.CT.Weapons[3].length > 2) {
                        CockpitDB3M.this.bBombs[3] = !CockpitDB3M.this.fm.CT.Weapons[3][2].haveBullets();
                    }
                    if (CockpitDB3M.this.fm.CT.Weapons[3].length > 3) {
                        CockpitDB3M.this.bBombs[2] = !CockpitDB3M.this.fm.CT.Weapons[3][3].haveBullets();
                    }
                    if (CockpitDB3M.this.fm.CT.Weapons[3].length > 4) {
                        CockpitDB3M.this.bBombs[5] = !CockpitDB3M.this.fm.CT.Weapons[3][4].haveBullets();
                    }
                    if (CockpitDB3M.this.fm.CT.Weapons[3].length > 5) {
                        CockpitDB3M.this.bBombs[4] = !CockpitDB3M.this.fm.CT.Weapons[3][5].haveBullets();
                    }
                    if (CockpitDB3M.this.fm.CT.Weapons[3].length > 6) {
                        CockpitDB3M.this.bBombs[5] = CockpitDB3M.this.bBombs[5] || !CockpitDB3M.this.fm.CT.Weapons[3][6].haveBullets();
                    }
                    if (CockpitDB3M.this.fm.CT.Weapons[3].length > 7) {
                        CockpitDB3M.this.bBombs[4] = CockpitDB3M.this.bBombs[4] || !CockpitDB3M.this.fm.CT.Weapons[3][7].haveBullets();
                    }
                    if (CockpitDB3M.this.fm.CT.Weapons[3].length > 8) {
                        CockpitDB3M.this.bBombs[7] = !CockpitDB3M.this.fm.CT.Weapons[3][8].haveBullets();
                    }
                    if (CockpitDB3M.this.fm.CT.Weapons[3].length > 9) {
                        CockpitDB3M.this.bBombs[6] = !CockpitDB3M.this.fm.CT.Weapons[3][9].haveBullets();
                    }
                }
                ...
                if (Math.abs(CockpitDB3M.this.fm.Or.getKren()) < 30F) {
                    CockpitDB3M.this.setNew.azimuth.setDeg(CockpitDB3M.this.setOld.azimuth.getDeg(1.0F), CockpitDB3M.this.fm.Or.azimut());
                }
                CockpitDB3M.this.setNew.vspeed = ((100F * CockpitDB3M.this.setOld.vspeed) + CockpitDB3M.this.fm.getVertSpeed()) / 101F;
                if (CockpitDB3M.this.useRealisticNavigationInstruments()) {
                    CockpitDB3M.this.setNew.waypointAzimuth.setDeg(CockpitDB3M.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitDB3M.this.getBeaconDirection());
                } else {
                    CockpitDB3M.this.setNew.waypointAzimuth.setDeg(CockpitDB3M.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitDB3M.this.waypointAzimuth() - CockpitDB3M.this.setOld.azimuth.getDeg(1.0F));
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitDB3M.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitDB3M.speedometerScale), 0.0F, 0.0F);
        this.resetYPRmodifier();
