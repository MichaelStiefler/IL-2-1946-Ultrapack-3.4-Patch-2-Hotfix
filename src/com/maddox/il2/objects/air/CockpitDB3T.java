...
public class CockpitDB3T extends CockpitPilot {
            ...
            if (CockpitDB3T.this.fm != null) {
                ...
                if (CockpitDB3T.this.fm.CT.Weapons[3] != null) {
                    if (CockpitDB3T.this.fm.CT.Weapons[3].length > 0) {
                        CockpitDB3T.this.bBombs[1] = !CockpitDB3T.this.fm.CT.Weapons[3][0].haveBullets();
                    }
                    if (CockpitDB3T.this.fm.CT.Weapons[3].length > 1) {
                        CockpitDB3T.this.bBombs[0] = !CockpitDB3T.this.fm.CT.Weapons[3][1].haveBullets();
                    }
                    if (CockpitDB3T.this.fm.CT.Weapons[3].length > 2) {
                        CockpitDB3T.this.bBombs[3] = !CockpitDB3T.this.fm.CT.Weapons[3][2].haveBullets();
                    }
                    if (CockpitDB3T.this.fm.CT.Weapons[3].length > 3) {
                        CockpitDB3T.this.bBombs[2] = !CockpitDB3T.this.fm.CT.Weapons[3][3].haveBullets();
                    }
                    if (CockpitDB3T.this.fm.CT.Weapons[3].length > 4) {
                        CockpitDB3T.this.bBombs[5] = !CockpitDB3T.this.fm.CT.Weapons[3][4].haveBullets();
                    }
                    if (CockpitDB3T.this.fm.CT.Weapons[3].length > 5) {
                        CockpitDB3T.this.bBombs[4] = !CockpitDB3T.this.fm.CT.Weapons[3][5].haveBullets();
                    }
                    if (CockpitDB3T.this.fm.CT.Weapons[3].length > 6) {
                        CockpitDB3T.this.bBombs[5] = CockpitDB3T.this.bBombs[5] || !CockpitDB3T.this.fm.CT.Weapons[3][6].haveBullets();
                    }
                    if (CockpitDB3T.this.fm.CT.Weapons[3].length > 7) {
                        CockpitDB3T.this.bBombs[4] = CockpitDB3T.this.bBombs[4] || !CockpitDB3T.this.fm.CT.Weapons[3][7].haveBullets();
                    }
                    if (CockpitDB3T.this.fm.CT.Weapons[3].length > 8) {
                        CockpitDB3T.this.bBombs[7] = !CockpitDB3T.this.fm.CT.Weapons[3][8].haveBullets();
                    }
                    if (CockpitDB3T.this.fm.CT.Weapons[3].length > 9) {
                        CockpitDB3T.this.bBombs[6] = !CockpitDB3T.this.fm.CT.Weapons[3][9].haveBullets();
                    }
                }
                CockpitDB3T.this.setNew.throttle1 = (0.9F * CockpitDB3T.this.setOld.throttle1) + (0.1F * CockpitDB3T.this.fm.EI.engines[0].getControlThrottle());
                CockpitDB3T.this.setNew.prop1 = (0.9F * CockpitDB3T.this.setOld.prop1) + (0.1F * CockpitDB3T.this.fm.EI.engines[0].getControlProp());
                CockpitDB3T.this.setNew.mix1 = (0.8F * CockpitDB3T.this.setOld.mix1) + (0.2F * CockpitDB3T.this.fm.EI.engines[0].getControlMix());
                CockpitDB3T.this.setNew.man1 = (0.92F * CockpitDB3T.this.setOld.man1) + (0.08F * CockpitDB3T.this.fm.EI.engines[0].getManifoldPressure());
                CockpitDB3T.this.setNew.throttle2 = (0.9F * CockpitDB3T.this.setOld.throttle2) + (0.1F * CockpitDB3T.this.fm.EI.engines[1].getControlThrottle());
                CockpitDB3T.this.setNew.prop2 = (0.9F * CockpitDB3T.this.setOld.prop2) + (0.1F * CockpitDB3T.this.fm.EI.engines[1].getControlProp());
                CockpitDB3T.this.setNew.mix2 = (0.8F * CockpitDB3T.this.setOld.mix2) + (0.2F * CockpitDB3T.this.fm.EI.engines[1].getControlMix());
                CockpitDB3T.this.setNew.man2 = (0.92F * CockpitDB3T.this.setOld.man2) + (0.08F * CockpitDB3T.this.fm.EI.engines[1].getManifoldPressure());
                CockpitDB3T.this.setNew.altimeter = CockpitDB3T.this.fm.getAltitude();
                if (Math.abs(CockpitDB3T.this.fm.Or.getKren()) < 30F) {
                    CockpitDB3T.this.setNew.azimuth.setDeg(CockpitDB3T.this.setOld.azimuth.getDeg(1.0F), CockpitDB3T.this.fm.Or.azimut());
                }
                CockpitDB3T.this.setNew.vspeed = ((100F * CockpitDB3T.this.setOld.vspeed) + CockpitDB3T.this.fm.getVertSpeed()) / 101F;
                if (CockpitDB3T.this.useRealisticNavigationInstruments()) {
                    CockpitDB3T.this.setNew.waypointAzimuth.setDeg(CockpitDB3T.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitDB3T.this.getBeaconDirection());
                } else {
                    CockpitDB3T.this.setNew.waypointAzimuth.setDeg(CockpitDB3T.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitDB3T.this.waypointAzimuth() - CockpitDB3T.this.setOld.azimuth.getDeg(1.0F));
                }
                CockpitDB3T.this.mesh.chunkSetAngles("Z_RTurret", CockpitDB3T.this.aircraft().FM.turret[0].tu[0], 0.0F, 0.0F);
                CockpitDB3T.this.mesh.chunkSetAngles("Z_RGun", -CockpitDB3T.this.aircraft().FM.turret[0].tu[1], 0.0F, 0.0F);
                CockpitDB3T.this.setNew.inert = (0.999F * CockpitDB3T.this.setOld.inert) + (0.001F * (CockpitDB3T.this.fm.EI.engines[0].getStage() == 6 ? 0.867F : 0.0F));
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitDB3T.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitDB3T.speedometerScale), 0.0F, 0.0F);
        this.resetYPRmodifier();
