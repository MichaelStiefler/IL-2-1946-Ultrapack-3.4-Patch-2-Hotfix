...
public class CockpitDO_335 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitDO_335.this.fm != null) {
                ...
                if (Math.abs(CockpitDO_335.this.fm.Or.getKren()) < 30F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speed1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitDO_335.speedometerScale), 0.0F, 0.0F);
        float f1 = this.setNew.vspeed <= 0.0F ? -1F : 1.0F;
        this.mesh.chunkSetAngles("Z_Climb1", f1 * this.floatindex(this.cvt(Math.abs(this.setNew.vspeed), 0.0F, 30F, 0.0F, 6F), CockpitDO_335.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitDO_335.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitDO_335.rpmScale), 0.0F, 0.0F);
