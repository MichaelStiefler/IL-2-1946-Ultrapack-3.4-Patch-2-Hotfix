...
public class CockpitDO_335V13 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitDO_335V13.this.fm != null) {
                CockpitDO_335V13.this.setTmp = CockpitDO_335V13.this.setOld;
                CockpitDO_335V13.this.setOld = CockpitDO_335V13.this.setNew;
                CockpitDO_335V13.this.setNew = CockpitDO_335V13.this.setTmp;
                ...
                if (CockpitDO_335V13.this.useRealisticNavigationInstruments()) {
                    CockpitDO_335V13.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitDO_335V13.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                ...
                if (Math.abs(CockpitDO_335V13.this.fm.Or.getKren()) < 30F) {
                ...
                CockpitDO_335V13.this.setNew.vspeed = ((199F * CockpitDO_335V13.this.setOld.vspeed) + CockpitDO_335V13.this.fm.getVertSpeed()) / 200F;
                if (CockpitDO_335V13.this.cockpitDimControl) {
                    if (CockpitDO_335V13.this.setNew.dimPosition > 0.0F) {
                        CockpitDO_335V13.this.setNew.dimPosition = CockpitDO_335V13.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitDO_335V13.this.setNew.dimPosition < 1.0F) {
                    CockpitDO_335V13.this.setNew.dimPosition = CockpitDO_335V13.this.setOld.dimPosition + 0.05F;
                }
                CockpitDO_335V13.this.setNew.radioalt = (0.9F * CockpitDO_335V13.this.setOld.radioalt) + (0.1F * (CockpitDO_335V13.this.fm.getAltitude() - Landscape.HQ_Air((float) CockpitDO_335V13.this.fm.Loc.x, (float) CockpitDO_335V13.this.fm.Loc.y)));
                CockpitDO_335V13.this.setNew.beaconDirection = ((10F * CockpitDO_335V13.this.setOld.beaconDirection) + CockpitDO_335V13.this.getBeaconDirection()) / 11F;
                CockpitDO_335V13.this.setNew.beaconRange = ((10F * CockpitDO_335V13.this.setOld.beaconRange) + CockpitDO_335V13.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.resetYPRmodifier();
        Cockpit.xyz[2] = 0.12F * this.fm.CT.getRudder();
        ...
        this.resetYPRmodifier();
        Cockpit.xyz[1] = 0.065F * this.fm.CT.BayDoorControl;
        this.mesh.chunkSetLocate("Z_BombBay", Cockpit.xyz, Cockpit.ypr);
        this.resetYPRmodifier();
        Cockpit.xyz[2] = this.cvt(this.gun[0].countBullets(), 0.0F, 500F, -0.00465F, 0.04175F);
        this.mesh.chunkSetLocate("Z_AmmoCounter1", Cockpit.xyz, Cockpit.ypr);
        Cockpit.xyz[2] = this.cvt(this.gun[2].countBullets(), 0.0F, 100F, -0.00465F, 0.04175F);
        this.mesh.chunkSetLocate("Z_AmmoCounter2", Cockpit.xyz, Cockpit.ypr);
        Cockpit.xyz[2] = this.cvt(this.gun[1].countBullets(), 0.0F, 500F, -0.00465F, 0.04175F);
        this.mesh.chunkSetLocate("Z_AmmoCounter3", Cockpit.xyz, Cockpit.ypr);
        Cockpit.xyz[2] = this.cvt(this.gun[3].countBullets(), 0.0F, 100F, -0.00465F, 0.04175F);
        this.mesh.chunkSetLocate("Z_AmmoCounter4", Cockpit.xyz, Cockpit.ypr);
        Cockpit.xyz[2] = this.cvt(this.gun[4].countBullets(), 0.0F, 100F, -0.00465F, 0.04175F);
        this.mesh.chunkSetLocate("Z_AmmoCounter5", Cockpit.xyz, Cockpit.ypr);
        ...
        this.mesh.chunkSetAngles("Z_Speed1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitDO_335V13.speedometerScale), 0.0F, 0.0F);
        float f1 = this.setNew.vspeed <= 0.0F ? -1F : 1.0F;
        this.mesh.chunkSetAngles("Z_Climb1", f1 * this.floatindex(this.cvt(Math.abs(this.setNew.vspeed), 0.0F, 30F, 0.0F, 6F), CockpitDO_335V13.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitDO_335V13.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitDO_335V13.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Oiltemp1", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 57F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Oiltemp2", this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 57F), 0.0F, 0.0F);
    ...
    protected float waypointAzimuth() {
        return this.waypointAzimuthInvertMinus(15F);
    }
