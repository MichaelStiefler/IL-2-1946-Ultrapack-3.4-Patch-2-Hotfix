...
public class CockpitDXXI_SARJA3_LATE extends CockpitPilot {
    private class Variables {
        ...
        private Variables() {
            ...
            this.compassPoint[0] = new Vector3d(0.0D, Math.sqrt(1.0D - (CockpitDXXI_SARJA3_LATE.compassZ * CockpitDXXI_SARJA3_LATE.compassZ)), CockpitDXXI_SARJA3_LATE.compassZ);
            this.compassPoint[1] = new Vector3d(-Math.sqrt(1.0D - (CockpitDXXI_SARJA3_LATE.compassZ * CockpitDXXI_SARJA3_LATE.compassZ)), 0.0D, CockpitDXXI_SARJA3_LATE.compassZ);
            this.compassPoint[2] = new Vector3d(0.0D, -Math.sqrt(1.0D - (CockpitDXXI_SARJA3_LATE.compassZ * CockpitDXXI_SARJA3_LATE.compassZ)), CockpitDXXI_SARJA3_LATE.compassZ);
            this.compassPoint[3] = new Vector3d(Math.sqrt(1.0D - (CockpitDXXI_SARJA3_LATE.compassZ * CockpitDXXI_SARJA3_LATE.compassZ)), 0.0D, CockpitDXXI_SARJA3_LATE.compassZ);
            this.cP[0] = new Vector3d(0.0D, Math.sqrt(1.0D - (CockpitDXXI_SARJA3_LATE.compassZ * CockpitDXXI_SARJA3_LATE.compassZ)), CockpitDXXI_SARJA3_LATE.compassZ);
            this.cP[1] = new Vector3d(-Math.sqrt(1.0D - (CockpitDXXI_SARJA3_LATE.compassZ * CockpitDXXI_SARJA3_LATE.compassZ)), 0.0D, CockpitDXXI_SARJA3_LATE.compassZ);
            this.cP[2] = new Vector3d(0.0D, -Math.sqrt(1.0D - (CockpitDXXI_SARJA3_LATE.compassZ * CockpitDXXI_SARJA3_LATE.compassZ)), CockpitDXXI_SARJA3_LATE.compassZ);
            this.cP[3] = new Vector3d(Math.sqrt(1.0D - (CockpitDXXI_SARJA3_LATE.compassZ * CockpitDXXI_SARJA3_LATE.compassZ)), 0.0D, CockpitDXXI_SARJA3_LATE.compassZ);
        }
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitDXXI_SARJA3_LATE.this.bNeedSetUp) {
                CockpitDXXI_SARJA3_LATE.this.reflectPlaneMats();
                CockpitDXXI_SARJA3_LATE.this.bNeedSetUp = false;
            }
            if ((CockpitDXXI_SARJA3_LATE.this.ac != null) && CockpitDXXI_SARJA3_LATE.this.ac.bChangedPit) {
                CockpitDXXI_SARJA3_LATE.this.reflectPlaneToModel();
                CockpitDXXI_SARJA3_LATE.this.ac.bChangedPit = false;
            }
            CockpitDXXI_SARJA3_LATE.this.setTmp = CockpitDXXI_SARJA3_LATE.this.setOld;
            CockpitDXXI_SARJA3_LATE.this.setOld = CockpitDXXI_SARJA3_LATE.this.setNew;
            CockpitDXXI_SARJA3_LATE.this.setNew = CockpitDXXI_SARJA3_LATE.this.setTmp;
            if (((CockpitDXXI_SARJA3_LATE.this.fm.AS.astateCockpitState & 2) != 0) && (CockpitDXXI_SARJA3_LATE.this.setNew.stbyPosition < 1.0F)) {
                CockpitDXXI_SARJA3_LATE.this.setNew.stbyPosition = CockpitDXXI_SARJA3_LATE.this.setOld.stbyPosition + 0.0125F;
                CockpitDXXI_SARJA3_LATE.this.setOld.stbyPosition = CockpitDXXI_SARJA3_LATE.this.setNew.stbyPosition;
            }
            CockpitDXXI_SARJA3_LATE.this.setNew.altimeter = CockpitDXXI_SARJA3_LATE.this.fm.getAltitude();
            if (CockpitDXXI_SARJA3_LATE.this.useRealisticNavigationInstruments()) {
                if (Math.abs(CockpitDXXI_SARJA3_LATE.this.fm.Or.getKren()) < 30F) {
                    CockpitDXXI_SARJA3_LATE.this.setNew.azimuth.setDeg(CockpitDXXI_SARJA3_LATE.this.setOld.azimuth.getDeg(1.0F), CockpitDXXI_SARJA3_LATE.this.fm.Or.azimut() + CockpitDXXI_SARJA3_LATE.this.ac.gyroDelta);
                }
            } else {
                if (Math.abs(CockpitDXXI_SARJA3_LATE.this.fm.Or.getKren()) < 30F) {
                    CockpitDXXI_SARJA3_LATE.this.setNew.azimuth.setDeg(CockpitDXXI_SARJA3_LATE.this.setOld.azimuth.getDeg(1.0F), CockpitDXXI_SARJA3_LATE.this.fm.Or.azimut());
                }
            }
            CockpitDXXI_SARJA3_LATE.this.setNew.throttle = ((10F * CockpitDXXI_SARJA3_LATE.this.setOld.throttle) + CockpitDXXI_SARJA3_LATE.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitDXXI_SARJA3_LATE.this.setNew.mix = ((10F * CockpitDXXI_SARJA3_LATE.this.setOld.mix) + CockpitDXXI_SARJA3_LATE.this.fm.EI.engines[0].getControlMix()) / 11F;
            CockpitDXXI_SARJA3_LATE.this.setNew.prop = CockpitDXXI_SARJA3_LATE.this.setOld.prop;
            if (CockpitDXXI_SARJA3_LATE.this.setNew.prop < (CockpitDXXI_SARJA3_LATE.this.fm.EI.engines[0].getControlProp() - 0.01F)) {
                CockpitDXXI_SARJA3_LATE.this.setNew.prop += 0.0025F;
            }
            if (CockpitDXXI_SARJA3_LATE.this.setNew.prop > (CockpitDXXI_SARJA3_LATE.this.fm.EI.engines[0].getControlProp() + 0.01F)) {
                CockpitDXXI_SARJA3_LATE.this.setNew.prop -= 0.0025F;
            }
            CockpitDXXI_SARJA3_LATE.this.w.set(CockpitDXXI_SARJA3_LATE.this.fm.getW());
            CockpitDXXI_SARJA3_LATE.this.fm.Or.transform(CockpitDXXI_SARJA3_LATE.this.w);
            CockpitDXXI_SARJA3_LATE.this.setNew.turn = ((12F * CockpitDXXI_SARJA3_LATE.this.setOld.turn) + CockpitDXXI_SARJA3_LATE.this.w.z) / 13F;
            CockpitDXXI_SARJA3_LATE.this.setNew.vspeed = ((299F * CockpitDXXI_SARJA3_LATE.this.setOld.vspeed) + CockpitDXXI_SARJA3_LATE.this.fm.getVertSpeed()) / 300F;
            CockpitDXXI_SARJA3_LATE.this.pictSupc = (0.8F * CockpitDXXI_SARJA3_LATE.this.pictSupc) + (0.2F * CockpitDXXI_SARJA3_LATE.this.fm.EI.engines[0].getControlCompressor());
            if (CockpitDXXI_SARJA3_LATE.this.cockpitDimControl) {
                if (CockpitDXXI_SARJA3_LATE.this.setNew.dimPos < 1.0F) {
                    CockpitDXXI_SARJA3_LATE.this.setNew.dimPos = CockpitDXXI_SARJA3_LATE.this.setOld.dimPos + 0.03F;
                }
            } else if (CockpitDXXI_SARJA3_LATE.this.setNew.dimPos > 0.0F) {
                CockpitDXXI_SARJA3_LATE.this.setNew.dimPos = CockpitDXXI_SARJA3_LATE.this.setOld.dimPos - 0.03F;
            }
            if (CockpitDXXI_SARJA3_LATE.this.flaps == CockpitDXXI_SARJA3_LATE.this.fm.CT.getFlap()) {
                CockpitDXXI_SARJA3_LATE.this.flapsDirection = 0;
                CockpitDXXI_SARJA3_LATE.this.sfxStop(16);
            } else if (CockpitDXXI_SARJA3_LATE.this.flaps < CockpitDXXI_SARJA3_LATE.this.fm.CT.getFlap()) {
                if (CockpitDXXI_SARJA3_LATE.this.flapsDirection == 0) {
                    CockpitDXXI_SARJA3_LATE.this.sfxStart(16);
                }
                CockpitDXXI_SARJA3_LATE.this.flaps = CockpitDXXI_SARJA3_LATE.this.fm.CT.getFlap();
                CockpitDXXI_SARJA3_LATE.this.flapsPump = CockpitDXXI_SARJA3_LATE.this.flapsPump + CockpitDXXI_SARJA3_LATE.this.flapsPumpIncrement;
                CockpitDXXI_SARJA3_LATE.this.flapsDirection = 1;
                if ((CockpitDXXI_SARJA3_LATE.this.flapsPump < 0.0F) || (CockpitDXXI_SARJA3_LATE.this.flapsPump > 1.0F)) {
                    CockpitDXXI_SARJA3_LATE.this.flapsPumpIncrement = -CockpitDXXI_SARJA3_LATE.this.flapsPumpIncrement;
                }
            } else if (CockpitDXXI_SARJA3_LATE.this.flaps > CockpitDXXI_SARJA3_LATE.this.fm.CT.getFlap()) {
                if (CockpitDXXI_SARJA3_LATE.this.flapsDirection == 0) {
                    CockpitDXXI_SARJA3_LATE.this.sfxStart(16);
            ...
            if (!CockpitDXXI_SARJA3_LATE.this.fm.Gears.bTailwheelLocked && (CockpitDXXI_SARJA3_LATE.this.tailWheelLock < 1.0F)) {
                CockpitDXXI_SARJA3_LATE.this.tailWheelLock = CockpitDXXI_SARJA3_LATE.this.tailWheelLock + 0.05F;
            } else if (CockpitDXXI_SARJA3_LATE.this.fm.Gears.bTailwheelLocked && (CockpitDXXI_SARJA3_LATE.this.tailWheelLock > 0.0F)) {
                CockpitDXXI_SARJA3_LATE.this.tailWheelLock = CockpitDXXI_SARJA3_LATE.this.tailWheelLock - 0.05F;
            }
            CockpitDXXI_SARJA3_LATE.this.updateCompass();
            return true;
        }
    ...
    public CockpitDXXI_SARJA3_LATE() {
        super("3DO/Cockpit/DXXI_SARJA3_LATE/hier.him", "bf109");
        ...
        this.compassFirst = 0;
        this.ac = (DXXI_SARJA3_LATE) this.aircraft();
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (((DXXI_SARJA3_LATE) this.aircraft()).bChangedPit) {
            this.reflectPlaneToModel();
            ((DXXI_SARJA3_LATE) this.aircraft()).bChangedPit = false;
        }
    ...
    private void initCompass() {
        ...
        this.segLen1 = 2D * Math.sqrt(1.0D - (CockpitDXXI_SARJA3_LATE.compassZ * CockpitDXXI_SARJA3_LATE.compassZ));
        this.segLen2 = this.segLen1 / Math.sqrt(2D);
        this.compassLimit = -1D * Math.sin(0.01745328888888889D * CockpitDXXI_SARJA3_LATE.compassLimitAngle);
    ...
    private void updateCompass() {
        ...
        if (this.accel.length() > (-CockpitDXXI_SARJA3_LATE.compassZ * 0.7D)) {
            this.accel.scale((-CockpitDXXI_SARJA3_LATE.compassZ * 0.7D) / this.accel.length());
        }
        for (int i = 0; i < 4; i++) {
        ...
        vector3d1.normalize();
        vector3d1.scale(-CockpitDXXI_SARJA3_LATE.compassZ);
