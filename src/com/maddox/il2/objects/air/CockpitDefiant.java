...
public class CockpitDefiant extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitDefiant.this.bNeedSetUp) {
                CockpitDefiant.this.reflectPlaneMats();
                CockpitDefiant.this.bNeedSetUp = false;
            }
            if (CockpitDefiant.this.fm != null) {
                CockpitDefiant.this.setTmp = CockpitDefiant.this.setOld;
                CockpitDefiant.this.setOld = CockpitDefiant.this.setNew;
                CockpitDefiant.this.setNew = CockpitDefiant.this.setTmp;
                CockpitDefiant.this.setNew.throttle = ((10F * CockpitDefiant.this.setOld.throttle) + CockpitDefiant.this.fm.CT.PowerControl) / 11F;
                CockpitDefiant.this.setNew.altimeter = CockpitDefiant.this.fm.getAltitude();
                CockpitDefiant.this.setNew.waypointAzimuth.setDeg(CockpitDefiant.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitDefiant.this.waypointAzimuth() - CockpitDefiant.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitDefiant.this.fm.Or.getKren()) < 30F) {
                    CockpitDefiant.this.setNew.azimuth.setDeg(CockpitDefiant.this.setOld.azimuth.getDeg(1.0F), CockpitDefiant.this.fm.Or.azimut());
                }
                CockpitDefiant.this.setNew.vspeed = ((199F * CockpitDefiant.this.setOld.vspeed) + CockpitDefiant.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitDefiant.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 100F, 0.0F, 270F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitDefiant.radScale));
        this.resetYPRmodifier();
        ...
        if (this.bFAF) {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 143.0528F, 0.0F, 32F), CockpitDefiant.speedometerScaleFAF));
        } else {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 180.0555F, 0.0F, 35F), CockpitDefiant.speedometerScale));
        }
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitDefiant.variometerScale));
