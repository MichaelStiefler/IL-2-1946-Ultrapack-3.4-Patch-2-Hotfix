    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitDefiantF.this.fm != null) {
                ...
                float f = CockpitDefiantF.this.waypointAzimuth();
                if (CockpitDefiantF.this.useRealisticNavigationInstruments()) {
                    CockpitDefiantF.this.setNew.waypointAzimuth.setDeg(f - 90.0F);
                    CockpitDefiantF.this.setOld.waypointAzimuth.setDeg(f - 90.0F);
                } else {
                    CockpitDefiantF.this.setNew.waypointAzimuth.setDeg(CockpitDefiantF.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitDefiantF.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitDefiantF.this.fm.Or.getKren()) < 30F) {
                    CockpitDefiantF.this.setNew.azimuth.setDeg(CockpitDefiantF.this.setOld.azimuth.getDeg(1.0F), CockpitDefiantF.this.fm.Or.azimut());
                }
