...
public class CockpitDo17 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitDo17.this.cockpitDimControl) {
                if (CockpitDo17.this.setNew.dimPosition > 0.0F) {
                    CockpitDo17.this.setNew.dimPosition = CockpitDo17.this.setNew.dimPosition - 0.05F;
                }
            } else if (CockpitDo17.this.setNew.dimPosition < 1.0F) {
                CockpitDo17.this.setNew.dimPosition = CockpitDo17.this.setNew.dimPosition + 0.05F;
            }
            ...
            if (CockpitDo17.this.useRealisticNavigationInstruments()) {
                ...
                CockpitDo17.this.setNew.waypointAzimuth.setDeg(CockpitDo17.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitDo17.this.setOld.azimuth.getDeg(1.0F));
            }
            if (Math.abs(CockpitDo17.this.fm.Or.getKren()) < 30F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("TempMeter", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 213.09F, 293.09F, 0.0F, 8F), CockpitDo17.frAirTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 750F, 0.0F, 14F), CockpitDo17.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zSpeed2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 50F, 750F, 0.0F, 14F), CockpitDo17.speedometerScale2), 0.0F, 0.0F);
