...
public class CockpitDo217_E2 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitDo217_E2.this.fm != null) {
                ...
                if (Math.abs(CockpitDo217_E2.this.fm.Or.getKren()) < 30F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("z_Speed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 800F, 0.0F, 15F), CockpitDo217_E2.speedometerScale), 0.0F);
        this.mesh.chunkSetAngles("z_VelX", 0.0F, this.floatindex(this.cvt(this.fm.getSpeedKMH(), 50F, 800F, 0.0F, 15F), CockpitDo217_E2.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("z_OAT", 0.0F, this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z) - 273.15F, -60F, 40F, 0.0F, 10F), CockpitDo217_E2.OATscale), 0.0F);
