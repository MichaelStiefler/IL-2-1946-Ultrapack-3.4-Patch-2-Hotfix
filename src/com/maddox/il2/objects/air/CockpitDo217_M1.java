...
public class CockpitDo217_M1 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            CockpitDo217_M1.this.setTmp = CockpitDo217_M1.this.setOld;
            CockpitDo217_M1.this.setOld = CockpitDo217_M1.this.setNew;
            CockpitDo217_M1.this.setNew = CockpitDo217_M1.this.setTmp;
            if (CockpitDo217_M1.this.cockpitDimControl) {
                if (CockpitDo217_M1.this.setNew.dimPos < 1.0F) {
                    CockpitDo217_M1.this.setNew.dimPos = CockpitDo217_M1.this.setOld.dimPos + 0.03F;
                }
            } else if (CockpitDo217_M1.this.setNew.dimPos > 0.0F) {
                CockpitDo217_M1.this.setNew.dimPos = CockpitDo217_M1.this.setOld.dimPos - 0.03F;
            }
            CockpitDo217_M1.this.setNew.altimeter = CockpitDo217_M1.this.fm.getAltitude();
            CockpitDo217_M1.this.setNew.throttlel = ((10F * CockpitDo217_M1.this.setOld.throttlel) + CockpitDo217_M1.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitDo217_M1.this.setNew.throttler = ((10F * CockpitDo217_M1.this.setOld.throttler) + CockpitDo217_M1.this.fm.EI.engines[1].getControlThrottle()) / 11F;
            CockpitDo217_M1.this.setNew.vspeed = ((499F * CockpitDo217_M1.this.setOld.vspeed) + CockpitDo217_M1.this.fm.getVertSpeed()) / 500F;
            CockpitDo217_M1.this.setNew.elevTrim = (0.85F * CockpitDo217_M1.this.setOld.elevTrim) + (CockpitDo217_M1.this.fm.CT.getTrimElevatorControl() * 0.15F);
            CockpitDo217_M1.this.setNew.rudderTrim = (0.85F * CockpitDo217_M1.this.setOld.rudderTrim) + (CockpitDo217_M1.this.fm.CT.getTrimRudderControl() * 0.15F);
            CockpitDo217_M1.this.setNew.ailTrim = (0.85F * CockpitDo217_M1.this.setOld.ailTrim) + (CockpitDo217_M1.this.fm.CT.getTrimAileronControl() * 0.15F);
            CockpitDo217_M1.this.setNew.propL = (0.85F * CockpitDo217_M1.this.setOld.propL) + (CockpitDo217_M1.this.fm.EI.engines[0].getControlProp() * 0.15F);
            CockpitDo217_M1.this.setNew.propR = (0.85F * CockpitDo217_M1.this.setOld.propR) + (CockpitDo217_M1.this.fm.EI.engines[1].getControlProp() * 0.15F);
            float f = CockpitDo217_M1.this.prevFuel - CockpitDo217_M1.this.fm.M.fuel;
            CockpitDo217_M1.this.prevFuel = CockpitDo217_M1.this.fm.M.fuel;
            f /= 0.72F;
            f /= Time.tickLenFs();
            f *= 3600F;
            CockpitDo217_M1.this.setNew.cons = (0.91F * CockpitDo217_M1.this.setOld.cons) + (0.09F * f);
            float f1 = CockpitDo217_M1.this.waypointAzimuth();
            if (CockpitDo217_M1.this.useRealisticNavigationInstruments()) {
                CockpitDo217_M1.this.setNew.waypointAzimuth.setDeg(f1 - 90F);
                CockpitDo217_M1.this.setOld.waypointAzimuth.setDeg(f1 - 90F);
                CockpitDo217_M1.this.setNew.radioCompassAzimuth.setDeg(CockpitDo217_M1.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitDo217_M1.this.radioCompassAzimuthInvertMinus() - CockpitDo217_M1.this.setOld.azimuth.getDeg(1.0F) - 90F);
            } else {
                CockpitDo217_M1.this.setNew.waypointAzimuth.setDeg(CockpitDo217_M1.this.setOld.waypointAzimuth.getDeg(0.1F), f1 - CockpitDo217_M1.this.setOld.azimuth.getDeg(1.0F));
            }
            if (Math.abs(CockpitDo217_M1.this.fm.Or.getKren()) < 30F) {
                CockpitDo217_M1.this.setNew.azimuth.setDeg(CockpitDo217_M1.this.setOld.azimuth.getDeg(1.0F), CockpitDo217_M1.this.fm.Or.azimut());
            }
            CockpitDo217_M1.this.setNew.beaconDirection = ((10F * CockpitDo217_M1.this.setOld.beaconDirection) + CockpitDo217_M1.this.getBeaconDirection()) / 11F;
            CockpitDo217_M1.this.setNew.beaconRange = ((10F * CockpitDo217_M1.this.setOld.beaconRange) + CockpitDo217_M1.this.getBeaconRange()) / 11F;
            return true;
        }
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            ...
            if (this.aircraft() instanceof Do217_M1) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("z_Speed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 800F, 0.0F, 15F), CockpitDo217_M1.speedometerScale), 0.0F);
        this.mesh.chunkSetAngles("z_VelX", 0.0F, this.floatindex(this.cvt(this.fm.getSpeedKMH(), 50F, 800F, 0.0F, 15F), CockpitDo217_M1.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("z_OAT", 0.0F, this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z) - 273.15F, -60F, 40F, 0.0F, 10F), CockpitDo217_M1.OATscale), 0.0F);
