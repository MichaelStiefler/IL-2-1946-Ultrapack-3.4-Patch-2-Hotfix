...
public class CockpitDo_18 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitDo_18.this.fm != null) {
                CockpitDo_18.this.setTmp = CockpitDo_18.this.setOld;
                CockpitDo_18.this.setOld = CockpitDo_18.this.setNew;
                CockpitDo_18.this.setNew = CockpitDo_18.this.setTmp;
                CockpitDo_18.this.setNew.throttle1 = (0.85F * CockpitDo_18.this.setOld.throttle1) + (CockpitDo_18.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitDo_18.this.setNew.throttle2 = (0.85F * CockpitDo_18.this.setOld.throttle2) + (CockpitDo_18.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitDo_18.this.setNew.prop1 = (0.85F * CockpitDo_18.this.setOld.prop1) + (CockpitDo_18.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitDo_18.this.setNew.prop2 = (0.85F * CockpitDo_18.this.setOld.prop2) + (CockpitDo_18.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitDo_18.this.setNew.altimeter = CockpitDo_18.this.fm.getAltitude();
                float f = CockpitDo_18.this.waypointAzimuth();
                if (Math.abs(CockpitDo_18.this.fm.Or.getKren()) < 30F) {
                    CockpitDo_18.this.setNew.azimuth.setDeg(CockpitDo_18.this.setOld.azimuth.getDeg(1.0F), CockpitDo_18.this.fm.Or.azimut());
                }
                CockpitDo_18.this.setNew.waypointAzimuth.setDeg(CockpitDo_18.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitDo_18.this.setNew.waypointDeviation.setDeg(CockpitDo_18.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitDo_18.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitDo_18.this.setNew.vspeed = ((199F * CockpitDo_18.this.setOld.vspeed) + CockpitDo_18.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitDo_18() {
        super("3DO/Cockpit/Do_18-P/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitDo_18.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitDo_18.speedometerScale), 0.0F);
