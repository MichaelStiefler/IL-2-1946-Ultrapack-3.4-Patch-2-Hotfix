...
public class CockpitDo_24T extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitDo_24T.this.fm != null) {
                CockpitDo_24T.this.setTmp = CockpitDo_24T.this.setOld;
                CockpitDo_24T.this.setOld = CockpitDo_24T.this.setNew;
                CockpitDo_24T.this.setNew = CockpitDo_24T.this.setTmp;
                CockpitDo_24T.this.setNew.throttle1 = (0.85F * CockpitDo_24T.this.setOld.throttle1) + (CockpitDo_24T.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitDo_24T.this.setNew.prop1 = (0.85F * CockpitDo_24T.this.setOld.prop1) + (CockpitDo_24T.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitDo_24T.this.setNew.throttle2 = (0.85F * CockpitDo_24T.this.setOld.throttle2) + (CockpitDo_24T.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitDo_24T.this.setNew.prop2 = (0.85F * CockpitDo_24T.this.setOld.prop2) + (CockpitDo_24T.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitDo_24T.this.setNew.throttle3 = (0.85F * CockpitDo_24T.this.setOld.throttle3) + (CockpitDo_24T.this.fm.EI.engines[2].getControlThrottle() * 0.15F);
                CockpitDo_24T.this.setNew.prop3 = (0.85F * CockpitDo_24T.this.setOld.prop3) + (CockpitDo_24T.this.fm.EI.engines[2].getControlProp() * 0.15F);
                CockpitDo_24T.this.setNew.altimeter = CockpitDo_24T.this.fm.getAltitude();
                float f = CockpitDo_24T.this.waypointAzimuth();
                if (Math.abs(CockpitDo_24T.this.fm.Or.getKren()) < 30F) {
                    CockpitDo_24T.this.setNew.azimuth.setDeg(CockpitDo_24T.this.setOld.azimuth.getDeg(1.0F), CockpitDo_24T.this.fm.Or.azimut());
                }
                if (CockpitDo_24T.this.useRealisticNavigationInstruments()) {
                    CockpitDo_24T.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitDo_24T.this.setOld.waypointAzimuth.setDeg(f - 90F);
                    CockpitDo_24T.this.setNew.radioCompassAzimuth.setDeg(CockpitDo_24T.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitDo_24T.this.radioCompassAzimuthInvertMinus() - CockpitDo_24T.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    CockpitDo_24T.this.setNew.waypointAzimuth.setDeg(CockpitDo_24T.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                    CockpitDo_24T.this.setNew.radioCompassAzimuth.setDeg(CockpitDo_24T.this.setOld.radioCompassAzimuth.getDeg(0.1F), f - CockpitDo_24T.this.setOld.azimuth.getDeg(0.1F) - 90F);
                }
                CockpitDo_24T.this.setNew.vspeed = ((199F * CockpitDo_24T.this.setOld.vspeed) + CockpitDo_24T.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitDo_24T() {
        super("3DO/Cockpit/Do_24T/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST1", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitDo_24T.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST2", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitDo_24T.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST3", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitDo_24T.boostScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM_SHORT1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitDo_24T.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM_LONG1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 80F), CockpitDo_24T.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM_SHORT2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitDo_24T.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM_LONG2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 80F), CockpitDo_24T.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM_SHORT3", this.floatindex(this.cvt(this.fm.EI.engines[2].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitDo_24T.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM_LONG3", this.floatindex(this.cvt(this.fm.EI.engines[2].getRPM(), 0.0F, 4000F, 0.0F, 80F), CockpitDo_24T.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TEMP_RAD1", this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitDo_24T.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_TEMP_RAD2", this.floatindex(this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitDo_24T.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_TEMP_RAD3", this.floatindex(this.cvt(this.fm.EI.engines[2].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitDo_24T.radScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 400F, 0.0F, 16F), CockpitDo_24T.speedometerScale), 0.0F, 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("STR_CLIMB", this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitDo_24T.variometerScale), 0.0F, 0.0F);
        }
