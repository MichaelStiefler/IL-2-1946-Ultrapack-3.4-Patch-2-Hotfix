...
public class CockpitDo_26 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitDo_26.this.fm != null) {
                CockpitDo_26.this.setTmp = CockpitDo_26.this.setOld;
                CockpitDo_26.this.setOld = CockpitDo_26.this.setNew;
                CockpitDo_26.this.setNew = CockpitDo_26.this.setTmp;
                CockpitDo_26.this.setNew.throttle1 = (0.85F * CockpitDo_26.this.setOld.throttle1) + (CockpitDo_26.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitDo_26.this.setNew.throttle2 = (0.85F * CockpitDo_26.this.setOld.throttle2) + (CockpitDo_26.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitDo_26.this.setNew.prop1 = (0.85F * CockpitDo_26.this.setOld.prop1) + (CockpitDo_26.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitDo_26.this.setNew.prop2 = (0.85F * CockpitDo_26.this.setOld.prop2) + (CockpitDo_26.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitDo_26.this.setNew.altimeter = CockpitDo_26.this.fm.getAltitude();
                float f = CockpitDo_26.this.waypointAzimuth();
                if (Math.abs(CockpitDo_26.this.fm.Or.getKren()) < 30F) {
                    CockpitDo_26.this.setNew.azimuth.setDeg(CockpitDo_26.this.setOld.azimuth.getDeg(1.0F), CockpitDo_26.this.fm.Or.azimut());
                }
                CockpitDo_26.this.setNew.waypointAzimuth.setDeg(CockpitDo_26.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitDo_26.this.setNew.waypointDeviation.setDeg(CockpitDo_26.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitDo_26.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitDo_26.this.setNew.vspeed = ((199F * CockpitDo_26.this.setOld.vspeed) + CockpitDo_26.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitDo_26() {
        super("3DO/Cockpit/Do_26-P/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitDo_26.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitDo_26.speedometerScale), 0.0F);
