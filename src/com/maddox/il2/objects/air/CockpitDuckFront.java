    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitDuckFront.this.fm != null) {
                ...
                CockpitDuckFront.this.setNew.waypointAzimuth.setDeg(CockpitDuckFront.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitDuckFront.this.waypointAzimuth() - CockpitDuckFront.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitDuckFront.this.fm.Or.getKren()) < 30F) {
                    CockpitDuckFront.this.setNew.azimuth.setDeg(CockpitDuckFront.this.setOld.azimuth.getDeg(1.0F), CockpitDuckFront.this.fm.Or.azimut());
                }
