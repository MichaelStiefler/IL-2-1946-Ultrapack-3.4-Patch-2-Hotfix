    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitE7K.this.fm != null) {
                ...
                CockpitE7K.this.setNew.waypointAzimuth.setDeg(CockpitE7K.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitE7K.this.waypointAzimuth() - CockpitE7K.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitE7K.this.fm.Or.getKren()) < 30F) {
                    CockpitE7K.this.setNew.azimuth.setDeg(CockpitE7K.this.setOld.azimuth.getDeg(1.0F), CockpitE7K.this.fm.Or.azimut());
                }
