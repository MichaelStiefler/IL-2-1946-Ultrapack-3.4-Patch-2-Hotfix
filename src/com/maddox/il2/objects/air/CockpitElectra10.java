...
public class CockpitElectra10 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitElectra10.this.fm != null) {
                CockpitElectra10.this.setTmp = CockpitElectra10.this.setOld;
                CockpitElectra10.this.setOld = CockpitElectra10.this.setNew;
                CockpitElectra10.this.setNew = CockpitElectra10.this.setTmp;
                CockpitElectra10.this.setNew.throttle1 = (0.85F * CockpitElectra10.this.setOld.throttle1) + (CockpitElectra10.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitElectra10.this.setNew.throttle2 = (0.85F * CockpitElectra10.this.setOld.throttle2) + (CockpitElectra10.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitElectra10.this.setNew.prop1 = (0.85F * CockpitElectra10.this.setOld.prop1) + (CockpitElectra10.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitElectra10.this.setNew.prop2 = (0.85F * CockpitElectra10.this.setOld.prop2) + (CockpitElectra10.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitElectra10.this.setNew.altimeter = CockpitElectra10.this.fm.getAltitude();
                float f = CockpitElectra10.this.waypointAzimuth();
                if (Math.abs(CockpitElectra10.this.fm.Or.getKren()) < 30F) {
                    CockpitElectra10.this.setNew.azimuth.setDeg(CockpitElectra10.this.setOld.azimuth.getDeg(1.0F), CockpitElectra10.this.fm.Or.azimut());
                }
                CockpitElectra10.this.setNew.waypointAzimuth.setDeg(CockpitElectra10.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitElectra10.this.setNew.waypointDeviation.setDeg(CockpitElectra10.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitElectra10.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitElectra10.this.setNew.vspeed = ((199F * CockpitElectra10.this.setOld.vspeed) + CockpitElectra10.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            ...
            this.aircraft().hierMesh().chunkVisible("Allglass", false);
            return true;
        } else {
            return false;
        }
    ...
    protected void doFocusLeave() {
        ...
        this.aircraft().hierMesh().chunkVisible("Allglass", true);
        super.doFocusLeave();
    }
    ...
    public CockpitElectra10() {
        super("3DO/Cockpit/Electra10P/heir.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitElectra10.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitElectra10.speedometerScale), 0.0F);
