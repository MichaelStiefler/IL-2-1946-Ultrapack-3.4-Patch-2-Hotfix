...
public class CockpitElectra14 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitElectra14.this.fm != null) {
                CockpitElectra14.this.setTmp = CockpitElectra14.this.setOld;
                CockpitElectra14.this.setOld = CockpitElectra14.this.setNew;
                CockpitElectra14.this.setNew = CockpitElectra14.this.setTmp;
                CockpitElectra14.this.setNew.throttle1 = (0.85F * CockpitElectra14.this.setOld.throttle1) + (CockpitElectra14.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitElectra14.this.setNew.throttle2 = (0.85F * CockpitElectra14.this.setOld.throttle2) + (CockpitElectra14.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitElectra14.this.setNew.prop1 = (0.85F * CockpitElectra14.this.setOld.prop1) + (CockpitElectra14.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitElectra14.this.setNew.prop2 = (0.85F * CockpitElectra14.this.setOld.prop2) + (CockpitElectra14.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitElectra14.this.setNew.altimeter = CockpitElectra14.this.fm.getAltitude();
                float f = CockpitElectra14.this.waypointAzimuth();
                if (Math.abs(CockpitElectra14.this.fm.Or.getKren()) < 30F) {
                    CockpitElectra14.this.setNew.azimuth.setDeg(CockpitElectra14.this.setOld.azimuth.getDeg(1.0F), CockpitElectra14.this.fm.Or.azimut());
                }
                CockpitElectra14.this.setNew.waypointAzimuth.setDeg(CockpitElectra14.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitElectra14.this.setNew.waypointDeviation.setDeg(CockpitElectra14.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitElectra14.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitElectra14.this.setNew.vspeed = ((199F * CockpitElectra14.this.setOld.vspeed) + CockpitElectra14.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitElectra14() {
        super("3DO/Cockpit/Electra14Front/heir.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitElectra14.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitElectra14.speedometerScale), 0.0F);
