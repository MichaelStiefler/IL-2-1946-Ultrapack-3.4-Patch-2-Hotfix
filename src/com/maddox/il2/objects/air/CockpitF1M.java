...
public class CockpitF1M extends CockpitPilot {
        ...
        public boolean tick() {
            if (CockpitF1M.this.fm != null) {
                ...
                if (CockpitF1M.this.cockpitDimControl) {
                    if (CockpitF1M.this.setNew.dimPos < 1.0F) {
                        CockpitF1M.this.setNew.dimPos = CockpitF1M.this.setOld.dimPos + 0.03F;
                    }
                } else if (CockpitF1M.this.setNew.dimPos > 0.0F) {
                    CockpitF1M.this.setNew.dimPos = CockpitF1M.this.setOld.dimPos - 0.03F;
                }
                ...
                if (Math.abs(CockpitF1M.this.fm.Or.getKren()) < 30F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1000F, 0.0F, 20F), CockpitF1M.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.5F, 6.5F), CockpitF1M.vsiNeedleScale), 0.0F, 0.0F);
