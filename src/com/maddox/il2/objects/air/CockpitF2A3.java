...
public class CockpitF2A3 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitF2A3.this.fm != null) {
                CockpitF2A3.this.setTmp = CockpitF2A3.this.setOld;
                CockpitF2A3.this.setOld = CockpitF2A3.this.setNew;
                CockpitF2A3.this.setNew = CockpitF2A3.this.setTmp;
                CockpitF2A3.this.setNew.throttle = ((10F * CockpitF2A3.this.setOld.throttle) + CockpitF2A3.this.fm.CT.PowerControl) / 11F;
                CockpitF2A3.this.setNew.altimeter = CockpitF2A3.this.fm.getAltitude();
                CockpitF2A3.this.setNew.waypointAzimuth.setDeg(CockpitF2A3.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitF2A3.this.waypointAzimuth() - CockpitF2A3.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitF2A3.this.fm.Or.getKren()) < 30F) {
                    CockpitF2A3.this.setNew.azimuth.setDeg(CockpitF2A3.this.setOld.azimuth.getDeg(1.0F), CockpitF2A3.this.fm.Or.azimut());
                }
                CockpitF2A3.this.setNew.vspeed = ((199F * CockpitF2A3.this.setOld.vspeed) + CockpitF2A3.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    protected void doFocusLeave() {
        if (!this.isFocused()) {
            ...
            this.leave();
            ((F2A3) this.aircraft()).bChangedExts = true;
            ((F2A3) this.aircraft()).doFixBellyDoor();
            super.doFocusLeave();
            return;
        }
    }
    ...
    public CockpitF2A3() {
        super("3DO/Cockpit/F2A-2/hierA3.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 981.5598F, 0.0F, 53F), CockpitF2A3.speedometerScale), 0.0F, 0.0F);
