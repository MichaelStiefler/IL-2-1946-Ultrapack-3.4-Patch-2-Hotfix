...
public class CockpitF2G extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitF2G.this.fm != null) {
                CockpitF2G.this.setTmp = CockpitF2G.this.setOld;
                CockpitF2G.this.setOld = CockpitF2G.this.setNew;
                CockpitF2G.this.setNew = CockpitF2G.this.setTmp;
                CockpitF2G.this.setNew.throttle = (0.85F * CockpitF2G.this.setOld.throttle) + (CockpitF2G.this.fm.CT.PowerControl * 0.15F);
                CockpitF2G.this.setNew.prop = (0.85F * CockpitF2G.this.setOld.prop) + (CockpitF2G.this.fm.CT.getStepControl() * 0.15F);
                CockpitF2G.this.setNew.altimeter = CockpitF2G.this.fm.getAltitude();
                float f = CockpitF2G.this.waypointAzimuth(10F);
                if (Math.abs(CockpitF2G.this.fm.Or.getKren()) < 30F) {
                    CockpitF2G.this.setNew.azimuth.setDeg(CockpitF2G.this.setOld.azimuth.getDeg(1.0F), CockpitF2G.this.fm.Or.azimut());
                }
                CockpitF2G.this.setNew.waypointAzimuth.setDeg(CockpitF2G.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                CockpitF2G.this.setNew.vspeed = ((199F * CockpitF2G.this.setOld.vspeed) + CockpitF2G.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitF2G() {
        super("3DO/Cockpit/F2G/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 796.3598F, 0.0F, 11F), CockpitF2G.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitF2G.variometerScale), 0.0F);
