...
public class CockpitF2H extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitF2H.this.fm != null) {
                CockpitF2H.this.setTmp = CockpitF2H.this.setOld;
                CockpitF2H.this.setOld = CockpitF2H.this.setNew;
                CockpitF2H.this.setNew = CockpitF2H.this.setTmp;
                CockpitF2H.this.setNew.throttle = (0.9F * CockpitF2H.this.setOld.throttle) + (CockpitF2H.this.fm.CT.PowerControl * 0.1F);
                CockpitF2H.this.setNew.altimeter = CockpitF2H.this.fm.getAltitude();
                CockpitF2H.this.setNew.waypointAzimuth.setDeg(CockpitF2H.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitF2H.this.waypointAzimuth() - CockpitF2H.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitF2H.this.fm.Or.getKren()) < 30F) {
                    CockpitF2H.this.setNew.azimuth.setDeg(CockpitF2H.this.setOld.azimuth.getDeg(1.0F), CockpitF2H.this.fm.Or.azimut());
                }
                CockpitF2H.this.setNew.vspeed = ((199F * CockpitF2H.this.setOld.vspeed) + CockpitF2H.this.fm.getVertSpeed()) / 200F;
                if (CockpitF2H.this.fm.CT.arrestorControl <= 0.5F) {
                    if (CockpitF2H.this.setNew.stbyPosition > 0.0F) {
                        CockpitF2H.this.setNew.stbyPosition = CockpitF2H.this.setOld.stbyPosition - 0.05F;
                    }
                } else if (CockpitF2H.this.setNew.stbyPosition < 1.0F) {
                    CockpitF2H.this.setNew.stbyPosition = CockpitF2H.this.setOld.stbyPosition + 0.05F;
                }
                if ((CockpitF2H.this.fm.EI.engines[0].getStage() < 6) && !CockpitF2H.this.fm.CT.bHasAileronControl && !CockpitF2H.this.fm.CT.bHasElevatorControl && !CockpitF2H.this.fm.CT.bHasGearControl && !CockpitF2H.this.fm.CT.bHasAirBrakeControl && !CockpitF2H.this.fm.CT.bHasFlapsControl) {
                    if (CockpitF2H.this.setNew.stbyPosition3 > 0.0F) {
                        CockpitF2H.this.setNew.stbyPosition3 = CockpitF2H.this.setOld.stbyPosition3 - 0.005F;
                    }
                } else if (CockpitF2H.this.setNew.stbyPosition3 < 1.0F) {
                    CockpitF2H.this.setNew.stbyPosition3 = CockpitF2H.this.setOld.stbyPosition3 + 0.005F;
                }
                float f = ((Banshee_X) ((F2H_3) CockpitF2H.this.aircraft())).k14Distance;
                CockpitF2H.this.setNew.k14w = (5F * CockpitF2H.k14TargetWingspanScale[((Banshee_X) ((F2H_3) CockpitF2H.this.aircraft())).k14WingspanType]) / f;
                CockpitF2H.this.setNew.k14w = (0.9F * CockpitF2H.this.setOld.k14w) + (0.1F * CockpitF2H.this.setNew.k14w);
                CockpitF2H.this.setNew.k14wingspan = (0.9F * CockpitF2H.this.setOld.k14wingspan) + (0.1F * CockpitF2H.k14TargetMarkScale[((Banshee_X) ((F2H_3) CockpitF2H.this.aircraft())).k14WingspanType]);
                CockpitF2H.this.setNew.k14mode = (0.8F * CockpitF2H.this.setOld.k14mode) + (0.2F * ((Banshee_X) ((F2H_3) CockpitF2H.this.aircraft())).k14Mode);
                Vector3d vector3d = CockpitF2H.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitF2H.this.floatindex((f - 200F) * 0.04F, CockpitF2H.k14BulletDrop) - CockpitF2H.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitF2H.this.setNew.k14x = (0.92F * CockpitF2H.this.setOld.k14x) + (0.08F * f1);
                CockpitF2H.this.setNew.k14y = (0.92F * CockpitF2H.this.setOld.k14y) + (0.08F * f2);
                if (CockpitF2H.this.setNew.k14x > 7F) {
                    CockpitF2H.this.setNew.k14x = 7F;
                }
                if (CockpitF2H.this.setNew.k14x < -7F) {
                    CockpitF2H.this.setNew.k14x = -7F;
                }
                if (CockpitF2H.this.setNew.k14y > 7F) {
                    CockpitF2H.this.setNew.k14y = 7F;
                }
                if (CockpitF2H.this.setNew.k14y < -7F) {
                    CockpitF2H.this.setNew.k14y = -7F;
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 2) == 0) {
            int i = ((Banshee_X) ((F2H_3) this.aircraft())).k14Mode;
            boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("Z_Speed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitF2H.speedometerScale), 0.0F, 0.0F);
        ...
        if (((Banshee_X) ((F2H_3) this.aircraft())).k14Mode == 2) {
