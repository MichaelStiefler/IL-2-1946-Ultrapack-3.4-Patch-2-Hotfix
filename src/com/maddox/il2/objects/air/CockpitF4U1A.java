...
public class CockpitF4U1A extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitF4U1A.this.fm != null) {
                CockpitF4U1A.this.setTmp = CockpitF4U1A.this.setOld;
                CockpitF4U1A.this.setOld = CockpitF4U1A.this.setNew;
                CockpitF4U1A.this.setNew = CockpitF4U1A.this.setTmp;
                CockpitF4U1A.this.setNew.throttle = (0.85F * CockpitF4U1A.this.setOld.throttle) + (CockpitF4U1A.this.fm.CT.PowerControl * 0.15F);
                CockpitF4U1A.this.setNew.prop = (0.85F * CockpitF4U1A.this.setOld.prop) + (CockpitF4U1A.this.fm.CT.getStepControl() * 0.15F);
                CockpitF4U1A.this.setNew.altimeter = CockpitF4U1A.this.fm.getAltitude();
                float f = CockpitF4U1A.this.waypointAzimuth(10F);
                if (Math.abs(CockpitF4U1A.this.fm.Or.getKren()) < 30F) {
                    CockpitF4U1A.this.setNew.azimuth.setDeg(CockpitF4U1A.this.setOld.azimuth.getDeg(1.0F), CockpitF4U1A.this.fm.Or.azimut());
                }
                CockpitF4U1A.this.setNew.waypointAzimuth.setDeg(CockpitF4U1A.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                CockpitF4U1A.this.setNew.vspeed = ((199F * CockpitF4U1A.this.setOld.vspeed) + CockpitF4U1A.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 796.3598F, 0.0F, 11F), CockpitF4U1A.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitF4U1A.variometerScale), 0.0F);
