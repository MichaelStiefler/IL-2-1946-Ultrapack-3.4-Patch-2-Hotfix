...
public class CockpitF4U1D extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitF4U1D.this.fm != null) {
                CockpitF4U1D.this.setTmp = CockpitF4U1D.this.setOld;
                CockpitF4U1D.this.setOld = CockpitF4U1D.this.setNew;
                CockpitF4U1D.this.setNew = CockpitF4U1D.this.setTmp;
                ...
                float f = CockpitF4U1D.this.waypointAzimuth(10F);
                if (Math.abs(CockpitF4U1D.this.fm.Or.getKren()) < 30F) {
                ...
                CockpitF4U1D.this.setNew.vspeed = ((199F * CockpitF4U1D.this.setOld.vspeed) + CockpitF4U1D.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 796.3598F, 0.0F, 11F), CockpitF4U1D.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitF4U1D.variometerScale), 0.0F);
