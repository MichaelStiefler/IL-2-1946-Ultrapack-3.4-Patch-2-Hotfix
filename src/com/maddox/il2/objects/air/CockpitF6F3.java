...
public class CockpitF6F3 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitF6F3.this.fm != null) {
                CockpitF6F3.this.setTmp = CockpitF6F3.this.setOld;
                CockpitF6F3.this.setOld = CockpitF6F3.this.setNew;
                CockpitF6F3.this.setNew = CockpitF6F3.this.setTmp;
                CockpitF6F3.this.setNew.throttle = (0.85F * CockpitF6F3.this.setOld.throttle) + (CockpitF6F3.this.fm.CT.PowerControl * 0.15F);
                CockpitF6F3.this.setNew.prop = (0.85F * CockpitF6F3.this.setOld.prop) + (CockpitF6F3.this.fm.CT.getStepControl() * 0.15F);
                CockpitF6F3.this.setNew.mix = (0.85F * CockpitF6F3.this.setOld.mix) + (CockpitF6F3.this.fm.EI.engines[0].getControlMix() * 0.15F);
                CockpitF6F3.this.setNew.altimeter = CockpitF6F3.this.fm.getAltitude();
                float f = CockpitF6F3.this.waypointAzimuth(10F);
                if (Math.abs(CockpitF6F3.this.fm.Or.getKren()) < 30F) {
                    CockpitF6F3.this.setNew.azimuth.setDeg(CockpitF6F3.this.setOld.azimuth.getDeg(1.0F), CockpitF6F3.this.fm.Or.azimut());
                }
                CockpitF6F3.this.setNew.waypointAzimuth.setDeg(CockpitF6F3.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                CockpitF6F3.this.setNew.vspeed = ((199F * CockpitF6F3.this.setOld.vspeed) + CockpitF6F3.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("WingLMid_D0", 100F * f1, 0.0F, 0.0F);
        this.mesh.chunkSetAngles("WingRMid_D0", -100F * f1, 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 963.0397F, 0.0F, 13F), CockpitF6F3.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitF6F3.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Compass1", this.setNew.azimuth.getDeg(f), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Compass2", 270F + this.setNew.waypointAzimuth.getDeg(f * 0.1F), 0.0F, 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            ...
            this.mesh.chunkSetAngles("Z_RPM1", this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 7000F, 0.0F, 278F), 0.0F, 0.0F);
        }
        ...
        if (this.fm.Gears.lgear) {
            this.mesh.chunkSetAngles("Z_GearInd1", 0.0F, this.cvt(this.fm.CT.getGear(), 0.0F, 1.0F, 0.0F, 65F), 0.0F);
        }
        if (this.fm.Gears.rgear) {
            this.mesh.chunkSetAngles("Z_GearInd2", 0.0F, this.cvt(this.fm.CT.getGear(), 0.0F, 1.0F, 0.0F, -65F), 0.0F);
        }
