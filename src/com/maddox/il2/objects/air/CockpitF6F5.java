...
public class CockpitF6F5 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitF6F5.this.fm != null) {
                CockpitF6F5.this.setTmp = CockpitF6F5.this.setOld;
                CockpitF6F5.this.setOld = CockpitF6F5.this.setNew;
                CockpitF6F5.this.setNew = CockpitF6F5.this.setTmp;
                ...
                float f = CockpitF6F5.this.waypointAzimuth(10F);
                if (Math.abs(CockpitF6F5.this.fm.Or.getKren()) < 30F) {
                ...
                CockpitF6F5.this.setNew.vspeed = ((199F * CockpitF6F5.this.setOld.vspeed) + CockpitF6F5.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 963.0397F, 0.0F, 13F), CockpitF6F5.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitF6F5.variometerScale), 0.0F, 0.0F);
