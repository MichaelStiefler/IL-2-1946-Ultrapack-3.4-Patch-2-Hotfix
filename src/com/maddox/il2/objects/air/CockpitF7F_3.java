...
public class CockpitF7F_3 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitF7F_3.this.fm != null) {
                CockpitF7F_3.this.setTmp = CockpitF7F_3.this.setOld;
                CockpitF7F_3.this.setOld = CockpitF7F_3.this.setNew;
                CockpitF7F_3.this.setNew = CockpitF7F_3.this.setTmp;
                CockpitF7F_3.this.setNew.throttle1 = (0.9F * CockpitF7F_3.this.setOld.throttle1) + (0.1F * CockpitF7F_3.this.fm.EI.engines[0].getControlThrottle());
                CockpitF7F_3.this.setNew.prop1 = (0.9F * CockpitF7F_3.this.setOld.prop1) + (0.1F * CockpitF7F_3.this.fm.EI.engines[0].getControlProp());
                CockpitF7F_3.this.setNew.mix1 = (0.8F * CockpitF7F_3.this.setOld.mix1) + (0.2F * CockpitF7F_3.this.fm.EI.engines[0].getControlMix());
                CockpitF7F_3.this.setNew.throttle2 = (0.9F * CockpitF7F_3.this.setOld.throttle2) + (0.1F * CockpitF7F_3.this.fm.EI.engines[1].getControlThrottle());
                CockpitF7F_3.this.setNew.prop2 = (0.9F * CockpitF7F_3.this.setOld.prop2) + (0.1F * CockpitF7F_3.this.fm.EI.engines[1].getControlProp());
                CockpitF7F_3.this.setNew.mix2 = (0.8F * CockpitF7F_3.this.setOld.mix2) + (0.2F * CockpitF7F_3.this.fm.EI.engines[1].getControlMix());
                CockpitF7F_3.this.setNew.man1 = (0.92F * CockpitF7F_3.this.setOld.man1) + (0.08F * CockpitF7F_3.this.fm.EI.engines[0].getManifoldPressure());
                CockpitF7F_3.this.setNew.man2 = (0.92F * CockpitF7F_3.this.setOld.man2) + (0.08F * CockpitF7F_3.this.fm.EI.engines[1].getManifoldPressure());
                CockpitF7F_3.this.setNew.altimeter = CockpitF7F_3.this.fm.getAltitude();
                if (Math.abs(CockpitF7F_3.this.fm.Or.getKren()) < 30F) {
                    CockpitF7F_3.this.setNew.azimuth.setDeg(CockpitF7F_3.this.setOld.azimuth.getDeg(1.0F), CockpitF7F_3.this.fm.Or.azimut());
                }
                CockpitF7F_3.this.setNew.vspeed = ((199F * CockpitF7F_3.this.setOld.vspeed) + CockpitF7F_3.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitF7F_3() {
        super("3DO/Cockpit/F7F-3/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 804.6721F, 0.0F, 10F), CockpitF7F_3.speedometerScale), 0.0F);
