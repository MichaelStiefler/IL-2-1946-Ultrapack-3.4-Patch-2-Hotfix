...
public class CockpitF84G1 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitF84G1.this.fm != null) {
                CockpitF84G1.this.setTmp = CockpitF84G1.this.setOld;
                CockpitF84G1.this.setOld = CockpitF84G1.this.setNew;
                CockpitF84G1.this.setNew = CockpitF84G1.this.setTmp;
                ...
                CockpitF84G1.this.setNew.waypointAzimuth.setDeg(CockpitF84G1.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitF84G1.this.waypointAzimuth() - CockpitF84G1.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitF84G1.this.fm.Or.getKren()) < 30F) {
                    CockpitF84G1.this.setNew.azimuth.setDeg(CockpitF84G1.this.setOld.azimuth.getDeg(1.0F), CockpitF84G1.this.fm.Or.azimut());
                }
                CockpitF84G1.this.setNew.vspeed = ((199F * CockpitF84G1.this.setOld.vspeed) + CockpitF84G1.this.fm.getVertSpeed()) / 200F;
                float f = ((F84G1) CockpitF84G1.this.aircraft()).k14Distance;
                CockpitF84G1.this.setNew.k14w = (5F * CockpitF84G1.k14TargetWingspanScale[((F84G1) CockpitF84G1.this.aircraft()).k14WingspanType]) / f;
                ...
                Vector3d vector3d = CockpitF84G1.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitF84G1.this.floatindex((f - 200F) * 0.04F, CockpitF84G1.k14BulletDrop) - CockpitF84G1.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitF84G1.this.setNew.k14x = (0.92F * CockpitF84G1.this.setOld.k14x) + (0.08F * f1);
                CockpitF84G1.this.setNew.k14y = (0.92F * CockpitF84G1.this.setOld.k14y) + (0.08F * f2);
                if (CockpitF84G1.this.setNew.k14x > 7F) {
                    CockpitF84G1.this.setNew.k14x = 7F;
                }
                if (CockpitF84G1.this.setNew.k14x < -7F) {
                    CockpitF84G1.this.setNew.k14x = -7F;
                }
                if (CockpitF84G1.this.setNew.k14y > 7F) {
                    CockpitF84G1.this.setNew.k14y = 7F;
                }
                if (CockpitF84G1.this.setNew.k14y < -7F) {
                    CockpitF84G1.this.setNew.k14y = -7F;
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 2) == 0) {
            int i = ((F84G1) this.aircraft()).k14Mode;
            boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitF84G1.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 0.0F, 1126.541F, 0.0F, 14F), CockpitF84G1.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitF84G1.variometerScale), 0.0F, 0.0F);
