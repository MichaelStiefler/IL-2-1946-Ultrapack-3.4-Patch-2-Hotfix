...
public class CockpitF84G3 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitF84G3.this.fm != null) {
                CockpitF84G3.this.setTmp = CockpitF84G3.this.setOld;
                CockpitF84G3.this.setOld = CockpitF84G3.this.setNew;
                CockpitF84G3.this.setNew = CockpitF84G3.this.setTmp;
                CockpitF84G3.this.setNew.throttle = (0.85F * CockpitF84G3.this.setOld.throttle) + (CockpitF84G3.this.fm.CT.PowerControl * 0.15F);
                CockpitF84G3.this.setNew.prop = (0.85F * CockpitF84G3.this.setOld.prop) + (CockpitF84G3.this.fm.CT.getStepControl() * 0.15F);
                CockpitF84G3.this.setNew.stage = (0.85F * CockpitF84G3.this.setOld.stage) + (CockpitF84G3.this.fm.EI.engines[0].getControlCompressor() * 0.15F);
                CockpitF84G3.this.setNew.mix = (0.85F * CockpitF84G3.this.setOld.mix) + (CockpitF84G3.this.fm.EI.engines[0].getControlMix() * 0.15F);
                CockpitF84G3.this.setNew.altimeter = CockpitF84G3.this.fm.getAltitude();
                CockpitF84G3.this.setNew.waypointAzimuth.setDeg(CockpitF84G3.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitF84G3.this.waypointAzimuth() - CockpitF84G3.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitF84G3.this.fm.Or.getKren()) < 30F) {
                    CockpitF84G3.this.setNew.azimuth.setDeg(CockpitF84G3.this.setOld.azimuth.getDeg(1.0F), CockpitF84G3.this.fm.Or.azimut());
                }
                CockpitF84G3.this.setNew.vspeed = ((199F * CockpitF84G3.this.setOld.vspeed) + CockpitF84G3.this.fm.getVertSpeed()) / 200F;
                float f = ((F84G3) CockpitF84G3.this.aircraft()).k14Distance;
                CockpitF84G3.this.setNew.k14w = (5F * CockpitF84G3.k14TargetWingspanScale[((F84G3) CockpitF84G3.this.aircraft()).k14WingspanType]) / f;
                CockpitF84G3.this.setNew.k14w = (0.9F * CockpitF84G3.this.setOld.k14w) + (0.1F * CockpitF84G3.this.setNew.k14w);
                CockpitF84G3.this.setNew.k14wingspan = (0.9F * CockpitF84G3.this.setOld.k14wingspan) + (0.1F * CockpitF84G3.k14TargetMarkScale[((F84G3) CockpitF84G3.this.aircraft()).k14WingspanType]);
                CockpitF84G3.this.setNew.k14mode = (0.8F * CockpitF84G3.this.setOld.k14mode) + (0.2F * ((F84G3) CockpitF84G3.this.aircraft()).k14Mode);
                Vector3d vector3d = CockpitF84G3.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitF84G3.this.floatindex((f - 200F) * 0.04F, CockpitF84G3.k14BulletDrop) - CockpitF84G3.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitF84G3.this.setNew.k14x = (0.92F * CockpitF84G3.this.setOld.k14x) + (0.08F * f1);
                CockpitF84G3.this.setNew.k14y = (0.92F * CockpitF84G3.this.setOld.k14y) + (0.08F * f2);
                if (CockpitF84G3.this.setNew.k14x > 7F) {
                    CockpitF84G3.this.setNew.k14x = 7F;
                }
                if (CockpitF84G3.this.setNew.k14x < -7F) {
                    CockpitF84G3.this.setNew.k14x = -7F;
                }
                if (CockpitF84G3.this.setNew.k14y > 7F) {
                    CockpitF84G3.this.setNew.k14y = 7F;
                }
                if (CockpitF84G3.this.setNew.k14y < -7F) {
                    CockpitF84G3.this.setNew.k14y = -7F;
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 2) == 0) {
            int i = ((F84G3) this.aircraft()).k14Mode;
            boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitF84G3.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 0.0F, 1126.541F, 0.0F, 14F), CockpitF84G3.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitF84G3.variometerScale), 0.0F, 0.0F);
