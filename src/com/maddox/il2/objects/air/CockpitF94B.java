...
public class CockpitF94B extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitF94B.this.fm != null) {
                CockpitF94B.this.setTmp = CockpitF94B.this.setOld;
                CockpitF94B.this.setOld = CockpitF94B.this.setNew;
                CockpitF94B.this.setNew = CockpitF94B.this.setTmp;
                CockpitF94B.this.setNew.throttle = (0.85F * CockpitF94B.this.setOld.throttle) + (CockpitF94B.this.fm.CT.PowerControl * 0.15F);
                CockpitF94B.this.setNew.prop = (0.85F * CockpitF94B.this.setOld.prop) + (CockpitF94B.this.fm.CT.getStepControl() * 0.15F);
                CockpitF94B.this.setNew.stage = (0.85F * CockpitF94B.this.setOld.stage) + (CockpitF94B.this.fm.EI.engines[0].getControlCompressor() * 0.15F);
                CockpitF94B.this.setNew.mix = (0.85F * CockpitF94B.this.setOld.mix) + (CockpitF94B.this.fm.EI.engines[0].getControlMix() * 0.15F);
                CockpitF94B.this.setNew.altimeter = CockpitF94B.this.fm.getAltitude();
                if (Math.abs(CockpitF94B.this.fm.Or.getKren()) < 30F) {
                    CockpitF94B.this.setNew.azimuth.setDeg(CockpitF94B.this.setOld.azimuth.getDeg(1.0F), CockpitF94B.this.fm.Or.azimut());
                }
                CockpitF94B.this.setNew.vspeed = ((199F * CockpitF94B.this.setOld.vspeed) + CockpitF94B.this.fm.getVertSpeed()) / 200F;
                float f = ((T_33xyz) ((F94B) CockpitF94B.this.aircraft())).k14Distance;
                CockpitF94B.this.setNew.k14w = (5F * CockpitF94B.k14TargetWingspanScale[((T_33xyz) ((F94B) CockpitF94B.this.aircraft())).k14WingspanType]) / f;
                CockpitF94B.this.setNew.k14w = (0.9F * CockpitF94B.this.setOld.k14w) + (0.1F * CockpitF94B.this.setNew.k14w);
                CockpitF94B.this.setNew.k14wingspan = (0.9F * CockpitF94B.this.setOld.k14wingspan) + (0.1F * CockpitF94B.k14TargetMarkScale[((T_33xyz) ((F94B) CockpitF94B.this.aircraft())).k14WingspanType]);
                CockpitF94B.this.setNew.k14mode = (0.8F * CockpitF94B.this.setOld.k14mode) + (0.2F * ((T_33xyz) ((F94B) CockpitF94B.this.aircraft())).k14Mode);
                Vector3d vector3d = CockpitF94B.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitF94B.this.floatindex((f - 200F) * 0.04F, CockpitF94B.k14BulletDrop) - CockpitF94B.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitF94B.this.setNew.k14x = (0.92F * CockpitF94B.this.setOld.k14x) + (0.08F * f1);
                CockpitF94B.this.setNew.k14y = (0.92F * CockpitF94B.this.setOld.k14y) + (0.08F * f2);
                if (CockpitF94B.this.setNew.k14x > 7F) {
                    CockpitF94B.this.setNew.k14x = 7F;
                }
                if (CockpitF94B.this.setNew.k14x < -7F) {
                    CockpitF94B.this.setNew.k14x = -7F;
                }
                if (CockpitF94B.this.setNew.k14y > 7F) {
                    CockpitF94B.this.setNew.k14y = 7F;
                }
                if (CockpitF94B.this.setNew.k14y < -7F) {
                    CockpitF94B.this.setNew.k14y = -7F;
                }
    ...
    public void reflectWorldToInstruments(float f) {
        if ((this.fm.AS.astateCockpitState & 2) == 0) {
            int i = ((T_33xyz) ((F94B) this.aircraft())).k14Mode;
            boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitF94B.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.cvt(this.fm.EI.engines[0].getRPM() * 1.23F, 1100F, 5000F, 0.0F, 322F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 1100F, 0.0F, 289F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitF94B.variometerScale), 0.0F, 0.0F);
