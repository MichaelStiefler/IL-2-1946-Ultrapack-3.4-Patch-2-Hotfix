...
public class CockpitF9F_Cougar extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitF9F_Cougar.this.fm != null) {
                CockpitF9F_Cougar.this.setTmp = CockpitF9F_Cougar.this.setOld;
                CockpitF9F_Cougar.this.setOld = CockpitF9F_Cougar.this.setNew;
                CockpitF9F_Cougar.this.setNew = CockpitF9F_Cougar.this.setTmp;
                CockpitF9F_Cougar.this.setNew.throttle = (0.9F * CockpitF9F_Cougar.this.setOld.throttle) + (CockpitF9F_Cougar.this.fm.CT.PowerControl * 0.1F);
                CockpitF9F_Cougar.this.setNew.altimeter = CockpitF9F_Cougar.this.fm.getAltitude();
                CockpitF9F_Cougar.this.setNew.waypointAzimuth.setDeg(CockpitF9F_Cougar.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitF9F_Cougar.this.waypointAzimuth() - CockpitF9F_Cougar.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitF9F_Cougar.this.fm.Or.getKren()) < 30F) {
                    CockpitF9F_Cougar.this.setNew.azimuth.setDeg(CockpitF9F_Cougar.this.setOld.azimuth.getDeg(1.0F), CockpitF9F_Cougar.this.fm.Or.azimut());
                }
                CockpitF9F_Cougar.this.setNew.vspeed = ((199F * CockpitF9F_Cougar.this.setOld.vspeed) + CockpitF9F_Cougar.this.fm.getVertSpeed()) / 200F;
                if (CockpitF9F_Cougar.this.fm.CT.arrestorControl <= 0.5F) {
                    if (CockpitF9F_Cougar.this.setNew.stbyPosition > 0.0F) {
                        CockpitF9F_Cougar.this.setNew.stbyPosition = CockpitF9F_Cougar.this.setOld.stbyPosition - 0.05F;
                    }
                } else if (CockpitF9F_Cougar.this.setNew.stbyPosition < 1.0F) {
                    CockpitF9F_Cougar.this.setNew.stbyPosition = CockpitF9F_Cougar.this.setOld.stbyPosition + 0.05F;
                }
                if ((CockpitF9F_Cougar.this.fm.EI.engines[0].getStage() < 6) && !CockpitF9F_Cougar.this.fm.CT.bHasAileronControl && !CockpitF9F_Cougar.this.fm.CT.bHasElevatorControl && !CockpitF9F_Cougar.this.fm.CT.bHasGearControl && !CockpitF9F_Cougar.this.fm.CT.bHasAirBrakeControl && !CockpitF9F_Cougar.this.fm.CT.bHasFlapsControl) {
                    if (CockpitF9F_Cougar.this.setNew.stbyPosition3 > 0.0F) {
                        CockpitF9F_Cougar.this.setNew.stbyPosition3 = CockpitF9F_Cougar.this.setOld.stbyPosition3 - 0.005F;
                    }
                } else if (CockpitF9F_Cougar.this.setNew.stbyPosition3 < 1.0F) {
                    CockpitF9F_Cougar.this.setNew.stbyPosition3 = CockpitF9F_Cougar.this.setOld.stbyPosition3 + 0.005F;
                }
                float f = ((F9F_Cougar) CockpitF9F_Cougar.this.aircraft()).k14Distance;
                CockpitF9F_Cougar.this.setNew.k14w = (5F * CockpitF9F_Cougar.k14TargetWingspanScale[((F9F_Cougar) CockpitF9F_Cougar.this.aircraft()).k14WingspanType]) / f;
                CockpitF9F_Cougar.this.setNew.k14w = (0.9F * CockpitF9F_Cougar.this.setOld.k14w) + (0.1F * CockpitF9F_Cougar.this.setNew.k14w);
                CockpitF9F_Cougar.this.setNew.k14wingspan = (0.9F * CockpitF9F_Cougar.this.setOld.k14wingspan) + (0.1F * CockpitF9F_Cougar.k14TargetMarkScale[((F9F_Cougar) CockpitF9F_Cougar.this.aircraft()).k14WingspanType]);
                CockpitF9F_Cougar.this.setNew.k14mode = (0.8F * CockpitF9F_Cougar.this.setOld.k14mode) + (0.2F * ((F9F_Cougar) CockpitF9F_Cougar.this.aircraft()).k14Mode);
                Vector3d vector3d = CockpitF9F_Cougar.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitF9F_Cougar.this.floatindex((f - 200F) * 0.04F, CockpitF9F_Cougar.k14BulletDrop) - CockpitF9F_Cougar.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitF9F_Cougar.this.setNew.k14x = (0.92F * CockpitF9F_Cougar.this.setOld.k14x) + (0.08F * f1);
                CockpitF9F_Cougar.this.setNew.k14y = (0.92F * CockpitF9F_Cougar.this.setOld.k14y) + (0.08F * f2);
                if (CockpitF9F_Cougar.this.setNew.k14x > 7F) {
                    CockpitF9F_Cougar.this.setNew.k14x = 7F;
                }
                if (CockpitF9F_Cougar.this.setNew.k14x < -7F) {
                    CockpitF9F_Cougar.this.setNew.k14x = -7F;
                }
                if (CockpitF9F_Cougar.this.setNew.k14y > 7F) {
                    CockpitF9F_Cougar.this.setNew.k14y = 7F;
                }
                if (CockpitF9F_Cougar.this.setNew.k14y < -7F) {
                    CockpitF9F_Cougar.this.setNew.k14y = -7F;
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitF9F_Cougar.speedometerScale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitF9F_Cougar.class, "normZN", 0.93F);
        Property.set(CockpitF9F_Cougar.class, "gsZN", 0.93F);
    }
