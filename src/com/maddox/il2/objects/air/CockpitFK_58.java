    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitFK_58.this.fm != null) {
                ...
                CockpitFK_58.this.setNew.waypointAzimuth.setDeg(CockpitFK_58.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitFK_58.this.waypointAzimuth() - CockpitFK_58.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitFK_58.this.fm.Or.getKren()) < 30F) {
                    CockpitFK_58.this.setNew.azimuth.setDeg(CockpitFK_58.this.setOld.azimuth.getDeg(1.0F), CockpitFK_58.this.fm.Or.azimut());
                }
