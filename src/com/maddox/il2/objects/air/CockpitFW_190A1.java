...
public class CockpitFW_190A1 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitFW_190A1.this.fm != null) {
                ...
                CockpitFW_190A1.this.setNew.waypointAzimuth.setDeg(CockpitFW_190A1.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitFW_190A1.this.waypointAzimuth() - CockpitFW_190A1.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitFW_190A1.this.fm.Or.getKren()) < 30F) {
                    CockpitFW_190A1.this.setNew.azimuth.setDeg(CockpitFW_190A1.this.setOld.azimuth.getDeg(1.0F), CockpitFW_190A1.this.fm.Or.azimut());
                }
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitFW_190A1.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitFW_190A1.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 4F), CockpitFW_190A1.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleOilTemp", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 3F), CockpitFW_190A1.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedleCD", this.setNew.vspeed < 0.0F ? this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190A1.vsiNeedleScale) : -this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190A1.vsiNeedleScale), 0.0F, 0.0F);
