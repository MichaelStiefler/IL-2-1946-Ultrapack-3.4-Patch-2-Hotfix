...
public class CockpitFW_190A3 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitFW_190A3.this.fm != null) {
                CockpitFW_190A3.this.setTmp = CockpitFW_190A3.this.setOld;
                CockpitFW_190A3.this.setOld = CockpitFW_190A3.this.setNew;
                CockpitFW_190A3.this.setNew = CockpitFW_190A3.this.setTmp;
                CockpitFW_190A3.this.setNew.altimeter = CockpitFW_190A3.this.fm.getAltitude();
                if (CockpitFW_190A3.this.cockpitDimControl) {
                    if (CockpitFW_190A3.this.setNew.dimPosition > 0.0F) {
                        CockpitFW_190A3.this.setNew.dimPosition = CockpitFW_190A3.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitFW_190A3.this.setNew.dimPosition < 1.0F) {
                    CockpitFW_190A3.this.setNew.dimPosition = CockpitFW_190A3.this.setOld.dimPosition + 0.05F;
                }
                CockpitFW_190A3.this.setNew.throttle = ((10F * CockpitFW_190A3.this.setOld.throttle) + CockpitFW_190A3.this.fm.CT.PowerControl) / 11F;
                CockpitFW_190A3.this.setNew.vspeed = ((499F * CockpitFW_190A3.this.setOld.vspeed) + CockpitFW_190A3.this.fm.getVertSpeed()) / 500F;
                float f = CockpitFW_190A3.this.waypointAzimuth();
                if (CockpitFW_190A3.this.useRealisticNavigationInstruments()) {
                    CockpitFW_190A3.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitFW_190A3.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitFW_190A3.this.setNew.waypointAzimuth.setDeg(CockpitFW_190A3.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitFW_190A3.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitFW_190A3.this.fm.Or.getKren()) < 30F) {
                    CockpitFW_190A3.this.setNew.azimuth.setDeg(CockpitFW_190A3.this.setOld.azimuth.getDeg(1.0F), CockpitFW_190A3.this.fm.Or.azimut());
                }
                CockpitFW_190A3.this.w.set(CockpitFW_190A3.this.fm.getW());
                CockpitFW_190A3.this.fm.Or.transform(CockpitFW_190A3.this.w);
                CockpitFW_190A3.this.setNew.turn = ((12F * CockpitFW_190A3.this.setOld.turn) + CockpitFW_190A3.this.w.z) / 13F;
                CockpitFW_190A3.this.setNew.beaconDirection = ((10F * CockpitFW_190A3.this.setOld.beaconDirection) + CockpitFW_190A3.this.getBeaconDirection()) / 11F;
                CockpitFW_190A3.this.setNew.beaconRange = ((10F * CockpitFW_190A3.this.setOld.beaconRange) + CockpitFW_190A3.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public CockpitFW_190A3() {
        super("3DO/Cockpit/FW-190A-3/hier.him", "bf109");
        this.gun = new Gun[6];
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitFW_190A3.speedometerScale), 0.0F, 0.0F);
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitFW_190A3.rpmScale), 0.0F, 0.0F);
        }
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 4F), CockpitFW_190A3.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleOilTemp", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 3F), CockpitFW_190A3.oilTempScale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitFW_190A3.class, "normZN", 0.72F);
        Property.set(CockpitFW_190A3.class, "gsZN", 0.66F);
    }
