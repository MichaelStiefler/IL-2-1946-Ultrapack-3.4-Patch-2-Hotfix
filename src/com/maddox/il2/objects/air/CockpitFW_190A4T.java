...
public class CockpitFW_190A4T extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitFW_190A4T.this.fm != null) {
                CockpitFW_190A4T.this.setTmp = CockpitFW_190A4T.this.setOld;
                CockpitFW_190A4T.this.setOld = CockpitFW_190A4T.this.setNew;
                CockpitFW_190A4T.this.setNew = CockpitFW_190A4T.this.setTmp;
                CockpitFW_190A4T.this.setNew.altimeter = CockpitFW_190A4T.this.fm.getAltitude();
                if (CockpitFW_190A4T.this.cockpitDimControl) {
                    if (CockpitFW_190A4T.this.setNew.dimPosition > 0.0F) {
                        CockpitFW_190A4T.this.setNew.dimPosition = CockpitFW_190A4T.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitFW_190A4T.this.setNew.dimPosition < 1.0F) {
                    CockpitFW_190A4T.this.setNew.dimPosition = CockpitFW_190A4T.this.setOld.dimPosition + 0.05F;
                }
                CockpitFW_190A4T.this.setNew.throttle = ((10F * CockpitFW_190A4T.this.setOld.throttle) + CockpitFW_190A4T.this.fm.CT.PowerControl) / 11F;
                CockpitFW_190A4T.this.setNew.vspeed = ((499F * CockpitFW_190A4T.this.setOld.vspeed) + CockpitFW_190A4T.this.fm.getVertSpeed()) / 500F;
                CockpitFW_190A4T.this.setNew.waypointAzimuth.setDeg(CockpitFW_190A4T.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitFW_190A4T.this.waypointAzimuth() - CockpitFW_190A4T.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitFW_190A4T.this.fm.Or.getKren()) < 30F) {
                    CockpitFW_190A4T.this.setNew.azimuth.setDeg(CockpitFW_190A4T.this.setOld.azimuth.getDeg(1.0F), CockpitFW_190A4T.this.fm.Or.azimut());
                }
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Handle", -this.cvt(this.fm.CT.getCockpitDoor(), 0.1F, 0.99F, 0.0F, 3600F), 0.0F, 0.0F);
        this.resetYPRmodifier();
        ...
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitFW_190A4T.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitFW_190A4T.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 4F), CockpitFW_190A4T.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleOilTemp", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 3F), CockpitFW_190A4T.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedleCD", this.setNew.vspeed >= 0.0F ? -this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190A4T.vsiNeedleScale) : this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190A4T.vsiNeedleScale), 0.0F, 0.0F);
