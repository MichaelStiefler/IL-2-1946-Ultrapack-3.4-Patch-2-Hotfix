...
public class CockpitFW_190A5 extends CockpitPilot {
        ...
        public boolean tick() {
            if (CockpitFW_190A5.this.fm != null) {
                ...
                if (CockpitFW_190A5.this.cockpitDimControl) {
                    if (CockpitFW_190A5.this.setNew.dimPosition > 0.0F) {
                        CockpitFW_190A5.this.setNew.dimPosition = CockpitFW_190A5.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitFW_190A5.this.setNew.dimPosition < 1.0F) {
                    CockpitFW_190A5.this.setNew.dimPosition = CockpitFW_190A5.this.setOld.dimPosition + 0.05F;
                }
                CockpitFW_190A5.this.setNew.throttle = ((10F * CockpitFW_190A5.this.setOld.throttle) + CockpitFW_190A5.this.fm.CT.PowerControl) / 11F;
                CockpitFW_190A5.this.setNew.vspeed = ((499F * CockpitFW_190A5.this.setOld.vspeed) + CockpitFW_190A5.this.fm.getVertSpeed()) / 500F;
                float f = CockpitFW_190A5.this.waypointAzimuth();
                if (CockpitFW_190A5.this.useRealisticNavigationInstruments()) {
                    CockpitFW_190A5.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitFW_190A5.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitFW_190A5.this.setNew.waypointAzimuth.setDeg(CockpitFW_190A5.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitFW_190A5.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitFW_190A5.this.fm.Or.getKren()) < 30F) {
                ...
                CockpitFW_190A5.this.setNew.turn = ((12F * CockpitFW_190A5.this.setOld.turn) + CockpitFW_190A5.this.w.z) / 13F;
                CockpitFW_190A5.this.setNew.beaconDirection = ((10F * CockpitFW_190A5.this.setOld.beaconDirection) + CockpitFW_190A5.this.getBeaconDirection()) / 11F;
                CockpitFW_190A5.this.setNew.beaconRange = ((10F * CockpitFW_190A5.this.setOld.beaconRange) + CockpitFW_190A5.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitFW_190A5.speedometerScale), 0.0F, 0.0F);
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitFW_190A5.rpmScale), 0.0F, 0.0F);
        }
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 4F), CockpitFW_190A5.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleOilTemp", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 3F), CockpitFW_190A5.oilTempScale), 0.0F, 0.0F);
