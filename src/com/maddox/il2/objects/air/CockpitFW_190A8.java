...
public class CockpitFW_190A8 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitFW_190A8.this.fm != null) {
                ...
                CockpitFW_190A8.this.setNew.throttle = ((10F * CockpitFW_190A8.this.setOld.throttle) + CockpitFW_190A8.this.fm.CT.PowerControl) / 11F;
                CockpitFW_190A8.this.setNew.vspeed = ((499F * CockpitFW_190A8.this.setOld.vspeed) + CockpitFW_190A8.this.fm.getVertSpeed()) / 500F;
                float f = CockpitFW_190A8.this.waypointAzimuth();
                if (CockpitFW_190A8.this.useRealisticNavigationInstruments()) {
                    CockpitFW_190A8.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitFW_190A8.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                ...
                if (Math.abs(CockpitFW_190A8.this.fm.Or.getKren()) < 30F) {
                ...
                CockpitFW_190A8.this.setNew.turn = ((12F * CockpitFW_190A8.this.setOld.turn) + CockpitFW_190A8.this.w.z) / 13F;
                CockpitFW_190A8.this.setNew.beaconDirection = ((10F * CockpitFW_190A8.this.setOld.beaconDirection) + CockpitFW_190A8.this.getBeaconDirection()) / 11F;
                CockpitFW_190A8.this.setNew.beaconRange = ((10F * CockpitFW_190A8.this.setOld.beaconRange) + CockpitFW_190A8.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitFW_190A8.speedometerScale), 0.0F, 0.0F);
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitFW_190A8.rpmScale), 0.0F, 0.0F);
        }
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 4F), CockpitFW_190A8.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleOilTemp", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 3F), CockpitFW_190A8.oilTempScale), 0.0F, 0.0F);
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            ...
            this.mesh.chunkSetAngles("NeedleCD", this.setNew.vspeed < 0.0F ? this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190A8.vsiNeedleScale) : -this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190A8.vsiNeedleScale), 0.0F, 0.0F);
        }
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
