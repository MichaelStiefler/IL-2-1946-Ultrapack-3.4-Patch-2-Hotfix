...
public class CockpitFW_190D14 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitFW_190D14.this.fm != null) {
                CockpitFW_190D14.this.setTmp = CockpitFW_190D14.this.setOld;
                CockpitFW_190D14.this.setOld = CockpitFW_190D14.this.setNew;
                CockpitFW_190D14.this.setNew = CockpitFW_190D14.this.setTmp;
                CockpitFW_190D14.this.setNew.altimeter = CockpitFW_190D14.this.fm.getAltitude();
                if (CockpitFW_190D14.this.cockpitDimControl) {
                    if (CockpitFW_190D14.this.setNew.dimPosition > 0.0F) {
                        CockpitFW_190D14.this.setNew.dimPosition = CockpitFW_190D14.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitFW_190D14.this.setNew.dimPosition < 1.0F) {
                    CockpitFW_190D14.this.setNew.dimPosition = CockpitFW_190D14.this.setOld.dimPosition + 0.05F;
                }
                CockpitFW_190D14.this.setNew.throttle = ((10F * CockpitFW_190D14.this.setOld.throttle) + CockpitFW_190D14.this.fm.CT.PowerControl) / 11F;
                CockpitFW_190D14.this.setNew.vspeed = ((499F * CockpitFW_190D14.this.setOld.vspeed) + CockpitFW_190D14.this.fm.getVertSpeed()) / 500F;
                float f = CockpitFW_190D14.this.waypointAzimuth();
                if (CockpitFW_190D14.this.useRealisticNavigationInstruments()) {
                    CockpitFW_190D14.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitFW_190D14.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitFW_190D14.this.setNew.waypointAzimuth.setDeg(CockpitFW_190D14.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitFW_190D14.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitFW_190D14.this.fm.Or.getKren()) < 30F) {
                    CockpitFW_190D14.this.setNew.azimuth.setDeg(CockpitFW_190D14.this.setOld.azimuth.getDeg(1.0F), CockpitFW_190D14.this.fm.Or.azimut());
                }
                CockpitFW_190D14.this.w.set(CockpitFW_190D14.this.fm.getW());
                CockpitFW_190D14.this.fm.Or.transform(CockpitFW_190D14.this.w);
                CockpitFW_190D14.this.setNew.turn = ((12F * CockpitFW_190D14.this.setOld.turn) + CockpitFW_190D14.this.w.z) / 13F;
                CockpitFW_190D14.this.setNew.beaconDirection = ((10F * CockpitFW_190D14.this.setOld.beaconDirection) + CockpitFW_190D14.this.getBeaconDirection()) / 11F;
                CockpitFW_190D14.this.setNew.beaconRange = ((10F * CockpitFW_190D14.this.setOld.beaconRange) + CockpitFW_190D14.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public CockpitFW_190D14() {
        super("3DO/Cockpit/FW-190D-14/hier.him", "bf109");
        ...
        this.cockpitNightMats = (new String[] { "D9GP1", "D9GP2", "D9GP3", "A5GP3Km", "D9GP4_MW50", "D9GP5", "A4GP6", "D9Trans2", "DD9GP1", "D9GP2", "DD9GP3", "DD9GP4", "DD9Trans2", "Trans4", "D9EQpt5" });
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.gun[0] == null) {
            ...
            this.gun[12] = ((Aircraft) this.fm.actor).getGunByHookName("_CANNON15");
        }
        if (this.bNeedSetUp) {
        ...
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitFW_190D14.speedometerScale), 0.0F, 0.0F);
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitFW_190D14.rpmScale), 0.0F, 0.0F);
        }
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 4F), CockpitFW_190D14.fuelScale), 0.0F, 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 0x20) == 0) && ((this.fm.AS.astateCockpitState & 0x80) == 0)) {
            this.mesh.chunkSetAngles("NeedleCD", this.setNew.vspeed >= 0.0F ? -this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190D14.vsiNeedleScale) : this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190D14.vsiNeedleScale), 0.0F, 0.0F);
        }
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
        ...
        this.resetYPRmodifier();
        if (this.gun[12] != null) {
            if (this.gun[12] instanceof MGunMK108k) {
                Cockpit.xyz[0] = this.cvt(this.gun[12].countBullets(), 0.0F, 500F, -0.044F, 0.0F);
            } else {
                Cockpit.xyz[0] = this.cvt(this.gun[12].countBullets(), 0.0F, 500F, -0.044F, 0.0F);
            }
            this.mesh.chunkSetLocate("RC_MG17_R", Cockpit.xyz, Cockpit.ypr);
            this.mesh.chunkVisible("XLampMG17_2", this.gun[12].haveBullets());
            if (this.gun[0] != null) {
    ...
    static {
        Property.set(CockpitFW_190D14.class, "normZN", 0.72F);
        Property.set(CockpitFW_190D14.class, "gsZN", 0.66F);
    }
