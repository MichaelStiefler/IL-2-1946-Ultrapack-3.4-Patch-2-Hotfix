...
public class CockpitFW_190D9r5 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitFW_190D9r5.this.fm != null) {
                CockpitFW_190D9r5.this.setTmp = CockpitFW_190D9r5.this.setOld;
                CockpitFW_190D9r5.this.setOld = CockpitFW_190D9r5.this.setNew;
                CockpitFW_190D9r5.this.setNew = CockpitFW_190D9r5.this.setTmp;
                CockpitFW_190D9r5.this.setNew.altimeter = CockpitFW_190D9r5.this.fm.getAltitude();
                if (CockpitFW_190D9r5.this.cockpitDimControl) {
                    if (CockpitFW_190D9r5.this.setNew.dimPosition > 0.0F) {
                        CockpitFW_190D9r5.this.setNew.dimPosition = CockpitFW_190D9r5.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitFW_190D9r5.this.setNew.dimPosition < 1.0F) {
                    CockpitFW_190D9r5.this.setNew.dimPosition = CockpitFW_190D9r5.this.setOld.dimPosition + 0.05F;
                }
                CockpitFW_190D9r5.this.setNew.throttle = ((10F * CockpitFW_190D9r5.this.setOld.throttle) + CockpitFW_190D9r5.this.fm.CT.PowerControl) / 11F;
                CockpitFW_190D9r5.this.setNew.vspeed = ((499F * CockpitFW_190D9r5.this.setOld.vspeed) + CockpitFW_190D9r5.this.fm.getVertSpeed()) / 500F;
                float f = CockpitFW_190D9r5.this.waypointAzimuth();
                if (CockpitFW_190D9r5.this.useRealisticNavigationInstruments()) {
                    CockpitFW_190D9r5.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitFW_190D9r5.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitFW_190D9r5.this.setNew.waypointAzimuth.setDeg(CockpitFW_190D9r5.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitFW_190D9r5.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitFW_190D9r5.this.fm.Or.getKren()) < 30F) {
                    CockpitFW_190D9r5.this.setNew.azimuth.setDeg(CockpitFW_190D9r5.this.setOld.azimuth.getDeg(1.0F), CockpitFW_190D9r5.this.fm.Or.azimut());
                }
                CockpitFW_190D9r5.this.w.set(CockpitFW_190D9r5.this.fm.getW());
                CockpitFW_190D9r5.this.fm.Or.transform(CockpitFW_190D9r5.this.w);
                CockpitFW_190D9r5.this.setNew.turn = ((12F * CockpitFW_190D9r5.this.setOld.turn) + CockpitFW_190D9r5.this.w.z) / 13F;
                CockpitFW_190D9r5.this.setNew.beaconDirection = ((10F * CockpitFW_190D9r5.this.setOld.beaconDirection) + CockpitFW_190D9r5.this.getBeaconDirection()) / 11F;
                CockpitFW_190D9r5.this.setNew.beaconRange = ((10F * CockpitFW_190D9r5.this.setOld.beaconRange) + CockpitFW_190D9r5.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitFW_190D9r5.speedometerScale), 0.0F, 0.0F);
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitFW_190D9r5.rpmScale), 0.0F, 0.0F);
        }
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 4F), CockpitFW_190D9r5.fuelScale), 0.0F, 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 0x20) == 0) && ((this.fm.AS.astateCockpitState & 0x80) == 0)) {
            this.mesh.chunkSetAngles("NeedleCD", this.setNew.vspeed >= 0.0F ? -this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190D9r5.vsiNeedleScale) : this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190D9r5.vsiNeedleScale), 0.0F, 0.0F);
        }
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
    ...
    static {
        Property.set(CockpitFW_190D9r5.class, "normZN", 0.72F);
        Property.set(CockpitFW_190D9r5.class, "gsZN", 0.66F);
    }
