...
public class CockpitFW_190F8MSTL extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitFW_190F8MSTL.this.fm != null) {
                ...
                CockpitFW_190F8MSTL.this.setNew.vspeed = ((499F * CockpitFW_190F8MSTL.this.setOld.vspeed) + CockpitFW_190F8MSTL.this.fm.getVertSpeed()) / 500F;
                float f = CockpitFW_190F8MSTL.this.waypointAzimuth();
                if (CockpitFW_190F8MSTL.this.useRealisticNavigationInstruments()) {
                    CockpitFW_190F8MSTL.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitFW_190F8MSTL.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitFW_190F8MSTL.this.setNew.waypointAzimuth.setDeg(CockpitFW_190F8MSTL.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitFW_190F8MSTL.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitFW_190F8MSTL.this.fm.Or.getKren()) < 30F) {
                ...
                CockpitFW_190F8MSTL.this.setNew.turn = ((12F * CockpitFW_190F8MSTL.this.setOld.turn) + CockpitFW_190F8MSTL.this.w.z) / 13F;
                CockpitFW_190F8MSTL.this.setNew.beaconDirection = ((10F * CockpitFW_190F8MSTL.this.setOld.beaconDirection) + CockpitFW_190F8MSTL.this.getBeaconDirection()) / 11F;
                CockpitFW_190F8MSTL.this.setNew.beaconRange = ((10F * CockpitFW_190F8MSTL.this.setOld.beaconRange) + CockpitFW_190F8MSTL.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public CockpitFW_190F8MSTL() {
        ...
        this.cockpitNightMats = (new String[] { "D9GP1", "A8GP2", "D9GP3", "F8SWGP4", "F8SWGP5", "A4GP6", "A5GP3Km", "F8SWGP8", "DA8GP1", "DA8GP2", "DA8GP3", "DF8SWGP4", "F8SWEQpt5" });
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.fm.EI.getNum() > 1) {
            this.mesh.chunkSetAngles("NeedleMP88_L", -this.cvt(this.fm.EI.engines[1].getManifoldPressure(), 0.6F, 1.8F, 0.0F, 336F), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("NeedleMP88_R", -this.cvt(this.fm.EI.engines[2].getManifoldPressure(), 0.6F, 1.8F, 0.0F, 336F), 0.0F, 0.0F);
        }
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitFW_190F8MSTL.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitFW_190F8MSTL.rpmScale), 0.0F, 0.0F);
        if (this.fm.EI.getNum() > 1) {
            this.mesh.chunkSetAngles("NeedleRPM88_L", -this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitFW_190F8MSTL.rpmScale), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("NeedleRPM88_R", -this.floatindex(this.cvt(this.fm.EI.engines[2].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitFW_190F8MSTL.rpmScale), 0.0F, 0.0F);
        }
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 4F), CockpitFW_190F8MSTL.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleOilTemp", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 3F), CockpitFW_190F8MSTL.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedleCD", this.setNew.vspeed >= 0.0F ? -this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190F8MSTL.vsiNeedleScale) : this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190F8MSTL.vsiNeedleScale), 0.0F, 0.0F);
        ...
        if (this.fm.EI.getNum() > 1) {
            this.mesh.chunkSetAngles("NeedleHBS88_L", -105F + ((float) Math.toDegrees(this.fm.EI.engines[1].getPropPhi() - this.fm.EI.engines[1].getPropPhiMin()) * 5F), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("NeedleHBL88_L", -270F + ((float) Math.toDegrees(this.fm.EI.engines[1].getPropPhi() - this.fm.EI.engines[1].getPropPhiMin()) * 60F), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("NeedleHBS88_R", -105F + ((float) Math.toDegrees(this.fm.EI.engines[2].getPropPhi() - this.fm.EI.engines[2].getPropPhiMin()) * 5F), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("NeedleHBL88_R", -270F + ((float) Math.toDegrees(this.fm.EI.engines[2].getPropPhi() - this.fm.EI.engines[2].getPropPhiMin()) * 60F), 0.0F, 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("SteeringHatUD", 30F * this.pictElev, 0.0F, 0.0F);
        this.mesh.chunkSetAngles("SteeringHatLR", 30F * this.pictAiler, 0.0F, 0.0F);
        this.resetYPRmodifier();
        ...
        this.resetYPRmodifier();
        Cockpit.ypr[0] = this.interp(this.setNew.throttle0, this.setOld.throttle0, f) * 34F * 0.91F;
        this.mesh.chunkSetLocate("ThrottleQuad", Cockpit.xyz, Cockpit.ypr);
        if (this.fm.EI.getNum() > 1) {
            this.mesh.chunkSetAngles("Ju88TQ_L", 0.0F, -30F * this.interp(this.setNew.throttle1, this.setOld.throttle1, f), 0.0F);
            this.mesh.chunkSetAngles("Ju88TQ_R", 0.0F, -30F * this.interp(this.setNew.throttle2, this.setOld.throttle2, f), 0.0F);
        }
