...
public class CockpitFW_190F8PB extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitFW_190F8PB.this.fm != null) {
                CockpitFW_190F8PB.this.setTmp = CockpitFW_190F8PB.this.setOld;
                CockpitFW_190F8PB.this.setOld = CockpitFW_190F8PB.this.setNew;
                CockpitFW_190F8PB.this.setNew = CockpitFW_190F8PB.this.setTmp;
                CockpitFW_190F8PB.this.setNew.altimeter = CockpitFW_190F8PB.this.fm.getAltitude();
                if (CockpitFW_190F8PB.this.cockpitDimControl) {
                    if (CockpitFW_190F8PB.this.setNew.dimPosition > 0.0F) {
                        CockpitFW_190F8PB.this.setNew.dimPosition = CockpitFW_190F8PB.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitFW_190F8PB.this.setNew.dimPosition < 1.0F) {
                    CockpitFW_190F8PB.this.setNew.dimPosition = CockpitFW_190F8PB.this.setOld.dimPosition + 0.05F;
                }
                CockpitFW_190F8PB.this.setNew.throttle = ((10F * CockpitFW_190F8PB.this.setOld.throttle) + CockpitFW_190F8PB.this.fm.CT.PowerControl) / 11F;
                CockpitFW_190F8PB.this.setNew.vspeed = ((499F * CockpitFW_190F8PB.this.setOld.vspeed) + CockpitFW_190F8PB.this.fm.getVertSpeed()) / 500F;
                float f = CockpitFW_190F8PB.this.waypointAzimuth();
                if (CockpitFW_190F8PB.this.useRealisticNavigationInstruments()) {
                    CockpitFW_190F8PB.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitFW_190F8PB.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitFW_190F8PB.this.setNew.waypointAzimuth.setDeg(CockpitFW_190F8PB.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitFW_190F8PB.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitFW_190F8PB.this.fm.Or.getKren()) < 30F) {
                    CockpitFW_190F8PB.this.setNew.azimuth.setDeg(CockpitFW_190F8PB.this.setOld.azimuth.getDeg(1.0F), CockpitFW_190F8PB.this.fm.Or.azimut());
                }
                CockpitFW_190F8PB.this.w.set(CockpitFW_190F8PB.this.fm.getW());
                CockpitFW_190F8PB.this.fm.Or.transform(CockpitFW_190F8PB.this.w);
                CockpitFW_190F8PB.this.setNew.turn = ((12F * CockpitFW_190F8PB.this.setOld.turn) + CockpitFW_190F8PB.this.w.z) / 13F;
                CockpitFW_190F8PB.this.setNew.beaconDirection = ((10F * CockpitFW_190F8PB.this.setOld.beaconDirection) + CockpitFW_190F8PB.this.getBeaconDirection()) / 11F;
                CockpitFW_190F8PB.this.setNew.beaconRange = ((10F * CockpitFW_190F8PB.this.setOld.beaconRange) + CockpitFW_190F8PB.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.bomb[0] == null) {
            ...
            if (((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb01") != GunEmpty.get()) {
                ...
                this.bomb[0] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb05");
            }
            if (((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock16") != GunEmpty.get()) {
                this.bomb[1] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock03");
                this.bomb[2] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock05");
                this.bomb[3] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock07");
                this.bomb[4] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock09");
                this.bomb[5] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock11");
                this.bomb[6] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock13");
                this.bomb[7] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock15");
            } else if (((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock21") != GunEmpty.get()) {
                this.bomb[1] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock17");
                this.bomb[2] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock19");
                this.bomb[3] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock21");
                this.bomb[4] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock23");
                this.bomb[5] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock25");
                this.bomb[6] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock27");
                this.bomb[7] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalRock29");
            }
        ...
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitFW_190F8PB.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitFW_190F8PB.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 4F), CockpitFW_190F8PB.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleOilTemp", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 3F), CockpitFW_190F8PB.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedleCD", this.setNew.vspeed >= 0.0F ? -this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190F8PB.vsiNeedleScale) : this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190F8PB.vsiNeedleScale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitFW_190F8PB.class, "normZN", 0.72F);
        Property.set(CockpitFW_190F8PB.class, "gsZN", 0.66F);
    }
