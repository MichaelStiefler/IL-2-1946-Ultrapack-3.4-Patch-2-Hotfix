...
public class CockpitFW_190F8T extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitFW_190F8T.this.fm != null) {
                CockpitFW_190F8T.this.setTmp = CockpitFW_190F8T.this.setOld;
                CockpitFW_190F8T.this.setOld = CockpitFW_190F8T.this.setNew;
                CockpitFW_190F8T.this.setNew = CockpitFW_190F8T.this.setTmp;
                CockpitFW_190F8T.this.setNew.altimeter = CockpitFW_190F8T.this.fm.getAltitude();
                if (CockpitFW_190F8T.this.cockpitDimControl) {
                    if (CockpitFW_190F8T.this.setNew.dimPosition > 0.0F) {
                        CockpitFW_190F8T.this.setNew.dimPosition = CockpitFW_190F8T.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitFW_190F8T.this.setNew.dimPosition < 1.0F) {
                    CockpitFW_190F8T.this.setNew.dimPosition = CockpitFW_190F8T.this.setOld.dimPosition + 0.05F;
                }
                CockpitFW_190F8T.this.setNew.throttle = ((10F * CockpitFW_190F8T.this.setOld.throttle) + CockpitFW_190F8T.this.fm.CT.PowerControl) / 11F;
                CockpitFW_190F8T.this.setNew.vspeed = ((499F * CockpitFW_190F8T.this.setOld.vspeed) + CockpitFW_190F8T.this.fm.getVertSpeed()) / 500F;
                CockpitFW_190F8T.this.setNew.waypointAzimuth.setDeg(CockpitFW_190F8T.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitFW_190F8T.this.waypointAzimuth() - CockpitFW_190F8T.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitFW_190F8T.this.fm.Or.getKren()) < 30F) {
                    CockpitFW_190F8T.this.setNew.azimuth.setDeg(CockpitFW_190F8T.this.setOld.azimuth.getDeg(1.0F), CockpitFW_190F8T.this.fm.Or.azimut());
                }
            }
            return true;
        }
    ...
    public CockpitFW_190F8T() {
        super("3DO/Cockpit/FW-190F-8T/hier.him", "bf109");
        this.gun = new Gun[6];
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitFW_190F8T.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitFW_190F8T.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 4F), CockpitFW_190F8T.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleOilTemp", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 3F), CockpitFW_190F8T.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedleCD", this.setNew.vspeed < 0.0F ? this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190F8T.vsiNeedleScale) : -this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190F8T.vsiNeedleScale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitFW_190F8T.class, "normZN", 0.72F);
        Property.set(CockpitFW_190F8T.class, "gsZN", 0.66F);
    }
