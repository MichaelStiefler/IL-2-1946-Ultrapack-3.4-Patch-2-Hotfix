...
public class CockpitFW_190FG89 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitFW_190FG89.this.fm != null) {
                CockpitFW_190FG89.this.setTmp = CockpitFW_190FG89.this.setOld;
                CockpitFW_190FG89.this.setOld = CockpitFW_190FG89.this.setNew;
                CockpitFW_190FG89.this.setNew = CockpitFW_190FG89.this.setTmp;
                CockpitFW_190FG89.this.setNew.altimeter = CockpitFW_190FG89.this.fm.getAltitude();
                if (CockpitFW_190FG89.this.cockpitDimControl) {
                    if (CockpitFW_190FG89.this.setNew.dimPosition > 0.0F) {
                        CockpitFW_190FG89.this.setNew.dimPosition = CockpitFW_190FG89.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitFW_190FG89.this.setNew.dimPosition < 1.0F) {
                    CockpitFW_190FG89.this.setNew.dimPosition = CockpitFW_190FG89.this.setOld.dimPosition + 0.05F;
                }
                CockpitFW_190FG89.this.setNew.throttle = ((10F * CockpitFW_190FG89.this.setOld.throttle) + CockpitFW_190FG89.this.fm.CT.PowerControl) / 11F;
                CockpitFW_190FG89.this.setNew.vspeed = ((499F * CockpitFW_190FG89.this.setOld.vspeed) + CockpitFW_190FG89.this.fm.getVertSpeed()) / 500F;
                float f = CockpitFW_190FG89.this.waypointAzimuth();
                if (CockpitFW_190FG89.this.useRealisticNavigationInstruments()) {
                    CockpitFW_190FG89.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitFW_190FG89.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitFW_190FG89.this.setNew.waypointAzimuth.setDeg(CockpitFW_190FG89.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitFW_190FG89.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitFW_190FG89.this.fm.Or.getKren()) < 30F) {
                    CockpitFW_190FG89.this.setNew.azimuth.setDeg(CockpitFW_190FG89.this.setOld.azimuth.getDeg(1.0F), CockpitFW_190FG89.this.fm.Or.azimut());
                }
                CockpitFW_190FG89.this.w.set(CockpitFW_190FG89.this.fm.getW());
                CockpitFW_190FG89.this.fm.Or.transform(CockpitFW_190FG89.this.w);
                CockpitFW_190FG89.this.setNew.turn = ((12F * CockpitFW_190FG89.this.setOld.turn) + CockpitFW_190FG89.this.w.z) / 13F;
                CockpitFW_190FG89.this.setNew.beaconDirection = ((10F * CockpitFW_190FG89.this.setOld.beaconDirection) + CockpitFW_190FG89.this.getBeaconDirection()) / 11F;
                CockpitFW_190FG89.this.setNew.beaconRange = ((10F * CockpitFW_190FG89.this.setOld.beaconRange) + CockpitFW_190FG89.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.bomb[0] == null) {
            ...
            if (((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb01") != GunEmpty.get()) {
                this.bomb[0] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb01");
                this.bomb[1] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb01");
            } else if (((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb05") != GunEmpty.get()) {
                this.bomb[0] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb02");
                this.bomb[1] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb03");
                this.bomb[4] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb04");
                this.bomb[5] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb05");
            } else if (((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalDev19") != GunEmpty.get()) {
                this.bomb[0] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalDev19");
                this.bomb[1] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalDev19");
            }
            if (((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb08") != GunEmpty.get()) {
                this.bomb[2] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb06");
                this.bomb[3] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb07");
                this.bomb[6] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb08");
                this.bomb[7] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb09");
            } else if (((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb10") != GunEmpty.get()) {
                this.bomb[2] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb10");
                this.bomb[3] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalBomb11");
            } else if (((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalDev15") != GunEmpty.get()) {
                this.bomb[2] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalDev15");
                this.bomb[3] = ((Aircraft) this.fm.actor).getBulletEmitterByHookName("_ExternalDev16");
            }
        ...
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitFW_190FG89.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitFW_190FG89.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 4F), CockpitFW_190FG89.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleOilTemp", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 3F), CockpitFW_190FG89.oilTempScale), 0.0F, 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 2) == 0) && ((this.fm.AS.astateCockpitState & 1) == 0) && ((this.fm.AS.astateCockpitState & 4) == 0)) {
            ...
            this.mesh.chunkSetAngles("NeedleCD", this.setNew.vspeed >= 0.0F ? -this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190FG89.vsiNeedleScale) : this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitFW_190FG89.vsiNeedleScale), 0.0F, 0.0F);
            ...
            if (this.t1 < Time.current()) {
                ...
                this.mesh.chunkVisible("XLampBomb_LWOut", this.bomb[3].haveBullets());
                this.mesh.chunkVisible("XLampBomb_LWIn", this.bomb[1].haveBullets());
                this.mesh.chunkVisible("XLampBomb_CFF_L", this.bomb[7].haveBullets());
                this.mesh.chunkVisible("XLampBomb_CFF_R", this.bomb[5].haveBullets());
                this.mesh.chunkVisible("XLampBomb_RWIn", this.bomb[0].haveBullets());
                this.mesh.chunkVisible("XLampBomb_RWOut", this.bomb[2].haveBullets());
                this.mesh.chunkVisible("XLampBomb_CFA_L", this.bomb[4].haveBullets());
                this.mesh.chunkVisible("XLampBomb_CFA_R", this.bomb[6].haveBullets());
            }
    ...
    static {
        Property.set(CockpitFW_190FG89.class, "normZN", 0.72F);
        Property.set(CockpitFW_190FG89.class, "gsZN", 0.66F);
    }
