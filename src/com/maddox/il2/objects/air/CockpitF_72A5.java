...
public class CockpitF_72A5 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitF_72A5.this.fm != null) {
                ...
                float f = CockpitF_72A5.this.waypointAzimuth();
                if (CockpitF_72A5.this.useRealisticNavigationInstruments()) {
                    CockpitF_72A5.this.setNew.waypointAzimuth.setDeg(f - 90.0F);
                    CockpitF_72A5.this.setOld.waypointAzimuth.setDeg(f - 90.0F);
                } else {
                    CockpitF_72A5.this.setNew.waypointAzimuth.setDeg(CockpitF_72A5.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitF_72A5.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitF_72A5.this.fm.Or.getKren()) < 30F) {
                    CockpitF_72A5.this.setNew.azimuth.setDeg(CockpitF_72A5.this.setOld.azimuth.getDeg(1.0F), CockpitF_72A5.this.fm.Or.azimut());
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("throtle", 0.0F, 0.0F, -62.7F * this.setNew.throttle);
