...
public class CockpitF_80C extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitF_80C.this.fm != null) {
                CockpitF_80C.this.setTmp = CockpitF_80C.this.setOld;
                CockpitF_80C.this.setOld = CockpitF_80C.this.setNew;
                CockpitF_80C.this.setNew = CockpitF_80C.this.setTmp;
                CockpitF_80C.this.setNew.throttle = (0.85F * CockpitF_80C.this.setOld.throttle) + (CockpitF_80C.this.fm.CT.PowerControl * 0.15F);
                CockpitF_80C.this.setNew.prop = (0.85F * CockpitF_80C.this.setOld.prop) + (CockpitF_80C.this.fm.CT.getStepControl() * 0.15F);
                CockpitF_80C.this.setNew.stage = (0.85F * CockpitF_80C.this.setOld.stage) + (CockpitF_80C.this.fm.EI.engines[0].getControlCompressor() * 0.15F);
                CockpitF_80C.this.setNew.mix = (0.85F * CockpitF_80C.this.setOld.mix) + (CockpitF_80C.this.fm.EI.engines[0].getControlMix() * 0.15F);
                CockpitF_80C.this.setNew.altimeter = CockpitF_80C.this.fm.getAltitude();
                CockpitF_80C.this.setNew.waypointAzimuth.setDeg(CockpitF_80C.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitF_80C.this.waypointAzimuth() - CockpitF_80C.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitF_80C.this.fm.Or.getKren()) < 30F) {
                    CockpitF_80C.this.setNew.azimuth.setDeg(CockpitF_80C.this.setOld.azimuth.getDeg(1.0F), CockpitF_80C.this.fm.Or.azimut());
                }
                CockpitF_80C.this.setNew.vspeed = ((199F * CockpitF_80C.this.setOld.vspeed) + CockpitF_80C.this.fm.getVertSpeed()) / 200F;
                float f = ((F_80C) CockpitF_80C.this.aircraft()).k14Distance;
                CockpitF_80C.this.setNew.k14w = (5F * CockpitF_80C.k14TargetWingspanScale[((F_80C) CockpitF_80C.this.aircraft()).k14WingspanType]) / f;
                CockpitF_80C.this.setNew.k14w = (0.9F * CockpitF_80C.this.setOld.k14w) + (0.1F * CockpitF_80C.this.setNew.k14w);
                CockpitF_80C.this.setNew.k14wingspan = (0.9F * CockpitF_80C.this.setOld.k14wingspan) + (0.1F * CockpitF_80C.k14TargetMarkScale[((F_80C) CockpitF_80C.this.aircraft()).k14WingspanType]);
                CockpitF_80C.this.setNew.k14mode = (0.8F * CockpitF_80C.this.setOld.k14mode) + (0.2F * ((F_80C) CockpitF_80C.this.aircraft()).k14Mode);
                Vector3d vector3d = CockpitF_80C.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitF_80C.this.floatindex((f - 200F) * 0.04F, CockpitF_80C.k14BulletDrop) - CockpitF_80C.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitF_80C.this.setNew.k14x = (0.92F * CockpitF_80C.this.setOld.k14x) + (0.08F * f1);
                CockpitF_80C.this.setNew.k14y = (0.92F * CockpitF_80C.this.setOld.k14y) + (0.08F * f2);
                if (CockpitF_80C.this.setNew.k14x > 7F) {
                    CockpitF_80C.this.setNew.k14x = 7F;
                }
                if (CockpitF_80C.this.setNew.k14x < -7F) {
                    CockpitF_80C.this.setNew.k14x = -7F;
                }
                if (CockpitF_80C.this.setNew.k14y > 7F) {
                    CockpitF_80C.this.setNew.k14y = 7F;
                }
                if (CockpitF_80C.this.setNew.k14y < -7F) {
                    CockpitF_80C.this.setNew.k14y = -7F;
                }
    ...
    public void reflectWorldToInstruments(float f) {
        if ((this.fm.AS.astateCockpitState & 2) == 0) {
            int i = ((F_80C) this.aircraft()).k14Mode;
            boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitF_80C.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitF_80C.variometerScale), 0.0F, 0.0F);
