...
public class CockpitF_86A extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitF_86A.this.fm != null) {
                CockpitF_86A.this.setTmp = CockpitF_86A.this.setOld;
                CockpitF_86A.this.setOld = CockpitF_86A.this.setNew;
                CockpitF_86A.this.setNew = CockpitF_86A.this.setTmp;
                ...
                float a = CockpitF_86A.this.waypointAzimuth();
                if (CockpitF_86A.this.useRealisticNavigationInstruments()) {
                    CockpitF_86A.this.setNew.waypointAzimuth.setDeg(a - 90F);
                    CockpitF_86A.this.setOld.waypointAzimuth.setDeg(a - 90F);
                } else {
                    CockpitF_86A.this.setNew.waypointAzimuth.setDeg(CockpitF_86A.this.setOld.waypointAzimuth.getDeg(0.1F), a - CockpitF_86A.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitF_86A.this.fm.Or.getKren()) < 30F) {
                    CockpitF_86A.this.setNew.azimuth.setDeg(CockpitF_86A.this.setOld.azimuth.getDeg(1.0F), CockpitF_86A.this.fm.Or.azimut());
                }
                CockpitF_86A.this.setNew.vspeed = ((199F * CockpitF_86A.this.setOld.vspeed) + CockpitF_86A.this.fm.getVertSpeed()) / 200F;
                float f = ((F_86A) CockpitF_86A.this.aircraft()).k14Distance;
                CockpitF_86A.this.setNew.k14w = (5F * CockpitF_86A.k14TargetWingspanScale[((F_86A) CockpitF_86A.this.aircraft()).k14WingspanType]) / f;
                ...
                com.maddox.JGP.Vector3d vector3d = CockpitF_86A.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitF_86A.this.floatindex((f - 200F) * 0.04F, CockpitF_86A.k14BulletDrop) - CockpitF_86A.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitF_86A.this.setNew.k14x = (0.92F * CockpitF_86A.this.setOld.k14x) + (0.08F * f1);
                CockpitF_86A.this.setNew.k14y = (0.92F * CockpitF_86A.this.setOld.k14y) + (0.08F * f2);
                if (CockpitF_86A.this.setNew.k14x > 7F) {
                    CockpitF_86A.this.setNew.k14x = 7F;
                }
                if (CockpitF_86A.this.setNew.k14x < -7F) {
                    CockpitF_86A.this.setNew.k14x = -7F;
                }
                if (CockpitF_86A.this.setNew.k14y > 7F) {
                    CockpitF_86A.this.setNew.k14y = 7F;
                }
                if (CockpitF_86A.this.setNew.k14y < -7F) {
                    CockpitF_86A.this.setNew.k14y = -7F;
                }
                CockpitF_86A.this.buzzerFX((CockpitF_86A.this.fm.getSpeed() < 63F) && (CockpitF_86A.this.fm.Gears.nOfGearsOnGr < 1));
                CockpitF_86A.this.setNew.beaconDirection = ((10F * CockpitF_86A.this.setOld.beaconDirection) + CockpitF_86A.this.getBeaconDirection()) / 11F;
                CockpitF_86A.this.setNew.beaconRange = ((10F * CockpitF_86A.this.setOld.beaconRange) + CockpitF_86A.this.getBeaconRange()) / 11F;
                if (CockpitF_86A.this.fm.EI.engines[0].getStage() < 6) {
                    if (CockpitF_86A.this.setNew.stbyPosition > 0.0F) {
                        CockpitF_86A.this.setNew.stbyPosition = CockpitF_86A.this.setOld.stbyPosition - 0.002F;
                    }
                } else if (CockpitF_86A.this.setNew.stbyPosition < 1.0F) {
                    CockpitF_86A.this.setNew.stbyPosition = CockpitF_86A.this.setOld.stbyPosition + 0.002F;
                }
                if (CockpitF_86A.this.setNew.stbyPosition2 < 1.0F) {
                    CockpitF_86A.this.setNew.stbyPosition2 = CockpitF_86A.this.setOld.stbyPosition2 + 0.002F;
                }
            }
            return true;
        }
    ...
    public CockpitF_86A() {
        super("3DO/Cockpit/F-86/F-86A.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.machNumber() < 0.95F) || (this.machNumber() > 1.0F)) {
            this.mesh.chunkSetAngles("Z_Speedometer86-1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()) * 1.131F, 74.07994F, 1222.319F, 0.0F, 14F), CockpitF_86A.speedometerScale), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("Z_Speedometer86-2", this.floatindex(this.cvt((this.machNumber() * 1.4F) - 0.4F, 0.3F, 1.5F, 0.0F, 14F), CockpitF_86A.speedometerScale), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("Z_Speedometer86-3", this.floatindex(this.cvt(this.fm.getSpeedKMH() * 1.131F, 74.07994F, 1222.319F, 0.0F, 14F), CockpitF_86A.speedometerScale), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("Z_Climb86", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitF_86A.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_G-Factor", this.cvt(this.fm.getOverload() + 1.0F, -4F, 12F, -80.5F, 241.5F), 0.0F, 0.0F);
        ...
        if (this.setNew.stbyPosition < 0.8F) {
