...
public class CockpitF_86F extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitF_86F.this.fm != null) {
                CockpitF_86F.this.setTmp = CockpitF_86F.this.setOld;
                CockpitF_86F.this.setOld = CockpitF_86F.this.setNew;
                CockpitF_86F.this.setNew = CockpitF_86F.this.setTmp;
                CockpitF_86F.this.setNew.throttle = (0.85F * CockpitF_86F.this.setOld.throttle) + (CockpitF_86F.this.fm.CT.PowerControl * 0.15F);
                CockpitF_86F.this.setNew.prop = (0.85F * CockpitF_86F.this.setOld.prop) + (CockpitF_86F.this.fm.CT.getStepControl() * 0.15F);
                CockpitF_86F.this.setNew.stage = (0.85F * CockpitF_86F.this.setOld.stage) + (CockpitF_86F.this.fm.EI.engines[0].getControlCompressor() * 0.15F);
                CockpitF_86F.this.setNew.mix = (0.85F * CockpitF_86F.this.setOld.mix) + (CockpitF_86F.this.fm.EI.engines[0].getControlMix() * 0.15F);
                CockpitF_86F.this.setNew.altimeter = CockpitF_86F.this.fm.getAltitude();
                float a = CockpitF_86F.this.waypointAzimuth();
                if (CockpitF_86F.this.useRealisticNavigationInstruments()) {
                    CockpitF_86F.this.setNew.waypointAzimuth.setDeg(a - 90F);
                    CockpitF_86F.this.setOld.waypointAzimuth.setDeg(a - 90F);
                } else {
                    CockpitF_86F.this.setNew.waypointAzimuth.setDeg(CockpitF_86F.this.setOld.waypointAzimuth.getDeg(0.1F), a - CockpitF_86F.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitF_86F.this.fm.Or.getKren()) < 30F) {
                    CockpitF_86F.this.setNew.azimuth.setDeg(CockpitF_86F.this.setOld.azimuth.getDeg(1.0F), CockpitF_86F.this.fm.Or.azimut());
                }
                CockpitF_86F.this.setNew.vspeed = ((199F * CockpitF_86F.this.setOld.vspeed) + CockpitF_86F.this.fm.getVertSpeed()) / 200F;
                float f = ((F_86F) CockpitF_86F.this.aircraft()).k14Distance;
                CockpitF_86F.this.setNew.k14w = (5F * CockpitF_86F.k14TargetWingspanScale[((F_86F) CockpitF_86F.this.aircraft()).k14WingspanType]) / f;
                CockpitF_86F.this.setNew.k14w = (0.9F * CockpitF_86F.this.setOld.k14w) + (0.1F * CockpitF_86F.this.setNew.k14w);
                CockpitF_86F.this.setNew.k14wingspan = (0.9F * CockpitF_86F.this.setOld.k14wingspan) + (0.1F * CockpitF_86F.k14TargetMarkScale[((F_86F) CockpitF_86F.this.aircraft()).k14WingspanType]);
                CockpitF_86F.this.setNew.k14mode = (0.8F * CockpitF_86F.this.setOld.k14mode) + (0.2F * ((F_86F) CockpitF_86F.this.aircraft()).k14Mode);
                com.maddox.JGP.Vector3d vector3d = CockpitF_86F.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitF_86F.this.floatindex((f - 200F) * 0.04F, CockpitF_86F.k14BulletDrop) - CockpitF_86F.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitF_86F.this.setNew.k14x = (0.92F * CockpitF_86F.this.setOld.k14x) + (0.08F * f1);
                CockpitF_86F.this.setNew.k14y = (0.92F * CockpitF_86F.this.setOld.k14y) + (0.08F * f2);
                if (CockpitF_86F.this.setNew.k14x > 7F) {
                    CockpitF_86F.this.setNew.k14x = 7F;
                }
                if (CockpitF_86F.this.setNew.k14x < -7F) {
                    CockpitF_86F.this.setNew.k14x = -7F;
                }
                if (CockpitF_86F.this.setNew.k14y > 7F) {
                    CockpitF_86F.this.setNew.k14y = 7F;
                }
                if (CockpitF_86F.this.setNew.k14y < -7F) {
                    CockpitF_86F.this.setNew.k14y = -7F;
                }
                CockpitF_86F.this.buzzerFX((CockpitF_86F.this.fm.getSpeed() < 63F) && (CockpitF_86F.this.fm.Gears.nOfGearsOnGr < 1));
                CockpitF_86F.this.setNew.beaconDirection = ((10F * CockpitF_86F.this.setOld.beaconDirection) + CockpitF_86F.this.getBeaconDirection()) / 11F;
                CockpitF_86F.this.setNew.beaconRange = ((10F * CockpitF_86F.this.setOld.beaconRange) + CockpitF_86F.this.getBeaconRange()) / 11F;
                if (CockpitF_86F.this.fm.EI.engines[0].getStage() < 6) {
                    if (CockpitF_86F.this.setNew.stbyPosition > 0.0F) {
                        CockpitF_86F.this.setNew.stbyPosition = CockpitF_86F.this.setOld.stbyPosition - 0.002F;
                    }
                } else if (CockpitF_86F.this.setNew.stbyPosition < 1.0F) {
                    CockpitF_86F.this.setNew.stbyPosition = CockpitF_86F.this.setOld.stbyPosition + 0.002F;
                }
                if (CockpitF_86F.this.setNew.stbyPosition2 < 1.0F) {
                    CockpitF_86F.this.setNew.stbyPosition2 = CockpitF_86F.this.setOld.stbyPosition2 + 0.002F;
                }
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.machNumber() < 0.95F) || (this.machNumber() > 1.0F)) {
            this.mesh.chunkSetAngles("Z_Speedometer86-1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()) * 1.131F, 74.07994F, 1222.319F, 0.0F, 14F), CockpitF_86F.speedometerScale), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("Z_Speedometer86-2", this.floatindex(this.cvt((this.machNumber() * 1.4F) - 0.4F, 0.3F, 1.5F, 0.0F, 14F), CockpitF_86F.speedometerScale), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("Z_Speedometer86-3", this.floatindex(this.cvt(this.fm.getSpeedKMH() * 1.131F, 74.07994F, 1222.319F, 0.0F, 14F), CockpitF_86F.speedometerScale), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("Z_Climb86", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitF_86F.variometerScale), 0.0F, 0.0F);
