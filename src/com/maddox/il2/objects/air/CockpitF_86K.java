...
public class CockpitF_86K extends CockpitPilot {
        ...
        public boolean tick() {
            if (CockpitF_86K.this.fm != null) {
                ...
                if (CockpitF_86K.this.useRealisticNavigationInstruments()) {
                    ...
                    CockpitF_86K.this.setNew.waypointAzimuth.setDeg(CockpitF_86K.this.setOld.waypointAzimuth.getDeg(0.1F), a - CockpitF_86K.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitF_86K.this.fm.Or.getKren()) < 30F) {
                ...
                if (CockpitF_86K.this.setNew.k14x > 7.0F) {
                    CockpitF_86K.this.setNew.k14x = 7.0F;
                }
                if (CockpitF_86K.this.setNew.k14x < -7.0F) {
                    CockpitF_86K.this.setNew.k14x = -7.0F;
                }
                if (CockpitF_86K.this.setNew.k14y > 7.0F) {
                    CockpitF_86K.this.setNew.k14y = 7.0F;
                }
                if (CockpitF_86K.this.setNew.k14y < -7.0F) {
                    CockpitF_86K.this.setNew.k14y = -7.0F;
                }
                ...
                if (CockpitF_86K.this.fm.EI.engines[0].getStage() < 6) {
                    if (CockpitF_86K.this.setNew.stbyPosition > 0.0F) {
                        CockpitF_86K.this.setNew.stbyPosition = CockpitF_86K.this.setOld.stbyPosition - 0.002F;
                    }
                } else if (CockpitF_86K.this.setNew.stbyPosition < 1.0F) {
                    CockpitF_86K.this.setNew.stbyPosition = CockpitF_86K.this.setOld.stbyPosition + 0.002F;
                }
                if (CockpitF_86K.this.setNew.stbyPosition2 < 1.0F) {
                    CockpitF_86K.this.setNew.stbyPosition2 = CockpitF_86K.this.setOld.stbyPosition2 + 0.002F;
                }
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.machNumber() < 0.95F) || (this.machNumber() > 1.0F)) {
            this.mesh.chunkSetAngles("Z_Speedometer86-1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()) * 1.131F, 74.07994F, 1222.319F, 0.0F, 14F), CockpitF_86K.speedometerScale), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("Z_Speedometer86-2", this.floatindex(this.cvt((this.machNumber() * 1.4F) - 0.4F, 0.3F, 1.5F, 0.0F, 14F), CockpitF_86K.speedometerScale), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("Z_Speedometer86-3", this.floatindex(this.cvt(this.fm.getSpeedKMH() * 1.131F, 74.07994F, 1222.319F, 0.0F, 14F), CockpitF_86K.speedometerScale), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("Z_Climb86", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitF_86K.variometerScale), 0.0F, 0.0F);
