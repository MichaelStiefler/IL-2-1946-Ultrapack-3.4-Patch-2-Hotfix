    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitFiatBr2x.this.fm != null) {
                ...
                if (Math.abs(CockpitFiatBr2x.this.fm.Or.getKren()) < 30F) {
                ...
                if (CockpitFiatBr2x.this.useRealisticNavigationInstruments()) {
                    CockpitFiatBr2x.this.setNew.beaconDirection = ((10F * CockpitFiatBr2x.this.setOld.beaconDirection) + CockpitFiatBr2x.this.getBeaconDirection()) / 11F;
                    CockpitFiatBr2x.this.setNew.beaconRange = ((10F * CockpitFiatBr2x.this.setOld.beaconRange) + CockpitFiatBr2x.this.getBeaconRange()) / 11F;
                } else {
