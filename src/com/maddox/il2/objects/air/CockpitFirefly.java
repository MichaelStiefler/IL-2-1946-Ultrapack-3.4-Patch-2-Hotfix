...
public class CockpitFirefly extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitFirefly.this.fm != null) {
                ...
                CockpitFirefly.this.setNew.waypointAzimuth.setDeg(CockpitFirefly.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitFirefly.this.waypointAzimuth() - CockpitFirefly.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitFirefly.this.fm.Or.getKren()) < 30F) {
                    CockpitFirefly.this.setNew.azimuth.setDeg(CockpitFirefly.this.setOld.azimuth.getDeg(1.0F), CockpitFirefly.this.fm.Or.azimut());
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.aircraft() instanceof Firefly) {
            if (Firefly.bChangedPit) {
                this.reflectPlaneToModel();
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitFirefly.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 50F, 100F, 0.0F, 271F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitFirefly.radScale));
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 25F), CockpitFirefly.speedometerScale));
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitFirefly.variometerScale));
