...
public class CockpitFireflyUpdate extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitFireflyUpdate.this.fm != null) {
                ...
                CockpitFireflyUpdate.this.setNew.waypointAzimuth.setDeg(CockpitFireflyUpdate.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitFireflyUpdate.this.waypointAzimuth() - CockpitFireflyUpdate.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitFireflyUpdate.this.fm.Or.getKren()) < 30F) {
                    CockpitFireflyUpdate.this.setNew.azimuth.setDeg(CockpitFireflyUpdate.this.setOld.azimuth.getDeg(1.0F), CockpitFireflyUpdate.this.fm.Or.azimut());
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("DIRECTOR", 0.0F, this.setNew.azimuth.getDeg(f), 0.0F);
        this.mesh.chunkSetAngles("COMPASS", 0.0F, this.setNew.azimuth.getDeg(f), 0.0F);
