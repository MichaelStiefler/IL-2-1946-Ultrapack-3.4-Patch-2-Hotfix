...
public class CockpitFokkerCX extends CockpitPilot {
    private class Variables {
        ...
        private Variables() {
            ...
            this.compassPoint[0] = new Vector3d(0.0D, Math.sqrt(1.0D - (CockpitFokkerCX.compassZ * CockpitFokkerCX.compassZ)), CockpitFokkerCX.compassZ);
            this.compassPoint[1] = new Vector3d(-Math.sqrt(1.0D - (CockpitFokkerCX.compassZ * CockpitFokkerCX.compassZ)), 0.0D, CockpitFokkerCX.compassZ);
            this.compassPoint[2] = new Vector3d(0.0D, -Math.sqrt(1.0D - (CockpitFokkerCX.compassZ * CockpitFokkerCX.compassZ)), CockpitFokkerCX.compassZ);
            this.compassPoint[3] = new Vector3d(Math.sqrt(1.0D - (CockpitFokkerCX.compassZ * CockpitFokkerCX.compassZ)), 0.0D, CockpitFokkerCX.compassZ);
            this.cP[0] = new Vector3d(0.0D, Math.sqrt(1.0D - (CockpitFokkerCX.compassZ * CockpitFokkerCX.compassZ)), CockpitFokkerCX.compassZ);
            this.cP[1] = new Vector3d(-Math.sqrt(1.0D - (CockpitFokkerCX.compassZ * CockpitFokkerCX.compassZ)), 0.0D, CockpitFokkerCX.compassZ);
            this.cP[2] = new Vector3d(0.0D, -Math.sqrt(1.0D - (CockpitFokkerCX.compassZ * CockpitFokkerCX.compassZ)), CockpitFokkerCX.compassZ);
            this.cP[3] = new Vector3d(Math.sqrt(1.0D - (CockpitFokkerCX.compassZ * CockpitFokkerCX.compassZ)), 0.0D, CockpitFokkerCX.compassZ);
        }
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            CockpitFokkerCX.this.setTmp = CockpitFokkerCX.this.setOld;
            CockpitFokkerCX.this.setOld = CockpitFokkerCX.this.setNew;
            CockpitFokkerCX.this.setNew = CockpitFokkerCX.this.setTmp;
            if (((CockpitFokkerCX.this.fm.AS.astateCockpitState & 2) != 0) && (CockpitFokkerCX.this.setNew.stbyPosition < 1.0F)) {
                CockpitFokkerCX.this.setNew.stbyPosition = CockpitFokkerCX.this.setOld.stbyPosition + 0.0125F;
                CockpitFokkerCX.this.setOld.stbyPosition = CockpitFokkerCX.this.setNew.stbyPosition;
            }
            CockpitFokkerCX.this.setNew.altimeter = CockpitFokkerCX.this.fm.getAltitude();
            if (Math.abs(CockpitFokkerCX.this.fm.Or.getKren()) < 30F) {
                CockpitFokkerCX.this.setNew.azimuth.setDeg(CockpitFokkerCX.this.setOld.azimuth.getDeg(1.0F), CockpitFokkerCX.this.fm.Or.azimut());
            }
            CockpitFokkerCX.this.setNew.throttle = ((10F * CockpitFokkerCX.this.setOld.throttle) + CockpitFokkerCX.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitFokkerCX.this.setNew.mix = ((10F * CockpitFokkerCX.this.setOld.mix) + CockpitFokkerCX.this.fm.EI.engines[0].getControlMix()) / 11F;
            CockpitFokkerCX.this.setNew.prop = CockpitFokkerCX.this.setOld.prop;
            if (CockpitFokkerCX.this.setNew.prop < (CockpitFokkerCX.this.fm.EI.engines[0].getControlProp() - 0.01F)) {
                CockpitFokkerCX.this.setNew.prop += 0.0025F;
            }
            if (CockpitFokkerCX.this.setNew.prop > (CockpitFokkerCX.this.fm.EI.engines[0].getControlProp() + 0.01F)) {
                CockpitFokkerCX.this.setNew.prop -= 0.0025F;
            }
            CockpitFokkerCX.this.w.set(CockpitFokkerCX.this.fm.getW());
            CockpitFokkerCX.this.fm.Or.transform(CockpitFokkerCX.this.w);
            CockpitFokkerCX.this.setNew.turn = ((12F * CockpitFokkerCX.this.setOld.turn) + CockpitFokkerCX.this.w.z) / 13F;
            CockpitFokkerCX.this.setNew.vspeed = ((299F * CockpitFokkerCX.this.setOld.vspeed) + CockpitFokkerCX.this.fm.getVertSpeed()) / 300F;
            CockpitFokkerCX.this.pictSupc = (0.8F * CockpitFokkerCX.this.pictSupc) + (0.2F * CockpitFokkerCX.this.fm.EI.engines[0].getControlCompressor());
            if (CockpitFokkerCX.this.cockpitDimControl) {
                if (CockpitFokkerCX.this.setNew.dimPos < 1.0F) {
                    CockpitFokkerCX.this.setNew.dimPos = CockpitFokkerCX.this.setOld.dimPos + 0.03F;
                }
            } else if (CockpitFokkerCX.this.setNew.dimPos > 0.0F) {
                CockpitFokkerCX.this.setNew.dimPos = CockpitFokkerCX.this.setOld.dimPos - 0.03F;
            }
            if (!CockpitFokkerCX.this.fm.Gears.bTailwheelLocked && (CockpitFokkerCX.this.tailWheelLock < 1.0F)) {
                CockpitFokkerCX.this.tailWheelLock = CockpitFokkerCX.this.tailWheelLock + 0.05F;
            } else if (CockpitFokkerCX.this.fm.Gears.bTailwheelLocked && (CockpitFokkerCX.this.tailWheelLock > 0.0F)) {
                CockpitFokkerCX.this.tailWheelLock = CockpitFokkerCX.this.tailWheelLock - 0.05F;
            }
            CockpitFokkerCX.this.updateCompass();
            return true;
        }
    ...
    public CockpitFokkerCX() {
        super("3DO/Cockpit/FokkerCX/hier.him", "bf109");
    ...
    private void initCompass() {
        ...
        this.segLen1 = 2D * Math.sqrt(1.0D - (CockpitFokkerCX.compassZ * CockpitFokkerCX.compassZ));
        this.segLen2 = this.segLen1 / Math.sqrt(2D);
        this.compassLimit = -1D * Math.sin(0.01745328888888889D * CockpitFokkerCX.compassLimitAngle);
    ...
    private void updateCompass() {
        ...
        if (this.accel.length() > (-CockpitFokkerCX.compassZ * 0.7D)) {
            this.accel.scale((-CockpitFokkerCX.compassZ * 0.7D) / this.accel.length());
        }
        for (int i = 0; i < 4; i++) {
        ...
        vector3d2.normalize();
        vector3d2.scale(-CockpitFokkerCX.compassZ);
