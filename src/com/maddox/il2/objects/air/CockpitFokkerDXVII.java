...
public class CockpitFokkerDXVII extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            CockpitFokkerDXVII.this.setTmp = CockpitFokkerDXVII.this.setOld;
            CockpitFokkerDXVII.this.setOld = CockpitFokkerDXVII.this.setNew;
            CockpitFokkerDXVII.this.setNew = CockpitFokkerDXVII.this.setTmp;
            if (((CockpitFokkerDXVII.this.fm.AS.astateCockpitState & 2) != 0) && (CockpitFokkerDXVII.this.setNew.stbyPosition < 1.0F)) {
                CockpitFokkerDXVII.this.setNew.stbyPosition = CockpitFokkerDXVII.this.setOld.stbyPosition + 0.0125F;
                CockpitFokkerDXVII.this.setOld.stbyPosition = CockpitFokkerDXVII.this.setNew.stbyPosition;
            }
            CockpitFokkerDXVII.this.setNew.altimeter = CockpitFokkerDXVII.this.fm.getAltitude();
            if (Math.abs(CockpitFokkerDXVII.this.fm.Or.getKren()) < 30F) {
                CockpitFokkerDXVII.this.setNew.azimuth.setDeg(CockpitFokkerDXVII.this.setOld.azimuth.getDeg(1.0F), CockpitFokkerDXVII.this.fm.Or.azimut());
            }
            CockpitFokkerDXVII.this.setNew.throttle = ((10F * CockpitFokkerDXVII.this.setOld.throttle) + CockpitFokkerDXVII.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitFokkerDXVII.this.setNew.mix = ((10F * CockpitFokkerDXVII.this.setOld.mix) + CockpitFokkerDXVII.this.fm.EI.engines[0].getControlMix()) / 11F;
            CockpitFokkerDXVII.this.setNew.prop = CockpitFokkerDXVII.this.setOld.prop;
            if (CockpitFokkerDXVII.this.setNew.prop < (CockpitFokkerDXVII.this.fm.EI.engines[0].getControlProp() - 0.01F)) {
                CockpitFokkerDXVII.this.setNew.prop += 0.0025F;
            }
            if (CockpitFokkerDXVII.this.setNew.prop > (CockpitFokkerDXVII.this.fm.EI.engines[0].getControlProp() + 0.01F)) {
                CockpitFokkerDXVII.this.setNew.prop -= 0.0025F;
            }
            CockpitFokkerDXVII.this.w.set(CockpitFokkerDXVII.this.fm.getW());
            CockpitFokkerDXVII.this.fm.Or.transform(CockpitFokkerDXVII.this.w);
            CockpitFokkerDXVII.this.setNew.turn = ((12F * CockpitFokkerDXVII.this.setOld.turn) + CockpitFokkerDXVII.this.w.z) / 13F;
            CockpitFokkerDXVII.this.setNew.vspeed = ((299F * CockpitFokkerDXVII.this.setOld.vspeed) + CockpitFokkerDXVII.this.fm.getVertSpeed()) / 300F;
            CockpitFokkerDXVII.this.pictSupc = (0.8F * CockpitFokkerDXVII.this.pictSupc) + (0.2F * CockpitFokkerDXVII.this.fm.EI.engines[0].getControlCompressor());
            if (CockpitFokkerDXVII.this.cockpitDimControl) {
                if (CockpitFokkerDXVII.this.setNew.dimPos < 1.0F) {
                    CockpitFokkerDXVII.this.setNew.dimPos = CockpitFokkerDXVII.this.setOld.dimPos + 0.03F;
                }
            } else if (CockpitFokkerDXVII.this.setNew.dimPos > 0.0F) {
                CockpitFokkerDXVII.this.setNew.dimPos = CockpitFokkerDXVII.this.setOld.dimPos - 0.03F;
            }
            if (!CockpitFokkerDXVII.this.fm.Gears.bTailwheelLocked && (CockpitFokkerDXVII.this.tailWheelLock < 1.0F)) {
                CockpitFokkerDXVII.this.tailWheelLock = CockpitFokkerDXVII.this.tailWheelLock + 0.05F;
            } else if (CockpitFokkerDXVII.this.fm.Gears.bTailwheelLocked && (CockpitFokkerDXVII.this.tailWheelLock > 0.0F)) {
                CockpitFokkerDXVII.this.tailWheelLock = CockpitFokkerDXVII.this.tailWheelLock - 0.05F;
            }
            CockpitFokkerDXVII.this.updateCompass();
            return true;
        }
    ...
    private class Variables {
        ...
        private Variables() {
            ...
            this.compassPoint[0] = new Vector3d(0.0D, Math.sqrt(1.0D - (CockpitFokkerDXVII.compassZ * CockpitFokkerDXVII.compassZ)), CockpitFokkerDXVII.compassZ);
            this.compassPoint[1] = new Vector3d(-Math.sqrt(1.0D - (CockpitFokkerDXVII.compassZ * CockpitFokkerDXVII.compassZ)), 0.0D, CockpitFokkerDXVII.compassZ);
            this.compassPoint[2] = new Vector3d(0.0D, -Math.sqrt(1.0D - (CockpitFokkerDXVII.compassZ * CockpitFokkerDXVII.compassZ)), CockpitFokkerDXVII.compassZ);
            this.compassPoint[3] = new Vector3d(Math.sqrt(1.0D - (CockpitFokkerDXVII.compassZ * CockpitFokkerDXVII.compassZ)), 0.0D, CockpitFokkerDXVII.compassZ);
            this.cP[0] = new Vector3d(0.0D, Math.sqrt(1.0D - (CockpitFokkerDXVII.compassZ * CockpitFokkerDXVII.compassZ)), CockpitFokkerDXVII.compassZ);
            this.cP[1] = new Vector3d(-Math.sqrt(1.0D - (CockpitFokkerDXVII.compassZ * CockpitFokkerDXVII.compassZ)), 0.0D, CockpitFokkerDXVII.compassZ);
            this.cP[2] = new Vector3d(0.0D, -Math.sqrt(1.0D - (CockpitFokkerDXVII.compassZ * CockpitFokkerDXVII.compassZ)), CockpitFokkerDXVII.compassZ);
            this.cP[3] = new Vector3d(Math.sqrt(1.0D - (CockpitFokkerDXVII.compassZ * CockpitFokkerDXVII.compassZ)), 0.0D, CockpitFokkerDXVII.compassZ);
        }

    }

    public CockpitFokkerDXVII() {
        super("3DO/Cockpit/FokkerDXVII/hier.him", "bf109");
    ...
    private void initCompass() {
        ...
        this.segLen1 = 2D * Math.sqrt(1.0D - (CockpitFokkerDXVII.compassZ * CockpitFokkerDXVII.compassZ));
        this.segLen2 = this.segLen1 / Math.sqrt(2D);
        this.compassLimit = -1D * Math.sin(0.01745328888888889D * CockpitFokkerDXVII.compassLimitAngle);
    ...
    private void updateCompass() {
        ...
        if (this.accel.length() > (-CockpitFokkerDXVII.compassZ * 0.7D)) {
            this.accel.scale((-CockpitFokkerDXVII.compassZ * 0.7D) / this.accel.length());
        }
        for (int i = 0; i < 4; i++) {
        ...
        vector3d2.normalize();
        vector3d2.scale(-CockpitFokkerDXVII.compassZ);
