    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (realisticInstruments) {
                if (Math.abs(CockpitFokker_DXXIII.this.fm.Or.getKren()) < 30F) {
            ...
            for (int engineIndex = 0; engineIndex < 2; engineIndex++) {
                ...
                if (CockpitFokker_DXXIII.this.setNew.prop[engineIndex] < (CockpitFokker_DXXIII.this.fm.EI.engines[engineIndex].getControlProp() - 0.01F)) {
                    CockpitFokker_DXXIII.this.setNew.prop[engineIndex] += 0.0025F;
                }
                if (CockpitFokker_DXXIII.this.setNew.prop[engineIndex] > (CockpitFokker_DXXIII.this.fm.EI.engines[engineIndex].getControlProp() + 0.01F)) {
                    CockpitFokker_DXXIII.this.setNew.prop[engineIndex] -= 0.0025F;
                }
            ...
            if (CockpitFokker_DXXIII.this.cockpitDimControl) {
                if (CockpitFokker_DXXIII.this.setNew.dimPos < 1.0F) {
                    CockpitFokker_DXXIII.this.setNew.dimPos = CockpitFokker_DXXIII.this.setOld.dimPos + 0.03F;
                }
            } else if (CockpitFokker_DXXIII.this.setNew.dimPos > 0.0F) {
                CockpitFokker_DXXIII.this.setNew.dimPos = CockpitFokker_DXXIII.this.setOld.dimPos - 0.03F;
            }
            if (CockpitFokker_DXXIII.this.flaps == CockpitFokker_DXXIII.this.fm.CT.getFlap()) {
                ...
                if (CockpitFokker_DXXIII.this.flapsDirection == 0) {
                    CockpitFokker_DXXIII.this.sfxStart(16);
                }
                ...
                if ((CockpitFokker_DXXIII.this.flapsPump < 0.0F) || (CockpitFokker_DXXIII.this.flapsPump > 1.0F)) {
                    CockpitFokker_DXXIII.this.flapsPumpIncrement = -CockpitFokker_DXXIII.this.flapsPumpIncrement;
                }
            } else if (CockpitFokker_DXXIII.this.flaps > CockpitFokker_DXXIII.this.fm.CT.getFlap()) {
                if (CockpitFokker_DXXIII.this.flapsDirection == 0) {
                    CockpitFokker_DXXIII.this.sfxStart(16);
            ...
            if (!CockpitFokker_DXXIII.this.fm.Gears.bTailwheelLocked && (CockpitFokker_DXXIII.this.tailWheelLock < 1.0F)) {
                CockpitFokker_DXXIII.this.tailWheelLock = CockpitFokker_DXXIII.this.tailWheelLock + 0.05F;
            } else if (CockpitFokker_DXXIII.this.fm.Gears.bTailwheelLocked && (CockpitFokker_DXXIII.this.tailWheelLock > 0.0F)) {
                CockpitFokker_DXXIII.this.tailWheelLock = CockpitFokker_DXXIII.this.tailWheelLock - 0.05F;
            }
...
// ac.registerPit(this);
        ...
        this.cockpitNightMats = new String[] { "gyro", "gauge_speed", "gauge_speed1", "gauge_speed2", "gauge_alt", "gauge_alt1", "gauge_alt2", "gauge_fuel", "gauge_fuel1", "gauge_fuel2", "gauges_various_1", "gauges_various_2", "LABELS1", "gauges_various_3", "gauges_various_4", "gauges_various_3_dam", "gauge_alt_dam", "gauge_alt1_dam", "gauge_alt2_dam", "gauges_various_2_dam" };
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        for (int engineIndex = 0; engineIndex < 2; engineIndex++) {
            ...
            if ((this.fm.Or.getKren() < -110F) || (this.fm.Or.getKren() > 110F)) {
                this.rpmGeneratedPressure[engineIndex] = this.rpmGeneratedPressure[engineIndex] - 2.0F;
            } else if (f1 < this.rpmGeneratedPressure[engineIndex]) {
                this.rpmGeneratedPressure[engineIndex] = this.rpmGeneratedPressure[engineIndex] - ((this.rpmGeneratedPressure[engineIndex] - f1) * 0.01F);
            } else {
                this.rpmGeneratedPressure[engineIndex] = this.rpmGeneratedPressure[engineIndex] + ((f1 - this.rpmGeneratedPressure[engineIndex]) * 0.001F);
            }
            if (this.rpmGeneratedPressure[engineIndex] < 800F) {
                this.oilPressure[engineIndex] = this.cvt(this.rpmGeneratedPressure[engineIndex], 0.0F, 800F, 0.0F, 4F);
            } else if (this.rpmGeneratedPressure[engineIndex] < 1800F) {
                this.oilPressure[engineIndex] = this.cvt(this.rpmGeneratedPressure[engineIndex], 800F, 1800F, 4F, 5F);
            } else {
                this.oilPressure[engineIndex] = this.cvt(this.rpmGeneratedPressure[engineIndex], 1800F, 2750F, 5F, 5.8F);
            }
            float f5 = 0.0F;
            if (this.fm.EI.engines[engineIndex].tOilIn > 90F) {
                f5 = this.cvt(this.fm.EI.engines[engineIndex].tOilIn, 90F, 110F, 1.1F, 1.5F);
            } else if (this.fm.EI.engines[engineIndex].tOilIn < 50F) {
                f5 = this.cvt(this.fm.EI.engines[engineIndex].tOilIn, 0.0F, 50F, 2.0F, 0.9F);
            } else {
                f5 = this.cvt(this.fm.EI.engines[engineIndex].tOilIn, 50F, 90F, 0.9F, 1.1F);
            }
            ...
            this.mesh.chunkSetAngles("Z_Need_manifold" + (engineIndex + 1), this.cvt(this.pictManifold[engineIndex] = (0.85F * this.pictManifold[engineIndex]) + (0.15F * this.fm.EI.engines[engineIndex].getManifoldPressure() * 76F), 30F, 120F, 22F, 296F), 0.0F, 0.0F);
...
// mesh.chunkVisible("CF_D2", hiermesh.isChunkVisible("CF_D2"));
    ...
    private void initCompass() {
        ...
        this.segLen1 = 2D * Math.sqrt(1.0D - (CockpitFokker_DXXIII.compassZ * CockpitFokker_DXXIII.compassZ));
        this.segLen2 = this.segLen1 / Math.sqrt(2D);
        this.compassLimit = -1D * Math.sin(0.0174533D * CockpitFokker_DXXIII.compassLimitAngle);
    ...
    private void updateCompass() {
        ...
        if (this.accel.length() > (-CockpitFokker_DXXIII.compassZ * 0.7D)) {
            this.accel.scale((-CockpitFokker_DXXIII.compassZ * 0.7D) / this.accel.length());
        }
        for (int i = 0; i < 4; i++) {
        ...
        vector3d1.normalize();
        vector3d1.scale(-CockpitFokker_DXXIII.compassZ);
