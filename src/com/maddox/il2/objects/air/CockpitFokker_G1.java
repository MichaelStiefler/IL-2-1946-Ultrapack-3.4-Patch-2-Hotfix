...
public class CockpitFokker_G1 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (Math.abs(CockpitFokker_G1.this.fm.Or.getKren()) < 30F) {
            ...
            if (CockpitFokker_G1.this.setNew.prop < (CockpitFokker_G1.this.fm.EI.engines[0].getControlProp() - 0.01F)) {
                CockpitFokker_G1.this.setNew.prop += 0.0025F;
            }
            if (CockpitFokker_G1.this.setNew.prop > (CockpitFokker_G1.this.fm.EI.engines[0].getControlProp() + 0.01F)) {
                CockpitFokker_G1.this.setNew.prop -= 0.0025F;
            }
            ...
            if (CockpitFokker_G1.this.cockpitDimControl) {
                if (CockpitFokker_G1.this.setNew.dimPos < 1.0F) {
                    CockpitFokker_G1.this.setNew.dimPos = CockpitFokker_G1.this.setOld.dimPos + 0.03F;
                }
            } else if (CockpitFokker_G1.this.setNew.dimPos > 0.0F) {
                CockpitFokker_G1.this.setNew.dimPos = CockpitFokker_G1.this.setOld.dimPos - 0.03F;
            }
            if (CockpitFokker_G1.this.flaps == CockpitFokker_G1.this.fm.CT.getFlap()) {
                ...
                if (CockpitFokker_G1.this.flapsDirection == 0) {
                    CockpitFokker_G1.this.sfxStart(16);
                }
                ...
                if ((CockpitFokker_G1.this.flapsPump < 0.0F) || (CockpitFokker_G1.this.flapsPump > 1.0F)) {
                    CockpitFokker_G1.this.flapsPumpIncrement = -CockpitFokker_G1.this.flapsPumpIncrement;
                }
            } else if (CockpitFokker_G1.this.flaps > CockpitFokker_G1.this.fm.CT.getFlap()) {
                if (CockpitFokker_G1.this.flapsDirection == 0) {
                    CockpitFokker_G1.this.sfxStart(16);
            ...
            if (!CockpitFokker_G1.this.fm.Gears.bTailwheelLocked && (CockpitFokker_G1.this.tailWheelLock < 1.0F)) {
                CockpitFokker_G1.this.tailWheelLock = CockpitFokker_G1.this.tailWheelLock + 0.05F;
            } else if (CockpitFokker_G1.this.fm.Gears.bTailwheelLocked && (CockpitFokker_G1.this.tailWheelLock > 0.0F)) {
                CockpitFokker_G1.this.tailWheelLock = CockpitFokker_G1.this.tailWheelLock - 0.05F;
            }
...
//        this.mesh.materialReplace("PanelC", "PanelCRevi");
    ...
    private void enter() {
        ...
        if (this.hasRevi) {
            hookpilot.setAim(new Point3d(1.65D, -0.038D, 1.02D));
        } else {
    ...
    private void initCompass() {
        ...
        this.segLen1 = 2D * Math.sqrt(1.0D - (CockpitFokker_G1.compassZ * CockpitFokker_G1.compassZ));
        this.segLen2 = this.segLen1 / Math.sqrt(2D);
        this.compassLimit = -1D * Math.sin(0.01745328888888889D * CockpitFokker_G1.compassLimitAngle);
    ...
    private void updateCompass() {
        ...
        if (this.accel.length() > (-CockpitFokker_G1.compassZ * 0.7D)) {
            this.accel.scale((-CockpitFokker_G1.compassZ * 0.7D) / this.accel.length());
        }
        for (int i = 0; i < 4; i++) {
        ...
        vector3d2.normalize();
        vector3d2.scale(-CockpitFokker_G1.compassZ);
