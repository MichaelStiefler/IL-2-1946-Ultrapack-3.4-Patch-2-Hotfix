...
public class CockpitFulmar extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitFulmar.this.fm != null) {
                ...
                CockpitFulmar.this.setNew.throttle = ((10F * CockpitFulmar.this.setOld.throttle) + CockpitFulmar.this.fm.CT.PowerControl) / 11F;
                CockpitFulmar.this.setNew.altimeter = CockpitFulmar.this.fm.getAltitude();
                CockpitFulmar.this.setNew.waypointAzimuth.setDeg(CockpitFulmar.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitFulmar.this.waypointAzimuth() - CockpitFulmar.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitFulmar.this.fm.Or.getKren()) < 30F) {
                    CockpitFulmar.this.setNew.azimuth.setDeg(CockpitFulmar.this.setOld.azimuth.getDeg(1.0F), CockpitFulmar.this.fm.Or.azimut());
                }
                CockpitFulmar.this.setNew.vspeed = ((199F * CockpitFulmar.this.setOld.vspeed) + CockpitFulmar.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitFulmar.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 100F, 0.0F, 270F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitFulmar.radScale));
        this.resetYPRmodifier();
        ...
        if (this.bFAF) {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 143.0528F, 0.0F, 32F), CockpitFulmar.speedometerScaleFAF));
        } else {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 180.0555F, 0.0F, 35F), CockpitFulmar.speedometerScale));
        }
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitFulmar.variometerScale));
