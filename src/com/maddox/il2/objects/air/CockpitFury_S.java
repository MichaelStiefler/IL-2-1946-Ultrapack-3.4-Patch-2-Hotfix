    ...
    private class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitFury_S.this.fm != null) {
                ...
                CockpitFury_S.this.setNew.waypointAzimuth.setDeg(CockpitFury_S.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitFury_S.this.waypointAzimuth() - CockpitFury_S.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitFury_S.this.fm.Or.getKren()) < 30F) {
                    CockpitFury_S.this.setNew.azimuth.setDeg(CockpitFury_S.this.setOld.azimuth.getDeg(1.0F), CockpitFury_S.this.fm.Or.azimut());
                }
