...
public class CockpitG3M2 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitG3M2.this.fm != null) {
                CockpitG3M2.this.setTmp = CockpitG3M2.this.setOld;
                CockpitG3M2.this.setOld = CockpitG3M2.this.setNew;
                CockpitG3M2.this.setNew = CockpitG3M2.this.setTmp;
                CockpitG3M2.this.setNew.throttle1 = (0.9F * CockpitG3M2.this.setOld.throttle1) + (0.1F * CockpitG3M2.this.fm.EI.engines[0].getControlThrottle());
                CockpitG3M2.this.setNew.prop1 = (0.9F * CockpitG3M2.this.setOld.prop1) + (0.1F * CockpitG3M2.this.fm.EI.engines[0].getControlProp());
                CockpitG3M2.this.setNew.mix1 = (0.8F * CockpitG3M2.this.setOld.mix1) + (0.2F * CockpitG3M2.this.fm.EI.engines[0].getControlMix());
                CockpitG3M2.this.setNew.throttle2 = (0.9F * CockpitG3M2.this.setOld.throttle2) + (0.1F * CockpitG3M2.this.fm.EI.engines[1].getControlThrottle());
                CockpitG3M2.this.setNew.prop2 = (0.9F * CockpitG3M2.this.setOld.prop2) + (0.1F * CockpitG3M2.this.fm.EI.engines[1].getControlProp());
                CockpitG3M2.this.setNew.mix2 = (0.8F * CockpitG3M2.this.setOld.mix2) + (0.2F * CockpitG3M2.this.fm.EI.engines[1].getControlMix());
                CockpitG3M2.this.setNew.man1 = (0.92F * CockpitG3M2.this.setOld.man1) + (0.08F * CockpitG3M2.this.fm.EI.engines[0].getManifoldPressure());
                CockpitG3M2.this.setNew.man2 = (0.92F * CockpitG3M2.this.setOld.man2) + (0.08F * CockpitG3M2.this.fm.EI.engines[1].getManifoldPressure());
                CockpitG3M2.this.setNew.altimeter = CockpitG3M2.this.fm.getAltitude();
                if (Math.abs(CockpitG3M2.this.fm.Or.getKren()) < 30F) {
                    CockpitG3M2.this.setNew.azimuth.setDeg(CockpitG3M2.this.setOld.azimuth.getDeg(1.0F), CockpitG3M2.this.fm.Or.azimut());
                }
                CockpitG3M2.this.setNew.vspeed = ((199F * CockpitG3M2.this.setOld.vspeed) + CockpitG3M2.this.fm.getVertSpeed()) / 200F;
                if (CockpitG3M2.this.useRealisticNavigationInstruments()) {
                    CockpitG3M2.this.setNew.waypointAzimuth.setDeg(CockpitG3M2.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitG3M2.this.waypointAzimuth());
                } else {
                    CockpitG3M2.this.setNew.waypointAzimuth.setDeg(CockpitG3M2.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitG3M2.this.fm.Or.azimut() + 90F);
                }
                CockpitG3M2.this.setNew.beaconDirection = ((10F * CockpitG3M2.this.setOld.beaconDirection) + CockpitG3M2.this.getBeaconDirection()) / 11F;
                CockpitG3M2.this.setNew.beaconRange = ((10F * CockpitG3M2.this.setOld.beaconRange) + CockpitG3M2.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public CockpitG3M2() {
        super("3DO/Cockpit/G4M1-11/hierG3M2.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        float f2 = this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitG3M2.speedometerScale);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitG3M2.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitG3M2.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitG3M2.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitG3M2.rpmScale), 0.0F, 0.0F);
