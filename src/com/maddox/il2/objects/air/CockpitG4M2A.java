...
public class CockpitG4M2A extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitG4M2A.this.fm != null) {
                CockpitG4M2A.this.setTmp = CockpitG4M2A.this.setOld;
                CockpitG4M2A.this.setOld = CockpitG4M2A.this.setNew;
                CockpitG4M2A.this.setNew = CockpitG4M2A.this.setTmp;
                CockpitG4M2A.this.setNew.throttle1 = (0.9F * CockpitG4M2A.this.setOld.throttle1) + (0.1F * CockpitG4M2A.this.fm.EI.engines[0].getControlThrottle());
                CockpitG4M2A.this.setNew.prop1 = (0.9F * CockpitG4M2A.this.setOld.prop1) + (0.1F * CockpitG4M2A.this.fm.EI.engines[0].getControlProp());
                CockpitG4M2A.this.setNew.mix1 = (0.8F * CockpitG4M2A.this.setOld.mix1) + (0.2F * CockpitG4M2A.this.fm.EI.engines[0].getControlMix());
                CockpitG4M2A.this.setNew.throttle2 = (0.9F * CockpitG4M2A.this.setOld.throttle2) + (0.1F * CockpitG4M2A.this.fm.EI.engines[1].getControlThrottle());
                CockpitG4M2A.this.setNew.prop2 = (0.9F * CockpitG4M2A.this.setOld.prop2) + (0.1F * CockpitG4M2A.this.fm.EI.engines[1].getControlProp());
                CockpitG4M2A.this.setNew.mix2 = (0.8F * CockpitG4M2A.this.setOld.mix2) + (0.2F * CockpitG4M2A.this.fm.EI.engines[1].getControlMix());
                CockpitG4M2A.this.setNew.man1 = (0.92F * CockpitG4M2A.this.setOld.man1) + (0.08F * CockpitG4M2A.this.fm.EI.engines[0].getManifoldPressure());
                CockpitG4M2A.this.setNew.man2 = (0.92F * CockpitG4M2A.this.setOld.man2) + (0.08F * CockpitG4M2A.this.fm.EI.engines[1].getManifoldPressure());
                CockpitG4M2A.this.setNew.altimeter = CockpitG4M2A.this.fm.getAltitude();
                if (Math.abs(CockpitG4M2A.this.fm.Or.getKren()) < 30F) {
                    CockpitG4M2A.this.setNew.azimuth.setDeg(CockpitG4M2A.this.setOld.azimuth.getDeg(1.0F), CockpitG4M2A.this.fm.Or.azimut());
                }
                CockpitG4M2A.this.setNew.vspeed = ((199F * CockpitG4M2A.this.setOld.vspeed) + CockpitG4M2A.this.fm.getVertSpeed()) / 200F;
                if (CockpitG4M2A.this.useRealisticNavigationInstruments()) {
                    CockpitG4M2A.this.setNew.waypointAzimuth.setDeg(CockpitG4M2A.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitG4M2A.this.waypointAzimuth());
                } else {
                    CockpitG4M2A.this.setNew.waypointAzimuth.setDeg(CockpitG4M2A.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitG4M2A.this.fm.Or.azimut() + 90F);
                }
                CockpitG4M2A.this.setNew.beaconDirection = ((10F * CockpitG4M2A.this.setOld.beaconDirection) + CockpitG4M2A.this.getBeaconDirection()) / 11F;
                CockpitG4M2A.this.setNew.beaconRange = ((10F * CockpitG4M2A.this.setOld.beaconRange) + CockpitG4M2A.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public CockpitG4M2A() {
        super("3DO/Cockpit/G4M2A/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        float f2 = this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitG4M2A.speedometerScale);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitG4M2A.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitG4M2A.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitG4M2A.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitG4M2A.rpmScale), 0.0F, 0.0F);
