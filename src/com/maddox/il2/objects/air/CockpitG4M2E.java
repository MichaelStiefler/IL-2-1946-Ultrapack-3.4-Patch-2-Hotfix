...
public class CockpitG4M2E extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitG4M2E.this.fm != null) {
                CockpitG4M2E.this.setTmp = CockpitG4M2E.this.setOld;
                CockpitG4M2E.this.setOld = CockpitG4M2E.this.setNew;
                CockpitG4M2E.this.setNew = CockpitG4M2E.this.setTmp;
                CockpitG4M2E.this.setNew.throttle1 = (0.9F * CockpitG4M2E.this.setOld.throttle1) + (0.1F * CockpitG4M2E.this.fm.EI.engines[0].getControlThrottle());
                CockpitG4M2E.this.setNew.prop1 = (0.9F * CockpitG4M2E.this.setOld.prop1) + (0.1F * CockpitG4M2E.this.fm.EI.engines[0].getControlProp());
                CockpitG4M2E.this.setNew.mix1 = (0.8F * CockpitG4M2E.this.setOld.mix1) + (0.2F * CockpitG4M2E.this.fm.EI.engines[0].getControlMix());
                CockpitG4M2E.this.setNew.throttle2 = (0.9F * CockpitG4M2E.this.setOld.throttle2) + (0.1F * CockpitG4M2E.this.fm.EI.engines[1].getControlThrottle());
                CockpitG4M2E.this.setNew.prop2 = (0.9F * CockpitG4M2E.this.setOld.prop2) + (0.1F * CockpitG4M2E.this.fm.EI.engines[1].getControlProp());
                CockpitG4M2E.this.setNew.mix2 = (0.8F * CockpitG4M2E.this.setOld.mix2) + (0.2F * CockpitG4M2E.this.fm.EI.engines[1].getControlMix());
                CockpitG4M2E.this.setNew.man1 = (0.92F * CockpitG4M2E.this.setOld.man1) + (0.08F * CockpitG4M2E.this.fm.EI.engines[0].getManifoldPressure());
                CockpitG4M2E.this.setNew.man2 = (0.92F * CockpitG4M2E.this.setOld.man2) + (0.08F * CockpitG4M2E.this.fm.EI.engines[1].getManifoldPressure());
                CockpitG4M2E.this.setNew.altimeter = CockpitG4M2E.this.fm.getAltitude();
                if (Math.abs(CockpitG4M2E.this.fm.Or.getKren()) < 30F) {
                    CockpitG4M2E.this.setNew.azimuth.setDeg(CockpitG4M2E.this.setOld.azimuth.getDeg(1.0F), CockpitG4M2E.this.fm.Or.azimut());
                }
                CockpitG4M2E.this.setNew.vspeed = ((199F * CockpitG4M2E.this.setOld.vspeed) + CockpitG4M2E.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitG4M2E.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitG4M2E.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitG4M2E.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitG4M2E.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitG4M2E.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitG4M2E.rpmScale), 0.0F, 0.0F);
