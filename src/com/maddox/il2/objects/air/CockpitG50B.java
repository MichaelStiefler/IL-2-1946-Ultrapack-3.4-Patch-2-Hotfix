...
public class CockpitG50B extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            CockpitG50B.this.setNew.waypointAzimuth.setDeg(CockpitG50B.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitG50B.this.waypointAzimuth() - CockpitG50B.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitG50B.this.fm.Or.getKren()) < 30F) {
                CockpitG50B.this.setNew.azimuth.setDeg(CockpitG50B.this.setOld.azimuth.getDeg(1.0F), CockpitG50B.this.fm.Or.azimut());
            }
            return true;
        }
