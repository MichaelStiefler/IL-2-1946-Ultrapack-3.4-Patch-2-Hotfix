...
public class CockpitG50_R extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            CockpitG50_R.this.setTmp = CockpitG50_R.this.setOld;
            CockpitG50_R.this.setOld = CockpitG50_R.this.setNew;
            CockpitG50_R.this.setNew = CockpitG50_R.this.setTmp;
            if (((CockpitG50_R.this.fm.AS.astateCockpitState & 2) != 0) && (CockpitG50_R.this.setNew.stbyPosition < 1.0F)) {
                CockpitG50_R.this.delay--;
                if (CockpitG50_R.this.delay <= 0) {
                    CockpitG50_R.this.setNew.stbyPosition = CockpitG50_R.this.setOld.stbyPosition + 0.03F;
                    CockpitG50_R.this.setOld.stbyPosition = CockpitG50_R.this.setNew.stbyPosition;
                    CockpitG50_R.this.sightDamaged = true;
                }
            }
            CockpitG50_R.this.setNew.throttle = ((10F * CockpitG50_R.this.setOld.throttle) + CockpitG50_R.this.fm.CT.PowerControl) / 11F;
            CockpitG50_R.this.setNew.prop = ((10F * CockpitG50_R.this.setOld.prop) + CockpitG50_R.this.fm.EI.engines[0].getControlProp()) / 11F;
            CockpitG50_R.this.setNew.mix = ((10F * CockpitG50_R.this.setOld.mix) + CockpitG50_R.this.fm.EI.engines[0].getControlMix()) / 11F;
            CockpitG50_R.this.setNew.vspeed = ((199F * CockpitG50_R.this.setOld.vspeed) + CockpitG50_R.this.fm.getVertSpeed()) / 200F;
            CockpitG50_R.this.setNew.waypointAzimuth.setDeg(CockpitG50_R.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitG50_R.this.waypointAzimuth() - CockpitG50_R.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitG50_R.this.fm.Or.getKren()) < 30F) {
                CockpitG50_R.this.setNew.azimuth.setDeg(CockpitG50_R.this.setOld.azimuth.getDeg(1.0F), CockpitG50_R.this.fm.Or.azimut());
            }
            return true;
        }
    ...
    public CockpitG50_R() {
        super("3DO/Cockpit/G50_R/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Compass1", -60F - this.setNew.azimuth.getDeg(f), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 600F, 0.0F, 12F), CockpitG50_R.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 600F, 0.0F, 12F), CockpitG50_R.speedometerScale), 0.0F, 0.0F);
        ...
        if (this.aircraft().isFMTrackMirror()) {
            ...
            f_0_ = this.cvt((this.setNew.azimuth.getDeg(f) - this.setOld.azimuth.getDeg(f)) / Time.tickLenFs(), -9F, 9F, -24F, 24F);
        ...
        this.mesh.chunkSetAngles("Z_Prescockp1", -this.floatindex(this.cvt(this.fm.EI.engines[0].getManifoldPressure(), 0.533288F, 1.33322F, 0.0F, 6F), CockpitG50_R.manifoldScale), 0.0F, 0.0F);
