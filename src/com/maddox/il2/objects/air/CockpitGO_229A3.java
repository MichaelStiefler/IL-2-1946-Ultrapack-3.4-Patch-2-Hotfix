...
public class CockpitGO_229A3 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            CockpitGO_229A3.this.setTmp = CockpitGO_229A3.this.setOld;
            CockpitGO_229A3.this.setOld = CockpitGO_229A3.this.setNew;
            CockpitGO_229A3.this.setNew = CockpitGO_229A3.this.setTmp;
            CockpitGO_229A3.this.setNew.altimeter = CockpitGO_229A3.this.fm.getAltitude();
            CockpitGO_229A3.this.setNew.throttlel = ((10F * CockpitGO_229A3.this.setOld.throttlel) + CockpitGO_229A3.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitGO_229A3.this.setNew.throttler = ((10F * CockpitGO_229A3.this.setOld.throttler) + CockpitGO_229A3.this.fm.EI.engines[1].getControlThrottle()) / 11F;
            CockpitGO_229A3.this.setNew.waypointAzimuth.setDeg(CockpitGO_229A3.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitGO_229A3.this.waypointAzimuth() - CockpitGO_229A3.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitGO_229A3.this.fm.Or.getKren()) < 30F) {
                CockpitGO_229A3.this.setNew.azimuth.setDeg(CockpitGO_229A3.this.setOld.azimuth.getDeg(1.0F), CockpitGO_229A3.this.fm.Or.azimut());
            }
            CockpitGO_229A3.this.setNew.vspeed = ((299F * CockpitGO_229A3.this.setOld.vspeed) + CockpitGO_229A3.this.fm.getVertSpeed()) / 300F;
            if (CockpitGO_229A3.this.cockpitDimControl) {
                if (CockpitGO_229A3.this.setNew.dimPosition > 0.0F) {
                    CockpitGO_229A3.this.setNew.dimPosition = CockpitGO_229A3.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitGO_229A3.this.setNew.dimPosition < 1.0F) {
                CockpitGO_229A3.this.setNew.dimPosition = CockpitGO_229A3.this.setOld.dimPosition + 0.05F;
            }
            float f = CockpitGO_229A3.this.setNew.k14Distance = ((GO_229A3) CockpitGO_229A3.this.aircraft()).k14Distance;
            CockpitGO_229A3.this.setNew.k14w = (5F * CockpitGO_229A3.k14TargetWingspanScale[((GO_229A3) CockpitGO_229A3.this.aircraft()).k14WingspanType]) / f;
            CockpitGO_229A3.this.setNew.k14w = (0.9F * CockpitGO_229A3.this.setOld.k14w) + (0.1F * CockpitGO_229A3.this.setNew.k14w);
            CockpitGO_229A3.this.setNew.k14wingspan = (0.9F * CockpitGO_229A3.this.setOld.k14wingspan) + (0.1F * CockpitGO_229A3.k14TargetMarkScale[((GO_229A3) CockpitGO_229A3.this.aircraft()).k14WingspanType]);
            CockpitGO_229A3.this.setNew.k14mode = (0.8F * CockpitGO_229A3.this.setOld.k14mode) + (0.2F * ((GO_229A3) CockpitGO_229A3.this.aircraft()).k14Mode);
            Vector3d vector3d = CockpitGO_229A3.this.aircraft().FM.getW();
            double d = 0.00125D * f;
            float f1 = (float) Math.toDegrees(d * vector3d.z);
            float f2 = -(float) Math.toDegrees(d * vector3d.y);
            float f3 = CockpitGO_229A3.this.floatindex((f - 200F) * 0.04F, CockpitGO_229A3.k14BulletDrop) - CockpitGO_229A3.k14BulletDrop[0];
            f2 += (float) Math.toDegrees(Math.atan(f3 / f));
            CockpitGO_229A3.this.setNew.k14x = (0.92F * CockpitGO_229A3.this.setOld.k14x) + (0.08F * f1);
            CockpitGO_229A3.this.setNew.k14y = (0.92F * CockpitGO_229A3.this.setOld.k14y) + (0.08F * f2);
            if (CockpitGO_229A3.this.setNew.k14x > 7F) {
                CockpitGO_229A3.this.setNew.k14x = 7F;
            }
            if (CockpitGO_229A3.this.setNew.k14x < -7F) {
                CockpitGO_229A3.this.setNew.k14x = -7F;
            }
            if (CockpitGO_229A3.this.setNew.k14y > 7F) {
                CockpitGO_229A3.this.setNew.k14y = 7F;
            }
            if (CockpitGO_229A3.this.setNew.k14y < -7F) {
                CockpitGO_229A3.this.setNew.k14y = -7F;
            }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        int i = ((GO_229A3) this.aircraft()).k14Mode;
        boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("zSpeed1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 400F, 2.0F, 8F), CockpitGO_229A3.speedometerIndScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zSpeed2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 100F, 1000F, 1.0F, 10F), CockpitGO_229A3.speedometerTruScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitGO_229A3.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitGO_229A3.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zFuel1", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), CockpitGO_229A3.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zFuel2", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), CockpitGO_229A3.fuelScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -20F, 50F, 0.0F, 14F), CockpitGO_229A3.variometerScale), 0.0F, 0.0F);
