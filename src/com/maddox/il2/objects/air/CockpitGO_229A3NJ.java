...
public class CockpitGO_229A3NJ extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            CockpitGO_229A3NJ.this.setNew.waypointAzimuth.setDeg(CockpitGO_229A3NJ.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitGO_229A3NJ.this.waypointAzimuth() - CockpitGO_229A3NJ.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitGO_229A3NJ.this.fm.Or.getKren()) < 30F) {
                CockpitGO_229A3NJ.this.setNew.azimuth.setDeg(CockpitGO_229A3NJ.this.setOld.azimuth.getDeg(1.0F), CockpitGO_229A3NJ.this.fm.Or.azimut());
            }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 400F, 2.0F, 8F), CockpitGO_229A3NJ.speedometerIndScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zSpeed2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 100F, 1000F, 1.0F, 10F), CockpitGO_229A3NJ.speedometerTruScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitGO_229A3NJ.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitGO_229A3NJ.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zFuel1", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), CockpitGO_229A3NJ.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zFuel2", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), CockpitGO_229A3NJ.fuelScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -20F, 50F, 0.0F, 14F), CockpitGO_229A3NJ.variometerScale), 0.0F, 0.0F);
