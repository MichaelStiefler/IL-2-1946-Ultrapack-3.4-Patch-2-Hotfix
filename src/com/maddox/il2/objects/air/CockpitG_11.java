    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitG_11.this.fm != null) {
                CockpitG_11.this.setTmp = CockpitG_11.this.setOld;
                CockpitG_11.this.setOld = CockpitG_11.this.setNew;
                CockpitG_11.this.setNew = CockpitG_11.this.setTmp;
                CockpitG_11.this.setNew.throttle = ((10F * CockpitG_11.this.setOld.throttle) + CockpitG_11.this.fm.CT.PowerControl) / 11F;
