...
public class CockpitG_55 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitG_55.this.fm != null) {
                ...
                CockpitG_55.this.setNew.throttle = (0.85F * CockpitG_55.this.setOld.throttle) + (CockpitG_55.this.fm.CT.PowerControl * 0.15F);
                CockpitG_55.this.setNew.prop = (0.85F * CockpitG_55.this.setOld.prop) + (CockpitG_55.this.fm.CT.getStepControl() * 0.15F);
                CockpitG_55.this.setNew.altimeter = CockpitG_55.this.fm.getAltitude();
                float f = CockpitG_55.this.waypointAzimuth();
                CockpitG_55.this.setNew.waypointAzimuth.setDeg(CockpitG_55.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitG_55.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitG_55.this.fm.Or.getKren()) < 30F) {
                    CockpitG_55.this.setNew.azimuth.setDeg(CockpitG_55.this.setOld.azimuth.getDeg(1.0F), CockpitG_55.this.fm.Or.azimut());
                }
                CockpitG_55.this.setNew.vspeed = ((199F * CockpitG_55.this.setOld.vspeed) + CockpitG_55.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 700F, 0.0F, 12F), CockpitG_55.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_EngTemp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 30F, 130F, 0.0F, 10F), CockpitG_55.waterTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_OilTemp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 150F, 0.0F, 4F), CockpitG_55.oilTempScale), 0.0F, 0.0F);
