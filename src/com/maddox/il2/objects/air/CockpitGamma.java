...
public class CockpitGamma extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitGamma.this.fm != null) {
                CockpitGamma.this.setTmp = CockpitGamma.this.setOld;
                CockpitGamma.this.setOld = CockpitGamma.this.setNew;
                CockpitGamma.this.setNew = CockpitGamma.this.setTmp;
                CockpitGamma.this.setNew.flaps = (0.9F * CockpitGamma.this.setOld.flaps) + (0.1F * CockpitGamma.this.fm.CT.FlapsControl);
                CockpitGamma.this.setNew.gear = (0.7F * CockpitGamma.this.setOld.gear) + (0.3F * CockpitGamma.this.fm.CT.GearControl);
                CockpitGamma.this.setNew.throttle = (0.8F * CockpitGamma.this.setOld.throttle) + (0.2F * CockpitGamma.this.fm.CT.PowerControl);
                CockpitGamma.this.setNew.prop = (0.8F * CockpitGamma.this.setOld.prop) + (0.2F * CockpitGamma.this.fm.EI.engines[0].getControlProp());
                CockpitGamma.this.setNew.mix = (0.8F * CockpitGamma.this.setOld.mix) + (0.2F * CockpitGamma.this.fm.EI.engines[0].getControlMix());
                CockpitGamma.this.setNew.divebrake = (0.8F * CockpitGamma.this.setOld.divebrake) + (0.2F * CockpitGamma.this.fm.CT.AirBrakeControl);
                CockpitGamma.this.setNew.man = (0.92F * CockpitGamma.this.setOld.man) + (0.08F * CockpitGamma.this.fm.EI.engines[0].getManifoldPressure());
                CockpitGamma.this.setNew.altimeter = CockpitGamma.this.fm.getAltitude();
                if (Math.abs(CockpitGamma.this.fm.Or.getKren()) < 30F) {
                    CockpitGamma.this.setNew.azimuth.setDeg(CockpitGamma.this.setOld.azimuth.getDeg(1.0F), CockpitGamma.this.fm.Or.azimut());
                }
                CockpitGamma.this.setNew.vspeed = ((399F * CockpitGamma.this.setOld.vspeed) + CockpitGamma.this.fm.getVertSpeed()) / 400F;
            }
            return true;
        }
    ...
    public CockpitGamma() {
        super("3DO/Cockpit/Gamma/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 925.9998F, 0.0F, 10F), CockpitGamma.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.setNew.vspeed >= 0.0F ? -this.floatindex(this.cvt(this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitGamma.variometerScale) : this.floatindex(this.cvt(-this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitGamma.variometerScale), 0.0F);
