...
public class CockpitH19D extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitH19D.this.fm != null) {
                CockpitH19D.this.setTmp = CockpitH19D.this.setOld;
                CockpitH19D.this.setOld = CockpitH19D.this.setNew;
                CockpitH19D.this.setNew = CockpitH19D.this.setTmp;
                CockpitH19D.this.setNew.throttle = (0.85F * CockpitH19D.this.setOld.throttle) + (CockpitH19D.this.fm.CT.PowerControl * 0.15F);
                CockpitH19D.this.setNew.prop = (0.85F * CockpitH19D.this.setOld.prop) + (CockpitH19D.this.fm.CT.getStepControl() * 0.15F);
                CockpitH19D.this.setNew.stage = (0.85F * CockpitH19D.this.setOld.stage) + (CockpitH19D.this.fm.EI.engines[0].getControlCompressor() * 0.15F);
                CockpitH19D.this.setNew.mix = (0.85F * CockpitH19D.this.setOld.mix) + (CockpitH19D.this.fm.EI.engines[0].getControlMix() * 0.15F);
                CockpitH19D.this.setNew.altimeter = CockpitH19D.this.fm.getAltitude();
                CockpitH19D.this.setNew.waypointAzimuth.setDeg(CockpitH19D.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitH19D.this.waypointAzimuth() - CockpitH19D.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitH19D.this.fm.Or.getKren()) < 30F) {
                    CockpitH19D.this.setNew.azimuth.setDeg(CockpitH19D.this.setOld.azimuth.getDeg(1.0F), CockpitH19D.this.fm.Or.azimut());
                }
                CockpitH19D.this.setNew.vspeed = ((199F * CockpitH19D.this.setOld.vspeed) + CockpitH19D.this.fm.getVertSpeed()) / 200F;
                Variables variables = CockpitH19D.this.setNew;
                float f = 0.5F * CockpitH19D.this.setOld.radioalt;
                float f1 = 0.5F;
                float f2 = CockpitH19D.this.fm.getAltitude();
                World.cur();
                World.land();
                variables.radioalt = f + (f1 * (f2 - Landscape.HQ_Air((float) CockpitH19D.this.fm.Loc.x, (float) CockpitH19D.this.fm.Loc.y)));
                if (CockpitH19D.this.cockpitDimControl) {
                    if (CockpitH19D.this.setNew.dimPosition > 0.0F) {
                        CockpitH19D.this.setNew.dimPosition = CockpitH19D.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitH19D.this.setNew.dimPosition < 1.0F) {
                    CockpitH19D.this.setNew.dimPosition = CockpitH19D.this.setOld.dimPosition + 0.05F;
                }
            }
            return true;
...
//        pictGear = 0.0F;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_ASI1", 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitH19D.speedometerScale), 0.0F);
        this.mesh.chunkSetAngles("Z_ASI2", 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitH19D.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Variometro1", 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitH19D.variometerScale), 0.0F);
        this.mesh.chunkSetAngles("Z_Variometro2", 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitH19D.variometerScale), 0.0F);
