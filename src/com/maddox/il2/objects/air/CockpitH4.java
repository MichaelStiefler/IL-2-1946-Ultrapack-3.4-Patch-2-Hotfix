...
public class CockpitH4 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitH4.this.fm != null) {
                CockpitH4.this.setTmp = CockpitH4.this.setOld;
                CockpitH4.this.setOld = CockpitH4.this.setNew;
                CockpitH4.this.setNew = CockpitH4.this.setTmp;
                CockpitH4.this.setNew.throttle1 = (0.9F * CockpitH4.this.setOld.throttle1) + (0.1F * CockpitH4.this.fm.EI.engines[0].getControlThrottle());
                CockpitH4.this.setNew.prop1 = (0.9F * CockpitH4.this.setOld.prop1) + (0.1F * CockpitH4.this.fm.EI.engines[0].getControlProp());
                CockpitH4.this.setNew.mix1 = (0.8F * CockpitH4.this.setOld.mix1) + (0.2F * CockpitH4.this.fm.EI.engines[0].getControlMix());
                CockpitH4.this.setNew.throttle2 = (0.9F * CockpitH4.this.setOld.throttle2) + (0.1F * CockpitH4.this.fm.EI.engines[1].getControlThrottle());
                CockpitH4.this.setNew.prop2 = (0.9F * CockpitH4.this.setOld.prop2) + (0.1F * CockpitH4.this.fm.EI.engines[1].getControlProp());
                CockpitH4.this.setNew.mix2 = (0.8F * CockpitH4.this.setOld.mix2) + (0.2F * CockpitH4.this.fm.EI.engines[1].getControlMix());
                CockpitH4.this.setNew.man1 = (0.92F * CockpitH4.this.setOld.man1) + (0.08F * CockpitH4.this.fm.EI.engines[0].getManifoldPressure());
                CockpitH4.this.setNew.man2 = (0.92F * CockpitH4.this.setOld.man2) + (0.08F * CockpitH4.this.fm.EI.engines[1].getManifoldPressure());
                CockpitH4.this.setNew.altimeter = CockpitH4.this.fm.getAltitude();
                if (Math.abs(CockpitH4.this.fm.Or.getKren()) < 30F) {
                    CockpitH4.this.setNew.azimuth.setDeg(CockpitH4.this.setOld.azimuth.getDeg(1.0F), CockpitH4.this.fm.Or.azimut());
                }
                CockpitH4.this.setNew.vspeed = ((199F * CockpitH4.this.setOld.vspeed) + CockpitH4.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitH4.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitH4.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitH4.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitH4.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitH4.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitH4.rpmScale), 0.0F, 0.0F);
