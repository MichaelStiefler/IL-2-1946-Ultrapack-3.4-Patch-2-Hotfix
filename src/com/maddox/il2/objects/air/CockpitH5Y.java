...
public class CockpitH5Y extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitH5Y.this.fm != null) {
                CockpitH5Y.this.setTmp = CockpitH5Y.this.setOld;
                CockpitH5Y.this.setOld = CockpitH5Y.this.setNew;
                CockpitH5Y.this.setNew = CockpitH5Y.this.setTmp;
                CockpitH5Y.this.setNew.throttle1 = (0.85F * CockpitH5Y.this.setOld.throttle1) + (CockpitH5Y.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitH5Y.this.setNew.throttle2 = (0.85F * CockpitH5Y.this.setOld.throttle2) + (CockpitH5Y.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitH5Y.this.setNew.prop1 = (0.85F * CockpitH5Y.this.setOld.prop1) + (CockpitH5Y.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitH5Y.this.setNew.prop2 = (0.85F * CockpitH5Y.this.setOld.prop2) + (CockpitH5Y.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitH5Y.this.setNew.altimeter = CockpitH5Y.this.fm.getAltitude();
                float f = CockpitH5Y.this.waypointAzimuth();
                if (Math.abs(CockpitH5Y.this.fm.Or.getKren()) < 30F) {
                    CockpitH5Y.this.setNew.azimuth.setDeg(CockpitH5Y.this.setOld.azimuth.getDeg(1.0F), CockpitH5Y.this.fm.Or.azimut());
                }
                CockpitH5Y.this.setNew.waypointAzimuth.setDeg(CockpitH5Y.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitH5Y.this.setNew.waypointDeviation.setDeg(CockpitH5Y.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitH5Y.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitH5Y.this.setNew.vspeed = ((199F * CockpitH5Y.this.setOld.vspeed) + CockpitH5Y.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitH5Y() {
        super("3DO/Cockpit/H5Y/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitH5Y.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitH5Y.speedometerScale), 0.0F);
