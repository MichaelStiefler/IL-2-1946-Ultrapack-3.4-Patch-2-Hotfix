...
public class CockpitH6K5_P extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitH6K5_P.this.fm != null) {
                CockpitH6K5_P.this.setTmp = CockpitH6K5_P.this.setOld;
                CockpitH6K5_P.this.setOld = CockpitH6K5_P.this.setNew;
                CockpitH6K5_P.this.setNew = CockpitH6K5_P.this.setTmp;
                CockpitH6K5_P.this.setNew.throttle1 = (0.9F * CockpitH6K5_P.this.setOld.throttle1) + (0.1F * CockpitH6K5_P.this.fm.EI.engines[0].getControlThrottle());
                CockpitH6K5_P.this.setNew.prop1 = (0.9F * CockpitH6K5_P.this.setOld.prop1) + (0.1F * CockpitH6K5_P.this.fm.EI.engines[0].getControlProp());
                CockpitH6K5_P.this.setNew.mix1 = (0.8F * CockpitH6K5_P.this.setOld.mix1) + (0.2F * CockpitH6K5_P.this.fm.EI.engines[0].getControlMix());
                CockpitH6K5_P.this.setNew.throttle2 = (0.9F * CockpitH6K5_P.this.setOld.throttle2) + (0.1F * CockpitH6K5_P.this.fm.EI.engines[1].getControlThrottle());
                CockpitH6K5_P.this.setNew.prop2 = (0.9F * CockpitH6K5_P.this.setOld.prop2) + (0.1F * CockpitH6K5_P.this.fm.EI.engines[1].getControlProp());
                CockpitH6K5_P.this.setNew.mix2 = (0.8F * CockpitH6K5_P.this.setOld.mix2) + (0.2F * CockpitH6K5_P.this.fm.EI.engines[1].getControlMix());
                CockpitH6K5_P.this.setNew.man1 = (0.92F * CockpitH6K5_P.this.setOld.man1) + (0.08F * CockpitH6K5_P.this.fm.EI.engines[0].getManifoldPressure());
                CockpitH6K5_P.this.setNew.man2 = (0.92F * CockpitH6K5_P.this.setOld.man2) + (0.08F * CockpitH6K5_P.this.fm.EI.engines[1].getManifoldPressure());
                CockpitH6K5_P.this.setNew.altimeter = CockpitH6K5_P.this.fm.getAltitude();
                if (Math.abs(CockpitH6K5_P.this.fm.Or.getKren()) < 30F) {
                    CockpitH6K5_P.this.setNew.azimuth.setDeg(CockpitH6K5_P.this.setOld.azimuth.getDeg(1.0F), CockpitH6K5_P.this.fm.Or.azimut());
                }
                CockpitH6K5_P.this.setNew.vspeed = ((199F * CockpitH6K5_P.this.setOld.vspeed) + CockpitH6K5_P.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            ...
            this.aircraft().hierMesh().chunkVisible("Blister3_D0", false);
            this.aircraft().hierMesh().chunkVisible("Dina_D0", false);
            return true;
        } else {
            return false;
        }
    ...
    protected void doFocusLeave() {
        ...
        this.aircraft().hierMesh().chunkVisible("Blister3_D0", true);
        this.aircraft().hierMesh().chunkVisible("Dina_D0", true);
        super.doFocusLeave();
    }

    public CockpitH6K5_P() {
        super("3DO/Cockpit/H6K5-P/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitH6K5_P.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitH6K5_P.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitH6K5_P.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitH6K5_P.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitH6K5_P.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitH6K5_P.rpmScale), 0.0F, 0.0F);
