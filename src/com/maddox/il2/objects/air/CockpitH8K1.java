...
public class CockpitH8K1 extends CockpitPilot {
    class Interpolater extends com.maddox.il2.engine.InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitH8K1.this.fm != null) {
                ...
                if (Math.abs(CockpitH8K1.this.fm.Or.getKren()) < 30F) {
                    CockpitH8K1.this.setNew.azimuth.setDeg(CockpitH8K1.this.setOld.azimuth.getDeg(1.0F), CockpitH8K1.this.fm.Or.azimut());
                }
                CockpitH8K1.this.setNew.vspeed = ((199F * CockpitH8K1.this.setOld.vspeed) + CockpitH8K1.this.fm.getVertSpeed()) / 200F;
                if (CockpitH8K1.this.useRealisticNavigationInstruments()) {
                    CockpitH8K1.this.setNew.waypointAzimuth.setDeg(CockpitH8K1.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitH8K1.this.waypointAzimuth());
                } else {
                    CockpitH8K1.this.setNew.waypointAzimuth.setDeg(CockpitH8K1.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitH8K1.this.fm.Or.azimut() + 90F);
                }
                CockpitH8K1.this.setNew.beaconDirection = ((10F * CockpitH8K1.this.setOld.beaconDirection) + CockpitH8K1.this.getBeaconDirection()) / 11F;
                CockpitH8K1.this.setNew.beaconRange = ((10F * CockpitH8K1.this.setOld.beaconRange) + CockpitH8K1.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    protected void doFocusLeave() {
        // TODO: +++ Fix outer frame parts appearing when aircraft is damaged
        this.aircraft().hierMesh().chunkVisible("CF_D" + this.damageIndex, true);
        boolean isChunkAnyDamageVisible = this.aircraft().isChunkAnyDamageVisible("CF_D");
        this.aircraft().hierMesh().chunkVisible("Cockpit_D0", isChunkAnyDamageVisible);
        this.aircraft().hierMesh().chunkVisible("CF_D0", isChunkAnyDamageVisible);
        this.aircraft().hierMesh().chunkVisible("Pilot2_D0", isChunkAnyDamageVisible);
        // ---
        super.doFocusLeave();
    }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        float f2 = this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitH8K1.speedometerScale);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitH8K1.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitH8K1.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitH8K1.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitH8K1.rpmScale), 0.0F, 0.0F);
