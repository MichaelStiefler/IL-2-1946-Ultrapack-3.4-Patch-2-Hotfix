...
public class CockpitHAWK extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitHAWK.this.fm != null) {
                CockpitHAWK.this.setTmp = CockpitHAWK.this.setOld;
                CockpitHAWK.this.setOld = CockpitHAWK.this.setNew;
                CockpitHAWK.this.setNew = CockpitHAWK.this.setTmp;
                CockpitHAWK.this.setNew.throttle = ((10F * CockpitHAWK.this.setOld.throttle) + CockpitHAWK.this.fm.CT.PowerControl) / 11F;
                CockpitHAWK.this.setNew.prop = ((8F * CockpitHAWK.this.setOld.prop) + CockpitHAWK.this.fm.CT.getStepControl()) / 9F;
                CockpitHAWK.this.setNew.altimeter = CockpitHAWK.this.fm.getAltitude();
                CockpitHAWK.this.setNew.waypointAzimuth.setDeg(CockpitHAWK.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitHAWK.this.waypointAzimuth() - CockpitHAWK.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitHAWK.this.fm.Or.getKren()) < 30F) {
                    CockpitHAWK.this.setNew.azimuth.setDeg(CockpitHAWK.this.setOld.azimuth.getDeg(1.0F), CockpitHAWK.this.fm.Or.azimut());
                }
                CockpitHAWK.this.setNew.vspeed = ((199F * CockpitHAWK.this.setOld.vspeed) + CockpitHAWK.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitHAWK() {
        super("3DO/Cockpit/Hawk/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitHAWK.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TurnBank2", 0.0F, this.cvt(this.getBall(8D), -8F, 8F, -13F, 13F), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitHAWK.variometerScale), 0.0F);
