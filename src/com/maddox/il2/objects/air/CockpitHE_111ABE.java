...
public class CockpitHE_111ABE extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            CockpitHE_111ABE.this.setTmp = CockpitHE_111ABE.this.setOld;
            CockpitHE_111ABE.this.setOld = CockpitHE_111ABE.this.setNew;
            CockpitHE_111ABE.this.setNew = CockpitHE_111ABE.this.setTmp;
            CockpitHE_111ABE.this.setNew.altimeter = CockpitHE_111ABE.this.fm.getAltitude();
            CockpitHE_111ABE.this.setNew.throttlel = ((10F * CockpitHE_111ABE.this.setOld.throttlel) + CockpitHE_111ABE.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitHE_111ABE.this.setNew.throttler = ((10F * CockpitHE_111ABE.this.setOld.throttler) + CockpitHE_111ABE.this.fm.EI.engines[1].getControlThrottle()) / 11F;
            CockpitHE_111ABE.this.w.set(CockpitHE_111ABE.this.fm.getW());
            CockpitHE_111ABE.this.fm.Or.transform(CockpitHE_111ABE.this.w);
            CockpitHE_111ABE.this.setNew.turn = ((12F * CockpitHE_111ABE.this.setOld.turn) + CockpitHE_111ABE.this.w.z) / 13F;
            float f = CockpitHE_111ABE.this.waypointAzimuth();
            CockpitHE_111ABE.this.setNew.waypointAzimuth.setDeg(CockpitHE_111ABE.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitHE_111ABE.this.setOld.azimuth.getDeg(1.0F));
            if (Math.abs(CockpitHE_111ABE.this.fm.Or.getKren()) < 30F) {
                CockpitHE_111ABE.this.setNew.azimuth.setDeg(CockpitHE_111ABE.this.setOld.azimuth.getDeg(1.0F), CockpitHE_111ABE.this.fm.Or.azimut());
            }
            CockpitHE_111ABE.this.setNew.vspeed = ((499F * CockpitHE_111ABE.this.setOld.vspeed) + CockpitHE_111ABE.this.fm.getVertSpeed()) / 500F;
            return true;
        }
    ...
    public CockpitHE_111ABE() {
        super("3DO/Cockpit/He-111ABE/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitHE_111ABE.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3000F, 0.0F, 15F), CockpitHE_111ABE.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3000F, 0.0F, 15F), CockpitHE_111ABE.rpmScale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitHE_111ABE.class, "normZNs", new float[] { 1.0F, 1.0F, 1.25F, 1.0F });
    }
}
