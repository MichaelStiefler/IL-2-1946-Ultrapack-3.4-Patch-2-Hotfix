...
public class CockpitHE_111H1 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitHE_111H1.this.useRealisticNavigationInstruments()) {
                ...
                CockpitHE_111H1.this.setNew.waypointAzimuth.setDeg(CockpitHE_111H1.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitHE_111H1.this.setOld.azimuth.getDeg(1.0F));
            }
            if (Math.abs(CockpitHE_111H1.this.fm.Or.getKren()) < 30F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitHE_111H1.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3000F, 0.0F, 15F), CockpitHE_111H1.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3000F, 0.0F, 15F), CockpitHE_111H1.rpmScale), 0.0F, 0.0F);
