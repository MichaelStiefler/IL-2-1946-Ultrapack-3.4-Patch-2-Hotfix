...
public class CockpitHE_111H6 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            CockpitHE_111H6.this.setTmp = CockpitHE_111H6.this.setOld;
            CockpitHE_111H6.this.setOld = CockpitHE_111H6.this.setNew;
            CockpitHE_111H6.this.setNew = CockpitHE_111H6.this.setTmp;
            CockpitHE_111H6.this.setNew.altimeter = CockpitHE_111H6.this.fm.getAltitude();
            CockpitHE_111H6.this.setNew.throttlel = ((10F * CockpitHE_111H6.this.setOld.throttlel) + CockpitHE_111H6.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitHE_111H6.this.setNew.throttler = ((10F * CockpitHE_111H6.this.setOld.throttler) + CockpitHE_111H6.this.fm.EI.engines[1].getControlThrottle()) / 11F;
            CockpitHE_111H6.this.w.set(CockpitHE_111H6.this.fm.getW());
            CockpitHE_111H6.this.fm.Or.transform(CockpitHE_111H6.this.w);
            CockpitHE_111H6.this.setNew.turn = ((12F * CockpitHE_111H6.this.setOld.turn) + CockpitHE_111H6.this.w.z) / 13F;
            float f = CockpitHE_111H6.this.waypointAzimuth();
            if (CockpitHE_111H6.this.useRealisticNavigationInstruments()) {
                CockpitHE_111H6.this.setNew.waypointAzimuth.setDeg(f - 90F);
                CockpitHE_111H6.this.setOld.waypointAzimuth.setDeg(f - 90F);
                CockpitHE_111H6.this.setNew.radioCompassAzimuth.setDeg(CockpitHE_111H6.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitHE_111H6.this.radioCompassAzimuthInvertMinus() - CockpitHE_111H6.this.setOld.azimuth.getDeg(1.0F) - 90F);
            } else {
            ...
            if (Math.abs(CockpitHE_111H6.this.fm.Or.getKren()) < 30F) {
            ...
            CockpitHE_111H6.this.setNew.vspeed = ((499F * CockpitHE_111H6.this.setOld.vspeed) + CockpitHE_111H6.this.fm.getVertSpeed()) / 500F;
            CockpitHE_111H6.this.setNew.beaconDirection = ((10F * CockpitHE_111H6.this.setOld.beaconDirection) + CockpitHE_111H6.this.getBeaconDirection()) / 11F;
            CockpitHE_111H6.this.setNew.beaconRange = ((10F * CockpitHE_111H6.this.setOld.beaconRange) + CockpitHE_111H6.this.getBeaconRange()) / 11F;
            return true;
        }
    ...
    public CockpitHE_111H6(String s) {
        super(s, "he111");
        this.setOld = new Variables();
        this.setNew = new Variables();
        this.pictAiler = 0.0F;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 400F, 0.0F, 16F), CockpitHE_111H6.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitHE_111H6.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitHE_111H6.rpmScale), 0.0F, 0.0F);
