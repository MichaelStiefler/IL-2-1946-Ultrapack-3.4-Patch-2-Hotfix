...
public class CockpitHE_111H6_Late extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            CockpitHE_111H6_Late.this.setTmp = CockpitHE_111H6_Late.this.setOld;
            CockpitHE_111H6_Late.this.setOld = CockpitHE_111H6_Late.this.setNew;
            CockpitHE_111H6_Late.this.setNew = CockpitHE_111H6_Late.this.setTmp;
            CockpitHE_111H6_Late.this.setNew.altimeter = CockpitHE_111H6_Late.this.fm.getAltitude();
            CockpitHE_111H6_Late.this.setNew.throttlel = ((10F * CockpitHE_111H6_Late.this.setOld.throttlel) + CockpitHE_111H6_Late.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitHE_111H6_Late.this.setNew.throttler = ((10F * CockpitHE_111H6_Late.this.setOld.throttler) + CockpitHE_111H6_Late.this.fm.EI.engines[1].getControlThrottle()) / 11F;
            CockpitHE_111H6_Late.this.w.set(CockpitHE_111H6_Late.this.fm.getW());
            CockpitHE_111H6_Late.this.fm.Or.transform(CockpitHE_111H6_Late.this.w);
            CockpitHE_111H6_Late.this.setNew.turn = ((12F * CockpitHE_111H6_Late.this.setOld.turn) + CockpitHE_111H6_Late.this.w.z) / 13F;
            CockpitHE_111H6_Late.this.mesh.chunkSetAngles("zTurretA", 0.0F, CockpitHE_111H6_Late.this.fm.turret[0].tu[0], 0.0F);
            CockpitHE_111H6_Late.this.mesh.chunkSetAngles("zTurretB", 0.0F, CockpitHE_111H6_Late.this.fm.turret[0].tu[1], 0.0F);
            float f = CockpitHE_111H6_Late.this.waypointAzimuth();
            if (CockpitHE_111H6_Late.this.useRealisticNavigationInstruments()) {
                CockpitHE_111H6_Late.this.setNew.waypointAzimuth.setDeg(f - 90F);
                CockpitHE_111H6_Late.this.setOld.waypointAzimuth.setDeg(f - 90F);
                CockpitHE_111H6_Late.this.setNew.radioCompassAzimuth.setDeg(CockpitHE_111H6_Late.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitHE_111H6_Late.this.radioCompassAzimuthInvertMinus() - CockpitHE_111H6_Late.this.setOld.azimuth.getDeg(1.0F) - 90F);
            } else {
                CockpitHE_111H6_Late.this.setNew.waypointAzimuth.setDeg(CockpitHE_111H6_Late.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitHE_111H6_Late.this.setOld.azimuth.getDeg(1.0F));
            }
            if (Math.abs(CockpitHE_111H6_Late.this.fm.Or.getKren()) < 30F) {
                CockpitHE_111H6_Late.this.setNew.azimuth.setDeg(CockpitHE_111H6_Late.this.setOld.azimuth.getDeg(1.0F), CockpitHE_111H6_Late.this.fm.Or.azimut());
            }
            CockpitHE_111H6_Late.this.setNew.vspeed = ((499F * CockpitHE_111H6_Late.this.setOld.vspeed) + CockpitHE_111H6_Late.this.fm.getVertSpeed()) / 500F;
            CockpitHE_111H6_Late.this.setNew.beaconDirection = ((10F * CockpitHE_111H6_Late.this.setOld.beaconDirection) + CockpitHE_111H6_Late.this.getBeaconDirection()) / 11F;
            CockpitHE_111H6_Late.this.setNew.beaconRange = ((10F * CockpitHE_111H6_Late.this.setOld.beaconRange) + CockpitHE_111H6_Late.this.getBeaconRange()) / 11F;
            float f1 = CockpitHE_111H6_Late.this.prevFuel - CockpitHE_111H6_Late.this.fm.M.fuel;
            CockpitHE_111H6_Late.this.prevFuel = CockpitHE_111H6_Late.this.fm.M.fuel;
            f1 /= 0.72F;
            f1 /= Time.tickLenFs();
            f1 *= 3600F;
            CockpitHE_111H6_Late.this.setNew.cons = (0.9F * CockpitHE_111H6_Late.this.setOld.cons) + (0.1F * f1);
            float f2 = CockpitHE_111H6_Late.this.fm.EI.engines[0].getEngineForce().x;
            float f3 = CockpitHE_111H6_Late.this.fm.EI.engines[1].getEngineForce().x;
            if ((f2 < 100F) || (CockpitHE_111H6_Late.this.fm.EI.engines[0].getRPM() < 600F)) {
                f2 = 1.0F;
            }
            if ((f3 < 100F) || (CockpitHE_111H6_Late.this.fm.EI.engines[1].getRPM() < 600F)) {
                f3 = 1.0F;
            }
            CockpitHE_111H6_Late.this.setNew.consL = (0.9F * CockpitHE_111H6_Late.this.setOld.consL) + ((0.1F * (CockpitHE_111H6_Late.this.setNew.cons * f2)) / (f2 + f3));
            CockpitHE_111H6_Late.this.setNew.consR = (0.9F * CockpitHE_111H6_Late.this.setOld.consR) + ((0.1F * (CockpitHE_111H6_Late.this.setNew.cons * f3)) / (f2 + f3));
            return true;
        }
    ...
    public CockpitHE_111H6_Late() {
        ...
        this.cockpitNightMats = new String[] { "clocks1", "clocks2", "clocks3B", "clocks4", "clocks5", "clocks6", "clocks7" };
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitHE_111H6_Late.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3600F, 0.0F, 6F), CockpitHE_111H6_Late.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3600F, 0.0F, 6F), CockpitHE_111H6_Late.rpmScale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitHE_111H6_Late.class, "normZNs", new float[] { 1.0F, 1.0F, 1.25F, 1.0F });
    }
}
