...
public class CockpitHE_111H8 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            CockpitHE_111H8.this.setTmp = CockpitHE_111H8.this.setOld;
            CockpitHE_111H8.this.setOld = CockpitHE_111H8.this.setNew;
            CockpitHE_111H8.this.setNew = CockpitHE_111H8.this.setTmp;
            CockpitHE_111H8.this.setNew.altimeter = CockpitHE_111H8.this.fm.getAltitude();
            CockpitHE_111H8.this.setNew.throttlel = ((10F * CockpitHE_111H8.this.setOld.throttlel) + CockpitHE_111H8.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitHE_111H8.this.setNew.throttler = ((10F * CockpitHE_111H8.this.setOld.throttler) + CockpitHE_111H8.this.fm.EI.engines[1].getControlThrottle()) / 11F;
            CockpitHE_111H8.this.w.set(CockpitHE_111H8.this.fm.getW());
            CockpitHE_111H8.this.fm.Or.transform(CockpitHE_111H8.this.w);
            CockpitHE_111H8.this.setNew.turn = ((12F * CockpitHE_111H8.this.setOld.turn) + CockpitHE_111H8.this.w.z) / 13F;
            float f = CockpitHE_111H8.this.waypointAzimuth();
            if (CockpitHE_111H8.this.useRealisticNavigationInstruments()) {
                CockpitHE_111H8.this.setNew.waypointAzimuth.setDeg(f - 90F);
                CockpitHE_111H8.this.setOld.waypointAzimuth.setDeg(f - 90F);
                CockpitHE_111H8.this.setNew.radioCompassAzimuth.setDeg(CockpitHE_111H8.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitHE_111H8.this.radioCompassAzimuthInvertMinus() - CockpitHE_111H8.this.setOld.azimuth.getDeg(1.0F) - 90F);
            } else {
                CockpitHE_111H8.this.setNew.waypointAzimuth.setDeg(CockpitHE_111H8.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitHE_111H8.this.setOld.azimuth.getDeg(1.0F));
            }
            if (Math.abs(CockpitHE_111H8.this.fm.Or.getKren()) < 30F) {
                CockpitHE_111H8.this.setNew.azimuth.setDeg(CockpitHE_111H8.this.setOld.azimuth.getDeg(1.0F), CockpitHE_111H8.this.fm.Or.azimut());
            }
            CockpitHE_111H8.this.setNew.vspeed = ((499F * CockpitHE_111H8.this.setOld.vspeed) + CockpitHE_111H8.this.fm.getVertSpeed()) / 500F;
            CockpitHE_111H8.this.setNew.beaconDirection = ((10F * CockpitHE_111H8.this.setOld.beaconDirection) + CockpitHE_111H8.this.getBeaconDirection()) / 11F;
            CockpitHE_111H8.this.setNew.beaconRange = ((10F * CockpitHE_111H8.this.setOld.beaconRange) + CockpitHE_111H8.this.getBeaconRange()) / 11F;
            float f1 = CockpitHE_111H8.this.prevFuel - CockpitHE_111H8.this.fm.M.fuel;
            CockpitHE_111H8.this.prevFuel = CockpitHE_111H8.this.fm.M.fuel;
            f1 /= 0.72F;
            f1 /= Time.tickLenFs();
            f1 *= 3600F;
            CockpitHE_111H8.this.setNew.cons = (0.9F * CockpitHE_111H8.this.setOld.cons) + (0.1F * f1);
            float f2 = CockpitHE_111H8.this.fm.EI.engines[0].getEngineForce().x;
            float f3 = CockpitHE_111H8.this.fm.EI.engines[1].getEngineForce().x;
            if ((f2 < 100F) || (CockpitHE_111H8.this.fm.EI.engines[0].getRPM() < 600F)) {
                f2 = 1.0F;
            }
            if ((f3 < 100F) || (CockpitHE_111H8.this.fm.EI.engines[1].getRPM() < 600F)) {
                f3 = 1.0F;
            }
            CockpitHE_111H8.this.setNew.consL = (0.9F * CockpitHE_111H8.this.setOld.consL) + ((0.1F * (CockpitHE_111H8.this.setNew.cons * f2)) / (f2 + f3));
            CockpitHE_111H8.this.setNew.consR = (0.9F * CockpitHE_111H8.this.setOld.consR) + ((0.1F * (CockpitHE_111H8.this.setNew.cons * f3)) / (f2 + f3));
            return true;
        }
    ...
    public CockpitHE_111H8() {
        super("3DO/Cockpit/He-111P-4/hier-H8.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitHE_111H8.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3600F, 0.0F, 6F), CockpitHE_111H8.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3600F, 0.0F, 6F), CockpitHE_111H8.rpmScale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitHE_111H8.class, "normZNs", new float[] { 1.0F, 1.0F, 1.25F, 1.0F });
    }
}
