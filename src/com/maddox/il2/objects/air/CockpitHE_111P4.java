...
public class CockpitHE_111P4 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            CockpitHE_111P4.this.setTmp = CockpitHE_111P4.this.setOld;
            CockpitHE_111P4.this.setOld = CockpitHE_111P4.this.setNew;
            CockpitHE_111P4.this.setNew = CockpitHE_111P4.this.setTmp;
            CockpitHE_111P4.this.setNew.altimeter = CockpitHE_111P4.this.fm.getAltitude();
            CockpitHE_111P4.this.setNew.throttlel = ((10F * CockpitHE_111P4.this.setOld.throttlel) + CockpitHE_111P4.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitHE_111P4.this.setNew.throttler = ((10F * CockpitHE_111P4.this.setOld.throttler) + CockpitHE_111P4.this.fm.EI.engines[1].getControlThrottle()) / 11F;
            CockpitHE_111P4.this.w.set(CockpitHE_111P4.this.fm.getW());
            CockpitHE_111P4.this.fm.Or.transform(CockpitHE_111P4.this.w);
            CockpitHE_111P4.this.setNew.turn = ((12F * CockpitHE_111P4.this.setOld.turn) + CockpitHE_111P4.this.w.z) / 13F;
            CockpitHE_111P4.this.mesh.chunkSetAngles("zTurretA", 0.0F, CockpitHE_111P4.this.fm.turret[0].tu[0], 0.0F);
            CockpitHE_111P4.this.mesh.chunkSetAngles("zTurretB", 0.0F, CockpitHE_111P4.this.fm.turret[0].tu[1], 0.0F);
            CockpitHE_111P4.this.mesh.chunkSetAngles("TurretNA", 0.0F, CockpitHE_111P4.this.fm.turret[6].tu[0], 0.0F);
            CockpitHE_111P4.this.mesh.chunkSetAngles("TurretNB", 0.0F, CockpitHE_111P4.this.fm.turret[6].tu[1], 0.0F);
            float f = CockpitHE_111P4.this.waypointAzimuth();
            if (CockpitHE_111P4.this.useRealisticNavigationInstruments()) {
                CockpitHE_111P4.this.setNew.waypointAzimuth.setDeg(f - 90F);
                CockpitHE_111P4.this.setOld.waypointAzimuth.setDeg(f - 90F);
                CockpitHE_111P4.this.setNew.radioCompassAzimuth.setDeg(CockpitHE_111P4.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitHE_111P4.this.radioCompassAzimuthInvertMinus() - CockpitHE_111P4.this.setOld.azimuth.getDeg(1.0F) - 90F);
            } else {
                CockpitHE_111P4.this.setNew.waypointAzimuth.setDeg(CockpitHE_111P4.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitHE_111P4.this.setOld.azimuth.getDeg(1.0F));
            }
            if (Math.abs(CockpitHE_111P4.this.fm.Or.getKren()) < 30F) {
                CockpitHE_111P4.this.setNew.azimuth.setDeg(CockpitHE_111P4.this.setOld.azimuth.getDeg(1.0F), CockpitHE_111P4.this.fm.Or.azimut());
            }
            CockpitHE_111P4.this.setNew.vspeed = ((499F * CockpitHE_111P4.this.setOld.vspeed) + CockpitHE_111P4.this.fm.getVertSpeed()) / 500F;
            CockpitHE_111P4.this.setNew.beaconDirection = ((10F * CockpitHE_111P4.this.setOld.beaconDirection) + CockpitHE_111P4.this.getBeaconDirection()) / 11F;
            CockpitHE_111P4.this.setNew.beaconRange = ((10F * CockpitHE_111P4.this.setOld.beaconRange) + CockpitHE_111P4.this.getBeaconRange()) / 11F;
            return true;
        }
    ...
    public CockpitHE_111P4() {
        super("3DO/Cockpit/He-111P-4/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitHE_111P4.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3000F, 0.0F, 15F), CockpitHE_111P4.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3000F, 0.0F, 15F), CockpitHE_111P4.rpmScale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitHE_111P4.class, "normZNs", new float[] { 1.0F, 1.0F, 1.25F, 1.0F });
    }
}
