...
public class CockpitHE_111Z extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            CockpitHE_111Z.this.setNew.altimeter = CockpitHE_111Z.this.fm.getAltitude();
            CockpitHE_111Z.this.setNew.throttlel = ((10F * CockpitHE_111Z.this.setOld.throttlel) + CockpitHE_111Z.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitHE_111Z.this.setNew.throttler = ((10F * CockpitHE_111Z.this.setOld.throttler) + CockpitHE_111Z.this.fm.EI.engines[1].getControlThrottle()) / 11F;
            CockpitHE_111Z.this.setNew.waypointAzimuth.setDeg(CockpitHE_111Z.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitHE_111Z.this.waypointAzimuth() - CockpitHE_111Z.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitHE_111Z.this.fm.Or.getKren()) < 30F) {
                CockpitHE_111Z.this.setNew.azimuth.setDeg(CockpitHE_111Z.this.setOld.azimuth.getDeg(1.0F), CockpitHE_111Z.this.fm.Or.azimut());
            }
            CockpitHE_111Z.this.setNew.vspeed = ((499F * CockpitHE_111Z.this.setOld.vspeed) + CockpitHE_111Z.this.fm.getVertSpeed()) / 500F;
            if (CockpitHE_111Z.this.fm.isTick(12, 0)) {
                Airport airport = Airport.nearest(CockpitHE_111Z.this.fm.Loc, -1, 1);
                if ((airport != null) && airport.nearestRunway(CockpitHE_111Z.this.fm.Loc, CockpitHE_111Z.this.tmpLoc)) {
                    CockpitHE_111Z.this.tmpLoc.transformInv(CockpitHE_111Z.this.fm.Loc, CockpitHE_111Z.this.tmpP);
                    ...
                    CockpitHE_111Z.this.tmpV.z -= 0.034899D;
                    if (CockpitHE_111Z.this.tmpV.x > 0.96D) {
                        if (CockpitHE_111Z.this.tmpV.y > 0.0D) {
                            CockpitHE_111Z.this.setNew.blindDotX = 1.889F * (float) Math.sqrt(CockpitHE_111Z.this.tmpV.y);
                        } else {
                            CockpitHE_111Z.this.setNew.blindDotX = -1.889F * (float) Math.sqrt(-CockpitHE_111Z.this.tmpV.y);
                        }
                        if (CockpitHE_111Z.this.tmpV.z > 0.0D) {
                            CockpitHE_111Z.this.setNew.blindDotY = 1.889F * (float) Math.sqrt(CockpitHE_111Z.this.tmpV.z);
                        } else {
                            CockpitHE_111Z.this.setNew.blindDotY = -1.889F * (float) Math.sqrt(-CockpitHE_111Z.this.tmpV.z);
                        }
                    } else {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 400F, 0.0F, 16F), CockpitHE_111Z.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitHE_111Z.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitHE_111Z.rpmScale), 0.0F, 0.0F);
