...
public class CockpitHE_115 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitHE_115.this.cockpitDimControl) {
                if (CockpitHE_115.this.setNew.dimPosition > 0.0F) {
                    CockpitHE_115.this.setNew.dimPosition = CockpitHE_115.this.setNew.dimPosition - 0.05F;
                }
            } else if (CockpitHE_115.this.setNew.dimPosition < 1.0F) {
                CockpitHE_115.this.setNew.dimPosition = CockpitHE_115.this.setNew.dimPosition + 0.05F;
            }
            ...
            CockpitHE_115.this.setNew.waypointAzimuth.setDeg(CockpitHE_115.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitHE_115.this.waypointAzimuth() - CockpitHE_115.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitHE_115.this.fm.Or.getKren()) < 30F) {
                CockpitHE_115.this.setNew.azimuth.setDeg(CockpitHE_115.this.setOld.azimuth.getDeg(1.0F), CockpitHE_115.this.fm.Or.azimut());
            }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 12F), CockpitHE_115.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speed1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitHE_115.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitHE_115.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitHE_115.rpmScale), 0.0F, 0.0F);
