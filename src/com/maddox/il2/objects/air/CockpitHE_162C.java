...
public class CockpitHE_162C extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitHE_162C.this.bNeedSetUp) {
                ...
                CockpitHE_162C.this.bNeedSetUp = false;
            }
            CockpitHE_162C.this.setTmp = CockpitHE_162C.this.setOld;
            CockpitHE_162C.this.setOld = CockpitHE_162C.this.setNew;
            CockpitHE_162C.this.setNew = CockpitHE_162C.this.setTmp;
            CockpitHE_162C.this.setNew.vspeed = ((299F * CockpitHE_162C.this.setOld.vspeed) + CockpitHE_162C.this.fm.getVertSpeed()) / 300F;
            CockpitHE_162C.this.setNew.altimeter = CockpitHE_162C.this.fm.getAltitude();
            if (CockpitHE_162C.this.cockpitDimControl) {
                if (CockpitHE_162C.this.setNew.dimPosition > 0.0F) {
                    CockpitHE_162C.this.setNew.dimPosition = CockpitHE_162C.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitHE_162C.this.setNew.dimPosition < 1.0F) {
                CockpitHE_162C.this.setNew.dimPosition = CockpitHE_162C.this.setOld.dimPosition + 0.05F;
            }
            CockpitHE_162C.this.setNew.throttle = ((10F * CockpitHE_162C.this.setOld.throttle) + CockpitHE_162C.this.fm.CT.PowerControl) / 11F;
            CockpitHE_162C.this.setNew.mix = ((8F * CockpitHE_162C.this.setOld.mix) + CockpitHE_162C.this.fm.EI.engines[0].getControlMix()) / 9F;
            if (Math.abs(CockpitHE_162C.this.fm.Or.getKren()) < 30F) {
                CockpitHE_162C.this.setNew.azimuth.setDeg(CockpitHE_162C.this.setOld.azimuth.getDeg(1.0F), CockpitHE_162C.this.fm.Or.azimut());
            }
            CockpitHE_162C.this.setNew.beaconDirection = ((10F * CockpitHE_162C.this.setOld.beaconDirection) + CockpitHE_162C.this.getBeaconDirection()) / 11F;
            CockpitHE_162C.this.setNew.beaconRange = ((10F * CockpitHE_162C.this.setOld.beaconRange) + CockpitHE_162C.this.getBeaconRange()) / 11F;
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1000F, 0.0F, 10F), CockpitHE_162C.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 0.0F, 1000F, 0.0F, 10F), CockpitHE_162C.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitHE_162C.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.setNew.vspeed < 0.0F ? -this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitHE_162C.vsiNeedleScale) : this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitHE_162C.vsiNeedleScale), 0.0F, 0.0F);
