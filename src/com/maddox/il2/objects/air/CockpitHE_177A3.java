        ...
        public boolean tick() {
            if (CockpitHE_177A3.this.fm != null) {
                ...
                if (CockpitHE_177A3.this.useRealisticNavigationInstruments()) {
                    ...
                    CockpitHE_177A3.this.setNew.waypointAzimuth.setDeg(CockpitHE_177A3.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitHE_177A3.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitHE_177A3.this.fm.Or.getKren()) < 30F) {
                ...
                if ((f1 > 55F) || (f1 < -55F) || (f2 < -55F) || (f2 > 55F)) {
                    CockpitHE_177A3.this.Pn.z = 250D;
                } else {
                    ...
                    if (CockpitHE_177A3.this.fm.CT.getGear() > 0.5F) {
                        CockpitHE_177A3.this.Pn.z = CockpitHE_177A3.this.cvt((float) CockpitHE_177A3.this.Pn.z, 0.0F, 150F, 0.0F, 250F);
                    } else {
                        CockpitHE_177A3.this.Pn.z = CockpitHE_177A3.this.cvt((float) CockpitHE_177A3.this.Pn.z, 0.0F, 750F, 0.0F, 250F);
                    }
                }
...
//		this.hidePilot = true;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_N_AirSpeed1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 750F, 0.0F, 15F), CockpitHE_177A3.IAS_Scale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_N_AirSpeed2", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 750F, 0.0F, 15F), CockpitHE_177A3.IAS_Scale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_N_RPM1", -this.floatindex(this.cvt(f39, 400F, 3600F, 0.0F, 32F), CockpitHE_177A3.Fl20274_Scale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_N_RPM2", -this.floatindex(this.cvt(f39, 400F, 3600F, 0.0F, 32F), CockpitHE_177A3.Fl20274_Scale), 0.0F, 0.0F);
        float f40 = ((FlightModelMain) this.fm).EI.engines[1].getRPM();
        this.mesh.chunkSetAngles("Z_N_RPM3", -this.floatindex(this.cvt(f40, 400F, 3600F, 0.0F, 32F), CockpitHE_177A3.Fl20274_Scale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_N_RPM4", -this.floatindex(this.cvt(f40, 400F, 3600F, 0.0F, 32F), CockpitHE_177A3.Fl20274_Scale), 0.0F, 0.0F);
...
//		}
        ...
        this.mesh.chunkSetAngles("Z_N_E1CoolTemp", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 130F, 0.0F, 13F), CockpitHE_177A3.Fl20342_Scale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_N_E2CoolTemp", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 130F, 0.0F, 13F), CockpitHE_177A3.Fl20342_Scale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_N_E3CoolTemp", -this.floatindex(this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 130F, 0.0F, 13F), CockpitHE_177A3.Fl20342_Scale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_N_E4CoolTemp", -this.floatindex(this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 130F, 0.0F, 13F), CockpitHE_177A3.Fl20342_Scale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_N_E1OilTemp", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 130F, 0.0F, 13F), CockpitHE_177A3.Fl20342_Scale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_N_E2OilTemp", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 130F, 0.0F, 13F), CockpitHE_177A3.Fl20342_Scale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_N_E3OilTemp", -this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 130F, 0.0F, 13F), CockpitHE_177A3.Fl20342_Scale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_N_E4OilTemp", -this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 130F, 0.0F, 13F), CockpitHE_177A3.Fl20342_Scale), 0.0F, 0.0F);
...
//			;
        ...
        this.mesh.chunkSetAngles("Z_tLink", 0.0F, 0.0F, this.floatindex(this.cvt(f51, 0.0F, 90F, 0.0F, 18F), CockpitHE_177A3.Turret_Z1));
        this.mesh.chunkSetAngles("Z_tHandle", 0.0F, 0.0F, -this.floatindex(this.cvt(f51, 0.0F, 90F, 0.0F, 18F), CockpitHE_177A3.Turret_Z2));
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            ...
            if (this.aircraft().thisWeaponsName.endsWith("Schlong")) {
                this.mesh.chunkVisible("Schlong", true);
            }
            return true;
        } else {
            return false;
