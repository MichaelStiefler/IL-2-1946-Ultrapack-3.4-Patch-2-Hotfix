...
abstract class CockpitHE_1XX extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (engineIsUp) {
                for (int i = 0; i < CockpitHE_1XX.NUM_COUNTERS; i++) {
            ...
            CockpitHE_1XX.this.setNew.waypointAzimuth.setDeg(CockpitHE_1XX.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitHE_1XX.this.waypointAzimuth() - CockpitHE_1XX.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitHE_1XX.this.fm.Or.getKren()) < 30F) {
                CockpitHE_1XX.this.setNew.azimuth.setDeg(CockpitHE_1XX.this.setOld.azimuth.getDeg(1.0F), CockpitHE_1XX.this.fm.Or.azimut());
            }
...
//    }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        Cockpit.xyz[1] = HE_1xx.smoothCvt(this.fm.CT.getCockpitDoor(), 0.01F, 0.99F, 0.0F, (this.aircraft() instanceof HE_112) ? 0.6F : 0.7F);
...
//        this.mesh.chunkSetAngles("Z_CanopyHandle", 0.0F, this.cvt(this.interp(this.setNew.canopyHandlePosition, this.setOld.canopyHandlePosition, f), 0.0F, 1.0F, 0.0F, 120F), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) ((Tuple3d) (this.fm.Loc)).z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitHE_1XX.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitHE_1XX.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), CockpitHE_1XX.fuelScale), 0.0F, 0.0F);
        ...
        if (this.fm.EI.engines[0].getStage() == 6) {
            ...
            float f2 = this.cvt((this.setNew.azimuth.getDeg(f) - this.setOld.azimuth.getDeg(f)) / Time.tickLenFs(), -5F, 5F, 18F, -18F);
...
//        }
        ...
        if (engineIsUp) {
            for (int i = 3; i < CockpitHE_1XX.MAX_GUNS; i++) {
...
//            this.mesh.chunkVisible("Z_ATA1", false);
    ...
    protected void reflectPlaneMats() {
        ...
        for (int i = 0; i < CockpitHE_1XX.MAX_GUNS; i++) {
            if (this.gun[i] instanceof GunEmpty) {
    ...
    private int getLoadoutType() {
        ...
        if (this.aircraft() instanceof HE_100D) {
            ...
            if (loadoutName.equals("late1") || loadoutName.equals("late2")) {
                return 13;
            }
