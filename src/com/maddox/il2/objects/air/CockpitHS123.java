...
public class CockpitHS123 extends CockpitPilot {
        ...
        public boolean tick() {
            if (CockpitHS123.this.fm != null) {
                ...
                if (CockpitHS123.this.cockpitDimControl) {
                    if (CockpitHS123.this.setNew.dimPosition > 0.0F) {
                        CockpitHS123.this.setNew.dimPosition = CockpitHS123.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitHS123.this.setNew.dimPosition < 1.0F) {
                    CockpitHS123.this.setNew.dimPosition = CockpitHS123.this.setOld.dimPosition + 0.05F;
                }
                ...
                if (Math.abs(CockpitHS123.this.fm.Or.getKren()) < 30F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitHS123.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitHS123.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), CockpitHS123.fuelScale), 0.0F, 0.0F);
