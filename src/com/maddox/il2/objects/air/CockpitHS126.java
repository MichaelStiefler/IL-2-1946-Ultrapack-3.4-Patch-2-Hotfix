...
public class CockpitHS126 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitHS126.this.useRealisticNavigationInstruments()) {
                ...
                CockpitHS126.this.setNew.waypointAzimuth.setDeg(CockpitHS126.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitHS126.this.setOld.azimuth.getDeg(1.0F));
            }
            if (Math.abs(CockpitHS126.this.fm.Or.getKren()) < 30F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zTOil1a", 0.0F, (f1 = this.fm.EI.engines[0].tOilOut) > 100F ? 180F + (3.725F * (f1 - 100F)) : this.floatindex(this.cvt(f1, 0.0F, 100F, 0.0F, 5F), CockpitHS126.oilTScale), 0.0F);
        this.mesh.chunkSetAngles("zGasPrs1a", 0.0F, this.floatindex(this.cvt(1.388889F * this.fm.M.fuel, 0.0F, 450F, 0.0F, 9F), CockpitHS126.fuelScale), 0.0F);
