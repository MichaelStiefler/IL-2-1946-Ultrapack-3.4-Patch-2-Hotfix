...
public class CockpitHalifaxBMkI extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitHalifaxBMkI.this.fm != null) {
                ...
                CockpitHalifaxBMkI.this.setNew.waypointAzimuth.setDeg(CockpitHalifaxBMkI.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitHalifaxBMkI.this.waypointAzimuth() - CockpitHalifaxBMkI.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitHalifaxBMkI.this.fm.Or.getKren()) < 30F) {
                    CockpitHalifaxBMkI.this.setNew.azimuth.setDeg(CockpitHalifaxBMkI.this.setOld.azimuth.getDeg(1.0F), CockpitHalifaxBMkI.this.fm.Or.azimut());
                }
                ...
                switch (CockpitHalifaxBMkI.this.iWiper) {
                    ...
                    case 0:
                        if ((Mission.curCloudsType() > 4) && (CockpitHalifaxBMkI.this.fm.getSpeedKMH() < 220F) && (CockpitHalifaxBMkI.this.fm.getAltitude() < (Mission.curCloudsHeight() + 300F))) {
                            CockpitHalifaxBMkI.this.iWiper = 1;
                        }
                        break;

                    case 1:
                        CockpitHalifaxBMkI.this.setNew.wiper = CockpitHalifaxBMkI.this.setOld.wiper - 0.05F;
                        if (CockpitHalifaxBMkI.this.setNew.wiper < -1.03F) {
                            CockpitHalifaxBMkI.this.iWiper++;
                        }
                        if (CockpitHalifaxBMkI.this.wiState >= 2) {
                            break;
                        }
                        if (CockpitHalifaxBMkI.this.wiState == 0) {
                            ...
                            if (CockpitHalifaxBMkI.this.fxw != null) {
                                CockpitHalifaxBMkI.this.fxw.play(CockpitHalifaxBMkI.this.wiStart);
                            }
                        }
                        if (CockpitHalifaxBMkI.this.fxw != null) {
                    ...
                    case 2:
                        ...
                        if (CockpitHalifaxBMkI.this.wiState > 1) {
                            CockpitHalifaxBMkI.this.wiState = 1;
                        }
                        break;

                    case 3:
                        CockpitHalifaxBMkI.this.setNew.wiper = CockpitHalifaxBMkI.this.setOld.wiper - 0.05F;
                        if (CockpitHalifaxBMkI.this.setNew.wiper >= 0.02F) {
                            break;
                        }
                        if ((CockpitHalifaxBMkI.this.fm.getSpeedKMH() > 250F) || (CockpitHalifaxBMkI.this.fm.getAltitude() > (Mission.curCloudsHeight() + 400F))) {
                            CockpitHalifaxBMkI.this.iWiper++;
                        } else {
                            CockpitHalifaxBMkI.this.iWiper = 1;
                        }
                    ...
                    case 4:
                        ...
                        if (CockpitHalifaxBMkI.this.fxw != null) {
                            CockpitHalifaxBMkI.this.fxw.cancel();
                        }
                        break;
                }
            }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST1", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitHalifaxBMkI.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST2", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitHalifaxBMkI.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST3", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitHalifaxBMkI.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST4", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitHalifaxBMkI.boostScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TEMP_RAD1", this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitHalifaxBMkI.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_TEMP_RAD2", this.floatindex(this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitHalifaxBMkI.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_TEMP_RAD3", this.floatindex(this.cvt(this.fm.EI.engines[2].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitHalifaxBMkI.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_TEMP_RAD4", this.floatindex(this.cvt(this.fm.EI.engines[3].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitHalifaxBMkI.radScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 26.8224F, 214.5792F, 0.0F, 21F), CockpitHalifaxBMkI.speedometerScale), 0.0F, 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("STR_CLIMB", this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitHalifaxBMkI.variometerScale), 0.0F, 0.0F);
        }
