...
public class CockpitHalifaxBMkIII extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitHalifaxBMkIII.this.fm != null) {
                ...
                if (Math.abs(CockpitHalifaxBMkIII.this.fm.Or.getKren()) < 30F) {
                ...
                switch (CockpitHalifaxBMkIII.this.iWiper) {
                    ...
                    case 0:
                        if ((Mission.curCloudsType() > 4) && (CockpitHalifaxBMkIII.this.fm.getSpeedKMH() < 320F) && (CockpitHalifaxBMkIII.this.fm.getAltitude() < (Mission.curCloudsHeight() + 300F))) {
                            CockpitHalifaxBMkIII.this.iWiper = 1;
                        }
                    ...
                    case 1:
                        ...
                        if (CockpitHalifaxBMkIII.this.setNew.wiper > 1.03F) {
                            CockpitHalifaxBMkIII.this.iWiper++;
                        }
                    ...
                    case 2:
                        CockpitHalifaxBMkIII.this.setNew.wiper = CockpitHalifaxBMkIII.this.setOld.wiper - 0.05F;
                        if (CockpitHalifaxBMkIII.this.wiState > 1) {
                            CockpitHalifaxBMkIII.this.wiState = 1;
                        }
                        if (CockpitHalifaxBMkIII.this.setNew.wiper >= 0.02F) {
                            break;
                        }
                        if ((CockpitHalifaxBMkIII.this.fm.getSpeedKMH() > 350F) || (CockpitHalifaxBMkIII.this.fm.getAltitude() > (Mission.curCloudsHeight() + 400F))) {
                            CockpitHalifaxBMkIII.this.iWiper++;
                        } else {
                            CockpitHalifaxBMkIII.this.iWiper = 1;
                        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST1", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitHalifaxBMkIII.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST2", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitHalifaxBMkIII.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST3", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitHalifaxBMkIII.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST4", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitHalifaxBMkIII.boostScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TEMP_RAD1", this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitHalifaxBMkIII.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_TEMP_RAD2", this.floatindex(this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitHalifaxBMkIII.radScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 26.8224F, 214.5792F, 0.0F, 21F), CockpitHalifaxBMkIII.speedometerScale), 0.0F, 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("STR_CLIMB", this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitHalifaxBMkIII.variometerScale), 0.0F, 0.0F);
        }
