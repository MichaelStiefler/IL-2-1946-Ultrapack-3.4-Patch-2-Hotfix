...
public class CockpitHampdenMkI extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitHampdenMkI.this.fm != null) {
                ...
                if (Math.abs(CockpitHampdenMkI.this.fm.Or.getKren()) < 30F) {
                ...
                if ((CockpitHampdenMkI.this.fm.AS.astateCockpitState & 0x40) == 0) {
                    CockpitHampdenMkI.this.setNew.vspeed = ((199F * CockpitHampdenMkI.this.setOld.vspeed) + CockpitHampdenMkI.this.fm.getVertSpeed()) / 200F;
                } else {
                    CockpitHampdenMkI.this.setNew.vspeed = ((1990F * CockpitHampdenMkI.this.setOld.vspeed) + CockpitHampdenMkI.this.fm.getVertSpeed()) / 2000F;
                }
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 143.0528F, 0.0F, 32F), CockpitHampdenMkI.speedometerScaleFAF), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitHampdenMkI.variometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 0.0F, 8F), CockpitHampdenMkI.rpmScale), 0.0F);
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 1000F, 5000F, 0.0F, 8F), CockpitHampdenMkI.rpmScale), 0.0F);
        } else {
            this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 500F, 9800F, 0.0F, 8F), CockpitHampdenMkI.rpmScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Temp1", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilIn, 0.0F, 140F, 0.0F, 14F), CockpitHampdenMkI.radScale), 0.0F);
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Temp2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].tOilIn, 0.0F, 140F, 0.0F, 14F), CockpitHampdenMkI.radScale), 0.0F);
        }
