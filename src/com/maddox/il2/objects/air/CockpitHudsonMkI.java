...
public class CockpitHudsonMkI extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitHudsonMkI.this.fm != null) {
                CockpitHudsonMkI.this.setTmp = CockpitHudsonMkI.this.setOld;
                CockpitHudsonMkI.this.setOld = CockpitHudsonMkI.this.setNew;
                CockpitHudsonMkI.this.setNew = CockpitHudsonMkI.this.setTmp;
                CockpitHudsonMkI.this.setNew.throttle1 = (0.85F * CockpitHudsonMkI.this.setOld.throttle1) + (CockpitHudsonMkI.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitHudsonMkI.this.setNew.throttle2 = (0.85F * CockpitHudsonMkI.this.setOld.throttle2) + (CockpitHudsonMkI.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitHudsonMkI.this.setNew.prop1 = (0.85F * CockpitHudsonMkI.this.setOld.prop1) + (CockpitHudsonMkI.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitHudsonMkI.this.setNew.prop2 = (0.85F * CockpitHudsonMkI.this.setOld.prop2) + (CockpitHudsonMkI.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitHudsonMkI.this.setNew.altimeter = CockpitHudsonMkI.this.fm.getAltitude();
                float f = CockpitHudsonMkI.this.waypointAzimuth();
                if (Math.abs(CockpitHudsonMkI.this.fm.Or.getKren()) < 30F) {
                    CockpitHudsonMkI.this.setNew.azimuth.setDeg(CockpitHudsonMkI.this.setOld.azimuth.getDeg(1.0F), CockpitHudsonMkI.this.fm.Or.azimut());
                }
                CockpitHudsonMkI.this.setNew.waypointAzimuth.setDeg(CockpitHudsonMkI.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitHudsonMkI.this.setNew.waypointDeviation.setDeg(CockpitHudsonMkI.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitHudsonMkI.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitHudsonMkI.this.setNew.vspeed = ((199F * CockpitHudsonMkI.this.setOld.vspeed) + CockpitHudsonMkI.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitHudsonMkI() {
        super("3DO/Cockpit/HudsonMkI/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitHudsonMkI.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitHudsonMkI.speedometerScale), 0.0F);
