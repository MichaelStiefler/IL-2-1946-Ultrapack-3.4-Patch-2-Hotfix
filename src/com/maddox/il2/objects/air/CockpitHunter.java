    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitHunter.this.fm != null) {
                ...
                if (Math.abs(CockpitHunter.this.fm.Or.getKren()) < 30F) {
...
// AircraftLH.printCompassHeading = true;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitHunter.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitHunter.variometerScale), 0.0F, 0.0F);
