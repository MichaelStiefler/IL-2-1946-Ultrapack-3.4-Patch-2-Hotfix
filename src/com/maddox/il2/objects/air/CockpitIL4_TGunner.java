    ...
    public void clipAnglesGun(Orient orient) {
        ...
        if (!this.isRealMode()) {
            ...
            if (this.bNeedSetUp) {
                ...
                this.reflectWorldToInstruments(0F);
//                bNeedSetUp = false;
            }
    ...
    public void reflectWorldToInstruments(float f) {
        if (this.bNeedSetUp) {
            ...
            System.out.println("### CockpitIL4_TGunner reflectWorldToInstruments(" + f + "), calling reflectPlaneMats(), bNeedSetUp=" + this.bNeedSetUp);
    ...
    public CockpitIL4_TGunner() {
        ...
        this.prevA0 = 0.0F;
        this.hook1 = null;
        System.out.println("### CockpitIL4_TGunner <init>, bNeedSetUp=" + this.bNeedSetUp);
    }
