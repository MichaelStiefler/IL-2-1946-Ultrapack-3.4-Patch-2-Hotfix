...
public class CockpitIL_2_1940 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitIL_2_1940.this.fm != null) {
                CockpitIL_2_1940.this.setTmp = CockpitIL_2_1940.this.setOld;
                CockpitIL_2_1940.this.setOld = CockpitIL_2_1940.this.setNew;
                CockpitIL_2_1940.this.setNew = CockpitIL_2_1940.this.setTmp;
                CockpitIL_2_1940.this.setNew.throttle = ((10F * CockpitIL_2_1940.this.setOld.throttle) + CockpitIL_2_1940.this.fm.CT.PowerControl) / 11F;
                if (CockpitIL_2_1940.this.fm.Gears.isHydroOperable()) {
                    CockpitIL_2_1940.this.setNew.undercarriage = ((10F * CockpitIL_2_1940.this.setOld.undercarriage) + CockpitIL_2_1940.this.fm.CT.GearControl) / 11F;
                }
                CockpitIL_2_1940.this.setNew.flaps = ((10F * CockpitIL_2_1940.this.setOld.flaps) + (CockpitIL_2_1940.this.fm.CT.FlapsControl <= 0.0F ? 1.0F : 0.0F)) / 11F;
                CockpitIL_2_1940.this.setNew.altimeter = CockpitIL_2_1940.this.fm.getAltitude();
                if (Math.abs(CockpitIL_2_1940.this.fm.Or.getKren()) < 30F) {
                    CockpitIL_2_1940.this.setNew.azimuth.setDeg(CockpitIL_2_1940.this.setOld.azimuth.getDeg(1.0F), CockpitIL_2_1940.this.fm.Or.azimut());
                }
                CockpitIL_2_1940.this.setNew.vspeed = ((199F * CockpitIL_2_1940.this.setOld.vspeed) + CockpitIL_2_1940.this.fm.getVertSpeed()) / 200F;
                if (CockpitIL_2_1940.this.fm.CT.saveWeaponControl[2]) {
                    CockpitIL_2_1940.this.roControl = true;
                    CockpitIL_2_1940.this.roControlTime = Time.current();
                }
                if (CockpitIL_2_1940.this.roControl) {
                    CockpitIL_2_1940.this.setNew.roPos = ((2.0F * CockpitIL_2_1940.this.setOld.roPos) - 230F) / 3F;
                    if (CockpitIL_2_1940.this.roControlTime < (Time.current() - 2210L)) {
                        CockpitIL_2_1940.this.roControl = false;
                    }
                } else {
                    CockpitIL_2_1940.this.setNew.roPos = ((14F * CockpitIL_2_1940.this.setOld.roPos) - 0.0F) / 15F;
                }
                if (CockpitIL_2_1940.this.fm.CT.saveWeaponControl[3]) {
                ...
                if (CockpitIL_2_1940.this.bombControl) {
                    CockpitIL_2_1940.this.setNew.bombPos = ((2.0F * CockpitIL_2_1940.this.setOld.bombPos) - 220F) / 3F;
                    if (CockpitIL_2_1940.this.bombControlTime < (Time.current() - 2210L)) {
                        CockpitIL_2_1940.this.bombControl = false;
                    }
                } else {
                    CockpitIL_2_1940.this.setNew.bombPos = ((14F * CockpitIL_2_1940.this.setOld.bombPos) - 0.0F) / 15F;
                }
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (((this.fm.AS.astateCockpitState & 2) == 0) && ((this.fm.AS.astateCockpitState & 4) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitIL_2_1940.speedometerScale), 0.0F);
