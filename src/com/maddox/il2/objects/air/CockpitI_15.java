...
public class CockpitI_15 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitI_15.this.bNeedSetUp) {
                CockpitI_15.this.reflectPlaneMats();
                CockpitI_15.this.bNeedSetUp = false;
            }
            if ((I_153_M62) CockpitI_15.this.aircraft() == null) {

            }
            if (I_153_M62.bChangedPit) {
                CockpitI_15.this.reflectPlaneToModel();
                if ((I_153_M62) CockpitI_15.this.aircraft() == null) {

                }
                I_153_M62.bChangedPit = false;
            }
            CockpitI_15.this.setTmp = CockpitI_15.this.setOld;
            CockpitI_15.this.setOld = CockpitI_15.this.setNew;
            CockpitI_15.this.setNew = CockpitI_15.this.setTmp;
            CockpitI_15.this.setNew.altimeter = CockpitI_15.this.fm.getAltitude();
            if (Math.abs(CockpitI_15.this.fm.Or.getKren()) < 30F) {
                CockpitI_15.this.setNew.azimuth.setDeg(CockpitI_15.this.setOld.azimuth.getDeg(1.0F), CockpitI_15.this.fm.Or.azimut());
            }
            CockpitI_15.this.setNew.throttle = ((10F * CockpitI_15.this.setOld.throttle) + CockpitI_15.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitI_15.this.setNew.mix = ((10F * CockpitI_15.this.setOld.mix) + CockpitI_15.this.fm.EI.engines[0].getControlMix()) / 11F;
            CockpitI_15.this.setNew.prop = CockpitI_15.this.setOld.prop;
            if (CockpitI_15.this.setNew.prop < (CockpitI_15.this.fm.EI.engines[0].getControlProp() - 0.01F)) {
                CockpitI_15.this.setNew.prop += 0.0025F;
            }
            if (CockpitI_15.this.setNew.prop > (CockpitI_15.this.fm.EI.engines[0].getControlProp() + 0.01F)) {
                CockpitI_15.this.setNew.prop -= 0.0025F;
            }
            CockpitI_15.this.w.set(CockpitI_15.this.fm.getW());
            CockpitI_15.this.fm.Or.transform(CockpitI_15.this.w);
            CockpitI_15.this.setNew.turn = ((12F * CockpitI_15.this.setOld.turn) + CockpitI_15.this.w.z) / 13F;
            CockpitI_15.this.setNew.vspeed = ((299F * CockpitI_15.this.setOld.vspeed) + CockpitI_15.this.fm.getVertSpeed()) / 300F;
            CockpitI_15.this.pictSupc = (0.8F * CockpitI_15.this.pictSupc) + (0.2F * CockpitI_15.this.fm.EI.engines[0].getControlCompressor());
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 600F, 0.0F, 12F), CockpitI_15.speedometerScale), 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 4) == 0) {
            this.mesh.chunkSetAngles("zRPS1a", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 2400F, 0.0F, 11F), CockpitI_15.rpmScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zManifold1a", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getManifoldPressure(), 0.399966F, 2.133152F, 3F, 16F), CockpitI_15.manifoldScale), 0.0F);
