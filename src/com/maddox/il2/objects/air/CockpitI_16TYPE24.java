...
public class CockpitI_16TYPE24 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitI_16TYPE24.this.fm != null) {
                if (CockpitI_16TYPE24.this.bNeedSetUp) {
                    CockpitI_16TYPE24.this.reflectPlaneMats();
                    CockpitI_16TYPE24.this.bNeedSetUp = false;
                }
                CockpitI_16TYPE24.this.setTmp = CockpitI_16TYPE24.this.setOld;
                CockpitI_16TYPE24.this.setOld = CockpitI_16TYPE24.this.setNew;
                CockpitI_16TYPE24.this.setNew = CockpitI_16TYPE24.this.setTmp;
                CockpitI_16TYPE24.this.setNew.throttle = ((10F * CockpitI_16TYPE24.this.setOld.throttle) + CockpitI_16TYPE24.this.fm.CT.PowerControl) / 11F;
                CockpitI_16TYPE24.this.setNew.prop = ((10F * CockpitI_16TYPE24.this.setOld.prop) + CockpitI_16TYPE24.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitI_16TYPE24.this.setNew.altimeter = CockpitI_16TYPE24.this.fm.getAltitude();
                CockpitI_16TYPE24.this.setNew.waypointAzimuth.setDeg(CockpitI_16TYPE24.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitI_16TYPE24.this.waypointAzimuth() - CockpitI_16TYPE24.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitI_16TYPE24.this.fm.Or.getKren()) < 30F) {
                    CockpitI_16TYPE24.this.setNew.azimuth.setDeg(CockpitI_16TYPE24.this.setOld.azimuth.getDeg(1.0F), CockpitI_16TYPE24.this.fm.Or.azimut());
                }
                CockpitI_16TYPE24.this.setNew.vspeed = ((199F * CockpitI_16TYPE24.this.setOld.vspeed) + CockpitI_16TYPE24.this.fm.getVertSpeed()) / 200F;
                boolean flag = false;
                if (CockpitI_16TYPE24.this.setNew.gCrankAngle < (CockpitI_16TYPE24.this.fm.CT.getGear() - 0.005F)) {
                    if (Math.abs(CockpitI_16TYPE24.this.setNew.gCrankAngle - CockpitI_16TYPE24.this.fm.CT.getGear()) < 0.33F) {
                        CockpitI_16TYPE24.this.setNew.gCrankAngle += 0.0025F;
                        flag = true;
                    } else {
                        CockpitI_16TYPE24.this.setNew.gCrankAngle = CockpitI_16TYPE24.this.fm.CT.getGear();
                        CockpitI_16TYPE24.this.setOld.gCrankAngle = CockpitI_16TYPE24.this.fm.CT.getGear();
                    }
                }
                if (CockpitI_16TYPE24.this.setNew.gCrankAngle > (CockpitI_16TYPE24.this.fm.CT.getGear() + 0.005F)) {
                    if (Math.abs(CockpitI_16TYPE24.this.setNew.gCrankAngle - CockpitI_16TYPE24.this.fm.CT.getGear()) < 0.33F) {
                ...
                if (flag != this.sfxPlaying) {
                    if (flag) {
                        CockpitI_16TYPE24.this.sfxStart(16);
                    } else {
                        CockpitI_16TYPE24.this.sfxStop(16);
                    }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zGas1a", 0.0F, this.floatindex(this.cvt(this.fm.M.fuel, 0.0F, 190F, 0.0F, 14F), CockpitI_16TYPE24.fuelQuantityScale), 0.0F);
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitI_16TYPE24.speedometerScale), 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x20) == 0)) {
            this.mesh.chunkSetAngles("zRPS1a", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 2400F, 0.0F, 13F), CockpitI_16TYPE24.engineRPMScale), 0.0F);
