...
public class CockpitI_16TYPE24_SPB extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitI_16TYPE24_SPB.this.fm != null) {
                if (CockpitI_16TYPE24_SPB.this.bNeedSetUp) {
                    CockpitI_16TYPE24_SPB.this.reflectPlaneMats();
                    CockpitI_16TYPE24_SPB.this.bNeedSetUp = false;
                }
                CockpitI_16TYPE24_SPB.this.setTmp = CockpitI_16TYPE24_SPB.this.setOld;
                CockpitI_16TYPE24_SPB.this.setOld = CockpitI_16TYPE24_SPB.this.setNew;
                CockpitI_16TYPE24_SPB.this.setNew = CockpitI_16TYPE24_SPB.this.setTmp;
                CockpitI_16TYPE24_SPB.this.setNew.throttle = ((10F * CockpitI_16TYPE24_SPB.this.setOld.throttle) + CockpitI_16TYPE24_SPB.this.fm.CT.PowerControl) / 11F;
                CockpitI_16TYPE24_SPB.this.setNew.prop = ((10F * CockpitI_16TYPE24_SPB.this.setOld.prop) + CockpitI_16TYPE24_SPB.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitI_16TYPE24_SPB.this.setNew.altimeter = CockpitI_16TYPE24_SPB.this.fm.getAltitude();
                CockpitI_16TYPE24_SPB.this.setNew.waypointAzimuth.setDeg(CockpitI_16TYPE24_SPB.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitI_16TYPE24_SPB.this.waypointAzimuth() - CockpitI_16TYPE24_SPB.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitI_16TYPE24_SPB.this.fm.Or.getKren()) < 30F) {
                    CockpitI_16TYPE24_SPB.this.setNew.azimuth.setDeg(CockpitI_16TYPE24_SPB.this.setOld.azimuth.getDeg(1.0F), CockpitI_16TYPE24_SPB.this.fm.Or.azimut());
                }
                CockpitI_16TYPE24_SPB.this.setNew.vspeed = ((199F * CockpitI_16TYPE24_SPB.this.setOld.vspeed) + CockpitI_16TYPE24_SPB.this.fm.getVertSpeed()) / 200F;
                boolean flag = false;
                if (CockpitI_16TYPE24_SPB.this.setNew.gCrankAngle < (CockpitI_16TYPE24_SPB.this.fm.CT.getGear() - 0.005F)) {
                    if (Math.abs(CockpitI_16TYPE24_SPB.this.setNew.gCrankAngle - CockpitI_16TYPE24_SPB.this.fm.CT.getGear()) < 0.33F) {
                        CockpitI_16TYPE24_SPB.this.setNew.gCrankAngle += 0.0025F;
                        flag = true;
                    } else {
                        CockpitI_16TYPE24_SPB.this.setNew.gCrankAngle = CockpitI_16TYPE24_SPB.this.fm.CT.getGear();
                        CockpitI_16TYPE24_SPB.this.setOld.gCrankAngle = CockpitI_16TYPE24_SPB.this.fm.CT.getGear();
                    }
                }
                if (CockpitI_16TYPE24_SPB.this.setNew.gCrankAngle > (CockpitI_16TYPE24_SPB.this.fm.CT.getGear() + 0.005F)) {
                    if (Math.abs(CockpitI_16TYPE24_SPB.this.setNew.gCrankAngle - CockpitI_16TYPE24_SPB.this.fm.CT.getGear()) < 0.33F) {
                ...
                if (flag != this.sfxPlaying) {
                    if (flag) {
                        CockpitI_16TYPE24_SPB.this.sfxStart(16);
                    } else {
    ...
    public void reflectWorldToInstruments(float f) {
        if (((TypeDockable) this.aircraft()).typeDockableIsDocked() != this.bDocked) {
            ...
            if (this.bDocked) {
                HierMesh hiermesh = ((ActorHMesh) ((I_16TYPE24DRONE) this.aircraft()).typeDockableGetQueen()).hierMesh();
                ...
                if (((I_16TYPE24DRONE) this.aircraft()).typeDockableGetDockport() == 0) {
        ...
        this.mesh.chunkSetAngles("zGas1a", 0.0F, this.floatindex(this.cvt(this.fm.M.fuel, 0.0F, 190F, 0.0F, 14F), CockpitI_16TYPE24_SPB.fuelQuantityScale), 0.0F);
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitI_16TYPE24_SPB.speedometerScale), 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x20) == 0)) {
            this.mesh.chunkSetAngles("zRPS1a", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 2400F, 0.0F, 13F), CockpitI_16TYPE24_SPB.engineRPMScale), 0.0F);
    ...
    protected void reflectPlaneMats() {
        this.mesh.chunkVisible("ritedoor", true);
    }
