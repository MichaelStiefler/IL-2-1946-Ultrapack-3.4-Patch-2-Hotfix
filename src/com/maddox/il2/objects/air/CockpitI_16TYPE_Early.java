...
public class CockpitI_16TYPE_Early extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitI_16TYPE_Early.this.fm != null) {
                if (CockpitI_16TYPE_Early.this.bNeedSetUp) {
                    CockpitI_16TYPE_Early.this.reflectPlaneMats();
                    CockpitI_16TYPE_Early.this.bNeedSetUp = false;
                }
                CockpitI_16TYPE_Early.this.setTmp = CockpitI_16TYPE_Early.this.setOld;
                CockpitI_16TYPE_Early.this.setOld = CockpitI_16TYPE_Early.this.setNew;
                CockpitI_16TYPE_Early.this.setNew = CockpitI_16TYPE_Early.this.setTmp;
                CockpitI_16TYPE_Early.this.setNew.throttle = ((10F * CockpitI_16TYPE_Early.this.setOld.throttle) + CockpitI_16TYPE_Early.this.fm.CT.PowerControl) / 11F;
                CockpitI_16TYPE_Early.this.setNew.prop = ((10F * CockpitI_16TYPE_Early.this.setOld.prop) + CockpitI_16TYPE_Early.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitI_16TYPE_Early.this.setNew.altimeter = CockpitI_16TYPE_Early.this.fm.getAltitude();
                CockpitI_16TYPE_Early.this.setNew.waypointAzimuth.setDeg(CockpitI_16TYPE_Early.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitI_16TYPE_Early.this.waypointAzimuth() - CockpitI_16TYPE_Early.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitI_16TYPE_Early.this.fm.Or.getKren()) < 30F) {
                    CockpitI_16TYPE_Early.this.setNew.azimuth.setDeg(CockpitI_16TYPE_Early.this.setOld.azimuth.getDeg(1.0F), CockpitI_16TYPE_Early.this.fm.Or.azimut());
                }
                CockpitI_16TYPE_Early.this.setNew.vspeed = ((199F * CockpitI_16TYPE_Early.this.setOld.vspeed) + CockpitI_16TYPE_Early.this.fm.getVertSpeed()) / 200F;
                boolean flag = false;
                if (CockpitI_16TYPE_Early.this.setNew.gCrankAngle < (CockpitI_16TYPE_Early.this.fm.CT.getGear() - 0.005F)) {
                    if (Math.abs(CockpitI_16TYPE_Early.this.setNew.gCrankAngle - CockpitI_16TYPE_Early.this.fm.CT.getGear()) < 0.33F) {
                        CockpitI_16TYPE_Early.this.setNew.gCrankAngle += 0.0025F;
                        flag = true;
                    } else {
                        CockpitI_16TYPE_Early.this.setNew.gCrankAngle = CockpitI_16TYPE_Early.this.fm.CT.getGear();
                        CockpitI_16TYPE_Early.this.setOld.gCrankAngle = CockpitI_16TYPE_Early.this.fm.CT.getGear();
                    }
                }
                if (CockpitI_16TYPE_Early.this.setNew.gCrankAngle > (CockpitI_16TYPE_Early.this.fm.CT.getGear() + 0.005F)) {
                    if (Math.abs(CockpitI_16TYPE_Early.this.setNew.gCrankAngle - CockpitI_16TYPE_Early.this.fm.CT.getGear()) < 0.33F) {
                ...
                if (flag != this.sfxPlaying) {
                    if (flag) {
                        CockpitI_16TYPE_Early.this.sfxStart(16);
                    } else {
                        CockpitI_16TYPE_Early.this.sfxStop(16);
                    }
    ...
    public CockpitI_16TYPE_Early() {
        super("3DO/Cockpit/I-16/hierEarly.him", "i16");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zGas1a", 0.0F, this.floatindex(this.cvt(this.fm.M.fuel, 0.0F, 190F, 0.0F, 14F), CockpitI_16TYPE_Early.fuelQuantityScale), 0.0F);
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitI_16TYPE_Early.speedometerScale), 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x20) == 0)) {
            this.mesh.chunkSetAngles("zRPS1a", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 2400F, 0.0F, 13F), CockpitI_16TYPE_Early.engineRPMScale), 0.0F);
