...
public class CockpitI_185M71 extends CockpitPilot {
        ...
        public boolean tick() {
            if (CockpitI_185M71.this.fm != null) {
                if (CockpitI_185M71.this.bNeedSetUp) {
                    ...
                    CockpitI_185M71.this.bNeedSetUp = false;
                }
                CockpitI_185M71.this.setTmp = CockpitI_185M71.this.setOld;
                CockpitI_185M71.this.setOld = CockpitI_185M71.this.setNew;
                CockpitI_185M71.this.setNew = CockpitI_185M71.this.setTmp;
                CockpitI_185M71.this.setNew.throttle = ((10F * CockpitI_185M71.this.setOld.throttle) + CockpitI_185M71.this.fm.CT.PowerControl) / 11F;
                ...
                if (CockpitI_185M71.this.useRealisticNavigationInstruments()) {
                    CockpitI_185M71.this.setNew.waypointAzimuth.setDeg(CockpitI_185M71.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitI_185M71.this.getBeaconDirection());
                } else {
                    CockpitI_185M71.this.setNew.waypointAzimuth.setDeg(CockpitI_185M71.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitI_185M71.this.waypointAzimuth() - CockpitI_185M71.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                }
                if (Math.abs(CockpitI_185M71.this.fm.Or.getKren()) < 30F) {
                    CockpitI_185M71.this.setNew.azimuth.setDeg(CockpitI_185M71.this.setOld.azimuth.getDeg(1.0F), CockpitI_185M71.this.fm.Or.azimut());
                }
                CockpitI_185M71.this.setNew.vspeed = ((199F * CockpitI_185M71.this.setOld.vspeed) + CockpitI_185M71.this.fm.getVertSpeed()) / 200F;
                if (CockpitI_185M71.this.fm.getAltitude() > 3000F) {
                    float f = (float) Math.sin(1.0F * CockpitI_185M71.this.cvt(CockpitI_185M71.this.fm.getOverload(), 1.0F, 8F, 1.0F, 0.45F) * CockpitI_185M71.this.cvt(CockpitI_185M71.this.fm.AS.astatePilotStates[0], 0.0F, 100F, 1.0F, 0.1F) * (0.001F * Time.current()));
                    if (f > 0.0F) {
                        CockpitI_185M71.this.pictBlinker += 0.3F;
                        if (CockpitI_185M71.this.pictBlinker > 1.0F) {
                            CockpitI_185M71.this.pictBlinker = 1.0F;
                        }
                    } else {
                        CockpitI_185M71.this.pictBlinker -= 0.3F;
                        if (CockpitI_185M71.this.pictBlinker < 0.0F) {
                            CockpitI_185M71.this.pictBlinker = 0.0F;
                        }
                    }
                }
                CockpitI_185M71.this.pictStage = (0.8F * CockpitI_185M71.this.pictStage) + (0.1F * CockpitI_185M71.this.fm.EI.engines[0].getControlCompressor());
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed1a", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitI_185M71.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zManifold1a", this.floatindex(this.cvt(this.fm.EI.engines[0].getManifoldPressure(), 0.399966F, 2.133152F, 3F, 16F), CockpitI_185M71.manifoldScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zVariometer1a", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 6F), CockpitI_185M71.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zCarbpress", this.cvt((0.6F * this.fm.CT.getPower()) + (0.6F * (this.fm.EI.engines[0].getw() / 3000F)), 0.0F, 1.5F, 0.0F, 105F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zOiltemper_I", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 100F, 0.0F, -293F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zOiltemper_II", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 100F, 0.0F, -293F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zOiltemper_III", this.cvt(this.fm.EI.engines[0].tOilIn, 0.0F, 100F, 0.0F, -293F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zOilpress", this.cvt(1.0F + (0.05F * this.fm.EI.engines[0].tOilOut), 0.0F, 10F, 0.0F, 296F), 0.0F, 0.0F);
