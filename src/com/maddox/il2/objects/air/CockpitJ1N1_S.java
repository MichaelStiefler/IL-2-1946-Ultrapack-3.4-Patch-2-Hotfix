...
public class CockpitJ1N1_S extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitJ1N1_S.this.fm != null) {
                CockpitJ1N1_S.this.setTmp = CockpitJ1N1_S.this.setOld;
                CockpitJ1N1_S.this.setOld = CockpitJ1N1_S.this.setNew;
                CockpitJ1N1_S.this.setNew = CockpitJ1N1_S.this.setTmp;
                CockpitJ1N1_S.this.setNew.flap = (0.88F * CockpitJ1N1_S.this.setOld.flap) + (0.12F * CockpitJ1N1_S.this.fm.CT.FlapsControl);
                CockpitJ1N1_S.this.setNew.tlock = (0.7F * CockpitJ1N1_S.this.setOld.tlock) + (0.3F * (CockpitJ1N1_S.this.fm.Gears.bTailwheelLocked ? 1.0F : 0.0F));
                if (CockpitJ1N1_S.this.cockpitDimControl) {
                    if (CockpitJ1N1_S.this.setNew.dimPosition > 0.0F) {
                        CockpitJ1N1_S.this.setNew.dimPosition = CockpitJ1N1_S.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitJ1N1_S.this.setNew.dimPosition < 1.0F) {
                    CockpitJ1N1_S.this.setNew.dimPosition = CockpitJ1N1_S.this.setOld.dimPosition + 0.05F;
                }
                if ((CockpitJ1N1_S.this.fm.AS.astateCockpitState & 2) != 0) {
                    if (CockpitJ1N1_S.this.setNew.stbyPosition > 0.0F) {
                        CockpitJ1N1_S.this.setNew.stbyPosition = CockpitJ1N1_S.this.setOld.stbyPosition - 0.025F;
                    }
                } else if (CockpitJ1N1_S.this.setNew.stbyPosition < 1.0F) {
                    CockpitJ1N1_S.this.setNew.stbyPosition = CockpitJ1N1_S.this.setOld.stbyPosition + 0.025F;
                }
                if ((CockpitJ1N1_S.this.fm.CT.GearControl < 0.5F) && (CockpitJ1N1_S.this.setNew.gear < 1.0F)) {
                    CockpitJ1N1_S.this.setNew.gear = CockpitJ1N1_S.this.setOld.gear + 0.02F;
                }
                if ((CockpitJ1N1_S.this.fm.CT.GearControl > 0.5F) && (CockpitJ1N1_S.this.setNew.gear > 0.0F)) {
                    CockpitJ1N1_S.this.setNew.gear = CockpitJ1N1_S.this.setOld.gear - 0.02F;
                }
                CockpitJ1N1_S.this.setNew.throttle = (0.9F * CockpitJ1N1_S.this.setOld.throttle) + (0.1F * CockpitJ1N1_S.this.fm.CT.PowerControl);
                CockpitJ1N1_S.this.setNew.manifold = (0.8F * CockpitJ1N1_S.this.setOld.manifold) + (0.2F * CockpitJ1N1_S.this.fm.EI.engines[0].getManifoldPressure());
                CockpitJ1N1_S.this.setNew.pitch = (0.9F * CockpitJ1N1_S.this.setOld.pitch) + (0.1F * CockpitJ1N1_S.this.fm.EI.engines[0].getControlProp());
                CockpitJ1N1_S.this.setNew.mix = (0.9F * CockpitJ1N1_S.this.setOld.mix) + (0.1F * CockpitJ1N1_S.this.fm.EI.engines[0].getControlMix());
                CockpitJ1N1_S.this.setNew.altimeter = CockpitJ1N1_S.this.fm.getAltitude();
                if (Math.abs(CockpitJ1N1_S.this.fm.Or.getKren()) < 30F) {
                    CockpitJ1N1_S.this.setNew.azimuth.setDeg(CockpitJ1N1_S.this.setOld.azimuth.getDeg(1.0F), CockpitJ1N1_S.this.fm.Or.azimut());
                }
                CockpitJ1N1_S.this.setNew.vspeed = ((199F * CockpitJ1N1_S.this.setOld.vspeed) + CockpitJ1N1_S.this.fm.getVertSpeed()) / 200F;
                CockpitJ1N1_S.this.setNew.waypointAzimuth.setDeg(CockpitJ1N1_S.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitJ1N1_S.this.fm.Or.azimut() + 90F);
            }
            return true;
        }
    ...
    public CockpitJ1N1_S() {
        super("3DO/Cockpit/J1N1-S/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedClimb", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.5F, 6.5F), CockpitJ1N1_S.vsiNeedleScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1000F, 0.0F, 20F), CockpitJ1N1_S.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedRPM", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitJ1N1_S.revolutionsScale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitJ1N1_S.class, "normZNs", new float[] { 1.07F, 0.56F, 0.89F, 0.56F });
    }
