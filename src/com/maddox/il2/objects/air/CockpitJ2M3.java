...
public class CockpitJ2M3 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitJ2M3.this.fm != null) {
                CockpitJ2M3.this.setTmp = CockpitJ2M3.this.setOld;
                CockpitJ2M3.this.setOld = CockpitJ2M3.this.setNew;
                CockpitJ2M3.this.setNew = CockpitJ2M3.this.setTmp;
                CockpitJ2M3.this.setNew.throttle = (0.85F * CockpitJ2M3.this.setOld.throttle) + (CockpitJ2M3.this.fm.CT.PowerControl * 0.15F);
                CockpitJ2M3.this.setNew.prop = (0.85F * CockpitJ2M3.this.setOld.prop) + (CockpitJ2M3.this.fm.CT.getStepControl() * 0.15F);
                CockpitJ2M3.this.setNew.altimeter = CockpitJ2M3.this.fm.getAltitude();
                CockpitJ2M3.this.setNew.waypointAzimuth.setDeg(CockpitJ2M3.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitJ2M3.this.waypointAzimuth() - CockpitJ2M3.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitJ2M3.this.fm.Or.getKren()) < 30F) {
                    CockpitJ2M3.this.setNew.azimuth.setDeg(CockpitJ2M3.this.setOld.azimuth.getDeg(1.0F), CockpitJ2M3.this.fm.Or.azimut());
                }
                CockpitJ2M3.this.setNew.vspeed = ((199F * CockpitJ2M3.this.setOld.vspeed) + CockpitJ2M3.this.fm.getVertSpeed()) / 200F;
                CockpitJ2M3.this.setNew.manifold = (0.8F * CockpitJ2M3.this.setOld.manifold) + (0.2F * CockpitJ2M3.this.fm.EI.engines[0].getManifoldPressure());
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 92.59998F, 740.7998F, 0.0F, 7F), CockpitJ2M3.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Oil1", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 110F, 0.0F, 4F), CockpitJ2M3.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Ext_Air_Temp", -this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 233.09F, 333.09F, 0.0F, 5F), CockpitJ2M3.frAirTempScale), 0.0F, 0.0F);
