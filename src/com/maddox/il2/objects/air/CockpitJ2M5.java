...
public class CockpitJ2M5 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitJ2M5.this.fm != null) {
                CockpitJ2M5.this.setTmp = CockpitJ2M5.this.setOld;
                CockpitJ2M5.this.setOld = CockpitJ2M5.this.setNew;
                CockpitJ2M5.this.setNew = CockpitJ2M5.this.setTmp;
                ...
                CockpitJ2M5.this.setNew.waypointAzimuth.setDeg(CockpitJ2M5.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitJ2M5.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitJ2M5.this.fm.Or.getKren()) < 30F) {
                    CockpitJ2M5.this.setNew.azimuth.setDeg(CockpitJ2M5.this.setOld.azimuth.getDeg(1.0F), CockpitJ2M5.this.fm.Or.azimut());
                }
                CockpitJ2M5.this.setNew.vspeed = ((199F * CockpitJ2M5.this.setOld.vspeed) + CockpitJ2M5.this.fm.getVertSpeed()) / 200F;
                ...
                if (CockpitJ2M5.this.cockpitDimControl) {
                    if (CockpitJ2M5.this.setNew.dimPosition > 0.0F) {
                        CockpitJ2M5.this.setNew.dimPosition = CockpitJ2M5.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitJ2M5.this.setNew.dimPosition < 1.0F) {
                    CockpitJ2M5.this.setNew.dimPosition = CockpitJ2M5.this.setOld.dimPosition + 0.05F;
                }
            }
            return true;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 92.59998F, 740.7998F, 0.0F, 7F), CockpitJ2M5.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Oil1", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 110F, 0.0F, 4F), CockpitJ2M5.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Ext_Air_Temp", -this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 233.09F, 333.09F, 0.0F, 5F), CockpitJ2M5.frAirTempScale), 0.0F, 0.0F);
