...
public class CockpitJ2M5_mod extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitJ2M5_mod.this.fm != null) {
                CockpitJ2M5_mod.this.setTmp = CockpitJ2M5_mod.this.setOld;
                CockpitJ2M5_mod.this.setOld = CockpitJ2M5_mod.this.setNew;
                CockpitJ2M5_mod.this.setNew = CockpitJ2M5_mod.this.setTmp;
                CockpitJ2M5_mod.this.setNew.throttle = (0.85F * CockpitJ2M5_mod.this.setOld.throttle) + (CockpitJ2M5_mod.this.fm.CT.PowerControl * 0.15F);
                CockpitJ2M5_mod.this.setNew.prop = (0.85F * CockpitJ2M5_mod.this.setOld.prop) + (CockpitJ2M5_mod.this.fm.CT.getStepControl() * 0.15F);
                CockpitJ2M5_mod.this.setNew.altimeter = CockpitJ2M5_mod.this.fm.getAltitude();
                float f = CockpitJ2M5_mod.this.waypointAzimuth();
                CockpitJ2M5_mod.this.setNew.waypointAzimuth.setDeg(CockpitJ2M5_mod.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitJ2M5_mod.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitJ2M5_mod.this.fm.Or.getKren()) < 30F) {
                    CockpitJ2M5_mod.this.setNew.azimuth.setDeg(CockpitJ2M5_mod.this.setOld.azimuth.getDeg(1.0F), CockpitJ2M5_mod.this.fm.Or.azimut());
                }
                CockpitJ2M5_mod.this.setNew.vspeed = ((199F * CockpitJ2M5_mod.this.setOld.vspeed) + CockpitJ2M5_mod.this.fm.getVertSpeed()) / 200F;
                CockpitJ2M5_mod.this.setNew.manifold = (0.8F * CockpitJ2M5_mod.this.setOld.manifold) + (0.2F * CockpitJ2M5_mod.this.fm.EI.engines[0].getManifoldPressure());
                if (CockpitJ2M5_mod.this.cockpitDimControl) {
                    if (CockpitJ2M5_mod.this.setNew.dimPosition > 0.0F) {
                        CockpitJ2M5_mod.this.setNew.dimPosition = CockpitJ2M5_mod.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitJ2M5_mod.this.setNew.dimPosition < 1.0F) {
                    CockpitJ2M5_mod.this.setNew.dimPosition = CockpitJ2M5_mod.this.setOld.dimPosition + 0.05F;
                }
                if (CockpitJ2M5_mod.this.fm.EI.engines[0].getStage() > 0) {
                    if (CockpitJ2M5_mod.this.fm.AS.astateSootStates[0] == 0) {
                        CockpitJ2M5_mod.this.pictT = (0.993F * CockpitJ2M5_mod.this.pictT) + (0.007F * World.Rnd().nextFloat(600F, 900F + (CockpitJ2M5_mod.this.fm.CT.getPowerControl() * 100F)));
                    } else {
                        CockpitJ2M5_mod.this.pictT = (0.993F * CockpitJ2M5_mod.this.pictT) + (0.007F * World.Rnd().nextFloat(500F, 600F + (CockpitJ2M5_mod.this.fm.CT.getPowerControl() * 100F)));
                    }
                } else {
                    CockpitJ2M5_mod.this.pictT = (0.9992F * CockpitJ2M5_mod.this.pictT) + (0.0008F * (Atmosphere.temperature((float) CockpitJ2M5_mod.this.fm.Loc.z) - 200F));
                }
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 92.59998F, 740.7998F, 0.0F, 7F), CockpitJ2M5_mod.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Oil1", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 110F, 0.0F, 4F), CockpitJ2M5_mod.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Ext_Air_Temp", -this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 233.09F, 333.09F, 0.0F, 5F), CockpitJ2M5_mod.frAirTempScale), 0.0F, 0.0F);
