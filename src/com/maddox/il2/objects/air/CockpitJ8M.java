...
public class CockpitJ8M extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitJ8M.this.bNeedSetUp) {
                CockpitJ8M.this.reflectPlaneMats();
                CockpitJ8M.this.bNeedSetUp = false;
            }
            if (CockpitJ8M.this.fm != null) {
                CockpitJ8M.this.setTmp = CockpitJ8M.this.setOld;
                CockpitJ8M.this.setOld = CockpitJ8M.this.setNew;
                CockpitJ8M.this.setNew = CockpitJ8M.this.setTmp;
                if (Math.abs(CockpitJ8M.this.fm.Or.getKren()) < 30F) {
                    CockpitJ8M.this.setNew.azimuth.setDeg(CockpitJ8M.this.setOld.azimuth.getDeg(1.0F), CockpitJ8M.this.fm.Or.azimut());
                }
                CockpitJ8M.this.setNew.vspeed = ((98F * CockpitJ8M.this.setOld.vspeed) + CockpitJ8M.this.fm.getVertSpeed()) / 99F;
                CockpitJ8M.this.setNew.altimeter = CockpitJ8M.this.fm.getAltitude();
                CockpitJ8M.this.setNew.fuel = CockpitJ8M.this.fm.M.fuel;
                if (CockpitJ8M.this.cockpitDimControl) {
                    if (CockpitJ8M.this.setNew.dimPosition > 0.0F) {
                        CockpitJ8M.this.setNew.dimPosition = CockpitJ8M.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitJ8M.this.setNew.dimPosition < 1.0F) {
                    CockpitJ8M.this.setNew.dimPosition = CockpitJ8M.this.setOld.dimPosition + 0.05F;
                }
            }
            return true;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (!((J8M1) this.aircraft()).bCartAttached) {
        ...
        this.mesh.chunkSetAngles("Z_Speed1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 400F, 2.0F, 8F), CockpitJ8M.speedometerIndScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speed2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 100F, 1000F, 1.0F, 10F), CockpitJ8M.speedometerTruScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("RPM", this.floatindex(this.cvt(this.pictTurbo = (0.92F * this.pictTurbo) + (0.08F * f1), 2000F, 14000F, 2.0F, 14F), CockpitJ8M.rpmScale), 0.0F, 0.0F);
