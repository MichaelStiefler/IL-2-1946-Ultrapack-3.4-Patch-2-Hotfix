...
public class CockpitJU524E extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitJU524E.this.fm != null) {
                CockpitJU524E.this.setTmp = CockpitJU524E.this.setOld;
                CockpitJU524E.this.setOld = CockpitJU524E.this.setNew;
                CockpitJU524E.this.setNew = CockpitJU524E.this.setTmp;
                CockpitJU524E.this.setNew.throttle1 = (0.85F * CockpitJU524E.this.setOld.throttle1) + (CockpitJU524E.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitJU524E.this.setNew.prop1 = (0.85F * CockpitJU524E.this.setOld.prop1) + (CockpitJU524E.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitJU524E.this.setNew.throttle2 = (0.85F * CockpitJU524E.this.setOld.throttle2) + (CockpitJU524E.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitJU524E.this.setNew.prop2 = (0.85F * CockpitJU524E.this.setOld.prop2) + (CockpitJU524E.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitJU524E.this.setNew.throttle3 = (0.85F * CockpitJU524E.this.setOld.throttle3) + (CockpitJU524E.this.fm.EI.engines[2].getControlThrottle() * 0.15F);
                CockpitJU524E.this.setNew.prop3 = (0.85F * CockpitJU524E.this.setOld.prop3) + (CockpitJU524E.this.fm.EI.engines[2].getControlProp() * 0.15F);
                CockpitJU524E.this.setNew.altimeter = CockpitJU524E.this.fm.getAltitude();
                float f = CockpitJU524E.this.waypointAzimuth();
                CockpitJU524E.this.setNew.waypointAzimuth.setDeg(CockpitJU524E.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU524E.this.setOld.azimuth.getDeg(1.0F));
                if (Math.abs(CockpitJU524E.this.fm.Or.getKren()) < 30F) {
                    CockpitJU524E.this.setNew.azimuth.setDeg(CockpitJU524E.this.setOld.azimuth.getDeg(1.0F), CockpitJU524E.this.fm.Or.azimut());
                }
                CockpitJU524E.this.setNew.vspeed = (0.99F * CockpitJU524E.this.setOld.vspeed) + (0.01F * CockpitJU524E.this.fm.getVertSpeed());
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST1", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitJU524E.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST2", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitJU524E.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST3", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitJU524E.boostScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM_SHORT1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitJU524E.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM_LONG1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 80F), CockpitJU524E.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM_SHORT2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitJU524E.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM_LONG2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 80F), CockpitJU524E.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM_SHORT3", this.floatindex(this.cvt(this.fm.EI.engines[2].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitJU524E.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM_LONG3", this.floatindex(this.cvt(this.fm.EI.engines[2].getRPM(), 0.0F, 4000F, 0.0F, 80F), CockpitJU524E.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TEMP_RAD1", this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitJU524E.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_TEMP_RAD2", this.floatindex(this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitJU524E.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_TEMP_RAD3", this.floatindex(this.cvt(this.fm.EI.engines[2].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitJU524E.radScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 400F, 0.0F, 16F), CockpitJU524E.speedometerScale), 0.0F, 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("STR_CLIMB", this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitJU524E.variometerScale), 0.0F, 0.0F);
        }
