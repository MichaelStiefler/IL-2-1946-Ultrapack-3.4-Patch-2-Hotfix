...
public class CockpitJU_388 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (JU_388K.bChangedPit) {
                CockpitJU_388.this.reflectPlaneToModel();
                JU_388K.bChangedPit = false;
            }
            if (CockpitJU_388.this.fm != null) {
                CockpitJU_388.this.setTmp = CockpitJU_388.this.setOld;
                CockpitJU_388.this.setOld = CockpitJU_388.this.setNew;
                CockpitJU_388.this.setNew = CockpitJU_388.this.setTmp;
                CockpitJU_388.this.setNew.throttle1 = (0.85F * CockpitJU_388.this.setOld.throttle1) + (CockpitJU_388.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitJU_388.this.setNew.prop1 = (0.85F * CockpitJU_388.this.setOld.prop1) + (CockpitJU_388.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitJU_388.this.setNew.throttle2 = (0.85F * CockpitJU_388.this.setOld.throttle2) + (CockpitJU_388.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitJU_388.this.setNew.prop2 = (0.85F * CockpitJU_388.this.setOld.prop2) + (CockpitJU_388.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitJU_388.this.setNew.altimeter = CockpitJU_388.this.fm.getAltitude();
                float f = CockpitJU_388.this.waypointAzimuth();
                CockpitJU_388.this.setNew.waypointAzimuth.setDeg(CockpitJU_388.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_388.this.setOld.azimuth.getDeg(1.0F));
                if (Math.abs(CockpitJU_388.this.fm.Or.getKren()) < 30F) {
                    CockpitJU_388.this.setNew.azimuth.setDeg(CockpitJU_388.this.setOld.azimuth.getDeg(1.0F), CockpitJU_388.this.fm.Or.azimut());
                }
                CockpitJU_388.this.setNew.vspeed = ((199F * CockpitJU_388.this.setOld.vspeed) + CockpitJU_388.this.fm.getVertSpeed()) / 200F;
                if (CockpitJU_388.this.cockpitDimControl) {
                    if (CockpitJU_388.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_388.this.setNew.dimPosition = CockpitJU_388.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_388.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_388.this.setNew.dimPosition = CockpitJU_388.this.setOld.dimPosition + 0.05F;
                }
            }
            return true;
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            ...
            this.aircraft().hierMesh().chunkVisible("Blister1A_d0", false);
    ...
    protected void doFocusLeave() {
        if (this.isFocused()) {
            ...
            this.aircraft().hierMesh().chunkVisible("Blister1A_d0", true);
            this.aircraft().hierMesh().chunkVisible("DummyBlister_D0", false);
            super.doFocusLeave();
        }
    }

    public CockpitJU_388() {
        super("3DO/Cockpit/Ju-388K/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("TempMeter", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 213.09F, 293.09F, 0.0F, 8F), CockpitJU_388.frAirTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 750F, 0.0F, 14F), CockpitJU_388.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zSpeed2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 50F, 750F, 0.0F, 14F), CockpitJU_388.speedometerScale2), 0.0F, 0.0F);
