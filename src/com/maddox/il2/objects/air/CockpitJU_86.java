...
public class CockpitJU_86 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitJU_86.this.fm != null) {
                CockpitJU_86.this.setTmp = CockpitJU_86.this.setOld;
                CockpitJU_86.this.setOld = CockpitJU_86.this.setNew;
                CockpitJU_86.this.setNew = CockpitJU_86.this.setTmp;
                CockpitJU_86.this.setNew.throttle1 = (0.9F * CockpitJU_86.this.setOld.throttle1) + (0.1F * CockpitJU_86.this.fm.EI.engines[0].getControlThrottle());
                CockpitJU_86.this.setNew.prop1 = (0.9F * CockpitJU_86.this.setOld.prop1) + (0.1F * CockpitJU_86.this.fm.EI.engines[0].getControlProp());
                CockpitJU_86.this.setNew.mix1 = (0.8F * CockpitJU_86.this.setOld.mix1) + (0.2F * CockpitJU_86.this.fm.EI.engines[0].getControlMix());
                CockpitJU_86.this.setNew.throttle2 = (0.9F * CockpitJU_86.this.setOld.throttle2) + (0.1F * CockpitJU_86.this.fm.EI.engines[1].getControlThrottle());
                CockpitJU_86.this.setNew.prop2 = (0.9F * CockpitJU_86.this.setOld.prop2) + (0.1F * CockpitJU_86.this.fm.EI.engines[1].getControlProp());
                CockpitJU_86.this.setNew.mix2 = (0.8F * CockpitJU_86.this.setOld.mix2) + (0.2F * CockpitJU_86.this.fm.EI.engines[1].getControlMix());
                CockpitJU_86.this.setNew.man1 = (0.92F * CockpitJU_86.this.setOld.man1) + (0.08F * CockpitJU_86.this.fm.EI.engines[0].getManifoldPressure());
                CockpitJU_86.this.setNew.man2 = (0.92F * CockpitJU_86.this.setOld.man2) + (0.08F * CockpitJU_86.this.fm.EI.engines[1].getManifoldPressure());
                CockpitJU_86.this.setNew.altimeter = CockpitJU_86.this.fm.getAltitude();
                if (Math.abs(CockpitJU_86.this.fm.Or.getKren()) < 30F) {
                    CockpitJU_86.this.setNew.azimuth.setDeg(CockpitJU_86.this.setOld.azimuth.getDeg(1.0F), CockpitJU_86.this.fm.Or.azimut());
                }
                CockpitJU_86.this.setNew.vspeed = ((199F * CockpitJU_86.this.setOld.vspeed) + CockpitJU_86.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            this.aircraft().hierMesh().chunkVisible("RPC", false);
    ...
    protected void doFocusLeave() {
        this.aircraft().hierMesh().chunkVisible("RPC", true);
        this.aircraft().hierMesh().chunkVisible("Wire", true);
        super.doFocusLeave();
    }

    public CockpitJU_86() {
        super("3DO/Cockpit/Ju-86E/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitJU_86.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitJU_86.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitJU_86.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitJU_86.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitJU_86.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitJU_86.rpmScale), 0.0F, 0.0F);
