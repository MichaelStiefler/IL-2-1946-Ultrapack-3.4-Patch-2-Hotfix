...
public class CockpitJU_87B2 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitJU_87B2.this.fm != null) {
                CockpitJU_87B2.this.setTmp = CockpitJU_87B2.this.setOld;
                CockpitJU_87B2.this.setOld = CockpitJU_87B2.this.setNew;
                CockpitJU_87B2.this.setNew = CockpitJU_87B2.this.setTmp;
                CockpitJU_87B2.this.setNew.altimeter = CockpitJU_87B2.this.fm.getAltitude();
                if (CockpitJU_87B2.this.cockpitDimControl) {
                    if (CockpitJU_87B2.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_87B2.this.setNew.dimPosition = CockpitJU_87B2.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_87B2.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_87B2.this.setNew.dimPosition = CockpitJU_87B2.this.setOld.dimPosition + 0.05F;
                }
                CockpitJU_87B2.this.setNew.throttle = ((10F * CockpitJU_87B2.this.setOld.throttle) + CockpitJU_87B2.this.fm.CT.PowerControl) / 11F;
                float f = CockpitJU_87B2.this.waypointAzimuth();
                if (CockpitJU_87B2.this.useRealisticNavigationInstruments()) {
                    CockpitJU_87B2.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitJU_87B2.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                ...
                if (Math.abs(CockpitJU_87B2.this.fm.Or.getKren()) < 30F) {
                ...
                CockpitJU_87B2.this.setNew.turn = ((12F * CockpitJU_87B2.this.setOld.turn) + CockpitJU_87B2.this.w.z) / 13F;
                CockpitJU_87B2.this.setNew.vspeed = ((499F * CockpitJU_87B2.this.setOld.vspeed) + CockpitJU_87B2.this.fm.getVertSpeed()) / 500F;
                if (CockpitJU_87B2.this.buzzerFX != null) {
                    if ((CockpitJU_87B2.this.fm.Loc.z < 750D) && (((JU_87) CockpitJU_87B2.this.fm.actor).diveMechStage == 1)) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitJU_87B2.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitJU_87B2.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zFuel1", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 250F, 0.0F, 5F), CockpitJU_87B2.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zCoolant1", this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 130F, 0.0F, 13F), CockpitJU_87B2.temperatureScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zOilTemp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 130F, 0.0F, 13F), CockpitJU_87B2.temperatureScale), 0.0F, 0.0F);
