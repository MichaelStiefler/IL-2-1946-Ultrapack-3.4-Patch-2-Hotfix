...
public class CockpitJU_87D3 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            CockpitJU_87D3.this.fm = World.getPlayerFM();
            if (CockpitJU_87D3.this.fm != null) {
                if (CockpitJU_87D3.this.bNeedSetUp) {
                    CockpitJU_87D3.this.reflectPlaneMats();
                    CockpitJU_87D3.this.bNeedSetUp = false;
                }
                CockpitJU_87D3.this.setTmp = CockpitJU_87D3.this.setOld;
                CockpitJU_87D3.this.setOld = CockpitJU_87D3.this.setNew;
                CockpitJU_87D3.this.setNew = CockpitJU_87D3.this.setTmp;
                CockpitJU_87D3.this.setNew.altimeter = CockpitJU_87D3.this.fm.getAltitude();
                if (CockpitJU_87D3.this.cockpitDimControl) {
                    if (CockpitJU_87D3.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_87D3.this.setNew.dimPosition = CockpitJU_87D3.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_87D3.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_87D3.this.setNew.dimPosition = CockpitJU_87D3.this.setOld.dimPosition + 0.05F;
                }
                CockpitJU_87D3.this.setNew.throttle = ((10F * CockpitJU_87D3.this.setOld.throttle) + CockpitJU_87D3.this.fm.CT.PowerControl) / 11F;
                float f = CockpitJU_87D3.this.waypointAzimuth();
                if (CockpitJU_87D3.this.useRealisticNavigationInstruments()) {
                    CockpitJU_87D3.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitJU_87D3.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitJU_87D3.this.setNew.waypointAzimuth.setDeg(CockpitJU_87D3.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_87D3.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitJU_87D3.this.fm.Or.getKren()) < 30F) {
                    CockpitJU_87D3.this.setNew.azimuth.setDeg(CockpitJU_87D3.this.setOld.azimuth.getDeg(1.0F), CockpitJU_87D3.this.fm.Or.azimut());
                }
                CockpitJU_87D3.this.w.set(CockpitJU_87D3.this.fm.getW());
                CockpitJU_87D3.this.fm.Or.transform(CockpitJU_87D3.this.w);
                CockpitJU_87D3.this.setNew.turn = ((12F * CockpitJU_87D3.this.setOld.turn) + CockpitJU_87D3.this.w.z) / 13F;
                CockpitJU_87D3.this.setNew.vspeed = ((499F * CockpitJU_87D3.this.setOld.vspeed) + CockpitJU_87D3.this.fm.getVertSpeed()) / 500F;
                if (CockpitJU_87D3.this.buzzerFX != null) {
                    if ((CockpitJU_87D3.this.fm.Loc.z < 750D) && (((JU_87) CockpitJU_87D3.this.fm.actor).diveMechStage == 1)) {
                        CockpitJU_87D3.this.buzzerFX.play();
                    } else if (CockpitJU_87D3.this.buzzerFX.isPlaying()) {
                        CockpitJU_87D3.this.buzzerFX.stop();
                    }
                }
                CockpitJU_87D3.this.setNew.beaconDirection = ((10F * CockpitJU_87D3.this.setOld.beaconDirection) + CockpitJU_87D3.this.getBeaconDirection()) / 11F;
                CockpitJU_87D3.this.setNew.beaconRange = ((10F * CockpitJU_87D3.this.setOld.beaconRange) + CockpitJU_87D3.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitJU_87D3.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitJU_87D3.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zFuel1", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 250F, 0.0F, 5F), CockpitJU_87D3.fuelScale), 0.0F, 0.0F);
...
//        if ((this.fm.AS.astateCockpitState & 0x40) == 0);
    ...
    protected void reflectPlaneMats() {
        if (Actor.isValid(this.fm.actor)) {
            if (this.fm.actor instanceof JU_87G1) {
