        ...
        public boolean tick() {
            ...
            if (CockpitJU_87D5.this.fm != null) {
                ...
                if (CockpitJU_87D5.this.cockpitDimControl) {
                    if (CockpitJU_87D5.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_87D5.this.setNew.dimPosition = CockpitJU_87D5.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_87D5.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_87D5.this.setNew.dimPosition = CockpitJU_87D5.this.setOld.dimPosition + 0.05F;
                }
                ...
                if (CockpitJU_87D5.this.useRealisticNavigationInstruments()) {
                    ...
                    CockpitJU_87D5.this.setNew.waypointAzimuth.setDeg(CockpitJU_87D5.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_87D5.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitJU_87D5.this.fm.Or.getKren()) < 30F) {
                ...
                if (CockpitJU_87D5.this.buzzerFX != null) {
                    if ((CockpitJU_87D5.this.fm.Loc.z < ((JU_87D5) CockpitJU_87D5.this.aircraft()).fDiveRecoveryAlt) && (((JU_87) CockpitJU_87D5.this.fm.actor).diveMechStage == 1)) {
...
//            }
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitJU_87D5.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zRPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitJU_87D5.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zFuel1", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 250F, 0.0F, 5F), CockpitJU_87D5.fuelScale), 0.0F, 0.0F);
