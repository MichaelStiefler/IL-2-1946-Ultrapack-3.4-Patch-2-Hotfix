...
public class CockpitJU_88A17 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitJU_88A17.this.fm != null) {
                CockpitJU_88A17.this.setTmp = CockpitJU_88A17.this.setOld;
                CockpitJU_88A17.this.setOld = CockpitJU_88A17.this.setNew;
                CockpitJU_88A17.this.setNew = CockpitJU_88A17.this.setTmp;
                ...
                float f = CockpitJU_88A17.this.waypointAzimuth();
                if (CockpitJU_88A17.this.useRealisticNavigationInstruments()) {
                    CockpitJU_88A17.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitJU_88A17.this.setOld.waypointAzimuth.setDeg(f - 90F);
                    CockpitJU_88A17.this.setNew.radioCompassAzimuth.setDeg(CockpitJU_88A17.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitJU_88A17.this.radioCompassAzimuthInvertMinus() - CockpitJU_88A17.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    CockpitJU_88A17.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A17.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88A17.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitJU_88A17.this.fm.Or.getKren()) < 30F) {
                ...
                CockpitJU_88A17.this.setNew.vspeed = ((199F * CockpitJU_88A17.this.setOld.vspeed) + CockpitJU_88A17.this.fm.getVertSpeed()) / 200F;
                if (CockpitJU_88A17.this.cockpitDimControl) {
                    if (CockpitJU_88A17.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_88A17.this.setNew.dimPosition = CockpitJU_88A17.this.setNew.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_88A17.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_88A17.this.setNew.dimPosition = CockpitJU_88A17.this.setNew.dimPosition + 0.05F;
                }
                float f1 = CockpitJU_88A17.this.prevFuel - CockpitJU_88A17.this.fm.M.fuel;
                CockpitJU_88A17.this.prevFuel = CockpitJU_88A17.this.fm.M.fuel;
                f1 /= 0.72F;
                f1 /= Time.tickLenFs();
                f1 *= 3600F;
                CockpitJU_88A17.this.setNew.cons = (0.91F * CockpitJU_88A17.this.setOld.cons) + (0.09F * f1);
            }
            CockpitJU_88A17.this.setNew.beaconDirection = ((10F * CockpitJU_88A17.this.setOld.beaconDirection) + CockpitJU_88A17.this.getBeaconDirection()) / 11F;
            CockpitJU_88A17.this.setNew.beaconRange = ((10F * CockpitJU_88A17.this.setOld.beaconRange) + CockpitJU_88A17.this.getBeaconRange()) / 11F;
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("TempMeter", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 213.09F, 293.09F, 0.0F, 8F), CockpitJU_88A17.frAirTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zAlt3", (((JU_88A17) this.aircraft()).fDiveRecoveryAlt * 360F) / 6000F, 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 750F, 0.0F, 14F), CockpitJU_88A17.speedometerScale), 0.0F, 0.0F);
        ...
        float f1 = ((JU_88A17) this.aircraft()).fAOB;
        float f2 = ((JU_88A17) this.aircraft()).fShipSpeed;
        float f3 = ((JU_88A17) this.aircraft()).FM.AS.getGyroAngle();
