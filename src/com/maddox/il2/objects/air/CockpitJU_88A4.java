...
public class CockpitJU_88A4 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (JU_88A4.bChangedPit) {
                CockpitJU_88A4.this.reflectPlaneToModel();
                JU_88A4.bChangedPit = false;
            }
            if (CockpitJU_88A4.this.fm != null) {
                CockpitJU_88A4.this.setTmp = CockpitJU_88A4.this.setOld;
                CockpitJU_88A4.this.setOld = CockpitJU_88A4.this.setNew;
                CockpitJU_88A4.this.setNew = CockpitJU_88A4.this.setTmp;
                ...
                float f = CockpitJU_88A4.this.waypointAzimuth();
                if (CockpitJU_88A4.this.useRealisticNavigationInstruments()) {
                    CockpitJU_88A4.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitJU_88A4.this.setOld.waypointAzimuth.setDeg(f - 90F);
                    CockpitJU_88A4.this.setNew.radioCompassAzimuth.setDeg(CockpitJU_88A4.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitJU_88A4.this.radioCompassAzimuthInvertMinus() - CockpitJU_88A4.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    CockpitJU_88A4.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A4.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88A4.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitJU_88A4.this.fm.Or.getKren()) < 30F) {
                ...
                CockpitJU_88A4.this.setNew.vspeed = ((199F * CockpitJU_88A4.this.setOld.vspeed) + CockpitJU_88A4.this.fm.getVertSpeed()) / 200F;
                if (CockpitJU_88A4.this.cockpitDimControl) {
                    if (CockpitJU_88A4.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_88A4.this.setNew.dimPosition = CockpitJU_88A4.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_88A4.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_88A4.this.setNew.dimPosition = CockpitJU_88A4.this.setOld.dimPosition + 0.05F;
                }
                float f1 = CockpitJU_88A4.this.prevFuel - CockpitJU_88A4.this.fm.M.fuel;
                CockpitJU_88A4.this.prevFuel = CockpitJU_88A4.this.fm.M.fuel;
                f1 /= 0.72F;
                f1 /= Time.tickLenFs();
                f1 *= 3600F;
                CockpitJU_88A4.this.setNew.cons = (0.91F * CockpitJU_88A4.this.setOld.cons) + (0.09F * f1);
                if (CockpitJU_88A4.this.buzzerFX != null) {
                    if ((CockpitJU_88A4.this.fm.Loc.z < ((JU_88A4) CockpitJU_88A4.this.aircraft()).fDiveRecoveryAlt) && (((JU_88A4) CockpitJU_88A4.this.fm.actor).diveMechStage == 1)) {
                        CockpitJU_88A4.this.buzzerFX.play();
                    } else if (CockpitJU_88A4.this.buzzerFX.isPlaying()) {
                        CockpitJU_88A4.this.buzzerFX.stop();
                    }
                }
                f1 = ((JU_88A4) CockpitJU_88A4.this.aircraft()).fDiveRecoveryAlt;
                float f2 = -(((JU_88A4) CockpitJU_88A4.this.aircraft()).fDiveVelocity * 0.27777F * (float) Math.sin(Math.toRadians(((JU_88A4) CockpitJU_88A4.this.aircraft()).fDiveAngle))) * 0.1019F;
                f2 += (float) Math.sqrt((f2 * f2) + (2.0F * f1 * 0.1019F));
                float f3 = ((JU_88A4) CockpitJU_88A4.this.aircraft()).fDiveVelocity * 0.27777F * (float) Math.cos(Math.toRadians(((JU_88A4) CockpitJU_88A4.this.aircraft()).fDiveAngle));
                float f4 = ((f3 * f2) + 10F) - 10F;
                CockpitJU_88A4.this.setNew.alpha = 90F - ((JU_88A4) CockpitJU_88A4.this.aircraft()).fDiveAngle - (float) Math.toDegrees(Math.atan(f4 / f1));
                CockpitJU_88A4.this.setNew.beaconDirection = ((10F * CockpitJU_88A4.this.setOld.beaconDirection) + CockpitJU_88A4.this.getBeaconDirection()) / 11F;
                CockpitJU_88A4.this.setNew.beaconRange = ((10F * CockpitJU_88A4.this.setOld.beaconRange) + CockpitJU_88A4.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("z_Object20", this.cvt(((JU_88A4) this.aircraft()).fSightCurSpeed, 400F, 800F, 87F, -63.5F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("TempMeter", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 213.09F, 293.09F, 0.0F, 8F), CockpitJU_88A4.frAirTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zAlt3", (((JU_88A4) this.aircraft()).fDiveRecoveryAlt * 360F) / 6000F, 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 750F, 0.0F, 14F), CockpitJU_88A4.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zSpeed2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 50F, 750F, 0.0F, 14F), CockpitJU_88A4.speedometerScale2), 0.0F, 0.0F);
