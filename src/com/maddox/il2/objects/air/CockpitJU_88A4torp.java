...
public class CockpitJU_88A4torp extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitJU_88A4torp.this.fm != null) {
                CockpitJU_88A4torp.this.setTmp = CockpitJU_88A4torp.this.setOld;
                CockpitJU_88A4torp.this.setOld = CockpitJU_88A4torp.this.setNew;
                CockpitJU_88A4torp.this.setNew = CockpitJU_88A4torp.this.setTmp;
                CockpitJU_88A4torp.this.setNew.throttle1 = (0.85F * CockpitJU_88A4torp.this.setOld.throttle1) + (CockpitJU_88A4torp.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitJU_88A4torp.this.setNew.prop1 = (0.85F * CockpitJU_88A4torp.this.setOld.prop1) + (CockpitJU_88A4torp.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitJU_88A4torp.this.setNew.throttle2 = (0.85F * CockpitJU_88A4torp.this.setOld.throttle2) + (CockpitJU_88A4torp.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitJU_88A4torp.this.setNew.prop2 = (0.85F * CockpitJU_88A4torp.this.setOld.prop2) + (CockpitJU_88A4torp.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitJU_88A4torp.this.setNew.altimeter = CockpitJU_88A4torp.this.fm.getAltitude();
                float f = CockpitJU_88A4torp.this.waypointAzimuth();
                if (CockpitJU_88A4torp.this.useRealisticNavigationInstruments()) {
                    CockpitJU_88A4torp.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitJU_88A4torp.this.setOld.waypointAzimuth.setDeg(f - 90F);
                    CockpitJU_88A4torp.this.setNew.radioCompassAzimuth.setDeg(CockpitJU_88A4torp.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitJU_88A4torp.this.radioCompassAzimuthInvertMinus() - CockpitJU_88A4torp.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    CockpitJU_88A4torp.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A4torp.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88A4torp.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitJU_88A4torp.this.fm.Or.getKren()) < 30F) {
                    CockpitJU_88A4torp.this.setNew.azimuth.setDeg(CockpitJU_88A4torp.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A4torp.this.fm.Or.azimut());
                }
                CockpitJU_88A4torp.this.setNew.vspeed = ((199F * CockpitJU_88A4torp.this.setOld.vspeed) + CockpitJU_88A4torp.this.fm.getVertSpeed()) / 200F;
                if (CockpitJU_88A4torp.this.cockpitDimControl) {
                    if (CockpitJU_88A4torp.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_88A4torp.this.setNew.dimPosition = CockpitJU_88A4torp.this.setNew.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_88A4torp.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_88A4torp.this.setNew.dimPosition = CockpitJU_88A4torp.this.setNew.dimPosition + 0.05F;
                }
                float f1 = CockpitJU_88A4torp.this.prevFuel - CockpitJU_88A4torp.this.fm.M.fuel;
                CockpitJU_88A4torp.this.prevFuel = CockpitJU_88A4torp.this.fm.M.fuel;
                f1 /= 0.72F;
                f1 /= Time.tickLenFs();
                f1 *= 3600F;
                CockpitJU_88A4torp.this.setNew.cons = (0.91F * CockpitJU_88A4torp.this.setOld.cons) + (0.09F * f1);
            }
            CockpitJU_88A4torp.this.setNew.beaconDirection = ((10F * CockpitJU_88A4torp.this.setOld.beaconDirection) + CockpitJU_88A4torp.this.getBeaconDirection()) / 11F;
            CockpitJU_88A4torp.this.setNew.beaconRange = ((10F * CockpitJU_88A4torp.this.setOld.beaconRange) + CockpitJU_88A4torp.this.getBeaconRange()) / 11F;
            return true;
        }
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            ...
            this.aircraft().hierMesh().chunkVisible("MGFF2", false);
    ...
    protected void doFocusLeave() {
        if (this.isFocused()) {
            ...
            this.aircraft().hierMesh().chunkVisible("MGFF2", true);
    ...
    public CockpitJU_88A4torp() {
        super("3DO/Cockpit/Ju-88A-4/hierA4torp.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("TempMeter", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 213.09F, 293.09F, 0.0F, 8F), CockpitJU_88A4torp.frAirTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zAlt3", (((JU_88A4torp) this.aircraft()).fDiveRecoveryAlt * 360F) / 6000F, 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 750F, 0.0F, 14F), CockpitJU_88A4torp.speedometerScale), 0.0F, 0.0F);
        ...
        float f1 = ((JU_88A4torp) this.aircraft()).fAOB;
        float f2 = ((JU_88A4torp) this.aircraft()).fShipSpeed;
        float f3 = ((JU_88A4torp) this.aircraft()).FM.AS.getGyroAngle();
