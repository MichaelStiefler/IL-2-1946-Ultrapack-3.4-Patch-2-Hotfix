...
public class CockpitJU_88A5 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (JU_88A5.bChangedPit) {
                CockpitJU_88A5.this.reflectPlaneToModel();
                JU_88A5.bChangedPit = false;
            }
            if (CockpitJU_88A5.this.fm != null) {
                CockpitJU_88A5.this.setTmp = CockpitJU_88A5.this.setOld;
                CockpitJU_88A5.this.setOld = CockpitJU_88A5.this.setNew;
                CockpitJU_88A5.this.setNew = CockpitJU_88A5.this.setTmp;
                CockpitJU_88A5.this.setNew.throttle1 = (0.85F * CockpitJU_88A5.this.setOld.throttle1) + (CockpitJU_88A5.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitJU_88A5.this.setNew.prop1 = (0.85F * CockpitJU_88A5.this.setOld.prop1) + (CockpitJU_88A5.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitJU_88A5.this.setNew.throttle2 = (0.85F * CockpitJU_88A5.this.setOld.throttle2) + (CockpitJU_88A5.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitJU_88A5.this.setNew.prop2 = (0.85F * CockpitJU_88A5.this.setOld.prop2) + (CockpitJU_88A5.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitJU_88A5.this.setNew.altimeter = CockpitJU_88A5.this.fm.getAltitude();
                float f = CockpitJU_88A5.this.waypointAzimuth();
                CockpitJU_88A5.this.setNew.waypointAzimuth.setDeg(CockpitJU_88A5.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88A5.this.setOld.azimuth.getDeg(1.0F));
                if (Math.abs(CockpitJU_88A5.this.fm.Or.getKren()) < 30F) {
                    CockpitJU_88A5.this.setNew.azimuth.setDeg(CockpitJU_88A5.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88A5.this.fm.Or.azimut());
                }
                CockpitJU_88A5.this.setNew.vspeed = ((199F * CockpitJU_88A5.this.setOld.vspeed) + CockpitJU_88A5.this.fm.getVertSpeed()) / 200F;
                if (CockpitJU_88A5.this.cockpitDimControl) {
                    if (CockpitJU_88A5.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_88A5.this.setNew.dimPosition = CockpitJU_88A5.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_88A5.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_88A5.this.setNew.dimPosition = CockpitJU_88A5.this.setOld.dimPosition + 0.05F;
                }
                float f1 = CockpitJU_88A5.this.prevFuel - CockpitJU_88A5.this.fm.M.fuel;
                CockpitJU_88A5.this.prevFuel = CockpitJU_88A5.this.fm.M.fuel;
                f1 /= 0.72F;
                f1 /= Time.tickLenFs();
                f1 *= 3600F;
                CockpitJU_88A5.this.setNew.cons = (0.91F * CockpitJU_88A5.this.setOld.cons) + (0.09F * f1);
                if (CockpitJU_88A5.this.buzzerFX != null) {
                    if ((CockpitJU_88A5.this.fm.Loc.z < ((JU_88A5) CockpitJU_88A5.this.aircraft()).fDiveRecoveryAlt) && (((JU_88A5) CockpitJU_88A5.this.fm.actor).diveMechStage == 1)) {
                        CockpitJU_88A5.this.buzzerFX.play();
                    } else if (CockpitJU_88A5.this.buzzerFX.isPlaying()) {
                        CockpitJU_88A5.this.buzzerFX.stop();
                    }
                }
                f1 = ((JU_88A5) CockpitJU_88A5.this.aircraft()).fDiveRecoveryAlt;
                float f2 = -(((JU_88A5) CockpitJU_88A5.this.aircraft()).fDiveVelocity * 0.27777F * (float) Math.sin(Math.toRadians(((JU_88A5) CockpitJU_88A5.this.aircraft()).fDiveAngle))) * 0.1019F;
                f2 += (float) Math.sqrt((f2 * f2) + (2.0F * f1 * 0.1019F));
                float f3 = ((JU_88A5) CockpitJU_88A5.this.aircraft()).fDiveVelocity * 0.27777F * (float) Math.cos(Math.toRadians(((JU_88A5) CockpitJU_88A5.this.aircraft()).fDiveAngle));
                float f4 = ((f3 * f2) + 10F) - 10F;
                CockpitJU_88A5.this.setNew.alpha = 90F - ((JU_88A5) CockpitJU_88A5.this.aircraft()).fDiveAngle - (float) Math.toDegrees(Math.atan(f4 / f1));
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("z_Object20", this.cvt(((JU_88A5) this.aircraft()).fSightCurSpeed, 400F, 800F, 87F, -63.5F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("TempMeter", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 213.09F, 293.09F, 0.0F, 8F), CockpitJU_88A5.frAirTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zAlt3", (((JU_88A5) this.aircraft()).fDiveRecoveryAlt * 360F) / 6000F, 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 750F, 0.0F, 14F), CockpitJU_88A5.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zSpeed2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 50F, 750F, 0.0F, 14F), CockpitJU_88A5.speedometerScale2), 0.0F, 0.0F);
