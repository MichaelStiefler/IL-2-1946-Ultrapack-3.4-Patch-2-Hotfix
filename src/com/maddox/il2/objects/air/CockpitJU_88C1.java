...
public class CockpitJU_88C1 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (JU_88C1.bChangedPit) {
                CockpitJU_88C1.this.reflectPlaneToModel();
                JU_88C1.bChangedPit = false;
            }
            if (CockpitJU_88C1.this.fm != null) {
                CockpitJU_88C1.this.setTmp = CockpitJU_88C1.this.setOld;
                CockpitJU_88C1.this.setOld = CockpitJU_88C1.this.setNew;
                CockpitJU_88C1.this.setNew = CockpitJU_88C1.this.setTmp;
                CockpitJU_88C1.this.setNew.throttle1 = (0.85F * CockpitJU_88C1.this.setOld.throttle1) + (CockpitJU_88C1.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitJU_88C1.this.setNew.prop1 = (0.85F * CockpitJU_88C1.this.setOld.prop1) + (CockpitJU_88C1.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitJU_88C1.this.setNew.throttle2 = (0.85F * CockpitJU_88C1.this.setOld.throttle2) + (CockpitJU_88C1.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitJU_88C1.this.setNew.prop2 = (0.85F * CockpitJU_88C1.this.setOld.prop2) + (CockpitJU_88C1.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitJU_88C1.this.setNew.altimeter = CockpitJU_88C1.this.fm.getAltitude();
                float f = CockpitJU_88C1.this.waypointAzimuth();
                CockpitJU_88C1.this.setNew.waypointAzimuth.setDeg(CockpitJU_88C1.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88C1.this.setOld.azimuth.getDeg(1.0F));
                if (Math.abs(CockpitJU_88C1.this.fm.Or.getKren()) < 30F) {
                    CockpitJU_88C1.this.setNew.azimuth.setDeg(CockpitJU_88C1.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88C1.this.fm.Or.azimut());
                }
                CockpitJU_88C1.this.setNew.vspeed = ((199F * CockpitJU_88C1.this.setOld.vspeed) + CockpitJU_88C1.this.fm.getVertSpeed()) / 200F;
                if (CockpitJU_88C1.this.cockpitDimControl) {
                    if (CockpitJU_88C1.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_88C1.this.setNew.dimPosition = CockpitJU_88C1.this.setNew.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_88C1.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_88C1.this.setNew.dimPosition = CockpitJU_88C1.this.setNew.dimPosition + 0.05F;
                }
                float f1 = CockpitJU_88C1.this.prevFuel - CockpitJU_88C1.this.fm.M.fuel;
                CockpitJU_88C1.this.prevFuel = CockpitJU_88C1.this.fm.M.fuel;
                f1 /= 0.72F;
                f1 /= Time.tickLenFs();
                f1 *= 3600F;
                CockpitJU_88C1.this.setNew.cons = (0.91F * CockpitJU_88C1.this.setOld.cons) + (0.09F * f1);
            }
            return true;
        }
    ...
    public CockpitJU_88C1() {
        super("3DO/Cockpit/Ju-88C-2/hier_C1.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("TempMeter", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 213.09F, 293.09F, 0.0F, 8F), CockpitJU_88C1.frAirTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 750F, 0.0F, 14F), CockpitJU_88C1.speedometerScale), 0.0F, 0.0F);
