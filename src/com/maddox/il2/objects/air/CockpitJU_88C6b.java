...
public class CockpitJU_88C6b extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitJU_88C6b.this.fm != null) {
                ...
                if (Math.abs(CockpitJU_88C6b.this.fm.Or.getKren()) < 30F) {
                ...
                if (CockpitJU_88C6b.this.cockpitDimControl) {
                    if (CockpitJU_88C6b.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_88C6b.this.setNew.dimPosition = CockpitJU_88C6b.this.setNew.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_88C6b.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_88C6b.this.setNew.dimPosition = CockpitJU_88C6b.this.setNew.dimPosition + 0.05F;
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("TempMeter", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 213.09F, 293.09F, 0.0F, 8F), CockpitJU_88C6b.frAirTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 750F, 0.0F, 14F), CockpitJU_88C6b.speedometerScale), 0.0F, 0.0F);
