...
public class CockpitJU_88G6 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (JU_88G6.bChangedPit) {
                JU_88G6.bChangedPit = false;
            }
            if (CockpitJU_88G6.this.fm != null) {
                CockpitJU_88G6.this.setTmp = CockpitJU_88G6.this.setOld;
                CockpitJU_88G6.this.setOld = CockpitJU_88G6.this.setNew;
                CockpitJU_88G6.this.setNew = CockpitJU_88G6.this.setTmp;
                CockpitJU_88G6.this.setNew.throttle1 = (0.85F * CockpitJU_88G6.this.setOld.throttle1) + (CockpitJU_88G6.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitJU_88G6.this.setNew.prop1 = (0.85F * CockpitJU_88G6.this.setOld.prop1) + (CockpitJU_88G6.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitJU_88G6.this.setNew.throttle2 = (0.85F * CockpitJU_88G6.this.setOld.throttle2) + (CockpitJU_88G6.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitJU_88G6.this.setNew.prop2 = (0.85F * CockpitJU_88G6.this.setOld.prop2) + (CockpitJU_88G6.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitJU_88G6.this.setNew.altimeter = CockpitJU_88G6.this.fm.getAltitude();
                float f = CockpitJU_88G6.this.waypointAzimuth();
                if (CockpitJU_88G6.this.useRealisticNavigationInstruments()) {
                    CockpitJU_88G6.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitJU_88G6.this.setOld.waypointAzimuth.setDeg(f - 90F);
                    CockpitJU_88G6.this.setNew.radioCompassAzimuth.setDeg(CockpitJU_88G6.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitJU_88G6.this.radioCompassAzimuthInvertMinus() - CockpitJU_88G6.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    CockpitJU_88G6.this.setNew.waypointAzimuth.setDeg(CockpitJU_88G6.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88G6.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitJU_88G6.this.fm.Or.getKren()) < 30F) {
                    CockpitJU_88G6.this.setNew.azimuth.setDeg(CockpitJU_88G6.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88G6.this.fm.Or.azimut());
                }
                CockpitJU_88G6.this.setNew.vspeed = ((199F * CockpitJU_88G6.this.setOld.vspeed) + CockpitJU_88G6.this.fm.getVertSpeed()) / 200F;
                if (CockpitJU_88G6.this.cockpitDimControl) {
                    if (CockpitJU_88G6.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_88G6.this.setNew.dimPosition = CockpitJU_88G6.this.setNew.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_88G6.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_88G6.this.setNew.dimPosition = CockpitJU_88G6.this.setNew.dimPosition + 0.05F;
                }
                float f1 = CockpitJU_88G6.this.prevFuel - CockpitJU_88G6.this.fm.M.fuel;
                CockpitJU_88G6.this.prevFuel = CockpitJU_88G6.this.fm.M.fuel;
                f1 /= 0.72F;
                f1 /= Time.tickLenFs();
                f1 *= 3600F;
                CockpitJU_88G6.this.setNew.cons = (0.91F * CockpitJU_88G6.this.setOld.cons) + (0.09F * f1);
            }
            CockpitJU_88G6.this.setNew.beaconDirection = ((10F * CockpitJU_88G6.this.setOld.beaconDirection) + CockpitJU_88G6.this.getBeaconDirection()) / 11F;
            CockpitJU_88G6.this.setNew.beaconRange = ((10F * CockpitJU_88G6.this.setOld.beaconRange) + CockpitJU_88G6.this.getBeaconRange()) / 11F;
            return true;
        }
    ...
    public CockpitJU_88G6() {
        super("3DO/Cockpit/Ju-88G-6/G6hier.him", "he111");
        ...
        this.pictManf2 = 1.0F;
        this.prevFuel = 0.0F;
        this.cockpitNightMats = (new String[] { "88a4_I_Set1", "88a4_I_Set2", "88a4_I_Set3", "88a4_I_Set4", "88a4_I_Set5", "88a4_I_Set6", "88a4_I_SetEng", "88a4_SlidingGlass", "88gardinen", "88InstrGenrl", "Peil1", "skala", "Pedal", "Peil2", "PeilNeedle", "radar_glass" });
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("TempMeter", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 213.09F, 293.09F, 0.0F, 8F), CockpitJU_88G6.frAirTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 750F, 0.0F, 14F), CockpitJU_88G6.speedometerScale), 0.0F, 0.0F);
