...
public class CockpitJU_88GStechmucke extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitJU_88GStechmucke.this.fm != null) {
                ...
                CockpitJU_88GStechmucke.this.setOld = CockpitJU_88GStechmucke.this.setNew;
                CockpitJU_88GStechmucke.this.setNew = CockpitJU_88GStechmucke.this.setTmp;
                CockpitJU_88GStechmucke.this.setNew.throttle1 = (0.85F * CockpitJU_88GStechmucke.this.setOld.throttle1) + (CockpitJU_88GStechmucke.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitJU_88GStechmucke.this.setNew.prop1 = (0.85F * CockpitJU_88GStechmucke.this.setOld.prop1) + (CockpitJU_88GStechmucke.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitJU_88GStechmucke.this.setNew.throttle2 = (0.85F * CockpitJU_88GStechmucke.this.setOld.throttle2) + (CockpitJU_88GStechmucke.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitJU_88GStechmucke.this.setNew.prop2 = (0.85F * CockpitJU_88GStechmucke.this.setOld.prop2) + (CockpitJU_88GStechmucke.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitJU_88GStechmucke.this.setNew.altimeter = CockpitJU_88GStechmucke.this.fm.getAltitude();
                float f = CockpitJU_88GStechmucke.this.waypointAzimuth();
                CockpitJU_88GStechmucke.this.setNew.waypointAzimuth.setDeg(CockpitJU_88GStechmucke.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88GStechmucke.this.setOld.azimuth.getDeg(1.0F));
                if (Math.abs(CockpitJU_88GStechmucke.this.fm.Or.getKren()) < 30F) {
                    CockpitJU_88GStechmucke.this.setNew.azimuth.setDeg(CockpitJU_88GStechmucke.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88GStechmucke.this.fm.Or.azimut());
                }
                CockpitJU_88GStechmucke.this.setNew.vspeed = ((199F * CockpitJU_88GStechmucke.this.setOld.vspeed) + CockpitJU_88GStechmucke.this.fm.getVertSpeed()) / 200F;
                if (CockpitJU_88GStechmucke.this.cockpitDimControl) {
                    if (CockpitJU_88GStechmucke.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_88GStechmucke.this.setNew.dimPosition = CockpitJU_88GStechmucke.this.setNew.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_88GStechmucke.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_88GStechmucke.this.setNew.dimPosition = CockpitJU_88GStechmucke.this.setNew.dimPosition + 0.05F;
                }
                float f1 = CockpitJU_88GStechmucke.this.prevFuel - CockpitJU_88GStechmucke.this.fm.M.fuel;
                CockpitJU_88GStechmucke.this.prevFuel = CockpitJU_88GStechmucke.this.fm.M.fuel;
                f1 /= 0.72F;
                f1 /= Time.tickLenFs();
                f1 *= 3600F;
                CockpitJU_88GStechmucke.this.setNew.cons = (0.91F * CockpitJU_88GStechmucke.this.setOld.cons) + (0.09F * f1);
            }
            return true;
        }
    ...
    public CockpitJU_88GStechmucke() {
        super("3DO/Cockpit/Ju-88GStechmucke/GMHhier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("TempMeter", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 213.09F, 293.09F, 0.0F, 8F), CockpitJU_88GStechmucke.frAirTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 750F, 0.0F, 14F), CockpitJU_88GStechmucke.speedometerScale), 0.0F, 0.0F);
