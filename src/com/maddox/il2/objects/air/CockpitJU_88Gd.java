...
public class CockpitJU_88Gd extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (JU_88G1d.bChangedPit) {
                CockpitJU_88Gd.this.reflectPlaneToModel();
                JU_88G1d.bChangedPit = false;
            }
            if (CockpitJU_88Gd.this.fm != null) {
                CockpitJU_88Gd.this.setTmp = CockpitJU_88Gd.this.setOld;
                CockpitJU_88Gd.this.setOld = CockpitJU_88Gd.this.setNew;
                CockpitJU_88Gd.this.setNew = CockpitJU_88Gd.this.setTmp;
                CockpitJU_88Gd.this.setNew.throttle1 = (0.85F * CockpitJU_88Gd.this.setOld.throttle1) + (CockpitJU_88Gd.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitJU_88Gd.this.setNew.prop1 = (0.85F * CockpitJU_88Gd.this.setOld.prop1) + (CockpitJU_88Gd.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitJU_88Gd.this.setNew.throttle2 = (0.85F * CockpitJU_88Gd.this.setOld.throttle2) + (CockpitJU_88Gd.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitJU_88Gd.this.setNew.prop2 = (0.85F * CockpitJU_88Gd.this.setOld.prop2) + (CockpitJU_88Gd.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitJU_88Gd.this.setNew.altimeter = CockpitJU_88Gd.this.fm.getAltitude();
                float f = CockpitJU_88Gd.this.waypointAzimuth();
                CockpitJU_88Gd.this.setNew.waypointAzimuth.setDeg(CockpitJU_88Gd.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitJU_88Gd.this.setOld.azimuth.getDeg(1.0F));
                if (Math.abs(CockpitJU_88Gd.this.fm.Or.getKren()) < 30F) {
                    CockpitJU_88Gd.this.setNew.azimuth.setDeg(CockpitJU_88Gd.this.setOld.azimuth.getDeg(1.0F), CockpitJU_88Gd.this.fm.Or.azimut());
                }
                CockpitJU_88Gd.this.setNew.vspeed = ((199F * CockpitJU_88Gd.this.setOld.vspeed) + CockpitJU_88Gd.this.fm.getVertSpeed()) / 200F;
                if (CockpitJU_88Gd.this.cockpitDimControl) {
                    if (CockpitJU_88Gd.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_88Gd.this.setNew.dimPosition = CockpitJU_88Gd.this.setNew.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_88Gd.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_88Gd.this.setNew.dimPosition = CockpitJU_88Gd.this.setNew.dimPosition + 0.05F;
                }
                float f1 = CockpitJU_88Gd.this.prevFuel - CockpitJU_88Gd.this.fm.M.fuel;
                CockpitJU_88Gd.this.prevFuel = CockpitJU_88Gd.this.fm.M.fuel;
                f1 /= 0.72F;
                f1 /= Time.tickLenFs();
                f1 *= 3600F;
                CockpitJU_88Gd.this.setNew.cons = (0.91F * CockpitJU_88Gd.this.setOld.cons) + (0.09F * f1);
            }
            return true;
        }
    ...
    public CockpitJU_88Gd() {
        super("3DO/Cockpit/Ju-88Gd/GMHhier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("TempMeter", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 213.09F, 293.09F, 0.0F, 8F), CockpitJU_88Gd.frAirTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zAlt3", (((JU_88G1d) this.aircraft()).fDiveRecoveryAlt * 360F) / 6000F, 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 750F, 0.0F, 14F), CockpitJU_88Gd.speedometerScale), 0.0F, 0.0F);
