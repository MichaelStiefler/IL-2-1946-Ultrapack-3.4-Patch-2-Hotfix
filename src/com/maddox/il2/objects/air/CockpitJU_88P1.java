...
public class CockpitJU_88P1 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitJU_88P1.this.fm != null) {
                ...
                if (Math.abs(CockpitJU_88P1.this.fm.Or.getKren()) < 30F) {
                ...
                if (CockpitJU_88P1.this.cockpitDimControl) {
                    if (CockpitJU_88P1.this.setNew.dimPosition > 0.0F) {
                        CockpitJU_88P1.this.setNew.dimPosition = CockpitJU_88P1.this.setNew.dimPosition - 0.05F;
                    }
                } else if (CockpitJU_88P1.this.setNew.dimPosition < 1.0F) {
                    CockpitJU_88P1.this.setNew.dimPosition = CockpitJU_88P1.this.setNew.dimPosition + 0.05F;
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("TempMeter", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 213.09F, 293.09F, 0.0F, 8F), CockpitJU_88P1.frAirTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 750F, 0.0F, 14F), CockpitJU_88P1.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Climb1", this.cvt(this.setNew.vspeed, -15F, 15F, -151F, 151F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zWaterTemp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 120F, 0.0F, 3F), CockpitJU_88P1.waterTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zWaterTemp2", this.floatindex(this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 120F, 0.0F, 3F), CockpitJU_88P1.waterTempScale), 0.0F, 0.0F);
