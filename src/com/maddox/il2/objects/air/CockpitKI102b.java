...
public class CockpitKI102b extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitKI102b.this.bNeedSetUp) {
                CockpitKI102b.this.bNeedSetUp = false;
                CockpitKI102b.this.reflectPlaneMats();
            }
            CockpitKI102b.this.setTmp = CockpitKI102b.this.setOld;
            CockpitKI102b.this.setOld = CockpitKI102b.this.setNew;
            CockpitKI102b.this.setNew = CockpitKI102b.this.setTmp;
            if (((CockpitKI102b.this.fm.AS.astateCockpitState & 2) != 0) && (CockpitKI102b.this.setNew.ironSight < 1.0F)) {
                CockpitKI102b.this.setNew.ironSight = CockpitKI102b.this.setOld.ironSight + 0.0125F;
                CockpitKI102b.this.setOld.ironSight = CockpitKI102b.this.setNew.ironSight;
            }
            CockpitKI102b.this.setNew.altimeter = CockpitKI102b.this.fm.getAltitude();
            if (CockpitKI102b.this.cockpitDimControl) {
                if ((CockpitKI102b.this.setNew.dimPosition > 0.0F) && (CockpitKI102b.this.setNew.ironSight == 0.0F)) {
                    CockpitKI102b.this.setNew.dimPosition = CockpitKI102b.this.setNew.dimPosition - 0.05F;
                }
            } else if ((CockpitKI102b.this.setNew.dimPosition < 1.0F) && (CockpitKI102b.this.setNew.ironSight == 0.0F)) {
                CockpitKI102b.this.setNew.dimPosition = CockpitKI102b.this.setNew.dimPosition + 0.05F;
            }
            CockpitKI102b.this.setNew.throttle1 = (0.91F * CockpitKI102b.this.setOld.throttle1) + (0.09F * CockpitKI102b.this.fm.EI.engines[0].getControlThrottle());
            CockpitKI102b.this.setNew.throttle2 = (0.91F * CockpitKI102b.this.setOld.throttle2) + (0.09F * CockpitKI102b.this.fm.EI.engines[1].getControlThrottle());
            CockpitKI102b.this.setNew.mix1 = (0.88F * CockpitKI102b.this.setOld.mix1) + (0.12F * CockpitKI102b.this.fm.EI.engines[0].getControlMix());
            CockpitKI102b.this.setNew.mix2 = (0.88F * CockpitKI102b.this.setOld.mix2) + (0.12F * CockpitKI102b.this.fm.EI.engines[1].getControlMix());
            if (Math.abs(CockpitKI102b.this.fm.Or.getKren()) < 30F) {
                CockpitKI102b.this.setNew.azimuth.setDeg(CockpitKI102b.this.setOld.azimuth.getDeg(1.0F), -CockpitKI102b.this.fm.Or.azimut() - 90F);
            }
            CockpitKI102b.this.w.set(CockpitKI102b.this.fm.getW());
            CockpitKI102b.this.fm.Or.transform(CockpitKI102b.this.w);
            CockpitKI102b.this.setNew.turn = ((12F * CockpitKI102b.this.setOld.turn) + CockpitKI102b.this.w.z) / 13F;
            CockpitKI102b.this.setNew.vspeed = ((199F * CockpitKI102b.this.setOld.vspeed) + CockpitKI102b.this.fm.getVertSpeed()) / 200F;
            CockpitKI102b.this.setNew.manifold1 = (0.8F * CockpitKI102b.this.setOld.manifold1) + (0.2F * CockpitKI102b.this.fm.EI.engines[0].getManifoldPressure());
            CockpitKI102b.this.setNew.manifold2 = (0.8F * CockpitKI102b.this.setOld.manifold2) + (0.2F * CockpitKI102b.this.fm.EI.engines[1].getManifoldPressure());
            float f = 30F;
            for (int i = 0; i < 2; i++) {
                if ((CockpitKI102b.this.cowlFlapsLever[i] != 0.0F) && (CockpitKI102b.this.cowlFlaps[i] == CockpitKI102b.this.fm.EI.engines[i].getControlRadiator())) {
                    CockpitKI102b.this.cowlFlapsLever[i] = CockpitKI102b.this.cowlFlapsLever[i] * 0.8F;
                    if (Math.abs(CockpitKI102b.this.cowlFlapsLever[i]) < 0.1F) {
                        CockpitKI102b.this.cowlFlapsLever[i] = 0.0F;
                    }
                } else if (CockpitKI102b.this.cowlFlaps[i] < CockpitKI102b.this.fm.EI.engines[i].getControlRadiator()) {
                    CockpitKI102b.this.cowlFlaps[i] = CockpitKI102b.this.fm.EI.engines[i].getControlRadiator();
                    CockpitKI102b.this.cowlFlapsLever[i] = CockpitKI102b.this.cowlFlapsLever[i] + 2.0F;
                    if (CockpitKI102b.this.cowlFlapsLever[i] > f) {
                        CockpitKI102b.this.cowlFlapsLever[i] = f;
                    }
                } else if (CockpitKI102b.this.cowlFlaps[i] > CockpitKI102b.this.fm.EI.engines[i].getControlRadiator()) {
                    CockpitKI102b.this.cowlFlaps[i] = CockpitKI102b.this.fm.EI.engines[i].getControlRadiator();
                    CockpitKI102b.this.cowlFlapsLever[i] = CockpitKI102b.this.cowlFlapsLever[i] - 2.0F;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Need_Climb", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 12F), CockpitKI102b.variometerScale), 0.0F);
        this.mesh.chunkSetAngles("Z_Need_AirSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 700F, 0.0F, 14F), CockpitKI102b.speedometerScale), 0.0F);
    ...
    static {
        Property.set(CockpitKI102b.class, "normZNs", new float[] { 0.7F, 0.7F, 0.8F, 0.7F });
    }
}
