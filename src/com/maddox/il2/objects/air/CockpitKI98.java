...
public class CockpitKI98 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitKI98.this.fm != null) {
                CockpitKI98.this.setTmp = CockpitKI98.this.setOld;
                CockpitKI98.this.setOld = CockpitKI98.this.setNew;
                CockpitKI98.this.setNew = CockpitKI98.this.setTmp;
                CockpitKI98.this.setNew.flap = (0.88F * CockpitKI98.this.setOld.flap) + (0.12F * CockpitKI98.this.fm.CT.FlapsControl);
                CockpitKI98.this.setNew.tlock = (0.7F * CockpitKI98.this.setOld.tlock) + (0.3F * (CockpitKI98.this.fm.Gears.bTailwheelLocked ? 1.0F : 0.0F));
                if (CockpitKI98.this.cockpitDimControl) {
                    if (CockpitKI98.this.setNew.dimPosition > 0.0F) {
                        CockpitKI98.this.setNew.dimPosition = CockpitKI98.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitKI98.this.setNew.dimPosition < 1.0F) {
                    CockpitKI98.this.setNew.dimPosition = CockpitKI98.this.setOld.dimPosition + 0.05F;
                }
                if ((CockpitKI98.this.fm.AS.astateCockpitState & 2) != 0) {
                    if (CockpitKI98.this.setNew.stbyPosition > 0.0F) {
                        CockpitKI98.this.setNew.stbyPosition = CockpitKI98.this.setOld.stbyPosition - 0.025F;
                    }
                } else if (CockpitKI98.this.setNew.stbyPosition < 1.0F) {
                    CockpitKI98.this.setNew.stbyPosition = CockpitKI98.this.setOld.stbyPosition + 0.025F;
                }
                if ((CockpitKI98.this.fm.CT.GearControl < 0.5F) && (CockpitKI98.this.setNew.gear < 1.0F)) {
                    CockpitKI98.this.setNew.gear = CockpitKI98.this.setOld.gear + 0.02F;
                }
                if ((CockpitKI98.this.fm.CT.GearControl > 0.5F) && (CockpitKI98.this.setNew.gear > 0.0F)) {
                    CockpitKI98.this.setNew.gear = CockpitKI98.this.setOld.gear - 0.02F;
                }
                CockpitKI98.this.setNew.throttle = (0.9F * CockpitKI98.this.setOld.throttle) + (0.1F * CockpitKI98.this.fm.CT.PowerControl);
                CockpitKI98.this.setNew.manifold = (0.8F * CockpitKI98.this.setOld.manifold) + (0.2F * CockpitKI98.this.fm.EI.engines[0].getManifoldPressure());
                CockpitKI98.this.setNew.pitch = (0.9F * CockpitKI98.this.setOld.pitch) + (0.1F * CockpitKI98.this.fm.EI.engines[0].getControlProp());
                CockpitKI98.this.setNew.mix = (0.9F * CockpitKI98.this.setOld.mix) + (0.1F * CockpitKI98.this.fm.EI.engines[0].getControlMix());
                CockpitKI98.this.setNew.altimeter = CockpitKI98.this.fm.getAltitude();
                if (Math.abs(CockpitKI98.this.fm.Or.getKren()) < 30F) {
                    CockpitKI98.this.setNew.azimuth.setDeg(CockpitKI98.this.setOld.azimuth.getDeg(1.0F), CockpitKI98.this.fm.Or.azimut());
                }
                float f = CockpitKI98.this.waypointAzimuth();
                CockpitKI98.this.setNew.waypointAzimuth.setDeg(CockpitKI98.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitKI98.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-3F, 3F));
                CockpitKI98.this.setNew.vspeed = ((199F * CockpitKI98.this.setOld.vspeed) + CockpitKI98.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitKI98() {
        super("3DO/Cockpit/ki-98/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedOilTemp", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 110F, 0.0F, 8F), CockpitKI98.oilTScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedRPM", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitKI98.revolutionsScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 740.7998F, 0.0F, 20F), CockpitKI98.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedExternalT", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 233.09F, 333.09F, 0.0F, 5F), CockpitKI98.frAirTempScale), 0.0F, 0.0F);
