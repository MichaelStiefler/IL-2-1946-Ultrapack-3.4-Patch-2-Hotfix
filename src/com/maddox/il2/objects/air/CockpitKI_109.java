...
public class CockpitKI_109 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitKI_109.this.fm != null) {
                CockpitKI_109.this.setTmp = CockpitKI_109.this.setOld;
                CockpitKI_109.this.setOld = CockpitKI_109.this.setNew;
                CockpitKI_109.this.setNew = CockpitKI_109.this.setTmp;
                CockpitKI_109.this.setNew.throttle1 = (0.9F * CockpitKI_109.this.setOld.throttle1) + (0.1F * CockpitKI_109.this.fm.EI.engines[0].getControlThrottle());
                CockpitKI_109.this.setNew.prop1 = (0.9F * CockpitKI_109.this.setOld.prop1) + (0.1F * CockpitKI_109.this.fm.EI.engines[0].getControlProp());
                CockpitKI_109.this.setNew.mix1 = (0.8F * CockpitKI_109.this.setOld.mix1) + (0.2F * CockpitKI_109.this.fm.EI.engines[0].getControlMix());
                CockpitKI_109.this.setNew.throttle2 = (0.9F * CockpitKI_109.this.setOld.throttle2) + (0.1F * CockpitKI_109.this.fm.EI.engines[1].getControlThrottle());
                CockpitKI_109.this.setNew.prop2 = (0.9F * CockpitKI_109.this.setOld.prop2) + (0.1F * CockpitKI_109.this.fm.EI.engines[1].getControlProp());
                CockpitKI_109.this.setNew.mix2 = (0.8F * CockpitKI_109.this.setOld.mix2) + (0.2F * CockpitKI_109.this.fm.EI.engines[1].getControlMix());
                CockpitKI_109.this.setNew.man1 = (0.92F * CockpitKI_109.this.setOld.man1) + (0.08F * CockpitKI_109.this.fm.EI.engines[0].getManifoldPressure());
                CockpitKI_109.this.setNew.man2 = (0.92F * CockpitKI_109.this.setOld.man2) + (0.08F * CockpitKI_109.this.fm.EI.engines[1].getManifoldPressure());
                CockpitKI_109.this.setNew.altimeter = CockpitKI_109.this.fm.getAltitude();
                if (Math.abs(CockpitKI_109.this.fm.Or.getKren()) < 30F) {
                    CockpitKI_109.this.setNew.azimuth.setDeg(CockpitKI_109.this.setOld.azimuth.getDeg(1.0F), CockpitKI_109.this.fm.Or.azimut());
                }
                CockpitKI_109.this.setNew.vspeed = ((199F * CockpitKI_109.this.setOld.vspeed) + CockpitKI_109.this.fm.getVertSpeed()) / 200F;
                if (CockpitKI_109.this.useRealisticNavigationInstruments()) {
                    CockpitKI_109.this.setNew.waypointAzimuth.setDeg(CockpitKI_109.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitKI_109.this.waypointAzimuth());
                } else {
                    CockpitKI_109.this.setNew.waypointAzimuth.setDeg(CockpitKI_109.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitKI_109.this.fm.Or.azimut() + 90F);
                }
                CockpitKI_109.this.setNew.beaconDirection = ((10F * CockpitKI_109.this.setOld.beaconDirection) + CockpitKI_109.this.getBeaconDirection()) / 11F;
                CockpitKI_109.this.setNew.beaconRange = ((10F * CockpitKI_109.this.setOld.beaconRange) + CockpitKI_109.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public CockpitKI_109() {
        super("3DO/Cockpit/Ki109/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        float f2 = this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitKI_109.speedometerScale);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitKI_109.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitKI_109.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitKI_109.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitKI_109.rpmScale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitKI_109.class, "normZNs", new float[] { 1.47F, 1.1F, 0.86F, 0.8F });
    }
