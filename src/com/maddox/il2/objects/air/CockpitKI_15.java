...
public class CockpitKI_15 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitKI_15.this.fm != null) {
                CockpitKI_15.this.setTmp = CockpitKI_15.this.setOld;
                CockpitKI_15.this.setOld = CockpitKI_15.this.setNew;
                CockpitKI_15.this.setNew = CockpitKI_15.this.setTmp;
                CockpitKI_15.this.setNew.flap = (0.88F * CockpitKI_15.this.setOld.flap) + (0.12F * CockpitKI_15.this.fm.CT.FlapsControl);
                if (CockpitKI_15.this.cockpitDimControl) {
                    if (CockpitKI_15.this.setNew.dimPosition > 0.0F) {
                        CockpitKI_15.this.setOld.dimPosition -= 0.05F;
                    } else if (CockpitKI_15.this.setNew.dimPosition < 1.0F) {
                        CockpitKI_15.this.setOld.dimPosition += 0.05F;
                    }
                }
                CockpitKI_15.this.setNew.throttle = (0.9F * CockpitKI_15.this.setOld.throttle) + (0.1F * CockpitKI_15.this.fm.CT.PowerControl);
                CockpitKI_15.this.setNew.manifold = (0.8F * CockpitKI_15.this.setOld.manifold) + (0.2F * CockpitKI_15.this.fm.EI.engines[0].getManifoldPressure());
                CockpitKI_15.this.setNew.pitch = (0.9F * CockpitKI_15.this.setOld.pitch) + (0.1F * CockpitKI_15.this.fm.EI.engines[0].getControlProp());
                CockpitKI_15.this.setNew.mix = (0.9F * CockpitKI_15.this.setOld.mix) + (0.1F * CockpitKI_15.this.fm.EI.engines[0].getControlMix());
                CockpitKI_15.this.setNew.altimeter = CockpitKI_15.this.fm.getAltitude();
                if (Math.abs(CockpitKI_15.this.fm.Or.getKren()) < 30F) {
                    CockpitKI_15.this.setNew.azimuth.setDeg(CockpitKI_15.this.setOld.azimuth.getDeg(1.0F), CockpitKI_15.this.fm.Or.azimut());
                }
                float f = CockpitKI_15.this.waypointAzimuth();
                CockpitKI_15.this.setNew.waypointAzimuth.setDeg(CockpitKI_15.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitKI_15.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-3F, 3F));
                CockpitKI_15.this.setNew.vspeed = ((199F * CockpitKI_15.this.setOld.vspeed) + CockpitKI_15.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitKI_15() {
        super("3DO/Cockpit/Ki-15-P/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.pictAiler = (0.85F * this.pictAiler) + (0.15F * this.fm.CT.AileronControl);
        this.mesh.chunkSetAngles("FLCS", this.pictAiler * 20F, 0.0F, 20F * (this.pictElev = (0.85F * this.pictElev) + (0.15F * this.fm.CT.ElevatorControl)));
        ...
        this.mesh.chunkSetAngles("NeedFuelA", this.cvt(this.fm.M.fuel, 100F, 555F, 0.0F, 290F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedFuelB", this.cvt(this.fm.M.fuel, 0.0F, 100F, 0.0F, 153F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedOilTemp", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 110F, 0.0F, 8F), CockpitKI_15.oilTScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedRPM", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitKI_15.revolutionsScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 740.7998F, 0.0F, 20F), CockpitKI_15.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedExternalT", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 233.09F, 333.09F, 0.0F, 5F), CockpitKI_15.frAirTempScale), 0.0F, 0.0F);
        if ((this.fm.AS.astateCockpitState & 0x10) == 0) {
            this.mesh.chunkSetAngles("NeedDF", this.cvt(this.setNew.waypointAzimuth.getDeg(f), -90F, 90F, -33F, 33F), 0.0F, 0.0F);
        }
        this.mesh.chunkVisible("FlareBoostRed", this.fm.M.fuel > 50F);
        this.mesh.chunkVisible("FlareBoostGreen", this.fm.M.fuel < 50.1F);
    }
