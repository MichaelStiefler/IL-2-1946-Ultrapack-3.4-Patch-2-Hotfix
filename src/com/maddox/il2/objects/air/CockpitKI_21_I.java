...
public class CockpitKI_21_I extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitKI_21_I.this.fm != null) {
                CockpitKI_21_I.this.setTmp = CockpitKI_21_I.this.setOld;
                CockpitKI_21_I.this.setOld = CockpitKI_21_I.this.setNew;
                CockpitKI_21_I.this.setNew = CockpitKI_21_I.this.setTmp;
                CockpitKI_21_I.this.setNew.throttle1 = (0.9F * CockpitKI_21_I.this.setOld.throttle1) + (0.1F * CockpitKI_21_I.this.fm.EI.engines[0].getControlThrottle());
                CockpitKI_21_I.this.setNew.prop1 = (0.9F * CockpitKI_21_I.this.setOld.prop1) + (0.1F * CockpitKI_21_I.this.fm.EI.engines[0].getControlProp());
                CockpitKI_21_I.this.setNew.mix1 = (0.8F * CockpitKI_21_I.this.setOld.mix1) + (0.2F * CockpitKI_21_I.this.fm.EI.engines[0].getControlMix());
                CockpitKI_21_I.this.setNew.throttle2 = (0.9F * CockpitKI_21_I.this.setOld.throttle2) + (0.1F * CockpitKI_21_I.this.fm.EI.engines[1].getControlThrottle());
                CockpitKI_21_I.this.setNew.prop2 = (0.9F * CockpitKI_21_I.this.setOld.prop2) + (0.1F * CockpitKI_21_I.this.fm.EI.engines[1].getControlProp());
                CockpitKI_21_I.this.setNew.mix2 = (0.8F * CockpitKI_21_I.this.setOld.mix2) + (0.2F * CockpitKI_21_I.this.fm.EI.engines[1].getControlMix());
                CockpitKI_21_I.this.setNew.man1 = (0.92F * CockpitKI_21_I.this.setOld.man1) + (0.08F * CockpitKI_21_I.this.fm.EI.engines[0].getManifoldPressure());
                CockpitKI_21_I.this.setNew.man2 = (0.92F * CockpitKI_21_I.this.setOld.man2) + (0.08F * CockpitKI_21_I.this.fm.EI.engines[1].getManifoldPressure());
                CockpitKI_21_I.this.setNew.altimeter = CockpitKI_21_I.this.fm.getAltitude();
                if (Math.abs(CockpitKI_21_I.this.fm.Or.getKren()) < 30F) {
                    CockpitKI_21_I.this.setNew.azimuth.setDeg(CockpitKI_21_I.this.setOld.azimuth.getDeg(1.0F), CockpitKI_21_I.this.fm.Or.azimut());
                }
                CockpitKI_21_I.this.setNew.vspeed = ((199F * CockpitKI_21_I.this.setOld.vspeed) + CockpitKI_21_I.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitKI_21_I() {
        super("3DO/Cockpit/KI21SAS/CockpitKI21I.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitKI_21_I.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitKI_21_I.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitKI_21_I.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitKI_21_I.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitKI_21_I.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitKI_21_I.rpmScale), 0.0F, 0.0F);
