...
public class CockpitKI_27KO extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitKI_27KO.this.fm != null) {
                CockpitKI_27KO.this.setTmp = CockpitKI_27KO.this.setOld;
                CockpitKI_27KO.this.setOld = CockpitKI_27KO.this.setNew;
                CockpitKI_27KO.this.setNew = CockpitKI_27KO.this.setTmp;
                if (CockpitKI_27KO.this.cockpitDimControl) {
                    if (CockpitKI_27KO.this.setNew.dimPos < 1.0F) {
                        CockpitKI_27KO.this.setNew.dimPos = CockpitKI_27KO.this.setOld.dimPos + 0.03F;
                    }
                } else if (CockpitKI_27KO.this.setNew.dimPos > 0.0F) {
                    CockpitKI_27KO.this.setNew.dimPos = CockpitKI_27KO.this.setOld.dimPos - 0.03F;
                }
                CockpitKI_27KO.this.setNew.manifold = (0.8F * CockpitKI_27KO.this.setOld.manifold) + (0.2F * CockpitKI_27KO.this.fm.EI.engines[0].getManifoldPressure());
                CockpitKI_27KO.this.setNew.throttle = (0.8F * CockpitKI_27KO.this.setOld.throttle) + (0.2F * CockpitKI_27KO.this.fm.CT.PowerControl);
                CockpitKI_27KO.this.setNew.prop = (0.8F * CockpitKI_27KO.this.setOld.prop) + (0.2F * CockpitKI_27KO.this.fm.EI.engines[0].getControlProp());
                CockpitKI_27KO.this.setNew.mix = (0.8F * CockpitKI_27KO.this.setOld.mix) + (0.2F * CockpitKI_27KO.this.fm.EI.engines[0].getControlMix());
                CockpitKI_27KO.this.setNew.man = (0.92F * CockpitKI_27KO.this.setOld.man) + (0.08F * CockpitKI_27KO.this.fm.EI.engines[0].getManifoldPressure());
                CockpitKI_27KO.this.setNew.altimeter = CockpitKI_27KO.this.fm.getAltitude();
                float f = CockpitKI_27KO.this.waypointAzimuth();
                if (Math.abs(CockpitKI_27KO.this.fm.Or.getKren()) < 30F) {
                    CockpitKI_27KO.this.setNew.azimuth.setDeg(CockpitKI_27KO.this.setOld.azimuth.getDeg(1.0F), CockpitKI_27KO.this.fm.Or.azimut());
                }
                CockpitKI_27KO.this.setNew.waypointDeviation.setDeg(CockpitKI_27KO.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitKI_27KO.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-5F, 5F));
                CockpitKI_27KO.this.setNew.waypointAzimuth.setDeg(CockpitKI_27KO.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitKI_27KO.this.setNew.vspeed = (0.5F * CockpitKI_27KO.this.setOld.vspeed) + (0.5F * CockpitKI_27KO.this.fm.getVertSpeed());
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (KI_27.bChangedPit) {
            this.reflectPlaneToModel();
            KI_27.bChangedPit = false;
        }
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitKI_27KO.speedometerScale), 0.0F, 0.0F);
