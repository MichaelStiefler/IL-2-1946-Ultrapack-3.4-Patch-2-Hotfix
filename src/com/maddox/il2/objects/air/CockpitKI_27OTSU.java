...
public class CockpitKI_27OTSU extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitKI_27OTSU.this.fm != null) {
                CockpitKI_27OTSU.this.setTmp = CockpitKI_27OTSU.this.setOld;
                CockpitKI_27OTSU.this.setOld = CockpitKI_27OTSU.this.setNew;
                CockpitKI_27OTSU.this.setNew = CockpitKI_27OTSU.this.setTmp;
                if (CockpitKI_27OTSU.this.cockpitDimControl) {
                    if (CockpitKI_27OTSU.this.setNew.dimPos < 1.0F) {
                        CockpitKI_27OTSU.this.setNew.dimPos = CockpitKI_27OTSU.this.setOld.dimPos + 0.03F;
                    }
                } else if (CockpitKI_27OTSU.this.setNew.dimPos > 0.0F) {
                    CockpitKI_27OTSU.this.setNew.dimPos = CockpitKI_27OTSU.this.setOld.dimPos - 0.03F;
                }
                ...
                if (Math.abs(CockpitKI_27OTSU.this.fm.Or.getKren()) < 30F) {
                ...
                CockpitKI_27OTSU.this.setNew.waypointDeviation.setDeg(CockpitKI_27OTSU.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitKI_27OTSU.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-5F, 5F));
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitKI_27OTSU.speedometerScale), 0.0F, 0.0F);
