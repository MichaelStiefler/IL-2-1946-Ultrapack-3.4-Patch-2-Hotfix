...
public class CockpitKI_43_II extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitKI_43_II.this.fm != null) {
                CockpitKI_43_II.this.setTmp = CockpitKI_43_II.this.setOld;
                CockpitKI_43_II.this.setOld = CockpitKI_43_II.this.setNew;
                CockpitKI_43_II.this.setNew = CockpitKI_43_II.this.setTmp;
                if (CockpitKI_43_II.this.cockpitDimControl) {
                    if (CockpitKI_43_II.this.setNew.dimPos < 1.0F) {
                        CockpitKI_43_II.this.setNew.dimPos = CockpitKI_43_II.this.setOld.dimPos + 0.03F;
                    }
                } else if (CockpitKI_43_II.this.setNew.dimPos > 0.0F) {
                    CockpitKI_43_II.this.setNew.dimPos = CockpitKI_43_II.this.setOld.dimPos - 0.03F;
                }
                if ((CockpitKI_43_II.this.fm.AS.astateCockpitState & 2) != 0) {
                    CockpitKI_43_II.this.setNew.emdimPos = CockpitKI_43_II.this.setOld.emdimPos + 0.03F;
                    if (CockpitKI_43_II.this.setNew.emdimPos > 1.0F) {
                        CockpitKI_43_II.this.setNew.emdimPos = 1.0F;
                    }
                }
                CockpitKI_43_II.this.setNew.manifold = (0.8F * CockpitKI_43_II.this.setOld.manifold) + (0.2F * CockpitKI_43_II.this.fm.EI.engines[0].getManifoldPressure());
                CockpitKI_43_II.this.setNew.throttle = (0.8F * CockpitKI_43_II.this.setOld.throttle) + (0.2F * CockpitKI_43_II.this.fm.CT.PowerControl);
                CockpitKI_43_II.this.setNew.prop = (0.8F * CockpitKI_43_II.this.setOld.prop) + (0.2F * CockpitKI_43_II.this.fm.EI.engines[0].getControlProp());
                CockpitKI_43_II.this.setNew.mix = (0.8F * CockpitKI_43_II.this.setOld.mix) + (0.2F * CockpitKI_43_II.this.fm.EI.engines[0].getControlMix());
                CockpitKI_43_II.this.setNew.man = (0.92F * CockpitKI_43_II.this.setOld.man) + (0.08F * CockpitKI_43_II.this.fm.EI.engines[0].getManifoldPressure());
                CockpitKI_43_II.this.setNew.altimeter = CockpitKI_43_II.this.fm.getAltitude();
                float f = CockpitKI_43_II.this.waypointAzimuth();
                if (Math.abs(CockpitKI_43_II.this.fm.Or.getKren()) < 30F) {
                    CockpitKI_43_II.this.setNew.azimuth.setDeg(CockpitKI_43_II.this.setOld.azimuth.getDeg(1.0F), CockpitKI_43_II.this.fm.Or.azimut());
                }
                CockpitKI_43_II.this.setNew.waypointDeviation.setDeg(CockpitKI_43_II.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitKI_43_II.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-5F, 5F));
                CockpitKI_43_II.this.setNew.waypointAzimuth.setDeg(CockpitKI_43_II.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitKI_43_II.this.setNew.vspeed = (0.5F * CockpitKI_43_II.this.setOld.vspeed) + (0.5F * CockpitKI_43_II.this.fm.getVertSpeed());
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 700F, 0.0F, 14F), CockpitKI_43_II.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", 0.0F, this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3200F, 0.0F, 360F), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Fuel1", this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.26F, 0.0F, 1.0F, 0.0F, -360F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Gunpres1", 0.0F, 148F, 0.0F);
