...
public class CockpitKI_43_IIKAI extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitKI_43_IIKAI.this.fm != null) {
                CockpitKI_43_IIKAI.this.setTmp = CockpitKI_43_IIKAI.this.setOld;
                CockpitKI_43_IIKAI.this.setOld = CockpitKI_43_IIKAI.this.setNew;
                CockpitKI_43_IIKAI.this.setNew = CockpitKI_43_IIKAI.this.setTmp;
                if (CockpitKI_43_IIKAI.this.cockpitDimControl) {
                    if (CockpitKI_43_IIKAI.this.setNew.dimPos < 1.0F) {
                        CockpitKI_43_IIKAI.this.setNew.dimPos = CockpitKI_43_IIKAI.this.setOld.dimPos + 0.03F;
                    }
                } else if (CockpitKI_43_IIKAI.this.setNew.dimPos > 0.0F) {
                    CockpitKI_43_IIKAI.this.setNew.dimPos = CockpitKI_43_IIKAI.this.setOld.dimPos - 0.03F;
                }
                if ((CockpitKI_43_IIKAI.this.fm.AS.astateCockpitState & 2) != 0) {
                ...
                if (Math.abs(CockpitKI_43_IIKAI.this.fm.Or.getKren()) < 30F) {
                ...
                CockpitKI_43_IIKAI.this.setNew.waypointDeviation.setDeg(CockpitKI_43_IIKAI.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitKI_43_IIKAI.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-5F, 5F));
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 700F, 0.0F, 14F), CockpitKI_43_IIKAI.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Fuel4", this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.26F, 0.0F, 1.0F, 0.0F, -330F), 0.0F, 0.0F);
