...
public class CockpitKI_45 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitKI_45.this.cockpitDimControl) {
                if ((CockpitKI_45.this.setNew.dimPosition > 0.0F) && (CockpitKI_45.this.setNew.ironSight == 0.0F)) {
                    CockpitKI_45.this.setNew.dimPosition = CockpitKI_45.this.setNew.dimPosition - 0.05F;
                }
            } else if ((CockpitKI_45.this.setNew.dimPosition < 1.0F) && (CockpitKI_45.this.setNew.ironSight == 0.0F)) {
                CockpitKI_45.this.setNew.dimPosition = CockpitKI_45.this.setNew.dimPosition + 0.05F;
            }
            ...
            if (Math.abs(CockpitKI_45.this.fm.Or.getKren()) < 30F) {
            ...
            for (int i = 0; i < 2; i++) {
                if ((CockpitKI_45.this.cowlFlapsLever[i] != 0.0F) && (CockpitKI_45.this.cowlFlaps[i] == CockpitKI_45.this.fm.EI.engines[i].getControlRadiator())) {
                    ...
                    if (Math.abs(CockpitKI_45.this.cowlFlapsLever[i]) < 0.1F) {
                        CockpitKI_45.this.cowlFlapsLever[i] = 0.0F;
                    }
                    ...
                    if (CockpitKI_45.this.cowlFlapsLever[i] > f) {
                        CockpitKI_45.this.cowlFlapsLever[i] = f;
                    }
                } else if (CockpitKI_45.this.cowlFlaps[i] > CockpitKI_45.this.fm.EI.engines[i].getControlRadiator()) {
                    CockpitKI_45.this.cowlFlaps[i] = CockpitKI_45.this.fm.EI.engines[i].getControlRadiator();
                    CockpitKI_45.this.cowlFlapsLever[i] = CockpitKI_45.this.cowlFlapsLever[i] - 2.0F;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Need_Climb", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 12F), CockpitKI_45.variometerScale), 0.0F);
        this.mesh.chunkSetAngles("Z_Need_AirSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 700F, 0.0F, 14F), CockpitKI_45.speedometerScale), 0.0F);
        ...
        if (!this.ac.sideWindow) {
            ...
            this.mesh.chunkSetAngles("Z_LCanopy", 0.0F, this.floatindex(this.cvt(f2, 0.0F, 80F, 0.0F, 8F), CockpitKI_45.canopyScale), 0.0F);
        } else {
            Aircraft.xyz[0] = 0.0F;
            Aircraft.xyz[2] = 0.0F;
            Aircraft.ypr[0] = 0.0F;
            ...
            if (this.isSlideRight) {
                this.mesh.chunkSetLocate("Z_RSlideWindow", Aircraft.xyz, Aircraft.ypr);
            } else {
                this.mesh.chunkSetLocate("Z_LSlideWindow", Aircraft.xyz, Aircraft.ypr);
            }
        }
    }
