...
public class CockpitKI_46_OTSU extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitKI_46_OTSU.this.fm != null) {
                CockpitKI_46_OTSU.this.setTmp = CockpitKI_46_OTSU.this.setOld;
                CockpitKI_46_OTSU.this.setOld = CockpitKI_46_OTSU.this.setNew;
                CockpitKI_46_OTSU.this.setNew = CockpitKI_46_OTSU.this.setTmp;
                CockpitKI_46_OTSU.this.setNew.flap = (0.88F * CockpitKI_46_OTSU.this.setOld.flap) + (0.12F * CockpitKI_46_OTSU.this.fm.CT.FlapsControl);
                CockpitKI_46_OTSU.this.setNew.tlock = (0.7F * CockpitKI_46_OTSU.this.setOld.tlock) + (0.3F * (CockpitKI_46_OTSU.this.fm.Gears.bTailwheelLocked ? 1.0F : 0.0F));
                if (CockpitKI_46_OTSU.this.cockpitDimControl) {
                    if (CockpitKI_46_OTSU.this.setNew.dimPosition > 0.0F) {
                        CockpitKI_46_OTSU.this.setNew.dimPosition = CockpitKI_46_OTSU.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitKI_46_OTSU.this.setNew.dimPosition < 1.0F) {
                    CockpitKI_46_OTSU.this.setNew.dimPosition = CockpitKI_46_OTSU.this.setOld.dimPosition + 0.05F;
                }
                if ((CockpitKI_46_OTSU.this.fm.CT.GearControl < 0.5F) && (CockpitKI_46_OTSU.this.setNew.gear < 1.0F)) {
                    CockpitKI_46_OTSU.this.setNew.gear = CockpitKI_46_OTSU.this.setOld.gear + 0.02F;
                }
                if ((CockpitKI_46_OTSU.this.fm.CT.GearControl > 0.5F) && (CockpitKI_46_OTSU.this.setNew.gear > 0.0F)) {
                    CockpitKI_46_OTSU.this.setNew.gear = CockpitKI_46_OTSU.this.setOld.gear - 0.02F;
                }
                CockpitKI_46_OTSU.this.setNew.throttle = (0.9F * CockpitKI_46_OTSU.this.setOld.throttle) + (0.1F * CockpitKI_46_OTSU.this.fm.CT.PowerControl);
                CockpitKI_46_OTSU.this.setNew.manifold = (0.8F * CockpitKI_46_OTSU.this.setOld.manifold) + (0.2F * CockpitKI_46_OTSU.this.fm.EI.engines[0].getManifoldPressure());
                CockpitKI_46_OTSU.this.setNew.pitch = (0.9F * CockpitKI_46_OTSU.this.setOld.pitch) + (0.1F * CockpitKI_46_OTSU.this.fm.EI.engines[0].getControlProp());
                CockpitKI_46_OTSU.this.setNew.mix = (0.9F * CockpitKI_46_OTSU.this.setOld.mix) + (0.1F * CockpitKI_46_OTSU.this.fm.EI.engines[0].getControlMix());
                CockpitKI_46_OTSU.this.setNew.altimeter = CockpitKI_46_OTSU.this.fm.getAltitude();
                if (Math.abs(CockpitKI_46_OTSU.this.fm.Or.getKren()) < 30F) {
                    CockpitKI_46_OTSU.this.setNew.azimuth.setDeg(CockpitKI_46_OTSU.this.setOld.azimuth.getDeg(1.0F), CockpitKI_46_OTSU.this.fm.Or.azimut());
                }
                CockpitKI_46_OTSU.this.setNew.vspeed = ((199F * CockpitKI_46_OTSU.this.setOld.vspeed) + CockpitKI_46_OTSU.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitKI_46_OTSU() {
        super("3DO/Cockpit/Ki-46/CockpitKI_46_OTSU.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedClimb", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.5F, 6.5F), CockpitKI_46_OTSU.vsiNeedleScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1000F, 0.0F, 20F), CockpitKI_46_OTSU.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedRPM", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitKI_46_OTSU.revolutionsScale), 0.0F, 0.0F);
