...
public class CockpitKI_48 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitKI_48.this.fm != null) {
                ...
                if (Math.abs(CockpitKI_48.this.fm.Or.getKren()) < 30F) {
    ...
    public CockpitKI_48() {
        ...
        this.pictAiler = 0.0F;
        this.pictElev = 0.0F;
        this.cockpitNightMats = new String[] { "Pressure_Gauges", "Needs_Instr", "maininstrumentspanel4", "instructions", "instru_main_pan", "instru_main_pan2", "instru_main_pan3", "dmaininstrumentspanel4", "dinstru_main_pan", "dinstru_main_pan2", "dinstru_main_pan3", "GP1_d1", "GP1", "GP7", "GP9" };
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Need_Climb", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 12F), CockpitKI_48.variometerScale), 0.0F);
        this.mesh.chunkSetAngles("Z_Need_AirSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 700F, 0.0F, 14F), CockpitKI_48.speedometerScale), 0.0F);
    ...
    public void toggleLight() {
        ...
        if (this.cockpitLightControl) {
            ...
            if ((this.light1 != null) && (this.light1.light != null)) {
                this.light1.light.setEmit(1.0F, 0.5F);
            }
            if ((this.light2 != null) && (this.light2.light != null)) {
                this.light2.light.setEmit(1.0F, 0.5F);
            }
            if ((this.light3 != null) && (this.light3.light != null)) {
                this.light3.light.setEmit(1.0F, 0.5F);
            }
            if ((this.light4 != null) && (this.light4.light != null)) {
