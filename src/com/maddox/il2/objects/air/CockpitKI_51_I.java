...
public class CockpitKI_51_I extends CockpitPilot {
        ...
        public boolean tick() {
            if (CockpitKI_51_I.this.fm != null) {
                ...
                if (CockpitKI_51_I.this.cockpitDimControl) {
                    if (CockpitKI_51_I.this.setNew.dimPos < 1.0F) {
                        CockpitKI_51_I.this.setNew.dimPos = CockpitKI_51_I.this.setOld.dimPos + 0.03F;
                    }
                } else if (CockpitKI_51_I.this.setNew.dimPos > 0.0F) {
                    CockpitKI_51_I.this.setNew.dimPos = CockpitKI_51_I.this.setOld.dimPos - 0.03F;
                }
                ...
                if (Math.abs(CockpitKI_51_I.this.fm.Or.getKren()) < 30F) {
    ...
    public CockpitKI_51_I() {
        ...
        this.bEntered = false;
        this.cockpitNightMats = new String[] { "gauges1_d1", "gauges1", "gauges2_d1", "gauges2", "gauges3_d1", "gauges3", "gauges4_d1", "gauges4", "gauges5", "gauges6", "gauges7", "turnbank_d1", "turnbank", "Fuel", "gauge1_D1", "gauge1", "gauge2_D2", "gauge2", "gauge3", "gauge4_D4", "gauge4", "gauge" };
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1000F, 0.0F, 20F), CockpitKI_51_I.speedometerScale), 0.0F, 0.0F);
        this.w.set(this.fm.getW());
        this.mesh.chunkSetAngles("Z_Compass2", -this.setNew.azimuth.getDeg(f), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.5F, 6.5F), CockpitKI_51_I.vsiNeedleScale), 0.0F, 0.0F);
