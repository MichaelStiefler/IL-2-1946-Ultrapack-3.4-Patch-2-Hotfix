...
public class CockpitKI_67_I extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitKI_67_I.this.fm != null) {
                CockpitKI_67_I.this.setTmp = CockpitKI_67_I.this.setOld;
                CockpitKI_67_I.this.setOld = CockpitKI_67_I.this.setNew;
                CockpitKI_67_I.this.setNew = CockpitKI_67_I.this.setTmp;
                CockpitKI_67_I.this.setNew.throttle1 = (0.9F * CockpitKI_67_I.this.setOld.throttle1) + (0.1F * CockpitKI_67_I.this.fm.EI.engines[0].getControlThrottle());
                CockpitKI_67_I.this.setNew.prop1 = (0.9F * CockpitKI_67_I.this.setOld.prop1) + (0.1F * CockpitKI_67_I.this.fm.EI.engines[0].getControlProp());
                CockpitKI_67_I.this.setNew.mix1 = (0.8F * CockpitKI_67_I.this.setOld.mix1) + (0.2F * CockpitKI_67_I.this.fm.EI.engines[0].getControlMix());
                CockpitKI_67_I.this.setNew.throttle2 = (0.9F * CockpitKI_67_I.this.setOld.throttle2) + (0.1F * CockpitKI_67_I.this.fm.EI.engines[1].getControlThrottle());
                CockpitKI_67_I.this.setNew.prop2 = (0.9F * CockpitKI_67_I.this.setOld.prop2) + (0.1F * CockpitKI_67_I.this.fm.EI.engines[1].getControlProp());
                CockpitKI_67_I.this.setNew.mix2 = (0.8F * CockpitKI_67_I.this.setOld.mix2) + (0.2F * CockpitKI_67_I.this.fm.EI.engines[1].getControlMix());
                CockpitKI_67_I.this.setNew.man1 = (0.92F * CockpitKI_67_I.this.setOld.man1) + (0.08F * CockpitKI_67_I.this.fm.EI.engines[0].getManifoldPressure());
                CockpitKI_67_I.this.setNew.man2 = (0.92F * CockpitKI_67_I.this.setOld.man2) + (0.08F * CockpitKI_67_I.this.fm.EI.engines[1].getManifoldPressure());
                CockpitKI_67_I.this.setNew.altimeter = CockpitKI_67_I.this.fm.getAltitude();
                if (Math.abs(CockpitKI_67_I.this.fm.Or.getKren()) < 30F) {
                    CockpitKI_67_I.this.setNew.azimuth.setDeg(CockpitKI_67_I.this.setOld.azimuth.getDeg(1.0F), CockpitKI_67_I.this.fm.Or.azimut());
                }
                CockpitKI_67_I.this.setNew.vspeed = ((199F * CockpitKI_67_I.this.setOld.vspeed) + CockpitKI_67_I.this.fm.getVertSpeed()) / 200F;
                if (CockpitKI_67_I.this.useRealisticNavigationInstruments()) {
                    CockpitKI_67_I.this.setNew.waypointAzimuth.setDeg(CockpitKI_67_I.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitKI_67_I.this.waypointAzimuth());
                } else {
                    CockpitKI_67_I.this.setNew.waypointAzimuth.setDeg(CockpitKI_67_I.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitKI_67_I.this.fm.Or.azimut() + 90F);
                }
                CockpitKI_67_I.this.setNew.beaconDirection = ((10F * CockpitKI_67_I.this.setOld.beaconDirection) + CockpitKI_67_I.this.getBeaconDirection()) / 11F;
                CockpitKI_67_I.this.setNew.beaconRange = ((10F * CockpitKI_67_I.this.setOld.beaconRange) + CockpitKI_67_I.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public CockpitKI_67_I() {
        super("3DO/Cockpit/Ki67-I/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        float f2 = this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitKI_67_I.speedometerScale);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitKI_67_I.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitKI_67_I.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitKI_67_I.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitKI_67_I.rpmScale), 0.0F, 0.0F);
