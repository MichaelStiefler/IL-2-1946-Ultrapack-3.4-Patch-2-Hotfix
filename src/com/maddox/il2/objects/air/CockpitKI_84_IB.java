...
public class CockpitKI_84_IB extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitKI_84_IB.this.fm != null) {
                CockpitKI_84_IB.this.setTmp = CockpitKI_84_IB.this.setOld;
                CockpitKI_84_IB.this.setOld = CockpitKI_84_IB.this.setNew;
                CockpitKI_84_IB.this.setNew = CockpitKI_84_IB.this.setTmp;
                ...
                if (CockpitKI_84_IB.this.cockpitDimControl) {
                    if (CockpitKI_84_IB.this.setNew.dimPosition > 0.0F) {
                        CockpitKI_84_IB.this.setNew.dimPosition = CockpitKI_84_IB.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitKI_84_IB.this.setNew.dimPosition < 1.0F) {
                    CockpitKI_84_IB.this.setNew.dimPosition = CockpitKI_84_IB.this.setOld.dimPosition + 0.05F;
                }
                ...
                if (Math.abs(CockpitKI_84_IB.this.fm.Or.getKren()) < 30F) {
                ...
                CockpitKI_84_IB.this.setNew.vspeed = ((199F * CockpitKI_84_IB.this.setOld.vspeed) + CockpitKI_84_IB.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedClimb", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.5F, 6.5F), CockpitKI_84_IB.vsiNeedleScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1000F, 0.0F, 20F), CockpitKI_84_IB.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedRPM", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitKI_84_IB.revolutionsScale), 0.0F, 0.0F);
