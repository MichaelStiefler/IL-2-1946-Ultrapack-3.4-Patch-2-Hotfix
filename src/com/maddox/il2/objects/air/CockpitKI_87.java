...
public class CockpitKI_87 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitKI_87.this.fm != null) {
                CockpitKI_87.this.setTmp = CockpitKI_87.this.setOld;
                CockpitKI_87.this.setOld = CockpitKI_87.this.setNew;
                CockpitKI_87.this.setNew = CockpitKI_87.this.setTmp;
                CockpitKI_87.this.setNew.flap = (0.88F * CockpitKI_87.this.setOld.flap) + (0.12F * CockpitKI_87.this.fm.CT.FlapsControl);
                CockpitKI_87.this.setNew.tlock = (0.7F * CockpitKI_87.this.setOld.tlock) + (0.3F * (CockpitKI_87.this.fm.Gears.bTailwheelLocked ? 1.0F : 0.0F));
                if (CockpitKI_87.this.cockpitDimControl) {
                    if (CockpitKI_87.this.setNew.dimPosition > 0.0F) {
                        CockpitKI_87.this.setNew.dimPosition = CockpitKI_87.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitKI_87.this.setNew.dimPosition < 1.0F) {
                    CockpitKI_87.this.setNew.dimPosition = CockpitKI_87.this.setOld.dimPosition + 0.05F;
                }
                if ((CockpitKI_87.this.fm.CT.GearControl < 0.5F) && (CockpitKI_87.this.setNew.gear < 1.0F)) {
                    CockpitKI_87.this.setNew.gear = CockpitKI_87.this.setOld.gear + 0.02F;
                }
                if ((CockpitKI_87.this.fm.CT.GearControl > 0.5F) && (CockpitKI_87.this.setNew.gear > 0.0F)) {
                    CockpitKI_87.this.setNew.gear = CockpitKI_87.this.setOld.gear - 0.02F;
                }
                CockpitKI_87.this.setNew.throttle = (0.9F * CockpitKI_87.this.setOld.throttle) + (0.1F * CockpitKI_87.this.fm.CT.PowerControl);
                CockpitKI_87.this.setNew.manifold = (0.8F * CockpitKI_87.this.setOld.manifold) + (0.2F * CockpitKI_87.this.fm.EI.engines[0].getManifoldPressure());
                CockpitKI_87.this.setNew.pitch = (0.9F * CockpitKI_87.this.setOld.pitch) + (0.1F * CockpitKI_87.this.fm.EI.engines[0].getControlProp());
                CockpitKI_87.this.setNew.mix = (0.9F * CockpitKI_87.this.setOld.mix) + (0.1F * CockpitKI_87.this.fm.EI.engines[0].getControlMix());
                CockpitKI_87.this.setNew.altimeter = CockpitKI_87.this.fm.getAltitude();
                if (Math.abs(CockpitKI_87.this.fm.Or.getKren()) < 30F) {
                    CockpitKI_87.this.setNew.azimuth.setDeg(CockpitKI_87.this.setOld.azimuth.getDeg(1.0F), CockpitKI_87.this.fm.Or.azimut());
                }
                CockpitKI_87.this.setNew.vspeed = ((199F * CockpitKI_87.this.setOld.vspeed) + CockpitKI_87.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitKI_87() {
        super("3DO/Cockpit/Ki-87/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedClimb", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.5F, 6.5F), CockpitKI_87.vsiNeedleScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1000F, 0.0F, 20F), CockpitKI_87.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedRPM", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitKI_87.revolutionsScale), 0.0F, 0.0F);
