...
public class CockpitKi36 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitKi36.this.fm != null) {
                CockpitKi36.this.setTmp = CockpitKi36.this.setOld;
                CockpitKi36.this.setOld = CockpitKi36.this.setNew;
                CockpitKi36.this.setNew = CockpitKi36.this.setTmp;
                if (CockpitKi36.this.cockpitDimControl) {
                    if (CockpitKi36.this.setNew.dimPos < 1.0F) {
                        CockpitKi36.this.setNew.dimPos = CockpitKi36.this.setOld.dimPos + 0.03F;
                    }
                } else if (CockpitKi36.this.setNew.dimPos > 0.0F) {
                    CockpitKi36.this.setNew.dimPos = CockpitKi36.this.setOld.dimPos - 0.03F;
                }
                CockpitKi36.this.setNew.throttle = (0.8F * CockpitKi36.this.setOld.throttle) + (0.2F * CockpitKi36.this.fm.CT.PowerControl);
                CockpitKi36.this.setNew.prop = (0.8F * CockpitKi36.this.setOld.prop) + (0.2F * CockpitKi36.this.fm.EI.engines[0].getControlProp());
                CockpitKi36.this.setNew.mix = (0.8F * CockpitKi36.this.setOld.mix) + (0.2F * CockpitKi36.this.fm.EI.engines[0].getControlMix());
                CockpitKi36.this.setNew.man = (0.92F * CockpitKi36.this.setOld.man) + (0.08F * CockpitKi36.this.fm.EI.engines[0].getManifoldPressure());
                CockpitKi36.this.setNew.altimeter = CockpitKi36.this.fm.getAltitude();
                float f = CockpitKi36.this.waypointAzimuth();
                if (Math.abs(CockpitKi36.this.fm.Or.getKren()) < 30F) {
                    CockpitKi36.this.setNew.azimuth.setDeg(CockpitKi36.this.setOld.azimuth.getDeg(1.0F), CockpitKi36.this.fm.Or.azimut());
                }
                CockpitKi36.this.setNew.waypointDeviation.setDeg(CockpitKi36.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitKi36.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-5F, 5F));
                CockpitKi36.this.setNew.waypointAzimuth.setDeg(CockpitKi36.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitKi36.this.setNew.vspeed = (0.5F * CockpitKi36.this.setOld.vspeed) + (0.5F * CockpitKi36.this.fm.getVertSpeed());
                CockpitKi36.this.mesh.chunkSetAngles("Turret1A_D0", 0.0F, -CockpitKi36.this.aircraft().FM.turret[0].tu[0], 0.0F);
                CockpitKi36.this.mesh.chunkSetAngles("Turret1B_D0", 0.0F, CockpitKi36.this.aircraft().FM.turret[0].tu[1], 0.0F);
            }
            return true;
        }
    ...
    public CockpitKi36() {
        super("3DO/Cockpit/Ki-36/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 340F, 0.0F, 17F), CockpitKi36.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Temp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 7F), CockpitKi36.oilScale), 0.0F, 0.0F);
