...
public class CockpitKi96 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitKi96.this.bNeedSetUp) {
                CockpitKi96.this.bNeedSetUp = false;
                CockpitKi96.this.reflectPlaneMats();
            }
            CockpitKi96.this.setTmp = CockpitKi96.this.setOld;
            CockpitKi96.this.setOld = CockpitKi96.this.setNew;
            CockpitKi96.this.setNew = CockpitKi96.this.setTmp;
            if (((CockpitKi96.this.fm.AS.astateCockpitState & 2) != 0) && (CockpitKi96.this.setNew.ironSight < 1.0F)) {
                CockpitKi96.this.setNew.ironSight = CockpitKi96.this.setOld.ironSight + 0.0125F;
                CockpitKi96.this.setOld.ironSight = CockpitKi96.this.setNew.ironSight;
            }
            CockpitKi96.this.setNew.altimeter = CockpitKi96.this.fm.getAltitude();
            if (CockpitKi96.this.cockpitDimControl) {
                if ((CockpitKi96.this.setNew.dimPosition > 0.0F) && (CockpitKi96.this.setNew.ironSight == 0.0F)) {
                    CockpitKi96.this.setNew.dimPosition = CockpitKi96.this.setNew.dimPosition - 0.05F;
                }
            } else if ((CockpitKi96.this.setNew.dimPosition < 1.0F) && (CockpitKi96.this.setNew.ironSight == 0.0F)) {
                CockpitKi96.this.setNew.dimPosition = CockpitKi96.this.setNew.dimPosition + 0.05F;
            }
            CockpitKi96.this.setNew.throttle1 = (0.91F * CockpitKi96.this.setOld.throttle1) + (0.09F * CockpitKi96.this.fm.EI.engines[0].getControlThrottle());
            CockpitKi96.this.setNew.throttle2 = (0.91F * CockpitKi96.this.setOld.throttle2) + (0.09F * CockpitKi96.this.fm.EI.engines[1].getControlThrottle());
            CockpitKi96.this.setNew.mix1 = (0.88F * CockpitKi96.this.setOld.mix1) + (0.12F * CockpitKi96.this.fm.EI.engines[0].getControlMix());
            CockpitKi96.this.setNew.mix2 = (0.88F * CockpitKi96.this.setOld.mix2) + (0.12F * CockpitKi96.this.fm.EI.engines[1].getControlMix());
            if (Math.abs(CockpitKi96.this.fm.Or.getKren()) < 30F) {
                CockpitKi96.this.setNew.azimuth.setDeg(CockpitKi96.this.setOld.azimuth.getDeg(1.0F), -CockpitKi96.this.fm.Or.azimut() - 90F);
            }
            CockpitKi96.this.w.set(CockpitKi96.this.fm.getW());
            CockpitKi96.this.fm.Or.transform(CockpitKi96.this.w);
            CockpitKi96.this.setNew.turn = ((12F * CockpitKi96.this.setOld.turn) + CockpitKi96.this.w.z) / 13F;
            CockpitKi96.this.setNew.vspeed = ((199F * CockpitKi96.this.setOld.vspeed) + CockpitKi96.this.fm.getVertSpeed()) / 200F;
            CockpitKi96.this.setNew.manifold1 = (0.8F * CockpitKi96.this.setOld.manifold1) + (0.2F * CockpitKi96.this.fm.EI.engines[0].getManifoldPressure());
            CockpitKi96.this.setNew.manifold2 = (0.8F * CockpitKi96.this.setOld.manifold2) + (0.2F * CockpitKi96.this.fm.EI.engines[1].getManifoldPressure());
            float f = 30F;
            for (int i = 0; i < 2; i++) {
                if ((CockpitKi96.this.cowlFlapsLever[i] != 0.0F) && (CockpitKi96.this.cowlFlaps[i] == CockpitKi96.this.fm.EI.engines[i].getControlRadiator())) {
                    CockpitKi96.this.cowlFlapsLever[i] = CockpitKi96.this.cowlFlapsLever[i] * 0.8F;
                    if (Math.abs(CockpitKi96.this.cowlFlapsLever[i]) < 0.1F) {
                        CockpitKi96.this.cowlFlapsLever[i] = 0.0F;
                    }
                } else if (CockpitKi96.this.cowlFlaps[i] < CockpitKi96.this.fm.EI.engines[i].getControlRadiator()) {
                    CockpitKi96.this.cowlFlaps[i] = CockpitKi96.this.fm.EI.engines[i].getControlRadiator();
                    CockpitKi96.this.cowlFlapsLever[i] = CockpitKi96.this.cowlFlapsLever[i] + 2.0F;
                    if (CockpitKi96.this.cowlFlapsLever[i] > f) {
                        CockpitKi96.this.cowlFlapsLever[i] = f;
                    }
                } else if (CockpitKi96.this.cowlFlaps[i] > CockpitKi96.this.fm.EI.engines[i].getControlRadiator()) {
                    CockpitKi96.this.cowlFlaps[i] = CockpitKi96.this.fm.EI.engines[i].getControlRadiator();
                    CockpitKi96.this.cowlFlapsLever[i] = CockpitKi96.this.cowlFlapsLever[i] - 2.0F;
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            this.aircraft().hierMesh().chunkVisible("CN_D0", false);
            this.aircraft().hierMesh().chunkVisible("CN_D1", false);
            this.aircraft().hierMesh().chunkVisible("CN_D2", false);
            this.aircraft().hierMesh().chunkVisible("CN_D3", false);
            this.aircraft().hierMesh().chunkVisible("RUS", false);
            this.aircraft().hierMesh().chunkVisible("Blister", false);
    ...
    protected void doFocusLeave() {
        this.aircraft().hierMesh().chunkVisible("CN_D0", true);
        this.aircraft().hierMesh().chunkVisible("RUS", true);
        this.aircraft().hierMesh().chunkVisible("Blister", true);
        this.aircraft().hierMesh().chunkVisible("Blister1_D0", true);
        super.doFocusLeave();
    }

    public CockpitKi96() {
        super("3DO/Cockpit/KI-96-P/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Need_Climb", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 12F), CockpitKi96.variometerScale), 0.0F);
        this.mesh.chunkSetAngles("Z_Need_AirSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 700F, 0.0F, 14F), CockpitKi96.speedometerScale), 0.0F);
    ...
    static {
        Property.set(CockpitKi96.class, "normZNs", new float[] { 0.7F, 0.7F, 0.8F, 0.7F });
    }
