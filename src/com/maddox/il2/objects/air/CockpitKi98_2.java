...
public class CockpitKi98_2 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitKi98_2.this.fm != null) {
                CockpitKi98_2.this.setTmp = CockpitKi98_2.this.setOld;
                CockpitKi98_2.this.setOld = CockpitKi98_2.this.setNew;
                CockpitKi98_2.this.setNew = CockpitKi98_2.this.setTmp;
                CockpitKi98_2.this.setNew.flap = (0.88F * CockpitKi98_2.this.setOld.flap) + (0.12F * CockpitKi98_2.this.fm.CT.FlapsControl);
                CockpitKi98_2.this.setNew.tlock = (0.7F * CockpitKi98_2.this.setOld.tlock) + (0.3F * (CockpitKi98_2.this.fm.Gears.bTailwheelLocked ? 1.0F : 0.0F));
                if (CockpitKi98_2.this.cockpitDimControl) {
                    if (CockpitKi98_2.this.setNew.dimPosition > 0.0F) {
                        CockpitKi98_2.this.setNew.dimPosition = CockpitKi98_2.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitKi98_2.this.setNew.dimPosition < 1.0F) {
                    CockpitKi98_2.this.setNew.dimPosition = CockpitKi98_2.this.setOld.dimPosition + 0.05F;
                }
                if ((CockpitKi98_2.this.fm.AS.astateCockpitState & 2) != 0) {
                    if (CockpitKi98_2.this.setNew.stbyPosition > 0.0F) {
                        CockpitKi98_2.this.setNew.stbyPosition = CockpitKi98_2.this.setOld.stbyPosition - 0.025F;
                    }
                } else if (CockpitKi98_2.this.setNew.stbyPosition < 1.0F) {
                    CockpitKi98_2.this.setNew.stbyPosition = CockpitKi98_2.this.setOld.stbyPosition + 0.025F;
                }
                if ((CockpitKi98_2.this.fm.CT.GearControl < 0.5F) && (CockpitKi98_2.this.setNew.gear < 1.0F)) {
                    CockpitKi98_2.this.setNew.gear = CockpitKi98_2.this.setOld.gear + 0.02F;
                }
                if ((CockpitKi98_2.this.fm.CT.GearControl > 0.5F) && (CockpitKi98_2.this.setNew.gear > 0.0F)) {
                    CockpitKi98_2.this.setNew.gear = CockpitKi98_2.this.setOld.gear - 0.02F;
                }
                CockpitKi98_2.this.setNew.throttle = (0.9F * CockpitKi98_2.this.setOld.throttle) + (0.1F * CockpitKi98_2.this.fm.CT.PowerControl);
                CockpitKi98_2.this.setNew.manifold = (0.8F * CockpitKi98_2.this.setOld.manifold) + (0.2F * CockpitKi98_2.this.fm.EI.engines[0].getManifoldPressure());
                CockpitKi98_2.this.setNew.pitch = (0.9F * CockpitKi98_2.this.setOld.pitch) + (0.1F * CockpitKi98_2.this.fm.EI.engines[0].getControlProp());
                CockpitKi98_2.this.setNew.mix = (0.9F * CockpitKi98_2.this.setOld.mix) + (0.1F * CockpitKi98_2.this.fm.EI.engines[0].getControlMix());
                CockpitKi98_2.this.setNew.altimeter = CockpitKi98_2.this.fm.getAltitude();
                if (Math.abs(CockpitKi98_2.this.fm.Or.getKren()) < 30F) {
                    CockpitKi98_2.this.setNew.azimuth.setDeg(CockpitKi98_2.this.setOld.azimuth.getDeg(1.0F), CockpitKi98_2.this.fm.Or.azimut());
                }
                float f = CockpitKi98_2.this.waypointAzimuth();
                CockpitKi98_2.this.setNew.waypointAzimuth.setDeg(CockpitKi98_2.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitKi98_2.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-3F, 3F));
                CockpitKi98_2.this.setNew.vspeed = ((199F * CockpitKi98_2.this.setOld.vspeed) + CockpitKi98_2.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitKi98_2() {
        super("3DO/Cockpit/ki-98-II/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        Cockpit.xyz[2] = Aircraft.cvt(this.fm.CT.getCockpitDoor(), 0.01F, 0.5F, 0.0F, 0.02F);
        ...
        this.mesh.chunkSetAngles("NeedOilTemp", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 110F, 0.0F, 8F), CockpitKi98_2.oilTScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedRPM", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitKi98_2.revolutionsScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 740.7998F, 0.0F, 20F), CockpitKi98_2.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedExternalT", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 233.09F, 333.09F, 0.0F, 5F), CockpitKi98_2.frAirTempScale), 0.0F, 0.0F);
