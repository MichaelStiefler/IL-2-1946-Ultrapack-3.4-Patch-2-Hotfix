...
public class CockpitKi_10 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitKi_10.this.fm != null) {
                CockpitKi_10.this.setTmp = CockpitKi_10.this.setOld;
                CockpitKi_10.this.setOld = CockpitKi_10.this.setNew;
                CockpitKi_10.this.setNew = CockpitKi_10.this.setTmp;
                if (CockpitKi_10.this.cockpitDimControl) {
                    if (CockpitKi_10.this.setNew.dimPos < 1.0F) {
                        CockpitKi_10.this.setNew.dimPos = CockpitKi_10.this.setOld.dimPos + 0.03F;
                    }
                } else if (CockpitKi_10.this.setNew.dimPos > 0.0F) {
                    CockpitKi_10.this.setNew.dimPos = CockpitKi_10.this.setOld.dimPos - 0.03F;
                }
                CockpitKi_10.this.setNew.manifold = (0.8F * CockpitKi_10.this.setOld.manifold) + (0.2F * CockpitKi_10.this.fm.EI.engines[0].getManifoldPressure());
                CockpitKi_10.this.setNew.throttle = (0.8F * CockpitKi_10.this.setOld.throttle) + (0.2F * CockpitKi_10.this.fm.CT.PowerControl);
                CockpitKi_10.this.setNew.prop = (0.8F * CockpitKi_10.this.setOld.prop) + (0.2F * CockpitKi_10.this.fm.EI.engines[0].getControlProp());
                CockpitKi_10.this.setNew.mix = (0.8F * CockpitKi_10.this.setOld.mix) + (0.2F * CockpitKi_10.this.fm.EI.engines[0].getControlMix());
                CockpitKi_10.this.setNew.man = (0.92F * CockpitKi_10.this.setOld.man) + (0.08F * CockpitKi_10.this.fm.EI.engines[0].getManifoldPressure());
                CockpitKi_10.this.setNew.altimeter = CockpitKi_10.this.fm.getAltitude();
                float f = CockpitKi_10.this.waypointAzimuth();
                if (Math.abs(CockpitKi_10.this.fm.Or.getKren()) < 30F) {
                    CockpitKi_10.this.setNew.azimuth.setDeg(CockpitKi_10.this.setOld.azimuth.getDeg(1.0F), CockpitKi_10.this.fm.Or.azimut());
                }
                CockpitKi_10.this.setNew.waypointDeviation.setDeg(CockpitKi_10.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitKi_10.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-5F, 5F));
                CockpitKi_10.this.setNew.waypointAzimuth.setDeg(CockpitKi_10.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitKi_10.this.setNew.vspeed = (0.5F * CockpitKi_10.this.setOld.vspeed) + (0.5F * CockpitKi_10.this.fm.getVertSpeed());
            }
            return true;
        }
    ...
    public CockpitKi_10() {
        super("3DO/Cockpit/Ki10/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitKi_10.speedometerScale), 0.0F, 0.0F);
        ...
        for (int i = 1; i < 20; i++) {
            this.mesh.chunkVisible("Z_OilP" + (i < 10 ? "0" + i : "" + i), f1 > (20 - i));
        }
        ...
        this.mesh.chunkSetAngles("Z_Oiltemp1", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 130F, 0.0F, -225F), 0.0F, 0.0F);
