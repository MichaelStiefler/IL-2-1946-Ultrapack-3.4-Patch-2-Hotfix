...
public class CockpitLAGG_3SERIES4 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitLAGG_3SERIES4.this.fm != null) {
                CockpitLAGG_3SERIES4.this.setTmp = CockpitLAGG_3SERIES4.this.setOld;
                CockpitLAGG_3SERIES4.this.setOld = CockpitLAGG_3SERIES4.this.setNew;
                CockpitLAGG_3SERIES4.this.setNew = CockpitLAGG_3SERIES4.this.setTmp;
                CockpitLAGG_3SERIES4.this.setNew.throttle = ((10F * CockpitLAGG_3SERIES4.this.setOld.throttle) + CockpitLAGG_3SERIES4.this.fm.CT.PowerControl) / 11F;
                CockpitLAGG_3SERIES4.this.setNew.prop = ((10F * CockpitLAGG_3SERIES4.this.setOld.prop) + CockpitLAGG_3SERIES4.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitLAGG_3SERIES4.this.setNew.altimeter = CockpitLAGG_3SERIES4.this.fm.getAltitude();
                if (CockpitLAGG_3SERIES4.this.useRealisticNavigationInstruments()) {
                    CockpitLAGG_3SERIES4.this.setNew.waypointAzimuth.setDeg(CockpitLAGG_3SERIES4.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitLAGG_3SERIES4.this.getBeaconDirection());
                } else {
                    CockpitLAGG_3SERIES4.this.setNew.waypointAzimuth.setDeg(CockpitLAGG_3SERIES4.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitLAGG_3SERIES4.this.waypointAzimuth() - CockpitLAGG_3SERIES4.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                }
                if (Math.abs(CockpitLAGG_3SERIES4.this.fm.Or.getKren()) < 30F) {
                    CockpitLAGG_3SERIES4.this.setNew.azimuth.setDeg(CockpitLAGG_3SERIES4.this.setOld.azimuth.getDeg(1.0F), CockpitLAGG_3SERIES4.this.fm.Or.azimut());
                }
                CockpitLAGG_3SERIES4.this.setNew.vspeed = ((199F * CockpitLAGG_3SERIES4.this.setOld.vspeed) + CockpitLAGG_3SERIES4.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitLAGG_3SERIES4.speedometerScale), 0.0F);
