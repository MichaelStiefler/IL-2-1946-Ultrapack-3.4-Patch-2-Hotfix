...
public class CockpitLA_7B20 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitLA_7B20.this.fm != null) {
                CockpitLA_7B20.this.setTmp = CockpitLA_7B20.this.setOld;
                CockpitLA_7B20.this.setOld = CockpitLA_7B20.this.setNew;
                CockpitLA_7B20.this.setNew = CockpitLA_7B20.this.setTmp;
                CockpitLA_7B20.this.setNew.throttle = ((10F * CockpitLA_7B20.this.setOld.throttle) + CockpitLA_7B20.this.fm.CT.PowerControl) / 11F;
                CockpitLA_7B20.this.setNew.prop = ((8F * CockpitLA_7B20.this.setOld.prop) + CockpitLA_7B20.this.fm.CT.getStepControl()) / 9F;
                ...
                if (CockpitLA_7B20.this.useRealisticNavigationInstruments()) {
                    ...
                    CockpitLA_7B20.this.setNew.waypointAzimuth.setDeg(CockpitLA_7B20.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitLA_7B20.this.waypointAzimuth() - CockpitLA_7B20.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                }
                if (Math.abs(CockpitLA_7B20.this.fm.Or.getKren()) < 30F) {
                    CockpitLA_7B20.this.setNew.azimuth.setDeg(CockpitLA_7B20.this.setOld.azimuth.getDeg(1.0F), CockpitLA_7B20.this.fm.Or.azimut());
                }
                CockpitLA_7B20.this.setNew.vspeed = ((199F * CockpitLA_7B20.this.setOld.vspeed) + CockpitLA_7B20.this.fm.getVertSpeed()) / 200F;
                if (CockpitLA_7B20.this.fm.getAltitude() > 3000F) {
                    float f = (float) Math.sin(1.0F * CockpitLA_7B20.this.cvt(CockpitLA_7B20.this.fm.getOverload(), 1.0F, 8F, 1.0F, 0.45F) * CockpitLA_7B20.this.cvt(CockpitLA_7B20.this.fm.AS.astatePilotStates[0], 0.0F, 100F, 1.0F, 0.1F) * (0.001F * Time.current()));
                    if (f > 0.0F) {
                        CockpitLA_7B20.this.pictBlinker += 0.3F;
                        if (CockpitLA_7B20.this.pictBlinker > 1.0F) {
                            CockpitLA_7B20.this.pictBlinker = 1.0F;
                        }
                    } else {
                        CockpitLA_7B20.this.pictBlinker -= 0.3F;
                        if (CockpitLA_7B20.this.pictBlinker < 0.0F) {
                            CockpitLA_7B20.this.pictBlinker = 0.0F;
                        }
                    }
                }
                CockpitLA_7B20.this.pictStage = (0.8F * CockpitLA_7B20.this.pictStage) + (0.1F * CockpitLA_7B20.this.fm.EI.engines[0].getControlCompressor());
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zManifold1a", this.floatindex(this.cvt(this.fm.EI.engines[0].getManifoldPressure(), 0.399966F, 2.133152F, 3F, 16F), CockpitLA_7B20.manifoldScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zGas1a", this.cvt(this.fm.M.fuel / 0.725F, 0.0F, 300F, 0.0F, 180F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zSpeed1a", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitLA_7B20.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zVariometer1a", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 6F), CockpitLA_7B20.variometerScale), 0.0F, 0.0F);
