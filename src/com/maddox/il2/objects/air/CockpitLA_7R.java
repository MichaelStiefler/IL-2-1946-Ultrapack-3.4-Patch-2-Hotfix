...
public class CockpitLA_7R extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitLA_7R.this.fm != null) {
                CockpitLA_7R.this.setTmp = CockpitLA_7R.this.setOld;
                CockpitLA_7R.this.setOld = CockpitLA_7R.this.setNew;
                CockpitLA_7R.this.setNew = CockpitLA_7R.this.setTmp;
                CockpitLA_7R.this.setNew.throttle = ((10F * CockpitLA_7R.this.setOld.throttle) + CockpitLA_7R.this.fm.CT.PowerControl) / 11F;
                CockpitLA_7R.this.setNew.prop = ((8F * CockpitLA_7R.this.setOld.prop) + CockpitLA_7R.this.fm.CT.getStepControl()) / 9F;
                CockpitLA_7R.this.setNew.altimeter = CockpitLA_7R.this.fm.getAltitude();
                if (CockpitLA_7R.this.useRealisticNavigationInstruments()) {
                    CockpitLA_7R.this.setNew.waypointAzimuth.setDeg(CockpitLA_7R.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitLA_7R.this.getBeaconDirection());
                } else {
                    CockpitLA_7R.this.setNew.waypointAzimuth.setDeg(CockpitLA_7R.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitLA_7R.this.waypointAzimuth() - CockpitLA_7R.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                }
                if (Math.abs(CockpitLA_7R.this.fm.Or.getKren()) < 30F) {
                    CockpitLA_7R.this.setNew.azimuth.setDeg(CockpitLA_7R.this.setOld.azimuth.getDeg(1.0F), CockpitLA_7R.this.fm.Or.azimut());
                }
                CockpitLA_7R.this.setNew.vspeed = ((199F * CockpitLA_7R.this.setOld.vspeed) + CockpitLA_7R.this.fm.getVertSpeed()) / 200F;
                if (CockpitLA_7R.this.fm.getAltitude() > 3000F) {
                    float f = (float) Math.sin(1.0F * CockpitLA_7R.this.cvt(CockpitLA_7R.this.fm.getOverload(), 1.0F, 8F, 1.0F, 0.45F) * CockpitLA_7R.this.cvt(CockpitLA_7R.this.fm.AS.astatePilotStates[0], 0.0F, 100F, 1.0F, 0.1F) * (0.001F * Time.current()));
                    if (f > 0.0F) {
                        CockpitLA_7R.this.pictBlinker += 0.3F;
                        if (CockpitLA_7R.this.pictBlinker > 1.0F) {
                            CockpitLA_7R.this.pictBlinker = 1.0F;
                        }
                    } else {
                        CockpitLA_7R.this.pictBlinker -= 0.3F;
                        if (CockpitLA_7R.this.pictBlinker < 0.0F) {
                            CockpitLA_7R.this.pictBlinker = 0.0F;
                        }
                    }
                }
                CockpitLA_7R.this.pictStage = (0.8F * CockpitLA_7R.this.pictStage) + (0.1F * CockpitLA_7R.this.fm.EI.engines[0].getControlCompressor());
                CockpitLA_7R.this.setNew.preved = (0.99F * CockpitLA_7R.this.setOld.preved) + (0.01F * (CockpitLA_7R.this.fm.EI.engines[1].getStage() != 6 ? 55F : 800F));
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        this.mesh.chunkSetAngles("zKerosin", this.cvt(this.fm.M.nitro, 0.0F, 250F, 0.0F, 270F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zAzotKislota", this.cvt(this.fm.M.nitro, 0.0F, 250F, 0.0F, 270F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zPVRD_Temp", this.cvt(this.setNew.preved, 0.0F, 900F, 0.0F, 118F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("SW_PVRD", this.fm.EI.engines[1].getStage() <= 0 ? 0.0F : 45F, 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zManifold1a", this.floatindex(this.cvt(this.fm.EI.engines[0].getManifoldPressure(), 0.399966F, 2.133152F, 3F, 16F), CockpitLA_7R.manifoldScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zGas1a", this.cvt(this.fm.M.fuel / 0.725F, 0.0F, 300F, 0.0F, 180F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zSpeed1a", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitLA_7R.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zVariometer1a", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 6F), CockpitLA_7R.variometerScale), 0.0F, 0.0F);
