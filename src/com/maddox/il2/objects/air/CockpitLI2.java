...
public class CockpitLI2 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitLI2.this.fm != null) {
                CockpitLI2.this.setTmp = CockpitLI2.this.setOld;
                CockpitLI2.this.setOld = CockpitLI2.this.setNew;
                CockpitLI2.this.setNew = CockpitLI2.this.setTmp;
                CockpitLI2.this.setNew.throttle1 = (0.85F * CockpitLI2.this.setOld.throttle1) + (CockpitLI2.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitLI2.this.setNew.throttle2 = (0.85F * CockpitLI2.this.setOld.throttle2) + (CockpitLI2.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitLI2.this.setNew.prop1 = (0.85F * CockpitLI2.this.setOld.prop1) + (CockpitLI2.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitLI2.this.setNew.prop2 = (0.85F * CockpitLI2.this.setOld.prop2) + (CockpitLI2.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitLI2.this.setNew.altimeter = CockpitLI2.this.fm.getAltitude();
                float f = CockpitLI2.this.waypointAzimuth();
                if (Math.abs(CockpitLI2.this.fm.Or.getKren()) < 30F) {
                    CockpitLI2.this.setNew.azimuth.setDeg(CockpitLI2.this.setOld.azimuth.getDeg(1.0F), CockpitLI2.this.fm.Or.azimut());
                }
                CockpitLI2.this.setNew.waypointAzimuth.setDeg(CockpitLI2.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitLI2.this.setNew.waypointDeviation.setDeg(CockpitLI2.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitLI2.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitLI2.this.setNew.vspeed = ((199F * CockpitLI2.this.setOld.vspeed) + CockpitLI2.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
...
//        pictGear = 0.0F;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitLI2.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitLI2.speedometerScale), 0.0F);
