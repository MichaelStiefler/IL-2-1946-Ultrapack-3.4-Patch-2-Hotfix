...
public class CockpitLN_411 extends CockpitPilot {
    private class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitLN_411.this.fm != null) {
                CockpitLN_411.this.setTmp = CockpitLN_411.this.setOld;
                CockpitLN_411.this.setOld = CockpitLN_411.this.setNew;
                CockpitLN_411.this.setNew = CockpitLN_411.this.setTmp;
                CockpitLN_411.this.setNew.throttle = (0.92F * CockpitLN_411.this.setOld.throttle) - (0.08F * CockpitLN_411.this.fm.CT.PowerControl);
                CockpitLN_411.this.setNew.prop = (0.92F * CockpitLN_411.this.setOld.prop) - (0.08F * CockpitLN_411.this.fm.EI.engines[0].getControlProp());
                CockpitLN_411.this.setNew.mix = (0.92F * CockpitLN_411.this.setOld.mix) - (0.08F * CockpitLN_411.this.fm.EI.engines[0].getControlMix());
                CockpitLN_411.this.setNew.altimeter = CockpitLN_411.this.fm.getAltitude();
                CockpitLN_411.this.setNew.waypointAzimuth.setDeg(CockpitLN_411.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitLN_411.this.waypointAzimuth() - CockpitLN_411.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitLN_411.this.fm.Or.getKren()) < 30F) {
                    CockpitLN_411.this.setNew.azimuth.setDeg(CockpitLN_411.this.setOld.azimuth.getDeg(1.0F), CockpitLN_411.this.fm.Or.azimut());
                }
                CockpitLN_411.this.setNew.vspeed = (0.99F * CockpitLN_411.this.setOld.vspeed) + (0.01F * CockpitLN_411.this.fm.getVertSpeed());
                if (CockpitLN_411.this.fm.CT.GearControl < 0.5F) {
                    if (CockpitLN_411.this.setNew.gearPhi > 0.0F) {
                        CockpitLN_411.this.setNew.gearPhi = CockpitLN_411.this.setOld.gearPhi - 0.021F;
                    }
                } else if (CockpitLN_411.this.setNew.gearPhi < 1.0F) {
                    CockpitLN_411.this.setNew.gearPhi = CockpitLN_411.this.setOld.gearPhi + 0.021F;
                }
            }
            return true;
    ...
    public CockpitLN_411() {
        super("3DO/Cockpit/LN/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 10F), CockpitLN_411.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_VY", -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitLN_411.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_FUEL1", this.cvt(this.fm.M.fuel, 0.0F, 224.64F, 0.0F, -308F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4500F, 0.0F, 10F), CockpitLN_411.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, -306F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitLN_411.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STR_OIL_LB", this.cvt(1.0F + (0.05F * this.fm.EI.engines[0].tOilOut), 0.0F, 10F, 0.0F, -36F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TURN_UP", this.cvt(this.w.z, -0.23562F, 0.23562F, -48F, 48F), 0.0F, 0.0F);
        this.w.set(this.fm.getW());
        this.fm.Or.transform(this.w);
        this.mesh.chunkSetAngles("STREL_TURN_DOWN", this.cvt(this.getBall(8D), -8F, 8F, 35F, -35F), 0.0F, 0.0F);
    ...
    private static final float rpmScale[]         = { 0.0F, 25F, 42F, 79.5F, 116.5F, 153F, 190F, 227.5F, 253F, 290F, 327.5F };
