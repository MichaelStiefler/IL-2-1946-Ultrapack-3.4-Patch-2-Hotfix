...
public class CockpitLanc extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitLanc.this.fm != null) {
                CockpitLanc.this.setTmp = CockpitLanc.this.setOld;
                CockpitLanc.this.setOld = CockpitLanc.this.setNew;
                CockpitLanc.this.setNew = CockpitLanc.this.setTmp;
                CockpitLanc.this.setNew.throttle1 = (0.85F * CockpitLanc.this.setOld.throttle1) + (CockpitLanc.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitLanc.this.setNew.prop1 = (0.85F * CockpitLanc.this.setOld.prop1) + (CockpitLanc.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitLanc.this.setNew.throttle2 = (0.85F * CockpitLanc.this.setOld.throttle2) + (CockpitLanc.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitLanc.this.setNew.prop2 = (0.85F * CockpitLanc.this.setOld.prop2) + (CockpitLanc.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitLanc.this.setNew.throttle3 = (0.85F * CockpitLanc.this.setOld.throttle3) + (CockpitLanc.this.fm.EI.engines[2].getControlThrottle() * 0.15F);
                CockpitLanc.this.setNew.prop3 = (0.85F * CockpitLanc.this.setOld.prop3) + (CockpitLanc.this.fm.EI.engines[3].getControlProp() * 0.15F);
                CockpitLanc.this.setNew.throttle4 = (0.85F * CockpitLanc.this.setOld.throttle4) + (CockpitLanc.this.fm.EI.engines[3].getControlThrottle() * 0.15F);
                CockpitLanc.this.setNew.prop4 = (0.85F * CockpitLanc.this.setOld.prop4) + (CockpitLanc.this.fm.EI.engines[3].getControlProp() * 0.15F);
                CockpitLanc.this.setNew.altimeter = CockpitLanc.this.fm.getAltitude();
                CockpitLanc.this.setNew.waypointAzimuth.setDeg(CockpitLanc.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitLanc.this.waypointAzimuth() - CockpitLanc.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitLanc.this.fm.Or.getKren()) < 30F) {
                    CockpitLanc.this.setNew.azimuth.setDeg(CockpitLanc.this.setOld.azimuth.getDeg(1.0F), CockpitLanc.this.fm.Or.azimut());
                }
                CockpitLanc.this.setNew.vspeed = (0.99F * CockpitLanc.this.setOld.vspeed) + (0.01F * CockpitLanc.this.fm.getVertSpeed());
                switch (CockpitLanc.this.iWiper) {
                    default:
                        break;

                    case 0:
                        if ((Mission.curCloudsType() > 4) && (CockpitLanc.this.fm.getSpeedKMH() < 220F) && (CockpitLanc.this.fm.getAltitude() < (Mission.curCloudsHeight() + 300F))) {
                            CockpitLanc.this.iWiper = 1;
                        }
                        break;

                    case 1:
                        CockpitLanc.this.setNew.wiper = CockpitLanc.this.setOld.wiper - 0.05F;
                        if (CockpitLanc.this.setNew.wiper < -1.03F) {
                            CockpitLanc.this.iWiper++;
                        }
                        if (CockpitLanc.this.wiState >= 2) {
                            break;
                        }
                        if (CockpitLanc.this.wiState == 0) {
                            if (CockpitLanc.this.fxw == null) {
                                CockpitLanc.this.fxw = CockpitLanc.this.aircraft().newSound("aircraft.wiper", false);
                                if (CockpitLanc.this.fxw != null) {
                                    CockpitLanc.this.fxw.setParent(CockpitLanc.this.aircraft().getRootFX());
                                    CockpitLanc.this.fxw.setPosition(CockpitLanc.this.sfxPos);
                                }
                            }
                            if (CockpitLanc.this.fxw != null) {
                                CockpitLanc.this.fxw.play(CockpitLanc.this.wiStart);
                            }
                        }
                        if (CockpitLanc.this.fxw != null) {
                            CockpitLanc.this.fxw.play(CockpitLanc.this.wiRun);
                            CockpitLanc.this.wiState = 2;
                        }
                        break;
                    ...
                    case 2:
                        ...
                        if (CockpitLanc.this.wiState > 1) {
                            CockpitLanc.this.wiState = 1;
                        }
                        break;

                    case 3:
                        CockpitLanc.this.setNew.wiper = CockpitLanc.this.setOld.wiper - 0.05F;
                        if (CockpitLanc.this.setNew.wiper >= 0.02F) {
                            break;
                        }
                        if ((CockpitLanc.this.fm.getSpeedKMH() > 250F) || (CockpitLanc.this.fm.getAltitude() > (Mission.curCloudsHeight() + 400F))) {
                            CockpitLanc.this.iWiper++;
                        } else {
                            CockpitLanc.this.iWiper = 1;
                        }
                    ...
                    case 4:
                        CockpitLanc.this.setNew.wiper = CockpitLanc.this.setOld.wiper;
                        CockpitLanc.this.iWiper = 0;
                        CockpitLanc.this.wiState = 0;
                        if (CockpitLanc.this.fxw != null) {
                            CockpitLanc.this.fxw.cancel();
                        }
                        break;
                }
            }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST1", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitLanc.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST2", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitLanc.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST3", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitLanc.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST4", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitLanc.boostScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TEMP_RAD1", this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitLanc.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_TEMP_RAD2", this.floatindex(this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitLanc.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_TEMP_RAD3", this.floatindex(this.cvt(this.fm.EI.engines[2].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitLanc.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_TEMP_RAD4", this.floatindex(this.cvt(this.fm.EI.engines[3].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitLanc.radScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 26.8224F, 214.5792F, 0.0F, 21F), CockpitLanc.speedometerScale), 0.0F, 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("STR_CLIMB", this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitLanc.variometerScale), 0.0F, 0.0F);
        }
