...
public class CockpitLate298 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            CockpitLate298.this.setNew.waypointAzimuth.setDeg(CockpitLate298.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitLate298.this.waypointAzimuth() - CockpitLate298.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitLate298.this.fm.Or.getKren()) < 30F) {
                CockpitLate298.this.setNew.azimuth.setDeg(CockpitLate298.this.setOld.azimuth.getDeg(1.0F), CockpitLate298.this.fm.Or.azimut());
            }
