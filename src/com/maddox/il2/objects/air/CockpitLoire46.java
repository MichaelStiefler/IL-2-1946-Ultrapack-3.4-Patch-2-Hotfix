...
public class CockpitLoire46 extends CockpitPilot {
    private class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitLoire46.this.fm != null) {
                CockpitLoire46.this.setTmp = CockpitLoire46.this.setOld;
                CockpitLoire46.this.setOld = CockpitLoire46.this.setNew;
                CockpitLoire46.this.setNew = CockpitLoire46.this.setTmp;
                CockpitLoire46.this.setNew.throttle = (0.92F * CockpitLoire46.this.setOld.throttle) + (0.08F * CockpitLoire46.this.fm.CT.PowerControl);
                CockpitLoire46.this.setNew.prop = (0.92F * CockpitLoire46.this.setOld.prop) + (0.08F * CockpitLoire46.this.fm.EI.engines[0].getControlProp());
                CockpitLoire46.this.setNew.mix = (0.92F * CockpitLoire46.this.setOld.mix) + (0.08F * CockpitLoire46.this.fm.EI.engines[0].getControlMix());
                CockpitLoire46.this.setNew.altimeter = CockpitLoire46.this.fm.getAltitude();
                CockpitLoire46.this.setNew.waypointAzimuth.setDeg(CockpitLoire46.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitLoire46.this.waypointAzimuth() - CockpitLoire46.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitLoire46.this.fm.Or.getKren()) < 30F) {
                    CockpitLoire46.this.setNew.azimuth.setDeg(CockpitLoire46.this.setOld.azimuth.getDeg(1.0F), CockpitLoire46.this.fm.Or.azimut());
                }
                CockpitLoire46.this.setNew.vspeed = (0.99F * CockpitLoire46.this.setOld.vspeed) + (0.01F * CockpitLoire46.this.fm.getVertSpeed());
                if (CockpitLoire46.this.fm.CT.GearControl < 0.5F) {
                    if (CockpitLoire46.this.setNew.gearPhi > 0.0F) {
                        CockpitLoire46.this.setNew.gearPhi = CockpitLoire46.this.setOld.gearPhi - 0.021F;
                    }
                } else if (CockpitLoire46.this.setNew.gearPhi < 1.0F) {
                    CockpitLoire46.this.setNew.gearPhi = CockpitLoire46.this.setOld.gearPhi + 0.021F;
                }
            }
            return true;
    ...
    public CockpitLoire46() {
        super("3DO/Cockpit/Loire46/Loire46.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 10F), CockpitLoire46.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_VY", -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitLoire46.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 5000F, 0.0F, 10F), CockpitLoire46.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, -306F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitLoire46.radScale), 0.0F, 0.0F);
