    ...
    class Interpolater extends InterpolateRef {
        public boolean tick() {
            ...
            if (CockpitLysander_1.this.fm != null) {
                ...
                CockpitLysander_1.this.setNew.waypointAzimuth.setDeg(CockpitLysander_1.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitLysander_1.this.waypointAzimuth() - CockpitLysander_1.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitLysander_1.this.fm.Or.getKren()) < 30F) {
                    CockpitLysander_1.this.setNew.azimuth.setDeg(CockpitLysander_1.this.setOld.azimuth.getDeg(1.0F), CockpitLysander_1.this.fm.Or.azimut());
                }
...
//        this.cockpitNightMats = new String[] { "BORT2", "BORT4", "COMPASS", "prib_five_fin", "prib_five", "prib_four", "prib_one_fin", "prib_one", "prib_six", "prib_three", "prib_two", "pricel", "04", "04_damage" };
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        Cockpit.xyz[0] = this.cvt(this.fm.CT.getCockpitDoor(), 0.01F, 1.0F, 0.0F, -0.56F);
        ...
        Cockpit.xyz[0] = this.cvt(this.fm.CT.getCockpitDoor(), 0.0F, 1.0F, 0.0F, 0.0F);
        Cockpit.xyz[1] = this.cvt(this.fm.CT.getCockpitDoor(), 0.0F, 1.0F, 0.0F, 0.44F);
        Cockpit.xyz[2] = this.cvt(this.fm.CT.getCockpitDoor(), 0.0F, 1.0F, 0.0F, -0.78F);
        this.mesh.chunkSetLocate("BlisterL_D0", Cockpit.xyz, Cockpit.ypr);
        Cockpit.xyz[0] = this.cvt(this.fm.CT.getCockpitDoor(), 0.0F, 1.0F, 0.0F, 0.0F);
        Cockpit.xyz[1] = this.cvt(this.fm.CT.getCockpitDoor(), 0.0F, 1.0F, 0.0F, 0.14F);
        Cockpit.xyz[2] = this.cvt(this.fm.CT.getCockpitDoor(), 0.0F, 1.0F, 0.0F, -0.39F);
        this.mesh.chunkSetLocate("BlisterL2_D0", Cockpit.xyz, Cockpit.ypr);
        Cockpit.xyz[0] = this.cvt(this.fm.CT.getCockpitDoor(), 0.0F, 1.0F, 0.0F, 0.0F);
        Cockpit.xyz[1] = this.cvt(this.fm.CT.getCockpitDoor(), 0.0F, 1.0F, 0.0F, 0.06F);
        Cockpit.xyz[2] = this.cvt(this.fm.CT.getCockpitDoor(), 0.0F, 1.0F, 0.0F, -0.23F);
        this.mesh.chunkSetLocate("BlisterL3_D0", Cockpit.xyz, Cockpit.ypr);
        Cockpit.xyz[0] = this.cvt(this.fm.CT.getCockpitDoor(), 0.0F, 1.0F, 0.0F, 0.0F);
        Cockpit.xyz[1] = this.cvt(this.fm.CT.getCockpitDoor(), 0.0F, 1.0F, 0.0F, -0.28F);
        Cockpit.xyz[2] = this.cvt(this.fm.CT.getCockpitDoor(), 0.0F, 1.0F, 0.0F, -0.78F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitLysander_1.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 100F, 0.0F, 270F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitLysander_1.radScale));
        this.resetYPRmodifier();
        ...
        if (this.bFAF) {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 143.0528F, 0.0F, 32F), CockpitLysander_1.speedometerScaleFAF));
        } else {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 180.0555F, 0.0F, 35F), CockpitLysander_1.speedometerScale));
        }
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitLysander_1.variometerScale));
