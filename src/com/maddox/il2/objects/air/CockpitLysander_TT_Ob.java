...
public class CockpitLysander_TT_Ob extends CockpitGunner {

    public void moveGun(Orient orient) {
        super.moveGun(orient);
        float f = -orient.getYaw();
        float f1 = orient.getTangage();
        this.mesh.chunkSetAngles("TurretA", -0F, f, 0.0F);
    ...
    public CockpitLysander_TT_Ob() {
        super("3DO/Cockpit/Lysander_TT_Ob/hier.him", "bf109");
    ...
    static {
        Property.set(CockpitLysander_TT_Ob.class, "aiTuretNum", 0);
        Property.set(CockpitLysander_TT_Ob.class, "weaponControlNum", 10);
        Property.set(CockpitLysander_TT_Ob.class, "astatePilotIndx", 1);
    }
}
