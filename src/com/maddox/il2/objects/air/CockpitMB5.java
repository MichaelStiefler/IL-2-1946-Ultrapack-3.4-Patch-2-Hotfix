...
public class CockpitMB5 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitMB5.this.fm != null) {
                CockpitMB5.this.setTmp = CockpitMB5.this.setOld;
                CockpitMB5.this.setOld = CockpitMB5.this.setNew;
                CockpitMB5.this.setNew = CockpitMB5.this.setTmp;
                CockpitMB5.this.setNew.throttle = (0.92F * CockpitMB5.this.setOld.throttle) + (0.08F * CockpitMB5.this.fm.CT.PowerControl);
                CockpitMB5.this.setNew.prop = (0.92F * CockpitMB5.this.setOld.prop) + (0.08F * CockpitMB5.this.fm.EI.engines[0].getControlProp());
                CockpitMB5.this.setNew.mix = (0.92F * CockpitMB5.this.setOld.mix) + (0.08F * CockpitMB5.this.fm.EI.engines[0].getControlMix());
                CockpitMB5.this.setNew.altimeter = CockpitMB5.this.fm.getAltitude();
                CockpitMB5.this.setNew.waypointAzimuth.setDeg(CockpitMB5.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitMB5.this.waypointAzimuth() - CockpitMB5.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitMB5.this.fm.Or.getKren()) < 30F) {
                    CockpitMB5.this.setNew.azimuth.setDeg(CockpitMB5.this.setOld.azimuth.getDeg(1.0F), CockpitMB5.this.fm.Or.azimut());
                }
                CockpitMB5.this.setNew.vspeed = (0.99F * CockpitMB5.this.setOld.vspeed) + (0.01F * CockpitMB5.this.fm.getVertSpeed());
                if (CockpitMB5.this.fm.CT.GearControl < 0.5F) {
                    if (CockpitMB5.this.setNew.gearPhi > 0.0F) {
                        CockpitMB5.this.setNew.gearPhi = CockpitMB5.this.setOld.gearPhi - 0.021F;
                    }
                } else if (CockpitMB5.this.setNew.gearPhi < 1.0F) {
                    CockpitMB5.this.setNew.gearPhi = CockpitMB5.this.setOld.gearPhi + 0.021F;
                }
            }
            return true;
    ...
    public CockpitMB5() {
        super("3DO/Cockpit/MB5/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 10F), CockpitMB5.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_VY", -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitMB5.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 5000F, 0.0F, 10F), CockpitMB5.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, -306F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitMB5.radScale), 0.0F, 0.0F);
