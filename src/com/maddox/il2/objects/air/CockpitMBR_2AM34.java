...
public class CockpitMBR_2AM34 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if ((CockpitMBR_2AM34.this.fm.EI.engines[0].getStage() == 1) || (CockpitMBR_2AM34.this.fm.EI.engines[0].getStage() == 2)) {
                if (CockpitMBR_2AM34.this.setNew.Airstartr < 1.0F) {
                    CockpitMBR_2AM34.this.setNew.Airstartr = CockpitMBR_2AM34.this.setOld.Airstartr + 0.1F;
                }
                if (CockpitMBR_2AM34.this.setNew.Airstartr > 1.0F) {
                    CockpitMBR_2AM34.this.setNew.Airstartr = 1.0F;
                }
            } else {
                if (CockpitMBR_2AM34.this.setNew.Airstartr > 0.0F) {
                    CockpitMBR_2AM34.this.setNew.Airstartr = CockpitMBR_2AM34.this.setOld.Airstartr - 0.1F;
                }
                if (CockpitMBR_2AM34.this.setNew.Airstartr < 0.0F) {
                    CockpitMBR_2AM34.this.setNew.Airstartr = 0.0F;
                }
            }
            if (Math.abs(CockpitMBR_2AM34.this.fm.Or.getKren()) < 30F) {
            ...
            if (CockpitMBR_2AM34.this.fm.EI.engines[0].getRPM() > 200F) {
                if (CockpitMBR_2AM34.this.fm.M.fuel > 502.5F) {
                    CockpitMBR_2AM34.this.setNew.fuelPressure = (0.9F * CockpitMBR_2AM34.this.setOld.fuelPressure) + 0.03F;
                } else if (CockpitMBR_2AM34.this.fm.M.fuel > 1.0F) {
                    CockpitMBR_2AM34.this.setNew.fuelPressure = (0.9F * CockpitMBR_2AM34.this.setOld.fuelPressure) + 0.035F;
                }
            } else {
                CockpitMBR_2AM34.this.setNew.fuelPressure = 0.9F * CockpitMBR_2AM34.this.setOld.fuelPressure;
            }
            CockpitMBR_2AM34.this.setNew.fuelPressureV = 0.0F;
            if (CockpitMBR_2AM34.this.fm.getSpeed() > 5F) {
                CockpitMBR_2AM34.this.setNew.fuelPressureV = (0.9F * CockpitMBR_2AM34.this.setOld.fuelPressureV) + (0.1F * CockpitMBR_2AM34.this.setNew.fuelPressure) + (0.001F * World.Rnd().nextFloat());
            } else {
                CockpitMBR_2AM34.this.setNew.fuelPressureV = 0.9F * CockpitMBR_2AM34.this.setOld.fuelPressureV;
            }
            return true;
        }
    ...
    public CockpitMBR_2AM34() {
        ...
        if (Mission.getMissionDate(false) < 0x12853c5) {
            this.oldStyle = true;
        } else {
            this.oldStyle = false;
    ...
    public boolean CameraHookReplace(String s, String s1) {
        if (s.equals("CAMERA") || s.equals("CAMERAAIM") || s.equals("CAMERAUP")) {
            try {
...
//					this.setCameraOffset();
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.fm.AS.externalStoresDropped) {
            this.mesh.chunkSetAngles("Z_EmrgBombDrop", -90F, 0.0F, 0.0F);
        }
        this.mesh.chunkSetAngles("Z_Air_Press02", 153F, 0.0F, 0.0F);
        if (this.ac.airstartr) {
            this.mesh.chunkSetAngles("Z_Airstartr01", -90F * this.setNew.Airstartr, 0.0F, 0.0F);
        } else {
            this.mesh.chunkSetAngles("Z_Airstartr02", -90F * this.setNew.Airstartr, 0.0F, 0.0F);
        }
        if ((this.fm.EI.engines[0].getStage() == 1) || (this.fm.EI.engines[0].getStage() == 2)) {
            if (this.ac.airstartr) {
                this.mesh.chunkSetAngles("Z_Air_Press01", (-245F * this.setNew.Airstartr) + (5F * World.Rnd().nextFloat()), 0.0F, 0.0F);
            }
            if (!this.ac.airstartr) {
                this.mesh.chunkSetAngles("Z_Air_Press03", (-215F * this.setNew.Airstartr) + (5F * World.Rnd().nextFloat()), 0.0F, 0.0F);
            }
        } else {
        ...
        this.mesh.chunkSetAngles("Z_ND_Airspeed", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 450F, 0.0F, 9F), CockpitMBR_2AM34.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_ND_OilT_OUT", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 110F, 0.0F, 7F), CockpitMBR_2AM34.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_ND_OilT_IN", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilIn, 40F, 110F, 0.0F, 7F), CockpitMBR_2AM34.oilTempScale), 0.0F, 0.0F);
    ...
    public void reflectCockpitState() {
        ...
        if ((this.fm.AS.astateCockpitState & 4) != 0) {
            ...
            if (World.Rnd().nextFloat() < 0.75F) {
                this.mesh.chunkVisible("xGlassDm5", true);
            }
