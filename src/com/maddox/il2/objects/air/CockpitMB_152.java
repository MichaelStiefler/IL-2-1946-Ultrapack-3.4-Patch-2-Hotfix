...
public class CockpitMB_152 extends CockpitPilot {
    private class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitMB_152.this.fm != null) {
                CockpitMB_152.this.setTmp = CockpitMB_152.this.setOld;
                CockpitMB_152.this.setOld = CockpitMB_152.this.setNew;
                CockpitMB_152.this.setNew = CockpitMB_152.this.setTmp;
                CockpitMB_152.this.setNew.throttle = (0.92F * CockpitMB_152.this.setOld.throttle) + (0.08F * CockpitMB_152.this.fm.CT.PowerControl);
                CockpitMB_152.this.setNew.prop = (0.92F * CockpitMB_152.this.setOld.prop) + (0.08F * CockpitMB_152.this.fm.EI.engines[0].getControlProp());
                CockpitMB_152.this.setNew.mix = (0.92F * CockpitMB_152.this.setOld.mix) + (0.08F * CockpitMB_152.this.fm.EI.engines[0].getControlMix());
                CockpitMB_152.this.setNew.altimeter = CockpitMB_152.this.fm.getAltitude();
                CockpitMB_152.this.setNew.waypointAzimuth.setDeg(CockpitMB_152.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitMB_152.this.waypointAzimuth() - CockpitMB_152.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitMB_152.this.fm.Or.getKren()) < 30F) {
                    CockpitMB_152.this.setNew.azimuth.setDeg(CockpitMB_152.this.setOld.azimuth.getDeg(1.0F), CockpitMB_152.this.fm.Or.azimut());
                }
                CockpitMB_152.this.setNew.vspeed = (0.99F * CockpitMB_152.this.setOld.vspeed) + (0.01F * CockpitMB_152.this.fm.getVertSpeed());
                if (CockpitMB_152.this.fm.CT.GearControl < 0.5F) {
                    if (CockpitMB_152.this.setNew.gearPhi > 0.0F) {
                        CockpitMB_152.this.setNew.gearPhi = CockpitMB_152.this.setOld.gearPhi - 0.021F;
                    }
                } else if (CockpitMB_152.this.setNew.gearPhi < 1.0F) {
                    CockpitMB_152.this.setNew.gearPhi = CockpitMB_152.this.setOld.gearPhi + 0.021F;
                }
            }
            return true;
    ...
    public CockpitMB_152() {
        super("3DO/Cockpit/MB-152/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 10F), CockpitMB_152.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_VY", -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitMB_152.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 5000F, 0.0F, 10F), CockpitMB_152.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, -306F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitMB_152.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STR_OIL_LB", this.cvt(1.0F + (0.05F * this.fm.EI.engines[0].tOilOut), 0.0F, 10F, 0.0F, -36F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STREL_TURN_DOWN", this.cvt(this.getBall(8D), -8F, 8F, 45F, -45F), 0.0F, 0.0F);
