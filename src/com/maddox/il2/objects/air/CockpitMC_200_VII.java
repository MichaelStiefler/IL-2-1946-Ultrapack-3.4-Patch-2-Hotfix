...
public class CockpitMC_200_VII extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitMC_200_VII.this.fm != null) {
                CockpitMC_200_VII.this.setTmp = CockpitMC_200_VII.this.setOld;
                CockpitMC_200_VII.this.setOld = CockpitMC_200_VII.this.setNew;
                CockpitMC_200_VII.this.setNew = CockpitMC_200_VII.this.setTmp;
                CockpitMC_200_VII.this.setNew.throttle = (0.85F * CockpitMC_200_VII.this.setOld.throttle) + (CockpitMC_200_VII.this.fm.CT.PowerControl * 0.15F);
                CockpitMC_200_VII.this.setNew.prop = (0.85F * CockpitMC_200_VII.this.setOld.prop) + (CockpitMC_200_VII.this.fm.CT.getStepControl() * 0.15F);
                CockpitMC_200_VII.this.setNew.altimeter = CockpitMC_200_VII.this.fm.getAltitude();
                float f = CockpitMC_200_VII.this.waypointAzimuth();
                CockpitMC_200_VII.this.setNew.waypointAzimuth.setDeg(CockpitMC_200_VII.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitMC_200_VII.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitMC_200_VII.this.fm.Or.getKren()) < 30F) {
                    CockpitMC_200_VII.this.setNew.azimuth.setDeg(CockpitMC_200_VII.this.setOld.azimuth.getDeg(1.0F), CockpitMC_200_VII.this.fm.Or.azimut());
                }
                CockpitMC_200_VII.this.setNew.vspeed = ((199F * CockpitMC_200_VII.this.setOld.vspeed) + CockpitMC_200_VII.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 550F, 0.0F, 10F), CockpitMC_200_VII.speedometerScale), 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 50F, 550F, 0.0F, 10F), CockpitMC_200_VII.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_OilTemp1", 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 150F, 0.0F, 4F), CockpitMC_200_VII.oilTempScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_FuelPress1", 0.0F, -this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.32F, 0.0F, 1.0F, 0.0F, 301.5F), 0.0F);
