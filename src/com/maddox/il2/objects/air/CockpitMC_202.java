...
public class CockpitMC_202 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitMC_202.this.fm != null) {
                CockpitMC_202.this.setTmp = CockpitMC_202.this.setOld;
                CockpitMC_202.this.setOld = CockpitMC_202.this.setNew;
                CockpitMC_202.this.setNew = CockpitMC_202.this.setTmp;
                ...
                CockpitMC_202.this.setNew.waypointAzimuth.setDeg(CockpitMC_202.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitMC_202.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitMC_202.this.fm.Or.getKren()) < 30F) {
                    CockpitMC_202.this.setNew.azimuth.setDeg(CockpitMC_202.this.setOld.azimuth.getDeg(1.0F), CockpitMC_202.this.fm.Or.azimut());
                }
                CockpitMC_202.this.setNew.vspeed = ((199F * CockpitMC_202.this.setOld.vspeed) + CockpitMC_202.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 700F, 0.0F, 12F), CockpitMC_202.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_EngTemp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 30F, 130F, 0.0F, 10F), CockpitMC_202.waterTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_OilTemp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 150F, 0.0F, 4F), CockpitMC_202.oilTempScale), 0.0F, 0.0F);
