...
public class CockpitMC_205 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitMC_205.this.fm != null) {
                CockpitMC_205.this.setTmp = CockpitMC_205.this.setOld;
                CockpitMC_205.this.setOld = CockpitMC_205.this.setNew;
                CockpitMC_205.this.setNew = CockpitMC_205.this.setTmp;
                CockpitMC_205.this.setNew.throttle = (0.85F * CockpitMC_205.this.setOld.throttle) + (CockpitMC_205.this.fm.CT.PowerControl * 0.15F);
                CockpitMC_205.this.setNew.prop = (0.85F * CockpitMC_205.this.setOld.prop) + (CockpitMC_205.this.fm.CT.getStepControl() * 0.15F);
                CockpitMC_205.this.setNew.altimeter = CockpitMC_205.this.fm.getAltitude();
                float f = CockpitMC_205.this.waypointAzimuth();
                CockpitMC_205.this.setNew.waypointAzimuth.setDeg(CockpitMC_205.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitMC_205.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitMC_205.this.fm.Or.getKren()) < 30F) {
                    CockpitMC_205.this.setNew.azimuth.setDeg(CockpitMC_205.this.setOld.azimuth.getDeg(1.0F), CockpitMC_205.this.fm.Or.azimut());
                }
                CockpitMC_205.this.setNew.vspeed = ((199F * CockpitMC_205.this.setOld.vspeed) + CockpitMC_205.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 700F, 0.0F, 12F), CockpitMC_205.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_EngTemp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 30F, 130F, 0.0F, 10F), CockpitMC_205.waterTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_OilTemp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 150F, 0.0F, 4F), CockpitMC_205.oilTempScale), 0.0F, 0.0F);
