...
public class CockpitME_163 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitME_163.this.bNeedSetUp) {
                ...
                CockpitME_163.this.bNeedSetUp = false;
            }
            if (CockpitME_163.this.fm != null) {
                CockpitME_163.this.setTmp = CockpitME_163.this.setOld;
                CockpitME_163.this.setOld = CockpitME_163.this.setNew;
                CockpitME_163.this.setNew = CockpitME_163.this.setTmp;
                if (Math.abs(CockpitME_163.this.fm.Or.getKren()) < 30F) {
                    CockpitME_163.this.setNew.azimuth.setDeg(CockpitME_163.this.setOld.azimuth.getDeg(1.0F), CockpitME_163.this.fm.Or.azimut());
                }
                CockpitME_163.this.setNew.vspeed = ((98F * CockpitME_163.this.setOld.vspeed) + CockpitME_163.this.fm.getVertSpeed()) / 99F;
                ...
                if (CockpitME_163.this.cockpitDimControl) {
                    if (CockpitME_163.this.setNew.dimPosition > 0.0F) {
                        CockpitME_163.this.setNew.dimPosition = CockpitME_163.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitME_163.this.setNew.dimPosition < 1.0F) {
                    CockpitME_163.this.setNew.dimPosition = CockpitME_163.this.setOld.dimPosition + 0.05F;
                }
            }
            return true;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (!((ME_163B1A) this.aircraft()).bCartAttached) {
        ...
        this.mesh.chunkSetAngles("Z_Speed1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 400F, 2.0F, 8F), CockpitME_163.speedometerIndScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speed2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 100F, 1000F, 1.0F, 10F), CockpitME_163.speedometerTruScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("RPM", this.floatindex(this.cvt(this.pictTurbo = (0.92F * this.pictTurbo) + (0.08F * f1), 2000F, 14000F, 2.0F, 14F), CockpitME_163.rpmScale), 0.0F, 0.0F);
