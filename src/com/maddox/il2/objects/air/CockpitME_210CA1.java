...
public class CockpitME_210CA1 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if ((ME_210CA1) CockpitME_210CA1.this.aircraft() != null) {

            }
            if (ME_210CA1.bChangedPit) {
                CockpitME_210CA1.this.reflectPlaneToModel();
                if ((ME_210CA1) CockpitME_210CA1.this.aircraft() != null) {

                }
                ME_210CA1.bChangedPit = false;
            }
            CockpitME_210CA1.this.setTmp = CockpitME_210CA1.this.setOld;
            CockpitME_210CA1.this.setOld = CockpitME_210CA1.this.setNew;
            CockpitME_210CA1.this.setNew = CockpitME_210CA1.this.setTmp;
            CockpitME_210CA1.this.setNew.altimeter = CockpitME_210CA1.this.fm.getAltitude();
            if (CockpitME_210CA1.this.cockpitDimControl) {
                if (CockpitME_210CA1.this.setNew.dimPosition > 0.0F) {
                    CockpitME_210CA1.this.setNew.dimPosition = CockpitME_210CA1.this.setNew.dimPosition - 0.05F;
                }
            } else if (CockpitME_210CA1.this.setNew.dimPosition < 1.0F) {
                CockpitME_210CA1.this.setNew.dimPosition = CockpitME_210CA1.this.setNew.dimPosition + 0.05F;
            }
            CockpitME_210CA1.this.setNew.throttle1 = (0.91F * CockpitME_210CA1.this.setOld.throttle1) + (0.09F * CockpitME_210CA1.this.fm.EI.engines[0].getControlThrottle());
            CockpitME_210CA1.this.setNew.throttle2 = (0.91F * CockpitME_210CA1.this.setOld.throttle2) + (0.09F * CockpitME_210CA1.this.fm.EI.engines[1].getControlThrottle());
            CockpitME_210CA1.this.setNew.mix1 = (0.88F * CockpitME_210CA1.this.setOld.mix1) + (0.12F * CockpitME_210CA1.this.fm.EI.engines[0].getControlMix());
            CockpitME_210CA1.this.setNew.mix2 = (0.88F * CockpitME_210CA1.this.setOld.mix2) + (0.12F * CockpitME_210CA1.this.fm.EI.engines[1].getControlMix());
            CockpitME_210CA1.this.setNew.waypointAzimuth.setDeg(CockpitME_210CA1.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitME_210CA1.this.waypointAzimuth() - CockpitME_210CA1.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitME_210CA1.this.fm.Or.getKren()) < 30F) {
                CockpitME_210CA1.this.setNew.azimuth.setDeg(CockpitME_210CA1.this.setOld.azimuth.getDeg(1.0F), CockpitME_210CA1.this.fm.Or.azimut());
            }
            Variables variables = CockpitME_210CA1.this.setNew;
            float f = 0.9F * CockpitME_210CA1.this.setOld.radioalt;
            float f1 = 0.1F;
            float f2 = CockpitME_210CA1.this.fm.getAltitude();
            World.cur();
            World.land();
            variables.radioalt = f + (f1 * (f2 - Landscape.HQ_Air((float) CockpitME_210CA1.this.fm.Loc.x, (float) CockpitME_210CA1.this.fm.Loc.y)));
            CockpitME_210CA1.this.setNew.vspeed = ((199F * CockpitME_210CA1.this.setOld.vspeed) + CockpitME_210CA1.this.fm.getVertSpeed()) / 200F;
            CockpitME_210CA1.this.middleAngle = (CockpitME_210CA1.this.middleAngleTarget * 0.05F) + (0.95F * CockpitME_210CA1.this.middleAngle);
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 12F), CockpitME_210CA1.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speed1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitME_210CA1.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitME_210CA1.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitME_210CA1.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Oiltemp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 120F, 0.0F, 8F), CockpitME_210CA1.oilTScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Oiltemp2", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 40F, 120F, 0.0F, 8F), CockpitME_210CA1.oilTScale), 0.0F, 0.0F);
    }
