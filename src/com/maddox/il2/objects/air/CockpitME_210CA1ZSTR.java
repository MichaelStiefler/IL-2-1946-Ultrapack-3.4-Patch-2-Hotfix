...
public class CockpitME_210CA1ZSTR extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            CockpitME_210CA1ZSTR.this.setNew.altimeter = CockpitME_210CA1ZSTR.this.fm.getAltitude();
            ...
            CockpitME_210CA1ZSTR.this.setNew.throttle1 = (0.91F * CockpitME_210CA1ZSTR.this.setOld.throttle1) + (0.09F * CockpitME_210CA1ZSTR.this.fm.EI.engines[0].getControlThrottle());
            CockpitME_210CA1ZSTR.this.setNew.throttle2 = (0.91F * CockpitME_210CA1ZSTR.this.setOld.throttle2) + (0.09F * CockpitME_210CA1ZSTR.this.fm.EI.engines[1].getControlThrottle());
            CockpitME_210CA1ZSTR.this.setNew.mix1 = (0.88F * CockpitME_210CA1ZSTR.this.setOld.mix1) + (0.12F * CockpitME_210CA1ZSTR.this.fm.EI.engines[0].getControlMix());
            CockpitME_210CA1ZSTR.this.setNew.mix2 = (0.88F * CockpitME_210CA1ZSTR.this.setOld.mix2) + (0.12F * CockpitME_210CA1ZSTR.this.fm.EI.engines[1].getControlMix());
            CockpitME_210CA1ZSTR.this.setNew.waypointAzimuth.setDeg(CockpitME_210CA1ZSTR.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitME_210CA1ZSTR.this.waypointAzimuth() - CockpitME_210CA1ZSTR.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitME_210CA1ZSTR.this.fm.Or.getKren()) < 30F) {
                CockpitME_210CA1ZSTR.this.setNew.azimuth.setDeg(CockpitME_210CA1ZSTR.this.setOld.azimuth.getDeg(1.0F), CockpitME_210CA1ZSTR.this.fm.Or.azimut());
            }
            ...
            World.cur();
            World.land();
            variables.radioalt = f + (f1 * (f2 - Landscape.HQ_Air((float) CockpitME_210CA1ZSTR.this.fm.Loc.x, (float) CockpitME_210CA1ZSTR.this.fm.Loc.y)));
            CockpitME_210CA1ZSTR.this.setNew.vspeed = ((199F * CockpitME_210CA1ZSTR.this.setOld.vspeed) + CockpitME_210CA1ZSTR.this.fm.getVertSpeed()) / 200F;
            CockpitME_210CA1ZSTR.this.middleAngle = (CockpitME_210CA1ZSTR.this.middleAngleTarget * 0.05F) + (0.95F * CockpitME_210CA1ZSTR.this.middleAngle);
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 12F), CockpitME_210CA1ZSTR.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speed1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitME_210CA1ZSTR.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitME_210CA1ZSTR.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitME_210CA1ZSTR.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Oiltemp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 120F, 0.0F, 8F), CockpitME_210CA1ZSTR.oilTScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Oiltemp2", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 40F, 120F, 0.0F, 8F), CockpitME_210CA1ZSTR.oilTScale), 0.0F, 0.0F);
    }
