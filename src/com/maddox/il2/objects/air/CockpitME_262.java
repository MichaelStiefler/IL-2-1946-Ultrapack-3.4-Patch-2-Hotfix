...
public class CockpitME_262 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            CockpitME_262.this.setTmp = CockpitME_262.this.setOld;
            CockpitME_262.this.setOld = CockpitME_262.this.setNew;
            CockpitME_262.this.setNew = CockpitME_262.this.setTmp;
            CockpitME_262.this.setNew.altimeter = CockpitME_262.this.fm.getAltitude();
            CockpitME_262.this.setNew.throttlel = ((10F * CockpitME_262.this.setOld.throttlel) + CockpitME_262.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitME_262.this.setNew.throttler = ((10F * CockpitME_262.this.setOld.throttler) + CockpitME_262.this.fm.EI.engines[1].getControlThrottle()) / 11F;
            ...
            if (Math.abs(CockpitME_262.this.fm.Or.getKren()) < 30F) {
                CockpitME_262.this.setNew.azimuth.setDeg(CockpitME_262.this.setOld.azimuth.getDeg(1.0F), CockpitME_262.this.fm.Or.azimut());
            }
            CockpitME_262.this.setNew.vspeed = ((299F * CockpitME_262.this.setOld.vspeed) + CockpitME_262.this.fm.getVertSpeed()) / 300F;
            if (CockpitME_262.this.cockpitDimControl) {
                if (CockpitME_262.this.setNew.dimPosition > 0.0F) {
                    CockpitME_262.this.setNew.dimPosition = CockpitME_262.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitME_262.this.setNew.dimPosition < 1.0F) {
                CockpitME_262.this.setNew.dimPosition = CockpitME_262.this.setOld.dimPosition + 0.05F;
            }
            CockpitME_262.this.setNew.beaconDirection = ((10F * CockpitME_262.this.setOld.beaconDirection) + CockpitME_262.this.getBeaconDirection()) / 11F;
            CockpitME_262.this.setNew.beaconRange = ((10F * CockpitME_262.this.setOld.beaconRange) + CockpitME_262.this.getBeaconRange()) / 11F;
            return true;
        }
...
//        this.tmpV = new Vector3d();
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 400F, 2.0F, 8F), CockpitME_262.speedometerIndScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 100F, 1000F, 1.0F, 10F), CockpitME_262.speedometerTruScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -20F, 50F, 0.0F, 14F), CockpitME_262.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPML", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitME_262.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPMR", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitME_262.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_FuelRemainV", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), CockpitME_262.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelRemainIn", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), CockpitME_262.fuelScale), 0.0F, 0.0F);
...
//        System.out.println("lLBL=" + this.aircraft().FM.AS.listenLorenzBlindLanding + ", uRNI=" + this.useRealisticNavigationInstruments() + ", hB=" + Main.cur().mission.hasBeacons(this.fm.actor.getArmy()) + ", bDir=" + this.setNew.beaconDirection + ", bRng=" + this.setNew.beaconRange);
    }
