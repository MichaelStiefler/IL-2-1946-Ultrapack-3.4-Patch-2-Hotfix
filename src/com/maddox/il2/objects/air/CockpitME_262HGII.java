...
public class CockpitME_262HGII extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            CockpitME_262HGII.this.setTmp = CockpitME_262HGII.this.setOld;
            CockpitME_262HGII.this.setOld = CockpitME_262HGII.this.setNew;
            CockpitME_262HGII.this.setNew = CockpitME_262HGII.this.setTmp;
            CockpitME_262HGII.this.setNew.altimeter = CockpitME_262HGII.this.fm.getAltitude();
            CockpitME_262HGII.this.setNew.throttlel = ((10F * CockpitME_262HGII.this.setOld.throttlel) + CockpitME_262HGII.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitME_262HGII.this.setNew.throttler = ((10F * CockpitME_262HGII.this.setOld.throttler) + CockpitME_262HGII.this.fm.EI.engines[1].getControlThrottle()) / 11F;
            float f = CockpitME_262HGII.this.waypointAzimuth();
            if (CockpitME_262HGII.this.useRealisticNavigationInstruments()) {
                CockpitME_262HGII.this.setNew.waypointAzimuth.setDeg(f - 90F);
                CockpitME_262HGII.this.setOld.waypointAzimuth.setDeg(f - 90F);
            } else {
                CockpitME_262HGII.this.setNew.waypointAzimuth.setDeg(CockpitME_262HGII.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitME_262HGII.this.setOld.azimuth.getDeg(1.0F));
            }
            if (Math.abs(CockpitME_262HGII.this.fm.Or.getKren()) < 30F) {
                CockpitME_262HGII.this.setNew.azimuth.setDeg(CockpitME_262HGII.this.setOld.azimuth.getDeg(1.0F), CockpitME_262HGII.this.fm.Or.azimut());
            }
            CockpitME_262HGII.this.setNew.vspeed = ((299F * CockpitME_262HGII.this.setOld.vspeed) + CockpitME_262HGII.this.fm.getVertSpeed()) / 300F;
            if (CockpitME_262HGII.this.cockpitDimControl) {
                if (CockpitME_262HGII.this.setNew.dimPosition > 0.0F) {
                    CockpitME_262HGII.this.setNew.dimPosition = CockpitME_262HGII.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitME_262HGII.this.setNew.dimPosition < 1.0F) {
                CockpitME_262HGII.this.setNew.dimPosition = CockpitME_262HGII.this.setOld.dimPosition + 0.05F;
            }
            CockpitME_262HGII.this.setNew.beaconDirection = ((10F * CockpitME_262HGII.this.setOld.beaconDirection) + CockpitME_262HGII.this.getBeaconDirection()) / 11F;
            CockpitME_262HGII.this.setNew.beaconRange = ((10F * CockpitME_262HGII.this.setOld.beaconRange) + CockpitME_262HGII.this.getBeaconRange()) / 11F;
            return true;
        }
    ...
    public CockpitME_262HGII() {
        super("3DO/Cockpit/Me-262HG-II/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 400F, 2.0F, 8F), CockpitME_262HGII.speedometerIndScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 100F, 1000F, 1.0F, 10F), CockpitME_262HGII.speedometerTruScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -20F, 50F, 0.0F, 14F), CockpitME_262HGII.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPML", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitME_262HGII.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPMR", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitME_262HGII.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_FuelRemainV", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), CockpitME_262HGII.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelRemainIn", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), CockpitME_262HGII.fuelScale), 0.0F, 0.0F);
