...
public class CockpitME_262HGIV extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            CockpitME_262HGIV.this.setTmp = CockpitME_262HGIV.this.setOld;
            CockpitME_262HGIV.this.setOld = CockpitME_262HGIV.this.setNew;
            CockpitME_262HGIV.this.setNew = CockpitME_262HGIV.this.setTmp;
            CockpitME_262HGIV.this.setNew.altimeter = CockpitME_262HGIV.this.fm.getAltitude();
            CockpitME_262HGIV.this.setNew.throttlel = ((10F * CockpitME_262HGIV.this.setOld.throttlel) + CockpitME_262HGIV.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitME_262HGIV.this.setNew.throttler = ((10F * CockpitME_262HGIV.this.setOld.throttler) + CockpitME_262HGIV.this.fm.EI.engines[1].getControlThrottle()) / 11F;
            float f = CockpitME_262HGIV.this.waypointAzimuth();
            if (CockpitME_262HGIV.this.useRealisticNavigationInstruments()) {
                CockpitME_262HGIV.this.setNew.waypointAzimuth.setDeg(f - 90F);
                CockpitME_262HGIV.this.setOld.waypointAzimuth.setDeg(f - 90F);
            } else {
                CockpitME_262HGIV.this.setNew.waypointAzimuth.setDeg(CockpitME_262HGIV.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitME_262HGIV.this.setOld.azimuth.getDeg(1.0F));
            }
            if (Math.abs(CockpitME_262HGIV.this.fm.Or.getKren()) < 30F) {
                CockpitME_262HGIV.this.setNew.azimuth.setDeg(CockpitME_262HGIV.this.setOld.azimuth.getDeg(1.0F), CockpitME_262HGIV.this.fm.Or.azimut());
            }
            CockpitME_262HGIV.this.setNew.vspeed = ((299F * CockpitME_262HGIV.this.setOld.vspeed) + CockpitME_262HGIV.this.fm.getVertSpeed()) / 300F;
            if (CockpitME_262HGIV.this.cockpitDimControl) {
                if (CockpitME_262HGIV.this.setNew.dimPosition > 0.0F) {
                    CockpitME_262HGIV.this.setNew.dimPosition = CockpitME_262HGIV.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitME_262HGIV.this.setNew.dimPosition < 1.0F) {
                CockpitME_262HGIV.this.setNew.dimPosition = CockpitME_262HGIV.this.setOld.dimPosition + 0.05F;
            }
            CockpitME_262HGIV.this.setNew.beaconDirection = ((10F * CockpitME_262HGIV.this.setOld.beaconDirection) + CockpitME_262HGIV.this.getBeaconDirection()) / 11F;
            CockpitME_262HGIV.this.setNew.beaconRange = ((10F * CockpitME_262HGIV.this.setOld.beaconRange) + CockpitME_262HGIV.this.getBeaconRange()) / 11F;
            return true;
        }
    ...
    protected float waypointAzimuth() {
        return this.waypointAzimuthInvert(30F);
    }
    ...
    public CockpitME_262HGIV() {
        super("3DO/Cockpit/Me-262HG-II/hierHGIV.him", "he111");
        ...
        this.limits6DoF = (new float[] { 0.7F, 0.055F, -0.07F, 0.13F, 0.15F, -0.11F, 0.01F, -0.05F });
    }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 400F, 2.0F, 8F), CockpitME_262HGIV.speedometerIndScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 100F, 1000F, 1.0F, 10F), CockpitME_262HGIV.speedometerTruScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -20F, 50F, 0.0F, 14F), CockpitME_262HGIV.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPML", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitME_262HGIV.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPMR", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitME_262HGIV.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_GasTempL", this.cvt(this.fm.EI.engines[0].tWaterOut, 300F, 1000F, -2F, 92.5F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_GasTempR", this.cvt(this.fm.EI.engines[1].tWaterOut, 300F, 1000F, -2F, 92.5F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_FuelRemainV", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), CockpitME_262HGIV.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelRemainIn", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), CockpitME_262HGIV.fuelScale), 0.0F, 0.0F);
