...
public class CockpitME_262HG_VB extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            CockpitME_262HG_VB.this.setTmp = CockpitME_262HG_VB.this.setOld;
            CockpitME_262HG_VB.this.setOld = CockpitME_262HG_VB.this.setNew;
            CockpitME_262HG_VB.this.setNew = CockpitME_262HG_VB.this.setTmp;
            CockpitME_262HG_VB.this.setNew.altimeter = CockpitME_262HG_VB.this.fm.getAltitude();
            CockpitME_262HG_VB.this.setNew.throttlel = ((10F * CockpitME_262HG_VB.this.setOld.throttlel) + CockpitME_262HG_VB.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitME_262HG_VB.this.setNew.throttler = ((10F * CockpitME_262HG_VB.this.setOld.throttler) + CockpitME_262HG_VB.this.fm.EI.engines[1].getControlThrottle()) / 11F;
            float f = CockpitME_262HG_VB.this.waypointAzimuth();
            if (BaseGameVersion.is410orLater() && CockpitME_262HG_VB.this.useRealisticNavigationInstruments()) {
                CockpitME_262HG_VB.this.setNew.waypointAzimuth.setDeg(f - 90F);
                CockpitME_262HG_VB.this.setOld.waypointAzimuth.setDeg(f - 90F);
            } else {
                CockpitME_262HG_VB.this.setNew.waypointAzimuth.setDeg(CockpitME_262HG_VB.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitME_262HG_VB.this.setOld.azimuth.getDeg(1.0F));
            }
            if (Math.abs(CockpitME_262HG_VB.this.fm.Or.getKren()) < 30F) {
                CockpitME_262HG_VB.this.setNew.azimuth.setDeg(CockpitME_262HG_VB.this.setOld.azimuth.getDeg(1.0F), CockpitME_262HG_VB.this.fm.Or.azimut());
            }
            CockpitME_262HG_VB.this.setNew.vspeed = ((299F * CockpitME_262HG_VB.this.setOld.vspeed) + CockpitME_262HG_VB.this.fm.getVertSpeed()) / 300F;
            if (CockpitME_262HG_VB.this.cockpitDimControl) {
                if (CockpitME_262HG_VB.this.setNew.dimPosition > 0.0F) {
                    CockpitME_262HG_VB.this.setNew.dimPosition = CockpitME_262HG_VB.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitME_262HG_VB.this.setNew.dimPosition < 1.0F) {
                CockpitME_262HG_VB.this.setNew.dimPosition = CockpitME_262HG_VB.this.setOld.dimPosition + 0.05F;
            }
            if (BaseGameVersion.is410orLater()) {
                CockpitME_262HG_VB.this.setNew.beaconDirection = ((10F * CockpitME_262HG_VB.this.setOld.beaconDirection) + CockpitME_262HG_VB.this.getBeaconDirection()) / 11F;
                CockpitME_262HG_VB.this.setNew.beaconRange = ((10F * CockpitME_262HG_VB.this.setOld.beaconRange) + CockpitME_262HG_VB.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public CockpitME_262HG_VB() {
        super("3DO/Cockpit/Me-262HG-VB/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.resetYPRmodifier();
// mesh.chunkSetAngles("Canopy", 0.0F, 0.0F, -100F * fm.CT.getCockpitDoor());
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 400F, 2.0F, 8F), CockpitME_262HG_VB.speedometerIndScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 100F, 1000F, 1.0F, 10F), CockpitME_262HG_VB.speedometerTruScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -20F, 50F, 0.0F, 14F), CockpitME_262HG_VB.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPML", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitME_262HG_VB.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPMR", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitME_262HG_VB.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_FuelRemainV", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), CockpitME_262HG_VB.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelRemainIn", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), CockpitME_262HG_VB.fuelScale), 0.0F, 0.0F);
