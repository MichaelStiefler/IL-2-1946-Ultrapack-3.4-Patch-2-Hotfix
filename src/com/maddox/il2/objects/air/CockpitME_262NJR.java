...
public class CockpitME_262NJR extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            CockpitME_262NJR.this.setTmp = CockpitME_262NJR.this.setOld;
            CockpitME_262NJR.this.setOld = CockpitME_262NJR.this.setNew;
            CockpitME_262NJR.this.setNew = CockpitME_262NJR.this.setTmp;
            CockpitME_262NJR.this.setNew.altimeter = CockpitME_262NJR.this.fm.getAltitude();
            CockpitME_262NJR.this.setNew.throttlel = ((10F * CockpitME_262NJR.this.setOld.throttlel) + CockpitME_262NJR.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitME_262NJR.this.setNew.throttler = ((10F * CockpitME_262NJR.this.setOld.throttler) + CockpitME_262NJR.this.fm.EI.engines[1].getControlThrottle()) / 11F;
            float f = CockpitME_262NJR.this.waypointAzimuth();
            if (CockpitME_262NJR.this.useRealisticNavigationInstruments()) {
                CockpitME_262NJR.this.setNew.waypointAzimuth.setDeg(f - 90F);
                CockpitME_262NJR.this.setOld.waypointAzimuth.setDeg(f - 90F);
            } else {
                CockpitME_262NJR.this.setNew.waypointAzimuth.setDeg(CockpitME_262NJR.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitME_262NJR.this.setOld.azimuth.getDeg(1.0F));
            }
            if (Math.abs(CockpitME_262NJR.this.fm.Or.getKren()) < 30F) {
                CockpitME_262NJR.this.setNew.azimuth.setDeg(CockpitME_262NJR.this.setOld.azimuth.getDeg(1.0F), CockpitME_262NJR.this.fm.Or.azimut());
            }
            CockpitME_262NJR.this.setNew.vspeed = ((299F * CockpitME_262NJR.this.setOld.vspeed) + CockpitME_262NJR.this.fm.getVertSpeed()) / 300F;
            if (CockpitME_262NJR.this.cockpitDimControl) {
                if (CockpitME_262NJR.this.setNew.dimPosition > 0.0F) {
                    CockpitME_262NJR.this.setNew.dimPosition = CockpitME_262NJR.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitME_262NJR.this.setNew.dimPosition < 1.0F) {
                CockpitME_262NJR.this.setNew.dimPosition = CockpitME_262NJR.this.setOld.dimPosition + 0.05F;
            }
            CockpitME_262NJR.this.setNew.beaconDirection = ((10F * CockpitME_262NJR.this.setOld.beaconDirection) + CockpitME_262NJR.this.getBeaconDirection()) / 11F;
            CockpitME_262NJR.this.setNew.beaconRange = ((10F * CockpitME_262NJR.this.setOld.beaconRange) + CockpitME_262NJR.this.getBeaconRange()) / 11F;
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.fm.isTick(44, 0)) {
            ...
            if (!(((Aircraft) this.fm.actor).getGunByHookName("_CANNON05") instanceof GunEmpty)) {
                this.mesh.chunkVisible("Z_GunLamp02", !this.gun[4].haveBullets());
            } else {
                this.mesh.chunkVisible("Z_GunLamp02", !this.gun[1].haveBullets());
            }
            if (!(((Aircraft) this.fm.actor).getGunByHookName("_CANNON06") instanceof GunEmpty)) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 400F, 2.0F, 8F), CockpitME_262NJR.speedometerIndScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 100F, 1000F, 1.0F, 10F), CockpitME_262NJR.speedometerTruScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer1R", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 400F, 2.0F, 8F), CockpitME_262NJR.speedometerIndScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2R", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 100F, 1000F, 1.0F, 10F), CockpitME_262NJR.speedometerTruScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -20F, 50F, 0.0F, 14F), CockpitME_262NJR.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Climb1R", this.floatindex(this.cvt(this.setNew.vspeed, -20F, 50F, 0.0F, 14F), CockpitME_262NJR.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPML", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitME_262NJR.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPMR", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitME_262NJR.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_FuelRemainV", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), CockpitME_262NJR.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelRemainIn", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), CockpitME_262NJR.fuelScale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitME_262NJR.class, "astatePilotIndx", 1);
    }
