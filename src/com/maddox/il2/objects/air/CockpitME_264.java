...
public class CockpitME_264 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitME_264.this.fm != null) {
                ...
                CockpitME_264.this.setNew.beaconDirection = ((10F * CockpitME_264.this.setOld.beaconDirection) + CockpitME_264.this.getBeaconDirection()) / 11F;
                CockpitME_264.this.setNew.beaconRange = ((10F * CockpitME_264.this.setOld.beaconRange) + CockpitME_264.this.getBeaconRange()) / 11F;
                if (CockpitME_264.this.useRealisticNavigationInstruments()) {
                    ...
                    CockpitME_264.this.setNew.radioCompassAzimuth.setDeg(CockpitME_264.this.setOld.radioCompassAzimuth.getDeg(0.02F), CockpitME_264.this.radioCompassAzimuthInvertMinus() - CockpitME_264.this.setOld.azimuth.getDeg(1.0F) - 90F);
                } else {
                    CockpitME_264.this.setNew.waypointAzimuth.setDeg(CockpitME_264.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitME_264.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitME_264.this.fm.Or.getKren()) < 30F) {
                    CockpitME_264.this.setNew.azimuth.setDeg(CockpitME_264.this.setOld.azimuth.getDeg(1.0F), CockpitME_264.this.fm.Or.azimut());
                }
                CockpitME_264.this.setNew.pictAiler = (0.85F * CockpitME_264.this.setOld.pictAiler) + (0.15F * CockpitME_264.this.cvt(CockpitME_264.this.fm.CT.AileronControl, -1F, 1.0F, -1F, 1.0F));
                CockpitME_264.this.setNew.pictElev = (0.85F * CockpitME_264.this.setOld.pictElev) + (0.15F * CockpitME_264.this.cvt(CockpitME_264.this.fm.CT.ElevatorControl, -1F, 1.0F, -1F, 1.0F));
                CockpitME_264.this.setNew.elevTrim = (0.85F * CockpitME_264.this.setOld.elevTrim) + (0.15F * CockpitME_264.this.fm.CT.trimElevator);
                CockpitME_264.this.setNew.rudderTrim = (0.85F * CockpitME_264.this.setOld.rudderTrim) + (0.15F * CockpitME_264.this.fm.CT.trimRudder);
                CockpitME_264.this.setNew.ailTrim = (0.85F * CockpitME_264.this.setOld.ailTrim) + (0.15F * CockpitME_264.this.fm.CT.trimAileron);

                float fCons = 0F;
                for (int engineIndex = 0; engineIndex < 4; engineIndex++) {
                    CockpitME_264.this.setNew.throttle[engineIndex] = (0.85F * CockpitME_264.this.setOld.throttle[engineIndex]) + (CockpitME_264.this.fm.EI.engines[engineIndex].getControlThrottle() * 0.15F);
                    if (Math.toDegrees(CockpitME_264.this.fm.EI.engines[engineIndex].getPropPhi()) < 36D) {
                        CockpitME_264.this.setNew.prop[engineIndex] = (0.85F * CockpitME_264.this.setOld.prop[engineIndex]) + (((FlightModelMain) CockpitME_264.this.fm).EI.engines[engineIndex].getControlProp() * 0.15F);
                        CockpitME_264.this.setNew._prop[engineIndex] = CockpitME_264.this.cvt(CockpitME_264.this.setNew.prop[engineIndex], 0.0F, 1.0F, -22F, -63F);
                    } else {
                        CockpitME_264.this.setNew.prop[engineIndex] = 0.85F * CockpitME_264.this.setOld.prop[engineIndex];
                        CockpitME_264.this.setNew._prop[engineIndex] = CockpitME_264.this.cvt(CockpitME_264.this.setNew.prop[engineIndex], 0.0F, 1.0F, 0.0F, -63F);
                    }
                    CockpitME_264.this.setNew.pictManf[engineIndex] = (0.95F * CockpitME_264.this.setOld.pictManf[engineIndex]) + (0.05F * CockpitME_264.this.fm.EI.engines[engineIndex].getManifoldPressure());
                ...
                CockpitME_264.this.setNew.turn = ((12F * CockpitME_264.this.setOld.turn) + CockpitME_264.this.w.z) / 13F;
                CockpitME_264.this.setNew.altimeter = (0.85F * CockpitME_264.this.setOld.altimeter) + (CockpitME_264.this.fm.getAltitude() * 0.15F);
                CockpitME_264.this.setNew.vspeed = ((99F * CockpitME_264.this.setOld.vspeed) + CockpitME_264.this.fm.getVertSpeed()) / 100F;
                ...
                if ((f1 > 55F) || (f1 < -55F) || (f2 < -55F) || (f2 > 55F)) {
                    ...
                    CockpitME_264.this.Pn.z = CockpitME_264.this.fm.getAltitude() - Engine.cur.land.HQ(((Tuple3d) CockpitME_264.this.Pn).x, ((Tuple3d) CockpitME_264.this.Pn).y);
                    ...
                    CockpitME_264.this.Pn.z = (float) Math.sqrt((d * d) + (d1 * d1) + (CockpitME_264.this.Pn.z * CockpitME_264.this.Pn.z));
                    if (CockpitME_264.this.fm.CT.getGear() > 0.5F) {
                        CockpitME_264.this.Pn.z = CockpitME_264.this.cvt((float) CockpitME_264.this.Pn.z, 0.0F, 150F, 0.0F, 250F);
                    } else {
                        CockpitME_264.this.Pn.z = CockpitME_264.this.cvt((float) CockpitME_264.this.Pn.z, 0.0F, 750F, 0.0F, 250F);
                    }
                }
                CockpitME_264.this.setNew.AFN101 = (0.9F * CockpitME_264.this.setOld.AFN101) + (0.1F * (float) CockpitME_264.this.Pn.z);
                ...
                CockpitME_264.this.setNew.consumption = (0.9F * CockpitME_264.this.setOld.consumption) + ((0.1F * ((f6 * fCons) / 4F)) / (fCons + 1.0F));
                CockpitME_264.this.setNew.bombDoor = (0.9F * CockpitME_264.this.setOld.bombDoor) + (0.1F * CockpitME_264.this.fm.CT.getBayDoor());
            }
            return true;
        }
    ...
    public CockpitME_264() {
        ...
        this.w = new Vector3f();
        this.Pn = new Point3d();
        this.cockpitNightMats = new String[] { "CompGrad", "Fl20274", "Fl20342na", "Fl20342", "Fl20516", "Fl20556", "Fl20570", "Fl20572", "Fl20723_1185", "Fl20723_1850", "Fl20723_200na", "Fl20723_200", "Fl20723_640", "Fl20841", "Fl22231", "Fl22316", "Fl22320", "Fl22334b", "Fl22334c", "Fl22382", "Fl22412", "Fl22413", "Fl22561", "Fl23885na", "Fl23885", "Fl30489", "Fl30532", "Fl32336", "Gauge19", "Gauge20", "Ln27002", "Ln28330b", "Ln28330", "NeedlesnLights", "Nr92182B1na", "Voltmeters" };
        this.hidePilot = true;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkVisible("F_AllGearsDown", (gearL == 1.0F) && (gearR == 1.0F) && this.fm.Gears.lgear && this.fm.Gears.rgear);
        ...
        this.mesh.chunkSetAngles("Z_Gears", (gearL != 1.0F) || (gearR != 1.0F) || !this.fm.Gears.lgear || !this.fm.Gears.rgear ? 0.0F : 90F, 0.0F, 0.0F);
        ...
        for (int engineIndex = 1; engineIndex < 5; engineIndex++) {
            ...
            this.mesh.chunkSetAngles("Z_N_AiFuePress" + engineIndex, -this.cvt(this.setNew.pictManf[engineIndex - 1], 0.6F, 1.8F, 0.0F, 330F), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("Z_N_RPM" + engineIndex, -this.floatindex(this.cvt(this.fm.EI.engines[engineIndex - 1].getRPM(), 400F, 3600F, 0.0F, 32F), CockpitME_264.Fl20274_Scale), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("Z_N_E" + engineIndex + "CoolTemp", -this.floatindex(this.cvt(this.fm.EI.engines[engineIndex - 1].tWaterOut, 0.0F, 130F, 0.0F, 13F), CockpitME_264.Fl20342_Scale), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("Z_N_E" + engineIndex + "OilTemp", -this.floatindex(this.cvt(this.fm.EI.engines[engineIndex - 1].tOilOut, 0.0F, 130F, 0.0F, 13F), CockpitME_264.Fl20342_Scale), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("Z_N_E" + engineIndex + "_OilPress", this.cvt(1.0F + (0.05F * this.fm.EI.engines[engineIndex - 1].tOilOut), 0.0F, 10F, 0.0F, 183F), 0.0F, 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_N_AirSpeed1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 750F, 0.0F, 15F), CockpitME_264.IAS_Scale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_N_AirSpeed2", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 750F, 0.0F, 15F), CockpitME_264.IAS_Scale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_N_FuelConsom", -this.cvt(0.5F * this.setNew.consumption, 0.0F, 500F, 0.0F, 255.5F), 0.0F, 0.0F);
//		int i = ((ME_264) this.aircraft()).iRust;
        ...
        this.mesh.chunkSetAngles("Z_tLink", 0.0F, 0.0F, this.floatindex(this.cvt(f51, 0.0F, 90F, 0.0F, 18F), CockpitME_264.Turret_Z1));
        this.mesh.chunkSetAngles("Z_tHandle", 0.0F, 0.0F, -this.floatindex(this.cvt(f51, 0.0F, 90F, 0.0F, 18F), CockpitME_264.Turret_Z2));
    ...
    private static final float Fl20274_Scale[] = { 0.0F, 4.25F, 8F, 12F, 17F, 23F, 28.5F, 34.5F, 42F, 51F, 58.5F, 69F, 79F, 91F, 103F, 114.5F, 128F, 140F, 152.5F, 164.5F, 175F, 186.5F, 195.5F, 205F, 214F, 222.5F, 230.5F, 239F, 246.5F, 253.5F, 260.5F, 265F, 269.5F };
