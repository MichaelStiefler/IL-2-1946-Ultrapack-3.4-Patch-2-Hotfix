...
public class CockpitME_309C2 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            CockpitME_309C2.this.setTmp = CockpitME_309C2.this.setOld;
            CockpitME_309C2.this.setOld = CockpitME_309C2.this.setNew;
            CockpitME_309C2.this.setNew = CockpitME_309C2.this.setTmp;
            CockpitME_309C2.this.setNew.altimeter = CockpitME_309C2.this.fm.getAltitude();
            boolean flag = (CockpitME_309C2.this.fm.EI.engines[0].getStage() > 0) && (CockpitME_309C2.this.fm.EI.engines[0].getStage() < 7);
            boolean flag1 = (CockpitME_309C2.this.fm.EI.engines[0].getStage() == 1) || (CockpitME_309C2.this.fm.EI.engines[0].getStage() == 2);
            if (flag) {
                if (CockpitME_309C2.this.setNew.masterPosition < 1.0F) {
                    CockpitME_309C2.this.setNew.masterPosition = CockpitME_309C2.this.setOld.masterPosition + 0.1F;
                }
                if (CockpitME_309C2.this.setNew.reviPosition > 0.0F) {
                    CockpitME_309C2.this.setNew.reviPosition = CockpitME_309C2.this.setOld.reviPosition - 0.5F;
                }
                if (CockpitME_309C2.this.setNew.fuelPump0Position < 1.0F) {
                    CockpitME_309C2.this.setNew.fuelPump0Position = CockpitME_309C2.this.setOld.fuelPump0Position + 0.1F;
                }
                if (CockpitME_309C2.this.setNew.fuelSelectorPosition > 0.0F) {
                    CockpitME_309C2.this.setNew.fuelSelectorPosition = CockpitME_309C2.this.setOld.fuelSelectorPosition - 0.03F;
                }
                if (CockpitME_309C2.this.setNew.masterSwitchPosition < 1.0F) {
                    CockpitME_309C2.this.setNew.masterSwitchPosition = CockpitME_309C2.this.setOld.masterSwitchPosition + 0.1F;
                }
                if (CockpitME_309C2.this.setNew.oxyPressurePosition < 1.0F) {
                    CockpitME_309C2.this.setNew.oxyPressurePosition = CockpitME_309C2.this.setOld.oxyPressurePosition + 0.01F;
                }
                if (CockpitME_309C2.this.setNew.circuitBreakers0Position < 1.0F) {
                    CockpitME_309C2.this.setNew.circuitBreakers0Position = CockpitME_309C2.this.setOld.circuitBreakers0Position + 0.1F;
                }
                if (CockpitME_309C2.this.setNew.generator0Position < 1.0F) {
                    CockpitME_309C2.this.setNew.generator0Position = CockpitME_309C2.this.setOld.generator0Position + 0.1F;
                }
                if (CockpitME_309C2.this.setNew.radioSwitch0Position < 1.0F) {
                    CockpitME_309C2.this.setNew.radioSwitch0Position = CockpitME_309C2.this.setOld.radioSwitch0Position + 0.1F;
                }
                if (CockpitME_309C2.this.setNew.circuitBreakers2Position < 1.0F) {
                    CockpitME_309C2.this.setNew.circuitBreakers2Position = CockpitME_309C2.this.setOld.circuitBreakers2Position + 0.1F;
                }
                if (CockpitME_309C2.this.setNew.radioSwitch2Position < 1.0F) {
                    CockpitME_309C2.this.setNew.radioSwitch2Position = CockpitME_309C2.this.setOld.radioSwitch2Position + 0.1F;
                }
                if (CockpitME_309C2.this.setNew.generator2Position < 1.0F) {
                    CockpitME_309C2.this.setNew.generator2Position = CockpitME_309C2.this.setOld.generator2Position + 0.1F;
                }
            } else {
                if (CockpitME_309C2.this.setNew.masterPosition > 0.0F) {
                    CockpitME_309C2.this.setNew.masterPosition = CockpitME_309C2.this.setOld.masterPosition - 0.1F;
                }
                if (CockpitME_309C2.this.setNew.reviPosition < 1.0F) {
                    CockpitME_309C2.this.setNew.reviPosition = CockpitME_309C2.this.setOld.reviPosition + 0.5F;
                }
                if (CockpitME_309C2.this.setNew.fuelPump0Position > 0.0F) {
                    CockpitME_309C2.this.setNew.fuelPump0Position = CockpitME_309C2.this.setOld.fuelPump0Position - 0.1F;
                }
                if (CockpitME_309C2.this.setNew.fuelSelectorPosition < 1.0F) {
                    CockpitME_309C2.this.setNew.fuelSelectorPosition = CockpitME_309C2.this.setOld.fuelSelectorPosition + 0.03F;
                }
                if (CockpitME_309C2.this.setNew.masterSwitchPosition > 0.0F) {
                    CockpitME_309C2.this.setNew.masterSwitchPosition = CockpitME_309C2.this.setOld.masterSwitchPosition - 0.1F;
                }
                if (CockpitME_309C2.this.setNew.oxyPressurePosition > 0.0F) {
                    CockpitME_309C2.this.setNew.oxyPressurePosition = CockpitME_309C2.this.setOld.oxyPressurePosition - 0.01F;
                }
                if (CockpitME_309C2.this.setNew.circuitBreakers0Position > 0.0F) {
                    CockpitME_309C2.this.setNew.circuitBreakers0Position = CockpitME_309C2.this.setOld.circuitBreakers0Position - 0.1F;
                }
                if (CockpitME_309C2.this.setNew.generator0Position > 0.0F) {
                    CockpitME_309C2.this.setNew.generator0Position = CockpitME_309C2.this.setOld.generator0Position - 0.1F;
                }
                if (CockpitME_309C2.this.setNew.radioSwitch0Position > 0.0F) {
                    CockpitME_309C2.this.setNew.radioSwitch0Position = CockpitME_309C2.this.setOld.radioSwitch0Position - 0.1F;
                }
                if (CockpitME_309C2.this.setNew.circuitBreakers2Position > 0.0F) {
                    CockpitME_309C2.this.setNew.circuitBreakers2Position = CockpitME_309C2.this.setOld.circuitBreakers2Position - 0.1F;
                }
                if (CockpitME_309C2.this.setNew.fuelPump2Position < 1.0F) {
                    CockpitME_309C2.this.setNew.fuelPump2Position = CockpitME_309C2.this.setOld.fuelPump2Position + 0.1F;
                }
                if (CockpitME_309C2.this.setNew.fuelPump2Position > 0.0F) {
                    CockpitME_309C2.this.setNew.fuelPump2Position = CockpitME_309C2.this.setOld.fuelPump2Position - 0.1F;
                }
                if (CockpitME_309C2.this.setNew.radioSwitch2Position > 0.0F) {
                    CockpitME_309C2.this.setNew.radioSwitch2Position = CockpitME_309C2.this.setOld.radioSwitch2Position - 0.1F;
                }
                if (CockpitME_309C2.this.setNew.generator2Position > 0.0F) {
                    CockpitME_309C2.this.setNew.generator2Position = CockpitME_309C2.this.setOld.generator2Position - 0.1F;
                }
            }
            if (flag1) {
                if (CockpitME_309C2.this.setNew.starterPosition < 1.0F) {
                    CockpitME_309C2.this.setNew.starterPosition = CockpitME_309C2.this.setOld.starterPosition + 0.1F;
                }
                if (CockpitME_309C2.this.setNew.starter2Position < 1.0F) {
                    CockpitME_309C2.this.setNew.starter2Position = CockpitME_309C2.this.setOld.starter2Position + 0.1F;
                }
            } else {
                if (CockpitME_309C2.this.setNew.starterPosition > 0.0F) {
                    CockpitME_309C2.this.setNew.starterPosition = CockpitME_309C2.this.setOld.starterPosition - 0.1F;
                }
                if (CockpitME_309C2.this.setNew.starter2Position > 0.0F) {
                    CockpitME_309C2.this.setNew.starter2Position = CockpitME_309C2.this.setOld.starter2Position - 0.1F;
                }
            }
            if (CockpitME_309C2.this.setNew.masterArmPosition < 1.0F) {
                CockpitME_309C2.this.setNew.masterArmPosition = CockpitME_309C2.this.setOld.masterArmPosition + 0.5F;
            }
            if (flag) {
                for (int i = 0; i < CockpitME_309C2.NUM_COUNTERS; i++) {
                    if (!CockpitME_309C2.this.fm.CT.WeaponControl[CockpitME_309C2.this.triggerForBreechControl[i]]) {
                        if (CockpitME_309C2.this.setNew.shotPosition[i] < 1.0F) {
                            CockpitME_309C2.this.setNew.shotPosition[i] += 0.5F;
                        }
                    } else if ((CockpitME_309C2.this.gun[i] != null) && CockpitME_309C2.this.gun[i].haveBullets()) {
                        boolean flag3 = false;
                        long l = Time.current();
                        if (CockpitME_309C2.this.timePerShot[i] < (l - CockpitME_309C2.this.lastBreechTime[i])) {
                            flag3 = true;
                            CockpitME_309C2.this.lastBreechTime[i] = l;
                        }
                        if (flag3) {
                            CockpitME_309C2.this.setNew.shotPosition[i] = CockpitME_309C2.this.setNew.shotPosition[i] > 0.5F ? 0.0F : 1.0F;
                            CockpitME_309C2.this.setOld.shotPosition[i] = CockpitME_309C2.this.setNew.shotPosition[i];
                        }
                    } else if (CockpitME_309C2.this.setNew.shotPosition[i] > 0.0F) {
                        CockpitME_309C2.this.setNew.shotPosition[i] -= 0.5F;
                    }
                }

            } else {
                for (int j = 0; j < CockpitME_309C2.NUM_COUNTERS; j++) {
                    if (CockpitME_309C2.this.setNew.shotPosition[j] > 0.0F) {
                        CockpitME_309C2.this.setNew.shotPosition[j] = CockpitME_309C2.this.setOld.shotPosition[j] - 0.5F;
                    }
                }

            }
            if (CockpitME_309C2.this.fm.CT.GearControl == 1.0F) {
                if (CockpitME_309C2.this.setNew.gearLeverPosition > 0.0F) {
                    CockpitME_309C2.this.setNew.gearLeverPosition = CockpitME_309C2.this.setOld.gearLeverPosition - 0.5F;
                }
            } else if (CockpitME_309C2.this.setNew.gearLeverPosition < 1.0F) {
                CockpitME_309C2.this.setNew.gearLeverPosition = CockpitME_309C2.this.setOld.gearLeverPosition + 0.5F;
            }
            if ((CockpitME_309C2.this.fm.CT.GearControl == 0.0F) && (CockpitME_309C2.this.fm.CT.getGear() > 0.5F)) {
                if (CockpitME_309C2.this.setNew.gearUpPosition > 0.0F) {
                    CockpitME_309C2.this.setNew.gearUpPosition = CockpitME_309C2.this.setOld.gearUpPosition - 0.1F;
                }
            } else if (CockpitME_309C2.this.setNew.gearUpPosition < 1.0F) {
                CockpitME_309C2.this.setNew.gearUpPosition = CockpitME_309C2.this.setOld.gearUpPosition + 0.1F;
            }
            if ((CockpitME_309C2.this.fm.CT.GearControl == 1.0F) && (CockpitME_309C2.this.fm.CT.getGear() < 0.5F)) {
                if (CockpitME_309C2.this.setNew.gearDownPosition > 0.0F) {
                    CockpitME_309C2.this.setNew.gearDownPosition = CockpitME_309C2.this.setOld.gearDownPosition - 0.1F;
                }
            } else if (CockpitME_309C2.this.setNew.gearDownPosition < 1.0F) {
                CockpitME_309C2.this.setNew.gearDownPosition = CockpitME_309C2.this.setOld.gearDownPosition + 0.1F;
            }
            if (CockpitME_309C2.this.fm.CT.BayDoorControl == 0.0F) {
                if (CockpitME_309C2.this.setNew.kg13TriggerPosition > 0.0F) {
                    CockpitME_309C2.this.setNew.kg13TriggerPosition = CockpitME_309C2.this.setOld.kg13TriggerPosition - 0.05F;
                }
            } else if (CockpitME_309C2.this.setNew.kg13TriggerPosition < 1.0F) {
                CockpitME_309C2.this.setNew.kg13TriggerPosition = CockpitME_309C2.this.setOld.kg13TriggerPosition + 0.05F;
            }
            if (!CockpitME_309C2.this.fm.CT.getRadiatorControlAuto()) {
                if (CockpitME_309C2.this.setNew.radiatorPosition > 0.0F) {
                    CockpitME_309C2.this.setNew.radiatorPosition = CockpitME_309C2.this.setOld.radiatorPosition - 0.05F;
                }
            } else if (CockpitME_309C2.this.setNew.radiatorPosition < 1.0F) {
                CockpitME_309C2.this.setNew.radiatorPosition = CockpitME_309C2.this.setOld.radiatorPosition + 0.05F;
            }
            if (CockpitME_309C2.this.setNew.quickBrakePosition1 < 1.0F) {
                CockpitME_309C2.this.setNew.quickBrakePosition1 = CockpitME_309C2.this.setOld.quickBrakePosition1 + 0.05F;
            }
            if (CockpitME_309C2.this.setNew.quickBrakePosition2 < 1.0F) {
                CockpitME_309C2.this.setNew.quickBrakePosition2 = CockpitME_309C2.this.setOld.quickBrakePosition2 + 0.05F;
            }
            if (!CockpitME_309C2.this.EjectCanopyState) {
                if (CockpitME_309C2.this.setNew.ejectSystemPosition > 0.0F) {
                    CockpitME_309C2.this.setNew.ejectSystemPosition = CockpitME_309C2.this.setOld.ejectSystemPosition - 0.5F;
                }
            } else if (CockpitME_309C2.this.setNew.ejectSystemPosition < 1.0F) {
                CockpitME_309C2.this.setNew.ejectSystemPosition = CockpitME_309C2.this.setOld.ejectSystemPosition + 0.5F;
            }
            if (CockpitME_309C2.this.fm.AS.bIsAboutToBailout && (CockpitME_309C2.this.setNew.ejectCanopyPosition < 1.0F)) {
                CockpitME_309C2.this.setNew.ejectCanopyPosition = CockpitME_309C2.this.setOld.ejectCanopyPosition + 0.5F;
            }
            if (CockpitME_309C2.this.UnLockedTState) {
                if (CockpitME_309C2.this.setNew.lockTailWheel0Position > 0.0F) {
                    CockpitME_309C2.this.setNew.lockTailWheel0Position = CockpitME_309C2.this.setOld.lockTailWheel0Position - 0.07F;
                }
            } else if (CockpitME_309C2.this.setNew.lockTailWheel0Position < 1.0F) {
                CockpitME_309C2.this.setNew.lockTailWheel0Position = CockpitME_309C2.this.setOld.lockTailWheel0Position + 0.07F;
            }
            if (!CockpitME_309C2.this.LockedTDelayState) {
                if (CockpitME_309C2.this.setNew.lockTailWheelPosition1 > 0.0F) {
                    CockpitME_309C2.this.setNew.lockTailWheelPosition1 = CockpitME_309C2.this.setOld.lockTailWheelPosition1 - 0.07F;
                }
            } else if (CockpitME_309C2.this.setNew.lockTailWheelPosition1 < 1.0F) {
                CockpitME_309C2.this.setNew.lockTailWheelPosition1 = CockpitME_309C2.this.setOld.lockTailWheelPosition1 + 0.07F;
            }
            if (CockpitME_309C2.this.fm.CT.cockpitDoorControl == 1.0F) {
                if (CockpitME_309C2.this.setNew.topCablePosition1 > 0.0F) {
                    CockpitME_309C2.this.setNew.topCablePosition1 = CockpitME_309C2.this.setOld.topCablePosition1 - 0.022F;
                }
            } else if (CockpitME_309C2.this.setNew.topCablePosition1 < 1.0F) {
                CockpitME_309C2.this.setNew.topCablePosition1 = CockpitME_309C2.this.setOld.topCablePosition1 + 0.022F;
            }
            if (CockpitME_309C2.this.fm.getAltitude() > 3000F) {
                if (CockpitME_309C2.this.setNew.oxyButtonPosition < 1.0F) {
                    CockpitME_309C2.this.setNew.oxyButtonPosition = CockpitME_309C2.this.setOld.oxyButtonPosition + 0.05F;
                }
            } else if (CockpitME_309C2.this.setNew.oxyButtonPosition > 0.0F) {
                CockpitME_309C2.this.setNew.oxyButtonPosition = CockpitME_309C2.this.setOld.oxyButtonPosition - 0.05F;
            }
            if (CockpitME_309C2.this.fm.getAltitude() > 5000F) {
                if (CockpitME_309C2.this.setNew.glassCleanerPosition < 1.0F) {
                    CockpitME_309C2.this.setNew.glassCleanerPosition = CockpitME_309C2.this.setOld.glassCleanerPosition + 0.05F;
                }
            } else if (CockpitME_309C2.this.setNew.glassCleanerPosition > 0.0F) {
                CockpitME_309C2.this.setNew.glassCleanerPosition = CockpitME_309C2.this.setOld.glassCleanerPosition - 0.05F;
            }
            if (!CockpitME_309C2.this.CanopyClosedState) {
                if (CockpitME_309C2.this.setNew.canopyHandlePosition > 0.0F) {
                    CockpitME_309C2.this.setNew.canopyHandlePosition = CockpitME_309C2.this.setOld.canopyHandlePosition - 0.05F;
                }
            } else if (CockpitME_309C2.this.setNew.canopyHandlePosition < 1.0F) {
                CockpitME_309C2.this.setNew.canopyHandlePosition = CockpitME_309C2.this.setOld.canopyHandlePosition + 0.05F;
            }
            if (CockpitME_309C2.this.UnLockedTState) {
                if (CockpitME_309C2.this.setNew.lockTailWheel3Position > 0.0F) {
                    CockpitME_309C2.this.setNew.lockTailWheel3Position = CockpitME_309C2.this.setOld.lockTailWheel3Position - 0.07F;
                }
            } else if (CockpitME_309C2.this.setNew.lockTailWheel3Position < 1.0F) {
                CockpitME_309C2.this.setNew.lockTailWheel3Position = CockpitME_309C2.this.setOld.lockTailWheel3Position + 0.07F;
            }
            if (CockpitME_309C2.this.UnLockedTState) {
                if (CockpitME_309C2.this.setNew.lockTailWheelPosition2 > 0.0F) {
                    CockpitME_309C2.this.setNew.lockTailWheelPosition2 = CockpitME_309C2.this.setOld.lockTailWheelPosition2 - 0.07F;
                }
            } else if (CockpitME_309C2.this.setNew.lockTailWheelPosition2 < 1.0F) {
                CockpitME_309C2.this.setNew.lockTailWheelPosition2 = CockpitME_309C2.this.setOld.lockTailWheelPosition2 + 0.07F;
            }
            if (CockpitME_309C2.this.UnLockedTState) {
                if (CockpitME_309C2.this.setNew.lockTailWheel5Position > 0.0F) {
                    CockpitME_309C2.this.setNew.lockTailWheel5Position = CockpitME_309C2.this.setOld.lockTailWheel5Position - 0.07F;
                }
            } else if (CockpitME_309C2.this.setNew.lockTailWheel5Position < 1.0F) {
                CockpitME_309C2.this.setNew.lockTailWheel5Position = CockpitME_309C2.this.setOld.lockTailWheel5Position + 0.07F;
            }
            if (!CockpitME_309C2.this.cockpitLightControl) {
                if (CockpitME_309C2.this.setNew.cockpitLights0Position > 0.0F) {
                    CockpitME_309C2.this.setNew.cockpitLights0Position = CockpitME_309C2.this.setOld.cockpitLights0Position - 0.1F;
                }
            } else if (CockpitME_309C2.this.setNew.cockpitLights0Position < 1.0F) {
                CockpitME_309C2.this.setNew.cockpitLights0Position = CockpitME_309C2.this.setOld.cockpitLights0Position + 0.1F;
            }
            if (!CockpitME_309C2.this.fm.AS.bNavLightsOn) {
                if (CockpitME_309C2.this.setNew.navLights0Position > 0.0F) {
                    CockpitME_309C2.this.setNew.navLights0Position = CockpitME_309C2.this.setOld.navLights0Position - 0.1F;
                }
            } else if (CockpitME_309C2.this.setNew.navLights0Position < 1.0F) {
                CockpitME_309C2.this.setNew.navLights0Position = CockpitME_309C2.this.setOld.navLights0Position + 0.1F;
            }
            if (CockpitME_309C2.this.fm.EI.engines[0].isPropAngleDeviceOperational()) {
                if (CockpitME_309C2.this.setNew.propPitchPosition < 1.0F) {
                    CockpitME_309C2.this.setNew.propPitchPosition = CockpitME_309C2.this.setOld.propPitchPosition + 0.1F;
                }
                if (CockpitME_309C2.this.setNew.propPitch4Position < 1.0F) {
                    CockpitME_309C2.this.setNew.propPitch4Position = CockpitME_309C2.this.setOld.propPitch4Position + 0.1F;
                }
            } else {
                if (CockpitME_309C2.this.setNew.propPitchPosition > 0.0F) {
                    CockpitME_309C2.this.setNew.propPitchPosition = CockpitME_309C2.this.setOld.propPitchPosition - 0.1F;
                }
                if (CockpitME_309C2.this.setNew.propPitch4Position > 0.0F) {
                    CockpitME_309C2.this.setNew.propPitch4Position = CockpitME_309C2.this.setOld.propPitch4Position - 0.1F;
                }
            }
            if (!CockpitME_309C2.this.cockpitLightControl) {
                if (CockpitME_309C2.this.setNew.cockpitLights2Position > 0.0F) {
                    CockpitME_309C2.this.setNew.cockpitLights2Position = CockpitME_309C2.this.setOld.cockpitLights2Position - 0.1F;
                }
            } else if (CockpitME_309C2.this.setNew.cockpitLights2Position < 1.0F) {
                CockpitME_309C2.this.setNew.cockpitLights2Position = CockpitME_309C2.this.setOld.cockpitLights2Position + 0.1F;
            }
            if (!CockpitME_309C2.this.fm.AS.bNavLightsOn) {
                if (CockpitME_309C2.this.setNew.navLights2Position > 0.0F) {
                    CockpitME_309C2.this.setNew.navLights2Position = CockpitME_309C2.this.setOld.navLights2Position - 0.1F;
                }
            } else if (CockpitME_309C2.this.setNew.navLights2Position < 1.0F) {
                CockpitME_309C2.this.setNew.navLights2Position = CockpitME_309C2.this.setOld.navLights2Position + 0.1F;
            }
            if (!CockpitME_309C2.this.AccelerationState1) {
                if (CockpitME_309C2.this.setNew.cockpit0Position > 0.0F) {
                    CockpitME_309C2.this.setNew.cockpit0Position = CockpitME_309C2.this.setOld.cockpit0Position - 0.02F;
                }
            } else if (CockpitME_309C2.this.setNew.cockpit0Position < 1.0F) {
                CockpitME_309C2.this.setNew.cockpit0Position = CockpitME_309C2.this.setOld.cockpit0Position + 0.02F;
            }
            if (CockpitME_309C2.this.fm.AS.astateSootStates[0] > 0) {
                if (CockpitME_309C2.this.setNew.smoke1Position < 1.0F) {
                    CockpitME_309C2.this.setNew.smoke1Position = CockpitME_309C2.this.setOld.smoke1Position + 1E-005F;
                }
                if (CockpitME_309C2.this.setNew.smoke2Position < 1.0F) {
                    CockpitME_309C2.this.setNew.smoke2Position = CockpitME_309C2.this.setOld.smoke2Position + 2E-005F;
                }
            } else {
                if (CockpitME_309C2.this.setNew.smoke1Position > 0.0F) {
                    CockpitME_309C2.this.setNew.smoke1Position = CockpitME_309C2.this.setOld.smoke1Position - 1E-005F;
                }
                if (CockpitME_309C2.this.setNew.smoke2Position > 0.0F) {
                    CockpitME_309C2.this.setNew.smoke2Position = CockpitME_309C2.this.setOld.smoke2Position - 2E-005F;
                }
            }
            if (CockpitME_309C2.this.fm.EI.engines[0].getReadyness() < 0.8F) {
                if (CockpitME_309C2.this.setNew.smoke3Position < 1.0F) {
                    CockpitME_309C2.this.setNew.smoke3Position = CockpitME_309C2.this.setOld.smoke3Position + 1E-005F;
                }
                if (CockpitME_309C2.this.setNew.smoke4Position < 1.0F) {
                    CockpitME_309C2.this.setNew.smoke4Position = CockpitME_309C2.this.setOld.smoke4Position + 2E-005F;
                }
            } else {
                if (CockpitME_309C2.this.setNew.smoke3Position > 0.0F) {
                    CockpitME_309C2.this.setNew.smoke3Position = CockpitME_309C2.this.setOld.smoke3Position - 1E-005F;
                }
                if (CockpitME_309C2.this.setNew.smoke4Position > 0.0F) {
                    CockpitME_309C2.this.setNew.smoke4Position = CockpitME_309C2.this.setOld.smoke4Position - 2E-005F;
                }
            }
            if (CockpitME_309C2.this.fm.CT.GearControl == 1.0F) {
                if (CockpitME_309C2.this.setNew.gearIndicatorPosition > 0.0F) {
                    CockpitME_309C2.this.setNew.gearIndicatorPosition = CockpitME_309C2.this.setOld.gearIndicatorPosition - 0.005F;
                }
            } else if (CockpitME_309C2.this.setNew.gearIndicatorPosition < 1.0F) {
                CockpitME_309C2.this.setNew.gearIndicatorPosition = CockpitME_309C2.this.setOld.gearIndicatorPosition + 0.005F;
            }
            boolean flag2 = false;
            if (((NetAircraft) ((Aircraft) CockpitME_309C2.this.fm.actor)).thisWeaponsName.toLowerCase().startsWith("u5") && CockpitME_309C2.this.fm.CT.Weapons[9][0].haveBullets()) {
                flag2 = true;
            }
            if (flag2) {
                if (CockpitME_309C2.this.setNew.dropTankPosition < 1.0F) {
                    CockpitME_309C2.this.setNew.dropTankPosition = CockpitME_309C2.this.setOld.dropTankPosition + 0.1F;
                }
            } else if (CockpitME_309C2.this.setNew.dropTankPosition > 0.0F) {
                CockpitME_309C2.this.setNew.dropTankPosition = CockpitME_309C2.this.setOld.dropTankPosition - 0.1F;
            }
            if (!CockpitME_309C2.this.GunsightMove) {
                if (CockpitME_309C2.this.setNew.revi16SupportPosition > 0.0F) {
                    CockpitME_309C2.this.setNew.revi16SupportPosition = CockpitME_309C2.this.setOld.revi16SupportPosition - 0.05F;
                }
            } else if (CockpitME_309C2.this.setNew.revi16SupportPosition < 1.0F) {
                CockpitME_309C2.this.setNew.revi16SupportPosition = CockpitME_309C2.this.setOld.revi16SupportPosition + 0.05F;
            }
            if (!CockpitME_309C2.this.RotGunsightDelay) {
                if (CockpitME_309C2.this.setNew.revi16Support2Position > 0.0F) {
                    CockpitME_309C2.this.setNew.revi16Support2Position = CockpitME_309C2.this.setOld.revi16Support2Position - 0.05F;
                }
            } else if (CockpitME_309C2.this.setNew.revi16Support2Position < 1.0F) {
                CockpitME_309C2.this.setNew.revi16Support2Position = CockpitME_309C2.this.setOld.revi16Support2Position + 0.05F;
            }
            if (CockpitME_309C2.this.fm.EI.engines[0].getControlAfterburner()) {
                if (CockpitME_309C2.this.setNew.mw50Position < 1.0F) {
                    CockpitME_309C2.this.setNew.mw50Position = CockpitME_309C2.this.setOld.mw50Position + 0.5F;
                }
            } else if (CockpitME_309C2.this.setNew.mw50Position > 0.0F) {
                CockpitME_309C2.this.setNew.mw50Position = CockpitME_309C2.this.setOld.mw50Position - 0.5F;
            }
            if (!CockpitME_309C2.this.RotGunsightDelay) {
                if (CockpitME_309C2.this.setNew.revi16Support3Position > 0.0F) {
                    CockpitME_309C2.this.setNew.revi16Support3Position = CockpitME_309C2.this.setOld.revi16Support3Position - 0.05F;
                }
            } else if (CockpitME_309C2.this.setNew.revi16Support3Position < 1.0F) {
                CockpitME_309C2.this.setNew.revi16Support3Position = CockpitME_309C2.this.setOld.revi16Support3Position + 0.05F;
            }
            if (CockpitME_309C2.this.fm.CT.cockpitDoorControl == 1.0F) {
                if (CockpitME_309C2.this.setNew.topCablePosition2 > 0.0F) {
                    CockpitME_309C2.this.setNew.topCablePosition2 = CockpitME_309C2.this.setOld.topCablePosition2 - 0.022F;
                }
            } else if (CockpitME_309C2.this.setNew.topCablePosition2 < 1.0F) {
                CockpitME_309C2.this.setNew.topCablePosition2 = CockpitME_309C2.this.setOld.topCablePosition2 + 0.022F;
            }
            if (CockpitME_309C2.this.fm.EI.engines[0].getControlAfterburner() && (CockpitME_309C2.this.setNew.mw50CountPosition < 1.0F)) {
                CockpitME_309C2.this.setNew.mw50CountPosition += 5E-005F;
            }
            boolean flag4 = false;
            if (((NetAircraft) ((Aircraft) CockpitME_309C2.this.fm.actor)).thisWeaponsName.toLowerCase().startsWith("r1") && CockpitME_309C2.this.fm.CT.Weapons[3][0].haveBullets()) {
                flag4 = true;
            }
            if (flag4) {
                if (CockpitME_309C2.this.setNew.bombsContact1Position < 1.0F) {
                    CockpitME_309C2.this.setNew.bombsContact1Position = CockpitME_309C2.this.setOld.bombsContact1Position + 0.5F;
                }
                if (CockpitME_309C2.this.setNew.bombsContact2Position < 1.0F) {
                    CockpitME_309C2.this.setNew.bombsContact2Position = CockpitME_309C2.this.setOld.bombsContact2Position + 0.5F;
                }
                if (CockpitME_309C2.this.setNew.bombsPanel1Position < 1.0F) {
                    CockpitME_309C2.this.setNew.bombsPanel1Position = CockpitME_309C2.this.setOld.bombsPanel1Position + 1.0F;
                }
            } else if (CockpitME_309C2.this.setNew.bombsPanel1Position > 0.0F) {
                CockpitME_309C2.this.setNew.bombsPanel1Position = CockpitME_309C2.this.setOld.bombsPanel1Position - 1.0F;
            }
            if (CockpitME_309C2.this.setNew.leftPedalBase1Position < 1.0F) {
                CockpitME_309C2.this.setNew.leftPedalBase1Position = CockpitME_309C2.this.setOld.leftPedalBase1Position + 1.0F;
            }
            if (CockpitME_309C2.this.setNew.rightPedalBase1Position < 1.0F) {
                CockpitME_309C2.this.setNew.rightPedalBase1Position = CockpitME_309C2.this.setOld.rightPedalBase1Position + 1.0F;
            }
            if (!CockpitME_309C2.this.cockpitDimControl) {
                if (CockpitME_309C2.this.setNew.dimPosition > 0.0F) {
                    CockpitME_309C2.this.setNew.dimPosition = CockpitME_309C2.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitME_309C2.this.setNew.dimPosition < 1.0F) {
                CockpitME_309C2.this.setNew.dimPosition = CockpitME_309C2.this.setOld.dimPosition + 0.05F;
            }
            CockpitME_309C2.this.setNew.throttle = ((10F * CockpitME_309C2.this.setOld.throttle) + CockpitME_309C2.this.fm.CT.PowerControl) / 11F;
            CockpitME_309C2.this.setNew.waypointAzimuth.setDeg(CockpitME_309C2.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitME_309C2.this.waypointAzimuth() - CockpitME_309C2.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitME_309C2.this.fm.Or.getKren()) < 30F) {
                CockpitME_309C2.this.setNew.azimuth.setDeg(CockpitME_309C2.this.setOld.azimuth.getDeg(1.0F), CockpitME_309C2.this.fm.Or.azimut());
            }
            CockpitME_309C2.this.buzzerFX((CockpitME_309C2.this.fm.CT.getGear() < 0.999999F) && (CockpitME_309C2.this.fm.CT.getFlap() > 0.1F));
            return true;
        }
    ...
    private class Variables {
        ...
        public Variables() {
            this.shotPosition = new float[CockpitME_309C2.NUM_COUNTERS];
    ...
    public CockpitME_309C2() {
        super("3DO/Cockpit/Me-309C2-P/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitME_309C2.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitME_309C2.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), CockpitME_309C2.fuelScale), 0.0F, 0.0F);
        ...
        if (flag) {
            for (int j = 3; j < CockpitME_309C2.MAX_GUNS; j++) {
    ...
    private int getLoadoutType() {
        ...
        if (s.startsWith("3xMG-151/20") || s.startsWith("4xMG-131/13+3xMG-151/20")) {
            return 1;
        } else {
            return s.startsWith("3xMG151/20+2xFuelTank") || s.startsWith("4xMG-131/13+3xMG151/20+2xFuelTank") || s.startsWith("4xMG-131/13") ? 2 : 1;
        }
    }
    ...
    static {
        Property.set(CockpitME_309C2.class, "normZNs", new float[] { 0.72F, 0.47F, 0.47F, 0.47F });
    }
