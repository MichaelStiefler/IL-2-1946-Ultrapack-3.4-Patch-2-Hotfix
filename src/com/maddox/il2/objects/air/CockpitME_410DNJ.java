...
public class CockpitME_410DNJ extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if ((ME_410DNJ) CockpitME_410DNJ.this.aircraft() != null) {

            }
            if (ME_410DNJ.bChangedPit) {
                CockpitME_410DNJ.this.reflectPlaneToModel();
                if ((ME_410DNJ) CockpitME_410DNJ.this.aircraft() != null) {

                }
                ME_410DNJ.bChangedPit = false;
            }
            CockpitME_410DNJ.this.setTmp = CockpitME_410DNJ.this.setOld;
            CockpitME_410DNJ.this.setOld = CockpitME_410DNJ.this.setNew;
            CockpitME_410DNJ.this.setNew = CockpitME_410DNJ.this.setTmp;
            CockpitME_410DNJ.this.setNew.altimeter = CockpitME_410DNJ.this.fm.getAltitude();
            if (CockpitME_410DNJ.this.cockpitDimControl) {
                if (CockpitME_410DNJ.this.setNew.dimPosition > 0.0F) {
                    CockpitME_410DNJ.this.setNew.dimPosition = CockpitME_410DNJ.this.setNew.dimPosition - 0.05F;
                }
            } else if (CockpitME_410DNJ.this.setNew.dimPosition < 1.0F) {
                CockpitME_410DNJ.this.setNew.dimPosition = CockpitME_410DNJ.this.setNew.dimPosition + 0.05F;
            }
            CockpitME_410DNJ.this.setNew.throttle1 = (0.91F * CockpitME_410DNJ.this.setOld.throttle1) + (0.09F * CockpitME_410DNJ.this.fm.EI.engines[0].getControlThrottle());
            CockpitME_410DNJ.this.setNew.throttle2 = (0.91F * CockpitME_410DNJ.this.setOld.throttle2) + (0.09F * CockpitME_410DNJ.this.fm.EI.engines[1].getControlThrottle());
            CockpitME_410DNJ.this.setNew.mix1 = (0.88F * CockpitME_410DNJ.this.setOld.mix1) + (0.12F * CockpitME_410DNJ.this.fm.EI.engines[0].getControlMix());
            CockpitME_410DNJ.this.setNew.mix2 = (0.88F * CockpitME_410DNJ.this.setOld.mix2) + (0.12F * CockpitME_410DNJ.this.fm.EI.engines[1].getControlMix());
            CockpitME_410DNJ.this.setNew.waypointAzimuth.setDeg(CockpitME_410DNJ.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitME_410DNJ.this.waypointAzimuth() - CockpitME_410DNJ.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitME_410DNJ.this.fm.Or.getKren()) < 30F) {
                CockpitME_410DNJ.this.setNew.azimuth.setDeg(CockpitME_410DNJ.this.setOld.azimuth.getDeg(1.0F), CockpitME_410DNJ.this.fm.Or.azimut());
            }
            Variables variables = CockpitME_410DNJ.this.setNew;
            float f = 0.9F * CockpitME_410DNJ.this.setOld.radioalt;
            float f1 = 0.1F;
            float f2 = CockpitME_410DNJ.this.fm.getAltitude();
            World.cur();
            World.land();
            variables.radioalt = f + (f1 * (f2 - Landscape.HQ_Air((float) CockpitME_410DNJ.this.fm.Loc.x, (float) CockpitME_410DNJ.this.fm.Loc.y)));
            CockpitME_410DNJ.this.setNew.vspeed = ((199F * CockpitME_410DNJ.this.setOld.vspeed) + CockpitME_410DNJ.this.fm.getVertSpeed()) / 200F;
            CockpitME_410DNJ.this.middleAngle = (CockpitME_410DNJ.this.middleAngleTarget * 0.05F) + (0.95F * CockpitME_410DNJ.this.middleAngle);
            return true;
        }
    ...
    public CockpitME_410DNJ() {
        super("3DO/Cockpit/Me410/ME410DNJ.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 12F), CockpitME_410DNJ.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speed1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitME_410DNJ.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitME_410DNJ.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitME_410DNJ.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Fuelpress1", this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.77F, 0.0F, 2.0F, 0.0F, 160F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Fuelpress2", this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.77F, 0.0F, 2.0F, 0.0F, 160F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Oiltemp1", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 120F, 0.0F, 8F), CockpitME_410DNJ.oilTScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Oiltemp2", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 40F, 120F, 0.0F, 8F), CockpitME_410DNJ.oilTScale), 0.0F, 0.0F);
    }
