    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitME_P1101.this.fm != null) {
                ...
                CockpitME_P1101.this.setNew.waypointAzimuth.setDeg(CockpitME_P1101.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitME_P1101.this.waypointAzimuth() - CockpitME_P1101.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitME_P1101.this.fm.Or.getKren()) < 30F) {
                    CockpitME_P1101.this.setNew.azimuth.setDeg(CockpitME_P1101.this.setOld.azimuth.getDeg(1.0F), CockpitME_P1101.this.fm.Or.azimut());
                }
                ...
                CockpitME_P1101.this.setNew.beaconDirection = ((10F * CockpitME_P1101.this.setOld.beaconDirection) + CockpitME_P1101.this.getBeaconDirection()) / 11F;
                CockpitME_P1101.this.setNew.beaconRange = ((10F * CockpitME_P1101.this.setOld.beaconRange) + CockpitME_P1101.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    }
