...
public class CockpitMIG_3 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitMIG_3.this.bNeedSetUp) {
                CockpitMIG_3.this.reflectPlaneMats();
                CockpitMIG_3.this.bNeedSetUp = false;
            }
            if (CockpitMIG_3.this.fm != null) {
                CockpitMIG_3.this.setTmp = CockpitMIG_3.this.setOld;
                CockpitMIG_3.this.setOld = CockpitMIG_3.this.setNew;
                CockpitMIG_3.this.setNew = CockpitMIG_3.this.setTmp;
                CockpitMIG_3.this.setNew.throttle = ((10F * CockpitMIG_3.this.setOld.throttle) + CockpitMIG_3.this.fm.CT.PowerControl) / 11F;
                CockpitMIG_3.this.setNew.prop = ((10F * CockpitMIG_3.this.setOld.prop) + CockpitMIG_3.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitMIG_3.this.setNew.altimeter = CockpitMIG_3.this.fm.getAltitude();
                if (Math.abs(CockpitMIG_3.this.fm.Or.getKren()) < 30F) {
                    CockpitMIG_3.this.setNew.azimuth.setDeg(CockpitMIG_3.this.setOld.azimuth.getDeg(1.0F), CockpitMIG_3.this.fm.Or.azimut());
                }
                CockpitMIG_3.this.setNew.vspeed = ((199F * CockpitMIG_3.this.setOld.vspeed) + CockpitMIG_3.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitMIG_3.speedometerScale), 0.0F);
    ...
    protected void reflectPlaneMats() {
        ...
        if (this.aircraft() instanceof MIG_3EARLY) {
            this.mesh.chunkVisible("Engine1_D0_E", true);
        } else {
            this.mesh.chunkVisible("Engine1_D0", true);
        }
    }
