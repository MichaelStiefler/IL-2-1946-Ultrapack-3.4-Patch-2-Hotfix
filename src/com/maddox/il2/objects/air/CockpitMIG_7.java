...
public class CockpitMIG_7 extends CockpitPilot {
        ...
        public boolean tick() {
            ...
            if (CockpitMIG_7.this.fm != null) {
                ...
                if (Math.abs(CockpitMIG_7.this.fm.Or.getKren()) < 30F) {
                    CockpitMIG_7.this.setNew.azimuth.setDeg(CockpitMIG_7.this.setOld.azimuth.getDeg(1.0F), CockpitMIG_7.this.fm.Or.azimut());
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitMIG_7.speedometerScale), 0.0F);
