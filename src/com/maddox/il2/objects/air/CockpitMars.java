...
public class CockpitMars extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitMars.this.fm != null) {
                CockpitMars.this.setTmp = CockpitMars.this.setOld;
                CockpitMars.this.setOld = CockpitMars.this.setNew;
                CockpitMars.this.setNew = CockpitMars.this.setTmp;
                CockpitMars.this.setNew.throttle1 = (0.9F * CockpitMars.this.setOld.throttle1) + (0.1F * CockpitMars.this.fm.EI.engines[0].getControlThrottle());
                CockpitMars.this.setNew.prop1 = (0.9F * CockpitMars.this.setOld.prop1) + (0.1F * CockpitMars.this.fm.EI.engines[0].getControlProp());
                CockpitMars.this.setNew.mix1 = (0.8F * CockpitMars.this.setOld.mix1) + (0.2F * CockpitMars.this.fm.EI.engines[0].getControlMix());
                CockpitMars.this.setNew.throttle2 = (0.9F * CockpitMars.this.setOld.throttle2) + (0.1F * CockpitMars.this.fm.EI.engines[1].getControlThrottle());
                CockpitMars.this.setNew.prop2 = (0.9F * CockpitMars.this.setOld.prop2) + (0.1F * CockpitMars.this.fm.EI.engines[1].getControlProp());
                CockpitMars.this.setNew.mix2 = (0.8F * CockpitMars.this.setOld.mix2) + (0.2F * CockpitMars.this.fm.EI.engines[1].getControlMix());
                CockpitMars.this.setNew.man1 = (0.92F * CockpitMars.this.setOld.man1) + (0.08F * CockpitMars.this.fm.EI.engines[0].getManifoldPressure());
                CockpitMars.this.setNew.man2 = (0.92F * CockpitMars.this.setOld.man2) + (0.08F * CockpitMars.this.fm.EI.engines[1].getManifoldPressure());
                CockpitMars.this.setNew.altimeter = CockpitMars.this.fm.getAltitude();
                if (Math.abs(CockpitMars.this.fm.Or.getKren()) < 30F) {
                    CockpitMars.this.setNew.azimuth.setDeg(CockpitMars.this.setOld.azimuth.getDeg(1.0F), CockpitMars.this.fm.Or.azimut());
                }
                CockpitMars.this.setNew.vspeed = ((199F * CockpitMars.this.setOld.vspeed) + CockpitMars.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitMars() {
        super("3DO/Cockpit/CockpitMars/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitMars.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitMars.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Altimeter1", this.cvt(this.interp(this.setNew.altimeter, this.setOld.altimeter, f), 0.0F, 9144F, 180F, 1260F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Altimeter1a", this.cvt(this.interp(this.setNew.altimeter, this.setOld.altimeter, f), 0.0F, 9144F, 180F, 12600F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Altimeter2", this.cvt(this.interp(this.setNew.altimeter, this.setOld.altimeter, f), 0.0F, 9144F, 180F, 1260F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Altimeter2a", this.cvt(this.interp(this.setNew.altimeter, this.setOld.altimeter, f), 0.0F, 9144F, 180F, 12600F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitMars.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitMars.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitMars.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitMars.rpmScale), 0.0F, 0.0F);
    ...
    private static final float speedometerScale[] = { 180F, 182.5F, 239F, 306F, 335.5F, 403.5F, 420F, 434.5F, 451F, 465F, 476.5F, 488.5F, 504F, 518.5F };
