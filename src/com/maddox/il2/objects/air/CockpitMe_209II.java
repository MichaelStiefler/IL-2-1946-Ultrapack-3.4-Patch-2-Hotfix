...
public class CockpitMe_209II extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            CockpitMe_209II.this.setTmp = CockpitMe_209II.this.setOld;
            CockpitMe_209II.this.setOld = CockpitMe_209II.this.setNew;
            CockpitMe_209II.this.setNew = CockpitMe_209II.this.setTmp;
            CockpitMe_209II.this.setNew.altimeter = CockpitMe_209II.this.fm.getAltitude();
            boolean flag = (CockpitMe_209II.this.fm.EI.engines[0].getStage() > 0) && (CockpitMe_209II.this.fm.EI.engines[0].getStage() < 7);
            boolean flag1 = (CockpitMe_209II.this.fm.EI.engines[0].getStage() == 1) || (CockpitMe_209II.this.fm.EI.engines[0].getStage() == 2);
            if (flag) {
                if (CockpitMe_209II.this.setNew.masterPosition < 1.0F) {
                    CockpitMe_209II.this.setNew.masterPosition = CockpitMe_209II.this.setOld.masterPosition + 0.1F;
                }
                if (CockpitMe_209II.this.setNew.reviPosition > 0.0F) {
                    CockpitMe_209II.this.setNew.reviPosition = CockpitMe_209II.this.setOld.reviPosition - 0.5F;
                }
                if (CockpitMe_209II.this.setNew.fuelPump0Position < 1.0F) {
                    CockpitMe_209II.this.setNew.fuelPump0Position = CockpitMe_209II.this.setOld.fuelPump0Position + 0.1F;
                }
                if (CockpitMe_209II.this.setNew.fuelSelectorPosition > 0.0F) {
                    CockpitMe_209II.this.setNew.fuelSelectorPosition = CockpitMe_209II.this.setOld.fuelSelectorPosition - 0.03F;
                }
                if (CockpitMe_209II.this.setNew.masterSwitchPosition < 1.0F) {
                    CockpitMe_209II.this.setNew.masterSwitchPosition = CockpitMe_209II.this.setOld.masterSwitchPosition + 0.1F;
                }
                if (CockpitMe_209II.this.setNew.oxyPressurePosition < 1.0F) {
                    CockpitMe_209II.this.setNew.oxyPressurePosition = CockpitMe_209II.this.setOld.oxyPressurePosition + 0.01F;
                }
                if (CockpitMe_209II.this.setNew.circuitBreakers0Position < 1.0F) {
                    CockpitMe_209II.this.setNew.circuitBreakers0Position = CockpitMe_209II.this.setOld.circuitBreakers0Position + 0.1F;
                }
                if (CockpitMe_209II.this.setNew.generator0Position < 1.0F) {
                    CockpitMe_209II.this.setNew.generator0Position = CockpitMe_209II.this.setOld.generator0Position + 0.1F;
                }
                if (CockpitMe_209II.this.setNew.radioSwitch0Position < 1.0F) {
                    CockpitMe_209II.this.setNew.radioSwitch0Position = CockpitMe_209II.this.setOld.radioSwitch0Position + 0.1F;
                }
                if (CockpitMe_209II.this.setNew.circuitBreakers2Position < 1.0F) {
                    CockpitMe_209II.this.setNew.circuitBreakers2Position = CockpitMe_209II.this.setOld.circuitBreakers2Position + 0.1F;
                }
                if (CockpitMe_209II.this.setNew.radioSwitch2Position < 1.0F) {
                    CockpitMe_209II.this.setNew.radioSwitch2Position = CockpitMe_209II.this.setOld.radioSwitch2Position + 0.1F;
                }
                if (CockpitMe_209II.this.setNew.generator2Position < 1.0F) {
                    CockpitMe_209II.this.setNew.generator2Position = CockpitMe_209II.this.setOld.generator2Position + 0.1F;
                }
            } else {
                if (CockpitMe_209II.this.setNew.masterPosition > 0.0F) {
                    CockpitMe_209II.this.setNew.masterPosition = CockpitMe_209II.this.setOld.masterPosition - 0.1F;
                }
                if (CockpitMe_209II.this.setNew.reviPosition < 1.0F) {
                    CockpitMe_209II.this.setNew.reviPosition = CockpitMe_209II.this.setOld.reviPosition + 0.5F;
                }
                if (CockpitMe_209II.this.setNew.fuelPump0Position > 0.0F) {
                    CockpitMe_209II.this.setNew.fuelPump0Position = CockpitMe_209II.this.setOld.fuelPump0Position - 0.1F;
                }
                if (CockpitMe_209II.this.setNew.fuelSelectorPosition < 1.0F) {
                    CockpitMe_209II.this.setNew.fuelSelectorPosition = CockpitMe_209II.this.setOld.fuelSelectorPosition + 0.03F;
                }
                if (CockpitMe_209II.this.setNew.masterSwitchPosition > 0.0F) {
                    CockpitMe_209II.this.setNew.masterSwitchPosition = CockpitMe_209II.this.setOld.masterSwitchPosition - 0.1F;
                }
                if (CockpitMe_209II.this.setNew.oxyPressurePosition > 0.0F) {
                    CockpitMe_209II.this.setNew.oxyPressurePosition = CockpitMe_209II.this.setOld.oxyPressurePosition - 0.01F;
                }
                if (CockpitMe_209II.this.setNew.circuitBreakers0Position > 0.0F) {
                    CockpitMe_209II.this.setNew.circuitBreakers0Position = CockpitMe_209II.this.setOld.circuitBreakers0Position - 0.1F;
                }
                if (CockpitMe_209II.this.setNew.generator0Position > 0.0F) {
                    CockpitMe_209II.this.setNew.generator0Position = CockpitMe_209II.this.setOld.generator0Position - 0.1F;
                }
                if (CockpitMe_209II.this.setNew.radioSwitch0Position > 0.0F) {
                    CockpitMe_209II.this.setNew.radioSwitch0Position = CockpitMe_209II.this.setOld.radioSwitch0Position - 0.1F;
                }
                if (CockpitMe_209II.this.setNew.circuitBreakers2Position > 0.0F) {
                    CockpitMe_209II.this.setNew.circuitBreakers2Position = CockpitMe_209II.this.setOld.circuitBreakers2Position - 0.1F;
                }
                if (CockpitMe_209II.this.setNew.fuelPump2Position < 1.0F) {
                    CockpitMe_209II.this.setNew.fuelPump2Position = CockpitMe_209II.this.setOld.fuelPump2Position + 0.1F;
                }
                if (CockpitMe_209II.this.setNew.fuelPump2Position > 0.0F) {
                    CockpitMe_209II.this.setNew.fuelPump2Position = CockpitMe_209II.this.setOld.fuelPump2Position - 0.1F;
                }
                if (CockpitMe_209II.this.setNew.radioSwitch2Position > 0.0F) {
                    CockpitMe_209II.this.setNew.radioSwitch2Position = CockpitMe_209II.this.setOld.radioSwitch2Position - 0.1F;
                }
                if (CockpitMe_209II.this.setNew.generator2Position > 0.0F) {
                    CockpitMe_209II.this.setNew.generator2Position = CockpitMe_209II.this.setOld.generator2Position - 0.1F;
                }
            }
            if (flag1) {
                if (CockpitMe_209II.this.setNew.starterPosition < 1.0F) {
                    CockpitMe_209II.this.setNew.starterPosition = CockpitMe_209II.this.setOld.starterPosition + 0.1F;
                }
                if (CockpitMe_209II.this.setNew.starter2Position < 1.0F) {
                    CockpitMe_209II.this.setNew.starter2Position = CockpitMe_209II.this.setOld.starter2Position + 0.1F;
                }
            } else {
                if (CockpitMe_209II.this.setNew.starterPosition > 0.0F) {
                    CockpitMe_209II.this.setNew.starterPosition = CockpitMe_209II.this.setOld.starterPosition - 0.1F;
                }
                if (CockpitMe_209II.this.setNew.starter2Position > 0.0F) {
                    CockpitMe_209II.this.setNew.starter2Position = CockpitMe_209II.this.setOld.starter2Position - 0.1F;
                }
            }
            if (CockpitMe_209II.this.setNew.masterArmPosition < 1.0F) {
                CockpitMe_209II.this.setNew.masterArmPosition = CockpitMe_209II.this.setOld.masterArmPosition + 0.5F;
            }
            if (flag) {
                for (int i = 0; i < CockpitMe_209II.NUM_COUNTERS; i++) {
                    if (!CockpitMe_209II.this.fm.CT.WeaponControl[CockpitMe_209II.this.triggerForBreechControl[i]]) {
                        if (CockpitMe_209II.this.setNew.shotPosition[i] < 1.0F) {
                            CockpitMe_209II.this.setNew.shotPosition[i] += 0.5F;
                        }
                    } else if ((CockpitMe_209II.this.gun[i] != null) && CockpitMe_209II.this.gun[i].haveBullets()) {
                        boolean flag3 = false;
                        long l = Time.current();
                        if (CockpitMe_209II.this.timePerShot[i] < (l - CockpitMe_209II.this.lastBreechTime[i])) {
                            flag3 = true;
                            CockpitMe_209II.this.lastBreechTime[i] = l;
                        }
                        if (flag3) {
                            CockpitMe_209II.this.setNew.shotPosition[i] = CockpitMe_209II.this.setNew.shotPosition[i] > 0.5F ? 0.0F : 1.0F;
                            CockpitMe_209II.this.setOld.shotPosition[i] = CockpitMe_209II.this.setNew.shotPosition[i];
                        }
                    } else if (CockpitMe_209II.this.setNew.shotPosition[i] > 0.0F) {
                        CockpitMe_209II.this.setNew.shotPosition[i] -= 0.5F;
                    }
                }

            } else {
                for (int j = 0; j < CockpitMe_209II.NUM_COUNTERS; j++) {
                    if (CockpitMe_209II.this.setNew.shotPosition[j] > 0.0F) {
                        CockpitMe_209II.this.setNew.shotPosition[j] = CockpitMe_209II.this.setOld.shotPosition[j] - 0.5F;
                    }
                }

            }
            if (CockpitMe_209II.this.fm.CT.GearControl == 1.0F) {
                if (CockpitMe_209II.this.setNew.gearLeverPosition > 0.0F) {
                    CockpitMe_209II.this.setNew.gearLeverPosition = CockpitMe_209II.this.setOld.gearLeverPosition - 0.5F;
                }
            } else if (CockpitMe_209II.this.setNew.gearLeverPosition < 1.0F) {
                CockpitMe_209II.this.setNew.gearLeverPosition = CockpitMe_209II.this.setOld.gearLeverPosition + 0.5F;
            }
            if ((CockpitMe_209II.this.fm.CT.GearControl == 0.0F) && (CockpitMe_209II.this.fm.CT.getGear() > 0.5F)) {
                if (CockpitMe_209II.this.setNew.gearUpPosition > 0.0F) {
                    CockpitMe_209II.this.setNew.gearUpPosition = CockpitMe_209II.this.setOld.gearUpPosition - 0.1F;
                }
            } else if (CockpitMe_209II.this.setNew.gearUpPosition < 1.0F) {
                CockpitMe_209II.this.setNew.gearUpPosition = CockpitMe_209II.this.setOld.gearUpPosition + 0.1F;
            }
            if ((CockpitMe_209II.this.fm.CT.GearControl == 1.0F) && (CockpitMe_209II.this.fm.CT.getGear() < 0.5F)) {
                if (CockpitMe_209II.this.setNew.gearDownPosition > 0.0F) {
                    CockpitMe_209II.this.setNew.gearDownPosition = CockpitMe_209II.this.setOld.gearDownPosition - 0.1F;
                }
            } else if (CockpitMe_209II.this.setNew.gearDownPosition < 1.0F) {
                CockpitMe_209II.this.setNew.gearDownPosition = CockpitMe_209II.this.setOld.gearDownPosition + 0.1F;
            }
            if (CockpitMe_209II.this.fm.CT.BayDoorControl == 0.0F) {
                if (CockpitMe_209II.this.setNew.kg13TriggerPosition > 0.0F) {
                    CockpitMe_209II.this.setNew.kg13TriggerPosition = CockpitMe_209II.this.setOld.kg13TriggerPosition - 0.05F;
                }
            } else if (CockpitMe_209II.this.setNew.kg13TriggerPosition < 1.0F) {
                CockpitMe_209II.this.setNew.kg13TriggerPosition = CockpitMe_209II.this.setOld.kg13TriggerPosition + 0.05F;
            }
            if (!CockpitMe_209II.this.fm.CT.getRadiatorControlAuto()) {
                if (CockpitMe_209II.this.setNew.radiatorPosition > 0.0F) {
                    CockpitMe_209II.this.setNew.radiatorPosition = CockpitMe_209II.this.setOld.radiatorPosition - 0.05F;
                }
            } else if (CockpitMe_209II.this.setNew.radiatorPosition < 1.0F) {
                CockpitMe_209II.this.setNew.radiatorPosition = CockpitMe_209II.this.setOld.radiatorPosition + 0.05F;
            }
            if (CockpitMe_209II.this.setNew.quickBrakePosition1 < 1.0F) {
                CockpitMe_209II.this.setNew.quickBrakePosition1 = CockpitMe_209II.this.setOld.quickBrakePosition1 + 0.05F;
            }
            if (CockpitMe_209II.this.setNew.quickBrakePosition2 < 1.0F) {
                CockpitMe_209II.this.setNew.quickBrakePosition2 = CockpitMe_209II.this.setOld.quickBrakePosition2 + 0.05F;
            }
            if (!CockpitMe_209II.this.EjectCanopyState) {
                if (CockpitMe_209II.this.setNew.ejectSystemPosition > 0.0F) {
                    CockpitMe_209II.this.setNew.ejectSystemPosition = CockpitMe_209II.this.setOld.ejectSystemPosition - 0.5F;
                }
            } else if (CockpitMe_209II.this.setNew.ejectSystemPosition < 1.0F) {
                CockpitMe_209II.this.setNew.ejectSystemPosition = CockpitMe_209II.this.setOld.ejectSystemPosition + 0.5F;
            }
            if (CockpitMe_209II.this.fm.AS.bIsAboutToBailout && (CockpitMe_209II.this.setNew.ejectCanopyPosition < 1.0F)) {
                CockpitMe_209II.this.setNew.ejectCanopyPosition = CockpitMe_209II.this.setOld.ejectCanopyPosition + 0.5F;
            }
            if (CockpitMe_209II.this.UnLockedTState) {
                if (CockpitMe_209II.this.setNew.lockTailWheel0Position > 0.0F) {
                    CockpitMe_209II.this.setNew.lockTailWheel0Position = CockpitMe_209II.this.setOld.lockTailWheel0Position - 0.07F;
                }
            } else if (CockpitMe_209II.this.setNew.lockTailWheel0Position < 1.0F) {
                CockpitMe_209II.this.setNew.lockTailWheel0Position = CockpitMe_209II.this.setOld.lockTailWheel0Position + 0.07F;
            }
            if (!CockpitMe_209II.this.LockedTDelayState) {
                if (CockpitMe_209II.this.setNew.lockTailWheelPosition1 > 0.0F) {
                    CockpitMe_209II.this.setNew.lockTailWheelPosition1 = CockpitMe_209II.this.setOld.lockTailWheelPosition1 - 0.07F;
                }
            } else if (CockpitMe_209II.this.setNew.lockTailWheelPosition1 < 1.0F) {
                CockpitMe_209II.this.setNew.lockTailWheelPosition1 = CockpitMe_209II.this.setOld.lockTailWheelPosition1 + 0.07F;
            }
            if (CockpitMe_209II.this.fm.CT.cockpitDoorControl == 1.0F) {
                if (CockpitMe_209II.this.setNew.topCablePosition1 > 0.0F) {
                    CockpitMe_209II.this.setNew.topCablePosition1 = CockpitMe_209II.this.setOld.topCablePosition1 - 0.022F;
                }
            } else if (CockpitMe_209II.this.setNew.topCablePosition1 < 1.0F) {
                CockpitMe_209II.this.setNew.topCablePosition1 = CockpitMe_209II.this.setOld.topCablePosition1 + 0.022F;
            }
            if (CockpitMe_209II.this.fm.getAltitude() > 3000F) {
                if (CockpitMe_209II.this.setNew.oxyButtonPosition < 1.0F) {
                    CockpitMe_209II.this.setNew.oxyButtonPosition = CockpitMe_209II.this.setOld.oxyButtonPosition + 0.05F;
                }
            } else if (CockpitMe_209II.this.setNew.oxyButtonPosition > 0.0F) {
                CockpitMe_209II.this.setNew.oxyButtonPosition = CockpitMe_209II.this.setOld.oxyButtonPosition - 0.05F;
            }
            if (CockpitMe_209II.this.fm.getAltitude() > 5000F) {
                if (CockpitMe_209II.this.setNew.glassCleanerPosition < 1.0F) {
                    CockpitMe_209II.this.setNew.glassCleanerPosition = CockpitMe_209II.this.setOld.glassCleanerPosition + 0.05F;
                }
            } else if (CockpitMe_209II.this.setNew.glassCleanerPosition > 0.0F) {
                CockpitMe_209II.this.setNew.glassCleanerPosition = CockpitMe_209II.this.setOld.glassCleanerPosition - 0.05F;
            }
            if (!CockpitMe_209II.this.CanopyClosedState) {
                if (CockpitMe_209II.this.setNew.canopyHandlePosition > 0.0F) {
                    CockpitMe_209II.this.setNew.canopyHandlePosition = CockpitMe_209II.this.setOld.canopyHandlePosition - 0.05F;
                }
            } else if (CockpitMe_209II.this.setNew.canopyHandlePosition < 1.0F) {
                CockpitMe_209II.this.setNew.canopyHandlePosition = CockpitMe_209II.this.setOld.canopyHandlePosition + 0.05F;
            }
            if (CockpitMe_209II.this.UnLockedTState) {
                if (CockpitMe_209II.this.setNew.lockTailWheel3Position > 0.0F) {
                    CockpitMe_209II.this.setNew.lockTailWheel3Position = CockpitMe_209II.this.setOld.lockTailWheel3Position - 0.07F;
                }
            } else if (CockpitMe_209II.this.setNew.lockTailWheel3Position < 1.0F) {
                CockpitMe_209II.this.setNew.lockTailWheel3Position = CockpitMe_209II.this.setOld.lockTailWheel3Position + 0.07F;
            }
            if (CockpitMe_209II.this.UnLockedTState) {
                if (CockpitMe_209II.this.setNew.lockTailWheelPosition2 > 0.0F) {
                    CockpitMe_209II.this.setNew.lockTailWheelPosition2 = CockpitMe_209II.this.setOld.lockTailWheelPosition2 - 0.07F;
                }
            } else if (CockpitMe_209II.this.setNew.lockTailWheelPosition2 < 1.0F) {
                CockpitMe_209II.this.setNew.lockTailWheelPosition2 = CockpitMe_209II.this.setOld.lockTailWheelPosition2 + 0.07F;
            }
            if (CockpitMe_209II.this.UnLockedTState) {
                if (CockpitMe_209II.this.setNew.lockTailWheel5Position > 0.0F) {
                    CockpitMe_209II.this.setNew.lockTailWheel5Position = CockpitMe_209II.this.setOld.lockTailWheel5Position - 0.07F;
                }
            } else if (CockpitMe_209II.this.setNew.lockTailWheel5Position < 1.0F) {
                CockpitMe_209II.this.setNew.lockTailWheel5Position = CockpitMe_209II.this.setOld.lockTailWheel5Position + 0.07F;
            }
            if (!CockpitMe_209II.this.cockpitLightControl) {
                if (CockpitMe_209II.this.setNew.cockpitLights0Position > 0.0F) {
                    CockpitMe_209II.this.setNew.cockpitLights0Position = CockpitMe_209II.this.setOld.cockpitLights0Position - 0.1F;
                }
            } else if (CockpitMe_209II.this.setNew.cockpitLights0Position < 1.0F) {
                CockpitMe_209II.this.setNew.cockpitLights0Position = CockpitMe_209II.this.setOld.cockpitLights0Position + 0.1F;
            }
            if (!CockpitMe_209II.this.fm.AS.bNavLightsOn) {
                if (CockpitMe_209II.this.setNew.navLights0Position > 0.0F) {
                    CockpitMe_209II.this.setNew.navLights0Position = CockpitMe_209II.this.setOld.navLights0Position - 0.1F;
                }
            } else if (CockpitMe_209II.this.setNew.navLights0Position < 1.0F) {
                CockpitMe_209II.this.setNew.navLights0Position = CockpitMe_209II.this.setOld.navLights0Position + 0.1F;
            }
            if (CockpitMe_209II.this.fm.EI.engines[0].isPropAngleDeviceOperational()) {
                if (CockpitMe_209II.this.setNew.propPitchPosition < 1.0F) {
                    CockpitMe_209II.this.setNew.propPitchPosition = CockpitMe_209II.this.setOld.propPitchPosition + 0.1F;
                }
                if (CockpitMe_209II.this.setNew.propPitch4Position < 1.0F) {
                    CockpitMe_209II.this.setNew.propPitch4Position = CockpitMe_209II.this.setOld.propPitch4Position + 0.1F;
                }
            } else {
                if (CockpitMe_209II.this.setNew.propPitchPosition > 0.0F) {
                    CockpitMe_209II.this.setNew.propPitchPosition = CockpitMe_209II.this.setOld.propPitchPosition - 0.1F;
                }
                if (CockpitMe_209II.this.setNew.propPitch4Position > 0.0F) {
                    CockpitMe_209II.this.setNew.propPitch4Position = CockpitMe_209II.this.setOld.propPitch4Position - 0.1F;
                }
            }
            if (!CockpitMe_209II.this.cockpitLightControl) {
                if (CockpitMe_209II.this.setNew.cockpitLights2Position > 0.0F) {
                    CockpitMe_209II.this.setNew.cockpitLights2Position = CockpitMe_209II.this.setOld.cockpitLights2Position - 0.1F;
                }
            } else if (CockpitMe_209II.this.setNew.cockpitLights2Position < 1.0F) {
                CockpitMe_209II.this.setNew.cockpitLights2Position = CockpitMe_209II.this.setOld.cockpitLights2Position + 0.1F;
            }
            if (!CockpitMe_209II.this.fm.AS.bNavLightsOn) {
                if (CockpitMe_209II.this.setNew.navLights2Position > 0.0F) {
                    CockpitMe_209II.this.setNew.navLights2Position = CockpitMe_209II.this.setOld.navLights2Position - 0.1F;
                }
            } else if (CockpitMe_209II.this.setNew.navLights2Position < 1.0F) {
                CockpitMe_209II.this.setNew.navLights2Position = CockpitMe_209II.this.setOld.navLights2Position + 0.1F;
            }
            if (!CockpitMe_209II.this.AccelerationState1) {
                if (CockpitMe_209II.this.setNew.cockpit0Position > 0.0F) {
                    CockpitMe_209II.this.setNew.cockpit0Position = CockpitMe_209II.this.setOld.cockpit0Position - 0.02F;
                }
            } else if (CockpitMe_209II.this.setNew.cockpit0Position < 1.0F) {
                CockpitMe_209II.this.setNew.cockpit0Position = CockpitMe_209II.this.setOld.cockpit0Position + 0.02F;
            }
            if (CockpitMe_209II.this.fm.AS.astateSootStates[0] > 0) {
                if (CockpitMe_209II.this.setNew.smoke1Position < 1.0F) {
                    CockpitMe_209II.this.setNew.smoke1Position = CockpitMe_209II.this.setOld.smoke1Position + 1E-005F;
                }
                if (CockpitMe_209II.this.setNew.smoke2Position < 1.0F) {
                    CockpitMe_209II.this.setNew.smoke2Position = CockpitMe_209II.this.setOld.smoke2Position + 2E-005F;
                }
            } else {
                if (CockpitMe_209II.this.setNew.smoke1Position > 0.0F) {
                    CockpitMe_209II.this.setNew.smoke1Position = CockpitMe_209II.this.setOld.smoke1Position - 1E-005F;
                }
                if (CockpitMe_209II.this.setNew.smoke2Position > 0.0F) {
                    CockpitMe_209II.this.setNew.smoke2Position = CockpitMe_209II.this.setOld.smoke2Position - 2E-005F;
                }
            }
            if (CockpitMe_209II.this.fm.EI.engines[0].getReadyness() < 0.8F) {
                if (CockpitMe_209II.this.setNew.smoke3Position < 1.0F) {
                    CockpitMe_209II.this.setNew.smoke3Position = CockpitMe_209II.this.setOld.smoke3Position + 1E-005F;
                }
                if (CockpitMe_209II.this.setNew.smoke4Position < 1.0F) {
                    CockpitMe_209II.this.setNew.smoke4Position = CockpitMe_209II.this.setOld.smoke4Position + 2E-005F;
                }
            } else {
                if (CockpitMe_209II.this.setNew.smoke3Position > 0.0F) {
                    CockpitMe_209II.this.setNew.smoke3Position = CockpitMe_209II.this.setOld.smoke3Position - 1E-005F;
                }
                if (CockpitMe_209II.this.setNew.smoke4Position > 0.0F) {
                    CockpitMe_209II.this.setNew.smoke4Position = CockpitMe_209II.this.setOld.smoke4Position - 2E-005F;
                }
            }
            if (CockpitMe_209II.this.fm.CT.GearControl == 1.0F) {
                if (CockpitMe_209II.this.setNew.gearIndicatorPosition > 0.0F) {
                    CockpitMe_209II.this.setNew.gearIndicatorPosition = CockpitMe_209II.this.setOld.gearIndicatorPosition - 0.005F;
                }
            } else if (CockpitMe_209II.this.setNew.gearIndicatorPosition < 1.0F) {
                CockpitMe_209II.this.setNew.gearIndicatorPosition = CockpitMe_209II.this.setOld.gearIndicatorPosition + 0.005F;
            }
            boolean flag2 = false;
            if (((NetAircraft) ((Aircraft) CockpitMe_209II.this.fm.actor)).thisWeaponsName.toLowerCase().startsWith("u5") && CockpitMe_209II.this.fm.CT.Weapons[9][0].haveBullets()) {
                flag2 = true;
            }
            if (flag2) {
                if (CockpitMe_209II.this.setNew.dropTankPosition < 1.0F) {
                    CockpitMe_209II.this.setNew.dropTankPosition = CockpitMe_209II.this.setOld.dropTankPosition + 0.1F;
                }
            } else if (CockpitMe_209II.this.setNew.dropTankPosition > 0.0F) {
                CockpitMe_209II.this.setNew.dropTankPosition = CockpitMe_209II.this.setOld.dropTankPosition - 0.1F;
            }
            if (!CockpitMe_209II.this.GunsightMove) {
                if (CockpitMe_209II.this.setNew.revi16SupportPosition > 0.0F) {
                    CockpitMe_209II.this.setNew.revi16SupportPosition = CockpitMe_209II.this.setOld.revi16SupportPosition - 0.05F;
                }
            } else if (CockpitMe_209II.this.setNew.revi16SupportPosition < 1.0F) {
                CockpitMe_209II.this.setNew.revi16SupportPosition = CockpitMe_209II.this.setOld.revi16SupportPosition + 0.05F;
            }
            if (!CockpitMe_209II.this.RotGunsightDelay) {
                if (CockpitMe_209II.this.setNew.revi16Support2Position > 0.0F) {
                    CockpitMe_209II.this.setNew.revi16Support2Position = CockpitMe_209II.this.setOld.revi16Support2Position - 0.05F;
                }
            } else if (CockpitMe_209II.this.setNew.revi16Support2Position < 1.0F) {
                CockpitMe_209II.this.setNew.revi16Support2Position = CockpitMe_209II.this.setOld.revi16Support2Position + 0.05F;
            }
            if (CockpitMe_209II.this.fm.EI.engines[0].getControlAfterburner()) {
                if (CockpitMe_209II.this.setNew.mw50Position < 1.0F) {
                    CockpitMe_209II.this.setNew.mw50Position = CockpitMe_209II.this.setOld.mw50Position + 0.5F;
                }
            } else if (CockpitMe_209II.this.setNew.mw50Position > 0.0F) {
                CockpitMe_209II.this.setNew.mw50Position = CockpitMe_209II.this.setOld.mw50Position - 0.5F;
            }
            if (!CockpitMe_209II.this.RotGunsightDelay) {
                if (CockpitMe_209II.this.setNew.revi16Support3Position > 0.0F) {
                    CockpitMe_209II.this.setNew.revi16Support3Position = CockpitMe_209II.this.setOld.revi16Support3Position - 0.05F;
                }
            } else if (CockpitMe_209II.this.setNew.revi16Support3Position < 1.0F) {
                CockpitMe_209II.this.setNew.revi16Support3Position = CockpitMe_209II.this.setOld.revi16Support3Position + 0.05F;
            }
            if (CockpitMe_209II.this.fm.CT.cockpitDoorControl == 1.0F) {
                if (CockpitMe_209II.this.setNew.topCablePosition2 > 0.0F) {
                    CockpitMe_209II.this.setNew.topCablePosition2 = CockpitMe_209II.this.setOld.topCablePosition2 - 0.022F;
                }
            } else if (CockpitMe_209II.this.setNew.topCablePosition2 < 1.0F) {
                CockpitMe_209II.this.setNew.topCablePosition2 = CockpitMe_209II.this.setOld.topCablePosition2 + 0.022F;
            }
            if (CockpitMe_209II.this.fm.EI.engines[0].getControlAfterburner() && (CockpitMe_209II.this.setNew.mw50CountPosition < 1.0F)) {
                CockpitMe_209II.this.setNew.mw50CountPosition += 5E-005F;
            }
            boolean flag4 = false;
            if (((NetAircraft) ((Aircraft) CockpitMe_209II.this.fm.actor)).thisWeaponsName.toLowerCase().startsWith("r1") && CockpitMe_209II.this.fm.CT.Weapons[3][0].haveBullets()) {
                flag4 = true;
            }
            if (flag4) {
                if (CockpitMe_209II.this.setNew.bombsContact1Position < 1.0F) {
                    CockpitMe_209II.this.setNew.bombsContact1Position = CockpitMe_209II.this.setOld.bombsContact1Position + 0.5F;
                }
                if (CockpitMe_209II.this.setNew.bombsContact2Position < 1.0F) {
                    CockpitMe_209II.this.setNew.bombsContact2Position = CockpitMe_209II.this.setOld.bombsContact2Position + 0.5F;
                }
                if (CockpitMe_209II.this.setNew.bombsPanel1Position < 1.0F) {
                    CockpitMe_209II.this.setNew.bombsPanel1Position = CockpitMe_209II.this.setOld.bombsPanel1Position + 1.0F;
                }
            } else if (CockpitMe_209II.this.setNew.bombsPanel1Position > 0.0F) {
                CockpitMe_209II.this.setNew.bombsPanel1Position = CockpitMe_209II.this.setOld.bombsPanel1Position - 1.0F;
            }
            if (CockpitMe_209II.this.setNew.leftPedalBase1Position < 1.0F) {
                CockpitMe_209II.this.setNew.leftPedalBase1Position = CockpitMe_209II.this.setOld.leftPedalBase1Position + 1.0F;
            }
            if (CockpitMe_209II.this.setNew.rightPedalBase1Position < 1.0F) {
                CockpitMe_209II.this.setNew.rightPedalBase1Position = CockpitMe_209II.this.setOld.rightPedalBase1Position + 1.0F;
            }
            if (!CockpitMe_209II.this.cockpitDimControl) {
                if (CockpitMe_209II.this.setNew.dimPosition > 0.0F) {
                    CockpitMe_209II.this.setNew.dimPosition = CockpitMe_209II.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitMe_209II.this.setNew.dimPosition < 1.0F) {
                CockpitMe_209II.this.setNew.dimPosition = CockpitMe_209II.this.setOld.dimPosition + 0.05F;
            }
            CockpitMe_209II.this.setNew.throttle = ((10F * CockpitMe_209II.this.setOld.throttle) + CockpitMe_209II.this.fm.CT.PowerControl) / 11F;
            CockpitMe_209II.this.setNew.waypointAzimuth.setDeg(CockpitMe_209II.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitMe_209II.this.waypointAzimuth() - CockpitMe_209II.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitMe_209II.this.fm.Or.getKren()) < 30F) {
                CockpitMe_209II.this.setNew.azimuth.setDeg(CockpitMe_209II.this.setOld.azimuth.getDeg(1.0F), CockpitMe_209II.this.fm.Or.azimut());
            }
            CockpitMe_209II.this.buzzerFX((CockpitMe_209II.this.fm.CT.getGear() < 0.999999F) && (CockpitMe_209II.this.fm.CT.getFlap() > 0.1F));
            return true;
        }
    ...
    private class Variables {
        ...
        public Variables() {
            this.shotPosition = new float[CockpitMe_209II.NUM_COUNTERS];
    ...
    public CockpitMe_209II() {
        super("3do/cockpit/Me-209-II/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitMe_209II.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitMe_209II.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), CockpitMe_209II.fuelScale), 0.0F, 0.0F);
        ...
        if (flag) {
            for (int j = 3; j < CockpitMe_209II.MAX_GUNS; j++) {
    ...
    protected void reflectPlaneMats() {
        ...
        String s1 = ((NetAircraft) (this.aircraft())).thisWeaponsName.toUpperCase();
        ...
        for (int i = 0; i < CockpitMe_209II.MAX_GUNS; i++) {
    ...
    static {
        Property.set(CockpitMe_209II.class, "normZNs", new float[] { 0.72F, 0.47F, 0.47F, 0.47F });
    }
