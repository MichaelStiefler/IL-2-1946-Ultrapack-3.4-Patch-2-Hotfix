...
public class CockpitMorane extends CockpitPilot {
    private class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitMorane.this.fm != null) {
                CockpitMorane.this.setTmp = CockpitMorane.this.setOld;
                CockpitMorane.this.setOld = CockpitMorane.this.setNew;
                CockpitMorane.this.setNew = CockpitMorane.this.setTmp;
                CockpitMorane.this.setNew.throttle = (0.92F * CockpitMorane.this.setOld.throttle) + (0.08F * CockpitMorane.this.fm.CT.PowerControl);
                CockpitMorane.this.setNew.prop = (0.92F * CockpitMorane.this.setOld.prop) + (0.08F * CockpitMorane.this.fm.EI.engines[0].getControlProp());
                CockpitMorane.this.setNew.mix = (0.92F * CockpitMorane.this.setOld.mix) + (0.08F * CockpitMorane.this.fm.EI.engines[0].getControlMix());
                CockpitMorane.this.setNew.altimeter = CockpitMorane.this.fm.getAltitude();
                CockpitMorane.this.setNew.waypointAzimuth.setDeg(CockpitMorane.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitMorane.this.waypointAzimuth() - CockpitMorane.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitMorane.this.fm.Or.getKren()) < 30F) {
                    CockpitMorane.this.setNew.azimuth.setDeg(CockpitMorane.this.setOld.azimuth.getDeg(1.0F), CockpitMorane.this.fm.Or.azimut());
                }
                CockpitMorane.this.setNew.vspeed = (0.99F * CockpitMorane.this.setOld.vspeed) + (0.01F * CockpitMorane.this.fm.getVertSpeed());
                if (CockpitMorane.this.fm.CT.GearControl < 0.5F) {
                    if (CockpitMorane.this.setNew.gearPhi > 0.0F) {
                        CockpitMorane.this.setNew.gearPhi = CockpitMorane.this.setOld.gearPhi - 0.021F;
                    }
                } else if (CockpitMorane.this.setNew.gearPhi < 1.0F) {
                    CockpitMorane.this.setNew.gearPhi = CockpitMorane.this.setOld.gearPhi + 0.021F;
                }
            }
            return true;
    ...
    public CockpitMorane() {
        super("3DO/Cockpit/Morane/Morane.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 10F), CockpitMorane.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_VY", -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitMorane.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 5000F, 0.0F, 10F), CockpitMorane.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, -306F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitMorane.radScale), 0.0F, 0.0F);
