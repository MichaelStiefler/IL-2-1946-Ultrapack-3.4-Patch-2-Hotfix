...
public class CockpitMosquito16 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitMosquito16.this.fm != null) {
                CockpitMosquito16.this.setTmp = CockpitMosquito16.this.setOld;
                CockpitMosquito16.this.setOld = CockpitMosquito16.this.setNew;
                CockpitMosquito16.this.setNew = CockpitMosquito16.this.setTmp;
                CockpitMosquito16.this.setNew.throttle1 = (0.85F * CockpitMosquito16.this.setOld.throttle1) + (CockpitMosquito16.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitMosquito16.this.setNew.prop1 = (0.85F * CockpitMosquito16.this.setOld.prop1) + (CockpitMosquito16.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitMosquito16.this.setNew.throttle2 = (0.85F * CockpitMosquito16.this.setOld.throttle2) + (CockpitMosquito16.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitMosquito16.this.setNew.prop2 = (0.85F * CockpitMosquito16.this.setOld.prop2) + (CockpitMosquito16.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitMosquito16.this.setNew.altimeter = CockpitMosquito16.this.fm.getAltitude();
                float f = CockpitMosquito16.this.waypointAzimuth();
                CockpitMosquito16.this.setNew.waypointAzimuth.setDeg(CockpitMosquito16.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitMosquito16.this.setOld.azimuth.getDeg(1.0F));
                if (Math.abs(CockpitMosquito16.this.fm.Or.getKren()) < 30F) {
                    CockpitMosquito16.this.setNew.azimuth.setDeg(CockpitMosquito16.this.setOld.azimuth.getDeg(1.0F), CockpitMosquito16.this.fm.Or.azimut());
                }
                CockpitMosquito16.this.setNew.vspeed = (0.99F * CockpitMosquito16.this.setOld.vspeed) + (0.01F * CockpitMosquito16.this.fm.getVertSpeed());
                switch (CockpitMosquito16.this.iWiper) {
                    default:
                        break;

                    case 0:
                        if ((Mission.curCloudsType() > 4) && (CockpitMosquito16.this.fm.getSpeedKMH() < 220F) && (CockpitMosquito16.this.fm.getAltitude() < (Mission.curCloudsHeight() + 300F))) {
                            CockpitMosquito16.this.iWiper = 1;
                        }
                        break;

                    case 1:
                        CockpitMosquito16.this.setNew.wiper = CockpitMosquito16.this.setOld.wiper - 0.05F;
                        if (CockpitMosquito16.this.setNew.wiper < -1.03F) {
                            CockpitMosquito16.this.iWiper++;
                        }
                        if (CockpitMosquito16.this.wiState >= 2) {
                            break;
                        }
                        if (CockpitMosquito16.this.wiState == 0) {
                            if (CockpitMosquito16.this.fxw == null) {
                                CockpitMosquito16.this.fxw = CockpitMosquito16.this.aircraft().newSound("aircraft.wiper", false);
                                if (CockpitMosquito16.this.fxw != null) {
                                    CockpitMosquito16.this.fxw.setParent(CockpitMosquito16.this.aircraft().getRootFX());
                                    CockpitMosquito16.this.fxw.setPosition(CockpitMosquito16.this.sfxPos);
                                }
                            }
                            if (CockpitMosquito16.this.fxw != null) {
                                CockpitMosquito16.this.fxw.play(CockpitMosquito16.this.wiStart);
                            }
                        }
                        if (CockpitMosquito16.this.fxw != null) {
                            CockpitMosquito16.this.fxw.play(CockpitMosquito16.this.wiRun);
                            CockpitMosquito16.this.wiState = 2;
                        }
                        break;
                    ...
                    case 2:
                        ...
                        if (CockpitMosquito16.this.wiState > 1) {
                            CockpitMosquito16.this.wiState = 1;
                        }
                        break;

                    case 3:
                        CockpitMosquito16.this.setNew.wiper = CockpitMosquito16.this.setOld.wiper - 0.05F;
                        if (CockpitMosquito16.this.setNew.wiper >= 0.02F) {
                            break;
                        }
                        if ((CockpitMosquito16.this.fm.getSpeedKMH() > 250F) || (CockpitMosquito16.this.fm.getAltitude() > (Mission.curCloudsHeight() + 400F))) {
                            CockpitMosquito16.this.iWiper++;
                        } else {
                            CockpitMosquito16.this.iWiper = 1;
                        }
                    ...
                    case 4:
                        CockpitMosquito16.this.setNew.wiper = CockpitMosquito16.this.setOld.wiper;
                        CockpitMosquito16.this.iWiper = 0;
                        CockpitMosquito16.this.wiState = 0;
                        if (CockpitMosquito16.this.fxw != null) {
                            CockpitMosquito16.this.fxw.cancel();
                        }
                        break;
                }
            }
    ...
    public CockpitMosquito16() {
        super("3DO/Cockpit/Mosquito_FB_MkVI/CockpitMosquito16.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST1", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitMosquito16.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST2", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitMosquito16.boostScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TEMP_RAD1", this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitMosquito16.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_TEMP_RAD2", this.floatindex(this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitMosquito16.radScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 26.8224F, 214.5792F, 0.0F, 21F), CockpitMosquito16.speedometerScale), 0.0F, 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("STR_CLIMB", this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitMosquito16.variometerScale), 0.0F, 0.0F);
        }
