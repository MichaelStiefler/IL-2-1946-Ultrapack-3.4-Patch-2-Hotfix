...
public class CockpitMosquito4 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitMosquito4.this.fm != null) {
                CockpitMosquito4.this.setTmp = CockpitMosquito4.this.setOld;
                CockpitMosquito4.this.setOld = CockpitMosquito4.this.setNew;
                CockpitMosquito4.this.setNew = CockpitMosquito4.this.setTmp;
                CockpitMosquito4.this.setNew.throttle1 = (0.85F * CockpitMosquito4.this.setOld.throttle1) + (CockpitMosquito4.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitMosquito4.this.setNew.prop1 = (0.85F * CockpitMosquito4.this.setOld.prop1) + (CockpitMosquito4.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitMosquito4.this.setNew.throttle2 = (0.85F * CockpitMosquito4.this.setOld.throttle2) + (CockpitMosquito4.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitMosquito4.this.setNew.prop2 = (0.85F * CockpitMosquito4.this.setOld.prop2) + (CockpitMosquito4.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitMosquito4.this.setNew.altimeter = CockpitMosquito4.this.fm.getAltitude();
                float f = CockpitMosquito4.this.waypointAzimuth();
                if (CockpitMosquito4.this.useRealisticNavigationInstruments()) {
                    CockpitMosquito4.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitMosquito4.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitMosquito4.this.setNew.waypointAzimuth.setDeg(CockpitMosquito4.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                }
                if (Math.abs(CockpitMosquito4.this.fm.Or.getKren()) < 30F) {
                    CockpitMosquito4.this.setNew.azimuth.setDeg(CockpitMosquito4.this.setOld.azimuth.getDeg(1.0F), CockpitMosquito4.this.fm.Or.azimut());
                }
                CockpitMosquito4.this.setNew.vspeed = (0.99F * CockpitMosquito4.this.setOld.vspeed) + (0.01F * CockpitMosquito4.this.fm.getVertSpeed());
                switch (CockpitMosquito4.this.iWiper) {
                    default:
                        break;

                    case 0:
                        if ((Mission.curCloudsType() > 4) && (CockpitMosquito4.this.fm.getSpeedKMH() < 220F) && (CockpitMosquito4.this.fm.getAltitude() < (Mission.curCloudsHeight() + 300F))) {
                            CockpitMosquito4.this.iWiper = 1;
                        }
                        break;

                    case 1:
                        CockpitMosquito4.this.setNew.wiper = CockpitMosquito4.this.setOld.wiper - 0.05F;
                        if (CockpitMosquito4.this.setNew.wiper < -1.03F) {
                            CockpitMosquito4.this.iWiper++;
                        }
                        if (CockpitMosquito4.this.wiState >= 2) {
                            break;
                        }
                        if (CockpitMosquito4.this.wiState == 0) {
                            if (CockpitMosquito4.this.fxw == null) {
                                CockpitMosquito4.this.fxw = CockpitMosquito4.this.aircraft().newSound("aircraft.wiper", false);
                                if (CockpitMosquito4.this.fxw != null) {
                                    CockpitMosquito4.this.fxw.setParent(CockpitMosquito4.this.aircraft().getRootFX());
                                    CockpitMosquito4.this.fxw.setPosition(CockpitMosquito4.this.sfxPos);
                                }
                            }
                            if (CockpitMosquito4.this.fxw != null) {
                                CockpitMosquito4.this.fxw.play(CockpitMosquito4.this.wiStart);
                            }
                        }
                        if (CockpitMosquito4.this.fxw != null) {
                            CockpitMosquito4.this.fxw.play(CockpitMosquito4.this.wiRun);
                            CockpitMosquito4.this.wiState = 2;
                        }
                        break;
                    ...
                    case 2:
                        ...
                        if (CockpitMosquito4.this.wiState > 1) {
                            CockpitMosquito4.this.wiState = 1;
                        }
                        break;

                    case 3:
                        CockpitMosquito4.this.setNew.wiper = CockpitMosquito4.this.setOld.wiper - 0.05F;
                        if (CockpitMosquito4.this.setNew.wiper >= 0.02F) {
                            break;
                        }
                        if ((CockpitMosquito4.this.fm.getSpeedKMH() > 250F) || (CockpitMosquito4.this.fm.getAltitude() > (Mission.curCloudsHeight() + 400F))) {
                            CockpitMosquito4.this.iWiper++;
                        } else {
                            CockpitMosquito4.this.iWiper = 1;
                        }
                    ...
                    case 4:
                        CockpitMosquito4.this.setNew.wiper = CockpitMosquito4.this.setOld.wiper;
                        CockpitMosquito4.this.iWiper = 0;
                        CockpitMosquito4.this.wiState = 0;
                        if (CockpitMosquito4.this.fxw != null) {
                            CockpitMosquito4.this.fxw.cancel();
                        }
                        break;
                }
            }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Compass2", this.setNew.azimuth.getDeg(f) + this.setNew.waypointAzimuth.getDeg(f * 0.1F) + 90F, 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST1", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitMosquito4.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST2", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitMosquito4.boostScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TEMP_RAD1", this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitMosquito4.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_TEMP_RAD2", this.floatindex(this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitMosquito4.radScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 26.8224F, 214.5792F, 0.0F, 21F), CockpitMosquito4.speedometerScale), 0.0F, 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("STR_CLIMB", this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitMosquito4.variometerScale), 0.0F, 0.0F);
        }
