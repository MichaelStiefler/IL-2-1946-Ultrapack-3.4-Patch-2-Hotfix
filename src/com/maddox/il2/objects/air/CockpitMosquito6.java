...
public class CockpitMosquito6 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitMosquito6.this.fm != null) {
                CockpitMosquito6.this.setTmp = CockpitMosquito6.this.setOld;
                CockpitMosquito6.this.setOld = CockpitMosquito6.this.setNew;
                CockpitMosquito6.this.setNew = CockpitMosquito6.this.setTmp;
                ...
                if (CockpitMosquito6.this.useRealisticNavigationInstruments()) {
                    CockpitMosquito6.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitMosquito6.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitMosquito6.this.setNew.waypointAzimuth.setDeg(CockpitMosquito6.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                }
                if (Math.abs(CockpitMosquito6.this.fm.Or.getKren()) < 30F) {
                ...
                switch (CockpitMosquito6.this.iWiper) {
                    ...
                    case 0:
                        if ((Mission.curCloudsType() > 4) && (CockpitMosquito6.this.fm.getSpeedKMH() < 220F) && (CockpitMosquito6.this.fm.getAltitude() < (Mission.curCloudsHeight() + 300F))) {
                            CockpitMosquito6.this.iWiper = 1;
                        }
                        break;
                    ...
                    case 1:
                        ...
                        if (CockpitMosquito6.this.setNew.wiper < -1.03F) {
                            CockpitMosquito6.this.iWiper++;
                        }
                        if (CockpitMosquito6.this.wiState >= 2) {
                            break;
                        }
                        if (CockpitMosquito6.this.wiState == 0) {
                            if (CockpitMosquito6.this.fxw == null) {
                                CockpitMosquito6.this.fxw = CockpitMosquito6.this.aircraft().newSound("aircraft.wiper", false);
                                if (CockpitMosquito6.this.fxw != null) {
                            ...
                            if (CockpitMosquito6.this.fxw != null) {
                                CockpitMosquito6.this.fxw.play(CockpitMosquito6.this.wiStart);
                            }
                        }
                        if (CockpitMosquito6.this.fxw != null) {
                            CockpitMosquito6.this.fxw.play(CockpitMosquito6.this.wiRun);
                            CockpitMosquito6.this.wiState = 2;
                        }
                        break;
                    ...
                    case 2:
                        ...
                        if (CockpitMosquito6.this.wiState > 1) {
                            CockpitMosquito6.this.wiState = 1;
                        }
                        break;

                    case 3:
                        CockpitMosquito6.this.setNew.wiper = CockpitMosquito6.this.setOld.wiper - 0.05F;
                        if (CockpitMosquito6.this.setNew.wiper >= 0.02F) {
                            break;
                        }
                        if ((CockpitMosquito6.this.fm.getSpeedKMH() > 250F) || (CockpitMosquito6.this.fm.getAltitude() > (Mission.curCloudsHeight() + 400F))) {
                            CockpitMosquito6.this.iWiper++;
                        } else {
                            CockpitMosquito6.this.iWiper = 1;
                        }
                    ...
                    case 4:
                        ...
                        CockpitMosquito6.this.iWiper = 0;
                        CockpitMosquito6.this.wiState = 0;
                        if (CockpitMosquito6.this.fxw != null) {
                            CockpitMosquito6.this.fxw.cancel();
                        }
                        break;
                }
            }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST1", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitMosquito6.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST2", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitMosquito6.boostScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TEMP_RAD1", this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitMosquito6.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_TEMP_RAD2", this.floatindex(this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitMosquito6.radScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 26.8224F, 214.5792F, 0.0F, 21F), CockpitMosquito6.speedometerScale), 0.0F, 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("STR_CLIMB", this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitMosquito6.variometerScale), 0.0F, 0.0F);
        }
