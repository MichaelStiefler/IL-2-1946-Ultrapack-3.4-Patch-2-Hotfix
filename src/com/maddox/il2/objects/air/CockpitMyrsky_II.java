...
public class CockpitMyrsky_II extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitMyrsky_II.this.bNeedSetUp) {
                CockpitMyrsky_II.this.reflectPlaneMats();
                CockpitMyrsky_II.this.bNeedSetUp = false;
            }
            if (CockpitMyrsky_II.this.fm != null) {
                CockpitMyrsky_II.this.setTmp = CockpitMyrsky_II.this.setOld;
                CockpitMyrsky_II.this.setOld = CockpitMyrsky_II.this.setNew;
                CockpitMyrsky_II.this.setNew = CockpitMyrsky_II.this.setTmp;
                CockpitMyrsky_II.this.setNew.throttle = ((10F * CockpitMyrsky_II.this.setOld.throttle) + CockpitMyrsky_II.this.fm.CT.PowerControl) / 11F;
                CockpitMyrsky_II.this.setNew.altimeter = CockpitMyrsky_II.this.fm.getAltitude();
                CockpitMyrsky_II.this.setNew.waypointAzimuth.setDeg(CockpitMyrsky_II.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitMyrsky_II.this.waypointAzimuth() - CockpitMyrsky_II.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitMyrsky_II.this.fm.Or.getKren()) < 30F) {
                    CockpitMyrsky_II.this.setNew.azimuth.setDeg(CockpitMyrsky_II.this.setOld.azimuth.getDeg(1.0F), CockpitMyrsky_II.this.fm.Or.azimut());
                }
                CockpitMyrsky_II.this.setNew.vspeed = ((199F * CockpitMyrsky_II.this.setOld.vspeed) + CockpitMyrsky_II.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitMyrsky_II() {
        super("3DO/Cockpit/Myrsky/Myrsky_hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitMyrsky_II.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 100F, 0.0F, 270F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitMyrsky_II.radScale));
        this.resetYPRmodifier();
        ...
        if (this.bFAF) {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 143.0528F, 0.0F, 32F), CockpitMyrsky_II.speedometerScaleFAF));
        } else {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 180.0555F, 0.0F, 35F), CockpitMyrsky_II.speedometerScale));
        }
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitMyrsky_II.variometerScale));
    ...
    static {
        Property.set(CockpitMyrsky_II.class, "normZN", 0.77F);
    }
