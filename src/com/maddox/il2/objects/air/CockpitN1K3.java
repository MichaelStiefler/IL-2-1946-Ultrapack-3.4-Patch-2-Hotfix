...
public class CockpitN1K3 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitN1K3.this.fm != null) {
                CockpitN1K3.this.setTmp = CockpitN1K3.this.setOld;
                CockpitN1K3.this.setOld = CockpitN1K3.this.setNew;
                CockpitN1K3.this.setNew = CockpitN1K3.this.setTmp;
                CockpitN1K3.this.setNew.flap = (0.88F * CockpitN1K3.this.setOld.flap) + (0.12F * CockpitN1K3.this.fm.CT.FlapsControl);
                CockpitN1K3.this.setNew.tlock = (0.7F * CockpitN1K3.this.setOld.tlock) + (0.3F * (CockpitN1K3.this.fm.Gears.bTailwheelLocked ? 1.0F : 0.0F));
                if (CockpitN1K3.this.cockpitDimControl) {
                    if (CockpitN1K3.this.setNew.dimPosition > 0.0F) {
                        CockpitN1K3.this.setNew.dimPosition = CockpitN1K3.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitN1K3.this.setNew.dimPosition < 1.0F) {
                    CockpitN1K3.this.setNew.dimPosition = CockpitN1K3.this.setOld.dimPosition + 0.05F;
                }
                if ((CockpitN1K3.this.fm.CT.GearControl < 0.5F) && (CockpitN1K3.this.setNew.gear < 1.0F)) {
                    CockpitN1K3.this.setNew.gear = CockpitN1K3.this.setOld.gear + 0.02F;
                }
                if ((CockpitN1K3.this.fm.CT.GearControl > 0.5F) && (CockpitN1K3.this.setNew.gear > 0.0F)) {
                    CockpitN1K3.this.setNew.gear = CockpitN1K3.this.setOld.gear - 0.02F;
                }
                CockpitN1K3.this.setNew.throttle = (0.9F * CockpitN1K3.this.setOld.throttle) + (0.1F * CockpitN1K3.this.fm.CT.PowerControl);
                CockpitN1K3.this.setNew.manifold = (0.8F * CockpitN1K3.this.setOld.manifold) + (0.2F * CockpitN1K3.this.fm.EI.engines[0].getManifoldPressure());
                CockpitN1K3.this.setNew.pitch = (0.9F * CockpitN1K3.this.setOld.pitch) + (0.1F * CockpitN1K3.this.fm.EI.engines[0].getControlProp());
                CockpitN1K3.this.setNew.mix = (0.9F * CockpitN1K3.this.setOld.mix) + (0.1F * CockpitN1K3.this.fm.EI.engines[0].getControlMix());
                CockpitN1K3.this.setNew.altimeter = CockpitN1K3.this.fm.getAltitude();
                if (Math.abs(CockpitN1K3.this.fm.Or.getKren()) < 30F) {
                    CockpitN1K3.this.setNew.azimuth.setDeg(CockpitN1K3.this.setOld.azimuth.getDeg(1.0F), CockpitN1K3.this.fm.Or.azimut());
                }
                float f = CockpitN1K3.this.waypointAzimuth();
                CockpitN1K3.this.setNew.waypointAzimuth.setDeg(CockpitN1K3.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitN1K3.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-3F, 3F));
                CockpitN1K3.this.setNew.vspeed = ((199F * CockpitN1K3.this.setOld.vspeed) + CockpitN1K3.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitN1K3() {
        super("3DO/Cockpit/N1K3/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.resetYPRmodifier();
        float f_0_ = this.pictTE;
        if (f_0_ < 0.0F) {
            Cockpit.xyz[1] = this.cvt(f_0_, -0.25F, 0.0F, -0.02305F, 0.0F);
        } else {
            Cockpit.xyz[1] = this.cvt(f_0_, 0.0F, 0.5F, 0.0F, 0.04985F);
        }
        ...
        this.mesh.chunkSetAngles("NeedOilTemp", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 110F, 0.0F, 8F), CockpitN1K3.oilTScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedRPM", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitN1K3.revolutionsScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 740.7998F, 0.0F, 20F), CockpitN1K3.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedExternalT", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 233.09F, 333.09F, 0.0F, 5F), CockpitN1K3.frAirTempScale), 0.0F, 0.0F);
