...
public class CockpitNC223_4 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitNC223_4.this.fm != null) {
                CockpitNC223_4.this.setTmp = CockpitNC223_4.this.setOld;
                CockpitNC223_4.this.setOld = CockpitNC223_4.this.setNew;
                CockpitNC223_4.this.setNew = CockpitNC223_4.this.setTmp;
                CockpitNC223_4.this.setNew.throttle1 = (0.9F * CockpitNC223_4.this.setOld.throttle1) + (0.1F * CockpitNC223_4.this.fm.EI.engines[0].getControlThrottle());
                CockpitNC223_4.this.setNew.throttle2 = (0.9F * CockpitNC223_4.this.setOld.throttle2) + (0.1F * CockpitNC223_4.this.fm.EI.engines[1].getControlThrottle());
                CockpitNC223_4.this.setNew.throttle3 = (0.9F * CockpitNC223_4.this.setOld.throttle3) + (0.1F * CockpitNC223_4.this.fm.EI.engines[2].getControlThrottle());
                CockpitNC223_4.this.setNew.throttle4 = (0.9F * CockpitNC223_4.this.setOld.throttle4) + (0.1F * CockpitNC223_4.this.fm.EI.engines[3].getControlThrottle());
                CockpitNC223_4.this.setNew.prop1 = (0.9F * CockpitNC223_4.this.setOld.prop1) + (0.1F * CockpitNC223_4.this.fm.EI.engines[0].getControlProp());
                CockpitNC223_4.this.setNew.prop2 = (0.9F * CockpitNC223_4.this.setOld.prop2) + (0.1F * CockpitNC223_4.this.fm.EI.engines[1].getControlProp());
                CockpitNC223_4.this.setNew.prop3 = (0.9F * CockpitNC223_4.this.setOld.prop3) + (0.1F * CockpitNC223_4.this.fm.EI.engines[2].getControlProp());
                CockpitNC223_4.this.setNew.prop4 = (0.9F * CockpitNC223_4.this.setOld.prop4) + (0.1F * CockpitNC223_4.this.fm.EI.engines[3].getControlProp());
                CockpitNC223_4.this.setNew.mix1 = (0.8F * CockpitNC223_4.this.setOld.mix1) + (0.2F * CockpitNC223_4.this.fm.EI.engines[0].getControlMix());
                CockpitNC223_4.this.setNew.mix2 = (0.8F * CockpitNC223_4.this.setOld.mix2) + (0.2F * CockpitNC223_4.this.fm.EI.engines[1].getControlMix());
                CockpitNC223_4.this.setNew.mix3 = (0.8F * CockpitNC223_4.this.setOld.mix3) + (0.2F * CockpitNC223_4.this.fm.EI.engines[2].getControlMix());
                CockpitNC223_4.this.setNew.mix4 = (0.8F * CockpitNC223_4.this.setOld.mix4) + (0.2F * CockpitNC223_4.this.fm.EI.engines[3].getControlMix());
                CockpitNC223_4.this.setNew.man1 = (0.92F * CockpitNC223_4.this.setOld.man1) + (0.08F * CockpitNC223_4.this.fm.EI.engines[0].getManifoldPressure());
                CockpitNC223_4.this.setNew.man2 = (0.92F * CockpitNC223_4.this.setOld.man2) + (0.08F * CockpitNC223_4.this.fm.EI.engines[1].getManifoldPressure());
                CockpitNC223_4.this.setNew.man3 = (0.92F * CockpitNC223_4.this.setOld.man3) + (0.08F * CockpitNC223_4.this.fm.EI.engines[2].getManifoldPressure());
                CockpitNC223_4.this.setNew.man4 = (0.92F * CockpitNC223_4.this.setOld.man4) + (0.08F * CockpitNC223_4.this.fm.EI.engines[3].getManifoldPressure());
                CockpitNC223_4.this.setNew.altimeter = CockpitNC223_4.this.fm.getAltitude();
                if (Math.abs(CockpitNC223_4.this.fm.Or.getKren()) < 30F) {
                    CockpitNC223_4.this.setNew.azimuth.setDeg(CockpitNC223_4.this.setOld.azimuth.getDeg(1.0F), CockpitNC223_4.this.fm.Or.azimut());
                }
                CockpitNC223_4.this.setNew.vspeed = ((199F * CockpitNC223_4.this.setOld.vspeed) + CockpitNC223_4.this.fm.getVertSpeed()) / 200F;
                float f = CockpitNC223_4.this.waypointAzimuth();
                CockpitNC223_4.this.setNew.waypointAzimuth.setDeg(CockpitNC223_4.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitNC223_4.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitNC223_4.this.setNew.waypointDirection.setDeg(CockpitNC223_4.this.setOld.waypointDirection.getDeg(1.0F), f);
                CockpitNC223_4.this.setNew.inert = (0.999F * CockpitNC223_4.this.setOld.inert) + (0.001F * (CockpitNC223_4.this.fm.EI.engines[0].getStage() != 6 ? 0.0F : 0.867F));
                CockpitNC223_4.this.setNew.waypointAzimuth.setDeg(CockpitNC223_4.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitNC223_4.this.setOld.azimuth.getDeg(1.0F)) + 90F);
            }
            return true;
        }
    ...
    public CockpitNC223_4() {
        super("3DO/Cockpit/NC220/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        float f2 = this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitNC223_4.speedometerScale);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitNC223_4.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp71", this.floatindex(this.cvt(this.fm.EI.engines[3].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitNC223_4.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitNC223_4.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp81", this.floatindex(this.cvt(this.fm.EI.engines[2].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitNC223_4.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitNC223_4.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitNC223_4.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM3", this.floatindex(this.cvt(this.fm.EI.engines[2].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitNC223_4.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM4", this.floatindex(this.cvt(this.fm.EI.engines[3].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitNC223_4.rpmScale), 0.0F, 0.0F);
