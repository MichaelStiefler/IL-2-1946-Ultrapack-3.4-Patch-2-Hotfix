...
public class CockpitNaka_A2N extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitNaka_A2N.this.fm != null) {
                CockpitNaka_A2N.this.setTmp = CockpitNaka_A2N.this.setOld;
                CockpitNaka_A2N.this.setOld = CockpitNaka_A2N.this.setNew;
                CockpitNaka_A2N.this.setNew = CockpitNaka_A2N.this.setTmp;
                if (CockpitNaka_A2N.this.cockpitDimControl) {
                    if (CockpitNaka_A2N.this.setNew.dimPos < 1.0F) {
                        CockpitNaka_A2N.this.setNew.dimPos = CockpitNaka_A2N.this.setOld.dimPos + 0.03F;
                    }
                } else if (CockpitNaka_A2N.this.setNew.dimPos > 0.0F) {
                    CockpitNaka_A2N.this.setNew.dimPos = CockpitNaka_A2N.this.setOld.dimPos - 0.03F;
                }
                CockpitNaka_A2N.this.setNew.manifold = (0.8F * CockpitNaka_A2N.this.setOld.manifold) + (0.2F * CockpitNaka_A2N.this.fm.EI.engines[0].getManifoldPressure());
                CockpitNaka_A2N.this.setNew.throttle = (0.8F * CockpitNaka_A2N.this.setOld.throttle) + (0.2F * CockpitNaka_A2N.this.fm.CT.PowerControl);
                CockpitNaka_A2N.this.setNew.prop = (0.8F * CockpitNaka_A2N.this.setOld.prop) + (0.2F * CockpitNaka_A2N.this.fm.EI.engines[0].getControlProp());
                CockpitNaka_A2N.this.setNew.mix = (0.8F * CockpitNaka_A2N.this.setOld.mix) + (0.2F * CockpitNaka_A2N.this.fm.EI.engines[0].getControlMix());
                CockpitNaka_A2N.this.setNew.man = (0.92F * CockpitNaka_A2N.this.setOld.man) + (0.08F * CockpitNaka_A2N.this.fm.EI.engines[0].getManifoldPressure());
                CockpitNaka_A2N.this.setNew.altimeter = CockpitNaka_A2N.this.fm.getAltitude();
                float f = CockpitNaka_A2N.this.waypointAzimuth();
                if (Math.abs(CockpitNaka_A2N.this.fm.Or.getKren()) < 30F) {
                    CockpitNaka_A2N.this.setNew.azimuth.setDeg(CockpitNaka_A2N.this.setOld.azimuth.getDeg(1.0F), CockpitNaka_A2N.this.fm.Or.azimut());
                }
                CockpitNaka_A2N.this.setNew.waypointDeviation.setDeg(CockpitNaka_A2N.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitNaka_A2N.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-5F, 5F));
                CockpitNaka_A2N.this.setNew.waypointAzimuth.setDeg(CockpitNaka_A2N.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitNaka_A2N.this.setNew.vspeed = (0.5F * CockpitNaka_A2N.this.setOld.vspeed) + (0.5F * CockpitNaka_A2N.this.fm.getVertSpeed());
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitNaka_A2N.speedometerScale), 0.0F, 0.0F);
