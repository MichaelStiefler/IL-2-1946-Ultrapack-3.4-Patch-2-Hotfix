...
public class CockpitO_47B extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitO_47B.this.fm != null) {
                if (CockpitO_47B.this.bNeedSetUp) {
                    CockpitO_47B.this.bNeedSetUp = false;
                }
                CockpitO_47B.this.setTmp = CockpitO_47B.this.setOld;
                CockpitO_47B.this.setOld = CockpitO_47B.this.setNew;
                CockpitO_47B.this.setNew = CockpitO_47B.this.setTmp;
                CockpitO_47B.this.setNew.flaps = (0.9F * CockpitO_47B.this.setOld.flaps) + (0.1F * CockpitO_47B.this.fm.CT.FlapsControl);
                CockpitO_47B.this.setNew.gear = (0.7F * CockpitO_47B.this.setOld.gear) + (0.3F * CockpitO_47B.this.fm.CT.GearControl);
                CockpitO_47B.this.setNew.throttle = (0.8F * CockpitO_47B.this.setOld.throttle) + (0.2F * CockpitO_47B.this.fm.CT.PowerControl);
                CockpitO_47B.this.setNew.prop = (0.8F * CockpitO_47B.this.setOld.prop) + (0.2F * CockpitO_47B.this.fm.EI.engines[0].getControlProp());
                CockpitO_47B.this.setNew.mix = (0.8F * CockpitO_47B.this.setOld.mix) + (0.2F * CockpitO_47B.this.fm.EI.engines[0].getControlMix());
                CockpitO_47B.this.setNew.man = (0.92F * CockpitO_47B.this.setOld.man) + (0.08F * CockpitO_47B.this.fm.EI.engines[0].getManifoldPressure());
                CockpitO_47B.this.setNew.altimeter = CockpitO_47B.this.fm.getAltitude();
                if (Math.abs(CockpitO_47B.this.fm.Or.getKren()) < 30F) {
                    CockpitO_47B.this.setNew.azimuth.setDeg(CockpitO_47B.this.setOld.azimuth.getDeg(1.0F), CockpitO_47B.this.fm.Or.azimut());
                }
                CockpitO_47B.this.setNew.vspeed = ((399F * CockpitO_47B.this.setOld.vspeed) + CockpitO_47B.this.fm.getVertSpeed()) / 400F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 925.9998F, 0.0F, 10F), CockpitO_47B.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.setNew.vspeed >= 0.0F ? -this.floatindex(this.cvt(this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitO_47B.variometerScale) : this.floatindex(this.cvt(-this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitO_47B.variometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Fuel1", 0.0F, this.cvt(this.fm.M.fuel, 0.0F, 536F, 0.0F, -87F), 0.0F);
        this.mesh.chunkSetAngles("Z_Fuel2", 0.0F, this.cvt(this.fm.M.fuel, 0.0F, 536F, 0.0F, -87F), 0.0F);
        this.mesh.chunkSetAngles("Z_Fuel3", 0.0F, this.cvt(this.fm.M.fuel, 0.0F, 536F, 0.0F, -87F), 0.0F);
        this.mesh.chunkSetAngles("Z_Fuel4", 0.0F, this.cvt(this.fm.M.fuel, 0.0F, 536F, 0.0F, -87F), 0.0F);
