...
public class CockpitOspreyL extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitOspreyL.this.bNeedSetUp) {
                CockpitOspreyL.this.reflectPlaneMats();
                CockpitOspreyL.this.bNeedSetUp = false;
            }
            if (CockpitOspreyL.this.fm != null) {
                CockpitOspreyL.this.setTmp = CockpitOspreyL.this.setOld;
                CockpitOspreyL.this.setOld = CockpitOspreyL.this.setNew;
                CockpitOspreyL.this.setNew = CockpitOspreyL.this.setTmp;
                CockpitOspreyL.this.setNew.throttle = ((10F * CockpitOspreyL.this.setOld.throttle) + CockpitOspreyL.this.fm.CT.PowerControl) / 11F;
                CockpitOspreyL.this.setNew.altimeter = CockpitOspreyL.this.fm.getAltitude();
                CockpitOspreyL.this.setNew.waypointAzimuth.setDeg(CockpitOspreyL.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitOspreyL.this.waypointAzimuth() - CockpitOspreyL.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitOspreyL.this.fm.Or.getKren()) < 30F) {
                    CockpitOspreyL.this.setNew.azimuth.setDeg(CockpitOspreyL.this.setOld.azimuth.getDeg(1.0F), CockpitOspreyL.this.fm.Or.azimut());
                }
                CockpitOspreyL.this.setNew.vspeed = ((199F * CockpitOspreyL.this.setOld.vspeed) + CockpitOspreyL.this.fm.getVertSpeed()) / 200F;
            }
            float f = CockpitOspreyL.this.fm.CT.getAileron();
            CockpitOspreyL.this.mesh.chunkSetAngles("AroneL_D0", 0.0F, -20F * f, 0.0F);
            CockpitOspreyL.this.mesh.chunkSetAngles("AroneR_D0", 0.0F, -20F * f, 0.0F);
            return true;
        }
    ...
    public CockpitOspreyL() {
        super("3DO/Cockpit/OspreyL/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitOspreyL.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 100F, 0.0F, 270F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitOspreyL.radScale));
        this.resetYPRmodifier();
        ...
        if (this.bFAF) {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 143.0528F, 0.0F, 32F), CockpitOspreyL.speedometerScaleFAF));
        } else {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 180.0555F, 0.0F, 35F), CockpitOspreyL.speedometerScale));
        }
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitOspreyL.variometerScale));
