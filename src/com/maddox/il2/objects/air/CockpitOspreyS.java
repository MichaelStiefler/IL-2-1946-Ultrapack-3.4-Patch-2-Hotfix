...
public class CockpitOspreyS extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitOspreyS.this.bNeedSetUp) {
                CockpitOspreyS.this.reflectPlaneMats();
                CockpitOspreyS.this.bNeedSetUp = false;
            }
            if (CockpitOspreyS.this.fm != null) {
                CockpitOspreyS.this.setTmp = CockpitOspreyS.this.setOld;
                CockpitOspreyS.this.setOld = CockpitOspreyS.this.setNew;
                CockpitOspreyS.this.setNew = CockpitOspreyS.this.setTmp;
                CockpitOspreyS.this.setNew.throttle = ((10F * CockpitOspreyS.this.setOld.throttle) + CockpitOspreyS.this.fm.CT.PowerControl) / 11F;
                CockpitOspreyS.this.setNew.altimeter = CockpitOspreyS.this.fm.getAltitude();
                CockpitOspreyS.this.setNew.waypointAzimuth.setDeg(CockpitOspreyS.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitOspreyS.this.waypointAzimuth() - CockpitOspreyS.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitOspreyS.this.fm.Or.getKren()) < 30F) {
                    CockpitOspreyS.this.setNew.azimuth.setDeg(CockpitOspreyS.this.setOld.azimuth.getDeg(1.0F), CockpitOspreyS.this.fm.Or.azimut());
                }
                CockpitOspreyS.this.setNew.vspeed = ((199F * CockpitOspreyS.this.setOld.vspeed) + CockpitOspreyS.this.fm.getVertSpeed()) / 200F;
            }
            float f = CockpitOspreyS.this.fm.CT.getAileron();
            CockpitOspreyS.this.mesh.chunkSetAngles("AroneL_D0", 0.0F, -20F * f, 0.0F);
            CockpitOspreyS.this.mesh.chunkSetAngles("AroneR_D0", 0.0F, -20F * f, 0.0F);
            return true;
        }
    ...
    public CockpitOspreyS() {
        super("3DO/Cockpit/OspreyL/hierS.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitOspreyS.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 100F, 0.0F, 270F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitOspreyS.radScale));
        this.resetYPRmodifier();
        ...
        if (this.bFAF) {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 143.0528F, 0.0F, 32F), CockpitOspreyS.speedometerScaleFAF));
        } else {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 180.0555F, 0.0F, 35F), CockpitOspreyS.speedometerScale));
        }
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitOspreyS.variometerScale));
