...
public class CockpitP1Y1 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitP1Y1.this.cockpitDimControl) {
                if ((CockpitP1Y1.this.setNew.dimPosition > 0.0F) && (CockpitP1Y1.this.setNew.ironSight == 0.0F)) {
                    CockpitP1Y1.this.setNew.dimPosition = CockpitP1Y1.this.setNew.dimPosition - 0.05F;
                }
            } else if ((CockpitP1Y1.this.setNew.dimPosition < 1.0F) && (CockpitP1Y1.this.setNew.ironSight == 0.0F)) {
                CockpitP1Y1.this.setNew.dimPosition = CockpitP1Y1.this.setNew.dimPosition + 0.05F;
            }
            ...
            if (Math.abs(CockpitP1Y1.this.fm.Or.getKren()) < 30F) {
            ...
            for (int i = 0; i < 2; i++) {
                if ((CockpitP1Y1.this.cowlFlapsLever[i] != 0.0F) && (CockpitP1Y1.this.cowlFlaps[i] == CockpitP1Y1.this.fm.EI.engines[i].getControlRadiator())) {
                    ...
                    if (Math.abs(CockpitP1Y1.this.cowlFlapsLever[i]) < 0.1F) {
                        CockpitP1Y1.this.cowlFlapsLever[i] = 0.0F;
                    }
                    continue;
                }
                if (CockpitP1Y1.this.cowlFlaps[i] < CockpitP1Y1.this.fm.EI.engines[i].getControlRadiator()) {
                    ...
                    if (CockpitP1Y1.this.cowlFlapsLever[i] > f) {
                        CockpitP1Y1.this.cowlFlapsLever[i] = f;
                    }
                    continue;
                }
                if (CockpitP1Y1.this.cowlFlaps[i] <= CockpitP1Y1.this.fm.EI.engines[i].getControlRadiator()) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Need_Climb", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 12F), CockpitP1Y1.variometerScale), 0.0F);
        this.mesh.chunkSetAngles("Z_Need_AirSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 700F, 0.0F, 14F), CockpitP1Y1.speedometerScale), 0.0F);
