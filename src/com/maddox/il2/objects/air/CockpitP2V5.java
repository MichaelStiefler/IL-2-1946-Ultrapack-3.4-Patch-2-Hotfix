...
public class CockpitP2V5 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitP2V5.this.fm != null) {
                CockpitP2V5.this.setTmp = CockpitP2V5.this.setOld;
                CockpitP2V5.this.setOld = CockpitP2V5.this.setNew;
                CockpitP2V5.this.setNew = CockpitP2V5.this.setTmp;
                CockpitP2V5.this.setNew.throttle1 = (0.85F * CockpitP2V5.this.setOld.throttle1) + (CockpitP2V5.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitP2V5.this.setNew.throttle2 = (0.85F * CockpitP2V5.this.setOld.throttle2) + (CockpitP2V5.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitP2V5.this.setNew.prop1 = (0.85F * CockpitP2V5.this.setOld.prop1) + (CockpitP2V5.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitP2V5.this.setNew.prop2 = (0.85F * CockpitP2V5.this.setOld.prop2) + (CockpitP2V5.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitP2V5.this.setNew.altimeter = CockpitP2V5.this.fm.getAltitude();
                float f = CockpitP2V5.this.waypointAzimuth();
                if (Math.abs(CockpitP2V5.this.fm.Or.getKren()) < 30F) {
                    CockpitP2V5.this.setNew.azimuth.setDeg(CockpitP2V5.this.setOld.azimuth.getDeg(1.0F), CockpitP2V5.this.fm.Or.azimut());
                }
                CockpitP2V5.this.setNew.waypointAzimuth.setDeg(CockpitP2V5.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitP2V5.this.setNew.waypointDeviation.setDeg(CockpitP2V5.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitP2V5.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitP2V5.this.setNew.vspeed = ((199F * CockpitP2V5.this.setOld.vspeed) + CockpitP2V5.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitP2V5() {
        super("3DO/Cockpit/B-25J/CockpitP2V5.him", "bf109");
...
//        pictGear = 0.0F;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitP2V5.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitP2V5.speedometerScale), 0.0F);
