...
public class CockpitPB4Y_2 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitPB4Y_2.this.fm != null) {
                CockpitPB4Y_2.this.setTmp = CockpitPB4Y_2.this.setOld;
                CockpitPB4Y_2.this.setOld = CockpitPB4Y_2.this.setNew;
                CockpitPB4Y_2.this.setNew = CockpitPB4Y_2.this.setTmp;
                CockpitPB4Y_2.this.setNew.throttle1 = (0.85F * CockpitPB4Y_2.this.setOld.throttle1) + (CockpitPB4Y_2.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitPB4Y_2.this.setNew.throttle2 = (0.85F * CockpitPB4Y_2.this.setOld.throttle2) + (CockpitPB4Y_2.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitPB4Y_2.this.setNew.throttle3 = (0.85F * CockpitPB4Y_2.this.setOld.throttle3) + (CockpitPB4Y_2.this.fm.EI.engines[2].getControlThrottle() * 0.15F);
                CockpitPB4Y_2.this.setNew.throttle4 = (0.85F * CockpitPB4Y_2.this.setOld.throttle4) + (CockpitPB4Y_2.this.fm.EI.engines[3].getControlThrottle() * 0.15F);
                CockpitPB4Y_2.this.setNew.prop1 = (0.85F * CockpitPB4Y_2.this.setOld.prop1) + (CockpitPB4Y_2.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitPB4Y_2.this.setNew.prop2 = (0.85F * CockpitPB4Y_2.this.setOld.prop2) + (CockpitPB4Y_2.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitPB4Y_2.this.setNew.prop3 = (0.85F * CockpitPB4Y_2.this.setOld.prop1) + (CockpitPB4Y_2.this.fm.EI.engines[2].getControlProp() * 0.15F);
                CockpitPB4Y_2.this.setNew.prop4 = (0.85F * CockpitPB4Y_2.this.setOld.prop2) + (CockpitPB4Y_2.this.fm.EI.engines[3].getControlProp() * 0.15F);
                CockpitPB4Y_2.this.setNew.altimeter = CockpitPB4Y_2.this.fm.getAltitude();
                float f = CockpitPB4Y_2.this.waypointAzimuth();
                if (Math.abs(CockpitPB4Y_2.this.fm.Or.getKren()) < 30F) {
                    CockpitPB4Y_2.this.setNew.azimuth.setDeg(CockpitPB4Y_2.this.setOld.azimuth.getDeg(1.0F), CockpitPB4Y_2.this.fm.Or.azimut());
                }
                CockpitPB4Y_2.this.setNew.waypointAzimuth.setDeg(CockpitPB4Y_2.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitPB4Y_2.this.setNew.waypointDeviation.setDeg(CockpitPB4Y_2.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitPB4Y_2.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitPB4Y_2.this.setNew.vspeed = ((199F * CockpitPB4Y_2.this.setOld.vspeed) + CockpitPB4Y_2.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitPB4Y_2.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitPB4Y_2.speedometerScale), 0.0F);
