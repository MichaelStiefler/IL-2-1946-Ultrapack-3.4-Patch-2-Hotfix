...
public class CockpitPBN1 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitPBN1.this.fm != null) {
                CockpitPBN1.this.setTmp = CockpitPBN1.this.setOld;
                CockpitPBN1.this.setOld = CockpitPBN1.this.setNew;
                CockpitPBN1.this.setNew = CockpitPBN1.this.setTmp;
                CockpitPBN1.this.setNew.throttle1 = (0.85F * CockpitPBN1.this.setOld.throttle1) + (CockpitPBN1.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitPBN1.this.setNew.throttle2 = (0.85F * CockpitPBN1.this.setOld.throttle2) + (CockpitPBN1.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitPBN1.this.setNew.prop1 = (0.85F * CockpitPBN1.this.setOld.prop1) + (CockpitPBN1.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitPBN1.this.setNew.prop2 = (0.85F * CockpitPBN1.this.setOld.prop2) + (CockpitPBN1.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitPBN1.this.setNew.altimeter = CockpitPBN1.this.fm.getAltitude();
                float f = CockpitPBN1.this.waypointAzimuth();
                if (Math.abs(CockpitPBN1.this.fm.Or.getKren()) < 30F) {
                    CockpitPBN1.this.setNew.azimuth.setDeg(CockpitPBN1.this.setOld.azimuth.getDeg(1.0F), CockpitPBN1.this.fm.Or.azimut());
                }
                CockpitPBN1.this.setNew.waypointAzimuth.setDeg(CockpitPBN1.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitPBN1.this.setNew.waypointDeviation.setDeg(CockpitPBN1.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitPBN1.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitPBN1.this.setNew.vspeed = ((199F * CockpitPBN1.this.setOld.vspeed) + CockpitPBN1.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
...
//        pictGear = 0.0F;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitPBN1.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitPBN1.speedometerScale), 0.0F);
