...
public class CockpitPBY extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitPBY.this.fm != null) {
                CockpitPBY.this.setTmp = CockpitPBY.this.setOld;
                CockpitPBY.this.setOld = CockpitPBY.this.setNew;
                CockpitPBY.this.setNew = CockpitPBY.this.setTmp;
                CockpitPBY.this.setNew.throttle1 = (0.85F * CockpitPBY.this.setOld.throttle1) + (CockpitPBY.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitPBY.this.setNew.throttle2 = (0.85F * CockpitPBY.this.setOld.throttle2) + (CockpitPBY.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitPBY.this.setNew.prop1 = (0.85F * CockpitPBY.this.setOld.prop1) + (CockpitPBY.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitPBY.this.setNew.prop2 = (0.85F * CockpitPBY.this.setOld.prop2) + (CockpitPBY.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitPBY.this.setNew.altimeter = CockpitPBY.this.fm.getAltitude();
                float f = CockpitPBY.this.waypointAzimuth();
                if (Math.abs(CockpitPBY.this.fm.Or.getKren()) < 30F) {
                    CockpitPBY.this.setNew.azimuth.setDeg(CockpitPBY.this.setOld.azimuth.getDeg(1.0F), CockpitPBY.this.fm.Or.azimut());
                }
                CockpitPBY.this.setNew.waypointAzimuth.setDeg(CockpitPBY.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitPBY.this.setNew.waypointDeviation.setDeg(CockpitPBY.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitPBY.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitPBY.this.setNew.vspeed = ((199F * CockpitPBY.this.setOld.vspeed) + CockpitPBY.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
...
//        pictGear = 0.0F;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitPBY.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitPBY.speedometerScale), 0.0F);
