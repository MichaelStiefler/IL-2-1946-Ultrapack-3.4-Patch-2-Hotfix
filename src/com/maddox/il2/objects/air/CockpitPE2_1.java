...
public class CockpitPE2_1 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitPE2_1.this.fm != null) {
                CockpitPE2_1.this.setTmp = CockpitPE2_1.this.setOld;
                CockpitPE2_1.this.setOld = CockpitPE2_1.this.setNew;
                CockpitPE2_1.this.setNew = CockpitPE2_1.this.setTmp;
                if (CockpitPE2_1.this.eBombs[0] == null) {
                    CockpitPE2_1.this.eBombs[0] = CockpitPE2_1.this.aircraft().getBulletEmitterByHookName("_ExternalBomb01");
                    CockpitPE2_1.this.eBombs[1] = CockpitPE2_1.this.aircraft().getBulletEmitterByHookName("_ExternalBomb02");
                    CockpitPE2_1.this.eBombs[2] = CockpitPE2_1.this.aircraft().getBulletEmitterByHookName("_ExternalBomb03");
                    CockpitPE2_1.this.eBombs[3] = CockpitPE2_1.this.aircraft().getBulletEmitterByHookName("_ExternalBomb04");
                    CockpitPE2_1.this.eBombs[4] = CockpitPE2_1.this.aircraft().getBulletEmitterByHookName("_BombSpawn01");
                    CockpitPE2_1.this.eBombs[5] = CockpitPE2_1.this.aircraft().getBulletEmitterByHookName("_BombSpawn02");
                    CockpitPE2_1.this.eBombs[6] = CockpitPE2_1.this.aircraft().getBulletEmitterByHookName("_BombSpawn03");
                    CockpitPE2_1.this.eBombs[7] = CockpitPE2_1.this.aircraft().getBulletEmitterByHookName("_BombSpawn04");
                    CockpitPE2_1.this.eBombs[8] = CockpitPE2_1.this.aircraft().getBulletEmitterByHookName("_BombSpawn05");
                    CockpitPE2_1.this.eBombs[9] = CockpitPE2_1.this.aircraft().getBulletEmitterByHookName("_BombSpawn06");
                }
                for (int i = 0; i < 10; i++) {
                    CockpitPE2_1.this.bBombs[i] = !CockpitPE2_1.this.eBombs[i].haveBullets();
                }

                CockpitPE2_1.this.setNew.throttle1 = (0.9F * CockpitPE2_1.this.setOld.throttle1) + (0.1F * CockpitPE2_1.this.fm.EI.engines[0].getControlThrottle());
                CockpitPE2_1.this.setNew.prop1 = (0.9F * CockpitPE2_1.this.setOld.prop1) + (0.1F * CockpitPE2_1.this.fm.EI.engines[0].getControlProp());
                CockpitPE2_1.this.setNew.mix1 = (0.8F * CockpitPE2_1.this.setOld.mix1) + (0.2F * CockpitPE2_1.this.fm.EI.engines[0].getControlMix());
                CockpitPE2_1.this.setNew.man1 = (0.92F * CockpitPE2_1.this.setOld.man1) + (0.08F * CockpitPE2_1.this.fm.EI.engines[0].getManifoldPressure());
                CockpitPE2_1.this.setNew.throttle2 = (0.9F * CockpitPE2_1.this.setOld.throttle2) + (0.1F * CockpitPE2_1.this.fm.EI.engines[1].getControlThrottle());
                CockpitPE2_1.this.setNew.prop2 = (0.9F * CockpitPE2_1.this.setOld.prop2) + (0.1F * CockpitPE2_1.this.fm.EI.engines[1].getControlProp());
                CockpitPE2_1.this.setNew.mix2 = (0.8F * CockpitPE2_1.this.setOld.mix2) + (0.2F * CockpitPE2_1.this.fm.EI.engines[1].getControlMix());
                CockpitPE2_1.this.setNew.man2 = (0.92F * CockpitPE2_1.this.setOld.man2) + (0.08F * CockpitPE2_1.this.fm.EI.engines[1].getManifoldPressure());
                CockpitPE2_1.this.setNew.altimeter = CockpitPE2_1.this.fm.getAltitude();
                CockpitPE2_1.this.setNew.stage1 = (0.85F * CockpitPE2_1.this.setOld.stage1) + (CockpitPE2_1.this.fm.EI.engines[0].getControlCompressor() * 0.15F);
                CockpitPE2_1.this.setNew.stage2 = (0.85F * CockpitPE2_1.this.setOld.stage2) + (CockpitPE2_1.this.fm.EI.engines[1].getControlCompressor() * 0.15F);
                if (Math.abs(CockpitPE2_1.this.fm.Or.getKren()) < 30F) {
                    CockpitPE2_1.this.setNew.azimuth.setDeg(CockpitPE2_1.this.setOld.azimuth.getDeg(1.0F), CockpitPE2_1.this.fm.Or.azimut());
                }
                CockpitPE2_1.this.setNew.vspeed = ((100F * CockpitPE2_1.this.setOld.vspeed) + CockpitPE2_1.this.fm.getVertSpeed()) / 101F;
                if (CockpitPE2_1.this.useRealisticNavigationInstruments()) {
                    CockpitPE2_1.this.setNew.waypointAzimuth.setDeg(CockpitPE2_1.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitPE2_1.this.getBeaconDirection());
                } else {
                    CockpitPE2_1.this.setNew.waypointAzimuth.setDeg(CockpitPE2_1.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitPE2_1.this.waypointAzimuth() - CockpitPE2_1.this.setOld.azimuth.getDeg(1.0F));
                }
                CockpitPE2_1.this.mesh.chunkSetAngles("Z_RTurret", CockpitPE2_1.this.aircraft().FM.turret[0].tu[0], 0.0F, 0.0F);
                CockpitPE2_1.this.mesh.chunkSetAngles("Z_RGun", CockpitPE2_1.this.aircraft().FM.turret[0].tu[1], 0.0F, 0.0F);
                CockpitPE2_1.this.setNew.inert = (0.999F * CockpitPE2_1.this.setOld.inert) + (0.001F * (CockpitPE2_1.this.fm.EI.engines[0].getStage() != 6 ? 0.0F : 0.867F));
            }
            return true;
        }
    ...
    public CockpitPE2_1() {
        super("3DO/Cockpit/Pe-2series1/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitPE2_1.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitPE2_1.speedometerScale), 0.0F, 0.0F);
        this.resetYPRmodifier();
