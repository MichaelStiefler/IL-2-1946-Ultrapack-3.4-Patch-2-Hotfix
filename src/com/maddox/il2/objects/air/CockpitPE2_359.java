...
public class CockpitPE2_359 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitPE2_359.this.fm != null) {
                CockpitPE2_359.this.setTmp = CockpitPE2_359.this.setOld;
                CockpitPE2_359.this.setOld = CockpitPE2_359.this.setNew;
                CockpitPE2_359.this.setNew = CockpitPE2_359.this.setTmp;
                if (CockpitPE2_359.this.fm.CT.Weapons[3] != null) {
                    if (CockpitPE2_359.this.fm.CT.Weapons[3].length > 0) {
                        CockpitPE2_359.this.bBombs[1] = !CockpitPE2_359.this.fm.CT.Weapons[3][0].haveBullets();
                    }
                    if (CockpitPE2_359.this.fm.CT.Weapons[3].length > 1) {
                        CockpitPE2_359.this.bBombs[0] = !CockpitPE2_359.this.fm.CT.Weapons[3][1].haveBullets();
                    }
                    if (CockpitPE2_359.this.fm.CT.Weapons[3].length > 2) {
                        CockpitPE2_359.this.bBombs[3] = !CockpitPE2_359.this.fm.CT.Weapons[3][2].haveBullets();
                    }
                    if (CockpitPE2_359.this.fm.CT.Weapons[3].length > 3) {
                        CockpitPE2_359.this.bBombs[2] = !CockpitPE2_359.this.fm.CT.Weapons[3][3].haveBullets();
                    }
                    if (CockpitPE2_359.this.fm.CT.Weapons[3].length > 4) {
                        CockpitPE2_359.this.bBombs[5] = !CockpitPE2_359.this.fm.CT.Weapons[3][4].haveBullets();
                    }
                    if (CockpitPE2_359.this.fm.CT.Weapons[3].length > 5) {
                        CockpitPE2_359.this.bBombs[4] = !CockpitPE2_359.this.fm.CT.Weapons[3][5].haveBullets();
                    }
                    if (CockpitPE2_359.this.fm.CT.Weapons[3].length > 6) {
                        CockpitPE2_359.this.bBombs[5] = CockpitPE2_359.this.bBombs[5] || !CockpitPE2_359.this.fm.CT.Weapons[3][6].haveBullets();
                    }
                    if (CockpitPE2_359.this.fm.CT.Weapons[3].length > 7) {
                        CockpitPE2_359.this.bBombs[4] = CockpitPE2_359.this.bBombs[4] || !CockpitPE2_359.this.fm.CT.Weapons[3][7].haveBullets();
                    }
                    if (CockpitPE2_359.this.fm.CT.Weapons[3].length > 8) {
                        CockpitPE2_359.this.bBombs[7] = !CockpitPE2_359.this.fm.CT.Weapons[3][8].haveBullets();
                    }
                    if (CockpitPE2_359.this.fm.CT.Weapons[3].length > 9) {
                        CockpitPE2_359.this.bBombs[6] = !CockpitPE2_359.this.fm.CT.Weapons[3][9].haveBullets();
                    }
                }
                CockpitPE2_359.this.setNew.throttle1 = (0.9F * CockpitPE2_359.this.setOld.throttle1) + (0.1F * CockpitPE2_359.this.fm.EI.engines[0].getControlThrottle());
                CockpitPE2_359.this.setNew.prop1 = (0.9F * CockpitPE2_359.this.setOld.prop1) + (0.1F * CockpitPE2_359.this.fm.EI.engines[0].getControlProp());
                CockpitPE2_359.this.setNew.mix1 = (0.8F * CockpitPE2_359.this.setOld.mix1) + (0.2F * CockpitPE2_359.this.fm.EI.engines[0].getControlMix());
                CockpitPE2_359.this.setNew.man1 = (0.92F * CockpitPE2_359.this.setOld.man1) + (0.08F * CockpitPE2_359.this.fm.EI.engines[0].getManifoldPressure());
                CockpitPE2_359.this.setNew.throttle2 = (0.9F * CockpitPE2_359.this.setOld.throttle2) + (0.1F * CockpitPE2_359.this.fm.EI.engines[1].getControlThrottle());
                CockpitPE2_359.this.setNew.prop2 = (0.9F * CockpitPE2_359.this.setOld.prop2) + (0.1F * CockpitPE2_359.this.fm.EI.engines[1].getControlProp());
                CockpitPE2_359.this.setNew.mix2 = (0.8F * CockpitPE2_359.this.setOld.mix2) + (0.2F * CockpitPE2_359.this.fm.EI.engines[1].getControlMix());
                CockpitPE2_359.this.setNew.man2 = (0.92F * CockpitPE2_359.this.setOld.man2) + (0.08F * CockpitPE2_359.this.fm.EI.engines[1].getManifoldPressure());
                CockpitPE2_359.this.setNew.altimeter = CockpitPE2_359.this.fm.getAltitude();
                if (Math.abs(CockpitPE2_359.this.fm.Or.getKren()) < 30F) {
                    CockpitPE2_359.this.setNew.azimuth.setDeg(CockpitPE2_359.this.setOld.azimuth.getDeg(1.0F), CockpitPE2_359.this.fm.Or.azimut());
                }
                CockpitPE2_359.this.setNew.vspeed = ((100F * CockpitPE2_359.this.setOld.vspeed) + CockpitPE2_359.this.fm.getVertSpeed()) / 101F;
                if (CockpitPE2_359.this.useRealisticNavigationInstruments()) {
                    CockpitPE2_359.this.setNew.waypointAzimuth.setDeg(CockpitPE2_359.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitPE2_359.this.getBeaconDirection());
                } else {
                    CockpitPE2_359.this.setNew.waypointAzimuth.setDeg(CockpitPE2_359.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitPE2_359.this.waypointAzimuth() - CockpitPE2_359.this.setOld.azimuth.getDeg(1.0F));
                }
                CockpitPE2_359.this.mesh.chunkSetAngles("Z_RTurret", CockpitPE2_359.this.aircraft().FM.turret[0].tu[0], 0.0F, 0.0F);
                CockpitPE2_359.this.mesh.chunkSetAngles("Z_RGun", -CockpitPE2_359.this.aircraft().FM.turret[0].tu[1], 0.0F, 0.0F);
                CockpitPE2_359.this.setNew.inert = (0.999F * CockpitPE2_359.this.setOld.inert) + (0.001F * (CockpitPE2_359.this.fm.EI.engines[0].getStage() != 6 ? 0.0F : 0.867F));
            }
            return true;
        }
    ...
    public CockpitPE2_359() {
        super("3DO/Cockpit/Pe-2series359/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitPE2_359.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitPE2_359.speedometerScale), 0.0F, 0.0F);
        this.resetYPRmodifier();
