...
public class CockpitPE2_402 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitPE2_402.this.fm != null) {
                CockpitPE2_402.this.setTmp = CockpitPE2_402.this.setOld;
                CockpitPE2_402.this.setOld = CockpitPE2_402.this.setNew;
                CockpitPE2_402.this.setNew = CockpitPE2_402.this.setTmp;
                if (CockpitPE2_402.this.fm.CT.Weapons[3] != null) {
                    if (((PE_2NEW) CockpitPE2_402.this.aircraft()).BombLoadType == 1) {
                        CockpitPE2_402.this.bBombs[5] = CockpitPE2_402.this.fm.CT.Weapons[3][2].haveBullets();
                        CockpitPE2_402.this.bBombs[4] = CockpitPE2_402.this.fm.CT.Weapons[3][3].haveBullets();
                        CockpitPE2_402.this.bBombs[7] = CockpitPE2_402.this.fm.CT.Weapons[3][4].haveBullets();
                        CockpitPE2_402.this.bBombs[6] = CockpitPE2_402.this.fm.CT.Weapons[3][5].haveBullets();
                    } else if (((PE_2NEW) CockpitPE2_402.this.aircraft()).BombLoadType == 2) {
                        CockpitPE2_402.this.bBombs[1] = CockpitPE2_402.this.fm.CT.Weapons[3][0].haveBullets();
                        CockpitPE2_402.this.bBombs[0] = CockpitPE2_402.this.fm.CT.Weapons[3][1].haveBullets();
                    } else if (((PE_2NEW) CockpitPE2_402.this.aircraft()).BombLoadType == 3) {
                        CockpitPE2_402.this.bBombs[1] = CockpitPE2_402.this.fm.CT.Weapons[3][0].haveBullets();
                        CockpitPE2_402.this.bBombs[0] = CockpitPE2_402.this.fm.CT.Weapons[3][1].haveBullets();
                        CockpitPE2_402.this.bBombs[7] = CockpitPE2_402.this.fm.CT.Weapons[3][2].haveBullets();
                        CockpitPE2_402.this.bBombs[6] = CockpitPE2_402.this.fm.CT.Weapons[3][3].haveBullets();
                    } else if (((PE_2NEW) CockpitPE2_402.this.aircraft()).BombLoadType == 4) {
                        CockpitPE2_402.this.bBombs[1] = CockpitPE2_402.this.fm.CT.Weapons[3][0].haveBullets();
                        CockpitPE2_402.this.bBombs[0] = CockpitPE2_402.this.fm.CT.Weapons[3][1].haveBullets();
                        CockpitPE2_402.this.bBombs[3] = CockpitPE2_402.this.fm.CT.Weapons[3][2].haveBullets();
                        CockpitPE2_402.this.bBombs[2] = CockpitPE2_402.this.fm.CT.Weapons[3][3].haveBullets();
                    } else if (((PE_2NEW) CockpitPE2_402.this.aircraft()).BombLoadType == 5) {
                        CockpitPE2_402.this.bBombs[5] = CockpitPE2_402.this.fm.CT.Weapons[3][2].haveBullets();
                        CockpitPE2_402.this.bBombs[4] = CockpitPE2_402.this.fm.CT.Weapons[3][3].haveBullets();
                    }
                }
                CockpitPE2_402.this.setNew.throttle1 = (0.9F * CockpitPE2_402.this.setOld.throttle1) + (0.1F * CockpitPE2_402.this.fm.EI.engines[0].getControlThrottle());
                CockpitPE2_402.this.setNew.prop1 = (0.9F * CockpitPE2_402.this.setOld.prop1) + (0.1F * CockpitPE2_402.this.fm.EI.engines[0].getControlProp());
                CockpitPE2_402.this.setNew.mix1 = (0.8F * CockpitPE2_402.this.setOld.mix1) + (0.2F * CockpitPE2_402.this.fm.EI.engines[0].getControlMix());
                CockpitPE2_402.this.setNew.man1 = (0.92F * CockpitPE2_402.this.setOld.man1) + (0.08F * CockpitPE2_402.this.fm.EI.engines[0].getManifoldPressure());
                CockpitPE2_402.this.setNew.throttle2 = (0.9F * CockpitPE2_402.this.setOld.throttle2) + (0.1F * CockpitPE2_402.this.fm.EI.engines[1].getControlThrottle());
                CockpitPE2_402.this.setNew.prop2 = (0.9F * CockpitPE2_402.this.setOld.prop2) + (0.1F * CockpitPE2_402.this.fm.EI.engines[1].getControlProp());
                CockpitPE2_402.this.setNew.mix2 = (0.8F * CockpitPE2_402.this.setOld.mix2) + (0.2F * CockpitPE2_402.this.fm.EI.engines[1].getControlMix());
                CockpitPE2_402.this.setNew.man2 = (0.92F * CockpitPE2_402.this.setOld.man2) + (0.08F * CockpitPE2_402.this.fm.EI.engines[1].getManifoldPressure());
                CockpitPE2_402.this.setNew.altimeter = CockpitPE2_402.this.fm.getAltitude();
                if (Math.abs(CockpitPE2_402.this.fm.Or.getKren()) < 30F) {
                    CockpitPE2_402.this.setNew.azimuth.setDeg(CockpitPE2_402.this.setOld.azimuth.getDeg(1.0F), CockpitPE2_402.this.fm.Or.azimut());
                }
                CockpitPE2_402.this.setNew.vspeed = ((100F * CockpitPE2_402.this.setOld.vspeed) + CockpitPE2_402.this.fm.getVertSpeed()) / 101F;
                if (CockpitPE2_402.this.useRealisticNavigationInstruments()) {
                    CockpitPE2_402.this.setNew.waypointAzimuth.setDeg(CockpitPE2_402.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitPE2_402.this.getBeaconDirection());
                } else {
                    CockpitPE2_402.this.setNew.waypointAzimuth.setDeg(CockpitPE2_402.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitPE2_402.this.waypointAzimuth() - CockpitPE2_402.this.setOld.azimuth.getDeg(1.0F));
                }
                CockpitPE2_402.this.mesh.chunkSetAngles("Z_RTurret", CockpitPE2_402.this.aircraft().FM.turret[0].tu[0], 0.0F, 0.0F);
                CockpitPE2_402.this.mesh.chunkSetAngles("Z_RGun", -CockpitPE2_402.this.aircraft().FM.turret[0].tu[1], 0.0F, 0.0F);
                CockpitPE2_402.this.setNew.inert = (0.999F * CockpitPE2_402.this.setOld.inert) + (0.001F * (CockpitPE2_402.this.fm.EI.engines[0].getStage() == 6 ? 0.867F : 0.0F));
            }
            return true;
        }
    ...
    protected void setCameraOffset() {
        this.cameraCenter.add(0.15D, 0.0D, 0.0D);
    }

    public CockpitPE2_402() {
        this("3DO/Cockpit/Pe-2series402/hier.him");
    }

    public CockpitPE2_402(String s) {
        super(s, "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitPE2_402.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitPE2_402.speedometerScale), 0.0F, 0.0F);
        this.resetYPRmodifier();
        ...
        if (f1 < -40F) {
            this.mesh.chunkSetAngles("Z_AirTemp", this.cvt(f1, -70F, -40F, 52F, 35F), 0.0F, 0.0F);
        } else if (f1 < 0.0F) {
            this.mesh.chunkSetAngles("Z_AirTemp", this.cvt(f1, -40F, 0.0F, 35F, 0.0F), 0.0F, 0.0F);
        } else if (f1 < 20F) {
        ...
        if (this.fm.EI.engines[0].isHasControlCompressor() && this.fm.EI.engines[1].isHasControlCompressor()) {
            this.Compressor1 = this.fm.EI.engines[0].getControlCompressor();
            this.Compressor2 = this.fm.EI.engines[1].getControlCompressor();
            if (this.Compressor1 != this.Compressor) {
                this.fm.EI.engines[1].setControlCompressor(this.Compressor1);
                this.Compressor = this.Compressor1;
            } else if (this.Compressor2 != this.Compressor) {
                this.fm.EI.engines[0].setControlCompressor(this.Compressor2);
                this.Compressor = this.Compressor2;
            }
        } else if (this.fm.EI.engines[0].isHasControlCompressor() && !this.fm.EI.engines[1].isHasControlCompressor()) {
            this.Compressor = this.fm.EI.engines[0].getControlCompressor();
        } else if (!this.fm.EI.engines[0].isHasControlCompressor() && this.fm.EI.engines[1].isHasControlCompressor()) {
            this.Compressor = this.fm.EI.engines[1].getControlCompressor();
        }
        this.mesh.chunkSetAngles("Z_NagnetatelSwith", 0.0F, 0.0F, 90F * this.Compressor);
    ...
    static {
        Property.set(CockpitPE2_402.class, "normZNs", new float[] { 1.45F, 0.89F, 1.1F, 0.89F });
    }
}
