...
public class CockpitPE2_84 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitPE2_84.this.fm != null) {
                CockpitPE2_84.this.setTmp = CockpitPE2_84.this.setOld;
                CockpitPE2_84.this.setOld = CockpitPE2_84.this.setNew;
                CockpitPE2_84.this.setNew = CockpitPE2_84.this.setTmp;
                if (CockpitPE2_84.this.fm.CT.Weapons[3] != null) {
                    if (CockpitPE2_84.this.fm.CT.Weapons[3].length > 0) {
                        CockpitPE2_84.this.bBombs[1] = !CockpitPE2_84.this.fm.CT.Weapons[3][0].haveBullets();
                    }
                    if (CockpitPE2_84.this.fm.CT.Weapons[3].length > 1) {
                        CockpitPE2_84.this.bBombs[0] = !CockpitPE2_84.this.fm.CT.Weapons[3][1].haveBullets();
                    }
                    if (CockpitPE2_84.this.fm.CT.Weapons[3].length > 2) {
                        CockpitPE2_84.this.bBombs[3] = !CockpitPE2_84.this.fm.CT.Weapons[3][2].haveBullets();
                    }
                    if (CockpitPE2_84.this.fm.CT.Weapons[3].length > 3) {
                        CockpitPE2_84.this.bBombs[2] = !CockpitPE2_84.this.fm.CT.Weapons[3][3].haveBullets();
                    }
                    if (CockpitPE2_84.this.fm.CT.Weapons[3].length > 4) {
                        CockpitPE2_84.this.bBombs[5] = !CockpitPE2_84.this.fm.CT.Weapons[3][4].haveBullets();
                    }
                    if (CockpitPE2_84.this.fm.CT.Weapons[3].length > 5) {
                        CockpitPE2_84.this.bBombs[4] = !CockpitPE2_84.this.fm.CT.Weapons[3][5].haveBullets();
                    }
                    if (CockpitPE2_84.this.fm.CT.Weapons[3].length > 6) {
                        CockpitPE2_84.this.bBombs[5] = CockpitPE2_84.this.bBombs[5] || !CockpitPE2_84.this.fm.CT.Weapons[3][6].haveBullets();
                    }
                    if (CockpitPE2_84.this.fm.CT.Weapons[3].length > 7) {
                        CockpitPE2_84.this.bBombs[4] = CockpitPE2_84.this.bBombs[4] || !CockpitPE2_84.this.fm.CT.Weapons[3][7].haveBullets();
                    }
                    if (CockpitPE2_84.this.fm.CT.Weapons[3].length > 8) {
                        CockpitPE2_84.this.bBombs[7] = !CockpitPE2_84.this.fm.CT.Weapons[3][8].haveBullets();
                    }
                    if (CockpitPE2_84.this.fm.CT.Weapons[3].length > 9) {
                        CockpitPE2_84.this.bBombs[6] = !CockpitPE2_84.this.fm.CT.Weapons[3][9].haveBullets();
                    }
                }
                CockpitPE2_84.this.setNew.throttle1 = (0.9F * CockpitPE2_84.this.setOld.throttle1) + (0.1F * CockpitPE2_84.this.fm.EI.engines[0].getControlThrottle());
                CockpitPE2_84.this.setNew.prop1 = (0.9F * CockpitPE2_84.this.setOld.prop1) + (0.1F * CockpitPE2_84.this.fm.EI.engines[0].getControlProp());
                CockpitPE2_84.this.setNew.mix1 = (0.8F * CockpitPE2_84.this.setOld.mix1) + (0.2F * CockpitPE2_84.this.fm.EI.engines[0].getControlMix());
                CockpitPE2_84.this.setNew.man1 = (0.92F * CockpitPE2_84.this.setOld.man1) + (0.08F * CockpitPE2_84.this.fm.EI.engines[0].getManifoldPressure());
                CockpitPE2_84.this.setNew.throttle2 = (0.9F * CockpitPE2_84.this.setOld.throttle2) + (0.1F * CockpitPE2_84.this.fm.EI.engines[1].getControlThrottle());
                CockpitPE2_84.this.setNew.prop2 = (0.9F * CockpitPE2_84.this.setOld.prop2) + (0.1F * CockpitPE2_84.this.fm.EI.engines[1].getControlProp());
                CockpitPE2_84.this.setNew.mix2 = (0.8F * CockpitPE2_84.this.setOld.mix2) + (0.2F * CockpitPE2_84.this.fm.EI.engines[1].getControlMix());
                CockpitPE2_84.this.setNew.man2 = (0.92F * CockpitPE2_84.this.setOld.man2) + (0.08F * CockpitPE2_84.this.fm.EI.engines[1].getManifoldPressure());
                CockpitPE2_84.this.setNew.altimeter = CockpitPE2_84.this.fm.getAltitude();
                CockpitPE2_84.this.setNew.stage1 = (0.85F * CockpitPE2_84.this.setOld.stage1) + (CockpitPE2_84.this.fm.EI.engines[0].getControlCompressor() * 0.15F);
                CockpitPE2_84.this.setNew.stage2 = (0.85F * CockpitPE2_84.this.setOld.stage2) + (CockpitPE2_84.this.fm.EI.engines[1].getControlCompressor() * 0.15F);
                if (Math.abs(CockpitPE2_84.this.fm.Or.getKren()) < 30F) {
                    CockpitPE2_84.this.setNew.azimuth.setDeg(CockpitPE2_84.this.setOld.azimuth.getDeg(1.0F), CockpitPE2_84.this.fm.Or.azimut());
                }
                CockpitPE2_84.this.setNew.vspeed = ((100F * CockpitPE2_84.this.setOld.vspeed) + CockpitPE2_84.this.fm.getVertSpeed()) / 101F;
                if (CockpitPE2_84.this.useRealisticNavigationInstruments()) {
                    CockpitPE2_84.this.setNew.waypointAzimuth.setDeg(CockpitPE2_84.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitPE2_84.this.getBeaconDirection());
                } else {
                    CockpitPE2_84.this.setNew.waypointAzimuth.setDeg(CockpitPE2_84.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitPE2_84.this.waypointAzimuth() - CockpitPE2_84.this.setOld.azimuth.getDeg(1.0F));
                }
                CockpitPE2_84.this.mesh.chunkSetAngles("Z_RTurret", CockpitPE2_84.this.aircraft().FM.turret[0].tu[0], 0.0F, 0.0F);
                CockpitPE2_84.this.mesh.chunkSetAngles("Z_RGun", CockpitPE2_84.this.aircraft().FM.turret[0].tu[1], 0.0F, 0.0F);
                CockpitPE2_84.this.setNew.inert = (0.999F * CockpitPE2_84.this.setOld.inert) + (0.001F * (CockpitPE2_84.this.fm.EI.engines[0].getStage() != 6 ? 0.0F : 0.867F));
            }
            return true;
        }
    ...
    public CockpitPE2_84() {
        super("3DO/Cockpit/Pe-2series84/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitPE2_84.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitPE2_84.speedometerScale), 0.0F, 0.0F);
        this.resetYPRmodifier();
        ...
        this.mesh.chunkSetAngles("Z_SupL", 65F * this.setNew.stage1, 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_SupR", 65F * this.setNew.stage2, 0.0F, 0.0F);
