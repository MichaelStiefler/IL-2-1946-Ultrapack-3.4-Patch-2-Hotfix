...
public class CockpitPE3bis extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitPE3bis.this.fm != null) {
                CockpitPE3bis.this.setTmp = CockpitPE3bis.this.setOld;
                CockpitPE3bis.this.setOld = CockpitPE3bis.this.setNew;
                CockpitPE3bis.this.setNew = CockpitPE3bis.this.setTmp;
                if (CockpitPE3bis.this.fm.CT.Weapons[3] != null) {
                    if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 0) {
                        CockpitPE3bis.this.bBombs[1] = !CockpitPE3bis.this.fm.CT.Weapons[3][0].haveBullets();
                    }
                    if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 1) {
                        CockpitPE3bis.this.bBombs[0] = !CockpitPE3bis.this.fm.CT.Weapons[3][1].haveBullets();
                    }
                    if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 2) {
                        CockpitPE3bis.this.bBombs[3] = !CockpitPE3bis.this.fm.CT.Weapons[3][2].haveBullets();
                    }
                    if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 3) {
                        CockpitPE3bis.this.bBombs[2] = !CockpitPE3bis.this.fm.CT.Weapons[3][3].haveBullets();
                    }
                    if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 4) {
                        CockpitPE3bis.this.bBombs[5] = !CockpitPE3bis.this.fm.CT.Weapons[3][4].haveBullets();
                    }
                    if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 5) {
                        CockpitPE3bis.this.bBombs[4] = !CockpitPE3bis.this.fm.CT.Weapons[3][5].haveBullets();
                    }
                    if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 6) {
                        CockpitPE3bis.this.bBombs[5] = CockpitPE3bis.this.bBombs[5] || !CockpitPE3bis.this.fm.CT.Weapons[3][6].haveBullets();
                    }
                    if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 7) {
                        CockpitPE3bis.this.bBombs[4] = CockpitPE3bis.this.bBombs[4] || !CockpitPE3bis.this.fm.CT.Weapons[3][7].haveBullets();
                    }
                    if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 8) {
                        CockpitPE3bis.this.bBombs[7] = !CockpitPE3bis.this.fm.CT.Weapons[3][8].haveBullets();
                    }
                    if (CockpitPE3bis.this.fm.CT.Weapons[3].length > 9) {
                        CockpitPE3bis.this.bBombs[6] = !CockpitPE3bis.this.fm.CT.Weapons[3][9].haveBullets();
                    }
                }
                CockpitPE3bis.this.setNew.throttle1 = (0.9F * CockpitPE3bis.this.setOld.throttle1) + (0.1F * CockpitPE3bis.this.fm.EI.engines[0].getControlThrottle());
                CockpitPE3bis.this.setNew.prop1 = (0.9F * CockpitPE3bis.this.setOld.prop1) + (0.1F * CockpitPE3bis.this.fm.EI.engines[0].getControlProp());
                CockpitPE3bis.this.setNew.mix1 = (0.8F * CockpitPE3bis.this.setOld.mix1) + (0.2F * CockpitPE3bis.this.fm.EI.engines[0].getControlMix());
                CockpitPE3bis.this.setNew.man1 = (0.92F * CockpitPE3bis.this.setOld.man1) + (0.08F * CockpitPE3bis.this.fm.EI.engines[0].getManifoldPressure());
                CockpitPE3bis.this.setNew.throttle2 = (0.9F * CockpitPE3bis.this.setOld.throttle2) + (0.1F * CockpitPE3bis.this.fm.EI.engines[1].getControlThrottle());
                CockpitPE3bis.this.setNew.prop2 = (0.9F * CockpitPE3bis.this.setOld.prop2) + (0.1F * CockpitPE3bis.this.fm.EI.engines[1].getControlProp());
                CockpitPE3bis.this.setNew.mix2 = (0.8F * CockpitPE3bis.this.setOld.mix2) + (0.2F * CockpitPE3bis.this.fm.EI.engines[1].getControlMix());
                CockpitPE3bis.this.setNew.man2 = (0.92F * CockpitPE3bis.this.setOld.man2) + (0.08F * CockpitPE3bis.this.fm.EI.engines[1].getManifoldPressure());
                CockpitPE3bis.this.setNew.altimeter = CockpitPE3bis.this.fm.getAltitude();
                if (Math.abs(CockpitPE3bis.this.fm.Or.getKren()) < 30F) {
                    CockpitPE3bis.this.setNew.azimuth.setDeg(CockpitPE3bis.this.setOld.azimuth.getDeg(1.0F), CockpitPE3bis.this.fm.Or.azimut());
                }
                CockpitPE3bis.this.setNew.vspeed = ((100F * CockpitPE3bis.this.setOld.vspeed) + CockpitPE3bis.this.fm.getVertSpeed()) / 101F;
                if (CockpitPE3bis.this.useRealisticNavigationInstruments()) {
                    CockpitPE3bis.this.setNew.waypointAzimuth.setDeg(CockpitPE3bis.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitPE3bis.this.getBeaconDirection());
                } else {
                    CockpitPE3bis.this.setNew.waypointAzimuth.setDeg(CockpitPE3bis.this.setOld.waypointAzimuth.getDeg(0.1F), CockpitPE3bis.this.waypointAzimuth() - CockpitPE3bis.this.setOld.azimuth.getDeg(1.0F));
                }
                CockpitPE3bis.this.mesh.chunkSetAngles("Z_RTurret", CockpitPE3bis.this.aircraft().FM.turret[0].tu[0], 0.0F, 0.0F);
                CockpitPE3bis.this.mesh.chunkSetAngles("Z_RGun", -CockpitPE3bis.this.aircraft().FM.turret[0].tu[1], 0.0F, 0.0F);
                CockpitPE3bis.this.setNew.inert = (0.999F * CockpitPE3bis.this.setOld.inert) + (0.001F * (CockpitPE3bis.this.fm.EI.engines[0].getStage() != 6 ? 0.0F : 0.867F));
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitPE3bis.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitPE3bis.speedometerScale), 0.0F, 0.0F);
        this.resetYPRmodifier();
