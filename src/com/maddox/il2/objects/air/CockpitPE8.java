...
public class CockpitPE8 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitPE8.this.fm != null) {
                CockpitPE8.this.setTmp = CockpitPE8.this.setOld;
                CockpitPE8.this.setOld = CockpitPE8.this.setNew;
                CockpitPE8.this.setNew = CockpitPE8.this.setTmp;
                if (CockpitPE8.this.fm.CT.Weapons[3] != null) {
                    if (CockpitPE8.this.fm.CT.Weapons[3].length > 0) {
                        CockpitPE8.this.bBombs[1] = !CockpitPE8.this.fm.CT.Weapons[3][0].haveBullets();
                    }
                    if (CockpitPE8.this.fm.CT.Weapons[3].length > 1) {
                        CockpitPE8.this.bBombs[0] = !CockpitPE8.this.fm.CT.Weapons[3][1].haveBullets();
                    }
                    if (CockpitPE8.this.fm.CT.Weapons[3].length > 2) {
                        CockpitPE8.this.bBombs[3] = !CockpitPE8.this.fm.CT.Weapons[3][2].haveBullets();
                    }
                    if (CockpitPE8.this.fm.CT.Weapons[3].length > 3) {
                        CockpitPE8.this.bBombs[2] = !CockpitPE8.this.fm.CT.Weapons[3][3].haveBullets();
                    }
                    if (CockpitPE8.this.fm.CT.Weapons[3].length > 4) {
                        CockpitPE8.this.bBombs[5] = !CockpitPE8.this.fm.CT.Weapons[3][4].haveBullets();
                    }
                    if (CockpitPE8.this.fm.CT.Weapons[3].length > 5) {
                        CockpitPE8.this.bBombs[4] = !CockpitPE8.this.fm.CT.Weapons[3][5].haveBullets();
                    }
                    if (CockpitPE8.this.fm.CT.Weapons[3].length > 6) {
                        CockpitPE8.this.bBombs[5] = CockpitPE8.this.bBombs[5] || !CockpitPE8.this.fm.CT.Weapons[3][6].haveBullets();
                    }
                    if (CockpitPE8.this.fm.CT.Weapons[3].length > 7) {
                        CockpitPE8.this.bBombs[4] = CockpitPE8.this.bBombs[4] || !CockpitPE8.this.fm.CT.Weapons[3][7].haveBullets();
                    }
                    if (CockpitPE8.this.fm.CT.Weapons[3].length > 8) {
                        CockpitPE8.this.bBombs[7] = !CockpitPE8.this.fm.CT.Weapons[3][8].haveBullets();
                    }
                    if (CockpitPE8.this.fm.CT.Weapons[3].length > 9) {
                        CockpitPE8.this.bBombs[6] = !CockpitPE8.this.fm.CT.Weapons[3][9].haveBullets();
                    }
                }
                CockpitPE8.this.setNew.throttle1 = (0.9F * CockpitPE8.this.setOld.throttle1) + (0.1F * CockpitPE8.this.fm.EI.engines[0].getControlThrottle());
                CockpitPE8.this.setNew.prop1 = (0.9F * CockpitPE8.this.setOld.prop1) + (0.1F * CockpitPE8.this.fm.EI.engines[0].getControlProp());
                CockpitPE8.this.setNew.mix1 = (0.8F * CockpitPE8.this.setOld.mix1) + (0.2F * CockpitPE8.this.fm.EI.engines[0].getControlMix());
                CockpitPE8.this.setNew.man1 = (0.92F * CockpitPE8.this.setOld.man1) + (0.08F * CockpitPE8.this.fm.EI.engines[0].getManifoldPressure());
                CockpitPE8.this.setNew.throttle2 = (0.9F * CockpitPE8.this.setOld.throttle2) + (0.1F * CockpitPE8.this.fm.EI.engines[1].getControlThrottle());
                CockpitPE8.this.setNew.prop2 = (0.9F * CockpitPE8.this.setOld.prop2) + (0.1F * CockpitPE8.this.fm.EI.engines[1].getControlProp());
                CockpitPE8.this.setNew.mix2 = (0.8F * CockpitPE8.this.setOld.mix2) + (0.2F * CockpitPE8.this.fm.EI.engines[1].getControlMix());
                CockpitPE8.this.setNew.man2 = (0.92F * CockpitPE8.this.setOld.man2) + (0.08F * CockpitPE8.this.fm.EI.engines[1].getManifoldPressure());
                CockpitPE8.this.setNew.altimeter = CockpitPE8.this.fm.getAltitude();
                if (Math.abs(CockpitPE8.this.fm.Or.getKren()) < 30F) {
                    CockpitPE8.this.setNew.azimuth.setDeg(CockpitPE8.this.setOld.azimuth.getDeg(1.0F), CockpitPE8.this.fm.Or.azimut());
                }
                CockpitPE8.this.setNew.vspeed = ((100F * CockpitPE8.this.setOld.vspeed) + CockpitPE8.this.fm.getVertSpeed()) / 101F;
                float f = CockpitPE8.this.waypointAzimuth();
                CockpitPE8.this.setNew.waypointAzimuth.setDeg(CockpitPE8.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitPE8.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitPE8.this.setNew.waypointDirection.setDeg(CockpitPE8.this.setOld.waypointDirection.getDeg(1.0F), f);
                CockpitPE8.this.mesh.chunkSetAngles("Z_RTurret", CockpitPE8.this.aircraft().FM.turret[0].tu[0], 0.0F, 0.0F);
                CockpitPE8.this.mesh.chunkSetAngles("Z_RGun", -CockpitPE8.this.aircraft().FM.turret[0].tu[1], 0.0F, 0.0F);
                CockpitPE8.this.setNew.inert = (0.999F * CockpitPE8.this.setOld.inert) + (0.001F * (CockpitPE8.this.fm.EI.engines[0].getStage() != 6 ? 0.0F : 0.867F));
            }
            return true;
        }
    ...
    public CockpitPE8() {
        super("3DO/Cockpit/Pe-3bis/CockpitPE8.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitPE8.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitPE8.speedometerScale), 0.0F, 0.0F);
        this.resetYPRmodifier();
