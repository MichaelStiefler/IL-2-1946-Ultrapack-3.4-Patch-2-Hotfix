...
public class CockpitPWS_26_2 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            CockpitPWS_26_2.this.fm = World.getPlayerFM();
            if (CockpitPWS_26_2.this.fm == null) {
                return true;
            }
            if (CockpitPWS_26_2.this.bNeedSetUp) {
                CockpitPWS_26_2.this.reflectPlaneMats();
                CockpitPWS_26_2.this.reflectPlaneToModel();
                CockpitPWS_26_2.this.bNeedSetUp = false;
            }
            if (PWS_26.bChangedPit) {
                CockpitPWS_26_2.this.reflectPlaneToModel();
                PWS_26.bChangedPit = false;
            }
            CockpitPWS_26_2.this.setTmp = CockpitPWS_26_2.this.setOld;
            CockpitPWS_26_2.this.setOld = CockpitPWS_26_2.this.setNew;
            CockpitPWS_26_2.this.setNew = CockpitPWS_26_2.this.setTmp;
            CockpitPWS_26_2.this.setNew.altimeter = CockpitPWS_26_2.this.fm.getAltitude();
            if (Math.abs(CockpitPWS_26_2.this.fm.Or.getKren()) < 30F) {
                CockpitPWS_26_2.this.setNew.azimuth.setDeg(CockpitPWS_26_2.this.setOld.azimuth.getDeg(1.0F), CockpitPWS_26_2.this.fm.Or.azimut());
            }
            CockpitPWS_26_2.this.setNew.mix = ((10F * CockpitPWS_26_2.this.setOld.mix) + CockpitPWS_26_2.this.fm.EI.engines[0].getControlMix()) / 11F;
            CockpitPWS_26_2.this.setNew.throttle = ((10F * CockpitPWS_26_2.this.setOld.throttle) + CockpitPWS_26_2.this.fm.CT.PowerControl) / 11F;
            CockpitPWS_26_2.this.w.set(CockpitPWS_26_2.this.fm.getW());
            CockpitPWS_26_2.this.fm.Or.transform(CockpitPWS_26_2.this.w);
            CockpitPWS_26_2.this.setNew.turn = ((33F * CockpitPWS_26_2.this.setOld.turn) + CockpitPWS_26_2.this.w.z) / 34F;
            float f = CockpitPWS_26_2.this.fm.CT.getAileron();
            CockpitPWS_26_2.this.mesh.chunkSetAngles("AroneL_D0", 0.0F, -20F * f, 0.0F);
            CockpitPWS_26_2.this.mesh.chunkSetAngles("AroneR_D0", 0.0F, -20F * f, 0.0F);
            CockpitPWS_26_2.this.mesh.chunkSetAngles("AroneL1_D0", 0.0F, 20F * f, 0.0F);
            CockpitPWS_26_2.this.mesh.chunkSetAngles("AroneR1_D0", 0.0F, 20F * f, 0.0F);
            return true;
        }
    ...
    public CockpitPWS_26_2() {
        super("3DO/Cockpit/PWS-26-2/hier.him", "i16");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zRPM", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 2600F, 0.0F, 13F), CockpitPWS_26_2.rpmScale), 0.0F);
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 280F, 0.0F, 14F), CockpitPWS_26_2.speedometerScale), 0.0F);
    ...
    static {
        Property.set(CockpitPWS_26_2.class, "astatePilotIndx", 1);
    }
