...
public class CockpitPZL23B extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitPZL23B.this.bNeedSetUp) {
                CockpitPZL23B.this.reflectPlaneMats();
                CockpitPZL23B.this.bNeedSetUp = false;
            }
            if (PZL23B.bChangedPit) {
                CockpitPZL23B.this.reflectPlaneToModel();
                PZL23B.bChangedPit = false;
            }
            CockpitPZL23B.this.setTmp = CockpitPZL23B.this.setOld;
            CockpitPZL23B.this.setOld = CockpitPZL23B.this.setNew;
            CockpitPZL23B.this.setNew = CockpitPZL23B.this.setTmp;
            CockpitPZL23B.this.setNew.altimeter = CockpitPZL23B.this.fm.getAltitude();
            if (Math.abs(CockpitPZL23B.this.fm.Or.getKren()) < 30F) {
                CockpitPZL23B.this.setNew.azimuth.setDeg(CockpitPZL23B.this.setOld.azimuth.getDeg(1.0F), CockpitPZL23B.this.fm.Or.azimut());
            }
            CockpitPZL23B.this.setNew.mix = ((10F * CockpitPZL23B.this.setOld.mix) + CockpitPZL23B.this.fm.EI.engines[0].getControlMix()) / 11F;
            CockpitPZL23B.this.setNew.throttle = ((10F * CockpitPZL23B.this.setOld.throttle) + CockpitPZL23B.this.fm.CT.PowerControl) / 11F;
            CockpitPZL23B.this.w.set(CockpitPZL23B.this.fm.getW());
            CockpitPZL23B.this.fm.Or.transform(CockpitPZL23B.this.w);
            CockpitPZL23B.this.setNew.turn = ((33F * CockpitPZL23B.this.setOld.turn) + CockpitPZL23B.this.w.z) / 34F;
            CockpitPZL23B.this.setNew.power = (0.85F * CockpitPZL23B.this.setOld.power) + (CockpitPZL23B.this.fm.EI.engines[0].getPowerOutput() * 0.15F);
            CockpitPZL23B.this.setNew.fuelpressure = (0.9F * CockpitPZL23B.this.setOld.fuelpressure) + (((CockpitPZL23B.this.fm.M.fuel <= 1.0F) || (CockpitPZL23B.this.fm.EI.engines[0].getStage() != 6) ? 0.0F : 0.026F * (10F + (float) Math.sqrt(CockpitPZL23B.this.setNew.power))) * 0.1F);
            CockpitPZL23B.this.setNew.vspeed = ((199F * CockpitPZL23B.this.setOld.vspeed) + CockpitPZL23B.this.fm.getVertSpeed()) / 200F;
            CockpitPZL23B.this.mesh.chunkSetAngles("Turret1A", 0.0F, CockpitPZL23B.this.aircraft().FM.turret[0].tu[0], 0.0F);
            CockpitPZL23B.this.mesh.chunkSetAngles("Turret1B", 0.0F, CockpitPZL23B.this.aircraft().FM.turret[0].tu[1], 0.0F);
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 500F, 0.0F, 25F), CockpitPZL23B.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zOilIn", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilIn, 0.0F, 140F, 0.0F, 7F), CockpitPZL23B.oilTempScale), 0.0F);
        this.mesh.chunkSetAngles("zOilOut", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 140F, 0.0F, 7F), CockpitPZL23B.oilTempScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3200F, 0.0F, 16F), CockpitPZL23B.rpmScale), 0.0F);
