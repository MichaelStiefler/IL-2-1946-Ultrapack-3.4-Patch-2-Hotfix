...
public class CockpitPZL23_42_BASE extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            } else if (this.cockpit instanceof CockpitPZL42) {
            ...
            if (Math.abs(CockpitPZL23_42_BASE.this.fm.Or.getKren()) < 30F) {
                CockpitPZL23_42_BASE.this.setNew.azimuth.setDeg(CockpitPZL23_42_BASE.this.setOld.azimuth.getDeg(1.0F), CockpitPZL23_42_BASE.this.fm.Or.azimut());
            }
            ...
            CockpitPZL23_42_BASE.this.setNew.fuelpressure = (0.9F * CockpitPZL23_42_BASE.this.setOld.fuelpressure) + (((CockpitPZL23_42_BASE.this.fm.M.fuel <= 1.0F) || (CockpitPZL23_42_BASE.this.fm.EI.engines[0].getStage() != 6) ? 0.0F : 0.026F * (10F + (float) Math.sqrt(CockpitPZL23_42_BASE.this.setNew.power))) * 0.1F);
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 500F, 0.0F, 25F), CockpitPZL23_42_BASE.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zOilIn", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilIn, 0.0F, 140F, 0.0F, 7F), CockpitPZL23_42_BASE.oilTempScale), 0.0F);
        this.mesh.chunkSetAngles("zOilOut", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 140F, 0.0F, 7F), CockpitPZL23_42_BASE.oilTempScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3200F, 0.0F, 16F), CockpitPZL23_42_BASE.rpmScale), 0.0F);
