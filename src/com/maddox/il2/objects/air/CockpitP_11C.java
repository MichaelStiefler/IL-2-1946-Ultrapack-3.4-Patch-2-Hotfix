...
public class CockpitP_11C extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitP_11C.this.bNeedSetUp) {
                ...
                CockpitP_11C.this.reflectCockpitMats();
                CockpitP_11C.this.bNeedSetUp = false;
            }
            if (P_11.bChangedPit) {
                CockpitP_11C.this.reflectPlaneToModel();
                P_11.bChangedPit = false;
            }
            CockpitP_11C.this.setTmp = CockpitP_11C.this.setOld;
            CockpitP_11C.this.setOld = CockpitP_11C.this.setNew;
            CockpitP_11C.this.setNew = CockpitP_11C.this.setTmp;
            CockpitP_11C.this.setNew.altimeter = CockpitP_11C.this.fm.getAltitude();
            if (Math.abs(CockpitP_11C.this.fm.Or.getKren()) < 30F) {
                CockpitP_11C.this.setNew.azimuth.setDeg(CockpitP_11C.this.setOld.azimuth.getDeg(1.0F), CockpitP_11C.this.fm.Or.azimut());
            }
            CockpitP_11C.this.setNew.throttle = ((10F * CockpitP_11C.this.setOld.throttle) + CockpitP_11C.this.fm.CT.PowerControl) / 11F;
            CockpitP_11C.this.w.set(CockpitP_11C.this.fm.getW());
            CockpitP_11C.this.fm.Or.transform(CockpitP_11C.this.w);
            CockpitP_11C.this.setNew.turn = ((33F * CockpitP_11C.this.setOld.turn) + CockpitP_11C.this.w.z) / 34F;
            CockpitP_11C.this.setNew.power = (0.85F * CockpitP_11C.this.setOld.power) + (CockpitP_11C.this.fm.EI.engines[0].getPowerOutput() * 0.15F);
            CockpitP_11C.this.setNew.fuelpressure = (0.9F * CockpitP_11C.this.setOld.fuelpressure) + (((CockpitP_11C.this.fm.M.fuel <= 1.0F) || (CockpitP_11C.this.fm.EI.engines[0].getStage() != 6) ? 0.0F : 0.026F * (10F + (float) Math.sqrt(CockpitP_11C.this.setNew.power))) * 0.1F);
            if (CockpitP_11C.this.fm.getAltitude() > 5000F) {
                CockpitP_11C.oxyf = 12F;
            } else if (CockpitP_11C.this.fm.getAltitude() > 3000F) {
                CockpitP_11C.oxyf = (CockpitP_11C.this.fm.getAltitude() - 2600F) / 200F;
            }
            if (CockpitP_11C.this.fm.getAltitude() > 3000F) {
                CockpitP_11C.oxyp = CockpitP_11C.oxyp > 0.0F ? CockpitP_11C.oxyp - (1E-006F * CockpitP_11C.oxyf) : 0.0F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 420F, 0.0F, 21F), CockpitP_11C.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zOilIn", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilIn, 0.0F, 140F, 0.0F, 7F), CockpitP_11C.oilTempScale), 0.0F);
        this.mesh.chunkSetAngles("zOilOut", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 140F, 0.0F, 7F), CockpitP_11C.oilTempScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3000F, 0.0F, 15F), CockpitP_11C.rpmScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zU1", 0.0F, 0.0F, this.cvt(CockpitP_11C.oxyp, 0.0F, 1.0F, 0.0F, 260F));
        this.mesh.chunkSetAngles("zU2", 0.0F, 0.0F, this.cvt(CockpitP_11C.oxyf, 0.0F, 12F, 0.0F, 260F));
    }
    ...
    private void reflectCockpitMats() {
        ...
        CockpitP_11C.mat1_lit = this.mesh.material(i);
        int j = this.mesh.materialFind("ldials_lit");
        CockpitP_11C.mat2_lit = this.mesh.material(j);
        int k = this.mesh.materialFind("sdials_lit");
        CockpitP_11C.mat3_lit = this.mesh.material(k);
        int l = this.mesh.materialFind("dials4_lit");
        CockpitP_11C.mat4_lit = this.mesh.material(l);
    ...
    private void setLitMats(boolean flag) {
        CockpitP_11C.shine = flag ? 0.5F : 0.1F;
        if (CockpitP_11C.mat1_lit.isValidLayer(0)) {
            CockpitP_11C.mat1_lit.setLayer(0);
            CockpitP_11C.mat1_lit.set((byte) 24, CockpitP_11C.shine);
            CockpitP_11C.mat1_lit.set((short) 0, true);
        }
        if (CockpitP_11C.mat2_lit.isValidLayer(0)) {
            CockpitP_11C.mat2_lit.setLayer(0);
            CockpitP_11C.mat2_lit.set((byte) 24, CockpitP_11C.shine);
            CockpitP_11C.mat2_lit.set((short) 0, true);
        }
        if (CockpitP_11C.mat3_lit.isValidLayer(0)) {
            CockpitP_11C.mat3_lit.setLayer(0);
            CockpitP_11C.mat3_lit.set((byte) 24, CockpitP_11C.shine);
            CockpitP_11C.mat3_lit.set((short) 0, true);
        }
        if (CockpitP_11C.mat4_lit.isValidLayer(0)) {
            CockpitP_11C.mat4_lit.setLayer(0);
            CockpitP_11C.mat4_lit.set((byte) 24, CockpitP_11C.shine);
            CockpitP_11C.mat4_lit.set((short) 0, true);
        }
    }
