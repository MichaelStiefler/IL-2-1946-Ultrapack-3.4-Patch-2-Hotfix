...
public class CockpitP_11_BASE extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (Math.abs(CockpitP_11_BASE.this.fm.Or.getKren()) < 30F) {
                CockpitP_11_BASE.this.setNew.azimuth.setDeg(CockpitP_11_BASE.this.setOld.azimuth.getDeg(1.0F), CockpitP_11_BASE.this.fm.Or.azimut());
            }
            ...
            CockpitP_11_BASE.this.setNew.fuelpressure = (0.9F * CockpitP_11_BASE.this.setOld.fuelpressure) + (((CockpitP_11_BASE.this.fm.M.fuel <= 1.0F) || (CockpitP_11_BASE.this.fm.EI.engines[0].getStage() != 6) ? 0.0F : 0.026F * (10F + (float) Math.sqrt(CockpitP_11_BASE.this.setNew.power))) * 0.1F);
            if (CockpitP_11_BASE.this.fm.getAltitude() > 5000F) {
                CockpitP_11_BASE.oxyf = 12F;
            } else if (CockpitP_11_BASE.this.fm.getAltitude() > 3000F) {
                CockpitP_11_BASE.oxyf = (CockpitP_11_BASE.this.fm.getAltitude() - 2600F) / 200F;
            }
            if (CockpitP_11_BASE.this.fm.getAltitude() > 3000F) {
                CockpitP_11_BASE.oxyp = CockpitP_11_BASE.oxyp > 0.0F ? CockpitP_11_BASE.oxyp - (1E-006F * CockpitP_11_BASE.oxyf) : 0.0F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 420F, 0.0F, 21F), CockpitP_11_BASE.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zOilIn", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilIn, 0.0F, 140F, 0.0F, 7F), CockpitP_11_BASE.oilTempScale), 0.0F);
        this.mesh.chunkSetAngles("zOilOut", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 140F, 0.0F, 7F), CockpitP_11_BASE.oilTempScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zRPM", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3000F, 0.0F, 15F), CockpitP_11_BASE.rpmScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zU1", 0.0F, 0.0F, this.cvt(CockpitP_11_BASE.oxyp, 0.0F, 1.0F, 0.0F, 260F));
        this.mesh.chunkSetAngles("zU2", 0.0F, 0.0F, this.cvt(CockpitP_11_BASE.oxyf, 0.0F, 12F, 0.0F, 260F));
    }
    ...
    private void reflectCockpitMats() {
        CockpitP_11_BASE.mat1_lit = this.mesh.material(this.mesh.materialFind("dials3_lit"));
        CockpitP_11_BASE.mat2_lit = this.mesh.material(this.mesh.materialFind("ldials_lit"));
        CockpitP_11_BASE.mat3_lit = this.mesh.material(this.mesh.materialFind("sdials_lit"));
        CockpitP_11_BASE.mat4_lit = this.mesh.material(this.mesh.materialFind("dials4_lit"));
    ...
    private void setLitMats(boolean flag) {
        CockpitP_11_BASE.shine = flag ? 0.5F : 0.1F;
        if (CockpitP_11_BASE.mat1_lit.isValidLayer(0)) {
            CockpitP_11_BASE.mat1_lit.setLayer(0);
            CockpitP_11_BASE.mat1_lit.set((byte) 24, CockpitP_11_BASE.shine);
            CockpitP_11_BASE.mat1_lit.set((short) 0, true);
        }
        if (CockpitP_11_BASE.mat2_lit.isValidLayer(0)) {
            CockpitP_11_BASE.mat2_lit.setLayer(0);
            CockpitP_11_BASE.mat2_lit.set((byte) 24, CockpitP_11_BASE.shine);
            CockpitP_11_BASE.mat2_lit.set((short) 0, true);
        }
        if (CockpitP_11_BASE.mat3_lit.isValidLayer(0)) {
            CockpitP_11_BASE.mat3_lit.setLayer(0);
            CockpitP_11_BASE.mat3_lit.set((byte) 24, CockpitP_11_BASE.shine);
            CockpitP_11_BASE.mat3_lit.set((short) 0, true);
        }
        if (CockpitP_11_BASE.mat4_lit.isValidLayer(0)) {
            CockpitP_11_BASE.mat4_lit.setLayer(0);
            CockpitP_11_BASE.mat4_lit.set((byte) 24, CockpitP_11_BASE.shine);
            CockpitP_11_BASE.mat4_lit.set((short) 0, true);
        }
    }
