...
//                if ((P_24) CockpitP_24.this.aircraft() != null);
            ...
            if (Math.abs(CockpitP_24.this.fm.Or.getKren()) < 30F) {
                CockpitP_24.this.setNew.azimuth.setDeg(CockpitP_24.this.setOld.azimuth.getDeg(1.0F), CockpitP_24.this.fm.Or.azimut());
            }
            ...
            CockpitP_24.this.setNew.fuelpressure = (0.9F * CockpitP_24.this.setOld.fuelpressure) + (((CockpitP_24.this.fm.M.fuel > 1.0F) && (CockpitP_24.this.fm.EI.engines[0].getStage() == 6) ? 0.026F * (10F + (float) Math.sqrt(CockpitP_24.this.setNew.power)) : 0.0F) * 0.1F);
            if (CockpitP_24.this.fm.getAltitude() > 5000F) {
                CockpitP_24.oxyf = 12F;
            } else if (CockpitP_24.this.fm.getAltitude() > 3000F) {
                CockpitP_24.oxyf = (CockpitP_24.this.fm.getAltitude() - 2600F) / 200F;
            }
            if (CockpitP_24.this.fm.getAltitude() > 3000F) {
                CockpitP_24.oxyp = CockpitP_24.oxyp <= 0.0F ? 0.0F : CockpitP_24.oxyp - (1E-006F * CockpitP_24.oxyf);
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 600F, 0.0F, 30F), CockpitP_24.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zOilIn", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilIn, 0.0F, 140F, 0.0F, 7F), CockpitP_24.oilTempScale), 0.0F);
        this.mesh.chunkSetAngles("zOilOut", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 140F, 0.0F, 7F), CockpitP_24.oilTempScale), 0.0F);
        this.resetYPRmodifier();
        ...
        this.mesh.chunkSetAngles("zRPM", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3000F, 0.0F, 15F), CockpitP_24.rpmScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zU1", 0.0F, 0.0F, this.cvt(CockpitP_24.oxyp, 0.0F, 1.0F, 0.0F, 260F));
        this.mesh.chunkSetAngles("zU2", 0.0F, 0.0F, this.cvt(CockpitP_24.oxyf, 0.0F, 12F, 0.0F, 260F));
    }
    ...
    private void reflectCockpitMats() {
        CockpitP_24.mat1_lit = this.mesh.material(this.mesh.materialFind("dials3_lit"));
        CockpitP_24.mat2_lit = this.mesh.material(this.mesh.materialFind("ldials_lit"));
        CockpitP_24.mat3_lit = this.mesh.material(this.mesh.materialFind("sdials_lit"));
        CockpitP_24.mat4_lit = this.mesh.material(this.mesh.materialFind("dials4_lit"));
    ...
    private void setLitMats(boolean flag) {
        CockpitP_24.shine = flag ? 0.5F : 0.1F;
        if (CockpitP_24.mat1_lit.isValidLayer(0)) {
            CockpitP_24.mat1_lit.setLayer(0);
            CockpitP_24.mat1_lit.set((byte) 24, CockpitP_24.shine);
            CockpitP_24.mat1_lit.set((short) 0, true);
        }
        if (CockpitP_24.mat2_lit.isValidLayer(0)) {
            CockpitP_24.mat2_lit.setLayer(0);
            CockpitP_24.mat2_lit.set((byte) 24, CockpitP_24.shine);
            CockpitP_24.mat2_lit.set((short) 0, true);
        }
        if (CockpitP_24.mat3_lit.isValidLayer(0)) {
            CockpitP_24.mat3_lit.setLayer(0);
            CockpitP_24.mat3_lit.set((byte) 24, CockpitP_24.shine);
            CockpitP_24.mat3_lit.set((short) 0, true);
        }
        if (CockpitP_24.mat4_lit.isValidLayer(0)) {
            CockpitP_24.mat4_lit.setLayer(0);
            CockpitP_24.mat4_lit.set((byte) 24, CockpitP_24.shine);
            CockpitP_24.mat4_lit.set((short) 0, true);
        }
    }
