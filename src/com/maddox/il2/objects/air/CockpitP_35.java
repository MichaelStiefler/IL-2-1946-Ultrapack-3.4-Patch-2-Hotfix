...
public class CockpitP_35 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitP_35.this.fm != null) {
                ...
                if (Math.abs(CockpitP_35.this.fm.Or.getKren()) < 30F) {
                ...
                if ((CockpitP_35.this.flapsLever != 0.0F) && (CockpitP_35.this.flaps == CockpitP_35.this.fm.CT.getFlap())) {
                    ...
                    if (Math.abs(CockpitP_35.this.flapsLever) < 0.1F) {
                        CockpitP_35.this.flapsLever = 0.0F;
                    }
                    ...
                    if (CockpitP_35.this.flapsLever > f) {
                        CockpitP_35.this.flapsLever = f;
                    }
                } else if (CockpitP_35.this.flaps > CockpitP_35.this.fm.CT.getFlap()) {
                    CockpitP_35.this.flaps = CockpitP_35.this.fm.CT.getFlap();
                    CockpitP_35.this.flapsLever = CockpitP_35.this.flapsLever - 2.0F;
                ...
                if ((CockpitP_35.this.gearsLever != 0.0F) && (CockpitP_35.this.gears == CockpitP_35.this.fm.CT.getGear())) {
                    ...
                    if (Math.abs(CockpitP_35.this.gearsLever) < 0.1F) {
                        CockpitP_35.this.gearsLever = 0.0F;
                    }
                    ...
                    if (CockpitP_35.this.gearsLever > f) {
                        CockpitP_35.this.gearsLever = f;
                    }
                } else if (CockpitP_35.this.gears > CockpitP_35.this.fm.CT.getGear()) {
                    CockpitP_35.this.gears = CockpitP_35.this.fm.CT.getGear();
                    CockpitP_35.this.gearsLever = CockpitP_35.this.gearsLever - 2.0F;
                ...
                if (CockpitP_35.this.fuelPerct > CockpitP_35.fuelTankLevels[0]) {
                    if (CockpitP_35.this.fuelPerct > CockpitP_35.fuelTankLevels[1]) {
                        byte0 = 2;
                    } else {
                        byte0 = 1;
                    }
            ...
            if ((CockpitP_35.this.gearsLever != 0.0F) || (CockpitP_35.this.flapsLever != 0.0F)) {
                ...
                if (CockpitP_35.this.amps[0] < 12F) {
                    CockpitP_35.this.amps[2] = 0.02F;
                }
                if (CockpitP_35.this.fm.EI.engines[0].getStage() != 0) {
                    CockpitP_35.this.amps[1] = 10F;
                } else {
                    CockpitP_35.this.amps[1] = 0.0F;
                }
            }
            if (CockpitP_35.this.amps[0] != CockpitP_35.this.amps[1]) {
                if (CockpitP_35.this.amps[0] > CockpitP_35.this.amps[1]) {
                    ...
                    if (CockpitP_35.this.amps[0] < CockpitP_35.this.amps[1]) {
                        CockpitP_35.this.amps[0] = CockpitP_35.this.amps[1];
                    }
                } else {
                    CockpitP_35.this.amps[0] += CockpitP_35.this.amps[2];
                    if (CockpitP_35.this.amps[0] > CockpitP_35.this.amps[1]) {
                ...
                if ((CockpitP_35.this.fm.AS.astateCockpitState & 2) != 0) {
                    CockpitP_35.this.setNew.reviPos = ((9F * CockpitP_35.this.setOld.reviPos) + 1.0F) / 10F;
                }
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.fm.CT.getCockpitDoor() > 0.5D) {
            this.mesh.chunkSetAngles("Z_canopy_lever", 0.0F, -this.cvt(this.fm.CT.getCockpitDoor(), 0.9F, 1.0F, 7F, 0.0F), 0.0F);
        } else {
            this.mesh.chunkSetAngles("Z_canopy_lever", 0.0F, -this.cvt(this.fm.CT.getCockpitDoor(), 0.0F, 0.1F, 0.0F, 7F), 0.0F);
        }
        this.mesh.chunkSetAngles("Z_canopy_open_rod", Cockpit.xyz[1] * 2570F, 0.0F, 0.0F);
        this.w.set(this.fm.getW());
        this.fm.Or.transform(this.w);
        this.mesh.chunkSetAngles("Zairspeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 20F), CockpitP_35.speedometerScale), 0.0F);
        ...
        if (f1 > 600F) {
            this.mesh.chunkSetAngles("Zrpm", 0.0F, this.cvt(this.fm.EI.engines[0].getRPM(), 600F, 3000F, 16.5F, 343.2F), 0.0F);
        } else {
            this.mesh.chunkSetAngles("Zrpm", 0.0F, this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 600F, 0.0F, 16.5F), 0.0F);
        }
        this.resetYPRmodifier();
        ...
        if (this.reversedThrottle) {
            Cockpit.xyz[1] = 1.0F - this.interp(this.setNew.throttle, this.setOld.throttle, f);
        } else {
            Cockpit.xyz[1] = this.interp(this.setNew.throttle, this.setOld.throttle, f);
        }
        ...
        if (this.fm.Gears.lgear) {
            this.mesh.chunkSetAngles("ZGearL", 0.0F, this.cvt(this.fm.CT.getGear(), 0.0F, 1.0F, 0.0F, 76F), 0.0F);
        }
        if (this.fm.Gears.rgear) {
            this.mesh.chunkSetAngles("ZGearR", 0.0F, this.cvt(this.fm.CT.getGear(), 0.0F, 1.0F, 0.0F, -76F), 0.0F);
        }
        if (this.fm.Gears.cgear) {
            this.mesh.chunkSetAngles("ZGearC", 0.0F, this.cvt(this.fm.CT.getGear(), 0.0F, 1.0F, 0.0F, 90F), 0.0F);
        }
        ...
        if (this.fuelPerct > CockpitP_35.fuelTankLevels[0]) {
            this.mesh.chunkSetAngles("Zfuel", 0.0F, 295.5F, 0.0F);
            this.mesh.chunkSetAngles("ZfuelWing", 0.0F, this.cvt(this.fuelPerct, CockpitP_35.fuelTankLevels[0], 100F, 13.5F, 285.5F), 0.0F);
        } else {
            this.mesh.chunkSetAngles("Zfuel", 0.0F, this.cvt(this.fuelPerct, 0.0F, CockpitP_35.fuelTankLevels[0], -3.5F, 295.5F), 0.0F);
            this.mesh.chunkSetAngles("ZfuelWing", 0.0F, 13.5F, 0.0F);
        }
        if (this.setNew.fuelPSI < 12F) {
            this.mesh.chunkVisible("XFlareRed_01", true);
        } else {
            this.mesh.chunkVisible("XFlareRed_01", false);
        }
        ...
        this.mesh.chunkSetAngles("ZCarbAir", 0.0F, this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z) - 273.15F, -40F, 50F, 0.0F, 4F), CockpitP_35.airTempScale), 0.0F);
    }
    ...
    protected void reflectPlaneMats() {
        ...
        if (this.aircraft().getRegiment() != null) {
            ...
            if (this.aircraft().getRegiment().country().equals("fr")) {
                this.reversedThrottle = true;
            }
        }
