...
public class CockpitP_36 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitP_36.this.fm != null) {
                ...
                CockpitP_36.this.setNew.prop = ((8F * CockpitP_36.this.setOld.prop) + CockpitP_36.this.fm.CT.getStepControl()) / 9F;
                CockpitP_36.this.setNew.altimeter = CockpitP_36.this.fm.getAltitude();
                CockpitP_36.this.setNew.waypointAzimuth.setDeg(CockpitP_36.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitP_36.this.waypointAzimuth() - CockpitP_36.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitP_36.this.fm.Or.getKren()) < 30F) {
                    CockpitP_36.this.setNew.azimuth.setDeg(CockpitP_36.this.setOld.azimuth.getDeg(1.0F), CockpitP_36.this.fm.Or.azimut());
                }
                CockpitP_36.this.setNew.vspeed = ((199F * CockpitP_36.this.setOld.vspeed) + CockpitP_36.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitP_36.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitP_36.variometerScale), 0.0F);
