...
public class CockpitP_38DS extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitP_38DS.this.bNeedSetUp) {
                CockpitP_38DS.this.reflectPlaneMats();
                CockpitP_38DS.this.bNeedSetUp = false;
            }
            if (((P_38DroopSnoot) CockpitP_38DS.this.aircraft()).bChangedPit) {
                CockpitP_38DS.this.reflectPlaneToModel();
                ((P_38DroopSnoot) CockpitP_38DS.this.aircraft()).bChangedPit = false;
            }
            if (CockpitP_38DS.this.fm != null) {
                CockpitP_38DS.this.setTmp = CockpitP_38DS.this.setOld;
                CockpitP_38DS.this.setOld = CockpitP_38DS.this.setNew;
                CockpitP_38DS.this.setNew = CockpitP_38DS.this.setTmp;
                CockpitP_38DS.this.setNew.trim = (0.92F * CockpitP_38DS.this.setOld.trim) + (0.08F * CockpitP_38DS.this.fm.CT.getTrimElevatorControl());
                CockpitP_38DS.this.setNew.throttle1 = (0.85F * CockpitP_38DS.this.setOld.throttle1) + (CockpitP_38DS.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitP_38DS.this.setNew.throttle2 = (0.85F * CockpitP_38DS.this.setOld.throttle2) + (CockpitP_38DS.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitP_38DS.this.setNew.prop1 = (0.85F * CockpitP_38DS.this.setOld.prop1) + (CockpitP_38DS.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitP_38DS.this.setNew.prop2 = (0.85F * CockpitP_38DS.this.setOld.prop2) + (CockpitP_38DS.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitP_38DS.this.setNew.mix1 = (0.85F * CockpitP_38DS.this.setOld.mix1) + (CockpitP_38DS.this.fm.EI.engines[0].getControlMix() * 0.15F);
                CockpitP_38DS.this.setNew.mix2 = (0.85F * CockpitP_38DS.this.setOld.mix2) + (CockpitP_38DS.this.fm.EI.engines[1].getControlMix() * 0.15F);
                CockpitP_38DS.this.setNew.altimeter = CockpitP_38DS.this.fm.getAltitude();
                float f = CockpitP_38DS.this.waypointAzimuth();
                if (Math.abs(CockpitP_38DS.this.fm.Or.getKren()) < 30F) {
                    CockpitP_38DS.this.setNew.azimuth.setDeg(CockpitP_38DS.this.setOld.azimuth.getDeg(1.0F), CockpitP_38DS.this.fm.Or.azimut());
                }
                CockpitP_38DS.this.setNew.waypointAzimuth.setDeg(CockpitP_38DS.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitP_38DS.this.setNew.vspeed = ((199F * CockpitP_38DS.this.setOld.vspeed) + CockpitP_38DS.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (((P_38DroopSnoot) this.aircraft()).bChangedPit) {
            this.reflectPlaneToModel();
            ((P_38DroopSnoot) this.aircraft()).bChangedPit = false;
        }
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitP_38DS.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitP_38DS.variometerScale), 0.0F, 0.0F);
