...
public class CockpitP_38L extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitP_38L.this.bNeedSetUp) {
                ...
                CockpitP_38L.this.bNeedSetUp = false;
            }
            ...
            if (CockpitP_38L.this.fm != null) {
                CockpitP_38L.this.setTmp = CockpitP_38L.this.setOld;
                CockpitP_38L.this.setOld = CockpitP_38L.this.setNew;
                CockpitP_38L.this.setNew = CockpitP_38L.this.setTmp;
                ...
                if (Math.abs(CockpitP_38L.this.fm.Or.getKren()) < 30F) {
                ...
                if (CockpitP_38L.this.useRealisticNavigationInstruments()) {
                    CockpitP_38L.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitP_38L.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitP_38L.this.setNew.waypointAzimuth.setDeg(CockpitP_38L.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                }
                CockpitP_38L.this.setNew.vspeed = ((199F * CockpitP_38L.this.setOld.vspeed) + CockpitP_38L.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (((P_38L) this.aircraft()).bChangedPit) {
            this.reflectPlaneToModel();
            ((P_38L) this.aircraft()).bChangedPit = false;
        }
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitP_38L.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitP_38L.variometerScale), 0.0F, 0.0F);
