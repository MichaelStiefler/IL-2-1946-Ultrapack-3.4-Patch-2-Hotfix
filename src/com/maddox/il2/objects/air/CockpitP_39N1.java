...
public class CockpitP_39N1 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitP_39N1.this.fm != null) {
                CockpitP_39N1.this.setTmp = CockpitP_39N1.this.setOld;
                CockpitP_39N1.this.setOld = CockpitP_39N1.this.setNew;
                CockpitP_39N1.this.setNew = CockpitP_39N1.this.setTmp;
                CockpitP_39N1.this.setNew.throttle = ((10F * CockpitP_39N1.this.setOld.throttle) + CockpitP_39N1.this.fm.CT.PowerControl) / 11F;
                CockpitP_39N1.this.setNew.altimeter = CockpitP_39N1.this.fm.getAltitude();
                if (Math.abs(CockpitP_39N1.this.fm.Or.getKren()) < 45F) {
                    CockpitP_39N1.this.setNew.azimuthMag = ((349F * CockpitP_39N1.this.setOld.azimuthMag) + CockpitP_39N1.this.fm.Or.azimut()) / 350F;
                }
                if ((CockpitP_39N1.this.setOld.azimuthMag > 270F) && (CockpitP_39N1.this.setNew.azimuthMag < 90F)) {
                    CockpitP_39N1.this.setOld.azimuthMag -= 360F;
                }
                if ((CockpitP_39N1.this.setOld.azimuthMag < 90F) && (CockpitP_39N1.this.setNew.azimuthMag > 270F)) {
                    CockpitP_39N1.this.setOld.azimuthMag += 360F;
                }
                CockpitP_39N1.this.setNew.waypointAzimuth.setDeg(CockpitP_39N1.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitP_39N1.this.waypointAzimuth() - CockpitP_39N1.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitP_39N1.this.fm.Or.getKren()) < 30F) {
                    CockpitP_39N1.this.setNew.azimuth.setDeg(CockpitP_39N1.this.setOld.azimuth.getDeg(1.0F), CockpitP_39N1.this.fm.Or.azimut());
                }
                CockpitP_39N1.this.setNew.vspeed = ((499F * CockpitP_39N1.this.setOld.vspeed) + CockpitP_39N1.this.fm.getVertSpeed()) / 500F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("AirSpeed", this.floatindex(this.cvt(0.6213711F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 500F, 0.0F, 10F), CockpitP_39N1.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Climb", this.setNew.vspeed < 0.0F ? -this.floatindex(this.cvt(-this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitP_39N1.variometerScale) : this.floatindex(this.cvt(this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitP_39N1.variometerScale), 0.0F, 0.0F);
        float f1;
        ...
        this.mesh.chunkVisible("XFlareRed", (this.fm.CT.PowerControl < 0.333F) && (this.fm.CT.getGear() < 0.99F));
