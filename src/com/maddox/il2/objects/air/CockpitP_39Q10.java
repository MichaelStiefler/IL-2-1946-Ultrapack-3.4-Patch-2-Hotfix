...
public class CockpitP_39Q10 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitP_39Q10.this.fm != null) {
                ...
                if (Math.abs(CockpitP_39Q10.this.fm.Or.getKren()) < 45F) {
                    CockpitP_39Q10.this.setNew.azimuthMag = ((349F * CockpitP_39Q10.this.setOld.azimuthMag) + CockpitP_39Q10.this.fm.Or.azimut()) / 350F;
                }
                if ((CockpitP_39Q10.this.setOld.azimuthMag > 270F) && (CockpitP_39Q10.this.setNew.azimuthMag < 90F)) {
                    CockpitP_39Q10.this.setOld.azimuthMag -= 360F;
                }
                if ((CockpitP_39Q10.this.setOld.azimuthMag < 90F) && (CockpitP_39Q10.this.setNew.azimuthMag > 270F)) {
                    CockpitP_39Q10.this.setOld.azimuthMag += 360F;
                }
                CockpitP_39Q10.this.setNew.waypointAzimuth.setDeg(CockpitP_39Q10.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitP_39Q10.this.waypointAzimuth() - CockpitP_39Q10.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitP_39Q10.this.fm.Or.getKren()) < 30F) {
                    CockpitP_39Q10.this.setNew.azimuth.setDeg(CockpitP_39Q10.this.setOld.azimuth.getDeg(1.0F), CockpitP_39Q10.this.fm.Or.azimut());
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("AirSpeed", this.floatindex(this.cvt(0.6213711F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 500F, 0.0F, 10F), CockpitP_39Q10.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Climb", this.setNew.vspeed < 0.0F ? -this.floatindex(this.cvt(-this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitP_39Q10.variometerScale) : this.floatindex(this.cvt(this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitP_39Q10.variometerScale), 0.0F, 0.0F);
        float f1;
