...
public class CockpitP_40B extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitP_40B.this.fm != null) {
                CockpitP_40B.this.setTmp = CockpitP_40B.this.setOld;
                CockpitP_40B.this.setOld = CockpitP_40B.this.setNew;
                CockpitP_40B.this.setNew = CockpitP_40B.this.setTmp;
                CockpitP_40B.this.setNew.throttle = ((10F * CockpitP_40B.this.setOld.throttle) + CockpitP_40B.this.fm.CT.PowerControl) / 11F;
                CockpitP_40B.this.setNew.prop = ((8F * CockpitP_40B.this.setOld.prop) + CockpitP_40B.this.fm.CT.getStepControl()) / 9F;
                CockpitP_40B.this.setNew.altimeter = CockpitP_40B.this.fm.getAltitude();
                CockpitP_40B.this.setNew.waypointAzimuth.setDeg(CockpitP_40B.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitP_40B.this.waypointAzimuth() - CockpitP_40B.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitP_40B.this.fm.Or.getKren()) < 30F) {
                    CockpitP_40B.this.setNew.azimuth.setDeg(CockpitP_40B.this.setOld.azimuth.getDeg(1.0F), CockpitP_40B.this.fm.Or.azimut());
                }
                CockpitP_40B.this.setNew.vspeed = ((199F * CockpitP_40B.this.setOld.vspeed) + CockpitP_40B.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitP_40B.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitP_40B.variometerScale), 0.0F);
