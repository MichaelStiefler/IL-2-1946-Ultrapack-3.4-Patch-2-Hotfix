...
public class CockpitP_40C extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitP_40C.this.fm != null) {
                CockpitP_40C.this.setTmp = CockpitP_40C.this.setOld;
                CockpitP_40C.this.setOld = CockpitP_40C.this.setNew;
                CockpitP_40C.this.setNew = CockpitP_40C.this.setTmp;
                CockpitP_40C.this.setNew.throttle = ((10F * CockpitP_40C.this.setOld.throttle) + CockpitP_40C.this.fm.CT.PowerControl) / 11F;
                CockpitP_40C.this.setNew.prop = ((8F * CockpitP_40C.this.setOld.prop) + CockpitP_40C.this.fm.CT.getStepControl()) / 9F;
                CockpitP_40C.this.setNew.altimeter = CockpitP_40C.this.fm.getAltitude();
                CockpitP_40C.this.setNew.waypointAzimuth.setDeg(CockpitP_40C.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitP_40C.this.waypointAzimuth() - CockpitP_40C.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitP_40C.this.fm.Or.getKren()) < 30F) {
                    CockpitP_40C.this.setNew.azimuth.setDeg(CockpitP_40C.this.setOld.azimuth.getDeg(1.0F), CockpitP_40C.this.fm.Or.azimut());
                }
                CockpitP_40C.this.setNew.vspeed = ((199F * CockpitP_40C.this.setOld.vspeed) + CockpitP_40C.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitP_40C() {
        super("3DO/Cockpit/P-40C/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitP_40C.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitP_40C.variometerScale), 0.0F);
