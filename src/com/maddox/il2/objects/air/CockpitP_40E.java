...
public class CockpitP_40E extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitP_40E.this.fm != null) {
                ...
                CockpitP_40E.this.setNew.waypointAzimuth.setDeg(CockpitP_40E.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitP_40E.this.waypointAzimuth() - CockpitP_40E.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitP_40E.this.fm.Or.getKren()) < 30F) {
                    CockpitP_40E.this.setNew.azimuth.setDeg(CockpitP_40E.this.setOld.azimuth.getDeg(1.0F), CockpitP_40E.this.fm.Or.azimut());
                }
                CockpitP_40E.this.setNew.vspeed = ((199F * CockpitP_40E.this.setOld.vspeed) + CockpitP_40E.this.fm.getVertSpeed()) / 200F;

                // TODO: +++ New Oil and Fuel Pressure Calculation and Animation by
                // SAS~Storebror +++
                float newOilPressure = CockpitP_40E.this.cvt(CockpitP_40E.this.fm.EI.engines[0].getRPM(), 0F, 300F, 0F, 1F) * CockpitP_40E.this.fm.EI.engines[0].getReadyness() * CockpitP_40E.this.cvt(CockpitP_40E.this.fm.EI.engines[0].tOilOut, 70F, 80F, 70F, 60F) * CockpitP_40E.this.cvt(CockpitP_40E.this.fm.EI.engines[0].tOilOut, 60F, 70F, 85F / 70F, 1F) * CockpitP_40E.this.cvt(CockpitP_40E.this.fm.EI.engines[0].tOilOut, 80F, 100F, 1F, 0.7F);
                if (newOilPressure > CockpitP_40E.this.setOld.oilPressure) {
                    CockpitP_40E.this.setNew.oilPressure = (((CockpitP_40E.OIL_PRESSURE_SMOOTHING_UP - 1F) * CockpitP_40E.this.setOld.oilPressure) + newOilPressure) / CockpitP_40E.OIL_PRESSURE_SMOOTHING_UP;
                } else {
                    CockpitP_40E.this.setNew.oilPressure = (((CockpitP_40E.OIL_PRESSURE_SMOOTHING_DOWN - 1F) * CockpitP_40E.this.setOld.oilPressure) + newOilPressure) / CockpitP_40E.OIL_PRESSURE_SMOOTHING_DOWN;
                }

                float newFuelPressure = CockpitP_40E.this.cvt(CockpitP_40E.this.fm.EI.engines[0].getRPM(), 0F, 50F, 0F, 18F) * CockpitP_40E.this.cvt(CockpitP_40E.this.fm.EI.engines[0].getReadyness(), 0.5F, 1F, 0.9F, 1F) * CockpitP_40E.this.cvt(CockpitP_40E.this.fm.EI.engines[0].getReadyness(), 0.0F, 0.5F, 0F, 1F);
                if (newFuelPressure > CockpitP_40E.this.setOld.fuelPressure) {
                    CockpitP_40E.this.setNew.fuelPressure = (((CockpitP_40E.FUEL_PRESSURE_SMOOTHING_UP - 1F) * CockpitP_40E.this.setOld.fuelPressure) + newFuelPressure) / CockpitP_40E.FUEL_PRESSURE_SMOOTHING_UP;
                } else {
                    CockpitP_40E.this.setNew.fuelPressure = (((CockpitP_40E.FUEL_PRESSURE_SMOOTHING_DOWN - 1F) * CockpitP_40E.this.setOld.fuelPressure) + newFuelPressure) / CockpitP_40E.FUEL_PRESSURE_SMOOTHING_DOWN;
                    // TODO: --- New Oil and Fuel Pressure Calculation and Animation by
                    // SAS~Storebror ---
                }
            }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitP_40E.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Fuelqty", 0.0F, this.floatindex(this.cvt(this.fm.M.fuel, 0.0F, 400F, 0.0F, 5F), CockpitP_40E.fuelScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) ((Tuple3d) this.fm.Loc).z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitP_40E.speedometerScale), 0.0F, 0.0F);
    }
