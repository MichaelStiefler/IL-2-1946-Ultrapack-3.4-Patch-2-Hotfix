    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitP_43.this.fm != null) {
                ...
                CockpitP_43.this.setNew.waypointAzimuth.setDeg(CockpitP_43.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitP_43.this.waypointAzimuth() - CockpitP_43.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitP_43.this.fm.Or.getKren()) < 30F) {
                    CockpitP_43.this.setNew.azimuth.setDeg(CockpitP_43.this.setOld.azimuth.getDeg(1.0F), CockpitP_43.this.fm.Or.azimut());
                }
