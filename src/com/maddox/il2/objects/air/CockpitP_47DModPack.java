...
//                CockpitP_47DModPack.this.updateSound();
                ...
                CockpitP_47DModPack.this.setNew.waypointAzimuth.setDeg(CockpitP_47DModPack.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitP_47DModPack.this.waypointAzimuth() - CockpitP_47DModPack.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitP_47DModPack.this.fm.Or.getKren()) < 30F) {
                    CockpitP_47DModPack.this.setNew.azimuth.setDeg(CockpitP_47DModPack.this.setOld.azimuth.getDeg(1.0F), CockpitP_47DModPack.this.fm.Or.azimut());
                }
                ...
                if (CockpitP_47DModPack.this.fm.getAltitude() > 3000F) {
                    f = (float) Math.sin(1.0F * CockpitP_47DModPack.this.cvt(CockpitP_47DModPack.this.fm.getOverload(), 1.0F, 8F, 1.0F, 0.45F) * CockpitP_47DModPack.this.cvt(CockpitP_47DModPack.this.fm.AS.astatePilotStates[0], 0.0F, 100F, 1.0F, 0.1F) * (0.001F * Time.current()));
                    if (f > 0.0F) {
                        CockpitP_47DModPack.this.pictBlinker += 0.3F;
                        if (CockpitP_47DModPack.this.pictBlinker > 1.0F) {
                            CockpitP_47DModPack.this.pictBlinker = 1.0F;
                        }
                    } else {
                        CockpitP_47DModPack.this.pictBlinker -= 0.3F;
                        if (CockpitP_47DModPack.this.pictBlinker < 0.0F) {
                            CockpitP_47DModPack.this.pictBlinker = 0.0F;
                        }
                    }
                }
                if (CockpitP_47DModPack.this.fm.EI.engines[0].getRPM() < 0.01F) {
                    CockpitP_47DModPack.this.pictTurba = 0.0F;
                } else if (CockpitP_47DModPack.this.fm.getAltitude() < 1500F) {
                    CockpitP_47DModPack.this.pictTurba = 0.05F * CockpitP_47DModPack.this.fm.EI.engines[0].getManifoldPressure() * CockpitP_47DModPack.this.setNew.supercharge;
                } else {
                    CockpitP_47DModPack.this.pictTurba = (0.2F * CockpitP_47DModPack.this.fm.EI.engines[0].getManifoldPressure()) + (0.0001F * CockpitP_47DModPack.this.fm.getAltitude() * CockpitP_47DModPack.this.setNew.supercharge);
                }
                if (CockpitP_47DModPack.this.aircraft() instanceof P_47ModPackAceMakerGunsight) {
                    ...
                    if (CockpitP_47DModPack.this.setNew.k14x > 7F) {
                        CockpitP_47DModPack.this.setNew.k14x = 7F;
                    }
                    if (CockpitP_47DModPack.this.setNew.k14x < -7F) {
                        CockpitP_47DModPack.this.setNew.k14x = -7F;
                    }
                    if (CockpitP_47DModPack.this.setNew.k14y > 7F) {
                        CockpitP_47DModPack.this.setNew.k14y = 7F;
                    }
                    if (CockpitP_47DModPack.this.setNew.k14y < -7F) {
                        CockpitP_47DModPack.this.setNew.k14y = -7F;
                    }
...
//                CockpitP_47DModPack.this.sfxBellSound(true);
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zfuelR", 0.0F, this.floatindex(this.cvt(this.fm.M.fuel, 0.0F, 981F, 0.0F, 6F), CockpitP_47DModPack.fuelGallonsScale), 0.0F);
        this.mesh.chunkSetAngles("zfuelL", 0.0F, -this.floatindex(this.cvt(this.fm.M.fuel, 0.0F, 981F, 0.0F, 4F), CockpitP_47DModPack.fuelGallonsAuxScale), 0.0F);
        this.mesh.chunkSetAngles("zacceleration", 0.0F, this.cvt(this.fm.getOverload(), -4F, 12F, -77F, 244F), 0.0F);
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitP_47DModPack.speedometerScale), 0.0F);
        this.mesh.chunkSetAngles("zclimb", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitP_47DModPack.variometerScale), 0.0F);
        ...
        if (this.mesh.chunkFindCheck("zSlip") > 0) {
            this.mesh.chunkSetAngles("zSlip", 0.0F, this.cvt(this.getBall(7D), -7F, 7F, -16F, 16F), 0.0F);
        }
    }
    ...
    private void loadLocalSoundsFX() {
        if (this.sounds != null) {
            if (this.sounds[7] == null) {
                SoundFX tempSfx = this.aircraft().newSound(Cockpit.sfxPreset, false, false);
                if (tempSfx != null) {
                    this.sounds[7] = this.adjustFX(tempSfx, 7, -0.5D, 0.7D, -0.1D);
                    this.sounds[7].setVolume(10.0F);
                    this.sndBell = this.sounds[7];
                    CockpitP_47DModPack.printDebugMessage("*** Bell sound loaded");
                }
            }
            if (this.sounds[8] == null) {
                ...
                if (tempSfx != null) {
                    ...
                    CockpitP_47DModPack.printDebugMessage("*** Turbo sound loaded");
                }
            }
            if (this.sounds[10] == null) {
                ...
                if (tempSfx != null) {
                    ...
                    CockpitP_47DModPack.printDebugMessage("*** Wheels sound loaded");
                }
            }
            if (this.sounds[11] == null) {
                ...
                if (tempSfx != null) {
                    ...
                    CockpitP_47DModPack.printDebugMessage("*** GearUp sound loaded");
                }
            }
            if (this.sounds[12] == null) {
                ...
                if (tempSfx != null) {
                    ...
                    CockpitP_47DModPack.printDebugMessage("*** GearDn sound loaded");
                }
            }
            if (this.sounds[13] == null) {
                ...
                if (tempSfx != null) {
                    ...
                    CockpitP_47DModPack.printDebugMessage("*** FlapsEnd sound loaded");
                }
            }
            if (this.sounds[14] == null) {
                ...
                if (tempSfx != null) {
                    ...
                    CockpitP_47DModPack.printDebugMessage("*** Flaps sound loaded");
                }
            }
            if (this.sounds[15] == null) {
                ...
                if (tempSfx != null) {
                    ...
                    CockpitP_47DModPack.printDebugMessage("*** Canopy wind sound loaded");
                }
            }
        }
    }
    ...
    private void sfxFlapSound() {
        if (((P_47ModPack) this.aircraft()).bFlaps) {
            if (this.sndFlaps != null) {
                this.sndFlaps.setPlay(true);
            }
            this.iFlapEndCycles = this.fm.CT.FlapsControl != 0.0F ? 10 : 20;
        }
        if (((P_47ModPack) this.aircraft()).bFlapsEnd) {
            if (this.sndFlapsEnd != null) {
                this.sndFlapsEnd.setPlay(true);
            }
            if (this.iFlapEndCycles-- == 0) {
                if (this.sndFlaps != null) {
                    this.sndFlaps.setPlay(false);
                }
    ...
    private void initLocalSounds() {
        Cockpit.sfxPreset = null;
        Cockpit.sfxPreset = new SoundPreset("aircraft.cockpit_p47");
        this.sounds = new SoundFX[18];
        CockpitP_47DModPack.printDebugMessage("*** Local Sounds Loaded: aircraft.cockpit_p47.prs");
    }
    ...
    private void resetAcoustics(String s) {
        ...
        this.acoustics.globFX = new ReverbFXRoom(0.45F);
//        this.bNeedSetUp = true;
        CockpitP_47DModPack.printDebugMessage("*** Acoustics Loaded:" + s);
    }
...
//    }
    ...
    private void changeSound() {
        if ((this.fm.CT.getCockpitDoor() < 0.1F) && !this.bCanopyClosed) {
            ...
            CockpitP_47DModPack.printDebugMessage("*** Canopy closed - music: " + this.bMusicPresent);
        }
        if ((this.fm.CT.getCockpitDoor() > 0.1F) && this.bCanopyClosed) {
            this.resetAcoustics("p47opn");
            this.bCanopyClosed = false;
            CockpitP_47DModPack.printDebugMessage("*** Canopy open - music: " + this.bMusicPresent);
        }
        if (this.fm.isStationedOnGround() && !Main3D.cur3D().isViewOutside()) {
            if (this.bMusicPresent && (this.fm.CT.getCockpitDoor() < 0.1F)) {
                ...
                CockpitP_47DModPack.printDebugMessage("*** Music set to stop");
            }
            if (!this.bMusicPresent && (this.fm.CT.getCockpitDoor() > 0.1F)) {
                CmdEnv.top().exec("music PLAY");
                this.bMusicPresent = true;
                CockpitP_47DModPack.printDebugMessage("*** Music set to play");
            }
        }
    }
...
//    }
    ...
    private void checkForEnemyBehind() {
        this.bRadarWarning = false;
        if (!(this.aircraft() instanceof P_47ModPack) || !((P_47ModPack) this.aircraft()).isRwrActive) {
            return;
        }
        ...
        if (agl < 950) {
            maxDistance = Aircraft.cvt((float) agl, 450F, 950F, 300F, 730F);
        }
        ...
        try {
            ...
            for (int targetsListIndex = 0; targetsListIndex < targetsListSize; targetsListIndex++) {
                ...
                if ((targetDistance > maxDistance) || (targetDistance < 180D)) {
                    continue;
                }
                ...
                if ((targetAngle < 140F) || (targetAngle > 180F)) {
                    continue;
                }
...
//                HUD.training("D:" + twoDigits.format(targetDistance) + ", A:" + twoDigits.format(targetAngle));
    ...
    private void sfxBellSound(boolean flag) {
        if (this.sndBell != null) {
            this.sndBell.setPlay(flag);
        }
    }
    ...
    public void destroy() {
        ...
        if (this.sndFlaps != null) {
            this.sndFlaps.cancel();
        }
        if (this.sndFlapsEnd != null) {
            this.sndFlapsEnd.cancel();
        }
        if (this.sndTurbo != null) {
            this.sndTurbo.cancel();
        }
        if (this.sndBell != null) {
            this.sndBell.cancel();
        }
