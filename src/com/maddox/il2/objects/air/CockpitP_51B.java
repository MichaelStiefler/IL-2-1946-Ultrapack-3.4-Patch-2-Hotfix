...
public class CockpitP_51B extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitP_51B.this.fm != null) {
                CockpitP_51B.this.setTmp = CockpitP_51B.this.setOld;
                CockpitP_51B.this.setOld = CockpitP_51B.this.setNew;
                CockpitP_51B.this.setNew = CockpitP_51B.this.setTmp;
                CockpitP_51B.this.setNew.throttle = (0.85F * CockpitP_51B.this.setOld.throttle) + (CockpitP_51B.this.fm.CT.PowerControl * 0.15F);
                CockpitP_51B.this.setNew.prop = (0.85F * CockpitP_51B.this.setOld.prop) + (CockpitP_51B.this.fm.CT.getStepControl() * 0.15F);
                CockpitP_51B.this.setNew.stage = (0.85F * CockpitP_51B.this.setOld.stage) + (CockpitP_51B.this.fm.EI.engines[0].getControlCompressor() * 0.15F);
                CockpitP_51B.this.setNew.mix = (0.85F * CockpitP_51B.this.setOld.mix) + (CockpitP_51B.this.fm.EI.engines[0].getControlMix() * 0.15F);
                CockpitP_51B.this.setNew.altimeter = CockpitP_51B.this.fm.getAltitude();
                float f = CockpitP_51B.this.waypointAzimuth(10F);
                if (Math.abs(CockpitP_51B.this.fm.Or.getKren()) < 30F) {
                    CockpitP_51B.this.setNew.azimuth.setDeg(CockpitP_51B.this.setOld.azimuth.getDeg(1.0F), CockpitP_51B.this.fm.Or.azimut());
                }
                CockpitP_51B.this.setNew.waypointAzimuth.setDeg(CockpitP_51B.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                CockpitP_51B.this.setNew.vspeed = ((199F * CockpitP_51B.this.setOld.vspeed) + CockpitP_51B.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitP_51B() {
        super("3DO/Cockpit/P-51B/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitP_51B.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitP_51B.variometerScale), 0.0F, 0.0F);
