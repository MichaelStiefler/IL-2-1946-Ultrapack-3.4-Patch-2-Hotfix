...
public class CockpitP_51D20NTK14 extends CockpitPilot {
    class Interpolater extends com.maddox.il2.engine.InterpolateRef {

        public boolean tick() {
            if (CockpitP_51D20NTK14.this.fm != null) {
                CockpitP_51D20NTK14.this.setTmp = CockpitP_51D20NTK14.this.setOld;
                CockpitP_51D20NTK14.this.setOld = CockpitP_51D20NTK14.this.setNew;
                CockpitP_51D20NTK14.this.setNew = CockpitP_51D20NTK14.this.setTmp;
                CockpitP_51D20NTK14.this.setNew.throttle = (0.85F * CockpitP_51D20NTK14.this.setOld.throttle) + (CockpitP_51D20NTK14.this.fm.CT.PowerControl * 0.15F);
                CockpitP_51D20NTK14.this.setNew.prop = (0.85F * CockpitP_51D20NTK14.this.setOld.prop) + (CockpitP_51D20NTK14.this.fm.CT.getStepControl() * 0.15F);
                CockpitP_51D20NTK14.this.setNew.stage = (0.85F * CockpitP_51D20NTK14.this.setOld.stage) + (CockpitP_51D20NTK14.this.fm.EI.engines[0].getControlCompressor() * 0.15F);
                CockpitP_51D20NTK14.this.setNew.mix = (0.85F * CockpitP_51D20NTK14.this.setOld.mix) + (CockpitP_51D20NTK14.this.fm.EI.engines[0].getControlMix() * 0.15F);
                CockpitP_51D20NTK14.this.setNew.altimeter = CockpitP_51D20NTK14.this.fm.getAltitude();
                CockpitP_51D20NTK14.this.setNew.waypointAzimuth.setDeg(CockpitP_51D20NTK14.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitP_51D20NTK14.this.waypointAzimuth() - CockpitP_51D20NTK14.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitP_51D20NTK14.this.fm.Or.getKren()) < 30F) {
                    CockpitP_51D20NTK14.this.setNew.azimuth.setDeg(CockpitP_51D20NTK14.this.setOld.azimuth.getDeg(1.0F), CockpitP_51D20NTK14.this.fm.Or.azimut());
                }
                CockpitP_51D20NTK14.this.setNew.vspeed = ((199F * CockpitP_51D20NTK14.this.setOld.vspeed) + CockpitP_51D20NTK14.this.fm.getVertSpeed()) / 200F;
                float f = ((P_51D20NT) CockpitP_51D20NTK14.this.aircraft()).k14Distance;
                CockpitP_51D20NTK14.this.setNew.k14w = (5F * CockpitP_51D20NTK14.k14TargetWingspanScale[((P_51D20NT) CockpitP_51D20NTK14.this.aircraft()).k14WingspanType]) / f;
                CockpitP_51D20NTK14.this.setNew.k14w = (0.9F * CockpitP_51D20NTK14.this.setOld.k14w) + (0.1F * CockpitP_51D20NTK14.this.setNew.k14w);
                CockpitP_51D20NTK14.this.setNew.k14wingspan = (0.9F * CockpitP_51D20NTK14.this.setOld.k14wingspan) + (0.1F * CockpitP_51D20NTK14.k14TargetMarkScale[((P_51D20NT) CockpitP_51D20NTK14.this.aircraft()).k14WingspanType]);
                CockpitP_51D20NTK14.this.setNew.k14mode = (0.8F * CockpitP_51D20NTK14.this.setOld.k14mode) + (0.2F * ((P_51D20NT) CockpitP_51D20NTK14.this.aircraft()).k14Mode);
                Vector3d vector3d = CockpitP_51D20NTK14.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitP_51D20NTK14.this.floatindex((f - 200F) * 0.04F, CockpitP_51D20NTK14.k14BulletDrop) - CockpitP_51D20NTK14.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitP_51D20NTK14.this.setNew.k14x = (0.92F * CockpitP_51D20NTK14.this.setOld.k14x) + (0.08F * f1);
                CockpitP_51D20NTK14.this.setNew.k14y = (0.92F * CockpitP_51D20NTK14.this.setOld.k14y) + (0.08F * f2);
                if (CockpitP_51D20NTK14.this.setNew.k14x > 7F) {
                    CockpitP_51D20NTK14.this.setNew.k14x = 7F;
                }
                if (CockpitP_51D20NTK14.this.setNew.k14x < -7F) {
                    CockpitP_51D20NTK14.this.setNew.k14x = -7F;
                }
                if (CockpitP_51D20NTK14.this.setNew.k14y > 7F) {
                    CockpitP_51D20NTK14.this.setNew.k14y = 7F;
                }
                if (CockpitP_51D20NTK14.this.setNew.k14y < -7F) {
                    CockpitP_51D20NTK14.this.setNew.k14y = -7F;
                }
    ...
    public CockpitP_51D20NTK14() {
        super("3DO/Cockpit/P-51D-20NT(K14)/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        int i = ((P_51D20NT) this.aircraft()).k14Mode;
        boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitP_51D20NTK14.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitP_51D20NTK14.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Compass1", 90F + this.setNew.waypointAzimuth.getDeg(f), 0.0F, 0.0F);
