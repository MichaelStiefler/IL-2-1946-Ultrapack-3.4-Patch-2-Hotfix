...
//        if (aircraft != null) aircraft.setAcoustics(null);
    ...
    public CockpitPilot(String string, String string_1_) {
        ...
        if (string.indexOf("Bombardier") > -1) {
            this.pos.setAbs(new Point3d(0, 0, 0), new Orient(0, 0, 0));
    ...
    public void doSetSimpleUse(boolean paramBoolean) {
        ...
        if ((this.gsZN != -1.0F) && this.isSimpleUse) {
            this.ZNear(this.gsZN);
        } else if ((this.normZN != -1.0F) && !this.isSimpleUse) {
            this.ZNear(this.normZN);
        }
    }
    // TODO: --- 4.12.2 adaptations by SAS~Storebror
