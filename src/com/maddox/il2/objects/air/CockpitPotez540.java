...
public class CockpitPotez540 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitPotez540.this.fm != null) {
                CockpitPotez540.this.setTmp = CockpitPotez540.this.setOld;
                CockpitPotez540.this.setOld = CockpitPotez540.this.setNew;
                CockpitPotez540.this.setNew = CockpitPotez540.this.setTmp;
                CockpitPotez540.this.setNew.throttle1 = (0.9F * CockpitPotez540.this.setOld.throttle1) + (0.1F * CockpitPotez540.this.fm.EI.engines[0].getControlThrottle());
                CockpitPotez540.this.setNew.prop1 = (0.9F * CockpitPotez540.this.setOld.prop1) + (0.1F * CockpitPotez540.this.fm.EI.engines[0].getControlProp());
                CockpitPotez540.this.setNew.mix1 = (0.8F * CockpitPotez540.this.setOld.mix1) + (0.2F * CockpitPotez540.this.fm.EI.engines[0].getControlMix());
                CockpitPotez540.this.setNew.throttle2 = (0.9F * CockpitPotez540.this.setOld.throttle2) + (0.1F * CockpitPotez540.this.fm.EI.engines[1].getControlThrottle());
                CockpitPotez540.this.setNew.prop2 = (0.9F * CockpitPotez540.this.setOld.prop2) + (0.1F * CockpitPotez540.this.fm.EI.engines[1].getControlProp());
                CockpitPotez540.this.setNew.mix2 = (0.8F * CockpitPotez540.this.setOld.mix2) + (0.2F * CockpitPotez540.this.fm.EI.engines[1].getControlMix());
                CockpitPotez540.this.setNew.man1 = (0.92F * CockpitPotez540.this.setOld.man1) + (0.08F * CockpitPotez540.this.fm.EI.engines[0].getManifoldPressure());
                CockpitPotez540.this.setNew.man2 = (0.92F * CockpitPotez540.this.setOld.man2) + (0.08F * CockpitPotez540.this.fm.EI.engines[1].getManifoldPressure());
                CockpitPotez540.this.setNew.altimeter = CockpitPotez540.this.fm.getAltitude();
                if (Math.abs(CockpitPotez540.this.fm.Or.getKren()) < 30F) {
                    CockpitPotez540.this.setNew.azimuth.setDeg(CockpitPotez540.this.setOld.azimuth.getDeg(1.0F), CockpitPotez540.this.fm.Or.azimut());
                }
                CockpitPotez540.this.setNew.vspeed = ((199F * CockpitPotez540.this.setOld.vspeed) + CockpitPotez540.this.fm.getVertSpeed()) / 200F;
                if (CockpitPotez540.this.useRealisticNavigationInstruments()) {
                    CockpitPotez540.this.setNew.waypointAzimuth.setDeg(CockpitPotez540.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitPotez540.this.waypointAzimuth());
                } else {
                    CockpitPotez540.this.setNew.waypointAzimuth.setDeg(CockpitPotez540.this.setOld.waypointAzimuth.getDeg(1.0F), CockpitPotez540.this.fm.Or.azimut() + 90F);
                }
                CockpitPotez540.this.setNew.beaconDirection = ((10F * CockpitPotez540.this.setOld.beaconDirection) + CockpitPotez540.this.getBeaconDirection()) / 11F;
                CockpitPotez540.this.setNew.beaconRange = ((10F * CockpitPotez540.this.setOld.beaconRange) + CockpitPotez540.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public CockpitPotez540() {
        super("3DO/Cockpit/Potez540/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_ColumnbaseR", 0.0F, 0.0F, 10F * (this.pictElev = (0.85F * this.pictElev) + (0.15F * this.fm.CT.ElevatorControl)));
        ...
        this.mesh.chunkSetAngles("Z_Throtle3", 40F * this.interp(this.setNew.throttle1, this.setOld.throttle1, f), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Throtle4", 40F * this.interp(this.setNew.throttle2, this.setOld.throttle2, f), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Prop3", 75.5F * this.interp(this.setNew.prop1, this.setOld.prop1, f), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Prop4", 75.5F * this.interp(this.setNew.prop2, this.setOld.prop2, f), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Mixture3", 62.9F * this.interp(this.setNew.mix1, this.setOld.mix1, f), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Mixture4", 62.9F * this.interp(this.setNew.mix2, this.setOld.mix2, f), 0.0F, 0.0F);
        ...
        float f2 = this.floatindex(this.cvt(0.539957F * Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitPotez540.speedometerScale);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitPotez540.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitPotez540.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitPotez540.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitPotez540.rpmScale), 0.0F, 0.0F);
