...
public class CockpitPotez630 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitPotez630.this.fm != null) {
                ...
                if (Math.abs(CockpitPotez630.this.fm.Or.getKren()) < 30F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 92.59998F, 740.7998F, 0.0F, 7F), CockpitPotez630.speedometerScale), 0.0F, 0.0F);
        this.resetYPRmodifier();
        ...
        this.mesh.chunkSetAngles("Z_Ext_Air_Temp", -this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 233.09F, 333.09F, 0.0F, 5F), CockpitPotez630.frAirTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Oil1", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 110F, 0.0F, 4F), CockpitPotez630.oilTempScale), 0.0F, 0.0F);
