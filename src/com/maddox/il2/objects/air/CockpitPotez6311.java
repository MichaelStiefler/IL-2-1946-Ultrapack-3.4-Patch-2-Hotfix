...
public class CockpitPotez6311 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitPotez6311.this.fm != null) {
                CockpitPotez6311.this.setTmp = CockpitPotez6311.this.setOld;
                CockpitPotez6311.this.setOld = CockpitPotez6311.this.setNew;
                CockpitPotez6311.this.setNew = CockpitPotez6311.this.setTmp;
                CockpitPotez6311.this.setNew.throttle1 = (0.85F * CockpitPotez6311.this.setOld.throttle1) + (CockpitPotez6311.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitPotez6311.this.setNew.throttle2 = (0.85F * CockpitPotez6311.this.setOld.throttle2) + (CockpitPotez6311.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitPotez6311.this.setNew.altimeter = CockpitPotez6311.this.fm.getAltitude();
                float f = CockpitPotez6311.this.waypointAzimuth();
                CockpitPotez6311.this.setNew.waypointAzimuth.setDeg(CockpitPotez6311.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitPotez6311.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitPotez6311.this.fm.Or.getKren()) < 30F) {
                    CockpitPotez6311.this.setNew.azimuth.setDeg(CockpitPotez6311.this.setOld.azimuth.getDeg(1.0F), CockpitPotez6311.this.fm.Or.azimut());
                }
                CockpitPotez6311.this.setNew.vspeed = ((199F * CockpitPotez6311.this.setOld.vspeed) + CockpitPotez6311.this.fm.getVertSpeed()) / 200F;
                CockpitPotez6311.this.setNew.manifold = (0.8F * CockpitPotez6311.this.setOld.manifold) + (0.2F * CockpitPotez6311.this.fm.EI.engines[0].getManifoldPressure());
            }
            return true;
        }
    ...
    public CockpitPotez6311() {
        super("3DO/Cockpit/POTEZ-630P/hier2.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 92.59998F, 740.7998F, 0.0F, 7F), CockpitPotez6311.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Ext_Air_Temp", -this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 233.09F, 333.09F, 0.0F, 5F), CockpitPotez6311.frAirTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Fuel1", this.cvt(this.fm.M.fuel, 50F, 576F, 0.0F, -274F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Oil1", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 110F, 0.0F, 4F), CockpitPotez6311.oilTempScale), 0.0F, 0.0F);
