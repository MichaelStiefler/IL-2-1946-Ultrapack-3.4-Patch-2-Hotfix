...
public class CockpitR2Y1 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitR2Y1.this.fm != null) {
                CockpitR2Y1.this.setTmp = CockpitR2Y1.this.setOld;
                CockpitR2Y1.this.setOld = CockpitR2Y1.this.setNew;
                CockpitR2Y1.this.setNew = CockpitR2Y1.this.setTmp;
                CockpitR2Y1.this.setNew.throttle = (0.85F * CockpitR2Y1.this.setOld.throttle) + (CockpitR2Y1.this.fm.CT.PowerControl * 0.15F);
                CockpitR2Y1.this.setNew.prop = (0.85F * CockpitR2Y1.this.setOld.prop) + (CockpitR2Y1.this.fm.CT.getStepControl() * 0.15F);
                CockpitR2Y1.this.setNew.altimeter = CockpitR2Y1.this.fm.getAltitude();
                float f = CockpitR2Y1.this.waypointAzimuth();
                CockpitR2Y1.this.setNew.waypointAzimuth.setDeg(CockpitR2Y1.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitR2Y1.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitR2Y1.this.fm.Or.getKren()) < 30F) {
                    CockpitR2Y1.this.setNew.azimuth.setDeg(CockpitR2Y1.this.setOld.azimuth.getDeg(1.0F), CockpitR2Y1.this.fm.Or.azimut());
                }
                CockpitR2Y1.this.setNew.vspeed = ((199F * CockpitR2Y1.this.setOld.vspeed) + CockpitR2Y1.this.fm.getVertSpeed()) / 200F;
                CockpitR2Y1.this.setNew.manifold = (0.8F * CockpitR2Y1.this.setOld.manifold) + (0.2F * CockpitR2Y1.this.fm.EI.engines[0].getManifoldPressure());
                if (CockpitR2Y1.this.cockpitDimControl) {
                    if (CockpitR2Y1.this.setNew.dimPosition > 0.0F) {
                        CockpitR2Y1.this.setNew.dimPosition = CockpitR2Y1.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitR2Y1.this.setNew.dimPosition < 1.0F) {
                    CockpitR2Y1.this.setNew.dimPosition = CockpitR2Y1.this.setOld.dimPosition + 0.05F;
                }
            }
            return true;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 92.59998F, 740.7998F, 0.0F, 7F), CockpitR2Y1.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_FuelPres1", this.cvt(this.fm.M.fuel > 1.0F ? 0.32F : 0.0F, 0.0F, 1.0F, 0.0F, -278F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Oil1", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 110F, 0.0F, 4F), CockpitR2Y1.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Ext_Air_Temp", -this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 233.09F, 333.09F, 0.0F, 5F), CockpitR2Y1.frAirTempScale), 0.0F, 0.0F);
