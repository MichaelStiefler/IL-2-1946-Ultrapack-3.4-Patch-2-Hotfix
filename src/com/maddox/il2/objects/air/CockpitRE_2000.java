...
public class CockpitRE_2000 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitRE_2000.this.bNeedSetUp) {
                ...
                CockpitRE_2000.this.bNeedSetUp = false;
            }
            CockpitRE_2000.this.setTmp = CockpitRE_2000.this.setOld;
            CockpitRE_2000.this.setOld = CockpitRE_2000.this.setNew;
            CockpitRE_2000.this.setNew = CockpitRE_2000.this.setTmp;
            if (((CockpitRE_2000.this.fm.AS.astateCockpitState & 2) != 0) && (CockpitRE_2000.this.setNew.stbyPosition < 1.0F)) {
                CockpitRE_2000.this.delay--;
                if (CockpitRE_2000.this.delay <= 0) {
                    ...
                    CockpitRE_2000.this.sightDamaged = true;
                }
            }
            if (CockpitRE_2000.this.fm.CT.getRadiator() < CockpitRE_2000.this.currentRadiator) {
                CockpitRE_2000.this.radiatorDelta = -1;
            } else if (CockpitRE_2000.this.fm.CT.getRadiator() > CockpitRE_2000.this.currentRadiator) {
                CockpitRE_2000.this.radiatorDelta = 1;
            }
            if ((CockpitRE_2000.this.radiator > 1.0F) || (CockpitRE_2000.this.radiator < -1F)) {
                CockpitRE_2000.this.radiatorDelta = 0;
            }
            if (CockpitRE_2000.this.radiatorDelta != 0) {
                CockpitRE_2000.this.radiator = CockpitRE_2000.this.radiator + (CockpitRE_2000.this.radiatorDelta * 0.2F);
            } else if (CockpitRE_2000.this.currentRadiator == CockpitRE_2000.this.fm.CT.getRadiator()) {
                CockpitRE_2000.this.radiator = CockpitRE_2000.this.radiator * 0.5F;
            }
            CockpitRE_2000.this.currentRadiator = CockpitRE_2000.this.fm.CT.getRadiator();
            CockpitRE_2000.this.setNew.altimeter = CockpitRE_2000.this.fm.getAltitude();
            CockpitRE_2000.this.setNew.throttle = ((10F * CockpitRE_2000.this.setOld.throttle) + CockpitRE_2000.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitRE_2000.this.setNew.mix = ((10F * CockpitRE_2000.this.setOld.mix) + CockpitRE_2000.this.fm.EI.engines[0].getControlMix()) / 11F;
            CockpitRE_2000.this.setNew.prop = ((10F * CockpitRE_2000.this.setOld.prop) + CockpitRE_2000.this.fm.EI.engines[0].getControlProp()) / 11F;
            CockpitRE_2000.this.pictGear = (0.85F * CockpitRE_2000.this.pictGear) + (0.15F * CockpitRE_2000.this.fm.CT.GearControl);
            CockpitRE_2000.this.w.set(CockpitRE_2000.this.fm.getW());
            CockpitRE_2000.this.fm.Or.transform(CockpitRE_2000.this.w);
            CockpitRE_2000.this.setNew.turn = ((12F * CockpitRE_2000.this.setOld.turn) + CockpitRE_2000.this.w.z) / 13F;
            CockpitRE_2000.this.setNew.vspeed = ((299F * CockpitRE_2000.this.setOld.vspeed) + CockpitRE_2000.this.fm.getVertSpeed()) / 300F;
            if (CockpitRE_2000.this.flaps == CockpitRE_2000.this.fm.CT.getFlap()) {
                CockpitRE_2000.this.flapsDirection = 0;
                ...
                CockpitRE_2000.this.flaps = CockpitRE_2000.this.fm.CT.getFlap();
                CockpitRE_2000.this.flapsDirection = 1;
                CockpitRE_2000.this.flapsLeverAngle = CockpitRE_2000.this.flapsLeverAngle + CockpitRE_2000.this.flapsIncrement;
            } else if (CockpitRE_2000.this.flaps > CockpitRE_2000.this.fm.CT.getFlap()) {
                if (CockpitRE_2000.this.flapsDirection == 0) {
                    CockpitRE_2000.this.sfxStart(16);
                }
            ...
            if (!CockpitRE_2000.this.fm.Gears.bTailwheelLocked && (CockpitRE_2000.this.tailWheelLock < 1.0F)) {
                CockpitRE_2000.this.tailWheelLock = CockpitRE_2000.this.tailWheelLock + 0.1F;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (f3 < 100F) {
            f1 = this.cvt(f3, 0.0F, 100F, 0.0F, 41F);
        } else if (f3 < 200F) {
            f1 = this.cvt(f3, 100F, 200F, 41F, 110F);
        } else if (f3 < 300F) {
            f1 = this.cvt(f3, 200F, 300F, 110F, 144F);
        } else if (f3 < 400F) {
            f1 = this.cvt(f3, 300F, 400F, 144F, 212F);
        } else if (f3 < 500F) {
            f1 = this.cvt(f3, 400F, 500F, 212F, 292F);
        } else {
            f1 = this.cvt(f3, 500F, 550F, 292F, 328F);
        }
        ...
        this.mesh.chunkSetAngles("Z_need_oiltemp_01", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 150F, 0.0F, 12F), CockpitRE_2000.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_need_oiltemp_02", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilIn, 30F, 150F, 0.0F, 12F), CockpitRE_2000.oilTempScale), 0.0F, 0.0F);
        ...
        if (this.fm.EI.engines[0].tOilOut > 90F) {
            f4 = this.cvt(this.fm.EI.engines[0].tOilOut, 90F, 110F, 1.1F, 1.5F);
        } else if (this.fm.EI.engines[0].tOilOut < 50F) {
            f4 = this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 50F, 2.0F, 0.9F);
        } else {
            f4 = this.cvt(this.fm.EI.engines[0].tOilOut, 50F, 90F, 0.9F, 1.1F);
        }
        float f5 = f4 * this.fm.EI.engines[0].getReadyness() * this.oilPressure;
        this.mesh.chunkSetAngles("Z_need_oilpress", this.cvt(f5, 0.0F, 15F, 0.0F, -300F), 0.0F, 0.0F);
        ...
        if (this.fm.CT.bHasBrakeControl) {
            ...
            this.mesh.chunkSetAngles("Z_need_brakes_airpress02", -this.cvt(f2 + (f2 * this.fm.CT.getRudder()), 0.0F, 1.5F, 0.0F, 135F), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("Z_need_brakes_airpress01", this.cvt(f2 - (f2 * this.fm.CT.getRudder()), 0.0F, 1.5F, 0.0F, 135F), 0.0F, 0.0F);
            this.mesh.chunkSetAngles("Z_need_brakes_airpress03", -150F + (f2 * 20F), 0.0F, 0.0F);
            this.resetYPRmodifier();
            Cockpit.xyz[2] = -0.01F * f2;
    ...
    private void initCompass() {
        ...
        this.segLen1 = 2D * Math.sqrt(1.0D - (CockpitRE_2000.compassZ * CockpitRE_2000.compassZ));
        this.segLen2 = this.segLen1 / Math.sqrt(2D);
        this.compassLimit = -1D * Math.sin(0.01745328888888889D * CockpitRE_2000.compassLimitAngle);
    ...
    private void updateCompass() {
        ...
        if (this.accel.length() > (-CockpitRE_2000.compassZ * 0.7D)) {
            this.accel.scale((-CockpitRE_2000.compassZ * 0.7D) / this.accel.length());
        }
        for (int i = 0; i < 4; i++) {
        ...
        vector3d1.normalize();
        vector3d1.scale(-CockpitRE_2000.compassZ);
        ...
        this.mesh.chunkSetAngles("compass_base", 0.0F, -(float) ((d2 * 180D) / Math.PI), (float) ((d3 * 180D) / Math.PI));
        this.mesh.chunkSetAngles("compass_header", -(float) (90D - ((d4 * 180D) / Math.PI)), 0.0F, 0.0F);
        this.compassFirst++;
    }
