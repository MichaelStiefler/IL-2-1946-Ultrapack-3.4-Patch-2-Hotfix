...
public class CockpitR_5 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitR_5.this.fm != null) {
                CockpitR_5.this.setTmp = CockpitR_5.this.setOld;
                CockpitR_5.this.setOld = CockpitR_5.this.setNew;
                CockpitR_5.this.setNew = CockpitR_5.this.setTmp;
                CockpitR_5.this.setNew.pictElev = (0.8F * CockpitR_5.this.setOld.pictElev) + (0.2F * CockpitR_5.this.fm.CT.ElevatorControl);
                CockpitR_5.this.setNew.pictAiler = (0.8F * CockpitR_5.this.setOld.pictAiler) + (2.0F * CockpitR_5.this.fm.CT.AileronControl);
                CockpitR_5.this.setNew.pictRudd = (0.8F * CockpitR_5.this.setOld.pictRudd) + (4F * CockpitR_5.this.fm.CT.getRudder());
                CockpitR_5.this.setNew.throttle1 = (0.9F * CockpitR_5.this.setOld.throttle1) + (0.1F * CockpitR_5.this.fm.EI.engines[0].getControlThrottle());
                CockpitR_5.this.setNew.mix1 = (0.8F * CockpitR_5.this.setOld.mix1) + (0.2F * CockpitR_5.this.fm.EI.engines[0].getControlMix());
                CockpitR_5.this.setNew.altimeter = CockpitR_5.this.fm.getAltitude();
                CockpitR_5.this.w.set(CockpitR_5.this.fm.getW());
                CockpitR_5.this.fm.Or.transform(CockpitR_5.this.w);
                CockpitR_5.this.setNew.turn = ((12F * CockpitR_5.this.setOld.turn) + CockpitR_5.this.w.z) / 13F;
                if (Math.abs(CockpitR_5.this.fm.Or.getKren()) < 30F) {
                    CockpitR_5.this.setNew.azimuth.setDeg(CockpitR_5.this.setOld.azimuth.getDeg(1.0F), CockpitR_5.this.fm.Or.azimut());
                }
                CockpitR_5.this.setNew.compasTangage = (0.95F * CockpitR_5.this.setOld.compasTangage) + (0.05F * CockpitR_5.this.cvt(CockpitR_5.this.fm.Or.getTangage(), -20F, 20F, -20F, 20F));
                CockpitR_5.this.setNew.compasKren = (0.95F * CockpitR_5.this.setOld.compasKren) + (0.05F * CockpitR_5.this.cvt(CockpitR_5.this.fm.Or.getKren(), -20F, 20F, -20F, 20F));
                if (CockpitR_5.this.cockpitDimControl) {
                    if (CockpitR_5.this.setNew.dimPos < 1.0F) {
                        CockpitR_5.this.setNew.dimPos = CockpitR_5.this.setOld.dimPos + 0.05F;
                    }
                } else if (CockpitR_5.this.setNew.dimPos > 0.0F) {
                    CockpitR_5.this.setNew.dimPos = CockpitR_5.this.setOld.dimPos - 0.05F;
                }
            }
            if ((CockpitR_5.this.fm.EI.engines[0].getStage() == 1) || (CockpitR_5.this.fm.EI.engines[0].getStage() == 2)) {
                if (CockpitR_5.this.setNew.Airstartr < 1.0F) {
                    CockpitR_5.this.setNew.Airstartr = CockpitR_5.this.setOld.Airstartr + 0.1F;
                }
                if (CockpitR_5.this.setNew.Airstartr > 1.0F) {
                    CockpitR_5.this.setNew.Airstartr = 1.0F;
                }
            } else {
                if (CockpitR_5.this.setNew.Airstartr > 0.0F) {
                    CockpitR_5.this.setNew.Airstartr = CockpitR_5.this.setOld.Airstartr - 0.1F;
                }
                if (CockpitR_5.this.setNew.Airstartr < 0.0F) {
                    CockpitR_5.this.setNew.Airstartr = 0.0F;
                }
            }
            R_5xyz r_5xyz = (R_5xyz) CockpitR_5.this.aircraft();
            if (r_5xyz.getGunnerAnimation() < 1.0D) {
                CockpitR_5.this.moveGunner();
            } else {
                CockpitR_5.this.mesh.chunkSetAngles("zTurret1A", CockpitR_5.this.aircraft().FM.turret[0].tu[0], 0.0F, 0.0F);
                CockpitR_5.this.mesh.chunkSetAngles("zTurret1B", 0.0F, 0.0F, -CockpitR_5.this.aircraft().FM.turret[0].tu[1]);
                CockpitR_5.this.mesh.chunkSetAngles("zTurret1B_Flug", CockpitR_5.this.aircraft().FM.turret[0].tu[0], 0.0F, 0.0F);
            }
            return true;
        }
    ...
    private void moveGunner() {
        ...
        if (r_5xyz.getGunnerAnimation() > 0.5D) {
            ...
            this.mesh.chunkSetAngles("Pilot2_D0", 0.0F, 0.0F, 0.0F);
            this.mesh.chunkSetAngles("zTurret1A", f, 0.0F, 0.0F);
            this.mesh.chunkSetAngles("zTurret1B", -f, 0.0F, 0.0F);
            this.mesh.chunkSetAngles("zTurret1B_Flug", 0.0F, 0.0F, 0.0F);
            ...
            this.mesh.chunkVisible("Pilot2_D0", true);
            this.mesh.chunkVisible("Pilot3_D0", false);
            this.mesh.chunkSetAngles("zTurret1A", -60F, 0.0F, 0.0F);
            this.mesh.chunkSetAngles("zTurret1B", 60F, 0.0F, 0.0F);
            this.mesh.chunkSetAngles("zTurret1B_Flug", 0.0F, 0.0F, 0.0F);
        } else {
            Cockpit.xyz[0] = 0.0F;
            Cockpit.xyz[1] = 0.0F;
...
//            R_5xyz r_5xyz1 = (R_5xyz)aircraft();
        ...
        this.mesh.chunkSetAngles("zArr_Speed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 60F, 400F, 0.0F, 17F), CockpitR_5.IAS_Scale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zArr_RPM", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 400F, 2200F, 0.0F, 9F), CockpitR_5.RPM_Scale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zArr_OilTemp", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 125F, 0.0F, 17F), CockpitR_5.Oil_Scale), 0.0F);
    ...
    static {
        Property.set(CockpitR_5.class, "normZNs", new float[] { 1.9F, 0.7F, 0.7F, 0.7F });
    }
