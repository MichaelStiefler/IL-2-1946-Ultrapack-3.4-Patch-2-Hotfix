...
public class CockpitRo43 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitRo43.this.fm != null) {
                CockpitRo43.this.setTmp = CockpitRo43.this.setOld;
                CockpitRo43.this.setOld = CockpitRo43.this.setNew;
                CockpitRo43.this.setNew = CockpitRo43.this.setTmp;
                CockpitRo43.this.setNew.throttle = (0.92F * CockpitRo43.this.setOld.throttle) + (0.08F * CockpitRo43.this.fm.CT.PowerControl);
                CockpitRo43.this.setNew.prop = (0.92F * CockpitRo43.this.setOld.prop) + (0.08F * CockpitRo43.this.fm.EI.engines[0].getControlProp());
                CockpitRo43.this.setNew.mix = (0.92F * CockpitRo43.this.setOld.mix) + (0.08F * CockpitRo43.this.fm.EI.engines[0].getControlMix());
                CockpitRo43.this.setNew.altimeter = CockpitRo43.this.fm.getAltitude();
                CockpitRo43.this.setNew.waypointAzimuth.setDeg(CockpitRo43.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitRo43.this.waypointAzimuth() - CockpitRo43.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitRo43.this.fm.Or.getKren()) < 30F) {
                    CockpitRo43.this.setNew.azimuth.setDeg(CockpitRo43.this.setOld.azimuth.getDeg(1.0F), CockpitRo43.this.fm.Or.azimut());
                }
                CockpitRo43.this.setNew.vspeed = (0.99F * CockpitRo43.this.setOld.vspeed) + (0.01F * CockpitRo43.this.fm.getVertSpeed());
                if (CockpitRo43.this.fm.CT.GearControl < 0.5F) {
                    if (CockpitRo43.this.setNew.gearPhi > 0.0F) {
                        CockpitRo43.this.setNew.gearPhi = CockpitRo43.this.setOld.gearPhi - 0.021F;
                    }
                } else if (CockpitRo43.this.setNew.gearPhi < 1.0F) {
                    CockpitRo43.this.setNew.gearPhi = CockpitRo43.this.setOld.gearPhi + 0.021F;
                }
            }
            return true;
    ...
    public CockpitRo43() {
        super("3DO/Cockpit/Ro43/hierS.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 885.1392F, 0.0F, 11F), CockpitRo43.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_VY", -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitRo43.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 5000F, 0.0F, 10F), CockpitRo43.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, -306F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitRo43.radScale), 0.0F, 0.0F);
