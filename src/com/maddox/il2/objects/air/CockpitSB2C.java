...
public class CockpitSB2C extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitSB2C.this.fm != null) {
                CockpitSB2C.this.setTmp = CockpitSB2C.this.setOld;
                CockpitSB2C.this.setOld = CockpitSB2C.this.setNew;
                CockpitSB2C.this.setNew = CockpitSB2C.this.setTmp;
                CockpitSB2C.this.setNew.throttle = (0.85F * CockpitSB2C.this.setOld.throttle) + (CockpitSB2C.this.fm.CT.PowerControl * 0.15F);
                CockpitSB2C.this.setNew.prop = (0.85F * CockpitSB2C.this.setOld.prop) + (CockpitSB2C.this.fm.CT.getStepControl() * 0.15F);
                CockpitSB2C.this.setNew.altimeter = CockpitSB2C.this.fm.getAltitude();
                float f = CockpitSB2C.this.waypointAzimuth();
                if (Math.abs(CockpitSB2C.this.fm.Or.getKren()) < 30F) {
                    CockpitSB2C.this.setNew.azimuth.setDeg(CockpitSB2C.this.setOld.azimuth.getDeg(1.0F), CockpitSB2C.this.fm.Or.azimut());
                }
                CockpitSB2C.this.setNew.waypointAzimuth.setDeg(CockpitSB2C.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitSB2C.this.setNew.vspeed = ((199F * CockpitSB2C.this.setOld.vspeed) + CockpitSB2C.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitSB2C() {
        super("3DO/Cockpit/SB2C/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 796.3598F, 0.0F, 11F), CockpitSB2C.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitSB2C.variometerScale), 0.0F);
