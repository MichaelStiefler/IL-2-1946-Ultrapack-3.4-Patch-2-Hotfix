...
public class CockpitSBD3 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitSBD3.this.fm != null) {
                CockpitSBD3.this.setTmp = CockpitSBD3.this.setOld;
                CockpitSBD3.this.setOld = CockpitSBD3.this.setNew;
                CockpitSBD3.this.setNew = CockpitSBD3.this.setTmp;
                ...
                if (Math.abs(CockpitSBD3.this.fm.Or.getKren()) < 30F) {
                    CockpitSBD3.this.setNew.azimuth.setDeg(CockpitSBD3.this.setOld.azimuth.getDeg(1.0F), CockpitSBD3.this.fm.Or.azimut());
                }
                CockpitSBD3.this.setNew.vspeed = ((399F * CockpitSBD3.this.setOld.vspeed) + CockpitSBD3.this.fm.getVertSpeed()) / 400F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 925.9998F, 0.0F, 10F), CockpitSBD3.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.setNew.vspeed < 0.0F ? this.floatindex(this.cvt(-this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitSBD3.variometerScale) : -this.floatindex(this.cvt(this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitSBD3.variometerScale), 0.0F);
