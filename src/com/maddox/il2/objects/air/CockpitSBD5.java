...
public class CockpitSBD5 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitSBD5.this.fm != null) {
                CockpitSBD5.this.setTmp = CockpitSBD5.this.setOld;
                CockpitSBD5.this.setOld = CockpitSBD5.this.setNew;
                CockpitSBD5.this.setNew = CockpitSBD5.this.setTmp;
                CockpitSBD5.this.setNew.flaps = (0.9F * CockpitSBD5.this.setOld.flaps) + (0.1F * CockpitSBD5.this.fm.CT.FlapsControl);
                CockpitSBD5.this.setNew.gear = (0.7F * CockpitSBD5.this.setOld.gear) + (0.3F * CockpitSBD5.this.fm.CT.GearControl);
                CockpitSBD5.this.setNew.throttle = (0.8F * CockpitSBD5.this.setOld.throttle) + (0.2F * CockpitSBD5.this.fm.CT.PowerControl);
                CockpitSBD5.this.setNew.prop = (0.8F * CockpitSBD5.this.setOld.prop) + (0.2F * CockpitSBD5.this.fm.EI.engines[0].getControlProp());
                CockpitSBD5.this.setNew.mix = (0.8F * CockpitSBD5.this.setOld.mix) + (0.2F * CockpitSBD5.this.fm.EI.engines[0].getControlMix());
                CockpitSBD5.this.setNew.divebrake = (0.8F * CockpitSBD5.this.setOld.divebrake) + (0.2F * CockpitSBD5.this.fm.CT.AirBrakeControl);
                CockpitSBD5.this.setNew.man = (0.92F * CockpitSBD5.this.setOld.man) + (0.08F * CockpitSBD5.this.fm.EI.engines[0].getManifoldPressure());
                CockpitSBD5.this.setNew.altimeter = CockpitSBD5.this.fm.getAltitude();
                if (Math.abs(CockpitSBD5.this.fm.Or.getKren()) < 30F) {
                    CockpitSBD5.this.setNew.azimuth.setDeg(CockpitSBD5.this.setOld.azimuth.getDeg(1.0F), CockpitSBD5.this.fm.Or.azimut());
                }
                CockpitSBD5.this.setNew.vspeed = ((399F * CockpitSBD5.this.setOld.vspeed) + CockpitSBD5.this.fm.getVertSpeed()) / 400F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 925.9998F, 0.0F, 10F), CockpitSBD5.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.setNew.vspeed < 0.0F ? this.floatindex(this.cvt(-this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitSBD5.variometerScale) : -this.floatindex(this.cvt(this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitSBD5.variometerScale), 0.0F);
