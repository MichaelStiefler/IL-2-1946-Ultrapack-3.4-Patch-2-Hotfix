...
public class CockpitSB_2M103 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitSB_2M103.this.fm != null) {
                CockpitSB_2M103.this.setTmp = CockpitSB_2M103.this.setOld;
                CockpitSB_2M103.this.setOld = CockpitSB_2M103.this.setNew;
                CockpitSB_2M103.this.setNew = CockpitSB_2M103.this.setTmp;
                if (CockpitSB_2M103.this.fm.CT.Weapons[3] != null) {
                    if (CockpitSB_2M103.this.fm.CT.Weapons[3].length > 0) {
                        CockpitSB_2M103.this.bBombs[1] = !CockpitSB_2M103.this.fm.CT.Weapons[3][0].haveBullets();
                    }
                    if (CockpitSB_2M103.this.fm.CT.Weapons[3].length > 1) {
                        CockpitSB_2M103.this.bBombs[0] = !CockpitSB_2M103.this.fm.CT.Weapons[3][1].haveBullets();
                    }
                    if (CockpitSB_2M103.this.fm.CT.Weapons[3].length > 2) {
                        CockpitSB_2M103.this.bBombs[3] = !CockpitSB_2M103.this.fm.CT.Weapons[3][2].haveBullets();
                    }
                    if (CockpitSB_2M103.this.fm.CT.Weapons[3].length > 3) {
                        CockpitSB_2M103.this.bBombs[2] = !CockpitSB_2M103.this.fm.CT.Weapons[3][3].haveBullets();
                    }
                    if (CockpitSB_2M103.this.fm.CT.Weapons[3].length > 4) {
                        CockpitSB_2M103.this.bBombs[5] = !CockpitSB_2M103.this.fm.CT.Weapons[3][4].haveBullets();
                    }
                    if (CockpitSB_2M103.this.fm.CT.Weapons[3].length > 5) {
                        CockpitSB_2M103.this.bBombs[4] = !CockpitSB_2M103.this.fm.CT.Weapons[3][5].haveBullets();
                    }
                    if (CockpitSB_2M103.this.fm.CT.Weapons[3].length > 6) {
                        CockpitSB_2M103.this.bBombs[5] = CockpitSB_2M103.this.bBombs[5] || !CockpitSB_2M103.this.fm.CT.Weapons[3][6].haveBullets();
                    }
                    if (CockpitSB_2M103.this.fm.CT.Weapons[3].length > 7) {
                        CockpitSB_2M103.this.bBombs[4] = CockpitSB_2M103.this.bBombs[4] || !CockpitSB_2M103.this.fm.CT.Weapons[3][7].haveBullets();
                    }
                    if (CockpitSB_2M103.this.fm.CT.Weapons[3].length > 8) {
                        CockpitSB_2M103.this.bBombs[7] = !CockpitSB_2M103.this.fm.CT.Weapons[3][8].haveBullets();
                    }
                    if (CockpitSB_2M103.this.fm.CT.Weapons[3].length > 9) {
                        CockpitSB_2M103.this.bBombs[6] = !CockpitSB_2M103.this.fm.CT.Weapons[3][9].haveBullets();
                    }
                }
                CockpitSB_2M103.this.setNew.throttle1 = (0.9F * CockpitSB_2M103.this.setOld.throttle1) + (0.1F * CockpitSB_2M103.this.fm.EI.engines[0].getControlThrottle());
                CockpitSB_2M103.this.setNew.prop1 = (0.9F * CockpitSB_2M103.this.setOld.prop1) + (0.1F * CockpitSB_2M103.this.fm.EI.engines[0].getControlProp());
                CockpitSB_2M103.this.setNew.mix1 = (0.8F * CockpitSB_2M103.this.setOld.mix1) + (0.2F * CockpitSB_2M103.this.fm.EI.engines[0].getControlMix());
                CockpitSB_2M103.this.setNew.man1 = (0.92F * CockpitSB_2M103.this.setOld.man1) + (0.08F * CockpitSB_2M103.this.fm.EI.engines[0].getManifoldPressure());
                CockpitSB_2M103.this.setNew.throttle2 = (0.9F * CockpitSB_2M103.this.setOld.throttle2) + (0.1F * CockpitSB_2M103.this.fm.EI.engines[1].getControlThrottle());
                CockpitSB_2M103.this.setNew.prop2 = (0.9F * CockpitSB_2M103.this.setOld.prop2) + (0.1F * CockpitSB_2M103.this.fm.EI.engines[1].getControlProp());
                CockpitSB_2M103.this.setNew.mix2 = (0.8F * CockpitSB_2M103.this.setOld.mix2) + (0.2F * CockpitSB_2M103.this.fm.EI.engines[1].getControlMix());
                CockpitSB_2M103.this.setNew.man2 = (0.92F * CockpitSB_2M103.this.setOld.man2) + (0.08F * CockpitSB_2M103.this.fm.EI.engines[1].getManifoldPressure());
                CockpitSB_2M103.this.setNew.altimeter = CockpitSB_2M103.this.fm.getAltitude();
                if (Math.abs(CockpitSB_2M103.this.fm.Or.getKren()) < 30F) {
                    CockpitSB_2M103.this.setNew.azimuth.setDeg(CockpitSB_2M103.this.setOld.azimuth.getDeg(1.0F), CockpitSB_2M103.this.fm.Or.azimut());
                }
                CockpitSB_2M103.this.setNew.vspeed = ((100F * CockpitSB_2M103.this.setOld.vspeed) + CockpitSB_2M103.this.fm.getVertSpeed()) / 101F;
                float f = CockpitSB_2M103.this.waypointAzimuth();
                CockpitSB_2M103.this.setNew.waypointAzimuth.setDeg(CockpitSB_2M103.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitSB_2M103.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitSB_2M103.this.setNew.waypointDirection.setDeg(CockpitSB_2M103.this.setOld.waypointDirection.getDeg(1.0F), f);
                CockpitSB_2M103.this.mesh.chunkSetAngles("Z_RTurret", CockpitSB_2M103.this.aircraft().FM.turret[0].tu[0], 0.0F, 0.0F);
                CockpitSB_2M103.this.mesh.chunkSetAngles("Z_RGun", -CockpitSB_2M103.this.aircraft().FM.turret[0].tu[1], 0.0F, 0.0F);
                CockpitSB_2M103.this.setNew.inert = (0.999F * CockpitSB_2M103.this.setOld.inert) + (0.001F * (CockpitSB_2M103.this.fm.EI.engines[0].getStage() != 6 ? 0.0F : 0.867F));
            }
            return true;
        }
    ...
    public CockpitSB_2M103() {
        super("3DO/Cockpit/Pe-3bis/CockpitSB2M103.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitSB_2M103.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitSB_2M103.speedometerScale), 0.0F, 0.0F);
        this.resetYPRmodifier();
