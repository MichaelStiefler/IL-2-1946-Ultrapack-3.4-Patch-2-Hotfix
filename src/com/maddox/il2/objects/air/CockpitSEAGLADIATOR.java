...
public class CockpitSEAGLADIATOR extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitSEAGLADIATOR.this.bNeedSetUp) {
                CockpitSEAGLADIATOR.this.reflectPlaneMats();
                CockpitSEAGLADIATOR.this.bNeedSetUp = false;
            }
            if (((SEAGLADIATOR2) CockpitSEAGLADIATOR.this.aircraft()).bChangedPit) {
                CockpitSEAGLADIATOR.this.reflectPlaneToModel();
                ((SEAGLADIATOR2) CockpitSEAGLADIATOR.this.aircraft()).bChangedPit = false;
            }
            CockpitSEAGLADIATOR.this.setTmp = CockpitSEAGLADIATOR.this.setOld;
            CockpitSEAGLADIATOR.this.setOld = CockpitSEAGLADIATOR.this.setNew;
            CockpitSEAGLADIATOR.this.setNew = CockpitSEAGLADIATOR.this.setTmp;
            if (((CockpitSEAGLADIATOR.this.fm.AS.astateCockpitState & 2) != 0) && (CockpitSEAGLADIATOR.this.setNew.stbyPosition < 1.0F)) {
                CockpitSEAGLADIATOR.this.setNew.stbyPosition = CockpitSEAGLADIATOR.this.setOld.stbyPosition + 0.0125F;
                CockpitSEAGLADIATOR.this.setOld.stbyPosition = CockpitSEAGLADIATOR.this.setNew.stbyPosition;
            }
            CockpitSEAGLADIATOR.this.setNew.altimeter = CockpitSEAGLADIATOR.this.fm.getAltitude();
            if (Math.abs(CockpitSEAGLADIATOR.this.fm.Or.getKren()) < 30F) {
                CockpitSEAGLADIATOR.this.setNew.azimuth.setDeg(CockpitSEAGLADIATOR.this.setOld.azimuth.getDeg(1.0F), CockpitSEAGLADIATOR.this.fm.Or.azimut());
            }
            CockpitSEAGLADIATOR.this.setNew.throttle = ((10F * CockpitSEAGLADIATOR.this.setOld.throttle) + CockpitSEAGLADIATOR.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            CockpitSEAGLADIATOR.this.setNew.mix = ((10F * CockpitSEAGLADIATOR.this.setOld.mix) + CockpitSEAGLADIATOR.this.fm.EI.engines[0].getControlMix()) / 11F;
            CockpitSEAGLADIATOR.this.setNew.prop = CockpitSEAGLADIATOR.this.setOld.prop;
            if (CockpitSEAGLADIATOR.this.setNew.prop < (CockpitSEAGLADIATOR.this.fm.EI.engines[0].getControlProp() - 0.01F)) {
                CockpitSEAGLADIATOR.this.setNew.prop += 0.0025F;
            }
            if (CockpitSEAGLADIATOR.this.setNew.prop > (CockpitSEAGLADIATOR.this.fm.EI.engines[0].getControlProp() + 0.01F)) {
                CockpitSEAGLADIATOR.this.setNew.prop -= 0.0025F;
            }
            CockpitSEAGLADIATOR.this.w.set(CockpitSEAGLADIATOR.this.fm.getW());
            CockpitSEAGLADIATOR.this.fm.Or.transform(CockpitSEAGLADIATOR.this.w);
            CockpitSEAGLADIATOR.this.setNew.turn = ((12F * CockpitSEAGLADIATOR.this.setOld.turn) + CockpitSEAGLADIATOR.this.w.z) / 13F;
            CockpitSEAGLADIATOR.this.setNew.vspeed = ((199F * CockpitSEAGLADIATOR.this.setOld.vspeed) + CockpitSEAGLADIATOR.this.fm.getVertSpeed()) / 200F;
            CockpitSEAGLADIATOR.this.pictSupc = (0.8F * CockpitSEAGLADIATOR.this.pictSupc) + (0.2F * CockpitSEAGLADIATOR.this.fm.EI.engines[0].getControlCompressor());
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (((SEAGLADIATOR2) this.aircraft()).bChangedPit) {
            this.reflectPlaneToModel();
            ((SEAGLADIATOR2) this.aircraft()).bChangedPit = false;
        }
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 180.0555F, 0.0F, 35F), CockpitSEAGLADIATOR.speedometerScale));
