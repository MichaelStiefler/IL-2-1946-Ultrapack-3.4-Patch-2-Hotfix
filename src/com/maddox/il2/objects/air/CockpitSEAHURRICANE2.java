...
public class CockpitSEAHURRICANE2 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitSEAHURRICANE2.this.bNeedSetUp) {
                CockpitSEAHURRICANE2.this.reflectPlaneMats();
                CockpitSEAHURRICANE2.this.bNeedSetUp = false;
            }
            if (CockpitSEAHURRICANE2.this.fm != null) {
                CockpitSEAHURRICANE2.this.setTmp = CockpitSEAHURRICANE2.this.setOld;
                CockpitSEAHURRICANE2.this.setOld = CockpitSEAHURRICANE2.this.setNew;
                CockpitSEAHURRICANE2.this.setNew = CockpitSEAHURRICANE2.this.setTmp;
                CockpitSEAHURRICANE2.this.setNew.throttle = ((10F * CockpitSEAHURRICANE2.this.setOld.throttle) + CockpitSEAHURRICANE2.this.fm.CT.PowerControl) / 11F;
                CockpitSEAHURRICANE2.this.setNew.altimeter = CockpitSEAHURRICANE2.this.fm.getAltitude();
                CockpitSEAHURRICANE2.this.setNew.waypointAzimuth.setDeg(CockpitSEAHURRICANE2.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitSEAHURRICANE2.this.waypointAzimuth() - CockpitSEAHURRICANE2.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitSEAHURRICANE2.this.fm.Or.getKren()) < 30F) {
                    CockpitSEAHURRICANE2.this.setNew.azimuth.setDeg(CockpitSEAHURRICANE2.this.setOld.azimuth.getDeg(1.0F), CockpitSEAHURRICANE2.this.fm.Or.azimut());
                }
                CockpitSEAHURRICANE2.this.setNew.vspeed = ((199F * CockpitSEAHURRICANE2.this.setOld.vspeed) + CockpitSEAHURRICANE2.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitSEAHURRICANE2.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 100F, 0.0F, 270F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitSEAHURRICANE2.radScale));
        this.resetYPRmodifier();
        ...
        if (this.bFAF) {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 143.0528F, 0.0F, 32F), CockpitSEAHURRICANE2.speedometerScaleFAF));
        } else {
            this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 180.0555F, 0.0F, 35F), CockpitSEAHURRICANE2.speedometerScale));
        }
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitSEAHURRICANE2.variometerScale));
