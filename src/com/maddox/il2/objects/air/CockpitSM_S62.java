...
public class CockpitSM_S62 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitSM_S62.this.fm != null) {
                CockpitSM_S62.this.setTmp = CockpitSM_S62.this.setOld;
                CockpitSM_S62.this.setOld = CockpitSM_S62.this.setNew;
                CockpitSM_S62.this.setNew = CockpitSM_S62.this.setTmp;
                CockpitSM_S62.this.setNew.throttle1 = (0.85F * CockpitSM_S62.this.setOld.throttle1) + (CockpitSM_S62.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitSM_S62.this.setNew.prop1 = (0.85F * CockpitSM_S62.this.setOld.prop1) + (CockpitSM_S62.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitSM_S62.this.setNew.altimeter = CockpitSM_S62.this.fm.getAltitude();
                float f = CockpitSM_S62.this.waypointAzimuth();
                if (Math.abs(CockpitSM_S62.this.fm.Or.getKren()) < 30F) {
                    CockpitSM_S62.this.setNew.azimuth.setDeg(CockpitSM_S62.this.setOld.azimuth.getDeg(1.0F), CockpitSM_S62.this.fm.Or.azimut());
                }
                CockpitSM_S62.this.setNew.waypointAzimuth.setDeg(CockpitSM_S62.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitSM_S62.this.setNew.waypointDeviation.setDeg(CockpitSM_S62.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitSM_S62.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitSM_S62.this.setNew.vspeed = ((199F * CockpitSM_S62.this.setOld.vspeed) + CockpitSM_S62.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitSM_S62() {
        super("3DO/Cockpit/SM_S62/CockpitSM_S62.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitSM_S62.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitSM_S62.speedometerScale), 0.0F);
