...
public class CockpitSNJ extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitSNJ.this.fm != null) {
                CockpitSNJ.this.setTmp = CockpitSNJ.this.setOld;
                CockpitSNJ.this.setOld = CockpitSNJ.this.setNew;
                CockpitSNJ.this.setNew = CockpitSNJ.this.setTmp;
                CockpitSNJ.this.setNew.flaps = (0.9F * CockpitSNJ.this.setOld.flaps) + (0.1F * CockpitSNJ.this.fm.CT.FlapsControl);
                CockpitSNJ.this.setNew.gear = (0.7F * CockpitSNJ.this.setOld.gear) + (0.3F * CockpitSNJ.this.fm.CT.GearControl);
                CockpitSNJ.this.setNew.throttle = (0.8F * CockpitSNJ.this.setOld.throttle) + (0.2F * CockpitSNJ.this.fm.CT.PowerControl);
                CockpitSNJ.this.setNew.prop = (0.8F * CockpitSNJ.this.setOld.prop) + (0.2F * CockpitSNJ.this.fm.EI.engines[0].getControlProp());
                CockpitSNJ.this.setNew.mix = (0.8F * CockpitSNJ.this.setOld.mix) + (0.2F * CockpitSNJ.this.fm.EI.engines[0].getControlMix());
                CockpitSNJ.this.setNew.divebrake = (0.8F * CockpitSNJ.this.setOld.divebrake) + (0.2F * CockpitSNJ.this.fm.CT.AirBrakeControl);
                CockpitSNJ.this.setNew.man = (0.92F * CockpitSNJ.this.setOld.man) + (0.08F * CockpitSNJ.this.fm.EI.engines[0].getManifoldPressure());
                CockpitSNJ.this.setNew.altimeter = CockpitSNJ.this.fm.getAltitude();
                if (Math.abs(CockpitSNJ.this.fm.Or.getKren()) < 30F) {
                    CockpitSNJ.this.setNew.azimuth.setDeg(CockpitSNJ.this.setOld.azimuth.getDeg(1.0F), CockpitSNJ.this.fm.Or.azimut());
                }
                CockpitSNJ.this.setNew.vspeed = ((399F * CockpitSNJ.this.setOld.vspeed) + CockpitSNJ.this.fm.getVertSpeed()) / 400F;
            }
            return true;
        }
    ...
    public CockpitSNJ() {
        super("3DO/Cockpit/SNJ/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 925.9998F, 0.0F, 10F), CockpitSNJ.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.setNew.vspeed >= 0.0F ? -this.floatindex(this.cvt(this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitSNJ.variometerScale) : this.floatindex(this.cvt(-this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitSNJ.variometerScale), 0.0F);
