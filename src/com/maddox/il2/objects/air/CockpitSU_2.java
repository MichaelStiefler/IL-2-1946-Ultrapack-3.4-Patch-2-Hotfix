...
public class CockpitSU_2 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitSU_2.this.fm != null) {
                ...
                CockpitSU_2.this.setNew.prop = ((10F * CockpitSU_2.this.setOld.prop) + CockpitSU_2.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitSU_2.this.setNew.altimeter = CockpitSU_2.this.fm.getAltitude();
                if (Math.abs(CockpitSU_2.this.fm.Or.getKren()) < 30F) {
                    CockpitSU_2.this.setNew.azimuth.setDeg(CockpitSU_2.this.setOld.azimuth.getDeg(1.0F), CockpitSU_2.this.fm.Or.azimut());
                }
                CockpitSU_2.this.setNew.vspeed = ((199F * CockpitSU_2.this.setOld.vspeed) + CockpitSU_2.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitSU_2.speedometerScale), 0.0F);
