...
public class CockpitS_199 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            CockpitS_199.this.setTmp = CockpitS_199.this.setOld;
            CockpitS_199.this.setOld = CockpitS_199.this.setNew;
            CockpitS_199.this.setNew = CockpitS_199.this.setTmp;
            CockpitS_199.this.setNew.altimeter = CockpitS_199.this.fm.getAltitude();
            if (CockpitS_199.this.cockpitDimControl) {
                if (CockpitS_199.this.setNew.dimPosition > 0.0F) {
                    CockpitS_199.this.setNew.dimPosition = CockpitS_199.this.setOld.dimPosition - 0.05F;
                }
            } else if (CockpitS_199.this.setNew.dimPosition < 1.0F) {
                CockpitS_199.this.setNew.dimPosition = CockpitS_199.this.setOld.dimPosition + 0.05F;
            }
            CockpitS_199.this.setNew.throttle = ((10F * CockpitS_199.this.setOld.throttle) + CockpitS_199.this.fm.CT.PowerControl) / 11F;
            CockpitS_199.this.setNew.mix = ((8F * CockpitS_199.this.setOld.mix) + CockpitS_199.this.fm.EI.engines[0].getControlMix()) / 9F;
            float f = CockpitS_199.this.waypointAzimuth();
            if (CockpitS_199.this.useRealisticNavigationInstruments()) {
                CockpitS_199.this.setNew.waypointAzimuth.setDeg(f - 90F);
                CockpitS_199.this.setOld.waypointAzimuth.setDeg(f - 90F);
            } else {
                CockpitS_199.this.setNew.waypointAzimuth.setDeg(CockpitS_199.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitS_199.this.setOld.azimuth.getDeg(1.0F));
            }
            if (Math.abs(CockpitS_199.this.fm.Or.getKren()) < 30F) {
                CockpitS_199.this.setNew.azimuth.setDeg(CockpitS_199.this.setOld.azimuth.getDeg(1.0F), CockpitS_199.this.fm.Or.azimut());
            }
            CockpitS_199.this.w.set(CockpitS_199.this.fm.getW());
            CockpitS_199.this.fm.Or.transform(CockpitS_199.this.w);
            CockpitS_199.this.setNew.turn = ((12F * CockpitS_199.this.setOld.turn) + ((Tuple3f) CockpitS_199.this.w).z) / 13F;
            CockpitS_199.this.buzzerFX((CockpitS_199.this.fm.CT.getGear() < 0.999999F) && (CockpitS_199.this.fm.CT.getFlap() > 0.0F));
            CockpitS_199.this.setNew.beaconDirection = ((10F * CockpitS_199.this.setOld.beaconDirection) + CockpitS_199.this.getBeaconDirection()) / 11F;
            CockpitS_199.this.setNew.beaconRange = ((10F * CockpitS_199.this.setOld.beaconRange) + CockpitS_199.this.getBeaconRange()) / 11F;
            return true;
        }
    ...
    public CockpitS_199() {
        super("3DO/Cockpit/S-199/hier.him", "bf109");
        this.gun = new Gun[3];
        this.hasCanopy = true;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) ((Tuple3d) this.fm.Loc).z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitS_199.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitS_199.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), CockpitS_199.fuelScale), 0.0F, 0.0F);
...
//        if ((this.fm.AS.astateCockpitState & 0x20) == 0);
    ...
    static {
        Property.set(CockpitS_199.class, "normZN", 0.5F);
        Property.set(CockpitS_199.class, "gsZN", 0.5F);
    }
