...
public class CockpitSea2 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitSea2.this.fm != null) {
                CockpitSea2.this.setTmp = CockpitSea2.this.setOld;
                CockpitSea2.this.setOld = CockpitSea2.this.setNew;
                CockpitSea2.this.setNew = CockpitSea2.this.setTmp;
                CockpitSea2.this.setNew.throttle = (0.92F * CockpitSea2.this.setOld.throttle) + (0.08F * CockpitSea2.this.fm.CT.PowerControl);
                CockpitSea2.this.setNew.prop = (0.92F * CockpitSea2.this.setOld.prop) + (0.08F * CockpitSea2.this.fm.EI.engines[0].getControlProp());
                CockpitSea2.this.setNew.mix = (0.92F * CockpitSea2.this.setOld.mix) + (0.08F * CockpitSea2.this.fm.EI.engines[0].getControlMix());
                CockpitSea2.this.setNew.altimeter = CockpitSea2.this.fm.getAltitude();
                CockpitSea2.this.setNew.waypointAzimuth.setDeg(CockpitSea2.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitSea2.this.waypointAzimuth() - CockpitSea2.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitSea2.this.fm.Or.getKren()) < 30F) {
                    CockpitSea2.this.setNew.azimuth.setDeg(CockpitSea2.this.setOld.azimuth.getDeg(1.0F), CockpitSea2.this.fm.Or.azimut());
                }
                CockpitSea2.this.setNew.vspeed = (0.99F * CockpitSea2.this.setOld.vspeed) + (0.01F * CockpitSea2.this.fm.getVertSpeed());
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.aircraft() instanceof SEAFIRE1) {
            if (SEAFIRE1.bChangedPit) {
                this.reflectPlaneToModel();
                SEAFIRE1.bChangedPit = false;
            }
        } else if (this.aircraft() instanceof SEAFIRE2C) {
            if (SEAFIRE2C.bChangedPit) {
                this.reflectPlaneToModel();
                SEAFIRE2C.bChangedPit = false;
            }
        } else if (this.aircraft() instanceof SEAFIRE2C4) {
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitSea2.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 50F, 100F, 0.0F, 271F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitSea2.radScale));
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 25F), CockpitSea2.speedometerScale));
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitSea2.variometerScale));
