...
public class CockpitSea3 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitSea3.this.fm != null) {
                CockpitSea3.this.setTmp = CockpitSea3.this.setOld;
                CockpitSea3.this.setOld = CockpitSea3.this.setNew;
                CockpitSea3.this.setNew = CockpitSea3.this.setTmp;
                ...
                CockpitSea3.this.setNew.waypointAzimuth.setDeg(CockpitSea3.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitSea3.this.waypointAzimuth() - CockpitSea3.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitSea3.this.fm.Or.getKren()) < 30F) {
                    CockpitSea3.this.setNew.azimuth.setDeg(CockpitSea3.this.setOld.azimuth.getDeg(1.0F), CockpitSea3.this.fm.Or.azimut());
                }
    ...
    public CockpitSea3() {
        ...
        if (this.aircraft() instanceof SEAFIRE3F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (this.aircraft() instanceof SEAFIRE3) {
            if (SEAFIRE3.bChangedPit) {
                this.reflectPlaneToModel();
                SEAFIRE3.bChangedPit = false;
            }
        } else if (this.aircraft() instanceof SEAFIRE3F) {
            if (SEAFIRE3F.bChangedPit) {
                this.reflectPlaneToModel();
                SEAFIRE3F.bChangedPit = false;
            }
        }
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitSea3.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 50F, 100F, 0.0F, 271F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitSea3.radScale));
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 25F), CockpitSea3.speedometerScale));
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitSea3.variometerScale));
