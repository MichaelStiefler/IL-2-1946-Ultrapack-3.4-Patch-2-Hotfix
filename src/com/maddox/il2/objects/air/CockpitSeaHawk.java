...
public class CockpitSeaHawk extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitSeaHawk.this.fm != null) {
                CockpitSeaHawk.this.setTmp = CockpitSeaHawk.this.setOld;
                CockpitSeaHawk.this.setOld = CockpitSeaHawk.this.setNew;
                CockpitSeaHawk.this.setNew = CockpitSeaHawk.this.setTmp;
                CockpitSeaHawk.this.setNew.throttle = (0.9F * CockpitSeaHawk.this.setOld.throttle) + (CockpitSeaHawk.this.fm.CT.PowerControl * 0.1F);
                CockpitSeaHawk.this.setNew.altimeter = CockpitSeaHawk.this.fm.getAltitude();
                CockpitSeaHawk.this.setNew.waypointAzimuth.setDeg(CockpitSeaHawk.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitSeaHawk.this.waypointAzimuth() - CockpitSeaHawk.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitSeaHawk.this.fm.Or.getKren()) < 30F) {
                    CockpitSeaHawk.this.setNew.azimuth.setDeg(CockpitSeaHawk.this.setOld.azimuth.getDeg(1.0F), CockpitSeaHawk.this.fm.Or.azimut());
                }
                CockpitSeaHawk.this.setNew.vspeed = ((199F * CockpitSeaHawk.this.setOld.vspeed) + CockpitSeaHawk.this.fm.getVertSpeed()) / 200F;
                if (CockpitSeaHawk.this.fm.CT.arrestorControl <= 0.5F) {
                    if (CockpitSeaHawk.this.setNew.stbyPosition > 0.0F) {
                        CockpitSeaHawk.this.setNew.stbyPosition = CockpitSeaHawk.this.setOld.stbyPosition - 0.05F;
                    }
                } else if (CockpitSeaHawk.this.setNew.stbyPosition < 1.0F) {
                    CockpitSeaHawk.this.setNew.stbyPosition = CockpitSeaHawk.this.setOld.stbyPosition + 0.05F;
                }
                if ((CockpitSeaHawk.this.fm.EI.engines[0].getStage() < 6) && !CockpitSeaHawk.this.fm.CT.bHasAileronControl && !CockpitSeaHawk.this.fm.CT.bHasElevatorControl && !CockpitSeaHawk.this.fm.CT.bHasGearControl && !CockpitSeaHawk.this.fm.CT.bHasAirBrakeControl && !CockpitSeaHawk.this.fm.CT.bHasFlapsControl) {
                    if (CockpitSeaHawk.this.setNew.stbyPosition3 > 0.0F) {
                        CockpitSeaHawk.this.setNew.stbyPosition3 = CockpitSeaHawk.this.setOld.stbyPosition3 - 0.005F;
                    }
                } else if (CockpitSeaHawk.this.setNew.stbyPosition3 < 1.0F) {
                    CockpitSeaHawk.this.setNew.stbyPosition3 = CockpitSeaHawk.this.setOld.stbyPosition3 + 0.005F;
                }
                float f = ((SeaHawk_X) ((SeaHawk) CockpitSeaHawk.this.aircraft())).k14Distance;
                CockpitSeaHawk.this.setNew.k14w = (5F * CockpitSeaHawk.k14TargetWingspanScale[((SeaHawk_X) ((SeaHawk) CockpitSeaHawk.this.aircraft())).k14WingspanType]) / f;
                CockpitSeaHawk.this.setNew.k14w = (0.9F * CockpitSeaHawk.this.setOld.k14w) + (0.1F * CockpitSeaHawk.this.setNew.k14w);
                CockpitSeaHawk.this.setNew.k14wingspan = (0.9F * CockpitSeaHawk.this.setOld.k14wingspan) + (0.1F * CockpitSeaHawk.k14TargetMarkScale[((SeaHawk_X) ((SeaHawk) CockpitSeaHawk.this.aircraft())).k14WingspanType]);
                CockpitSeaHawk.this.setNew.k14mode = (0.8F * CockpitSeaHawk.this.setOld.k14mode) + (0.2F * ((SeaHawk_X) ((SeaHawk) CockpitSeaHawk.this.aircraft())).k14Mode);
                Vector3d vector3d = CockpitSeaHawk.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitSeaHawk.this.floatindex((f - 200F) * 0.04F, CockpitSeaHawk.k14BulletDrop) - CockpitSeaHawk.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitSeaHawk.this.setNew.k14x = (0.92F * CockpitSeaHawk.this.setOld.k14x) + (0.08F * f1);
                CockpitSeaHawk.this.setNew.k14y = (0.92F * CockpitSeaHawk.this.setOld.k14y) + (0.08F * f2);
                if (CockpitSeaHawk.this.setNew.k14x > 7F) {
                    CockpitSeaHawk.this.setNew.k14x = 7F;
                }
                if (CockpitSeaHawk.this.setNew.k14x < -7F) {
                    CockpitSeaHawk.this.setNew.k14x = -7F;
                }
                if (CockpitSeaHawk.this.setNew.k14y > 7F) {
                    CockpitSeaHawk.this.setNew.k14y = 7F;
                }
                if (CockpitSeaHawk.this.setNew.k14y < -7F) {
                    CockpitSeaHawk.this.setNew.k14y = -7F;
                }
    ...
    public void reflectWorldToInstruments(float f) {
        if (SeaHawk.bChangedPit) {
            SeaHawk.bChangedPit = false;
        }
        if ((this.fm.AS.astateCockpitState & 2) == 0) {
            int i = ((SeaHawk_X) ((SeaHawk) this.aircraft())).k14Mode;
            boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("Z_Speed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitSeaHawk.speedometerScale), 0.0F, 0.0F);
        ...
        if (((SeaHawk_X) ((SeaHawk) this.aircraft())).k14Mode == 2) {
    ...
    static {
        Property.set(CockpitSeaHawk.class, "normZN", 0.93F);
        Property.set(CockpitSeaHawk.class, "gsZN", 0.93F);
    }
