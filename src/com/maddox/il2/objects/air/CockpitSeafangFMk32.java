    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitSeafangFMk32.this.fm != null) {
                ...
                CockpitSeafangFMk32.this.setNew.waypointAzimuth.setDeg(CockpitSeafangFMk32.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitSeafangFMk32.this.waypointAzimuth() - CockpitSeafangFMk32.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitSeafangFMk32.this.fm.Or.getKren()) < 30F) {
                    CockpitSeafangFMk32.this.setNew.azimuth.setDeg(CockpitSeafangFMk32.this.setOld.azimuth.getDeg(1.0F), CockpitSeafangFMk32.this.fm.Or.azimut());
                }
