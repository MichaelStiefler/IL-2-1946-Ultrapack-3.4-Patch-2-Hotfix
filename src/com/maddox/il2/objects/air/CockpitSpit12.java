...
public class CockpitSpit12 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitSpit12.this.fm != null) {
                CockpitSpit12.this.setTmp = CockpitSpit12.this.setOld;
                CockpitSpit12.this.setOld = CockpitSpit12.this.setNew;
                CockpitSpit12.this.setNew = CockpitSpit12.this.setTmp;
                CockpitSpit12.this.setNew.throttle = (0.92F * CockpitSpit12.this.setOld.throttle) + (0.08F * CockpitSpit12.this.fm.CT.PowerControl);
                CockpitSpit12.this.setNew.prop = (0.92F * CockpitSpit12.this.setOld.prop) + (0.08F * CockpitSpit12.this.fm.EI.engines[0].getControlProp());
                CockpitSpit12.this.setNew.mix = (0.92F * CockpitSpit12.this.setOld.mix) + (0.08F * CockpitSpit12.this.fm.EI.engines[0].getControlMix());
                CockpitSpit12.this.setNew.altimeter = CockpitSpit12.this.fm.getAltitude();
                CockpitSpit12.this.setNew.waypointAzimuth.setDeg(CockpitSpit12.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitSpit12.this.waypointAzimuth() - CockpitSpit12.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitSpit12.this.fm.Or.getKren()) < 30F) {
                    CockpitSpit12.this.setNew.azimuth.setDeg(CockpitSpit12.this.setOld.azimuth.getDeg(1.0F), CockpitSpit12.this.fm.Or.azimut());
                }
                CockpitSpit12.this.setNew.vspeed = (0.99F * CockpitSpit12.this.setOld.vspeed) + (0.01F * CockpitSpit12.this.fm.getVertSpeed());
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitSpit12.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 50F, 100F, 0.0F, 271F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitSpit12.radScale));
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 223.52F, 0.0F, 25F), CockpitSpit12.speedometerScale));
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitSpit12.variometerScale));
    ...
    static {
        Property.set(CockpitSpit12.class, "normZN", 0.72F);
        Property.set(CockpitSpit12.class, "gsZN", 0.66F);
    }
