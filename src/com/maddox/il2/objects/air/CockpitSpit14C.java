...
public class CockpitSpit14C extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitSpit14C.this.fm != null) {
                CockpitSpit14C.this.setTmp = CockpitSpit14C.this.setOld;
                CockpitSpit14C.this.setOld = CockpitSpit14C.this.setNew;
                CockpitSpit14C.this.setNew = CockpitSpit14C.this.setTmp;
                CockpitSpit14C.this.setNew.throttle = (0.92F * CockpitSpit14C.this.setOld.throttle) + (0.08F * CockpitSpit14C.this.fm.CT.PowerControl);
                CockpitSpit14C.this.setNew.prop = (0.92F * CockpitSpit14C.this.setOld.prop) + (0.08F * CockpitSpit14C.this.fm.EI.engines[0].getControlProp());
                CockpitSpit14C.this.setNew.mix = (0.92F * CockpitSpit14C.this.setOld.mix) + (0.08F * CockpitSpit14C.this.fm.EI.engines[0].getControlMix());
                CockpitSpit14C.this.setNew.altimeter = CockpitSpit14C.this.fm.getAltitude();
                CockpitSpit14C.this.setNew.waypointAzimuth.setDeg(CockpitSpit14C.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitSpit14C.this.waypointAzimuth() - CockpitSpit14C.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitSpit14C.this.fm.Or.getKren()) < 30F) {
                    CockpitSpit14C.this.setNew.azimuth.setDeg(CockpitSpit14C.this.setOld.azimuth.getDeg(1.0F), CockpitSpit14C.this.fm.Or.azimut());
                }
                CockpitSpit14C.this.setNew.vspeed = (0.99F * CockpitSpit14C.this.setOld.vspeed) + (0.01F * CockpitSpit14C.this.fm.getVertSpeed());
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitSpit14C.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 50F, 100F, 0.0F, 271F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitSpit14C.radScale));
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 223.52F, 0.0F, 25F), CockpitSpit14C.speedometerScale));
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitSpit14C.variometerScale));
    ...
    static {
        Property.set(CockpitSpit14C.class, "normZN", 0.72F);
        Property.set(CockpitSpit14C.class, "gsZN", 0.66F);
    }
