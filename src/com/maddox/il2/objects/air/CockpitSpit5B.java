...
public class CockpitSpit5B extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitSpit5B.this.fm != null) {
                CockpitSpit5B.this.setTmp = CockpitSpit5B.this.setOld;
                CockpitSpit5B.this.setOld = CockpitSpit5B.this.setNew;
                CockpitSpit5B.this.setNew = CockpitSpit5B.this.setTmp;
                ...
                CockpitSpit5B.this.setNew.waypointAzimuth.setDeg(CockpitSpit5B.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitSpit5B.this.waypointAzimuth() - CockpitSpit5B.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitSpit5B.this.fm.Or.getKren()) < 30F) {
                    CockpitSpit5B.this.setNew.azimuth.setDeg(CockpitSpit5B.this.setOld.azimuth.getDeg(1.0F), CockpitSpit5B.this.fm.Or.azimut());
                }
    ...
    public CockpitSpit5B() {
        ...
        this.pictGear = 0.0F;
        this.pictManf = 1.0F;
        if (this.aircraft() instanceof SPITFIRE5B12LBS) {
            this.mesh.materialReplace("BORT2", "BORT2b");
            this.mesh.materialReplace("text14", "text14b");
        } else if (this.aircraft() instanceof SPITFIRE5B) {
            this.mesh.materialReplace("BORT2", "BORT2a");
            this.mesh.materialReplace("text14", "text14a");
        } else if ((this.aircraft() instanceof SPITFIRE5BLF) || (this.aircraft() instanceof SPITFIRE5BLFCLP)) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitSpit5B.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 50F, 100F, 0.0F, 271F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitSpit5B.radScale));
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 223.52F, 0.0F, 25F), CockpitSpit5B.speedometerScale));
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitSpit5B.variometerScale));
