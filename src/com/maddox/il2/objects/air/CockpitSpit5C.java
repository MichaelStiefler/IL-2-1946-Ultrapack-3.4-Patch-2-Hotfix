...
public class CockpitSpit5C extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitSpit5C.this.fm != null) {
                CockpitSpit5C.this.setTmp = CockpitSpit5C.this.setOld;
                CockpitSpit5C.this.setOld = CockpitSpit5C.this.setNew;
                CockpitSpit5C.this.setNew = CockpitSpit5C.this.setTmp;
                CockpitSpit5C.this.setNew.throttle = (0.92F * CockpitSpit5C.this.setOld.throttle) + (0.08F * CockpitSpit5C.this.fm.CT.PowerControl);
                CockpitSpit5C.this.setNew.prop = (0.92F * CockpitSpit5C.this.setOld.prop) + (0.08F * CockpitSpit5C.this.fm.EI.engines[0].getControlProp());
                CockpitSpit5C.this.setNew.mix = (0.92F * CockpitSpit5C.this.setOld.mix) + (0.08F * CockpitSpit5C.this.fm.EI.engines[0].getControlMix());
                CockpitSpit5C.this.setNew.altimeter = CockpitSpit5C.this.fm.getAltitude();
                CockpitSpit5C.this.setNew.waypointAzimuth.setDeg(CockpitSpit5C.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitSpit5C.this.waypointAzimuth() - CockpitSpit5C.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitSpit5C.this.fm.Or.getKren()) < 30F) {
                    CockpitSpit5C.this.setNew.azimuth.setDeg(CockpitSpit5C.this.setOld.azimuth.getDeg(1.0F), CockpitSpit5C.this.fm.Or.azimut());
                }
                CockpitSpit5C.this.setNew.vspeed = (0.99F * CockpitSpit5C.this.setOld.vspeed) + (0.01F * CockpitSpit5C.this.fm.getVertSpeed());
            }
            return true;
        }
    ...
    public CockpitSpit5C() {
        super("3DO/Cockpit/SpitfireMkVc/hier.him", "bf109");
        ...
        this.pictGear = 0.0F;
        this.pictManf = 1.0F;
        if (this.aircraft() instanceof SPITFIRE5C216LBS) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Throtle1", -51.8F * this.interp(this.setNew.throttle, this.setOld.throttle, f), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Prop1", -57F * this.setNew.prop, 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Mixture1", -57F * this.setNew.mix, 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitSpit5C.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 50F, 100F, 0.0F, 271F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitSpit5C.radScale));
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 223.52F, 0.0F, 25F), CockpitSpit5C.speedometerScale));
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitSpit5C.variometerScale));
