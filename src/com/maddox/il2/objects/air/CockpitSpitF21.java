...
public class CockpitSpitF21 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitSpitF21.this.fm != null) {
                CockpitSpitF21.this.setTmp = CockpitSpitF21.this.setOld;
                CockpitSpitF21.this.setOld = CockpitSpitF21.this.setNew;
                CockpitSpitF21.this.setNew = CockpitSpitF21.this.setTmp;
                CockpitSpitF21.this.setNew.throttle = (0.92F * CockpitSpitF21.this.setOld.throttle) + (0.08F * CockpitSpitF21.this.fm.CT.PowerControl);
                CockpitSpitF21.this.setNew.prop = (0.92F * CockpitSpitF21.this.setOld.prop) + (0.08F * CockpitSpitF21.this.fm.EI.engines[0].getControlProp());
                CockpitSpitF21.this.setNew.mix = (0.92F * CockpitSpitF21.this.setOld.mix) + (0.08F * CockpitSpitF21.this.fm.EI.engines[0].getControlMix());
                CockpitSpitF21.this.setNew.altimeter = CockpitSpitF21.this.fm.getAltitude();
                CockpitSpitF21.this.setNew.waypointAzimuth.setDeg(CockpitSpitF21.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitSpitF21.this.waypointAzimuth() - CockpitSpitF21.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitSpitF21.this.fm.Or.getKren()) < 30F) {
                    CockpitSpitF21.this.setNew.azimuth.setDeg(CockpitSpitF21.this.setOld.azimuth.getDeg(1.0F), CockpitSpitF21.this.fm.Or.azimut());
                }
                CockpitSpitF21.this.setNew.vspeed = (0.99F * CockpitSpitF21.this.setOld.vspeed) + (0.01F * CockpitSpitF21.this.fm.getVertSpeed());
                float f = ((SPITFIREF21) CockpitSpitF21.this.aircraft()).k14Distance;
                CockpitSpitF21.this.setNew.k14w = (5F * CockpitSpitF21.k14TargetWingspanScale[((SPITFIREF21) CockpitSpitF21.this.aircraft()).k14WingspanType]) / f;
                CockpitSpitF21.this.setNew.k14w = (0.9F * CockpitSpitF21.this.setOld.k14w) + (0.1F * CockpitSpitF21.this.setNew.k14w);
                CockpitSpitF21.this.setNew.k14wingspan = (0.9F * CockpitSpitF21.this.setOld.k14wingspan) + (0.1F * CockpitSpitF21.k14TargetMarkScale[((SPITFIREF21) CockpitSpitF21.this.aircraft()).k14WingspanType]);
                CockpitSpitF21.this.setNew.k14mode = (0.8F * CockpitSpitF21.this.setOld.k14mode) + (0.2F * ((SPITFIREF21) CockpitSpitF21.this.aircraft()).k14Mode);
                Vector3d vector3d = CockpitSpitF21.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitSpitF21.this.floatindex((f - 200F) * 0.04F, CockpitSpitF21.k14BulletDrop) - CockpitSpitF21.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitSpitF21.this.setNew.k14x = (0.92F * CockpitSpitF21.this.setOld.k14x) + (0.08F * f1);
                CockpitSpitF21.this.setNew.k14y = (0.92F * CockpitSpitF21.this.setOld.k14y) + (0.08F * f2);
                if (CockpitSpitF21.this.setNew.k14x > 7F) {
                    CockpitSpitF21.this.setNew.k14x = 7F;
                }
                if (CockpitSpitF21.this.setNew.k14x < -7F) {
                    CockpitSpitF21.this.setNew.k14x = -7F;
                }
                if (CockpitSpitF21.this.setNew.k14y > 7F) {
                    CockpitSpitF21.this.setNew.k14y = 7F;
                }
                if (CockpitSpitF21.this.setNew.k14y < -7F) {
                    CockpitSpitF21.this.setNew.k14y = -7F;
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        int i = ((SPITFIREF21) this.aircraft()).k14Mode;
        boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitSpitF21.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 50F, 100F, 0.0F, 271F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitSpitF21.radScale));
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 223.52F, 0.0F, 25F), CockpitSpitF21.speedometerScale));
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitSpitF21.variometerScale));
    ...
    static {
        Property.set(CockpitSpitF21.class, "normZN", 0.72F);
        Property.set(CockpitSpitF21.class, "gsZN", 0.66F);
    }
