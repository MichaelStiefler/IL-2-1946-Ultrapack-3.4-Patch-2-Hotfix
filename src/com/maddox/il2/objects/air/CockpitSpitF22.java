    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitSpitF22.this.fm != null) {
                ...
                CockpitSpitF22.this.setNew.waypointAzimuth.setDeg(CockpitSpitF22.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitSpitF22.this.waypointAzimuth() - CockpitSpitF22.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitSpitF22.this.fm.Or.getKren()) < 30F) {
                    CockpitSpitF22.this.setNew.azimuth.setDeg(CockpitSpitF22.this.setOld.azimuth.getDeg(1.0F), CockpitSpitF22.this.fm.Or.azimut());
                }
