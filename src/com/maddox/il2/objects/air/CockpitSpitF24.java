...
public class CockpitSpitF24 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitSpitF24.this.bNeedSetUp) {
                CockpitSpitF24.this.reflectPlaneMats();
                CockpitSpitF24.this.bNeedSetUp = false;
            }
            if (CockpitSpitF24.this.fm != null) {
                CockpitSpitF24.this.setTmp = CockpitSpitF24.this.setOld;
                CockpitSpitF24.this.setOld = CockpitSpitF24.this.setNew;
                CockpitSpitF24.this.setNew = CockpitSpitF24.this.setTmp;
                CockpitSpitF24.this.setNew.throttle = (0.92F * CockpitSpitF24.this.setOld.throttle) + (0.08F * CockpitSpitF24.this.fm.CT.PowerControl);
                CockpitSpitF24.this.setNew.prop = (0.92F * CockpitSpitF24.this.setOld.prop) + (0.08F * CockpitSpitF24.this.fm.EI.engines[0].getControlProp());
                CockpitSpitF24.this.setNew.mix = (0.92F * CockpitSpitF24.this.setOld.mix) + (0.08F * CockpitSpitF24.this.fm.EI.engines[0].getControlMix());
                CockpitSpitF24.this.setNew.altimeter = CockpitSpitF24.this.fm.getAltitude();
                CockpitSpitF24.this.setNew.waypointAzimuth.setDeg(CockpitSpitF24.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitSpitF24.this.waypointAzimuth() - CockpitSpitF24.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitSpitF24.this.fm.Or.getKren()) < 30F) {
                    CockpitSpitF24.this.setNew.azimuth.setDeg(CockpitSpitF24.this.setOld.azimuth.getDeg(1.0F), CockpitSpitF24.this.fm.Or.azimut());
                }
                CockpitSpitF24.this.setNew.vspeed = (0.99F * CockpitSpitF24.this.setOld.vspeed) + (0.01F * CockpitSpitF24.this.fm.getVertSpeed());
                float f = ((SPITFIREF24) CockpitSpitF24.this.aircraft()).k14Distance;
                CockpitSpitF24.this.setNew.k14w = (5F * CockpitSpitF24.k14TargetWingspanScale[((SPITFIREF24) CockpitSpitF24.this.aircraft()).k14WingspanType]) / f;
                CockpitSpitF24.this.setNew.k14w = (0.9F * CockpitSpitF24.this.setOld.k14w) + (0.1F * CockpitSpitF24.this.setNew.k14w);
                CockpitSpitF24.this.setNew.k14wingspan = (0.9F * CockpitSpitF24.this.setOld.k14wingspan) + (0.1F * CockpitSpitF24.k14TargetMarkScale[((SPITFIREF24) CockpitSpitF24.this.aircraft()).k14WingspanType]);
                CockpitSpitF24.this.setNew.k14mode = (0.8F * CockpitSpitF24.this.setOld.k14mode) + (0.2F * ((SPITFIREF24) CockpitSpitF24.this.aircraft()).k14Mode);
                Vector3d vector3d = CockpitSpitF24.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitSpitF24.this.floatindex((f - 200F) * 0.04F, CockpitSpitF24.k14BulletDrop) - CockpitSpitF24.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitSpitF24.this.setNew.k14x = (0.92F * CockpitSpitF24.this.setOld.k14x) + (0.08F * f1);
                CockpitSpitF24.this.setNew.k14y = (0.92F * CockpitSpitF24.this.setOld.k14y) + (0.08F * f2);
                if (CockpitSpitF24.this.setNew.k14x > 7F) {
                    CockpitSpitF24.this.setNew.k14x = 7F;
                }
                if (CockpitSpitF24.this.setNew.k14x < -7F) {
                    CockpitSpitF24.this.setNew.k14x = -7F;
                }
                if (CockpitSpitF24.this.setNew.k14y > 7F) {
                    CockpitSpitF24.this.setNew.k14y = 7F;
                }
                if (CockpitSpitF24.this.setNew.k14y < -7F) {
                    CockpitSpitF24.this.setNew.k14y = -7F;
                }
    ...
    public void reflectWorldToInstruments(float f) {
        int i = ((SPITFIREF24) this.aircraft()).k14Mode;
        boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitSpitF24.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 50F, 100F, 0.0F, 271F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitSpitF24.radScale));
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 223.52F, 0.0F, 25F), CockpitSpitF24.speedometerScale));
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitSpitF24.variometerScale));
    ...
    static {
        Property.set(CockpitSpitF24.class, "normZN", 0.72F);
        Property.set(CockpitSpitF24.class, "gsZN", 0.66F);
    }
