...
public class CockpitSpitLF14E extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitSpitLF14E.this.fm != null) {
                CockpitSpitLF14E.this.setTmp = CockpitSpitLF14E.this.setOld;
                CockpitSpitLF14E.this.setOld = CockpitSpitLF14E.this.setNew;
                CockpitSpitLF14E.this.setNew = CockpitSpitLF14E.this.setTmp;
                ...
                if (Math.abs(CockpitSpitLF14E.this.fm.Or.getKren()) < 30F) {
                    CockpitSpitLF14E.this.setNew.waypointAzimuth.setDeg(CockpitSpitLF14E.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitSpitLF14E.this.waypointAzimuth() - CockpitSpitLF14E.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                }
                if (Math.abs(CockpitSpitLF14E.this.fm.Or.getKren()) < 30F) {
                    CockpitSpitLF14E.this.setNew.azimuth.setDeg(CockpitSpitLF14E.this.setOld.azimuth.getDeg(1.0F), CockpitSpitLF14E.this.fm.Or.azimut());
                }
                ...
                float f = ((SPITFIRELF14E) CockpitSpitLF14E.this.aircraft()).k14Distance;
                CockpitSpitLF14E.this.setNew.k14w = (5F * CockpitSpitLF14E.k14TargetWingspanScale[((SPITFIRELF14E) CockpitSpitLF14E.this.aircraft()).k14WingspanType]) / f;
                ...
                Vector3d vector3d = CockpitSpitLF14E.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitSpitLF14E.this.floatindex((f - 200F) * 0.04F, CockpitSpitLF14E.k14BulletDrop) - CockpitSpitLF14E.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitSpitLF14E.this.setNew.k14x = (0.92F * CockpitSpitLF14E.this.setOld.k14x) + (0.08F * f1);
                CockpitSpitLF14E.this.setNew.k14y = (0.92F * CockpitSpitLF14E.this.setOld.k14y) + (0.08F * f2);
                if (CockpitSpitLF14E.this.setNew.k14x > 7F) {
                    CockpitSpitLF14E.this.setNew.k14x = 7F;
                }
                if (CockpitSpitLF14E.this.setNew.k14x < -7F) {
                    CockpitSpitLF14E.this.setNew.k14x = -7F;
                }
                if (CockpitSpitLF14E.this.setNew.k14y > 7F) {
                    CockpitSpitLF14E.this.setNew.k14y = 7F;
                }
                if (CockpitSpitLF14E.this.setNew.k14y < -7F) {
                    CockpitSpitLF14E.this.setNew.k14y = -7F;
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        int i = ((SPITFIRELF14E) this.aircraft()).k14Mode;
        boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitSpitLF14E.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 50F, 100F, 0.0F, 271F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitSpitLF14E.radScale));
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 223.52F, 0.0F, 25F), CockpitSpitLF14E.speedometerScale));
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitSpitLF14E.variometerScale));
