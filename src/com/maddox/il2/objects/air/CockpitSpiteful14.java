...
public class CockpitSpiteful14 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitSpiteful14.this.fm != null) {
                CockpitSpiteful14.this.setTmp = CockpitSpiteful14.this.setOld;
                CockpitSpiteful14.this.setOld = CockpitSpiteful14.this.setNew;
                CockpitSpiteful14.this.setNew = CockpitSpiteful14.this.setTmp;
                CockpitSpiteful14.this.setNew.throttle = (0.92F * CockpitSpiteful14.this.setOld.throttle) + (0.08F * CockpitSpiteful14.this.fm.CT.PowerControl);
                CockpitSpiteful14.this.setNew.prop = (0.92F * CockpitSpiteful14.this.setOld.prop) + (0.08F * CockpitSpiteful14.this.fm.EI.engines[0].getControlProp());
                CockpitSpiteful14.this.setNew.mix = (0.92F * CockpitSpiteful14.this.setOld.mix) + (0.08F * CockpitSpiteful14.this.fm.EI.engines[0].getControlMix());
                CockpitSpiteful14.this.setNew.altimeter = CockpitSpiteful14.this.fm.getAltitude();
                CockpitSpiteful14.this.setNew.waypointAzimuth.setDeg(CockpitSpiteful14.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitSpiteful14.this.waypointAzimuth() - CockpitSpiteful14.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitSpiteful14.this.fm.Or.getKren()) < 30F) {
                    CockpitSpiteful14.this.setNew.azimuth.setDeg(CockpitSpiteful14.this.setOld.azimuth.getDeg(1.0F), CockpitSpiteful14.this.fm.Or.azimut());
                }
                CockpitSpiteful14.this.setNew.vspeed = (0.99F * CockpitSpiteful14.this.setOld.vspeed) + (0.01F * CockpitSpiteful14.this.fm.getVertSpeed());
                float f = ((Spiteful14) CockpitSpiteful14.this.aircraft()).k14Distance;
                CockpitSpiteful14.this.setNew.k14w = (5F * CockpitSpiteful14.k14TargetWingspanScale[((Spiteful14) CockpitSpiteful14.this.aircraft()).k14WingspanType]) / f;
                CockpitSpiteful14.this.setNew.k14w = (0.9F * CockpitSpiteful14.this.setOld.k14w) + (0.1F * CockpitSpiteful14.this.setNew.k14w);
                CockpitSpiteful14.this.setNew.k14wingspan = (0.9F * CockpitSpiteful14.this.setOld.k14wingspan) + (0.1F * CockpitSpiteful14.k14TargetMarkScale[((Spiteful14) CockpitSpiteful14.this.aircraft()).k14WingspanType]);
                CockpitSpiteful14.this.setNew.k14mode = (0.8F * CockpitSpiteful14.this.setOld.k14mode) + (0.2F * ((Spiteful14) CockpitSpiteful14.this.aircraft()).k14Mode);
                Vector3d vector3d = CockpitSpiteful14.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitSpiteful14.this.floatindex((f - 200F) * 0.04F, CockpitSpiteful14.k14BulletDrop) - CockpitSpiteful14.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitSpiteful14.this.setNew.k14x = (0.92F * CockpitSpiteful14.this.setOld.k14x) + (0.08F * f1);
                CockpitSpiteful14.this.setNew.k14y = (0.92F * CockpitSpiteful14.this.setOld.k14y) + (0.08F * f2);
                if (CockpitSpiteful14.this.setNew.k14x > 7F) {
                    CockpitSpiteful14.this.setNew.k14x = 7F;
                }
                if (CockpitSpiteful14.this.setNew.k14x < -7F) {
                    CockpitSpiteful14.this.setNew.k14x = -7F;
                }
                if (CockpitSpiteful14.this.setNew.k14y > 7F) {
                    CockpitSpiteful14.this.setNew.k14y = 7F;
                }
                if (CockpitSpiteful14.this.setNew.k14y < -7F) {
                    CockpitSpiteful14.this.setNew.k14y = -7F;
                }
    ...
    public CockpitSpiteful14() {
        super("3DO/Cockpit/Spiteful_FMkXIV/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        int i = ((Spiteful14) this.aircraft()).k14Mode;
        boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000F, 5000F, 2.0F, 10F), CockpitSpiteful14.rpmScale));
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", 0.0F, 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, 50F, 100F, 0.0F, 271F));
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", 0.0F, 0.0F, -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitSpiteful14.radScale));
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", 0.0F, 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 223.52F, 0.0F, 25F), CockpitSpiteful14.speedometerScale));
        this.mesh.chunkSetAngles("STRELKA_VY", 0.0F, 0.0F, -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitSpiteful14.variometerScale));
    ...
    static {
        Property.set(CockpitSpiteful14.class, "normZN", 0.72F);
        Property.set(CockpitSpiteful14.class, "gsZN", 0.66F);
    }
