...
public class CockpitSunderland extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitSunderland.this.fm != null) {
                CockpitSunderland.this.setTmp = CockpitSunderland.this.setOld;
                CockpitSunderland.this.setOld = CockpitSunderland.this.setNew;
                CockpitSunderland.this.setNew = CockpitSunderland.this.setTmp;
                CockpitSunderland.this.setNew.throttle1 = (0.9F * CockpitSunderland.this.setOld.throttle1) + (0.1F * CockpitSunderland.this.fm.EI.engines[0].getControlThrottle());
                CockpitSunderland.this.setNew.prop1 = (0.9F * CockpitSunderland.this.setOld.prop1) + (0.1F * CockpitSunderland.this.fm.EI.engines[0].getControlProp());
                CockpitSunderland.this.setNew.mix1 = (0.8F * CockpitSunderland.this.setOld.mix1) + (0.2F * CockpitSunderland.this.fm.EI.engines[0].getControlMix());
                CockpitSunderland.this.setNew.throttle2 = (0.9F * CockpitSunderland.this.setOld.throttle2) + (0.1F * CockpitSunderland.this.fm.EI.engines[1].getControlThrottle());
                CockpitSunderland.this.setNew.prop2 = (0.9F * CockpitSunderland.this.setOld.prop2) + (0.1F * CockpitSunderland.this.fm.EI.engines[1].getControlProp());
                CockpitSunderland.this.setNew.mix2 = (0.8F * CockpitSunderland.this.setOld.mix2) + (0.2F * CockpitSunderland.this.fm.EI.engines[1].getControlMix());
                CockpitSunderland.this.setNew.man1 = (0.92F * CockpitSunderland.this.setOld.man1) + (0.08F * CockpitSunderland.this.fm.EI.engines[0].getManifoldPressure());
                CockpitSunderland.this.setNew.man2 = (0.92F * CockpitSunderland.this.setOld.man2) + (0.08F * CockpitSunderland.this.fm.EI.engines[1].getManifoldPressure());
                CockpitSunderland.this.setNew.altimeter = CockpitSunderland.this.fm.getAltitude();
                if (Math.abs(CockpitSunderland.this.fm.Or.getKren()) < 30F) {
                    CockpitSunderland.this.setNew.azimuth.setDeg(CockpitSunderland.this.setOld.azimuth.getDeg(1.0F), CockpitSunderland.this.fm.Or.azimut());
                }
                CockpitSunderland.this.setNew.vspeed = ((199F * CockpitSunderland.this.setOld.vspeed) + CockpitSunderland.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitSunderland() {
        super("3DO/Cockpit/CockpitSunderland/Sunderland.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitSunderland.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 300F, 0.0F, 15F), CockpitSunderland.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Temp7", this.floatindex(this.cvt(this.fm.EI.engines[1].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitSunderland.oilTempScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Temp8", this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 120F, 0.0F, 12F), CockpitSunderland.oilTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitSunderland.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 3500F, 0.0F, 7F), CockpitSunderland.rpmScale), 0.0F, 0.0F);
