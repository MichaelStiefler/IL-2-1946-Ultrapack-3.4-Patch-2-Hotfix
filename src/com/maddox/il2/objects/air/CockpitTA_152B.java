...
public class CockpitTA_152B extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitTA_152B.this.fm != null) {
                CockpitTA_152B.this.setTmp = CockpitTA_152B.this.setOld;
                CockpitTA_152B.this.setOld = CockpitTA_152B.this.setNew;
                CockpitTA_152B.this.setNew = CockpitTA_152B.this.setTmp;
                CockpitTA_152B.this.setNew.altimeter = CockpitTA_152B.this.fm.getAltitude();
                if (CockpitTA_152B.this.cockpitDimControl) {
                    if (CockpitTA_152B.this.setNew.dimPosition > 0.0F) {
                        CockpitTA_152B.this.setNew.dimPosition = CockpitTA_152B.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitTA_152B.this.setNew.dimPosition < 1.0F) {
                    CockpitTA_152B.this.setNew.dimPosition = CockpitTA_152B.this.setOld.dimPosition + 0.05F;
                }
                CockpitTA_152B.this.setNew.throttle = ((10F * CockpitTA_152B.this.setOld.throttle) + CockpitTA_152B.this.fm.CT.PowerControl) / 11F;
                CockpitTA_152B.this.setNew.vspeed = ((499F * CockpitTA_152B.this.setOld.vspeed) + CockpitTA_152B.this.fm.getVertSpeed()) / 500F;
                float f = CockpitTA_152B.this.waypointAzimuth();
                if (CockpitTA_152B.this.useRealisticNavigationInstruments()) {
                    CockpitTA_152B.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitTA_152B.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitTA_152B.this.setNew.waypointAzimuth.setDeg(CockpitTA_152B.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitTA_152B.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitTA_152B.this.fm.Or.getKren()) < 30F) {
                    CockpitTA_152B.this.setNew.azimuth.setDeg(CockpitTA_152B.this.setOld.azimuth.getDeg(1.0F), CockpitTA_152B.this.fm.Or.azimut());
                }
                CockpitTA_152B.this.w.set(CockpitTA_152B.this.fm.getW());
                CockpitTA_152B.this.fm.Or.transform(CockpitTA_152B.this.w);
                CockpitTA_152B.this.setNew.turn = ((12F * CockpitTA_152B.this.setOld.turn) + CockpitTA_152B.this.w.z) / 13F;
                CockpitTA_152B.this.setNew.beaconDirection = ((10F * CockpitTA_152B.this.setOld.beaconDirection) + CockpitTA_152B.this.getBeaconDirection()) / 11F;
                CockpitTA_152B.this.setNew.beaconRange = ((10F * CockpitTA_152B.this.setOld.beaconRange) + CockpitTA_152B.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public CockpitTA_152B() {
        super("3DO/Cockpit/Ta-152B-1/hier.him", "bf109");
        this.gun = new Gun[5];
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitTA_152B.speedometerScale), 0.0F, 0.0F);
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitTA_152B.rpmScale), 0.0F, 0.0F);
        }
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 4F), CockpitTA_152B.fuelScale), 0.0F, 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 0x20) == 0) && ((this.fm.AS.astateCockpitState & 0x80) == 0)) {
            this.mesh.chunkSetAngles("NeedleCD", this.setNew.vspeed >= 0.0F ? -this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitTA_152B.vsiNeedleScale) : this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitTA_152B.vsiNeedleScale), 0.0F, 0.0F);
        }
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
    ...
    static {
        Property.set(CockpitTA_152B.class, "normZN", 0.72F);
        Property.set(CockpitTA_152B.class, "gsZN", 0.66F);
    }
