...
public class CockpitTA_152C0 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitTA_152C0.this.fm != null) {
                CockpitTA_152C0.this.setTmp = CockpitTA_152C0.this.setOld;
                CockpitTA_152C0.this.setOld = CockpitTA_152C0.this.setNew;
                CockpitTA_152C0.this.setNew = CockpitTA_152C0.this.setTmp;
                ...
                CockpitTA_152C0.this.setNew.throttle = ((10F * CockpitTA_152C0.this.setOld.throttle) + CockpitTA_152C0.this.fm.CT.PowerControl) / 11F;
                CockpitTA_152C0.this.setNew.vspeed = ((499F * CockpitTA_152C0.this.setOld.vspeed) + CockpitTA_152C0.this.fm.getVertSpeed()) / 500F;
                float f = CockpitTA_152C0.this.waypointAzimuth();
                if (CockpitTA_152C0.this.useRealisticNavigationInstruments()) {
                    CockpitTA_152C0.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitTA_152C0.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitTA_152C0.this.setNew.waypointAzimuth.setDeg(CockpitTA_152C0.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitTA_152C0.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitTA_152C0.this.fm.Or.getKren()) < 30F) {
                    CockpitTA_152C0.this.setNew.azimuth.setDeg(CockpitTA_152C0.this.setOld.azimuth.getDeg(1.0F), CockpitTA_152C0.this.fm.Or.azimut());
                }
                CockpitTA_152C0.this.w.set(CockpitTA_152C0.this.fm.getW());
                CockpitTA_152C0.this.fm.Or.transform(CockpitTA_152C0.this.w);
                CockpitTA_152C0.this.setNew.turn = ((12F * CockpitTA_152C0.this.setOld.turn) + CockpitTA_152C0.this.w.z) / 13F;
                CockpitTA_152C0.this.setNew.beaconDirection = ((10F * CockpitTA_152C0.this.setOld.beaconDirection) + CockpitTA_152C0.this.getBeaconDirection()) / 11F;
                CockpitTA_152C0.this.setNew.beaconRange = ((10F * CockpitTA_152C0.this.setOld.beaconRange) + CockpitTA_152C0.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitTA_152C0.speedometerScale), 0.0F, 0.0F);
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitTA_152C0.rpmScale), 0.0F, 0.0F);
        }
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 4F), CockpitTA_152C0.fuelScale), 0.0F, 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 0x20) == 0) && ((this.fm.AS.astateCockpitState & 0x80) == 0)) {
            this.mesh.chunkSetAngles("NeedleCD", this.setNew.vspeed >= 0.0F ? -this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitTA_152C0.vsiNeedleScale) : this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitTA_152C0.vsiNeedleScale), 0.0F, 0.0F);
        }
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
    ...
    static {
        Property.set(CockpitTA_152C0.class, "normZN", 0.72F);
        Property.set(CockpitTA_152C0.class, "gsZN", 0.66F);
    }
