...
public class CockpitTA_152H extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitTA_152H.this.fm != null) {
                CockpitTA_152H.this.setTmp = CockpitTA_152H.this.setOld;
                CockpitTA_152H.this.setOld = CockpitTA_152H.this.setNew;
                CockpitTA_152H.this.setNew = CockpitTA_152H.this.setTmp;
                CockpitTA_152H.this.setNew.altimeter = CockpitTA_152H.this.fm.getAltitude();
                if (CockpitTA_152H.this.cockpitDimControl) {
                    if (CockpitTA_152H.this.setNew.dimPosition > 0.0F) {
                        CockpitTA_152H.this.setNew.dimPosition = CockpitTA_152H.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitTA_152H.this.setNew.dimPosition < 1.0F) {
                    CockpitTA_152H.this.setNew.dimPosition = CockpitTA_152H.this.setOld.dimPosition + 0.05F;
                }
                CockpitTA_152H.this.setNew.throttle = ((10F * CockpitTA_152H.this.setOld.throttle) + CockpitTA_152H.this.fm.CT.PowerControl) / 11F;
                CockpitTA_152H.this.setNew.vspeed = ((499F * CockpitTA_152H.this.setOld.vspeed) + CockpitTA_152H.this.fm.getVertSpeed()) / 500F;
                float f = CockpitTA_152H.this.waypointAzimuth();
                if (CockpitTA_152H.this.useRealisticNavigationInstruments()) {
                    CockpitTA_152H.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitTA_152H.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitTA_152H.this.setNew.waypointAzimuth.setDeg(CockpitTA_152H.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitTA_152H.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitTA_152H.this.fm.Or.getKren()) < 30F) {
                    CockpitTA_152H.this.setNew.azimuth.setDeg(CockpitTA_152H.this.setOld.azimuth.getDeg(1.0F), CockpitTA_152H.this.fm.Or.azimut());
                }
                CockpitTA_152H.this.w.set(CockpitTA_152H.this.fm.getW());
                CockpitTA_152H.this.fm.Or.transform(CockpitTA_152H.this.w);
                CockpitTA_152H.this.setNew.turn = ((12F * CockpitTA_152H.this.setOld.turn) + CockpitTA_152H.this.w.z) / 13F;
                CockpitTA_152H.this.setNew.beaconDirection = ((10F * CockpitTA_152H.this.setOld.beaconDirection) + CockpitTA_152H.this.getBeaconDirection()) / 11F;
                CockpitTA_152H.this.setNew.beaconRange = ((10F * CockpitTA_152H.this.setOld.beaconRange) + CockpitTA_152H.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitTA_152H.speedometerScale), 0.0F, 0.0F);
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitTA_152H.rpmScale), 0.0F, 0.0F);
        }
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.92F, 0.0F, 400F, 0.0F, 4F), CockpitTA_152H.fuelScale), 0.0F, 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 0x20) == 0) && ((this.fm.AS.astateCockpitState & 0x80) == 0)) {
            this.mesh.chunkSetAngles("NeedleCD", this.setNew.vspeed >= 0.0F ? -this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitTA_152H.vsiNeedleScale) : this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitTA_152H.vsiNeedleScale), 0.0F, 0.0F);
        }
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
    ...
    static {
        Property.set(CockpitTA_152H.class, "normZN", 0.74F);
        Property.set(CockpitTA_152H.class, "gsZN", 0.66F);
    }
