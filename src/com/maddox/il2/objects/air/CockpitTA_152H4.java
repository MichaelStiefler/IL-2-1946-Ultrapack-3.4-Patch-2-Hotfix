...
public class CockpitTA_152H4 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitTA_152H4.this.fm != null) {
                CockpitTA_152H4.this.setTmp = CockpitTA_152H4.this.setOld;
                CockpitTA_152H4.this.setOld = CockpitTA_152H4.this.setNew;
                CockpitTA_152H4.this.setNew = CockpitTA_152H4.this.setTmp;
                CockpitTA_152H4.this.setNew.altimeter = CockpitTA_152H4.this.fm.getAltitude();
                if (CockpitTA_152H4.this.cockpitDimControl) {
                    if (CockpitTA_152H4.this.setNew.dimPosition > 0.0F) {
                        CockpitTA_152H4.this.setNew.dimPosition = CockpitTA_152H4.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitTA_152H4.this.setNew.dimPosition < 1.0F) {
                    CockpitTA_152H4.this.setNew.dimPosition = CockpitTA_152H4.this.setOld.dimPosition + 0.05F;
                }
                CockpitTA_152H4.this.setNew.throttle = ((10F * CockpitTA_152H4.this.setOld.throttle) + CockpitTA_152H4.this.fm.CT.PowerControl) / 11F;
                CockpitTA_152H4.this.setNew.vspeed = ((499F * CockpitTA_152H4.this.setOld.vspeed) + CockpitTA_152H4.this.fm.getVertSpeed()) / 500F;
                float f = CockpitTA_152H4.this.waypointAzimuth();
                if (CockpitTA_152H4.this.useRealisticNavigationInstruments()) {
                    CockpitTA_152H4.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitTA_152H4.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitTA_152H4.this.setNew.waypointAzimuth.setDeg(CockpitTA_152H4.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitTA_152H4.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitTA_152H4.this.fm.Or.getKren()) < 30F) {
                    CockpitTA_152H4.this.setNew.azimuth.setDeg(CockpitTA_152H4.this.setOld.azimuth.getDeg(1.0F), CockpitTA_152H4.this.fm.Or.azimut());
                }
                CockpitTA_152H4.this.w.set(CockpitTA_152H4.this.fm.getW());
                CockpitTA_152H4.this.fm.Or.transform(CockpitTA_152H4.this.w);
                CockpitTA_152H4.this.setNew.turn = ((12F * CockpitTA_152H4.this.setOld.turn) + CockpitTA_152H4.this.w.z) / 13F;
                CockpitTA_152H4.this.setNew.beaconDirection = ((10F * CockpitTA_152H4.this.setOld.beaconDirection) + CockpitTA_152H4.this.getBeaconDirection()) / 11F;
                CockpitTA_152H4.this.setNew.beaconRange = ((10F * CockpitTA_152H4.this.setOld.beaconRange) + CockpitTA_152H4.this.getBeaconRange()) / 11F;
                float f1 = ((TA_152H4) CockpitTA_152H4.this.aircraft()).k14Distance;
                CockpitTA_152H4.this.setNew.k14w = (5F * CockpitTA_152H4.k14TargetWingspanScale[((TA_152H4) CockpitTA_152H4.this.aircraft()).k14WingspanType]) / f1;
                CockpitTA_152H4.this.setNew.k14w = (0.9F * CockpitTA_152H4.this.setOld.k14w) + (0.1F * CockpitTA_152H4.this.setNew.k14w);
                CockpitTA_152H4.this.setNew.k14wingspan = (0.9F * CockpitTA_152H4.this.setOld.k14wingspan) + (0.1F * CockpitTA_152H4.k14TargetMarkScale[((TA_152H4) CockpitTA_152H4.this.aircraft()).k14WingspanType]);
                CockpitTA_152H4.this.setNew.k14mode = (0.8F * CockpitTA_152H4.this.setOld.k14mode) + (0.2F * ((TA_152H4) CockpitTA_152H4.this.aircraft()).k14Mode);
                Vector3d vector3d = CockpitTA_152H4.this.aircraft().FM.getW();
                double d = 0.00125D * f1;
                float f2 = (float) Math.toDegrees(d * vector3d.z);
                float f3 = -(float) Math.toDegrees(d * vector3d.y);
                float f4 = CockpitTA_152H4.this.floatindex((f1 - 200F) * 0.04F, CockpitTA_152H4.k14BulletDrop) - CockpitTA_152H4.k14BulletDrop[0];
                f3 += (float) Math.toDegrees(Math.atan(f4 / f1));
                CockpitTA_152H4.this.setNew.k14x = (0.92F * CockpitTA_152H4.this.setOld.k14x) + (0.08F * f2);
                CockpitTA_152H4.this.setNew.k14y = (0.92F * CockpitTA_152H4.this.setOld.k14y) + (0.08F * f3);
                if (CockpitTA_152H4.this.setNew.k14x > 7F) {
                    CockpitTA_152H4.this.setNew.k14x = 7F;
                }
                if (CockpitTA_152H4.this.setNew.k14x < -7F) {
                    CockpitTA_152H4.this.setNew.k14x = -7F;
                }
                if (CockpitTA_152H4.this.setNew.k14y > 7F) {
                    CockpitTA_152H4.this.setNew.k14y = 7F;
                }
                if (CockpitTA_152H4.this.setNew.k14y < -7F) {
                    CockpitTA_152H4.this.setNew.k14y = -7F;
                }
    ...
    public void reflectWorldToInstruments(float f) {
        int i = ((TA_152H4) this.aircraft()).k14Mode;
        boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitTA_152H4.speedometerScale), 0.0F, 0.0F);
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitTA_152H4.rpmScale), 0.0F, 0.0F);
        }
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.92F, 0.0F, 400F, 0.0F, 4F), CockpitTA_152H4.fuelScale), 0.0F, 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            ...
            this.mesh.chunkSetAngles("NeedleAirPress1", -this.floatindex(this.cvt(this.fm.getAltitude() / 1000F, 0.0F, 15F, 0.0F, 8F), CockpitTA_152H4.altScale), 0.0F, 0.0F);
            ...
            this.mesh.chunkSetAngles("NeedleAirPress2", this.floatindex(this.cvt(this.fm.getAltitude() / 1000F, 0.0F, 2.5F, 0.0F, 8F), CockpitTA_152H4.presScale), 0.0F, 0.0F);
        }
        if (((this.fm.AS.astateCockpitState & 0x20) == 0) && ((this.fm.AS.astateCockpitState & 0x80) == 0)) {
            this.mesh.chunkSetAngles("NeedleCD", this.setNew.vspeed < 0.0F ? this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitTA_152H4.vsiNeedleScale) : -this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitTA_152H4.vsiNeedleScale), 0.0F, 0.0F);
        }
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
    ...
    static {
        Property.set(CockpitTA_152H4.class, "normZN", 0.74F);
        Property.set(CockpitTA_152H4.class, "gsZN", 0.66F);
    }
