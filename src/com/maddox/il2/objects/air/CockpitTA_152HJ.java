...
public class CockpitTA_152HJ extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitTA_152HJ.this.fm != null) {
                CockpitTA_152HJ.this.setTmp = CockpitTA_152HJ.this.setOld;
                CockpitTA_152HJ.this.setOld = CockpitTA_152HJ.this.setNew;
                CockpitTA_152HJ.this.setNew = CockpitTA_152HJ.this.setTmp;
                CockpitTA_152HJ.this.setNew.altimeter = CockpitTA_152HJ.this.fm.getAltitude();
                if (CockpitTA_152HJ.this.cockpitDimControl) {
                    if (CockpitTA_152HJ.this.setNew.dimPosition > 0.0F) {
                        CockpitTA_152HJ.this.setNew.dimPosition = CockpitTA_152HJ.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitTA_152HJ.this.setNew.dimPosition < 1.0F) {
                    CockpitTA_152HJ.this.setNew.dimPosition = CockpitTA_152HJ.this.setOld.dimPosition + 0.05F;
                }
                CockpitTA_152HJ.this.setNew.throttle = ((10F * CockpitTA_152HJ.this.setOld.throttle) + CockpitTA_152HJ.this.fm.CT.PowerControl) / 11F;
                CockpitTA_152HJ.this.setNew.vspeed = ((499F * CockpitTA_152HJ.this.setOld.vspeed) + CockpitTA_152HJ.this.fm.getVertSpeed()) / 500F;
                float f = CockpitTA_152HJ.this.waypointAzimuth();
                if (CockpitTA_152HJ.this.useRealisticNavigationInstruments()) {
                    CockpitTA_152HJ.this.setNew.waypointAzimuth.setDeg(f - 90F);
                    CockpitTA_152HJ.this.setOld.waypointAzimuth.setDeg(f - 90F);
                } else {
                    CockpitTA_152HJ.this.setNew.waypointAzimuth.setDeg(CockpitTA_152HJ.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitTA_152HJ.this.setOld.azimuth.getDeg(1.0F));
                }
                if (Math.abs(CockpitTA_152HJ.this.fm.Or.getKren()) < 30F) {
                    CockpitTA_152HJ.this.setNew.azimuth.setDeg(CockpitTA_152HJ.this.setOld.azimuth.getDeg(1.0F), CockpitTA_152HJ.this.fm.Or.azimut());
                }
                CockpitTA_152HJ.this.w.set(CockpitTA_152HJ.this.fm.getW());
                CockpitTA_152HJ.this.fm.Or.transform(CockpitTA_152HJ.this.w);
                CockpitTA_152HJ.this.setNew.turn = ((12F * CockpitTA_152HJ.this.setOld.turn) + CockpitTA_152HJ.this.w.z) / 13F;
                CockpitTA_152HJ.this.setNew.beaconDirection = ((10F * CockpitTA_152HJ.this.setOld.beaconDirection) + CockpitTA_152HJ.this.getBeaconDirection()) / 11F;
                CockpitTA_152HJ.this.setNew.beaconRange = ((10F * CockpitTA_152HJ.this.setOld.beaconRange) + CockpitTA_152HJ.this.getBeaconRange()) / 11F;
                float f1 = ((TA_152HJ) CockpitTA_152HJ.this.aircraft()).k14Distance;
                CockpitTA_152HJ.this.setNew.k14w = (5F * CockpitTA_152HJ.k14TargetWingspanScale[((TA_152HJ) CockpitTA_152HJ.this.aircraft()).k14WingspanType]) / f1;
                CockpitTA_152HJ.this.setNew.k14w = (0.9F * CockpitTA_152HJ.this.setOld.k14w) + (0.1F * CockpitTA_152HJ.this.setNew.k14w);
                CockpitTA_152HJ.this.setNew.k14wingspan = (0.9F * CockpitTA_152HJ.this.setOld.k14wingspan) + (0.1F * CockpitTA_152HJ.k14TargetMarkScale[((TA_152HJ) CockpitTA_152HJ.this.aircraft()).k14WingspanType]);
                CockpitTA_152HJ.this.setNew.k14mode = (0.8F * CockpitTA_152HJ.this.setOld.k14mode) + (0.2F * ((TA_152HJ) CockpitTA_152HJ.this.aircraft()).k14Mode);
                Vector3d vector3d = CockpitTA_152HJ.this.aircraft().FM.getW();
                double d = 0.00125D * f1;
                float f2 = (float) Math.toDegrees(d * vector3d.z);
                float f3 = -(float) Math.toDegrees(d * vector3d.y);
                float f4 = CockpitTA_152HJ.this.floatindex((f1 - 200F) * 0.04F, CockpitTA_152HJ.k14BulletDrop) - CockpitTA_152HJ.k14BulletDrop[0];
                f3 += (float) Math.toDegrees(Math.atan(f4 / f1));
                CockpitTA_152HJ.this.setNew.k14x = (0.92F * CockpitTA_152HJ.this.setOld.k14x) + (0.08F * f2);
                CockpitTA_152HJ.this.setNew.k14y = (0.92F * CockpitTA_152HJ.this.setOld.k14y) + (0.08F * f3);
                if (CockpitTA_152HJ.this.setNew.k14x > 7F) {
                    CockpitTA_152HJ.this.setNew.k14x = 7F;
                }
                if (CockpitTA_152HJ.this.setNew.k14x < -7F) {
                    CockpitTA_152HJ.this.setNew.k14x = -7F;
                }
                if (CockpitTA_152HJ.this.setNew.k14y > 7F) {
                    CockpitTA_152HJ.this.setNew.k14y = 7F;
                }
                if (CockpitTA_152HJ.this.setNew.k14y < -7F) {
                    CockpitTA_152HJ.this.setNew.k14y = -7F;
                }
    ...
    public CockpitTA_152HJ() {
        super("3DO/Cockpit/Ta-152H-Paulus/hier_EZ42_Jumo222.him", "bf109");
        this.gun = new Gun[5];
    ...
    public void reflectWorldToInstruments(float f) {
        int i = ((TA_152HJ) this.aircraft()).k14Mode;
        boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("NeedleKMH", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitTA_152HJ.speedometerScale), 0.0F, 0.0F);
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            this.mesh.chunkSetAngles("NeedleRPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitTA_152HJ.rpmScale), 0.0F, 0.0F);
        }
        this.mesh.chunkSetAngles("NeedleFuel", this.floatindex(this.cvt(this.fm.M.fuel / 0.92F, 0.0F, 400F, 0.0F, 4F), CockpitTA_152HJ.fuelScale), 0.0F, 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            ...
            this.mesh.chunkSetAngles("NeedleAirPress1", -this.floatindex(this.cvt(this.fm.getAltitude() / 1000F, 0.0F, 15F, 0.0F, 8F), CockpitTA_152HJ.altScale), 0.0F, 0.0F);
            ...
            this.mesh.chunkSetAngles("NeedleAirPress2", this.floatindex(this.cvt(this.fm.getAltitude() / 1000F, 0.0F, 2.5F, 0.0F, 8F), CockpitTA_152HJ.presScale), 0.0F, 0.0F);
        }
        if (((this.fm.AS.astateCockpitState & 0x20) == 0) && ((this.fm.AS.astateCockpitState & 0x80) == 0)) {
            this.mesh.chunkSetAngles("NeedleCD", this.setNew.vspeed < 0.0F ? this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitTA_152HJ.vsiNeedleScale) : -this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitTA_152HJ.vsiNeedleScale), 0.0F, 0.0F);
        }
        if (((this.fm.AS.astateCockpitState & 0x40) == 0) && ((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
        ...
        this.mesh.chunkSetAngles("SecTrigger2", -(240F + f1) * (this.pictClap = (0.85F * this.pictClap) + (0.15F * l)), 0.0F, 0.0F);
        this.mesh.chunkSetLocate("SecTrigger", Cockpit.xyz, Cockpit.ypr);
    ...
    private static final float k14TargetMarkScale[]     = { 0.0F, -0.2377F, -5.7991F, -21.9606F, -35.46F, -44.539F, -48.5318F, -84.2771F, -96.9686F, -106F };
    private static final float k14TargetWingspanScale[] = { 11.23F, 11.28F, 12.45F, 15.85F, 18.69F, 20.6F, 21.44F, 28.96F, 31.65F, 33.53F };
    ...
    static {
        Property.set(CockpitTA_152HJ.class, "normZN", 0.74F);
        Property.set(CockpitTA_152HJ.class, "gsZN", 0.66F);
    }
