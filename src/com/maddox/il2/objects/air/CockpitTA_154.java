...
public class CockpitTA_154 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            CockpitTA_154.this.setNew.waypointAzimuth.setDeg(CockpitTA_154.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitTA_154.this.waypointAzimuth() - CockpitTA_154.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(CockpitTA_154.this.fm.Or.getKren()) < 30F) {
                CockpitTA_154.this.setNew.azimuth.setDeg(CockpitTA_154.this.setOld.azimuth.getDeg(1.0F), CockpitTA_154.this.fm.Or.azimut());
            }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitTA_154.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitTA_154.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 0.0F, 4000F, 0.0F, 8F), CockpitTA_154.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelQuantity1", -44.5F + this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 400F, 0.0F, 8F), CockpitTA_154.fuelScale), 0.0F, 0.0F);
