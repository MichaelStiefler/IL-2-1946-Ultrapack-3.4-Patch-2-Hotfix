...
public class CockpitTA_183 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitTA_183.this.fm != null) {
                CockpitTA_183.this.setTmp = CockpitTA_183.this.setOld;
                CockpitTA_183.this.setOld = CockpitTA_183.this.setNew;
                CockpitTA_183.this.setNew = CockpitTA_183.this.setTmp;
                ...
                CockpitTA_183.this.setNew.vspeed = ((499F * CockpitTA_183.this.setOld.vspeed) + CockpitTA_183.this.fm.getVertSpeed()) / 500F;
                CockpitTA_183.this.setNew.waypointAzimuth.setDeg(CockpitTA_183.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitTA_183.this.waypointAzimuth() - CockpitTA_183.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitTA_183.this.fm.Or.getKren()) < 30F) {
                    CockpitTA_183.this.setNew.azimuth.setDeg(CockpitTA_183.this.setOld.azimuth.getDeg(1.0F), CockpitTA_183.this.fm.Or.azimut());
                }
                float f = ((TA_183) CockpitTA_183.this.aircraft()).k14Distance;
                CockpitTA_183.this.setNew.k14w = (5F * CockpitTA_183.k14TargetWingspanScale[((TA_183) CockpitTA_183.this.aircraft()).k14WingspanType]) / f;
                ...
                Vector3d vector3d = CockpitTA_183.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitTA_183.this.floatindex((f - 200F) * 0.04F, CockpitTA_183.k14BulletDrop) - CockpitTA_183.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitTA_183.this.setNew.k14x = (0.92F * CockpitTA_183.this.setOld.k14x) + (0.08F * f1);
                CockpitTA_183.this.setNew.k14y = (0.92F * CockpitTA_183.this.setOld.k14y) + (0.08F * f2);
                if (CockpitTA_183.this.setNew.k14x > 7F) {
                    CockpitTA_183.this.setNew.k14x = 7F;
                }
                if (CockpitTA_183.this.setNew.k14x < -7F) {
                    CockpitTA_183.this.setNew.k14x = -7F;
                }
                if (CockpitTA_183.this.setNew.k14y > 7F) {
                    CockpitTA_183.this.setNew.k14y = 7F;
                }
                if (CockpitTA_183.this.setNew.k14y < -7F) {
                    CockpitTA_183.this.setNew.k14y = -7F;
                }
                CockpitTA_183.this.setNew.beaconDirection = ((10F * CockpitTA_183.this.setOld.beaconDirection) + CockpitTA_183.this.getBeaconDirection()) / 11F;
                CockpitTA_183.this.setNew.beaconRange = ((10F * CockpitTA_183.this.setOld.beaconRange) + CockpitTA_183.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        int i = ((TA_183) this.aircraft()).k14Mode;
        boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("NeedleVSI", this.setNew.vspeed < 0.0F ? -this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitTA_183.vsiNeedleScale) : this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitTA_183.vsiNeedleScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleKMH", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitTA_183.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleRPM", 55F + this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitTA_183.rpmScale), 0.0F, 0.0F);
