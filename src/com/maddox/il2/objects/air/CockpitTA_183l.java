...
public class CockpitTA_183l extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitTA_183l.this.fm != null) {
                CockpitTA_183l.this.setTmp = CockpitTA_183l.this.setOld;
                CockpitTA_183l.this.setOld = CockpitTA_183l.this.setNew;
                CockpitTA_183l.this.setNew = CockpitTA_183l.this.setTmp;
                CockpitTA_183l.this.setNew.altimeter = CockpitTA_183l.this.fm.getAltitude();
                if (CockpitTA_183l.this.cockpitDimControl) {
                    if (CockpitTA_183l.this.setNew.dimPosition > 0.0F) {
                        CockpitTA_183l.this.setNew.dimPosition = CockpitTA_183l.this.setOld.dimPosition - 0.05F;
                    }
                } else if (CockpitTA_183l.this.setNew.dimPosition < 1.0F) {
                    CockpitTA_183l.this.setNew.dimPosition = CockpitTA_183l.this.setOld.dimPosition + 0.05F;
                }
                CockpitTA_183l.this.setNew.throttle = (0.92F * CockpitTA_183l.this.setOld.throttle) + (0.08F * CockpitTA_183l.this.fm.CT.PowerControl);
                CockpitTA_183l.this.setNew.vspeed = ((499F * CockpitTA_183l.this.setOld.vspeed) + CockpitTA_183l.this.fm.getVertSpeed()) / 500F;
                CockpitTA_183l.this.setNew.waypointAzimuth.setDeg(CockpitTA_183l.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitTA_183l.this.waypointAzimuth() - CockpitTA_183l.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitTA_183l.this.fm.Or.getKren()) < 30F) {
                    CockpitTA_183l.this.setNew.azimuth.setDeg(CockpitTA_183l.this.setOld.azimuth.getDeg(1.0F), CockpitTA_183l.this.fm.Or.azimut());
                }
                float f = ((TA_183l) CockpitTA_183l.this.aircraft()).k14Distance;
                CockpitTA_183l.this.setNew.k14w = (5F * CockpitTA_183l.k14TargetWingspanScale[((TA_183l) CockpitTA_183l.this.aircraft()).k14WingspanType]) / f;
                CockpitTA_183l.this.setNew.k14w = (0.9F * CockpitTA_183l.this.setOld.k14w) + (0.1F * CockpitTA_183l.this.setNew.k14w);
                CockpitTA_183l.this.setNew.k14wingspan = (0.9F * CockpitTA_183l.this.setOld.k14wingspan) + (0.1F * CockpitTA_183l.k14TargetMarkScale[((TA_183l) CockpitTA_183l.this.aircraft()).k14WingspanType]);
                CockpitTA_183l.this.setNew.k14mode = (0.8F * CockpitTA_183l.this.setOld.k14mode) + (0.2F * ((TA_183l) CockpitTA_183l.this.aircraft()).k14Mode);
                Vector3d vector3d = CockpitTA_183l.this.aircraft().FM.getW();
                double d = 0.00125D * f;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitTA_183l.this.floatindex((f - 200F) * 0.04F, CockpitTA_183l.k14BulletDrop) - CockpitTA_183l.k14BulletDrop[0];
                f2 += (float) Math.toDegrees(Math.atan(f3 / f));
                CockpitTA_183l.this.setNew.k14x = (0.92F * CockpitTA_183l.this.setOld.k14x) + (0.08F * f1);
                CockpitTA_183l.this.setNew.k14y = (0.92F * CockpitTA_183l.this.setOld.k14y) + (0.08F * f2);
                if (CockpitTA_183l.this.setNew.k14x > 7F) {
                    CockpitTA_183l.this.setNew.k14x = 7F;
                }
                if (CockpitTA_183l.this.setNew.k14x < -7F) {
                    CockpitTA_183l.this.setNew.k14x = -7F;
                }
                if (CockpitTA_183l.this.setNew.k14y > 7F) {
                    CockpitTA_183l.this.setNew.k14y = 7F;
                }
                if (CockpitTA_183l.this.setNew.k14y < -7F) {
                    CockpitTA_183l.this.setNew.k14y = -7F;
                }
                CockpitTA_183l.this.setNew.beaconDirection = ((10F * CockpitTA_183l.this.setOld.beaconDirection) + CockpitTA_183l.this.getBeaconDirection()) / 11F;
                CockpitTA_183l.this.setNew.beaconRange = ((10F * CockpitTA_183l.this.setOld.beaconRange) + CockpitTA_183l.this.getBeaconRange()) / 11F;
            }
            return true;
        }
    ...
    public CockpitTA_183l() {
        super("3DO/Cockpit/Ta-183/hierLight.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        int i = ((TA_183l) this.aircraft()).k14Mode;
        boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("NeedleVSI", this.setNew.vspeed >= 0.0F ? this.floatindex(this.cvt(this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitTA_183l.vsiNeedleScale) : -this.floatindex(this.cvt(-this.setNew.vspeed, 0.0F, 30F, 0.0F, 6F), CockpitTA_183l.vsiNeedleScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleKMH", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 900F, 0.0F, 9F), CockpitTA_183l.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedleRPM", 55F + this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitTA_183l.rpmScale), 0.0F, 0.0F);
