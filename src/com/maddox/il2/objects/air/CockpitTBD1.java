    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitTBD1.this.fm != null) {
                ...
                if (Math.abs(CockpitTBD1.this.fm.Or.getKren()) < 30F) {
                    CockpitTBD1.this.setNew.azimuth.setDeg(CockpitTBD1.this.setOld.azimuth.getDeg(1.0F), CockpitTBD1.this.fm.Or.azimut());
                }
...
//        this.tmpV = new Vector3d();
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 981.5598F, 0.0F, 53F), CockpitTBD1.speedometerScale), 0.0F, 0.0F);
