...
public class CockpitTBX1 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitTBX1.this.fm != null) {
                CockpitTBX1.this.setTmp = CockpitTBX1.this.setOld;
                CockpitTBX1.this.setOld = CockpitTBX1.this.setNew;
                CockpitTBX1.this.setNew = CockpitTBX1.this.setTmp;
                CockpitTBX1.this.setNew.throttle = (0.85F * CockpitTBX1.this.setOld.throttle) + (CockpitTBX1.this.fm.CT.PowerControl * 0.15F);
                CockpitTBX1.this.setNew.prop = (0.85F * CockpitTBX1.this.setOld.prop) + (CockpitTBX1.this.fm.CT.getStepControl() * 0.15F);
                CockpitTBX1.this.setNew.altimeter = CockpitTBX1.this.fm.getAltitude();
                float f = CockpitTBX1.this.waypointAzimuth();
                if (Math.abs(CockpitTBX1.this.fm.Or.getKren()) < 30F) {
                    CockpitTBX1.this.setNew.azimuth.setDeg(CockpitTBX1.this.setOld.azimuth.getDeg(1.0F), CockpitTBX1.this.fm.Or.azimut());
                }
                CockpitTBX1.this.setNew.waypointAzimuth.setDeg(CockpitTBX1.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitTBX1.this.setNew.vspeed = ((199F * CockpitTBX1.this.setOld.vspeed) + CockpitTBX1.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 796.3598F, 0.0F, 11F), CockpitTBX1.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitTBX1.variometerScale), 0.0F);
