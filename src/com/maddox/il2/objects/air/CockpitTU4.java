...
public class CockpitTU4 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitTU4.this.fm != null) {
                CockpitTU4.this.setTmp = CockpitTU4.this.setOld;
                CockpitTU4.this.setOld = CockpitTU4.this.setNew;
                CockpitTU4.this.setNew = CockpitTU4.this.setTmp;
                CockpitTU4.this.setNew.throttle1 = (0.85F * CockpitTU4.this.setOld.throttle1) + (CockpitTU4.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitTU4.this.setNew.throttle2 = (0.85F * CockpitTU4.this.setOld.throttle2) + (CockpitTU4.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitTU4.this.setNew.prop1 = (0.85F * CockpitTU4.this.setOld.prop1) + (CockpitTU4.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitTU4.this.setNew.prop2 = (0.85F * CockpitTU4.this.setOld.prop2) + (CockpitTU4.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitTU4.this.setNew.altimeter = CockpitTU4.this.fm.getAltitude();
                float f = CockpitTU4.this.waypointAzimuth();
                if (Math.abs(CockpitTU4.this.fm.Or.getKren()) < 30F) {
                    CockpitTU4.this.setNew.azimuth.setDeg(CockpitTU4.this.setOld.azimuth.getDeg(1.0F), CockpitTU4.this.fm.Or.azimut());
                }
                CockpitTU4.this.setNew.waypointAzimuth.setDeg(CockpitTU4.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitTU4.this.setNew.waypointDeviation.setDeg(CockpitTU4.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitTU4.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitTU4.this.setNew.vspeed = ((199F * CockpitTU4.this.setOld.vspeed) + CockpitTU4.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
...
//        pictGear = 0.0F;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitTU4.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitTU4.speedometerScale), 0.0F);
