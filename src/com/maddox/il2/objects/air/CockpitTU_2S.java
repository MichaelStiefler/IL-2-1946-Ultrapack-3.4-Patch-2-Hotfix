...
public class CockpitTU_2S extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitTU_2S.this.fm != null) {
                CockpitTU_2S.this.setTmp = CockpitTU_2S.this.setOld;
                CockpitTU_2S.this.setOld = CockpitTU_2S.this.setNew;
                CockpitTU_2S.this.setNew = CockpitTU_2S.this.setTmp;
                if (CockpitTU_2S.this.fm.CT.Weapons[3] != null) {
                    if (CockpitTU_2S.this.fm.CT.Weapons[3].length > 0) {
                        CockpitTU_2S.this.bBombs[1] = !CockpitTU_2S.this.fm.CT.Weapons[3][0].haveBullets();
                    }
                    if (CockpitTU_2S.this.fm.CT.Weapons[3].length > 1) {
                        CockpitTU_2S.this.bBombs[0] = !CockpitTU_2S.this.fm.CT.Weapons[3][1].haveBullets();
                    }
                    if (CockpitTU_2S.this.fm.CT.Weapons[3].length > 2) {
                        CockpitTU_2S.this.bBombs[3] = !CockpitTU_2S.this.fm.CT.Weapons[3][2].haveBullets();
                    }
                    if (CockpitTU_2S.this.fm.CT.Weapons[3].length > 3) {
                        CockpitTU_2S.this.bBombs[2] = !CockpitTU_2S.this.fm.CT.Weapons[3][3].haveBullets();
                    }
                    if (CockpitTU_2S.this.fm.CT.Weapons[3].length > 4) {
                        CockpitTU_2S.this.bBombs[5] = !CockpitTU_2S.this.fm.CT.Weapons[3][4].haveBullets();
                    }
                    if (CockpitTU_2S.this.fm.CT.Weapons[3].length > 5) {
                        CockpitTU_2S.this.bBombs[4] = !CockpitTU_2S.this.fm.CT.Weapons[3][5].haveBullets();
                    }
                    if (CockpitTU_2S.this.fm.CT.Weapons[3].length > 6) {
                        CockpitTU_2S.this.bBombs[5] = CockpitTU_2S.this.bBombs[5] || !CockpitTU_2S.this.fm.CT.Weapons[3][6].haveBullets();
                    }
                    if (CockpitTU_2S.this.fm.CT.Weapons[3].length > 7) {
                        CockpitTU_2S.this.bBombs[4] = CockpitTU_2S.this.bBombs[4] || !CockpitTU_2S.this.fm.CT.Weapons[3][7].haveBullets();
                    }
                    if (CockpitTU_2S.this.fm.CT.Weapons[3].length > 8) {
                        CockpitTU_2S.this.bBombs[7] = !CockpitTU_2S.this.fm.CT.Weapons[3][8].haveBullets();
                    }
                    if (CockpitTU_2S.this.fm.CT.Weapons[3].length > 9) {
                        CockpitTU_2S.this.bBombs[6] = !CockpitTU_2S.this.fm.CT.Weapons[3][9].haveBullets();
                    }
                }
                CockpitTU_2S.this.setNew.throttle1 = (0.9F * CockpitTU_2S.this.setOld.throttle1) + (0.1F * CockpitTU_2S.this.fm.EI.engines[0].getControlThrottle());
                CockpitTU_2S.this.setNew.prop1 = (0.9F * CockpitTU_2S.this.setOld.prop1) + (0.1F * CockpitTU_2S.this.fm.EI.engines[0].getControlProp());
                CockpitTU_2S.this.setNew.mix1 = (0.8F * CockpitTU_2S.this.setOld.mix1) + (0.2F * CockpitTU_2S.this.fm.EI.engines[0].getControlMix());
                CockpitTU_2S.this.setNew.man1 = (0.92F * CockpitTU_2S.this.setOld.man1) + (0.08F * CockpitTU_2S.this.fm.EI.engines[0].getManifoldPressure());
                CockpitTU_2S.this.setNew.throttle2 = (0.9F * CockpitTU_2S.this.setOld.throttle2) + (0.1F * CockpitTU_2S.this.fm.EI.engines[1].getControlThrottle());
                CockpitTU_2S.this.setNew.prop2 = (0.9F * CockpitTU_2S.this.setOld.prop2) + (0.1F * CockpitTU_2S.this.fm.EI.engines[1].getControlProp());
                CockpitTU_2S.this.setNew.mix2 = (0.8F * CockpitTU_2S.this.setOld.mix2) + (0.2F * CockpitTU_2S.this.fm.EI.engines[1].getControlMix());
                CockpitTU_2S.this.setNew.man2 = (0.92F * CockpitTU_2S.this.setOld.man2) + (0.08F * CockpitTU_2S.this.fm.EI.engines[1].getManifoldPressure());
                CockpitTU_2S.this.setNew.altimeter = CockpitTU_2S.this.fm.getAltitude();
                CockpitTU_2S.this.setNew.stage1 = (0.85F * CockpitTU_2S.this.setOld.stage1) + (CockpitTU_2S.this.fm.EI.engines[0].getControlCompressor() * 0.15F);
                CockpitTU_2S.this.setNew.stage2 = (0.85F * CockpitTU_2S.this.setOld.stage2) + (CockpitTU_2S.this.fm.EI.engines[1].getControlCompressor() * 0.15F);
                if (Math.abs(CockpitTU_2S.this.fm.Or.getKren()) < 30F) {
                    CockpitTU_2S.this.setNew.azimuth.setDeg(CockpitTU_2S.this.setOld.azimuth.getDeg(1.0F), CockpitTU_2S.this.fm.Or.azimut());
                }
                CockpitTU_2S.this.setNew.vspeed = ((100F * CockpitTU_2S.this.setOld.vspeed) + CockpitTU_2S.this.fm.getVertSpeed()) / 101F;
                float f = CockpitTU_2S.this.waypointAzimuth();
                CockpitTU_2S.this.setNew.waypointAzimuth.setDeg(CockpitTU_2S.this.setOld.waypointAzimuth.getDeg(0.1F), (f - CockpitTU_2S.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitTU_2S.this.setNew.waypointDirection.setDeg(CockpitTU_2S.this.setOld.waypointDirection.getDeg(1.0F), f);
                CockpitTU_2S.this.mesh.chunkSetAngles("Z_RTurret", CockpitTU_2S.this.aircraft().FM.turret[0].tu[0], 0.0F, 0.0F);
                CockpitTU_2S.this.mesh.chunkSetAngles("Z_RGun", CockpitTU_2S.this.aircraft().FM.turret[0].tu[1], 0.0F, 0.0F);
                CockpitTU_2S.this.setNew.inert = (0.999F * CockpitTU_2S.this.setOld.inert) + (0.001F * (CockpitTU_2S.this.fm.EI.engines[0].getStage() != 6 ? 0.0F : 0.867F));
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitTU_2S.speedometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitTU_2S.speedometerScale), 0.0F, 0.0F);
        this.resetYPRmodifier();
