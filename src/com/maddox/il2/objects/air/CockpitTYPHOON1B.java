...
public class CockpitTYPHOON1B extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitTYPHOON1B.this.fm != null) {
                CockpitTYPHOON1B.this.setTmp = CockpitTYPHOON1B.this.setOld;
                CockpitTYPHOON1B.this.setOld = CockpitTYPHOON1B.this.setNew;
                CockpitTYPHOON1B.this.setNew = CockpitTYPHOON1B.this.setTmp;
                CockpitTYPHOON1B.this.setNew.throttle = (0.92F * CockpitTYPHOON1B.this.setOld.throttle) + (0.08F * CockpitTYPHOON1B.this.fm.CT.PowerControl);
                CockpitTYPHOON1B.this.setNew.prop = (0.92F * CockpitTYPHOON1B.this.setOld.prop) + (0.08F * CockpitTYPHOON1B.this.fm.EI.engines[0].getControlProp());
                CockpitTYPHOON1B.this.setNew.mix = (0.92F * CockpitTYPHOON1B.this.setOld.mix) + (0.08F * CockpitTYPHOON1B.this.fm.EI.engines[0].getControlMix());
                CockpitTYPHOON1B.this.setNew.altimeter = CockpitTYPHOON1B.this.fm.getAltitude();
                CockpitTYPHOON1B.this.setNew.waypointAzimuth.setDeg(CockpitTYPHOON1B.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitTYPHOON1B.this.waypointAzimuth() - CockpitTYPHOON1B.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitTYPHOON1B.this.fm.Or.getKren()) < 30F) {
                    CockpitTYPHOON1B.this.setNew.azimuth.setDeg(CockpitTYPHOON1B.this.setOld.azimuth.getDeg(1.0F), CockpitTYPHOON1B.this.fm.Or.azimut());
                }
                CockpitTYPHOON1B.this.setNew.vspeed = (0.99F * CockpitTYPHOON1B.this.setOld.vspeed) + (0.01F * CockpitTYPHOON1B.this.fm.getVertSpeed());
                if (CockpitTYPHOON1B.this.fm.CT.GearControl < 0.5F) {
                    if (CockpitTYPHOON1B.this.setNew.gearPhi > 0.0F) {
                        CockpitTYPHOON1B.this.setNew.gearPhi = CockpitTYPHOON1B.this.setOld.gearPhi - 0.021F;
                    }
                } else if (CockpitTYPHOON1B.this.setNew.gearPhi < 1.0F) {
                    CockpitTYPHOON1B.this.setNew.gearPhi = CockpitTYPHOON1B.this.setOld.gearPhi + 0.021F;
                }
            }
            return true;
    ...
    public CockpitTYPHOON1B() {
        super("3DO/Cockpit/TempestMkV/Typhoonhier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 10F), CockpitTYPHOON1B.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_VY", -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitTYPHOON1B.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 5000F, 0.0F, 10F), CockpitTYPHOON1B.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, -306F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitTYPHOON1B.radScale), 0.0F, 0.0F);
