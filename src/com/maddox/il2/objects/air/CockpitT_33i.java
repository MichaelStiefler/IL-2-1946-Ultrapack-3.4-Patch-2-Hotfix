...
public class CockpitT_33i extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitT_33i.this.fm != null) {
                CockpitT_33i.this.setTmp = CockpitT_33i.this.setOld;
                CockpitT_33i.this.setOld = CockpitT_33i.this.setNew;
                CockpitT_33i.this.setNew = CockpitT_33i.this.setTmp;
                CockpitT_33i.this.setNew.throttle = (0.85F * CockpitT_33i.this.setOld.throttle) + (CockpitT_33i.this.fm.CT.PowerControl * 0.15F);
                CockpitT_33i.this.setNew.prop = (0.85F * CockpitT_33i.this.setOld.prop) + (CockpitT_33i.this.fm.CT.getStepControl() * 0.15F);
                CockpitT_33i.this.setNew.stage = (0.85F * CockpitT_33i.this.setOld.stage) + (CockpitT_33i.this.fm.EI.engines[0].getControlCompressor() * 0.15F);
                CockpitT_33i.this.setNew.mix = (0.85F * CockpitT_33i.this.setOld.mix) + (CockpitT_33i.this.fm.EI.engines[0].getControlMix() * 0.15F);
                CockpitT_33i.this.setNew.altimeter = CockpitT_33i.this.fm.getAltitude();
                if (Math.abs(CockpitT_33i.this.fm.Or.getKren()) < 30F) {
                    CockpitT_33i.this.setNew.azimuth.setDeg(CockpitT_33i.this.setOld.azimuth.getDeg(1.0F), CockpitT_33i.this.fm.Or.azimut());
                }
                CockpitT_33i.this.setNew.vspeed = ((199F * CockpitT_33i.this.setOld.vspeed) + CockpitT_33i.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        Cockpit.xyz[2] = this.cvt(f, 0.01F, 0.99F, 0.0F, 0.7F);
        this.mesh.chunkSetLocate("Cylinder_D0", Cockpit.xyz, Cockpit.ypr);
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitT_33i.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitT_33i.variometerScale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitT_33i.class, "astatePilotIndx", 1);
        Property.set(CockpitT_33i.class, "normZN", 2.35F);
        Property.set(CockpitT_33i.class, "gsZN", 2.35F);
    }
}
