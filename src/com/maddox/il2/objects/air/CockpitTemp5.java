...
public class CockpitTemp5 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitTemp5.this.fm != null) {
                CockpitTemp5.this.setTmp = CockpitTemp5.this.setOld;
                CockpitTemp5.this.setOld = CockpitTemp5.this.setNew;
                CockpitTemp5.this.setNew = CockpitTemp5.this.setTmp;
                CockpitTemp5.this.setNew.throttle = (0.92F * CockpitTemp5.this.setOld.throttle) + (0.08F * CockpitTemp5.this.fm.CT.PowerControl);
                CockpitTemp5.this.setNew.prop = (0.92F * CockpitTemp5.this.setOld.prop) + (0.08F * CockpitTemp5.this.fm.EI.engines[0].getControlProp());
                CockpitTemp5.this.setNew.mix = (0.92F * CockpitTemp5.this.setOld.mix) + (0.08F * CockpitTemp5.this.fm.EI.engines[0].getControlMix());
                CockpitTemp5.this.setNew.altimeter = CockpitTemp5.this.fm.getAltitude();
                CockpitTemp5.this.setNew.waypointAzimuth.setDeg(CockpitTemp5.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitTemp5.this.waypointAzimuth() - CockpitTemp5.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitTemp5.this.fm.Or.getKren()) < 30F) {
                    CockpitTemp5.this.setNew.azimuth.setDeg(CockpitTemp5.this.setOld.azimuth.getDeg(1.0F), CockpitTemp5.this.fm.Or.azimut());
                }
                CockpitTemp5.this.setNew.vspeed = (0.99F * CockpitTemp5.this.setOld.vspeed) + (0.01F * CockpitTemp5.this.fm.getVertSpeed());
                if (CockpitTemp5.this.fm.CT.GearControl < 0.5F) {
                    if (CockpitTemp5.this.setNew.gearPhi > 0.0F) {
                        CockpitTemp5.this.setNew.gearPhi = CockpitTemp5.this.setOld.gearPhi - 0.021F;
                    }
                } else if (CockpitTemp5.this.setNew.gearPhi < 1.0F) {
                    CockpitTemp5.this.setNew.gearPhi = CockpitTemp5.this.setOld.gearPhi + 0.021F;
                }
            }
            return true;
    ...
    public CockpitTemp5() {
        super("3DO/Cockpit/TempestMkV/Typhoon1late.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Canopy", 0.0F, 0.0F, 90F);
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 10F), CockpitTemp5.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_VY", -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitTemp5.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 5000F, 0.0F, 10F), CockpitTemp5.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, -306F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitTemp5.radScale), 0.0F, 0.0F);
