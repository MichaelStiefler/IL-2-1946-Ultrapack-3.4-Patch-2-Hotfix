...
public class CockpitU2UT extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitU2UT.this.fm != null) {
                if (CockpitU2UT.this.bNeedSetUp) {
                    CockpitU2UT.this.reflectPlaneMats();
                    CockpitU2UT.this.bNeedSetUp = false;
                }
                CockpitU2UT.this.setTmp = CockpitU2UT.this.setOld;
                CockpitU2UT.this.setOld = CockpitU2UT.this.setNew;
                CockpitU2UT.this.setNew = CockpitU2UT.this.setTmp;
                CockpitU2UT.this.setNew.throttle = ((10F * CockpitU2UT.this.setOld.throttle) + CockpitU2UT.this.fm.CT.PowerControl) / 11F;
                CockpitU2UT.this.setNew.prop = ((10F * CockpitU2UT.this.setOld.prop) + CockpitU2UT.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitU2UT.this.setNew.altimeter = CockpitU2UT.this.fm.getAltitude();
                CockpitU2UT.this.setNew.waypointAzimuth.setDeg(CockpitU2UT.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitU2UT.this.waypointAzimuth() - CockpitU2UT.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitU2UT.this.fm.Or.getKren()) < 30F) {
                    CockpitU2UT.this.setNew.azimuth.setDeg(CockpitU2UT.this.setOld.azimuth.getDeg(1.0F), CockpitU2UT.this.fm.Or.azimut());
                }
                CockpitU2UT.this.setNew.vspeed = ((199F * CockpitU2UT.this.setOld.vspeed) + CockpitU2UT.this.fm.getVertSpeed()) / 200F;
                boolean flag = false;
                if (CockpitU2UT.this.setNew.gCrankAngle < (CockpitU2UT.this.fm.CT.getGear() - 0.005F)) {
                    if (Math.abs(CockpitU2UT.this.setNew.gCrankAngle - CockpitU2UT.this.fm.CT.getGear()) < 0.33F) {
                        CockpitU2UT.this.setNew.gCrankAngle += 0.0025F;
                        flag = true;
                    } else {
                        CockpitU2UT.this.setNew.gCrankAngle = CockpitU2UT.this.fm.CT.getGear();
                        CockpitU2UT.this.setOld.gCrankAngle = CockpitU2UT.this.fm.CT.getGear();
                    }
                }
                if (CockpitU2UT.this.setNew.gCrankAngle > (CockpitU2UT.this.fm.CT.getGear() + 0.005F)) {
                    if (Math.abs(CockpitU2UT.this.setNew.gCrankAngle - CockpitU2UT.this.fm.CT.getGear()) < 0.33F) {
                ...
                if (flag != this.sfxPlaying) {
                    if (flag) {
                        CockpitU2UT.this.sfxStart(16);
                    } else {
                        CockpitU2UT.this.sfxStop(16);
                    }
    ...
    public CockpitU2UT() {
        super("3DO/Cockpit/U-2UT-PIL/CockpitU2VS.him", "i16");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zGas1a", 0.0F, this.floatindex(this.cvt(this.fm.M.fuel, 0.0F, 190F, 0.0F, 14F), CockpitU2UT.fuelQuantityScale), 0.0F);
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitU2UT.speedometerScale), 0.0F);
        if (((this.fm.AS.astateCockpitState & 4) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            ...
            this.mesh.chunkSetAngles("zGasPrsxx1a", 0.0F, this.cvt(this.fm.M.fuel <= 1.0F ? 0.0F : 0.26F, 0.0F, 10F, 0.0F, 275F), 0.0F);
        }
        ...
        if (((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x20) == 0)) {
            this.mesh.chunkSetAngles("zRPS1a", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 2400F, 0.0F, 13F), CockpitU2UT.engineRPMScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zOilPrsxx1a", 0.0F, this.cvt(1.0F + (0.05F * this.fm.EI.engines[0].tOilOut), 0.0F, 15F, 0.0F, 270F), 0.0F);
    ...
    public void reflectCockpitState() {
        if (((this.fm.AS.astateCockpitState & 4) != 0) || ((this.fm.AS.astateCockpitState & 0x10) != 0)) {
            ...
            this.mesh.chunkVisible("zOilPrsxx1a", false);
