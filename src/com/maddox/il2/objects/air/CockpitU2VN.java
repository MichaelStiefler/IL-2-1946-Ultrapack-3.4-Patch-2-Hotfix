...
public class CockpitU2VN extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitU2VN.this.fm != null) {
                if (CockpitU2VN.this.bNeedSetUp) {
                    CockpitU2VN.this.reflectPlaneMats();
                    CockpitU2VN.this.bNeedSetUp = false;
                }
                CockpitU2VN.this.setTmp = CockpitU2VN.this.setOld;
                CockpitU2VN.this.setOld = CockpitU2VN.this.setNew;
                CockpitU2VN.this.setNew = CockpitU2VN.this.setTmp;
                CockpitU2VN.this.setNew.throttle = ((10F * CockpitU2VN.this.setOld.throttle) + CockpitU2VN.this.fm.CT.PowerControl) / 11F;
                CockpitU2VN.this.setNew.prop = ((10F * CockpitU2VN.this.setOld.prop) + CockpitU2VN.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitU2VN.this.setNew.altimeter = CockpitU2VN.this.fm.getAltitude();
                CockpitU2VN.this.setNew.waypointAzimuth.setDeg(CockpitU2VN.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitU2VN.this.waypointAzimuth() - CockpitU2VN.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitU2VN.this.fm.Or.getKren()) < 30F) {
                    CockpitU2VN.this.setNew.azimuth.setDeg(CockpitU2VN.this.setOld.azimuth.getDeg(1.0F), CockpitU2VN.this.fm.Or.azimut());
                }
                CockpitU2VN.this.setNew.vspeed = ((199F * CockpitU2VN.this.setOld.vspeed) + CockpitU2VN.this.fm.getVertSpeed()) / 200F;
                boolean flag = false;
                if (CockpitU2VN.this.setNew.gCrankAngle < (CockpitU2VN.this.fm.CT.getGear() - 0.005F)) {
                    if (Math.abs(CockpitU2VN.this.setNew.gCrankAngle - CockpitU2VN.this.fm.CT.getGear()) < 0.33F) {
                        CockpitU2VN.this.setNew.gCrankAngle += 0.0025F;
                        flag = true;
                    } else {
                        CockpitU2VN.this.setNew.gCrankAngle = CockpitU2VN.this.fm.CT.getGear();
                        CockpitU2VN.this.setOld.gCrankAngle = CockpitU2VN.this.fm.CT.getGear();
                    }
                }
                if (CockpitU2VN.this.setNew.gCrankAngle > (CockpitU2VN.this.fm.CT.getGear() + 0.005F)) {
                    if (Math.abs(CockpitU2VN.this.setNew.gCrankAngle - CockpitU2VN.this.fm.CT.getGear()) < 0.33F) {
                ...
                if (flag != this.sfxPlaying) {
                    if (flag) {
                        CockpitU2VN.this.sfxStart(16);
                    } else {
                        CockpitU2VN.this.sfxStop(16);
                    }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zGas1a", 0.0F, this.floatindex(this.cvt(this.fm.M.fuel, 0.0F, 190F, 0.0F, 14F), CockpitU2VN.fuelQuantityScale), 0.0F);
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitU2VN.speedometerScale), 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x20) == 0)) {
            this.mesh.chunkSetAngles("zRPS1a", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 2400F, 0.0F, 13F), CockpitU2VN.engineRPMScale), 0.0F);
