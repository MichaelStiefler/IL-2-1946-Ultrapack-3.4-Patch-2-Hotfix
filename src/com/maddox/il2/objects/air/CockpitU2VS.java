...
public class CockpitU2VS extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitU2VS.this.fm != null) {
                ...
                CockpitU2VS.this.setNew.prop = ((10F * CockpitU2VS.this.setOld.prop) + CockpitU2VS.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitU2VS.this.setNew.altimeter = CockpitU2VS.this.fm.getAltitude();
                CockpitU2VS.this.setNew.waypointAzimuth.setDeg(CockpitU2VS.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitU2VS.this.waypointAzimuth() - CockpitU2VS.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitU2VS.this.fm.Or.getKren()) < 30F) {
                    CockpitU2VS.this.setNew.azimuth.setDeg(CockpitU2VS.this.setOld.azimuth.getDeg(1.0F), CockpitU2VS.this.fm.Or.azimut());
                }
                CockpitU2VS.this.setNew.vspeed = ((199F * CockpitU2VS.this.setOld.vspeed) + CockpitU2VS.this.fm.getVertSpeed()) / 200F;
                boolean flag = false;
                if (CockpitU2VS.this.setNew.gCrankAngle < (CockpitU2VS.this.fm.CT.getGear() - 0.005F)) {
                    if (Math.abs(CockpitU2VS.this.setNew.gCrankAngle - CockpitU2VS.this.fm.CT.getGear()) < 0.33F) {
                        CockpitU2VS.this.setNew.gCrankAngle += 0.0025F;
                        flag = true;
                    } else {
                        CockpitU2VS.this.setNew.gCrankAngle = CockpitU2VS.this.fm.CT.getGear();
                        CockpitU2VS.this.setOld.gCrankAngle = CockpitU2VS.this.fm.CT.getGear();
                    }
                }
                if (CockpitU2VS.this.setNew.gCrankAngle > (CockpitU2VS.this.fm.CT.getGear() + 0.005F)) {
                    if (Math.abs(CockpitU2VS.this.setNew.gCrankAngle - CockpitU2VS.this.fm.CT.getGear()) < 0.33F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zGas1a", 0.0F, this.floatindex(this.cvt(this.fm.M.fuel, 0.0F, 190F, 0.0F, 14F), CockpitU2VS.fuelQuantityScale), 0.0F);
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitU2VS.speedometerScale), 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x20) == 0)) {
            this.mesh.chunkSetAngles("zRPS1a", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 2400F, 0.0F, 13F), CockpitU2VS.engineRPMScale), 0.0F);
