...
public class CockpitU2VSs extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitU2VSs.this.fm != null) {
                if (CockpitU2VSs.this.bNeedSetUp) {
                    CockpitU2VSs.this.reflectPlaneMats();
                    CockpitU2VSs.this.bNeedSetUp = false;
                }
                CockpitU2VSs.this.setTmp = CockpitU2VSs.this.setOld;
                CockpitU2VSs.this.setOld = CockpitU2VSs.this.setNew;
                CockpitU2VSs.this.setNew = CockpitU2VSs.this.setTmp;
                CockpitU2VSs.this.setNew.throttle = ((10F * CockpitU2VSs.this.setOld.throttle) + CockpitU2VSs.this.fm.CT.PowerControl) / 11F;
                CockpitU2VSs.this.setNew.prop = ((10F * CockpitU2VSs.this.setOld.prop) + CockpitU2VSs.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitU2VSs.this.setNew.altimeter = CockpitU2VSs.this.fm.getAltitude();
                CockpitU2VSs.this.setNew.waypointAzimuth.setDeg(CockpitU2VSs.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitU2VSs.this.waypointAzimuth() - CockpitU2VSs.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitU2VSs.this.fm.Or.getKren()) < 30F) {
                    CockpitU2VSs.this.setNew.azimuth.setDeg(CockpitU2VSs.this.setOld.azimuth.getDeg(1.0F), CockpitU2VSs.this.fm.Or.azimut());
                }
                CockpitU2VSs.this.setNew.vspeed = ((199F * CockpitU2VSs.this.setOld.vspeed) + CockpitU2VSs.this.fm.getVertSpeed()) / 200F;
                boolean flag = false;
                if (CockpitU2VSs.this.setNew.gCrankAngle < (CockpitU2VSs.this.fm.CT.getGear() - 0.005F)) {
                    if (Math.abs(CockpitU2VSs.this.setNew.gCrankAngle - CockpitU2VSs.this.fm.CT.getGear()) < 0.33F) {
                        CockpitU2VSs.this.setNew.gCrankAngle += 0.0025F;
                        flag = true;
                    } else {
                        CockpitU2VSs.this.setNew.gCrankAngle = CockpitU2VSs.this.fm.CT.getGear();
                        CockpitU2VSs.this.setOld.gCrankAngle = CockpitU2VSs.this.fm.CT.getGear();
                    }
                }
                if (CockpitU2VSs.this.setNew.gCrankAngle > (CockpitU2VSs.this.fm.CT.getGear() + 0.005F)) {
                    if (Math.abs(CockpitU2VSs.this.setNew.gCrankAngle - CockpitU2VSs.this.fm.CT.getGear()) < 0.33F) {
                ...
                if (flag != this.sfxPlaying) {
                    if (flag) {
                        CockpitU2VSs.this.sfxStart(16);
                    } else {
                        CockpitU2VSs.this.sfxStop(16);
                    }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("thrtl", 30F - (57F * this.interp(this.setNew.throttle, this.setOld.throttle, f)), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Prop", (this.interp(this.setNew.prop, this.setOld.prop, f) * -57F) + 30F, 0.0F, 0.0F);
        this.mesh.chunkSetAngles("thr_tross", -30F + (57F * this.interp(this.setNew.throttle, this.setOld.throttle, f)), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zGas1a", 0.0F, this.floatindex(this.cvt(this.fm.M.fuel, 0.0F, 190F, 0.0F, 14F), CockpitU2VSs.fuelQuantityScale), 0.0F);
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitU2VSs.speedometerScale), 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x20) == 0)) {
            this.mesh.chunkSetAngles("zRPS1a", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 2400F, 0.0F, 13F), CockpitU2VSs.engineRPMScale), 0.0F);
