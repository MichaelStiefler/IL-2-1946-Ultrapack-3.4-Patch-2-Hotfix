...
public class CockpitUTI_4 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitUTI_4.this.fm != null) {
                if (CockpitUTI_4.this.bNeedSetUp) {
                    CockpitUTI_4.this.reflectPlaneMats();
                    CockpitUTI_4.this.bNeedSetUp = false;
                }
                CockpitUTI_4.this.setTmp = CockpitUTI_4.this.setOld;
                CockpitUTI_4.this.setOld = CockpitUTI_4.this.setNew;
                CockpitUTI_4.this.setNew = CockpitUTI_4.this.setTmp;
                CockpitUTI_4.this.setNew.throttle = ((10F * CockpitUTI_4.this.setOld.throttle) + CockpitUTI_4.this.fm.CT.PowerControl) / 11F;
                CockpitUTI_4.this.setNew.prop = ((10F * CockpitUTI_4.this.setOld.prop) + CockpitUTI_4.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitUTI_4.this.setNew.altimeter = CockpitUTI_4.this.fm.getAltitude();
                CockpitUTI_4.this.setNew.waypointAzimuth.setDeg(CockpitUTI_4.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitUTI_4.this.waypointAzimuth() - CockpitUTI_4.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitUTI_4.this.fm.Or.getKren()) < 30F) {
                    CockpitUTI_4.this.setNew.azimuth.setDeg(CockpitUTI_4.this.setOld.azimuth.getDeg(1.0F), CockpitUTI_4.this.fm.Or.azimut());
                }
                CockpitUTI_4.this.setNew.vspeed = ((199F * CockpitUTI_4.this.setOld.vspeed) + CockpitUTI_4.this.fm.getVertSpeed()) / 200F;
                boolean flag = false;
                if (CockpitUTI_4.this.setNew.gCrankAngle < (CockpitUTI_4.this.fm.CT.getGear() - 0.005F)) {
                    if (Math.abs(CockpitUTI_4.this.setNew.gCrankAngle - CockpitUTI_4.this.fm.CT.getGear()) < 0.33F) {
                        CockpitUTI_4.this.setNew.gCrankAngle += 0.0025F;
                        flag = true;
                    } else {
                        CockpitUTI_4.this.setNew.gCrankAngle = CockpitUTI_4.this.fm.CT.getGear();
                        CockpitUTI_4.this.setOld.gCrankAngle = CockpitUTI_4.this.fm.CT.getGear();
                    }
                }
                if (CockpitUTI_4.this.setNew.gCrankAngle > (CockpitUTI_4.this.fm.CT.getGear() + 0.005F)) {
                    if (Math.abs(CockpitUTI_4.this.setNew.gCrankAngle - CockpitUTI_4.this.fm.CT.getGear()) < 0.33F) {
                ...
                if (flag != this.sfxPlaying) {
                    if (flag) {
                        CockpitUTI_4.this.sfxStart(16);
                    } else {
                        CockpitUTI_4.this.sfxStop(16);
                    }
    ...
    public CockpitUTI_4() {
        super("3DO/Cockpit/UTI-4/hier.him", "i16");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zGas1a", 0.0F, this.floatindex(this.cvt(this.fm.M.fuel, 0.0F, 190F, 0.0F, 14F), CockpitUTI_4.fuelQuantityScale), 0.0F);
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitUTI_4.speedometerScale), 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x20) == 0)) {
            this.mesh.chunkSetAngles("zRPS1a", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 2400F, 0.0F, 13F), CockpitUTI_4.engineRPMScale), 0.0F);
