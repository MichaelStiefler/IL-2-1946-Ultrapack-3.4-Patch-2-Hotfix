...
public class CockpitUTI_4B extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitUTI_4B.this.fm != null) {
                if (CockpitUTI_4B.this.bNeedSetUp) {
                    CockpitUTI_4B.this.reflectPlaneMats();
                    CockpitUTI_4B.this.bNeedSetUp = false;
                }
                CockpitUTI_4B.this.setTmp = CockpitUTI_4B.this.setOld;
                CockpitUTI_4B.this.setOld = CockpitUTI_4B.this.setNew;
                CockpitUTI_4B.this.setNew = CockpitUTI_4B.this.setTmp;
                CockpitUTI_4B.this.setNew.throttle = ((10F * CockpitUTI_4B.this.setOld.throttle) + CockpitUTI_4B.this.fm.CT.PowerControl) / 11F;
                CockpitUTI_4B.this.setNew.prop = ((10F * CockpitUTI_4B.this.setOld.prop) + CockpitUTI_4B.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitUTI_4B.this.setNew.altimeter = CockpitUTI_4B.this.fm.getAltitude();
                CockpitUTI_4B.this.setNew.waypointAzimuth.setDeg(CockpitUTI_4B.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitUTI_4B.this.waypointAzimuth() - CockpitUTI_4B.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitUTI_4B.this.fm.Or.getKren()) < 30F) {
                    CockpitUTI_4B.this.setNew.azimuth.setDeg(CockpitUTI_4B.this.setOld.azimuth.getDeg(1.0F), CockpitUTI_4B.this.fm.Or.azimut());
                }
                CockpitUTI_4B.this.setNew.vspeed = ((199F * CockpitUTI_4B.this.setOld.vspeed) + CockpitUTI_4B.this.fm.getVertSpeed()) / 200F;
                boolean flag = false;
                if (CockpitUTI_4B.this.setNew.gCrankAngle < (CockpitUTI_4B.this.fm.CT.getGear() - 0.005F)) {
                    if (Math.abs(CockpitUTI_4B.this.setNew.gCrankAngle - CockpitUTI_4B.this.fm.CT.getGear()) < 0.33F) {
                        CockpitUTI_4B.this.setNew.gCrankAngle += 0.0025F;
                        flag = true;
                    } else {
                        CockpitUTI_4B.this.setNew.gCrankAngle = CockpitUTI_4B.this.fm.CT.getGear();
                        CockpitUTI_4B.this.setOld.gCrankAngle = CockpitUTI_4B.this.fm.CT.getGear();
                    }
                }
                if (CockpitUTI_4B.this.setNew.gCrankAngle > (CockpitUTI_4B.this.fm.CT.getGear() + 0.005F)) {
                    if (Math.abs(CockpitUTI_4B.this.setNew.gCrankAngle - CockpitUTI_4B.this.fm.CT.getGear()) < 0.33F) {
                ...
                if (flag != this.sfxPlaying) {
                    if (flag) {
                        CockpitUTI_4B.this.sfxStart(16);
                    } else {
                        CockpitUTI_4B.this.sfxStop(16);
                    }
    ...
    public CockpitUTI_4B() {
        super("3DO/Cockpit/UTI-4B/hier.him", "i16");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zGas1a", 0.0F, this.floatindex(this.cvt(this.fm.M.fuel, 0.0F, 190F, 0.0F, 14F), CockpitUTI_4B.fuelQuantityScale), 0.0F);
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 550F, 0.0F, 11F), CockpitUTI_4B.speedometerScale), 0.0F);
        ...
        if (((this.fm.AS.astateCockpitState & 8) == 0) && ((this.fm.AS.astateCockpitState & 0x20) == 0)) {
            this.mesh.chunkSetAngles("zRPS1a", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 2400F, 0.0F, 13F), CockpitUTI_4B.engineRPMScale), 0.0F);
