...
public class CockpitU_2VSxyz extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            HierMesh hiermesh = CockpitU_2VSxyz.this.aircraft().hierMesh();
            CockpitU_2VSxyz.this.setTmp = CockpitU_2VSxyz.this.setOld;
            CockpitU_2VSxyz.this.setOld = CockpitU_2VSxyz.this.setNew;
            CockpitU_2VSxyz.this.setNew = CockpitU_2VSxyz.this.setTmp;
            CockpitU_2VSxyz.this.setNew.pictAiler = (0.85F * CockpitU_2VSxyz.this.setOld.pictAiler) + (0.15F * CockpitU_2VSxyz.this.cvt(CockpitU_2VSxyz.this.fm.CT.AileronControl, -1F, 1.0F, -1F, 1.0F));
            CockpitU_2VSxyz.this.setNew.pictElev = (0.85F * CockpitU_2VSxyz.this.setOld.pictElev) + (0.15F * CockpitU_2VSxyz.this.cvt(CockpitU_2VSxyz.this.fm.CT.ElevatorControl, -1F, 1.0F, -1F, 1.0F));
            CockpitU_2VSxyz.this.setNew.pictRudd = (0.85F * CockpitU_2VSxyz.this.setOld.pictRudd) + (0.15F * CockpitU_2VSxyz.this.cvt(CockpitU_2VSxyz.this.fm.CT.getRudder(), -1F, 1.0F, -1F, 1.0F));
            CockpitU_2VSxyz.this.w.set(CockpitU_2VSxyz.this.fm.getW());
            CockpitU_2VSxyz.this.fm.Or.transform(CockpitU_2VSxyz.this.w);
            CockpitU_2VSxyz.this.setNew.turn = ((12F * CockpitU_2VSxyz.this.setOld.turn) + CockpitU_2VSxyz.this.w.z) / 13F;
            if (Math.abs(CockpitU_2VSxyz.this.fm.Or.getKren()) < 30F) {
                CockpitU_2VSxyz.this.setNew.azimuth.setDeg(CockpitU_2VSxyz.this.setOld.azimuth.getDeg(1.0F), CockpitU_2VSxyz.this.fm.Or.azimut());
            }
            CockpitU_2VSxyz.this.setNew.compasTangage = (0.95F * CockpitU_2VSxyz.this.setOld.compasTangage) + (0.05F * CockpitU_2VSxyz.this.cvt(CockpitU_2VSxyz.this.fm.Or.getTangage(), -20F, 20F, -20F, 20F));
            CockpitU_2VSxyz.this.setNew.compasKren = (0.95F * CockpitU_2VSxyz.this.setOld.compasKren) + (0.05F * CockpitU_2VSxyz.this.cvt(CockpitU_2VSxyz.this.fm.Or.getKren(), -20F, 20F, -20F, 20F));
            CockpitU_2VSxyz.this.setNew.throttle1 = (0.9F * CockpitU_2VSxyz.this.setOld.throttle1) + (0.1F * CockpitU_2VSxyz.this.fm.EI.engines[0].getControlThrottle());
            CockpitU_2VSxyz.this.setNew.mix1 = (0.8F * CockpitU_2VSxyz.this.setOld.mix1) + (0.2F * CockpitU_2VSxyz.this.fm.EI.engines[0].getControlMix());
            CockpitU_2VSxyz.this.setNew.altimeter = CockpitU_2VSxyz.this.fm.getAltitude();
            CockpitU_2VSxyz.this.setNew.vspeed = ((199F * CockpitU_2VSxyz.this.setOld.vspeed) + CockpitU_2VSxyz.this.fm.getVertSpeed()) / 200F;
            float f = 57.3F * CockpitU_2VSxyz.this.fm.EI.engines[0].getw();
            f %= 2880F;
            f /= 2880F;
            if (f <= 0.5F) {
                f *= 2.0F;
            ...
            f *= 1200F;
            CockpitU_2VSxyz.this.propPos = (CockpitU_2VSxyz.this.propPos + (f * U_2xyz.updatef)) % 360F;
            if (CockpitU_2VSxyz.this.fm.EI.engines[0].getRPM() > 0.0F) {
                if (CockpitU_2VSxyz.this.fm.EI.engines[0].getRPM() < 60F) {
                    if ((CockpitU_2VSxyz.this.propPos > 20F) && (CockpitU_2VSxyz.this.propPos < 50F)) {
                        CockpitU_2VSxyz.this.setNew.EngK2 = -15F;
                    }
                    CockpitU_2VSxyz.this.setNew.EngK1 = 0.0F;
                    if ((CockpitU_2VSxyz.this.propPos > 50F) && (CockpitU_2VSxyz.this.propPos < 80F)) {
                        CockpitU_2VSxyz.this.setNew.EngK2 = 0.0F;
                        CockpitU_2VSxyz.this.setNew.EngK1 = -15F;
                    }
                    if (CockpitU_2VSxyz.this.propPos > 80F) {
                        CockpitU_2VSxyz.this.setNew.EngK2 = 0.0F;
                        CockpitU_2VSxyz.this.setNew.EngK1 = 0.0F;
                    }
                } else {
                    CockpitU_2VSxyz.this.setNew.EngK2 = -15F * World.Rnd().nextFloat();
                    CockpitU_2VSxyz.this.setNew.EngK1 = -15F * World.Rnd().nextFloat();
                }
            } else {
                CockpitU_2VSxyz.this.setNew.EngK2 = 0.0F;
                CockpitU_2VSxyz.this.setNew.EngK1 = 0.0F;
            }
            if (CockpitU_2VSxyz.this.u_2xyz.getGunnerAnimation() < 1.0D) {
                ...
                CockpitU_2VSxyz.this.moveGunner();
            } else {
                hiermesh.chunkVisible("Turret1A_FAKE", false);
                hiermesh.chunkVisible("Turret1B_FAKE", false);
                hiermesh.chunkVisible("Turret1A_D0", true);
                hiermesh.chunkVisible("Turret1B_D0", !CockpitU_2VSxyz.this.u_2xyz.bMultiFunction || !CockpitU_2VSxyz.this.u_2xyz.isPlayerMannedTurret());
                CockpitU_2VSxyz.this.mesh.chunkSetAngles("zTurret1A", -CockpitU_2VSxyz.this.aircraft().FM.turret[0].tu[0], 0.0F, 0.0F);
                CockpitU_2VSxyz.this.mesh.chunkSetAngles("zTurret1B", 0.0F, 0.0F, -CockpitU_2VSxyz.this.aircraft().FM.turret[0].tu[1]);
            }
            return true;
        }
    ...
    public CockpitU_2VSxyz(String hier, String type) {
        super(hier, type);
        ...
        if (this.fm.CT.Weapons[2] != null) {
            this.mesh.chunkVisible("RocketKey", true);
            this.mesh.chunkVisible("Z_SW_Rocket", true);
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        Cockpit.xyz[1] = 0.0F;
        this.mesh.chunkSetLocate("Z_SW_Rocket", Cockpit.xyz, Cockpit.ypr);
        ...
        this.mesh.chunkSetAngles("zArr_RPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 400F, 2200F, 0.0F, 9F), CockpitU_2VSxyz.RPM_Scale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zArr_Speed", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 60F, 400F, 0.0F, 17F), CockpitU_2VSxyz.IAS_Scale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("zArr_Temp", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 40F, 125F, 0.0F, 17F), CockpitU_2VSxyz.Oil_Scale), 0.0F, 0.0F);
    ...
    static {
        Property.set(CockpitU_2VSxyz.class, "normZNs", new float[] { 0.7F, 0.6F, 0.6F, 0.6F });
        Property.set(CockpitU_2VSxyz.class, "gsZN", 0.2F);
    }
}
