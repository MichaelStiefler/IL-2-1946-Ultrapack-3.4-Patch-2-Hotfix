...
public class CockpitV156F extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitV156F.this.fm != null) {
                CockpitV156F.this.setTmp = CockpitV156F.this.setOld;
                CockpitV156F.this.setOld = CockpitV156F.this.setNew;
                CockpitV156F.this.setNew = CockpitV156F.this.setTmp;
                CockpitV156F.this.setNew.flaps = (0.9F * CockpitV156F.this.setOld.flaps) + (0.1F * CockpitV156F.this.fm.CT.FlapsControl);
                CockpitV156F.this.setNew.gear = (0.7F * CockpitV156F.this.setOld.gear) + (0.3F * CockpitV156F.this.fm.CT.GearControl);
                CockpitV156F.this.setNew.throttle = (0.8F * CockpitV156F.this.setOld.throttle) + (0.2F * CockpitV156F.this.fm.CT.PowerControl);
                CockpitV156F.this.setNew.prop = (0.8F * CockpitV156F.this.setOld.prop) + (0.2F * CockpitV156F.this.fm.EI.engines[0].getControlProp());
                CockpitV156F.this.setNew.mix = (0.8F * CockpitV156F.this.setOld.mix) + (0.2F * CockpitV156F.this.fm.EI.engines[0].getControlMix());
                CockpitV156F.this.setNew.divebrake = (0.8F * CockpitV156F.this.setOld.divebrake) + (0.2F * CockpitV156F.this.fm.CT.AirBrakeControl);
                CockpitV156F.this.setNew.man = (0.92F * CockpitV156F.this.setOld.man) + (0.08F * CockpitV156F.this.fm.EI.engines[0].getManifoldPressure());
                CockpitV156F.this.setNew.altimeter = CockpitV156F.this.fm.getAltitude();
                if (Math.abs(CockpitV156F.this.fm.Or.getKren()) < 30F) {
                    CockpitV156F.this.setNew.azimuth.setDeg(CockpitV156F.this.setOld.azimuth.getDeg(1.0F), CockpitV156F.this.fm.Or.azimut());
                }
                CockpitV156F.this.setNew.vspeed = ((399F * CockpitV156F.this.setOld.vspeed) + CockpitV156F.this.fm.getVertSpeed()) / 400F;
            }
            return true;
        }
    ...
    public CockpitV156F() {
        super("3DO/Cockpit/V-156-F/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.CT.Weapons[3] != null) && !this.fm.CT.Weapons[3][0].haveBullets()) {
            this.mesh.chunkSetAngles("Z_Bomb1", 0.0F, 35F, 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 925.9998F, 0.0F, 10F), CockpitV156F.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.setNew.vspeed < 0.0F ? this.floatindex(this.cvt(-this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitV156F.variometerScale) : -this.floatindex(this.cvt(this.setNew.vspeed / 5.08F, 0.0F, 6F, 0.0F, 12F), CockpitV156F.variometerScale), 0.0F);
