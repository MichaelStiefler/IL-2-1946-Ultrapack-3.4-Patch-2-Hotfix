...
public class CockpitVG_33 extends CockpitPilot {
    private class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitVG_33.this.fm != null) {
                CockpitVG_33.this.setTmp = CockpitVG_33.this.setOld;
                CockpitVG_33.this.setOld = CockpitVG_33.this.setNew;
                CockpitVG_33.this.setNew = CockpitVG_33.this.setTmp;
                CockpitVG_33.this.setNew.throttle = (0.92F * CockpitVG_33.this.setOld.throttle) + (0.08F * CockpitVG_33.this.fm.CT.PowerControl);
                CockpitVG_33.this.setNew.prop = (0.92F * CockpitVG_33.this.setOld.prop) + (0.08F * CockpitVG_33.this.fm.EI.engines[0].getControlProp());
                CockpitVG_33.this.setNew.mix = (0.92F * CockpitVG_33.this.setOld.mix) + (0.08F * CockpitVG_33.this.fm.EI.engines[0].getControlMix());
                CockpitVG_33.this.setNew.altimeter = CockpitVG_33.this.fm.getAltitude();
                CockpitVG_33.this.setNew.waypointAzimuth.setDeg(CockpitVG_33.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitVG_33.this.waypointAzimuth() - CockpitVG_33.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitVG_33.this.fm.Or.getKren()) < 30F) {
                    CockpitVG_33.this.setNew.azimuth.setDeg(CockpitVG_33.this.setOld.azimuth.getDeg(1.0F), CockpitVG_33.this.fm.Or.azimut());
                }
                CockpitVG_33.this.setNew.vspeed = (0.99F * CockpitVG_33.this.setOld.vspeed) + (0.01F * CockpitVG_33.this.fm.getVertSpeed());
                if (CockpitVG_33.this.fm.CT.GearControl < 0.5F) {
                    if (CockpitVG_33.this.setNew.gearPhi > 0.0F) {
                        CockpitVG_33.this.setNew.gearPhi = CockpitVG_33.this.setOld.gearPhi - 0.021F;
                    }
                } else if (CockpitVG_33.this.setNew.gearPhi < 1.0F) {
                    CockpitVG_33.this.setNew.gearPhi = CockpitVG_33.this.setOld.gearPhi + 0.021F;
                }
            }
            return true;
    ...
    public CockpitVG_33() {
        super("3DO/Cockpit/VG33/VG33.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 10F), CockpitVG_33.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_VY", -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitVG_33.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 5000F, 0.0F, 10F), CockpitVG_33.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, -306F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitVG_33.radScale), 0.0F, 0.0F);
