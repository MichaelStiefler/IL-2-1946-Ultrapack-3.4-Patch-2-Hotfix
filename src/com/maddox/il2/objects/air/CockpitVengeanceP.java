...
public class CockpitVengeanceP extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitVengeanceP.this.fm != null) {
                CockpitVengeanceP.this.setTmp = CockpitVengeanceP.this.setOld;
                CockpitVengeanceP.this.setOld = CockpitVengeanceP.this.setNew;
                CockpitVengeanceP.this.setNew = CockpitVengeanceP.this.setTmp;
                CockpitVengeanceP.this.setNew.throttle = (0.85F * CockpitVengeanceP.this.setOld.throttle) + (CockpitVengeanceP.this.fm.CT.PowerControl * 0.15F);
                CockpitVengeanceP.this.setNew.prop = (0.85F * CockpitVengeanceP.this.setOld.prop) + (CockpitVengeanceP.this.fm.CT.getStepControl() * 0.15F);
                CockpitVengeanceP.this.setNew.altimeter = CockpitVengeanceP.this.fm.getAltitude();
                float f = CockpitVengeanceP.this.waypointAzimuth();
                if (Math.abs(CockpitVengeanceP.this.fm.Or.getKren()) < 30F) {
                    CockpitVengeanceP.this.setNew.azimuth.setDeg(CockpitVengeanceP.this.setOld.azimuth.getDeg(1.0F), CockpitVengeanceP.this.fm.Or.azimut());
                }
                CockpitVengeanceP.this.setNew.waypointAzimuth.setDeg(CockpitVengeanceP.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitVengeanceP.this.setNew.vspeed = ((199F * CockpitVengeanceP.this.setOld.vspeed) + CockpitVengeanceP.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitVengeanceP() {
        super("3DO/Cockpit/VengeanceP/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 796.3598F, 0.0F, 11F), CockpitVengeanceP.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitVengeanceP.variometerScale), 0.0F);
