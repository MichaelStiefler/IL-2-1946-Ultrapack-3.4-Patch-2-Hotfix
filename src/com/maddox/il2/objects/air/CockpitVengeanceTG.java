...
public class CockpitVengeanceTG extends CockpitGunner {
    ...
    public void clipAnglesGun(Orient orient) {
        ...
        if (f1 < -this.floatindex(this.cvt(f2, 0.0F, 180F, 0.0F, 36F), CockpitVengeanceTG.angles)) {
            f1 = -this.floatindex(this.cvt(f2, 0.0F, 180F, 0.0F, 36F), CockpitVengeanceTG.angles);
        }
