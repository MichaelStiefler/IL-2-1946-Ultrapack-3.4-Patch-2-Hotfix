...
public abstract class CockpitVenom extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitVenom.this.fm != null) {
                CockpitVenom.this.setTmp = CockpitVenom.this.setOld;
                CockpitVenom.this.setOld = CockpitVenom.this.setNew;
                CockpitVenom.this.setNew = CockpitVenom.this.setTmp;
                CockpitVenom.this.setNew.throttle = (0.85F * CockpitVenom.this.setOld.throttle) + (CockpitVenom.this.fm.CT.PowerControl * 0.15F);
                CockpitVenom.this.setNew.prop = (0.85F * CockpitVenom.this.setOld.prop) + (CockpitVenom.this.fm.CT.getStepControl() * 0.15F);
                CockpitVenom.this.setNew.stage = (0.85F * CockpitVenom.this.setOld.stage) + (CockpitVenom.this.fm.EI.engines[0].getControlCompressor() * 0.15F);
                CockpitVenom.this.setNew.mix = (0.85F * CockpitVenom.this.setOld.mix) + (CockpitVenom.this.fm.EI.engines[0].getControlMix() * 0.15F);
                CockpitVenom.this.setNew.altimeter = CockpitVenom.this.fm.getAltitude();
                if (Math.abs(CockpitVenom.this.fm.Or.getKren()) < 30F) {
                    CockpitVenom.this.setNew.azimuth.setDeg(CockpitVenom.this.setOld.azimuth.getDeg(1.0F), CockpitVenom.this.fm.Or.azimut());
                }
                CockpitVenom.this.setNew.vspeed = ((199F * CockpitVenom.this.setOld.vspeed) + CockpitVenom.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitVenom(String meshName, String planeName) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitVenom.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitVenom.variometerScale), 0.0F, 0.0F);
