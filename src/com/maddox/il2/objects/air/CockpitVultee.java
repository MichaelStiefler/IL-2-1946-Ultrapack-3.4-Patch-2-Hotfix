...
public class CockpitVultee extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitVultee.this.fm != null) {
                CockpitVultee.this.setTmp = CockpitVultee.this.setOld;
                CockpitVultee.this.setOld = CockpitVultee.this.setNew;
                CockpitVultee.this.setNew = CockpitVultee.this.setTmp;
                CockpitVultee.this.setNew.throttle = (0.85F * CockpitVultee.this.setOld.throttle) + (CockpitVultee.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitVultee.this.setNew.prop = (0.85F * CockpitVultee.this.setOld.prop) + (CockpitVultee.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitVultee.this.setNew.altimeter = CockpitVultee.this.fm.getAltitude();
                float f = CockpitVultee.this.waypointAzimuth();
                if (Math.abs(CockpitVultee.this.fm.Or.getKren()) < 30F) {
                    CockpitVultee.this.setNew.azimuth.setDeg(CockpitVultee.this.setOld.azimuth.getDeg(1.0F), CockpitVultee.this.fm.Or.azimut());
                }
                CockpitVultee.this.setNew.waypointAzimuth.setDeg(CockpitVultee.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitVultee.this.setNew.waypointDeviation.setDeg(CockpitVultee.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitVultee.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitVultee.this.setNew.vspeed = ((199F * CockpitVultee.this.setOld.vspeed) + CockpitVultee.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitVultee() {
        super("3DO/Cockpit/Vultee/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zOilFlap2", 0.0F, -35F * this.fm.EI.engines[0].getControlRadiator(), 0.0F);
        this.mesh.chunkSetAngles("zMix1", 0.0F, -45.8F * this.fm.EI.engines[0].getControlMix(), 0.0F);
        this.mesh.chunkSetAngles("zMix2", 0.0F, -45.8F * this.fm.EI.engines[0].getControlMix(), 0.0F);
        this.mesh.chunkSetAngles("zPitch1", 0.0F, -54F * this.interp(this.setNew.prop, this.setOld.prop, f), 0.0F);
        this.mesh.chunkSetAngles("zPitch2", 0.0F, -54F * this.interp(this.setNew.prop, this.setOld.prop, f), 0.0F);
        this.mesh.chunkSetAngles("zThrottle1", 0.0F, -49F * this.interp(this.setNew.throttle, this.setOld.throttle, f), 0.0F);
        this.mesh.chunkSetAngles("zThrottle2", 0.0F, -49F * this.interp(this.setNew.throttle, this.setOld.throttle, f), 0.0F);
        this.mesh.chunkSetAngles("zCompressor1", 0.0F, this.cvt(this.fm.EI.engines[0].getControlCompressor(), 0.0F, 1.0F, 0.0F, -50F), 0.0F);
        this.mesh.chunkSetAngles("zCompressor2", 0.0F, this.cvt(this.fm.EI.engines[0].getControlCompressor(), 0.0F, 1.0F, 0.0F, -50F), 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitVultee.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitVultee.speedometerScale), 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            ...
            this.mesh.chunkSetAngles("zRPM2", 0.0F, this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 4500F, 0.0F, 323F), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Temp2", 0.0F, this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 350F, 0.0F, 100F), 0.0F);
        this.mesh.chunkSetAngles("zOilTemp1", 0.0F, -this.cvt(this.fm.EI.engines[0].tOilOut, -50F, 150F, -25F, 75F), 0.0F);
        this.mesh.chunkSetAngles("zOilTemp2", 0.0F, this.cvt(this.fm.EI.engines[0].tOilOut, -50F, 150F, -25F, 75F), 0.0F);
        ...
        float f1 = (0.5F * this.fm.EI.engines[0].getRPM()) + (0.5F * this.fm.EI.engines[0].getRPM());
