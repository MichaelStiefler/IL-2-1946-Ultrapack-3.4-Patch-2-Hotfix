...
public class CockpitWalrus extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitWalrus.this.fm != null) {
                CockpitWalrus.this.setTmp = CockpitWalrus.this.setOld;
                CockpitWalrus.this.setOld = CockpitWalrus.this.setNew;
                CockpitWalrus.this.setNew = CockpitWalrus.this.setTmp;
                CockpitWalrus.this.setNew.throttle1 = (0.85F * CockpitWalrus.this.setOld.throttle1) + (((FlightModelMain) (CockpitWalrus.this.fm)).EI.engines[0].getControlThrottle() * 0.15F);
                CockpitWalrus.this.setNew.prop1 = (0.85F * CockpitWalrus.this.setOld.prop1) + (((FlightModelMain) (CockpitWalrus.this.fm)).EI.engines[0].getControlProp() * 0.15F);
                CockpitWalrus.this.setNew.altimeter = CockpitWalrus.this.fm.getAltitude();
                float f = CockpitWalrus.this.waypointAzimuth();
                if (Math.abs(CockpitWalrus.this.fm.Or.getKren()) < 30F) {
                    CockpitWalrus.this.setNew.azimuth.setDeg(CockpitWalrus.this.setOld.azimuth.getDeg(1.0F), ((FlightModelMain) (CockpitWalrus.this.fm)).Or.azimut());
                }
                CockpitWalrus.this.setNew.waypointAzimuth.setDeg(CockpitWalrus.this.setOld.waypointAzimuth.getDeg(1.0F), f);
                CockpitWalrus.this.setNew.waypointDeviation.setDeg(CockpitWalrus.this.setOld.waypointDeviation.getDeg(0.1F), (f - CockpitWalrus.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                CockpitWalrus.this.setNew.vspeed = ((199F * CockpitWalrus.this.setOld.vspeed) + CockpitWalrus.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitWalrus() {
        super("3DO/Cockpit/Walrus/CockpitWalrus.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitWalrus.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("zSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitWalrus.speedometerScale), 0.0F);
