...
public class CockpitWellesley extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitWellesley.this.fm != null) {
                CockpitWellesley.this.setTmp = CockpitWellesley.this.setOld;
                CockpitWellesley.this.setOld = CockpitWellesley.this.setNew;
                CockpitWellesley.this.setNew = CockpitWellesley.this.setTmp;
                CockpitWellesley.this.setNew.throttle = (0.92F * CockpitWellesley.this.setOld.throttle) + (0.08F * CockpitWellesley.this.fm.CT.PowerControl);
                CockpitWellesley.this.setNew.prop = (0.92F * CockpitWellesley.this.setOld.prop) + (0.08F * CockpitWellesley.this.fm.EI.engines[0].getControlProp());
                CockpitWellesley.this.setNew.mix = (0.92F * CockpitWellesley.this.setOld.mix) + (0.08F * CockpitWellesley.this.fm.EI.engines[0].getControlMix());
                CockpitWellesley.this.setNew.altimeter = CockpitWellesley.this.fm.getAltitude();
                CockpitWellesley.this.setNew.waypointAzimuth.setDeg(CockpitWellesley.this.setOld.waypointAzimuth.getDeg(0.1F), (CockpitWellesley.this.waypointAzimuth() - CockpitWellesley.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(CockpitWellesley.this.fm.Or.getKren()) < 30F) {
                    CockpitWellesley.this.setNew.azimuth.setDeg(CockpitWellesley.this.setOld.azimuth.getDeg(1.0F), CockpitWellesley.this.fm.Or.azimut());
                }
                CockpitWellesley.this.setNew.vspeed = (0.99F * CockpitWellesley.this.setOld.vspeed) + (0.01F * CockpitWellesley.this.fm.getVertSpeed());
                if (CockpitWellesley.this.fm.CT.GearControl < 0.5F) {
                    if (CockpitWellesley.this.setNew.gearPhi > 0.0F) {
                        CockpitWellesley.this.setNew.gearPhi = CockpitWellesley.this.setOld.gearPhi - 0.021F;
                    }
                } else if (CockpitWellesley.this.setNew.gearPhi < 1.0F) {
                    CockpitWellesley.this.setNew.gearPhi = CockpitWellesley.this.setOld.gearPhi + 0.021F;
                }
            }
            return true;
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 257.2222F, 0.0F, 10F), CockpitWellesley.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_VY", -this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitWellesley.variometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_FUEL2", this.cvt((float) Math.sqrt(this.fm.M.fuel), 0.0F, (float) Math.sqrt(88.38D), 0.0F, -317F), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELKA_RPM", -this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 5000F, 0.0F, 10F), CockpitWellesley.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_OIL", this.cvt(this.fm.EI.engines[0].tOilOut, 0.0F, 160F, 0.0F, -306F), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("STRELK_TEMP_RAD", -this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitWellesley.radScale), 0.0F, 0.0F);
