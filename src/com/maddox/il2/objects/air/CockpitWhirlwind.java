...
public class CockpitWhirlwind extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (CockpitWhirlwind.this.fm != null) {
                ...
                if (Math.abs(CockpitWhirlwind.this.fm.Or.getKren()) < 30F) {
                ...
                if (CockpitWhirlwind.this.useRealisticNavigationInstruments()) {
                    ...
                    CockpitWhirlwind.this.setNew.waypointAzimuth.setDeg(CockpitWhirlwind.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                }
                CockpitWhirlwind.this.setNew.vspeed = ((199F * CockpitWhirlwind.this.setOld.vspeed) + CockpitWhirlwind.this.fm.getVertSpeed()) / 200F;

                CockpitWhirlwind.this.setNew.oilPress1 = (0.95F * CockpitWhirlwind.this.setOld.oilPress1) + (0.05F * CockpitWhirlwind.this.cvt(CockpitWhirlwind.this.fm.EI.engines[0].getRPM(), 0F, 750F, 0F, 0.6F) * CockpitWhirlwind.this.cvt(CockpitWhirlwind.this.fm.EI.engines[0].tOilOut, 0F, 15F, 1.7F, 1F) * CockpitWhirlwind.this.cvt(CockpitWhirlwind.this.fm.EI.engines[0].tOilOut, 50F, 80F, 1F, 0.85F) * CockpitWhirlwind.this.cvt(CockpitWhirlwind.this.fm.EI.engines[0].tOilOut, 80F, 100F, 1F, 0.9F) * CockpitWhirlwind.this.fm.EI.engines[0].getReadyness());
                CockpitWhirlwind.this.setNew.oilPress2 = (0.95F * CockpitWhirlwind.this.setOld.oilPress2) + (0.05F * CockpitWhirlwind.this.cvt(CockpitWhirlwind.this.fm.EI.engines[1].getRPM(), 0F, 750F, 0F, 0.6F) * CockpitWhirlwind.this.cvt(CockpitWhirlwind.this.fm.EI.engines[1].tOilOut, 0F, 15F, 1.7F, 1F) * CockpitWhirlwind.this.cvt(CockpitWhirlwind.this.fm.EI.engines[1].tOilOut, 50F, 80F, 1F, 0.85F) * CockpitWhirlwind.this.cvt(CockpitWhirlwind.this.fm.EI.engines[1].tOilOut, 80F, 100F, 1F, 0.9F) * CockpitWhirlwind.this.fm.EI.engines[1].getReadyness());
                if (CockpitWhirlwind.this.fm.EI.engines[0].getStage() > 6) {
                    CockpitWhirlwind.this.setNew.oilPress1 = 0.0F;
                }
                if (CockpitWhirlwind.this.fm.EI.engines[0].getRPM() < 100F) {
                    CockpitWhirlwind.this.setNew.oilPress1 = 0.0F;
                }
                if (CockpitWhirlwind.this.fm.EI.engines[1].getStage() > 6) {
                    CockpitWhirlwind.this.setNew.oilPress2 = 0.0F;
                }
                if (CockpitWhirlwind.this.fm.EI.engines[1].getRPM() < 100F) {
                    CockpitWhirlwind.this.setNew.oilPress2 = 0.0F;
                }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 648.2F, 0.0F, 35.0F), CockpitWhirlwind.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8.0F), CockpitWhirlwind.variometerScale), 0.0F, 0.0F);
        ...
        if (this.fm.Gears.onGround()) {
            this.mesh.chunkSetAngles("Z_Fuel2", this.floatindex(this.cvt(this.fm.M.fuel / 3.2835820895522388059701492537313F, 0.0F, 135.0F, 0.0F, 15.0F), CockpitWhirlwind.fuelScaleGround), 0.0F, 0.0F);
        } else {
            this.mesh.chunkSetAngles("Z_Fuel2", this.floatindex(this.cvt(this.fm.M.fuel / 3.2835820895522388059701492537313F, 0.0F, 135.0F, 0.0F, 27.0F), CockpitWhirlwind.fuelScaleFlight), 0.0F, 0.0F);
        }
        ...
        if (this.fm.EI.engines[1].getRPM() < 100.0F) {
            rndBoost2 = 0.0F;
        }
        ...
        this.mesh.chunkSetAngles("Z_RPM1", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 1000.0F, 5000.0F, 2.0F, 10.0F), CockpitWhirlwind.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 1000.0F, 5000.0F, 2.0F, 10.0F), CockpitWhirlwind.rpmScale), 0.0F, 0.0F);
    ...
    private static final float[] speedometerScale = { 0.0F, 0.0F, 0.0F, 10.0F, 22.0F, 36.0F, 47.0F, 64.0F, 78.0F, 94.0F, 115.0F, 133.0F, 152.0F, 171.0F, 186.0F, 201.0F, 220.5F, 239.0F, 257.0F, 274.0F, 295.0F, 314.0F, 337.0F, 359.0F, 377.0F, 395.0F, 410.0F, 426.0F, 446.0F, 465.0F, 479.0F, 497.0F, 516.0F, 534.0F, 550.0F, 565.0F };
    ...
    private static final float[] fuelScaleFlight  = { 60.0F, 75.0F, 80.5F, 85.0F, 87.7F, 92.0F, 94.8F, 97.0F, 99.7F, 102.1F, 103.2F, 104.0F, 104.4F, 105.2F, 105.5F, 106.6F, 107.7F, 110.4F, 111.9F, 113.4F, 114.4F, 115.6F, 116.5F, 117.2F, 117.7F, 119.0F, 120.0F, 121.2F };
