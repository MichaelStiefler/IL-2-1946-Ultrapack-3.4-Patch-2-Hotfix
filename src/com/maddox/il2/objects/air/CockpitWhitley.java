...
public class CockpitWhitley extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitWhitley.this.fm != null) {
                CockpitWhitley.this.setTmp = CockpitWhitley.this.setOld;
                CockpitWhitley.this.setOld = CockpitWhitley.this.setNew;
                CockpitWhitley.this.setNew = CockpitWhitley.this.setTmp;
                CockpitWhitley.this.setNew.throttle1 = (0.85F * CockpitWhitley.this.setOld.throttle1) + (CockpitWhitley.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitWhitley.this.setNew.prop1 = (0.85F * CockpitWhitley.this.setOld.prop1) + (CockpitWhitley.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitWhitley.this.setNew.throttle2 = (0.85F * CockpitWhitley.this.setOld.throttle2) + (CockpitWhitley.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitWhitley.this.setNew.prop2 = (0.85F * CockpitWhitley.this.setOld.prop2) + (CockpitWhitley.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitWhitley.this.setNew.altimeter = CockpitWhitley.this.fm.getAltitude();
                float f = CockpitWhitley.this.waypointAzimuth();
                CockpitWhitley.this.setNew.waypointAzimuth.setDeg(CockpitWhitley.this.setOld.waypointAzimuth.getDeg(0.1F), f - CockpitWhitley.this.setOld.azimuth.getDeg(1.0F));
                if (Math.abs(CockpitWhitley.this.fm.Or.getKren()) < 30F) {
                    CockpitWhitley.this.setNew.azimuth.setDeg(CockpitWhitley.this.setOld.azimuth.getDeg(1.0F), CockpitWhitley.this.fm.Or.azimut());
                }
                CockpitWhitley.this.setNew.vspeed = (0.99F * CockpitWhitley.this.setOld.vspeed) + (0.01F * CockpitWhitley.this.fm.getVertSpeed());
            }
            return true;
        }
    ...
    public CockpitWhitley() {
        super("3DO/Cockpit/Whitley/Whitley.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST1", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitWhitley.boostScale), 0.0F, 0.0F);
        ...
        f1 = Math.abs(f1);
        this.mesh.chunkSetAngles("STRELKA_BOOST2", f2 * this.floatindex(this.cvt(f1, 0.0F, 1.792637F, 0.0F, 13F), CockpitWhitley.boostScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_TEMP_RAD1", this.floatindex(this.cvt(this.fm.EI.engines[0].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitWhitley.radScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_TEMP_RAD2", this.floatindex(this.cvt(this.fm.EI.engines[1].tWaterOut, 0.0F, 140F, 0.0F, 14F), CockpitWhitley.radScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("STRELK_V_LONG", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 26.8224F, 214.5792F, 0.0F, 21F), CockpitWhitley.speedometerScale), 0.0F, 0.0F);
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("STR_CLIMB", this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), CockpitWhitley.variometerScale), 0.0F, 0.0F);
        }
