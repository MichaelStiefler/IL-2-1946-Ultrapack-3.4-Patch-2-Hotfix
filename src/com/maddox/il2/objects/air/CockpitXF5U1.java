...
public class CockpitXF5U1 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitXF5U1.this.fm != null) {
                ...
                if (Math.abs(CockpitXF5U1.this.fm.Or.getKren()) < 30F) {
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        Cockpit.xyz[1] = this.fm.CT.getCockpitDoor() * 0.6F;
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 804.6721F, 0.0F, 10F), CockpitXF5U1.speedometerScale), 0.0F);
