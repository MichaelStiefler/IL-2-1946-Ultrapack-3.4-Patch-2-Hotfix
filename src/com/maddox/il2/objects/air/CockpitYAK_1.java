...
public class CockpitYAK_1 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitYAK_1.this.fm != null) {
                CockpitYAK_1.this.setTmp = CockpitYAK_1.this.setOld;
                CockpitYAK_1.this.setOld = CockpitYAK_1.this.setNew;
                CockpitYAK_1.this.setNew = CockpitYAK_1.this.setTmp;
                CockpitYAK_1.this.setNew.throttle = ((10F * CockpitYAK_1.this.setOld.throttle) + CockpitYAK_1.this.fm.CT.PowerControl) / 11F;
                CockpitYAK_1.this.setNew.prop = ((10F * CockpitYAK_1.this.setOld.prop) + CockpitYAK_1.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitYAK_1.this.setNew.altimeter = CockpitYAK_1.this.fm.getAltitude();
                if (Math.abs(CockpitYAK_1.this.fm.Or.getKren()) < 30F) {
                    CockpitYAK_1.this.setNew.azimuth.setDeg(CockpitYAK_1.this.setOld.azimuth.getDeg(1.0F), CockpitYAK_1.this.fm.Or.azimut());
                }
                CockpitYAK_1.this.setNew.vspeed = ((199F * CockpitYAK_1.this.setOld.vspeed) + CockpitYAK_1.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitYAK_1.speedometerScale), 0.0F);
