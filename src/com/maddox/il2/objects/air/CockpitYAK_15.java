...
public class CockpitYAK_15 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitYAK_15.this.fm != null) {
                CockpitYAK_15.this.setTmp = CockpitYAK_15.this.setOld;
                CockpitYAK_15.this.setOld = CockpitYAK_15.this.setNew;
                CockpitYAK_15.this.setNew = CockpitYAK_15.this.setTmp;
                CockpitYAK_15.this.setNew.throttle = ((10F * CockpitYAK_15.this.setOld.throttle) + CockpitYAK_15.this.fm.CT.PowerControl) / 11F;
                CockpitYAK_15.this.setNew.prop = ((10F * CockpitYAK_15.this.setOld.prop) + CockpitYAK_15.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitYAK_15.this.setNew.altimeter = CockpitYAK_15.this.fm.getAltitude();
                if (Math.abs(CockpitYAK_15.this.fm.Or.getKren()) < 30F) {
                    CockpitYAK_15.this.setNew.azimuth.setDeg(CockpitYAK_15.this.setOld.azimuth.getDeg(0.1F), CockpitYAK_15.this.fm.Or.azimut());
                }
                CockpitYAK_15.this.setNew.vspeed = ((199F * CockpitYAK_15.this.setOld.vspeed) + CockpitYAK_15.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zRPM1a", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), CockpitYAK_15.rpmScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zAzimuth1b", 0.0F, -this.setNew.azimuth.getDeg(f * 0.1F) - 90F, 0.0F);
        ...
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitYAK_15.speedometerScale), 0.0F);
