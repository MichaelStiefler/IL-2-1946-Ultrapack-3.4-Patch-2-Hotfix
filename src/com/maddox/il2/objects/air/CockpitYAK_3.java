...
public class CockpitYAK_3 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitYAK_3.this.fm != null) {
                CockpitYAK_3.this.setTmp = CockpitYAK_3.this.setOld;
                CockpitYAK_3.this.setOld = CockpitYAK_3.this.setNew;
                CockpitYAK_3.this.setNew = CockpitYAK_3.this.setTmp;
                CockpitYAK_3.this.setNew.throttle = ((10F * CockpitYAK_3.this.setOld.throttle) + CockpitYAK_3.this.fm.CT.PowerControl) / 11F;
                CockpitYAK_3.this.setNew.prop = ((10F * CockpitYAK_3.this.setOld.prop) + CockpitYAK_3.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitYAK_3.this.setNew.altimeter = CockpitYAK_3.this.fm.getAltitude();
                if (Math.abs(CockpitYAK_3.this.fm.Or.getKren()) < 30F) {
                    CockpitYAK_3.this.setNew.azimuth.setDeg(CockpitYAK_3.this.setOld.azimuth.getDeg(1.0F), CockpitYAK_3.this.fm.Or.azimut());
                }
                CockpitYAK_3.this.setNew.vspeed = ((199F * CockpitYAK_3.this.setOld.vspeed) + CockpitYAK_3.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitYAK_3() {
        super("3DO/Cockpit/Yak-3und9/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitYAK_3.speedometerScale), 0.0F);
