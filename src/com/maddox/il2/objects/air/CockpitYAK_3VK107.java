...
public class CockpitYAK_3VK107 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitYAK_3VK107.this.fm != null) {
                CockpitYAK_3VK107.this.setTmp = CockpitYAK_3VK107.this.setOld;
                CockpitYAK_3VK107.this.setOld = CockpitYAK_3VK107.this.setNew;
                CockpitYAK_3VK107.this.setNew = CockpitYAK_3VK107.this.setTmp;
                CockpitYAK_3VK107.this.setNew.throttle = ((10F * CockpitYAK_3VK107.this.setOld.throttle) + CockpitYAK_3VK107.this.fm.CT.PowerControl) / 11F;
                CockpitYAK_3VK107.this.setNew.prop = ((10F * CockpitYAK_3VK107.this.setOld.prop) + CockpitYAK_3VK107.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitYAK_3VK107.this.setNew.altimeter = CockpitYAK_3VK107.this.fm.getAltitude();
                if (Math.abs(CockpitYAK_3VK107.this.fm.Or.getKren()) < 30F) {
                    CockpitYAK_3VK107.this.setNew.azimuth.setDeg(CockpitYAK_3VK107.this.setOld.azimuth.getDeg(1.0F), CockpitYAK_3VK107.this.fm.Or.azimut());
                }
                CockpitYAK_3VK107.this.setNew.vspeed = ((199F * CockpitYAK_3VK107.this.setOld.vspeed) + CockpitYAK_3VK107.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitYAK_3VK107.speedometerScale), 0.0F);
