...
public class CockpitYAK_7 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitYAK_7.this.fm != null) {
                CockpitYAK_7.this.setTmp = CockpitYAK_7.this.setOld;
                CockpitYAK_7.this.setOld = CockpitYAK_7.this.setNew;
                CockpitYAK_7.this.setNew = CockpitYAK_7.this.setTmp;
                CockpitYAK_7.this.setNew.throttle = ((10F * CockpitYAK_7.this.setOld.throttle) + CockpitYAK_7.this.fm.CT.PowerControl) / 11F;
                CockpitYAK_7.this.setNew.prop = ((10F * CockpitYAK_7.this.setOld.prop) + CockpitYAK_7.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitYAK_7.this.setNew.altimeter = CockpitYAK_7.this.fm.getAltitude();
                if (Math.abs(CockpitYAK_7.this.fm.Or.getKren()) < 30F) {
                    CockpitYAK_7.this.setNew.azimuth.setDeg(CockpitYAK_7.this.setOld.azimuth.getDeg(1.0F), CockpitYAK_7.this.fm.Or.azimut());
                }
                CockpitYAK_7.this.setNew.vspeed = ((199F * CockpitYAK_7.this.setOld.vspeed) + CockpitYAK_7.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitYAK_7() {
        super("3DO/Cockpit/Yak-7/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitYAK_7.speedometerScale), 0.0F);
