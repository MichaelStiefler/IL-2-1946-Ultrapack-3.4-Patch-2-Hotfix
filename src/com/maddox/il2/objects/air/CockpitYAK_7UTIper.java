...
public class CockpitYAK_7UTIper extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitYAK_7UTIper.this.fm != null) {
                CockpitYAK_7UTIper.this.setTmp = CockpitYAK_7UTIper.this.setOld;
                CockpitYAK_7UTIper.this.setOld = CockpitYAK_7UTIper.this.setNew;
                CockpitYAK_7UTIper.this.setNew = CockpitYAK_7UTIper.this.setTmp;
                CockpitYAK_7UTIper.this.setNew.throttle = ((10F * CockpitYAK_7UTIper.this.setOld.throttle) + CockpitYAK_7UTIper.this.fm.CT.PowerControl) / 11F;
                CockpitYAK_7UTIper.this.setNew.prop = ((10F * CockpitYAK_7UTIper.this.setOld.prop) + CockpitYAK_7UTIper.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitYAK_7UTIper.this.setNew.altimeter = CockpitYAK_7UTIper.this.fm.getAltitude();
                if (Math.abs(CockpitYAK_7UTIper.this.fm.Or.getKren()) < 30F) {
                    CockpitYAK_7UTIper.this.setNew.azimuth.setDeg(CockpitYAK_7UTIper.this.setOld.azimuth.getDeg(1.0F), CockpitYAK_7UTIper.this.fm.Or.azimut());
                }
                CockpitYAK_7UTIper.this.setNew.vspeed = ((199F * CockpitYAK_7UTIper.this.setOld.vspeed) + CockpitYAK_7UTIper.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitYAK_7UTIper() {
        super("3DO/Cockpit/Yak-7V/hierUTIPER.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("r_one", 0.0F, -20F * (this.fm.CT.WeaponControl[0] ? 1.0F : 0.0F), 0.0F);
        this.mesh.chunkSetAngles("r_two", 0.0F, -20F * (this.fm.CT.WeaponControl[1] ? 1.0F : 0.0F), 0.0F);
        ...
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitYAK_7UTIper.speedometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("zGasPrs1a", 0.0F, this.cvt(this.fm.M.fuel > 1.0F ? 0.26F : 0.0F, 0.0F, 8F, 0.0F, -180F), 0.0F);
