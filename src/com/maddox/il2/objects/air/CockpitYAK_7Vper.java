...
public class CockpitYAK_7Vper extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitYAK_7Vper.this.fm != null) {
                CockpitYAK_7Vper.this.setTmp = CockpitYAK_7Vper.this.setOld;
                CockpitYAK_7Vper.this.setOld = CockpitYAK_7Vper.this.setNew;
                CockpitYAK_7Vper.this.setNew = CockpitYAK_7Vper.this.setTmp;
                CockpitYAK_7Vper.this.setNew.throttle = ((10F * CockpitYAK_7Vper.this.setOld.throttle) + CockpitYAK_7Vper.this.fm.CT.PowerControl) / 11F;
                CockpitYAK_7Vper.this.setNew.prop = ((10F * CockpitYAK_7Vper.this.setOld.prop) + CockpitYAK_7Vper.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitYAK_7Vper.this.setNew.altimeter = CockpitYAK_7Vper.this.fm.getAltitude();
                if (Math.abs(CockpitYAK_7Vper.this.fm.Or.getKren()) < 30F) {
                    CockpitYAK_7Vper.this.setNew.azimuth.setDeg(CockpitYAK_7Vper.this.setOld.azimuth.getDeg(1.0F), CockpitYAK_7Vper.this.fm.Or.azimut());
                }
                CockpitYAK_7Vper.this.setNew.vspeed = ((199F * CockpitYAK_7Vper.this.setOld.vspeed) + CockpitYAK_7Vper.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitYAK_7Vper() {
        super("3DO/Cockpit/Yak-7V/hierPER.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitYAK_7Vper.speedometerScale), 0.0F);
