...
public class CockpitYAK_9 extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            CockpitYAK_9.this.fm = World.getPlayerFM();
            if (CockpitYAK_9.this.fm != null) {
                CockpitYAK_9.this.setTmp = CockpitYAK_9.this.setOld;
                CockpitYAK_9.this.setOld = CockpitYAK_9.this.setNew;
                CockpitYAK_9.this.setNew = CockpitYAK_9.this.setTmp;
                CockpitYAK_9.this.setNew.throttle = ((10F * CockpitYAK_9.this.setOld.throttle) + CockpitYAK_9.this.fm.CT.PowerControl) / 11F;
                CockpitYAK_9.this.setNew.prop = ((10F * CockpitYAK_9.this.setOld.prop) + CockpitYAK_9.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitYAK_9.this.setNew.altimeter = CockpitYAK_9.this.fm.getAltitude();
                if (Math.abs(CockpitYAK_9.this.fm.Or.getKren()) < 30F) {
                    CockpitYAK_9.this.setNew.azimuth.setDeg(CockpitYAK_9.this.setOld.azimuth.getDeg(1.0F), CockpitYAK_9.this.fm.Or.azimut());
                }
                CockpitYAK_9.this.setNew.vspeed = ((199F * CockpitYAK_9.this.setOld.vspeed) + CockpitYAK_9.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitYAK_9() {
        super("3DO/Cockpit/Yak-9/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("richag", 0.0F, this.fm.CT.getAileron() * 15F, this.fm.CT.getElevator() * 10F);
        ...
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitYAK_9.speedometerScale), 0.0F);
