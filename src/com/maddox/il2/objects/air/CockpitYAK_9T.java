...
public class CockpitYAK_9T extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitYAK_9T.this.fm != null) {
                CockpitYAK_9T.this.setTmp = CockpitYAK_9T.this.setOld;
                CockpitYAK_9T.this.setOld = CockpitYAK_9T.this.setNew;
                CockpitYAK_9T.this.setNew = CockpitYAK_9T.this.setTmp;
                CockpitYAK_9T.this.setNew.throttle = ((10F * CockpitYAK_9T.this.setOld.throttle) + CockpitYAK_9T.this.fm.CT.PowerControl) / 11F;
                CockpitYAK_9T.this.setNew.prop = ((10F * CockpitYAK_9T.this.setOld.prop) + CockpitYAK_9T.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitYAK_9T.this.setNew.altimeter = CockpitYAK_9T.this.fm.getAltitude();
                if (Math.abs(CockpitYAK_9T.this.fm.Or.getKren()) < 30F) {
                    CockpitYAK_9T.this.setNew.azimuth.setDeg(CockpitYAK_9T.this.setOld.azimuth.getDeg(1.0F), CockpitYAK_9T.this.fm.Or.azimut());
                }
                CockpitYAK_9T.this.setNew.vspeed = ((199F * CockpitYAK_9T.this.setOld.vspeed) + CockpitYAK_9T.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitYAK_9T() {
        super("3DO/Cockpit/Yak-9T/hier.him", "bf109");
        this.setOld = new Variables();
        this.setNew = new Variables();
        this.w = new Vector3f();
        this.pictAiler = 0.0F;
        this.pictElev = 0.0F;
        this.light1 = new LightPointActor(new LightPoint(), new Point3d(-0.7511D, 0.3392D, 0.2992D));
        this.light2 = new LightPointActor(new LightPoint(), new Point3d(-0.6617D, 0.2842D, 0.2591D));
        this.light3 = new LightPointActor(new LightPoint(), new Point3d(-0.4892D, 0.201D, 0.1981D));
        this.light4 = new LightPointActor(new LightPoint(), new Point3d(-0.7511D, -0.3392D, 0.2992D));
        this.light5 = new LightPointActor(new LightPoint(), new Point3d(-0.6617D, -0.2842D, 0.2591D));
        this.light6 = new LightPointActor(new LightPoint(), new Point3d(-0.4892D, -0.201D, 0.1981D));
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if (((this.fm.AS.astateCockpitState & 4) == 0) && ((this.fm.AS.astateCockpitState & 0x10) == 0)) {
            this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitYAK_9T.speedometerScale), 0.0F);
        }
