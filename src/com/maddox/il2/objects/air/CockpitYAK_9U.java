...
public class CockpitYAK_9U extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (CockpitYAK_9U.this.fm != null) {
                CockpitYAK_9U.this.setTmp = CockpitYAK_9U.this.setOld;
                CockpitYAK_9U.this.setOld = CockpitYAK_9U.this.setNew;
                CockpitYAK_9U.this.setNew = CockpitYAK_9U.this.setTmp;
                CockpitYAK_9U.this.setNew.throttle = ((10F * CockpitYAK_9U.this.setOld.throttle) + CockpitYAK_9U.this.fm.CT.PowerControl) / 11F;
                CockpitYAK_9U.this.setNew.prop = ((10F * CockpitYAK_9U.this.setOld.prop) + CockpitYAK_9U.this.fm.EI.engines[0].getControlProp()) / 11F;
                CockpitYAK_9U.this.setNew.altimeter = CockpitYAK_9U.this.fm.getAltitude();
                if (Math.abs(CockpitYAK_9U.this.fm.Or.getKren()) < 30F) {
                    CockpitYAK_9U.this.setNew.azimuth.setDeg(CockpitYAK_9U.this.setOld.azimuth.getDeg(1.0F), CockpitYAK_9U.this.fm.Or.azimut());
                }
                CockpitYAK_9U.this.setNew.vspeed = ((199F * CockpitYAK_9U.this.setOld.vspeed) + CockpitYAK_9U.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public CockpitYAK_9U() {
        super("3DO/Cockpit/Yak-9U/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("zSpeed1a", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 800F, 0.0F, 16F), CockpitYAK_9U.speedometerScale), 0.0F);
