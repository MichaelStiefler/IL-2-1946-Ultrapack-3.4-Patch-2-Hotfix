    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitYB40.this.fm != null) {
                ...
                if (Math.abs(CockpitYB40.this.fm.Or.getKren()) < 30F) {
...
//                if (CockpitYB40.this.b17 != null) {
                CockpitYB40.this.setNew.vspeed = ((199F * CockpitYB40.this.setOld.vspeed) + CockpitYB40.this.fm.getVertSpeed()) / 200F;
//                }
...
//        if (this.aircraft() instanceof YB_40abc) {
//            this.b17 = (YB_40abc) this.aircraft();
//        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("ZClimb", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitYB40.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Zspeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitYB40.speedometerScale), 0.0F);
