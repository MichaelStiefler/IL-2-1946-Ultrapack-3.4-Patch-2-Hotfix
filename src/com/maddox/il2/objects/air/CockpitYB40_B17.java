...
public class CockpitYB40_B17 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitYB40_B17.this.fm != null) {
                if (CockpitYB40_B17.this.bNeedSetUp) {
                    CockpitYB40_B17.this.reflectPlaneMats();
                    CockpitYB40_B17.this.bNeedSetUp = false;
                }
                CockpitYB40_B17.this.setTmp = CockpitYB40_B17.this.setOld;
                CockpitYB40_B17.this.setOld = CockpitYB40_B17.this.setNew;
                CockpitYB40_B17.this.setNew = CockpitYB40_B17.this.setTmp;
                CockpitYB40_B17.this.setNew.throttle1 = (0.85F * CockpitYB40_B17.this.setOld.throttle1) + (CockpitYB40_B17.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                CockpitYB40_B17.this.setNew.throttle2 = (0.85F * CockpitYB40_B17.this.setOld.throttle2) + (CockpitYB40_B17.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                CockpitYB40_B17.this.setNew.throttle3 = (0.85F * CockpitYB40_B17.this.setOld.throttle3) + (CockpitYB40_B17.this.fm.EI.engines[2].getControlThrottle() * 0.15F);
                CockpitYB40_B17.this.setNew.throttle4 = (0.85F * CockpitYB40_B17.this.setOld.throttle4) + (CockpitYB40_B17.this.fm.EI.engines[3].getControlThrottle() * 0.15F);
                CockpitYB40_B17.this.setNew.prop1 = (0.85F * CockpitYB40_B17.this.setOld.prop1) + (CockpitYB40_B17.this.fm.EI.engines[0].getControlProp() * 0.15F);
                CockpitYB40_B17.this.setNew.prop2 = (0.85F * CockpitYB40_B17.this.setOld.prop2) + (CockpitYB40_B17.this.fm.EI.engines[1].getControlProp() * 0.15F);
                CockpitYB40_B17.this.setNew.prop3 = (0.85F * CockpitYB40_B17.this.setOld.prop3) + (CockpitYB40_B17.this.fm.EI.engines[2].getControlProp() * 0.15F);
                CockpitYB40_B17.this.setNew.prop4 = (0.85F * CockpitYB40_B17.this.setOld.prop4) + (CockpitYB40_B17.this.fm.EI.engines[3].getControlProp() * 0.15F);
                CockpitYB40_B17.this.setNew.mix1 = (0.85F * CockpitYB40_B17.this.setOld.mix1) + (CockpitYB40_B17.this.fm.EI.engines[0].getControlMix() * 0.15F);
                CockpitYB40_B17.this.setNew.mix2 = (0.85F * CockpitYB40_B17.this.setOld.mix1) + (CockpitYB40_B17.this.fm.EI.engines[1].getControlMix() * 0.15F);
                CockpitYB40_B17.this.setNew.mix3 = (0.85F * CockpitYB40_B17.this.setOld.mix1) + (CockpitYB40_B17.this.fm.EI.engines[2].getControlMix() * 0.15F);
                CockpitYB40_B17.this.setNew.mix4 = (0.85F * CockpitYB40_B17.this.setOld.mix1) + (CockpitYB40_B17.this.fm.EI.engines[3].getControlMix() * 0.15F);
                CockpitYB40_B17.this.setNew.altimeter = CockpitYB40_B17.this.fm.getAltitude();
                float f = CockpitYB40_B17.this.waypointAzimuth();
                if (Math.abs(CockpitYB40_B17.this.fm.Or.getKren()) < 30F) {
                    CockpitYB40_B17.this.setNew.azimuth.setDeg(CockpitYB40_B17.this.setOld.azimuth.getDeg(1.0F), CockpitYB40_B17.this.fm.Or.azimut());
                }
                CockpitYB40_B17.this.setNew.waypointAzimuth.setDeg(f);
                CockpitYB40_B17.this.setOld.waypointAzimuth.setDeg(f);
//                if (CockpitYB40_B17.this.b17 != null) {
                CockpitYB40_B17.this.setNew.vspeed = ((199F * CockpitYB40_B17.this.setOld.vspeed) + CockpitYB40_B17.this.fm.getVertSpeed()) / 200F;
//                }
                CockpitYB40_B17.this.mesh.chunkSetAngles("Turret", 0.0F, CockpitYB40_B17.this.aircraft().FM.turret[3].tu[0], 0.0F);
                CockpitYB40_B17.this.mesh.chunkSetAngles("TurretB", 0.0F, CockpitYB40_B17.this.aircraft().FM.turret[3].tu[1], 0.0F);
            }
            return true;
        }
    ...
    public CockpitYB40_B17() {
        ...
        this.pictManf4 = 1.0F;
//        this.b17 = null;
        this.cockpitNightMats = (new String[] { "Gauge_1", "Gauge_1DMG", "Gauge_2", "Gauge_2DMG", "Gauge_3", "Gauge_3DMG", "Gauge_4", "Gauge_5", "Gauge_5DMG", "Gauge_6", "Gauge_6DMG", "Gauge_7", "Gauges1", "Gauge_1DMG", "Gauges_2DMG", "Gauge_3DMG", "Gauges_5DMG", "Gauge_6DMG" });
        this.setNightMats(false);
//        if (this.aircraft() instanceof B_17) {
//            this.b17 = (B_17) this.aircraft();
//        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("ZClimb", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitYB40_B17.variometerScale), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Zspeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 836.859F, 0.0F, 13F), CockpitYB40_B17.speedometerScale), 0.0F);
...
//    private B_17               b17;
    ...
    static {
        Property.set(CockpitYB40_B17.class, "normZNs", new float[] { 0.75F, 0.75F, 1.27F, 1.27F });
    }
}
