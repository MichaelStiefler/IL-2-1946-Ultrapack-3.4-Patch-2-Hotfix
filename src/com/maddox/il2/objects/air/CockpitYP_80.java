...
public class CockpitYP_80 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (CockpitYP_80.this.fm != null) {
                CockpitYP_80.this.setTmp = CockpitYP_80.this.setOld;
                CockpitYP_80.this.setOld = CockpitYP_80.this.setNew;
                CockpitYP_80.this.setNew = CockpitYP_80.this.setTmp;
                ...
                float f = CockpitYP_80.this.waypointAzimuth(10F);
                if (Math.abs(CockpitYP_80.this.fm.Or.getKren()) < 30F) {
                    CockpitYP_80.this.setNew.azimuth.setDeg(CockpitYP_80.this.setOld.azimuth.getDeg(1.0F), CockpitYP_80.this.fm.Or.azimut());
                }
                CockpitYP_80.this.setNew.waypointAzimuth.setDeg(CockpitYP_80.this.setOld.waypointAzimuth.getDeg(0.1F), f);
                CockpitYP_80.this.setNew.vspeed = ((199F * CockpitYP_80.this.setOld.vspeed) + CockpitYP_80.this.fm.getVertSpeed()) / 200F;
                float f4 = ((P_80A) CockpitYP_80.this.aircraft()).k14Distance;
                CockpitYP_80.this.setNew.k14w = (5F * CockpitYP_80.k14TargetWingspanScale[((P_80A) CockpitYP_80.this.aircraft()).k14WingspanType]) / f4;
                ...
                Vector3d vector3d = CockpitYP_80.this.aircraft().FM.getW();
                double d = 0.00125D * f4;
                float f1 = (float) Math.toDegrees(d * vector3d.z);
                float f2 = -(float) Math.toDegrees(d * vector3d.y);
                float f3 = CockpitYP_80.this.floatindex((f4 - 200F) * 0.04F, CockpitYP_80.k14BulletDrop) - CockpitYP_80.k14BulletDrop[0];
                ...
                if (CockpitYP_80.this.setNew.k14x > 7F) {
                    CockpitYP_80.this.setNew.k14x = 7F;
                }
                if (CockpitYP_80.this.setNew.k14x < -7F) {
                    CockpitYP_80.this.setNew.k14x = -7F;
                }
                if (CockpitYP_80.this.setNew.k14y > 7F) {
                    CockpitYP_80.this.setNew.k14y = 7F;
                }
                if (CockpitYP_80.this.setNew.k14y < -7F) {
                    CockpitYP_80.this.setNew.k14y = -7F;
                }
    ...
    public void reflectWorldToInstruments(float f) {
        if ((this.fm.AS.astateCockpitState & 2) == 0) {
            int i = ((P_80A) this.aircraft()).k14Mode;
            boolean flag = i < 2;
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 1126.541F, 0.0F, 14F), CockpitYP_80.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -30.48F, 30.48F, 0.0F, 12F), CockpitYP_80.variometerScale), 0.0F, 0.0F);
