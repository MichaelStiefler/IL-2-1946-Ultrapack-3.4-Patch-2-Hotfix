...
public class Cockpit_Anson extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (Cockpit_Anson.this.fm != null) {
                ...
                if (Math.abs(Cockpit_Anson.this.fm.Or.getKren()) < 30F) {
                ...
                if ((Cockpit_Anson.this.fm.AS.astateCockpitState & 0x40) == 0) {
                    Cockpit_Anson.this.setNew.vspeed = ((199F * Cockpit_Anson.this.setOld.vspeed) + Cockpit_Anson.this.fm.getVertSpeed()) / 200F;
                } else {
                    Cockpit_Anson.this.setNew.vspeed = ((1990F * Cockpit_Anson.this.setOld.vspeed) + Cockpit_Anson.this.fm.getVertSpeed()) / 2000F;
                }
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 180.0555F, 0.0F, 35F), Cockpit_Anson.speedometerScaleFAF), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), Cockpit_Anson.variometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 800F, 3500F, 0.0F, 8F), Cockpit_Anson.rpmScale), 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 800F, 3500F, 0.0F, 8F), Cockpit_Anson.rpmScale), 0.0F);
