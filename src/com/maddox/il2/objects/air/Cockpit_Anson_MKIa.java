...
public class Cockpit_Anson_MKIa extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            if (Cockpit_Anson_MKIa.this.fm != null) {
                Cockpit_Anson_MKIa.this.setTmp = Cockpit_Anson_MKIa.this.setOld;
                Cockpit_Anson_MKIa.this.setOld = Cockpit_Anson_MKIa.this.setNew;
                Cockpit_Anson_MKIa.this.setNew = Cockpit_Anson_MKIa.this.setTmp;
                Cockpit_Anson_MKIa.this.setNew.throttle1 = (0.85F * Cockpit_Anson_MKIa.this.setOld.throttle1) + (Cockpit_Anson_MKIa.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                Cockpit_Anson_MKIa.this.setNew.throttle2 = (0.85F * Cockpit_Anson_MKIa.this.setOld.throttle2) + (Cockpit_Anson_MKIa.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                Cockpit_Anson_MKIa.this.setNew.prop1 = (0.85F * Cockpit_Anson_MKIa.this.setOld.prop1) + (Cockpit_Anson_MKIa.this.fm.EI.engines[0].getControlProp() * 0.15F);
                Cockpit_Anson_MKIa.this.setNew.prop2 = (0.85F * Cockpit_Anson_MKIa.this.setOld.prop2) + (Cockpit_Anson_MKIa.this.fm.EI.engines[1].getControlProp() * 0.15F);
                Cockpit_Anson_MKIa.this.setNew.altimeter = Cockpit_Anson_MKIa.this.fm.getAltitude();
                if (Math.abs(Cockpit_Anson_MKIa.this.fm.Or.getKren()) < 30F) {
                    Cockpit_Anson_MKIa.this.setNew.azimuth.setDeg(Cockpit_Anson_MKIa.this.setOld.azimuth.getDeg(1.0F), Cockpit_Anson_MKIa.this.fm.Or.azimut());
                }
                float f = Cockpit_Anson_MKIa.this.waypointAzimuth();
                Cockpit_Anson_MKIa.this.setNew.waypointDeviation.setDeg(Cockpit_Anson_MKIa.this.setOld.waypointDeviation.getDeg(0.1F), f - Cockpit_Anson_MKIa.this.setOld.azimuth.getDeg(1.0F));
                Cockpit_Anson_MKIa.this.setNew.waypointAzimuth.setDeg(Cockpit_Anson_MKIa.this.setOld.waypointAzimuth.getDeg(0.1F), f - Cockpit_Anson_MKIa.this.setOld.azimuth.getDeg(1.0F) - 90F);
                if ((Cockpit_Anson_MKIa.this.fm.AS.astateCockpitState & 0x40) == 0) {
                    Cockpit_Anson_MKIa.this.setNew.vspeed = ((199F * Cockpit_Anson_MKIa.this.setOld.vspeed) + Cockpit_Anson_MKIa.this.fm.getVertSpeed()) / 200F;
                } else {
                    Cockpit_Anson_MKIa.this.setNew.vspeed = ((1990F * Cockpit_Anson_MKIa.this.setOld.vspeed) + Cockpit_Anson_MKIa.this.fm.getVertSpeed()) / 2000F;
                }
            }
            return true;
        }
    ...
    protected void doFocusLeave() {
        this.aircraft().hierMesh().chunkVisible("Salon", true);
        this.aircraft().hierMesh().chunkVisible("Frame", true);
        this.aircraft().hierMesh().chunkVisible("Seats", true);
        this.aircraft().hierMesh().chunkVisible("Blister1_D0", true);
        this.aircraft().hierMesh().chunkVisible("RUS", true);
        this.aircraft().hierMesh().chunkVisible("Panel", true);
        super.doFocusLeave();
    }

    public Cockpit_Anson_MKIa() {
        super("3DO/Cockpit/Anson-MKIa-P/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        if ((this.fm.AS.astateCockpitState & 0x40) == 0) {
            this.mesh.chunkSetAngles("Z_Speedometer1", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeed()), 0.0F, 180.0555F, 0.0F, 35F), Cockpit_Anson_MKIa.speedometerScaleFAF), 0.0F);
        }
        ...
        this.mesh.chunkSetAngles("Z_Climb1", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -20.32F, 20.32F, 0.0F, 8F), Cockpit_Anson_MKIa.variometerScale), 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_RPM1", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 800F, 3500F, 0.0F, 8F), Cockpit_Anson_MKIa.rpmScale), 0.0F);
        this.mesh.chunkSetAngles("Z_RPM2", 0.0F, this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM(), 800F, 3500F, 0.0F, 8F), Cockpit_Anson_MKIa.rpmScale), 0.0F);
    ...
    static {
        Property.set(Cockpit_Anson_MKIa.class, "normZNs", new float[] { 0.55F, 0.55F, 0.75F, 0.75F });
    }
