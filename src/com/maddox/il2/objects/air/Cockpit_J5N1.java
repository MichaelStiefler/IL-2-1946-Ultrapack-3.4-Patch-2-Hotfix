...
public class Cockpit_J5N1 extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (Cockpit_J5N1.this.bNeedSetUp) {
                Cockpit_J5N1.this.reflectPlaneMats();
                Cockpit_J5N1.this.bNeedSetUp = false;
            }
            if (Cockpit_J5N1.this.fm != null) {
                Cockpit_J5N1.this.setTmp = Cockpit_J5N1.this.setOld;
                Cockpit_J5N1.this.setOld = Cockpit_J5N1.this.setNew;
                Cockpit_J5N1.this.setNew = Cockpit_J5N1.this.setTmp;
                Cockpit_J5N1.this.setNew.throttle1 = (0.85F * Cockpit_J5N1.this.setOld.throttle1) + (Cockpit_J5N1.this.fm.EI.engines[0].getControlThrottle() * 0.15F);
                Cockpit_J5N1.this.setNew.throttle2 = (0.85F * Cockpit_J5N1.this.setOld.throttle2) + (Cockpit_J5N1.this.fm.EI.engines[1].getControlThrottle() * 0.15F);
                Cockpit_J5N1.this.setNew.altimeter = Cockpit_J5N1.this.fm.getAltitude();
                float f = Cockpit_J5N1.this.waypointAzimuth();
                Cockpit_J5N1.this.setNew.waypointAzimuth.setDeg(Cockpit_J5N1.this.setOld.waypointAzimuth.getDeg(0.1F), (f - Cockpit_J5N1.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
                if (Math.abs(Cockpit_J5N1.this.fm.Or.getKren()) < 30F) {
                    Cockpit_J5N1.this.setNew.azimuth.setDeg(Cockpit_J5N1.this.setOld.azimuth.getDeg(1.0F), Cockpit_J5N1.this.fm.Or.azimut());
                }
                Cockpit_J5N1.this.setNew.vspeed = ((199F * Cockpit_J5N1.this.setOld.vspeed) + Cockpit_J5N1.this.fm.getVertSpeed()) / 200F;
                Cockpit_J5N1.this.setNew.manifold = (0.8F * Cockpit_J5N1.this.setOld.manifold) + (0.2F * Cockpit_J5N1.this.fm.EI.engines[0].getManifoldPressure());
            }
            return true;
        }
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", -this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 92.59998F, 740.7998F, 0.0F, 7F), Cockpit_J5N1.speedometerScale), 0.0F, 0.0F);
        this.resetYPRmodifier();
        ...
        this.mesh.chunkSetAngles("Z_Ext_Air_Temp", -this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 233.09F, 333.09F, 0.0F, 5F), Cockpit_J5N1.frAirTempScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Oil1", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 110F, 0.0F, 4F), Cockpit_J5N1.oilTempScale), 0.0F, 0.0F);
