...
public class Cockpit_J6K1 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (Cockpit_J6K1.this.fm != null) {
                Cockpit_J6K1.this.setTmp = Cockpit_J6K1.this.setOld;
                Cockpit_J6K1.this.setOld = Cockpit_J6K1.this.setNew;
                Cockpit_J6K1.this.setNew = Cockpit_J6K1.this.setTmp;
                Cockpit_J6K1.this.setNew.flap = (0.88F * Cockpit_J6K1.this.setOld.flap) + (0.12F * Cockpit_J6K1.this.fm.CT.FlapsControl);
                Cockpit_J6K1.this.setNew.tlock = (0.7F * Cockpit_J6K1.this.setOld.tlock) + (0.3F * (Cockpit_J6K1.this.fm.Gears.bTailwheelLocked ? 1.0F : 0.0F));
                if (Cockpit_J6K1.this.cockpitDimControl) {
                    if (Cockpit_J6K1.this.setNew.dimPosition > 0.0F) {
                        Cockpit_J6K1.this.setNew.dimPosition = Cockpit_J6K1.this.setOld.dimPosition - 0.05F;
                    }
                } else if (Cockpit_J6K1.this.setNew.dimPosition < 1.0F) {
                    Cockpit_J6K1.this.setNew.dimPosition = Cockpit_J6K1.this.setOld.dimPosition + 0.05F;
                }
                if ((Cockpit_J6K1.this.fm.CT.GearControl < 0.5F) && (Cockpit_J6K1.this.setNew.gear < 1.0F)) {
                    Cockpit_J6K1.this.setNew.gear = Cockpit_J6K1.this.setOld.gear + 0.02F;
                }
                if ((Cockpit_J6K1.this.fm.CT.GearControl > 0.5F) && (Cockpit_J6K1.this.setNew.gear > 0.0F)) {
                    Cockpit_J6K1.this.setNew.gear = Cockpit_J6K1.this.setOld.gear - 0.02F;
                }
                Cockpit_J6K1.this.setNew.throttle = (0.9F * Cockpit_J6K1.this.setOld.throttle) + (0.1F * Cockpit_J6K1.this.fm.CT.PowerControl);
                Cockpit_J6K1.this.setNew.manifold = (0.8F * Cockpit_J6K1.this.setOld.manifold) + (0.2F * Cockpit_J6K1.this.fm.EI.engines[0].getManifoldPressure());
                Cockpit_J6K1.this.setNew.pitch = (0.9F * Cockpit_J6K1.this.setOld.pitch) + (0.1F * Cockpit_J6K1.this.fm.EI.engines[0].getControlProp());
                Cockpit_J6K1.this.setNew.mix = (0.9F * Cockpit_J6K1.this.setOld.mix) + (0.1F * Cockpit_J6K1.this.fm.EI.engines[0].getControlMix());
                Cockpit_J6K1.this.setNew.altimeter = Cockpit_J6K1.this.fm.getAltitude();
                if (Math.abs(Cockpit_J6K1.this.fm.Or.getKren()) < 30F) {
                    Cockpit_J6K1.this.setNew.azimuth.setDeg(Cockpit_J6K1.this.setOld.azimuth.getDeg(1.0F), Cockpit_J6K1.this.fm.Or.azimut());
                }
                float f = Cockpit_J6K1.this.waypointAzimuth();
                Cockpit_J6K1.this.setNew.waypointAzimuth.setDeg(Cockpit_J6K1.this.setOld.waypointAzimuth.getDeg(0.1F), (f - Cockpit_J6K1.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-3F, 3F));
                Cockpit_J6K1.this.setNew.vspeed = ((199F * Cockpit_J6K1.this.setOld.vspeed) + Cockpit_J6K1.this.fm.getVertSpeed()) / 200F;
            }
            return true;
        }
    ...
    public Cockpit_J6K1() {
        super("3DO/Cockpit/J6K1-P/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("NeedOilTemp", -this.floatindex(this.cvt(this.fm.EI.engines[0].tOilOut, 30F, 110F, 0.0F, 8F), Cockpit_J6K1.oilTScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedRPM", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM(), 0.0F, 3500F, 0.0F, 7F), Cockpit_J6K1.revolutionsScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("NeedSpeed", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 740.7998F, 0.0F, 20F), Cockpit_J6K1.speedometerScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("NeedExternalT", this.floatindex(this.cvt(Atmosphere.temperature((float) this.fm.Loc.z), 233.09F, 333.09F, 0.0F, 5F), Cockpit_J6K1.frAirTempScale), 0.0F, 0.0F);
