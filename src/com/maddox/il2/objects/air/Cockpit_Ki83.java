...
public class Cockpit_Ki83 extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            if (((Ki83abc) Cockpit_Ki83.this.aircraft()).bChangedPit) {
                if (Cockpit_Ki83.this.bNeedSetUp) {
                    Cockpit_Ki83.this.reflectPlaneToModel();
                    ((Ki83abc) Cockpit_Ki83.this.aircraft()).bChangedPit = false;
                    Cockpit_Ki83.this.bNeedSetUp = false;
                }
                Cockpit_Ki83.this.setTmp = Cockpit_Ki83.this.setOld;
                Cockpit_Ki83.this.setOld = Cockpit_Ki83.this.setNew;
                Cockpit_Ki83.this.setNew = Cockpit_Ki83.this.setTmp;
                if (((Cockpit_Ki83.this.fm.AS.astateCockpitState & 2) != 0) && (Cockpit_Ki83.this.setNew.ironSight < 1.0F)) {
                    Cockpit_Ki83.this.setNew.ironSight = Cockpit_Ki83.this.setOld.ironSight + 0.0125F;
                    Cockpit_Ki83.this.setOld.ironSight = Cockpit_Ki83.this.setNew.ironSight;
                }
                Cockpit_Ki83.this.setNew.altimeter = Cockpit_Ki83.this.fm.getAltitude();
                if (Cockpit_Ki83.this.cockpitDimControl) {
                    if ((Cockpit_Ki83.this.setNew.dimPosition > 0.0F) && (Cockpit_Ki83.this.setNew.ironSight == 0.0F)) {
                        Cockpit_Ki83.this.setNew.dimPosition = Cockpit_Ki83.this.setNew.dimPosition - 0.05F;
                    }
                } else if ((Cockpit_Ki83.this.setNew.dimPosition < 1.0F) && (Cockpit_Ki83.this.setNew.ironSight == 0.0F)) {
                    Cockpit_Ki83.this.setNew.dimPosition = Cockpit_Ki83.this.setNew.dimPosition + 0.05F;
                }
                Cockpit_Ki83.this.setNew.throttle1 = (0.91F * Cockpit_Ki83.this.setOld.throttle1) + (0.09F * Cockpit_Ki83.this.fm.EI.engines[0].getControlThrottle());
                Cockpit_Ki83.this.setNew.throttle2 = (0.91F * Cockpit_Ki83.this.setOld.throttle2) + (0.09F * Cockpit_Ki83.this.fm.EI.engines[1].getControlThrottle());
                Cockpit_Ki83.this.setNew.mix1 = (0.88F * Cockpit_Ki83.this.setOld.mix1) + (0.12F * Cockpit_Ki83.this.fm.EI.engines[0].getControlMix());
                Cockpit_Ki83.this.setNew.mix2 = (0.88F * Cockpit_Ki83.this.setOld.mix2) + (0.12F * Cockpit_Ki83.this.fm.EI.engines[1].getControlMix());
                if (Math.abs(Cockpit_Ki83.this.fm.Or.getKren()) < 30F) {
                    Cockpit_Ki83.this.setNew.azimuth.setDeg(Cockpit_Ki83.this.setOld.azimuth.getDeg(1.0F), -Cockpit_Ki83.this.fm.Or.azimut() - 90F);
                }
                Cockpit_Ki83.this.w.set(Cockpit_Ki83.this.fm.getW());
                Cockpit_Ki83.this.fm.Or.transform(Cockpit_Ki83.this.w);
                Cockpit_Ki83.this.setNew.turn = ((12F * Cockpit_Ki83.this.setOld.turn) + Cockpit_Ki83.this.w.z) / 13F;
                Cockpit_Ki83.this.setNew.vspeed = ((199F * Cockpit_Ki83.this.setOld.vspeed) + Cockpit_Ki83.this.fm.getVertSpeed()) / 200F;
                Cockpit_Ki83.this.setNew.manifold1 = (0.8F * Cockpit_Ki83.this.setOld.manifold1) + (0.2F * Cockpit_Ki83.this.fm.EI.engines[0].getManifoldPressure());
                Cockpit_Ki83.this.setNew.manifold2 = (0.8F * Cockpit_Ki83.this.setOld.manifold2) + (0.2F * Cockpit_Ki83.this.fm.EI.engines[1].getManifoldPressure());
                float f = 30F;
                for (int i = 0; i < 2; i++) {
                    if ((Cockpit_Ki83.this.cowlFlapsLever[i] != 0.0F) && (Cockpit_Ki83.this.cowlFlaps[i] == Cockpit_Ki83.this.fm.EI.engines[i].getControlRadiator())) {
                        Cockpit_Ki83.this.cowlFlapsLever[i] = Cockpit_Ki83.this.cowlFlapsLever[i] * 0.8F;
                        if (Math.abs(Cockpit_Ki83.this.cowlFlapsLever[i]) < 0.1F) {
                            Cockpit_Ki83.this.cowlFlapsLever[i] = 0.0F;
                        }
                    } else if (Cockpit_Ki83.this.cowlFlaps[i] < Cockpit_Ki83.this.fm.EI.engines[i].getControlRadiator()) {
                        Cockpit_Ki83.this.cowlFlaps[i] = Cockpit_Ki83.this.fm.EI.engines[i].getControlRadiator();
                        Cockpit_Ki83.this.cowlFlapsLever[i] = Cockpit_Ki83.this.cowlFlapsLever[i] + 2.0F;
                        if (Cockpit_Ki83.this.cowlFlapsLever[i] > f) {
                            Cockpit_Ki83.this.cowlFlapsLever[i] = f;
                        }
                    } else if (Cockpit_Ki83.this.cowlFlaps[i] > Cockpit_Ki83.this.fm.EI.engines[i].getControlRadiator()) {
                        Cockpit_Ki83.this.cowlFlaps[i] = Cockpit_Ki83.this.fm.EI.engines[i].getControlRadiator();
                        Cockpit_Ki83.this.cowlFlapsLever[i] = Cockpit_Ki83.this.cowlFlapsLever[i] - 2.0F;
    ...
    public Cockpit_Ki83() {
        super("3DO/Cockpit/Ki83-P/hier.him", "bf109");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Need_Climb", 0.0F, this.floatindex(this.cvt(this.setNew.vspeed, -30F, 30F, 0.0F, 12F), Cockpit_Ki83.variometerScale), 0.0F);
        this.mesh.chunkSetAngles("Z_Need_AirSpeed", 0.0F, this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 0.0F, 700F, 0.0F, 14F), Cockpit_Ki83.speedometerScale), 0.0F);
    ...
    protected boolean doFocusEnter() {
        if (super.doFocusEnter()) {
            ...
            this.aircraft().hierMesh().chunkVisible("CF_C", false);
            return true;
        } else {
            return false;
        }
    ...
    protected void doFocusLeave() {
        if (!this.isFocused()) {
            ...
            this.aircraft().hierMesh().chunkVisible("CF_C", true);
            super.doFocusLeave();
            return;
        }
    }
