...
public class Cockpit_Kikka extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            Cockpit_Kikka.this.setTmp = Cockpit_Kikka.this.setOld;
            Cockpit_Kikka.this.setOld = Cockpit_Kikka.this.setNew;
            Cockpit_Kikka.this.setNew = Cockpit_Kikka.this.setTmp;
            Cockpit_Kikka.this.setNew.altimeter = Cockpit_Kikka.this.fm.getAltitude();
            Cockpit_Kikka.this.setNew.throttlel = ((10F * Cockpit_Kikka.this.setOld.throttlel) + Cockpit_Kikka.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            Cockpit_Kikka.this.setNew.throttler = ((10F * Cockpit_Kikka.this.setOld.throttler) + Cockpit_Kikka.this.fm.EI.engines[1].getControlThrottle()) / 11F;
            Cockpit_Kikka.this.setNew.waypointAzimuth.setDeg(Cockpit_Kikka.this.setOld.waypointAzimuth.getDeg(0.1F), (Cockpit_Kikka.this.waypointAzimuth() - Cockpit_Kikka.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(Cockpit_Kikka.this.fm.Or.getKren()) < 30F) {
                Cockpit_Kikka.this.setNew.azimuth.setDeg(Cockpit_Kikka.this.setOld.azimuth.getDeg(1.0F), Cockpit_Kikka.this.fm.Or.azimut());
            }
            Cockpit_Kikka.this.setNew.vspeed = ((299F * Cockpit_Kikka.this.setOld.vspeed) + Cockpit_Kikka.this.fm.getVertSpeed()) / 300F;
            if (Cockpit_Kikka.this.cockpitDimControl) {
                if (Cockpit_Kikka.this.setNew.dimPosition > 0.0F) {
                    Cockpit_Kikka.this.setNew.dimPosition = Cockpit_Kikka.this.setOld.dimPosition - 0.05F;
                }
            } else if (Cockpit_Kikka.this.setNew.dimPosition < 1.0F) {
                Cockpit_Kikka.this.setNew.dimPosition = Cockpit_Kikka.this.setOld.dimPosition + 0.05F;
            }
            return true;
        }
    ...
    public Cockpit_Kikka() {
        super("3DO/Cockpit/Kikka-P/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 400F, 2.0F, 8F), Cockpit_Kikka.speedometerIndScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 100F, 1000F, 1.0F, 10F), Cockpit_Kikka.speedometerTruScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -20F, 50F, 0.0F, 14F), Cockpit_Kikka.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPML", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), Cockpit_Kikka.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPMR", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), Cockpit_Kikka.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_FuelRemainV", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), Cockpit_Kikka.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelRemainIn", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), Cockpit_Kikka.fuelScale), 0.0F, 0.0F);
    }
