...
public class Cockpit_KikkaKai extends CockpitPilot {
    ...
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            Cockpit_KikkaKai.this.setNew.waypointAzimuth.setDeg(Cockpit_KikkaKai.this.setOld.waypointAzimuth.getDeg(0.1F), (Cockpit_KikkaKai.this.waypointAzimuth() - Cockpit_KikkaKai.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(Cockpit_KikkaKai.this.fm.Or.getKren()) < 30F) {
                Cockpit_KikkaKai.this.setNew.azimuth.setDeg(Cockpit_KikkaKai.this.setOld.azimuth.getDeg(1.0F), Cockpit_KikkaKai.this.fm.Or.azimut());
            }
