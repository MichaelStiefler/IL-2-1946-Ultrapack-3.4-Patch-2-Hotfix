...
public class Cockpit_KikkaR extends CockpitPilot {
    class Interpolater extends InterpolateRef {

        public boolean tick() {
            Cockpit_KikkaR.this.setTmp = Cockpit_KikkaR.this.setOld;
            Cockpit_KikkaR.this.setOld = Cockpit_KikkaR.this.setNew;
            Cockpit_KikkaR.this.setNew = Cockpit_KikkaR.this.setTmp;
            Cockpit_KikkaR.this.setNew.altimeter = Cockpit_KikkaR.this.fm.getAltitude();
            Cockpit_KikkaR.this.setNew.throttlel = ((10F * Cockpit_KikkaR.this.setOld.throttlel) + Cockpit_KikkaR.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            Cockpit_KikkaR.this.setNew.throttler = ((10F * Cockpit_KikkaR.this.setOld.throttler) + Cockpit_KikkaR.this.fm.EI.engines[1].getControlThrottle()) / 11F;
            Cockpit_KikkaR.this.setNew.waypointAzimuth.setDeg(Cockpit_KikkaR.this.setOld.waypointAzimuth.getDeg(0.1F), (Cockpit_KikkaR.this.waypointAzimuth() - Cockpit_KikkaR.this.setOld.azimuth.getDeg(1.0F)) + World.Rnd().nextFloat(-10F, 10F));
            if (Math.abs(Cockpit_KikkaR.this.fm.Or.getKren()) < 30F) {
                Cockpit_KikkaR.this.setNew.azimuth.setDeg(Cockpit_KikkaR.this.setOld.azimuth.getDeg(1.0F), Cockpit_KikkaR.this.fm.Or.azimut());
            }
            Cockpit_KikkaR.this.setNew.vspeed = ((299F * Cockpit_KikkaR.this.setOld.vspeed) + Cockpit_KikkaR.this.fm.getVertSpeed()) / 300F;
            if (Cockpit_KikkaR.this.cockpitDimControl) {
                if (Cockpit_KikkaR.this.setNew.dimPosition > 0.0F) {
                    Cockpit_KikkaR.this.setNew.dimPosition = Cockpit_KikkaR.this.setOld.dimPosition - 0.05F;
                }
            } else if (Cockpit_KikkaR.this.setNew.dimPosition < 1.0F) {
                Cockpit_KikkaR.this.setNew.dimPosition = Cockpit_KikkaR.this.setOld.dimPosition + 0.05F;
            }
            return true;
        }
    ...
    public Cockpit_KikkaR() {
        super("3DO/Cockpit/Kikka-TR/hier.him", "he111");
    ...
    public void reflectWorldToInstruments(float f) {
        ...
        this.mesh.chunkSetAngles("Z_Speedometer1", this.floatindex(this.cvt(Pitot.Indicator((float) this.fm.Loc.z, this.fm.getSpeedKMH()), 100F, 400F, 2.0F, 8F), Cockpit_KikkaR.speedometerIndScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_Speedometer2", this.floatindex(this.cvt(this.fm.getSpeedKMH(), 100F, 1000F, 1.0F, 10F), Cockpit_KikkaR.speedometerTruScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_Climb1", this.floatindex(this.cvt(this.setNew.vspeed, -20F, 50F, 0.0F, 14F), Cockpit_KikkaR.variometerScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPML", this.floatindex(this.cvt(this.fm.EI.engines[0].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), Cockpit_KikkaR.rpmScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_RPMR", this.floatindex(this.cvt(this.fm.EI.engines[1].getRPM() * 10F * 0.25F, 2000F, 14000F, 2.0F, 14F), Cockpit_KikkaR.rpmScale), 0.0F, 0.0F);
        ...
        this.mesh.chunkSetAngles("Z_FuelRemainV", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), Cockpit_KikkaR.fuelScale), 0.0F, 0.0F);
        this.mesh.chunkSetAngles("Z_FuelRemainIn", this.floatindex(this.cvt(this.fm.M.fuel / 0.72F, 0.0F, 1000F, 0.0F, 5F), Cockpit_KikkaR.fuelScale), 0.0F, 0.0F);
    }
    ...
    static {
        Property.set(Cockpit_KikkaR.class, "astatePilotIndx", 1);
    }
