...
public class Cockpit_RanwersLetov extends CockpitPilot {
    class Interpolater extends InterpolateRef {
        ...
        public boolean tick() {
            ...
            if (((Cockpit_RanwersLetov.this.fm.AS.astateCockpitState & 2) != 0) && (Cockpit_RanwersLetov.this.setNew.stbyPosition < 1.0F)) {
            ...
            Cockpit_RanwersLetov.this.setNew.altimeter = Cockpit_RanwersLetov.this.fm.getAltitude();
            Cockpit_RanwersLetov.this.setNew.throttle = ((10F * Cockpit_RanwersLetov.this.setOld.throttle) + Cockpit_RanwersLetov.this.fm.EI.engines[0].getControlThrottle()) / 11F;
            Cockpit_RanwersLetov.this.setNew.mix = ((10F * Cockpit_RanwersLetov.this.setOld.mix) + Cockpit_RanwersLetov.this.fm.EI.engines[0].getControlMix()) / 11F;
            Cockpit_RanwersLetov.this.setNew.radiator = ((10F * Cockpit_RanwersLetov.this.setOld.radiator) + Cockpit_RanwersLetov.this.fm.EI.engines[0].getControlRadiator()) / 11F;
            Cockpit_RanwersLetov.this.setNew.prop = Cockpit_RanwersLetov.this.setOld.prop;
            if (Cockpit_RanwersLetov.this.setNew.prop < (Cockpit_RanwersLetov.this.fm.EI.engines[0].getControlProp() - 0.01F)) {
                Cockpit_RanwersLetov.this.setNew.prop += 0.0025F;
            }
            if (Cockpit_RanwersLetov.this.setNew.prop > (Cockpit_RanwersLetov.this.fm.EI.engines[0].getControlProp() + 0.01F)) {
                Cockpit_RanwersLetov.this.setNew.prop -= 0.0025F;
            }
            Cockpit_RanwersLetov.this.w.set(Cockpit_RanwersLetov.this.fm.getW());
            Cockpit_RanwersLetov.this.fm.Or.transform(Cockpit_RanwersLetov.this.w);
            Cockpit_RanwersLetov.this.setNew.turn = ((12F * Cockpit_RanwersLetov.this.setOld.turn) + Cockpit_RanwersLetov.this.w.z) / 13F;
            Cockpit_RanwersLetov.this.setNew.vspeed = ((299F * Cockpit_RanwersLetov.this.setOld.vspeed) + Cockpit_RanwersLetov.this.fm.getVertSpeed()) / 300F;
            Cockpit_RanwersLetov.this.pictSupc = (0.8F * Cockpit_RanwersLetov.this.pictSupc) + (0.2F * Cockpit_RanwersLetov.this.fm.EI.engines[0].getControlCompressor());
            ...
            if (!Cockpit_RanwersLetov.this.fm.Gears.bTailwheelLocked && (Cockpit_RanwersLetov.this.tailWheelLock < 1.0F)) {
                Cockpit_RanwersLetov.this.tailWheelLock = Cockpit_RanwersLetov.this.tailWheelLock + 0.05F;
            } else if (Cockpit_RanwersLetov.this.fm.Gears.bTailwheelLocked && (Cockpit_RanwersLetov.this.tailWheelLock > 0.0F)) {
                Cockpit_RanwersLetov.this.tailWheelLock = Cockpit_RanwersLetov.this.tailWheelLock - 0.05F;
            }
    ...
    private class Variables {
        ...
        private Variables() {
            ...
            this.compassPoint[0] = new Vector3d(0.0D, Math.sqrt(1.0D - (Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ)), Cockpit_RanwersLetov.compassZ);
            this.compassPoint[1] = new Vector3d(-Math.sqrt(1.0D - (Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ)), 0.0D, Cockpit_RanwersLetov.compassZ);
            this.compassPoint[2] = new Vector3d(0.0D, -Math.sqrt(1.0D - (Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ)), Cockpit_RanwersLetov.compassZ);
            this.compassPoint[3] = new Vector3d(Math.sqrt(1.0D - (Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ)), 0.0D, Cockpit_RanwersLetov.compassZ);
            this.cP[0] = new Vector3d(0.0D, Math.sqrt(1.0D - (Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ)), Cockpit_RanwersLetov.compassZ);
            this.cP[1] = new Vector3d(-Math.sqrt(1.0D - (Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ)), 0.0D, Cockpit_RanwersLetov.compassZ);
            this.cP[2] = new Vector3d(0.0D, -Math.sqrt(1.0D - (Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ)), Cockpit_RanwersLetov.compassZ);
            this.cP[3] = new Vector3d(Math.sqrt(1.0D - (Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ)), 0.0D, Cockpit_RanwersLetov.compassZ);
        }
    ...
    private void initCompass() {
        ...
        this.segLen1 = 2D * Math.sqrt(1.0D - (Cockpit_RanwersLetov.compassZ * Cockpit_RanwersLetov.compassZ));
        this.segLen2 = this.segLen1 / Math.sqrt(2D);
        this.compassLimit = -1D * Math.sin(0.01745328888888889D * Cockpit_RanwersLetov.compassLimitAngle);
    ...
    private void updateCompass() {
        ...
        if (this.accel.length() > (-Cockpit_RanwersLetov.compassZ * 0.7D)) {
            this.accel.scale((-Cockpit_RanwersLetov.compassZ * 0.7D) / this.accel.length());
        }
        for (int i = 0; i < 4; i++) {
        ...
        vector3d2.normalize();
        vector3d2.scale(-Cockpit_RanwersLetov.compassZ);
