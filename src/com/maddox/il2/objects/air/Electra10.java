...
public class Electra10 extends Scheme2 implements TypeScout, TypeTransport {
    ...
    protected void moveGear(float f) {
        Electra10.moveGear(this.hierMesh(), f);
    }
    ...
    protected void hitBone(String s, Shot shot, Point3d point3d) {
        if (s.startsWith("xx")) {
            ...
            if (s.startsWith("xxspar")) {
                if ((s.endsWith("lm1") || s.endsWith("lm2")) && World.Rnd().nextFloat() < Aircraft.cvt((float) Math.abs(((Tuple3d) Aircraft.v1).x), 0.0F, 1.0F, 1.0F, 0.08F) && this.chunkDamageVisible("WingLMid") > 2
                        && this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
                    Aircraft.debugprintln(this, "*** WingLMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLMid_D3", shot.initiator);
                }
                if ((s.endsWith("rm1") || s.endsWith("rm2")) && World.Rnd().nextFloat() < Aircraft.cvt((float) Math.abs(((Tuple3d) Aircraft.v1).x), 0.0F, 1.0F, 1.0F, 0.08F) && this.chunkDamageVisible("WingRMid") > 2
                        && this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
                    Aircraft.debugprintln(this, "*** WingRMid Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingRMid_D3", shot.initiator);
                }
                if ((s.endsWith("lo1") || s.endsWith("lo2")) && World.Rnd().nextFloat() < Aircraft.cvt((float) Math.abs(((Tuple3d) Aircraft.v1).x), 0.0F, 1.0F, 1.0F, 0.33F) && this.chunkDamageVisible("WingLOut") > 2
                        && this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
                    Aircraft.debugprintln(this, "*** WingLOut Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingLOut_D3", shot.initiator);
                }
                if ((s.endsWith("ro1") || s.endsWith("ro2")) && World.Rnd().nextFloat() < Aircraft.cvt((float) Math.abs(((Tuple3d) Aircraft.v1).x), 0.0F, 1.0F, 1.0F, 0.33F) && this.chunkDamageVisible("WingROut") > 2
                        && this.getEnergyPastArmor(12.5F * World.Rnd().nextFloat(1.0F, 1.2F), shot) > 0.0F) {
                    Aircraft.debugprintln(this, "*** WingROut Spars Damaged..");
                    this.nextDMGLevels(1, 2, "WingROut_D3", shot.initiator);
                }
                if ((s.endsWith("k1") || s.endsWith("k2")) && World.Rnd().nextFloat() < Aircraft.cvt((float) Math.abs(((Tuple3d) Aircraft.v1).x), 0.0F, 1.0F, 1.0F, 0.26F) && this.chunkDamageVisible("Keel1") > 1
    ...
    static {
        Class class1 = Electra10.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Electra");
        Property.set(class1, "meshName", "3DO/Plane/Electra10(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar00());
        Property.set(class1, "yearService", 1937F);
        Property.set(class1, "yearExpired", 1948F);
        Property.set(class1, "FlightModel", "FlightModels/Electra10.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitElectra10.class });
        Property.set(class1, "LOSElevation", 0.5265F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 3, 9, 9 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_BombSpawn14", "_ExternalDev01", "_ExternalDev02" });
    }
}
