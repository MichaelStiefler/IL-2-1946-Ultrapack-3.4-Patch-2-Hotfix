...
public class FW_187A0 extends FW_187
    implements TypeFighter, TypeBNZFighter, TypeStormovik, TypeRadarLiSN2Carrier
{
    ...
    static 
    {
        Class class1 = FW_187A0.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "FW-187");
        Property.set(class1, "meshName", "3DO/Plane/FW-187A0/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeBMPar03());
        Property.set(class1, "yearService", 1940F);
        Property.set(class1, "yearExpired", 1945.5F);
        Property.set(class1, "FlightModel", "FlightModels/FW-187A-0.fmd");
        Property.set(class1, "cockpitClass", new Class[] {
            CockpitFW_187A.class, CockpitFW_187_Radar.class
        });
