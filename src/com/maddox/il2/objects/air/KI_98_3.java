...
public class KI_98_3 extends KI_98x
    implements TypeFighter, TypeStormovik
{
    ...
    public void onAircraftLoaded()
    {
        ...
        KI_98_3.prepareWeapons(this.getClass(), this.hierMesh(), this.thisWeaponsName);
        if(thisWeaponsName.startsWith("Extra")) this.FM.M.massEmpty -= 100F;
    }

    static 
    {
        Class class1 = KI_98_3.class;
        ...
        Property.set(class1, "FlightModel", "FlightModels/Ki_98_III.fmd");
