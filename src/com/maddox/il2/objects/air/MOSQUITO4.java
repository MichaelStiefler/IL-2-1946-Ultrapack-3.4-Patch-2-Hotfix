...
public class MOSQUITO4 extends MOSQUITO implements TypeBomber {
    ...
    static {
        Class class1 = MOSQUITO4.class;
        new NetAircraft.SPAWN(class1);
        Property.set(class1, "iconFar_shortClassName", "Mosquito");
        Property.set(class1, "meshName", "3DO/Plane/Mosquito_B_MkIV(Multi1)/hier.him");
        Property.set(class1, "PaintScheme", new PaintSchemeFMPar04());
        Property.set(class1, "meshName_gb", "3DO/Plane/Mosquito_B_MkIV(GB)/hier.him");
        Property.set(class1, "PaintScheme_gb", new PaintSchemeFMPar06());
        Property.set(class1, "yearService", 1941F);
        Property.set(class1, "yearExpired", 1946.5F);
//        Property.set(class1, "FlightModel", "FlightModels/Mosquito-BMkIV.fmd");
        Property.set(class1, "FlightModel", "FlightModels/Mosquito-BMkIV_Ultrapack.fmd");
        Property.set(class1, "cockpitClass", new Class[] { CockpitMosquito4.class, CockpitMOSQUITO4_Bombardier.class });
        Property.set(class1, "LOSElevation", 0.76315F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 0, 3, 3, 3, 3 });
        Aircraft.weaponHooksRegister(class1, new String[] { "_Clip04", "_BombSpawn01", "_BombSpawn02", "_BombSpawn03", "_BombSpawn04" });
    }
}
