...
//        super.update(f);
//        HUD.training("E: " + df.format(this.FM.EI.engines[0].getRPM()) + ", P: " + df.format(this.FM.EI.engines[0].getPropRPM()) + ", Phi:" +  df.format(this.FM.EI.engines[0].getPropPhi()));
//    }
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/Mosquito-FBMkVI_Ultrapack.fmd");
