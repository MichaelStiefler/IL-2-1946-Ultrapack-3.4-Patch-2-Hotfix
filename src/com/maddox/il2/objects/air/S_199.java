...
public class S_199 extends BF_109 implements TypeBNZFighter {
    ...
    public void update(float f) {
        ...
        if (this.FM.CT.getCockpitDoor() > 0.2D && this.bHasBlister && this.FM.getSpeedKMH() > this.fMaxKMHSpeedForOpenCanopy && this.hierMesh().chunkFindCheck("Blister1_D0") != -1) {
            try {
                if (this == World.getPlayerAircraft()) ((CockpitS_199) Main3D.cur3D().cockpitCur).removeCanopy();
...
//    public float   cockpitDoor_;
    ...
    static {
        ...
        Property.set(class1, "FlightModel", "FlightModels/S-199.fmd");
