...
public class WAGEN extends CAR_NEW {

    public void onAircraftLoaded() {
        super.onAircraftLoaded();
        WAGEN.prepareWeapons(this.getClass(), this.hierMesh(), this.thisWeaponsName);
    ...
    static {
        ...
        Property.set(class1, "cockpitClass", new Class[] { CockpitWagen.class, CockpitKuebel_Gunner.class });
        Property.set(class1, "LOSElevation", 0.8941F);
        Aircraft.weaponTriggersRegister(class1, new int[] { 10, 10 });
