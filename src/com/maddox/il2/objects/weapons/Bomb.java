...
public class Bomb extends ActorMesh implements MsgCollisionRequestListener, MsgCollisionListener {
    ...
    protected void doExplosion(Actor actor, String s, Point3d point3d) {
        ...
        int newEffect = Property.intValue(class1, "newEffect", 0);
        int nuke = Property.intValue(class1, "nuke", 0);
        
        if (this.isArmed()) {
//            MsgExplosion.send(actor, s, point3d, this.getOwner(), this.M, f, i, f1, k);
            MsgExplosion.send(actor, s, point3d, this.getOwner(), this.M, f, i, f1, newEffect);
...
//            Explosions.generate(actor, point3d, f, i, f1, false, j);
            Explosions.generate(actor, point3d, f, i, f1, false, nuke);
...
//        System.out.println("Bomb setSeed(" + seedValue + ")");
    ...
    public Bomb() {
        ...
        // TODO: 4.14.1 Backport ---
        Bomb.printDebug(this.getOwner(), "Bomb " + Bomb.simpleClassName(this) + " Bomb()");
    }
    ...
    public static final int      NEW_EFFECT_DISABLED  = 0;
    public static final int      NEW_EFFECT_ENABLED  = 1;
    public static final int      NUKE_DISABLED  = 0;
    public static final int      NUKE_ENABLED  = 1;
    public static final int      NUKE_MISTEL  = -1;
